    ...
    for cls in classes:
        ...
        try:
            r = subprocess.run(
                ...
                capture_output=True, text=True, timeout=12, cwd="C:/Git/Agentic-Workflow"
            )
            out = (r.stdout + r.stderr).strip().split("\n")
            summary = [l for l in out if "passed" in l or "failed" in l or "error" in l or "no tests" in l.lower()]
