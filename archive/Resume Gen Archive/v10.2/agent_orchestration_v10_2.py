# File: agent_orchestration_v10_2.py
# Version: 10.2 (ChromaDB Semantic RAG)
#
# Description:
# v10.2: Imports updated to v10.2. Orchestration logic preserved.
#
# Contains the "brain" of the operation: the ReAct Conductors
# and the final LangGraph builder (get_graph_app).
# Imports stacks from agent_stacks_v10_2.py and
# tools from agent_tools_v10_2.py.
...
# ============================================================================
# LANGGRAPH WORKFLOW BUILDER (Design-Aligned v10.2)
# ============================================================================
...
def get_graph_app(checkpointer: RedisSaver, context: WorkflowContext, enable_hil: bool = True):
    ...
    async def run_rag_stack(state: dict) -> dict:
        """Node 3: RAG with ReAct Search (v10.2: Uses ChromaDB)"""
        rag_agent = RAG_SearchAgent(context)
        workflow_id = state.get('metadata', {}).get('workflow_id', '')
        
        query = f"{state['job']['job_title']} at {state['job']['company']}"
        # v10.2: 'professional_experience' is the key in the provided master_resume.json
    ...
    # --- BUILD GRAPH (Matches v10.1/v10.2 design) ---
    ...
    workflow.add_node("run_prompt_engineering", run_prompt_engineering) # Node 2.5
...
# ============================================================================
# END OF agent_orchestration_v10_2.py
# ============================================================================