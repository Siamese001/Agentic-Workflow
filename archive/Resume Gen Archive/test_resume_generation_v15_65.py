"""
Pytest suite for Resume_Generation_v15_65.py HOP-0.5 enhancements.

Tests the two major upgrades:
1. Enhanced JD skill extraction (structured requirements, clustering, implicit inference)
2. Master resume semantic indexing (skill→experience mappings, achievement catalog)

Run with: pytest test_resume_generation_v15_65.py -v
"""
...
from Resume_Generation_v15_65 import (
...
class TestMasterResumeSemanticIndexing:
    ...
    def test_index_initialization(self, sample_master_resume):
        ...
        with patch('Resume_Generation_v15_65.GEMINI_AVAILABLE', False):
...
class TestSkillClustering:
    ...
    def test_cluster_related_skills(self, sample_master_resume):
        ...
        with patch('Resume_Generation_v15_65.GEMINI_AVAILABLE', False):
            ...
            with patch('Resume_Generation_v15_65.TfidfVectorizer') as mock_vectorizer, \
                 patch('Resume_Generation_v15_65.cosine_similarity') as mock_similarity:
...
class TestEnhancedHOP05Integration:
    ...
    def test_execute_pre_rag_analysis_with_enhancements(self, sample_master_resume, 
        ...
        with patch('Resume_Generation_v15_65.GEMINI_AVAILABLE', True):
            analyzer = EnhancedJobDescriptionAnalyzer(
                master_resume=sample_master_resume,
