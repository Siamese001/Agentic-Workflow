"""
Pytest suite for Resume_Generation_v15_69.py Agentic RAG Loop validation.

Tests v15_69 NEW features:
1. RAGCritique dataclass structure and validation
2. RAGState evidence logging and accumulation
3. RAGEvidence individual action tracking
4. agentic_search_and_analyze iterative refinement loop
5. _critique_rag_results heuristic evaluation
6. _build_refinement_prompt gap-based query generation
7. _merge_rag_results cumulative evidence merging
8. ThematicAnalysis.evidence_log field population
9. Confidence thresholding and early termination
10. Backward compatibility with standard search_and_analyze

Also includes inherited tests from v15_68 for HOP output JSON persistence,
v15_67 for narrative generation fix, and v15_66 for MasterResumeIndex integration.

Run with: pytest test_resume_generation_v15_69.py -v
"""
...
from Resume_Generation_v15_69 import (
