# File: run_batch_v6_3.py
# NEW: Batch processing harness for v6.3
# Processes all job_input.json files in batch_queue/ folder
# Writes one-line summaries to batch_summary_v6_3.csv
...
SUMMARY_FILE = "batch_summary_v6_3.csv"
...
def run_batch():
    ...
    logger.info(f"v6.3 Batch process starting. Found {len(job_files)} jobs.")
    consecutive_failures = 0
    FAILURE_THRESHOLD = 3  # v6.3: Alerting - halt batch after 3 consecutive failures
    ...
    for job_file in job_files:
        ...
        try:
            ...
            logger.info(f"--- Starting v6.3 job: {company} - {title} ---")

            # --- v6.3: Cost Ceiling Check (Spell #6) - ACTIVATED ---
        ...
        # --- v6.3: Circuit Breaker Catch (Spell #5) ---
