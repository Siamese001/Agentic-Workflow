;; File: Resume Gen Agentic Pipeline v8.0.md
  ;; to ensure all agent definitions, scores, and logic checks are accurate.

  +------------------------------------------------------------------------------------------------------------+
  | 🚀 v8.0 PARALLEL BATCH HARNESS (run_batch_v8_0.py)                                                          |
  ...
  |  | | (v8.0 Cost Check)| | (v8.0 Cost Check)| | (v8.0 Cost Check)| | (v8.0 Cost Check)| simultaneously)|    |
  ...
  |  |                                      v                                                        |    |
  |  |   2. (finally) Write all results to `batch_summary_v8_0.csv` (Output 1) 📈                     |    |
  ...
  |  |   (Batch runner *automatically* calls `run_learning_v8_0.py`)                                    |    |
  |  +--------------------------------------------------------------------------------------------------+    |
  |                                                                                                            |
  + - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -+
  | ♾️ v8.0 ASYNCHRONOUS META-LEARNING LOOP (Safer v7.5+ Logic)                                                |
  | (Triggered by `run_batch_v8_0.py` after batch is complete)                                                 |
  |                                                                                                            |
  | 1. `run_learning_v8_0.py` runs:                                                                            |
  |    +---------------------------+ (Reads failures from) -> +-------------------------+                     |
  ...
  +------------------------------------------------------------------------------------------------------------+
  | 🧠 v8.0 LANGGRAPH ORCHESTRATION (Replaces v6.5 Governor)                                                     |
  | (LangGraph executes a 5-step stateful flow with dynamic recovery loops)                                    |
  |                                                                                                            |
  | 1. 🚀 **CrewOrchestrator** (Receives "Neo4j VP" goal)                                                      |
  | 2. **CrewOrchestrator** (Calls) -> 🧠 **v8.0 LangGraph State Flow** |
  |                                                                                                            |
  |  +------------------------------------------------------------------------------------------------+  |
  |  | **v8.0 LangGraph State Flow** |  |
  |  |                                                                                                |  |
  |  |   1. 🧭 **Run Strategy** (Calls `ThemeClassifierAgent`)                                          |  |
  |  |                | (Writes `strategy_brief` to 📋 State)                                        |  |
  |  |                v                                                                               |  |
  |  |   2. 🔍 **Run RAG** (Calls `v8.0 RAG Stack` agents) [Score: 96]                                  |  |
  |  |                | (Writes `rag_critique`, `rag_search_results` to 📋 State)                     |  |
  |  |                v                                                                               |  |
  |  |   3. ✒️ **Run Bullet Stack** (Calls `v8.0 ProvenanceRouterAgent`) [Score: 92] (Corrected)        |  |
  |  |                | (Writes `generated_bullets` to 📋 State)                                      |  |
  |  |                v                                                                               |  |
  |  |   4. ✍️ **Run Drafting** (Calls `v8.0 DraftingConductorAgent`) [Score: 98]                      |  |
  |  |                | (Writes `final_draft` to 📋 State)                                            |  |
  |  |                v                                                                               |  |
  |  |   5. 🛡️ **Run QA** (Calls `v8.0 QAConductorAgent`, `AtomicQASwarmLogic`) [Score: 95]           |  |
  ...
  +------------------------------------------------------------------------------------------------------------+
  | 🧭 v8.0 (v7.0 Arch) STEP 1: STRATEGY (Unchanged)                                                            |
  |                                                                                                            |
  |    +--------------------------------------------------------------------------------------------------+    |
  ...
  +------------------------------------------------------------------------------------------------------------+
  | 🔍 v8.0 STEP 2: RAG STACK (Agentic Upgrade) [Score: 96]                                                      |
  |                                                                                                            |
  ...
  |    |       `--> [ 🔗 **graph_search** ] (v8.0 Graph Tool)                                            |
  |    |       `--> [ ✍️ **write_to_graph** ] (v8.0 Graph Tool)                                          |
  |    |                                                                                                |
  ...
  +------------------------------------------------------------------------------------------------------------+
  | ✒️ v8.0 STEP 3: BULLET STACK (Provenance) [Score: 92] (Corrected) (Replaces v6.5 BulletSwarm)              |
  |                                                                                                            |
  ...
  +------------------------------------------------------------------------------------------------------------+
  | ✍️ v8.0 STEP 4: DRAFTING (MoE Conductor) [Score: 98] (Replaces v6.5 AdversarialRouter)                       |
  |                                                                                                            |
  ...
  |   | * [ 📊 **MetricsSpecialist (Flash)** [75] ] (v8.0: Injects/Fixes metrics)          |   |
  |   +----------------------------------------------------------------------------------+   |
  ...
  +------------------------------------------------------------------------------------------------------------+
  | 🛡️ v8.0 STEP 5: QA STACK (MoE Conductor) [Score: 95] (Code-Corrected)                                       |
  |                                                                                                            |
  |   +---------------------------------------+  +---------------------------------------+   |
  ...
  |   | * 🔎 **MissedOpportunityAgent** [80] (v8.0) |  |                                 |   |
  |   +---------------------------------------+  +---------------------------------------+   |
  |                                                                                                            |
  +------------------------------------------------------------------------------------------------------------+