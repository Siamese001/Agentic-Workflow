# File: run_learning_v8_0.py
# Overwrites: run_learning_v7_5.py
# Version: 8.0 (Agentic Upgrade)
#
# v8.0 (Agentic Upgrade) CHANGES:
# - Imports from core_v8_0.
...
def run_meta_learning():
    """
    Runs the asynchronous meta-learning loop (v8.0).
    """
    try:
    ...
    logger.info(f"===== Starting v8.0 Meta-Learning Loop ({datetime.now().isoformat()}) =====")
    
    if not CONFIG.meta_loop_config.enable_meta_learning:
        logger.info("Meta-learning is disabled in master_config_v8_0.json. Exiting.")
        return
    ...
    if not patterns:
        ...
        logger.info("===== v8.0 Meta-Learning Loop Complete =====")
        return
