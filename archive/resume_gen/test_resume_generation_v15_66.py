"""
Pytest suite for Resume_Generation_v15_66.py HOP-0 MasterResumeIndex integration.

Tests the integration of MasterResumeIndex throughout the RAG pipeline:
1. WebSearchRAG accepts and uses master_resume_index
2. Phase 1 and Phase 3 prompts include candidate context
3. Synthesis weights keywords based on candidate experience
4. Recency scores and achievements influence final prioritization

Run with: pytest test_resume_generation_v15_66.py -v
"""
...
from Resume_Generation_v15_66 import (
