...
reason:
  ...
  * Preserve ordering: LinkedIn QA Grid → RAG Mapping Table → Evidence Pack → Scoring Grid → AI Filter v4 (last).
...
After message body:
  ...
  3) Evidence Pack
  4) Scoring Grid
  5) AI Filter v4 Canonical (13 checks) — must always be last
...
- BLOCK-QA-ORDER-VIOLATION: AI Filter v4 not rendered last.
...
Retain the existing downstream order and keep AI Filter v5 last:

1) LinkedIn QA Grid  
2) Bullet→Company→Resume Mapping Table  
3) Evidence Pack  
4) Scoring Grid  
5) **AI Filter v5 Canonical (13 checks)**
...
- AI Filter v5 remains the final release gate and is unaffected in ordering:contentReference[oaicite:11]{index=11}.
