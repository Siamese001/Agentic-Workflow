...
# Description: Main executable for the LIC agentic workflow.
...
async def main():
    ...
    if not all([sender_profile, recipient_profile, job_description]):
        print("FATAL: mission_input.json is missing one or more required top-level keys: "
...
if __name__ == "__main__":
    # Note: Added necessary imports for asyncio
    import asyncio
    asyncio.run(main())