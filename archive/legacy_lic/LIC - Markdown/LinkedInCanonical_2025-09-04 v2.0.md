...
- BLOCK if not exactly NEW or EXISTING.
...
- Operator pastes exactly as copied. Semantic parse into Name, Title, About, canonical URL.  
...
- NO or invalid → BLOCK (see Section D checks).
...
===============================================================================
END OF LINKEDIN OUTREACH - CANONICAL v2.0
===============================================================================
