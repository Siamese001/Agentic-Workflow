...
from config_RES_v3_8 import AppConfig, DATA_DIR, CONFIG
from utils_RES_v3_8 import text_utils, sanitize_filename
# --- V18 REFACTOR: Import consolidated validator ---
from validator_RES_v3_8 import AppTrackerQAValidator
# --- END V18 REFACTOR ---

if TYPE_CHECKING:
    from workflow_RES_v3_8 import WorkflowOrchestrator
