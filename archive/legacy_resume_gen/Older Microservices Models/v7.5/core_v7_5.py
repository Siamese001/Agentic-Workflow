# File: core_v7_5.py
# Overwrites: core_v7_0.py
# Version: 7.5 (LangGraph + Redis + HIL)
# Zero-Loss Consolidation - The Foundation
# Merges: models_RES.py → config_RES.py → utils_RES.py → prompts_RES.py
# v7.5: Pointing CONFIG_PATH to master_config_v7_5.json
# v7.5: Updated GraphState to include HIL fields (original_draft, human_approved_draft, preference_insight)
#
...
# Load Configuration
CONFIG_PATH = PROJECT_ROOT / "master_config_v7_5.json"
