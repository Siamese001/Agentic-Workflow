...
from agentic_core.config.blueprint_sovereign.structure_blueprint_1 import DASHBOARD_DIR, get_validated_project_root
"""
...
def fix_file(file_path: Path) -> bool:
    ...
    try:
        ...
        has_ssot_import = 'from agentic_core.config.blueprint_sovereign.structure_blueprint_1 import' in content
