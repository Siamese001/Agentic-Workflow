...
from agentic_core.config.blueprint_sovereign.canonical_truth_1 import calculate_health_score
...
def main():
    ...
    for territory in territories:
        ...
        # Get values for health calculation
        ...
        new_health = round(calculate_health_score(
            heal_cap=heal_cap,
            invoc=invoc,
            test_cov=test_cov,
            obs=obs,
