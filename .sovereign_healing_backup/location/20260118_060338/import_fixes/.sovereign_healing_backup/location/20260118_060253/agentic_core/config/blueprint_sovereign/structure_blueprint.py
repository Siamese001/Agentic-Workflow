...
ROOT_PROTECTED_FILES: Any = {'canon_validator_agentic_v2.py', 'canon_validator_agentic_v2_thin.py', 'pyproject.toml', 'README.md', 'langgraph.json', '.env', 'windsurfrules.md', '.gitignore', 'agent_discovery_full.json', 'agent_discovery_full.manifest.json', 'runtime_state.json'}
