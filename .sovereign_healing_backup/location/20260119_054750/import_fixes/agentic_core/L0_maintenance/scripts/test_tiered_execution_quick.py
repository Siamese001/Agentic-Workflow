...
def test_implementation_structure():
    ...
    checks = [
        ...
        ("HierarchyAgent import", "from agentic_core.L5_safety.guardrails.HierarchyAgent import get_hierarchy_agent"),
        ("NamingAgent import", "from agentic_core.utils.core_extensions.NamingAgent import get_naming_agent"),
