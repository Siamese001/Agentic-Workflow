...
sys.path.insert(0, str(project_root / "scripts"))  # For territory_ssot_definitions
from territory_ssot_definitions import get_territory_sort_key

# Import from consolidated SSOT location
from archives.location_violations.ssot_definitions import (
