...
This script reads scripts/config/dashboard_ssot.yaml and generates:
...
YAML_CONFIG = Path(__file__).parent.parent / "config" / "ssot.yaml"  # Local to dashboards
PYTHON_OUTPUT = Path(__file__).parent.parent / "core" / "ssot_definitions.py"  # Local to dashboards
JS_OUTPUT = Path(__file__).parent.parent / "js" / "constants" / "dashboard-constants.js"  # Local to dashboards
