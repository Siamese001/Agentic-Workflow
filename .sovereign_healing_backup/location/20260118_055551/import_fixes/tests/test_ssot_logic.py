...
class TestLayerInference:
    ...
    def test_utils_detection(self):
        ...
        paths = [
            "agentic_core/utils/core_extensions/helper.py",
            "utils/general_helpers/tool.py"
        ]
        for path in paths:
...
class TestSSOTEnforcement:
    ...
    def test_no_hardcoded_health_weights_in_dashboard(self):
        ...
        if dashboard_path.exists():
            ...
            assert "from agentic_core.L5_safety.validators.canonical_truth import calculate_health_score" in content, \
