...
def validate_file(file_path: Path) -> List[Tuple[int, str, str]]:
    ...
    try:
        ...
        if 'from agentic_core.L5_safety.validators.structure_blueprint_2 import' in content:
...
def validate_repository() -> Tuple[bool, Dict]:
    ...
    if total_violations == 0:
        ...
        print("  from agentic_core.L5_safety.validators.structure_blueprint_2 import (")
