...
SSOT_IMPORT = """from agentic_core.L5_safety.validators.structure_blueprint_2 import (
...
def has_ssot_import(content: str) -> bool:
    ...
    return 'from agentic_core.L5_safety.validators.structure_blueprint_2 import' in content
