...
def validate_file(file_path: Path) -> List[Tuple[int, str, str]]:
    ...
    try:
        ...
        if 'from agentic_core.config.blueprint_sovereign.structure_blueprint import' in content:
...
def validate_repository() -> Tuple[bool, Dict]:
    ...
    if total_violations == 0:
        ...
        print("  from agentic_core.config.blueprint_sovereign.structure_blueprint import (")
