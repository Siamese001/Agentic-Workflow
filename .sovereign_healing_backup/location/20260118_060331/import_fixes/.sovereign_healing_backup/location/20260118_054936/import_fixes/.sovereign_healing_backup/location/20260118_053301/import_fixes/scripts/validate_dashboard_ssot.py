...
def check_file_for_hardcoded_paths(file_path: Path) -> List[Tuple[int, str]]:
    ...
    try:
        ...
        for line_num, line in enumerate(lines, 1):
            ...
            if 'from agentic_core.config.blueprint_sovereign.structure_blueprint_1 import' in line:
                continue
...
def validate_dashboard_ssot() -> Tuple[bool, List[str]]:
    ...
    if total_violations == 0:
        ...
        print("  from agentic_core.config.blueprint_sovereign.structure_blueprint_1 import DASHBOARD_DIR")
