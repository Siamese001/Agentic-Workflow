...
# ---------------------------------------------------------
REPO_ROOT = r"C:\Users\amita\Documents\Work\AI Job Search\AI\ML\L\GenAI\LLM 101\LLM Pipelines\Resume Gen\Git\Agentic_Workflow-10_11"
...
def get_destination_mapping(src_path, filename):
    ...
    # Resume app files
    if "resume_app" in path_lower:
        if "adapters" in path_lower:
    ...
    if "services" in path_lower:
        if "cache" in path_lower or "telemetry" in path_lower or "rate_limiting" in path_lower:
            return "apps/shared/adapters"
...
if __name__ == "__main__":
    ...
    print("  - Zero-tolerance compliance maintained ✓")
