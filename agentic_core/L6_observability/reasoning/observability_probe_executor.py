...
class ObservabilityProbeExecutorAgent(SovereignBaseAgent):
    ...
    def _get_handler(self):
        handlers = {'cost_tracker': self._probe_cost, 'coordinator': self._probe_coordination, 'strategic': self._probe_strategic, 'deadlock': self._probe_deadlock, 'debate': self._probe_debate, 'runtime_telemetry': self._probe_telemetry}
