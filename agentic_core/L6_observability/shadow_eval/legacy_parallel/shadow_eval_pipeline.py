...
if TYPE_CHECKING:
    ...
    from agentic_core.L6_observability.shadow_eval.legacy_parallel.promotion_packet import PromotionPacket
...
from agentic_core.L6_observability.shadow_eval.legacy_parallel.promotion_stager import (
    PromotionCandidate,
    PromotionStager,
)
from agentic_core.L6_observability.shadow_eval.legacy_parallel.rca_aggregator import (
    RcaAggregator,
    RcaCluster,
)
from agentic_core.L6_observability.shadow_eval.legacy_parallel.shadow_eval_grader import (
    ShadowEvalGrader,
    ShadowEvalResult,
    ShadowGradeBundle,
    ShadowPacketGrader,
...
class L6ShadowEvalPipeline:
    ...
    def approve_and_handoff(
        ...
        *,
        ...
        """
        from ops_scripts.reports.governed_handoff import (  # noqa: PLC0415
            GovernedHandoffAgent,
            HandoffRecord,
        )
        from agentic_core.L6_observability.shadow_eval.legacy_parallel.promotion_packet import (  # noqa: PLC0415
            ApprovalState,
