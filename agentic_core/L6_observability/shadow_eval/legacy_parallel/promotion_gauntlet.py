"""Legacy B-surface gauntlet (utils/evaluation) — compat only.

Canonical passive 06.7 owner: ``agentic_core.L6_observability.shadow_eval.gauntlet``.
New code MUST import shadow_eval gauntlet types; this module remains for
``promotion_packet`` / benchmark callers until M3 merge (ADR-086).
"""
