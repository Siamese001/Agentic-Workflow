...
_emit_emits_metric_event("dashboard_aggregate", "p4obs", "metric_1")
_emit_emits_metric_event("dashboard_aggregate", "p4obs", "metric_2")
_emit_emits_metric_event("dashboard_aggregate", "p4obs", "metric_3")
_emit_emits_metric_event("dashboard_aggregate", "p4obs", "metric_4")
_emit_emits_metric_event("dashboard_aggregate", "p4obs", "metric_5")
_emit_emits_metric_event("dashboard_aggregate", "p4obs", "metric_6")
_emit_records_incident_event("dashboard_aggregate", "p4obs", "incident")
_emit_captures_runtime_anomaly("dashboard_aggregate", "p4obs", "anomaly")
_emit_writes_observability_log("dashboard_aggregate", "p4obs", "obs_log")
_emit_updates_monitoring_state("dashboard_aggregate", "p4obs", "mon_state")
_emit_triggers_alert("dashboard_aggregate", "p4obs", "alert")
_emit_links_incident_trace("dashboard_aggregate", "p4obs", "trace_link")
_emit_captures_pattern("dashboard_aggregate", "p3lm", "pattern")
_emit_records_learning_event("dashboard_aggregate", "p3lm", "learning_event")
_emit_writes_learning_snapshot("dashboard_aggregate", "p3lm", "snapshot")
_emit_feeds_meta_learning("dashboard_aggregate", "p3lm", "meta_feed")
_emit_updates_routing_strategy("dashboard_aggregate", "p3lm", "routing")
_emit_improves_agent_policy("dashboard_aggregate", "p3lm", "policy")
_emit_stores_learning_state("dashboard_aggregate", "p3lm", "state")
_emit_records_execution_trace("dashboard_aggregate", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("dashboard_aggregate", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("dashboard_aggregate", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("dashboard_aggregate", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("dashboard_aggregate", "L4_STATE", "p2_trace_5")
_emit_reads_environ("dashboard_aggregate", "env_read", "p2_env_1")
_emit_reads_environ("dashboard_aggregate", "env_read", "p2_env_2")
_emit_reads_runtime_state("dashboard_aggregate", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("dashboard_aggregate", "runtime_state", "p2_rt_2")

emit_replay_key("p0", "dashboard_aggregate")
emit_determinism_digest("p0", "dashboard_aggregate")

_emit_dispatches_healing_run("p1", "dashboard_aggregate", "L6")
_emit_routes_through("p1", "dashboard_aggregate", "L6")
_emit_checks_agent_registry("p1", "dashboard_aggregate", "agent_registry")
_emit_validates_agent_capability("p1", "dashboard_aggregate", "capability")
_emit_dispatches_execution_plan("p1", "dashboard_aggregate", "exec_plan")
_emit_agent_executes_agent("p1", "dashboard_aggregate", "sub_agent")
_emit_routes_to_agent("p1", "dashboard_aggregate", "target_agent")
_emit_verifies_policy("p1", "dashboard_aggregate", "policy_check")
_emit_observes_runtime_state("p1", "dashboard_aggregate", "runtime_state")
_emit_verifies_boundary("p1", "dashboard_aggregate", "boundary_check")
_emit_transcripts_response("p1", "dashboard_aggregate", "transcript")
_emit_hard_fails_untranscripted("p1", "dashboard_aggregate")
_emit_gated_by_confidence("p1", "dashboard_aggregate", "confidence_gate")
_emit_escalates_to_human("p1", "dashboard_aggregate", "L6")
_emit_reads_policy_state("p1", "dashboard_aggregate", "L6")
_emit_pulls_context("p1", "dashboard_aggregate", "context_pull")
_emit_pulls_context("p1", "dashboard_aggregate", "context_pull_secondary")
_emit_execution_terminates_at_uwg("p1", "dashboard_aggregate", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "dashboard_aggregate", "uwg_term_secondary")
_emit_writes_through("p1", "dashboard_aggregate", "write_through")
_emit_writes_through("p1", "dashboard_aggregate", "write_through_secondary")
_emit_validated_by_safety_plane("p1", "dashboard_aggregate", "safety_validation")
_emit_invokes_eval("p1", "dashboard_aggregate", "eval_call")
_emit_proposal_commits_routing("p1", "dashboard_aggregate", "routing_commit")

_emit_signs_execution_trace("p0", "p0hash", "p0_trace", 0)
_emit_applies_guardrail("p0", "dashboard_aggregate", "p0_governance")
_emit_authorize_and_execute("p2", "dashboard_aggregate", "execution_auth")
_emit_validates_capability("p2", "dashboard_aggregate", "capability_check")
_emit_routes_to_capability("p2", "dashboard_aggregate", "capability_route")
_emit_writes_via_uwg("p2", "dashboard_aggregate", "uwg_write")
_emit_blocks_direct_write("p2", "dashboard_aggregate", "direct_write_block")
_emit_records_tool_invocation("p2", "dashboard_aggregate", "tool_invocation")
_emit_captures_execution_output("p2", "dashboard_aggregate", "exec_output")
_emit_dispatches_agent("p3", "dashboard_aggregate", "agent_dispatch")
_emit_coordinates_agents("p3", "dashboard_aggregate", "agent_coordination")
_emit_records_workflow_lineage("p3", "dashboard_aggregate", "workflow_lineage")
_emit_records_healing_outcome("p3", "dashboard_aggregate", "healing_outcome")
_emit_escalates_failure("p3", "dashboard_aggregate", "failure_escalation")
_emit_orchestrates_workflow("p3", "dashboard_aggregate", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "dashboard_aggregate", "healing_dispatch")
_emit_invokes_evaluation("p3", "dashboard_aggregate", "evaluation_signal")
_emit_records_telemetry_event("p4", "dashboard_aggregate", "telemetry_event")
_emit_captures_evaluation_metric("p4", "dashboard_aggregate", "eval_metric")
_emit_stores_embedding("p4", "dashboard_aggregate", "embedding_store")
_emit_updates_meta_learning_state("p4", "dashboard_aggregate", "meta_learning")
_emit_links_execution_to_snapshot("p4", "dashboard_aggregate", "exec_snapshot_link")
