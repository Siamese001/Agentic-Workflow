...
emit_determinism_digest("p0", "reasoning_streamer")

_emit_dispatches_healing_run("p1", "reasoning_streamer", "L6")
_emit_routes_through("p1", "reasoning_streamer", "L6")
_emit_checks_agent_registry("p1", "reasoning_streamer", "agent_registry")
_emit_validates_agent_capability("p1", "reasoning_streamer", "capability")
_emit_dispatches_execution_plan("p1", "reasoning_streamer", "exec_plan")
_emit_agent_executes_agent("p1", "reasoning_streamer", "sub_agent")
_emit_routes_to_agent("p1", "reasoning_streamer", "target_agent")
_emit_verifies_policy("p1", "reasoning_streamer", "policy_check")
_emit_observes_runtime_state("p1", "reasoning_streamer", "runtime_state")
_emit_verifies_boundary("p1", "reasoning_streamer", "boundary_check")
_emit_transcripts_response("p1", "reasoning_streamer", "transcript")
_emit_hard_fails_untranscripted("p1", "reasoning_streamer")
_emit_gated_by_confidence("p1", "reasoning_streamer", "confidence_gate")
...
_emit_emits_metric_event("reasoning_streamer", "p4obs", "metric_3")
_emit_emits_metric_event("reasoning_streamer", "p4obs", "metric_4")
_emit_emits_metric_event("reasoning_streamer", "p4obs", "metric_5")
_emit_emits_metric_event("reasoning_streamer", "p4obs", "metric_6")
_emit_records_incident_event("reasoning_streamer", "p4obs", "incident")
_emit_captures_runtime_anomaly("reasoning_streamer", "p4obs", "anomaly")
_emit_writes_observability_log("reasoning_streamer", "p4obs", "obs_log")
_emit_updates_monitoring_state("reasoning_streamer", "p4obs", "mon_state")
_emit_triggers_alert("reasoning_streamer", "p4obs", "alert")
_emit_links_incident_trace("reasoning_streamer", "p4obs", "trace_link")
_emit_captures_pattern("reasoning_streamer", "p3lm", "pattern")
_emit_records_learning_event("reasoning_streamer", "p3lm", "learning_event")
_emit_writes_learning_snapshot("reasoning_streamer", "p3lm", "snapshot")
_emit_feeds_meta_learning("reasoning_streamer", "p3lm", "meta_feed")
_emit_updates_routing_strategy("reasoning_streamer", "p3lm", "routing")
_emit_improves_agent_policy("reasoning_streamer", "p3lm", "policy")
_emit_stores_learning_state("reasoning_streamer", "p3lm", "state")
_emit_records_execution_trace("reasoning_streamer", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("reasoning_streamer", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("reasoning_streamer", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("reasoning_streamer", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("reasoning_streamer", "L4_STATE", "p2_trace_5")
_emit_reads_environ("reasoning_streamer", "env_read", "p2_env_1")
_emit_reads_environ("reasoning_streamer", "env_read", "p2_env_2")
_emit_reads_runtime_state("reasoning_streamer", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("reasoning_streamer", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "reasoning_streamer", "context_pull")
_emit_pulls_context("p1", "reasoning_streamer", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "reasoning_streamer", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "reasoning_streamer", "uwg_term_2")
_emit_writes_through("p1", "reasoning_streamer", "write_through")
_emit_writes_through("p1", "reasoning_streamer", "write_through_2")
_emit_validated_by_safety_plane("p1", "reasoning_streamer", "safety_validation")
_emit_invokes_eval("p1", "reasoning_streamer", "eval_call")
_emit_proposal_commits_routing("p1", "reasoning_streamer", "routing_commit")
