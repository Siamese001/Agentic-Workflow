...
class SovereignReport:
    ...
    class Builder:
        ...
        """
        KNOWN_DIMENSIONS = ['Structural SSOT', 'schema SSOT', 'Prompt SSOT', 'Config SSOT', 'DDD Alignment', 'Atomic Fission', 'Zero-Trust Membrane', 'observability Footprint', 'Healing Resilience']
    ...
    def get_all_issues(self) -> list[dict]:
        ...
        for dimension, raw_issues in self.issues.items():
            for raw in raw_issues:
                ...
                all_issues.append({'dimension': dimension, 'description': message, 'file': file_path, 'line': line_num})
        return all_issues
