# Document Loader: CSV Ingestion
# Territory: agentic_core/knowledge/document_loaders
# Canon Key 9 - Structured tabular data loading
# Requires: pip install pandas (sovereign dependency)
...
class CSVDocumentLoader:
    ...
    def load_sample(file_path: Path, rows: int = 10, **kwargs) -> List[Dict[str, Any]]:
        ...
        try:
            df = pd.read_csv(file_path, nrows=rows, **kwargs)
