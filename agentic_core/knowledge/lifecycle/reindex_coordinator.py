    ...
    def _notify_complete(self, job: ReindexJob) -> None:
        ...
        for callback in self._on_complete_callbacks:
            try:
                ...
                TypeError,
                ValueError,
            ) as e:  # guardian: allow-log-and-swallow -- complete callback isolation: non-fatal, other callbacks continue
    ...
    def _notify_progress(self, job_id: str, progress: float) -> None:
        ...
        for callback in self._on_progress_callbacks:
            try:
                ...
                TypeError,
                ValueError,
            ) as e:  # guardian: allow-log-and-swallow -- progress callback isolation: non-fatal, other callbacks continue
