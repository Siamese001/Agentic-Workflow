...
class CostGovernor:
    ...
    def __init__(
        self, budget_limit: float = 5.0, warning_threshold: float = 0.8, session_id: str = None
    ):
    ...
    def track_usage(
        ...
        with self._lock:
            ...
            ConfigurationService().input_tokens / 1000 * ConfigurationService().model_pricing[
                "input"
            ]
            ConfigurationService().output_tokens / 1000 * ConfigurationService().model_pricing[
                "output"
            ]
