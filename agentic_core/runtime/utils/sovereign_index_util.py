                ...
                for entry in entries:
                    try:
                        if entry.is_dir(follow_symlinks=False):
                            ...
                            self._all_files.append(Path(entry.path))    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling
                    except (PermissionError, OSError):
                        continue    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling    # guardian: Multiple exceptions (PermissionError, OSError) need specific handling
