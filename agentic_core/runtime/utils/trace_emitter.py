    ...
    def decorator(fn: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                return result
            except (ValueError, TypeError, RuntimeError):  # guardian: allow-double-logging -- trace-emit failure is non-fatal; debug log with elapsed timing is the trace itself
                elapsed_ms = (time.monotonic() - start) * 1000.0
                logger.debug(
