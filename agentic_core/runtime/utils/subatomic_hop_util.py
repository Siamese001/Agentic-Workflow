...
# models migrated to SSOT: agentic_core/runtime/types/core_contracts_types.py
...
class SubatomicHop:
    ...
    # _check_past_failures moved to canonical utility in state_utils.py
    async def _check_past_failures(self, Task: str, _fn=None) -> str:
