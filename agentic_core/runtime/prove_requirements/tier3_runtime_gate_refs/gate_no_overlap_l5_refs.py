"""Tier 3 Runtime Gates static reference module — NO_OVERLAP_WITH_L5.

Static gate contract for Step 1 row ``REQ-GATE-NO-OVERLAP-WITH-L5-001``.
...
STEP1_REQ_ID: str = "REQ-GATE-NO-OVERLAP-WITH-L5-001"
EXPECTED_FAIL_REASON: str = "GATE_L5_OVERLAP_BLOCKED"
GATE_FAMILY: str = "NO_OVERLAP_WITH_L5"
GATE_RANGE: str = "NO_OVERLAP_WITH_L5"
GATE_IDS: Tuple[str, ...] = ('RUNTIME_LIVE_GATE_VERDICT', 'L5_GOVERNANCE_CERTIFICATION')
SPAN_NAMES: Tuple[str, ...] = ('gate.no_overlap.l5.runtime_verdict', 'gate.no_overlap.l5.governance_certification')
NEGATIVE_CONTROL_NAME: str = "negative_control_l5_overlap_blocked"
REQUIRED_ARTIFACT_FIELDS: Tuple[str, ...] = ('runtime_gate_owns_live_gate_verdict', 'l5_owns_governance_certification', 'overlap_detected')

SCENARIO_KEY: str = "AD_gate_no_overlap_l5"
