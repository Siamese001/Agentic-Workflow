...
SOVEREIGN_REGISTRY: Any = {'agentic_core': {'depth': 3, 'subfolders': ['L0_maintenance', 'L1_cognition', 'L2_execution', 'L3_orchestration', 'L4_state', 'L5_safety', 'config', 'schemas', 'prompt_governance', 'runtime', 'observability', 'utils', 'patterns', 'semantic_memory', 'knowledge', 'bases']}, 'apps_rg': {'depth': 2, 'subfolders': ['logic_nodes', 'asset_library', 'system_flow', 'engines', 'templates', 'domain']}, 'apps_lic': {'depth': 2, 'subfolders': ['logic_nodes', 'asset_library', 'system_flow', 'engines', 'templates', 'domain', 'core']}, 'apps_shared': {'depth': 2, 'subfolders': ['base_definitions', 'common_utils', 'core_components', 'base_agents', 'models', 'utils', 'P1_core', 'config']}, 'tests': {'depth': 2, 'subfolders': ['unit', 'integration', 'e2e', 'functional', 'fixtures', 'automation', 'core', 'data', 'performance', 'security', 'autogen', 'regression']}}
CORE_SUBFOLDER_MAP: Any = {'L0_maintenance': ['scripts', 'logs', 'benchmarks'], 'L1_cognition': ['thought_engine', 'intent_analysis', 'planning', 'learning'], 'L2_execution': ['ToolRegistry', 'action_handlers', 'mcp', 'tool_registry'], 'L3_orchestration': ['workflow_engines', 'fission_logic', 'S3_vitality', 'mcp', 'meta_learning'], 'L4_state': ['ValidationContext', 'ledger', 'filesystem', 'memory', 'validation_context'], 'L5_safety': ['guardrails', 'red_teaming', 'gravity', 'validators', 'agents', 'bases', 'policies', 'utils', 'verifiability', 'utilities'], 'schemas': ['models', 'messages', 'types', 'validators'], 'config': ['blueprint_sovereign', 'environments', 'feature_flags', 'secrets_manager', 'validators'], 'prompt_governance': ['meta_prompts', 'version_registry', 'rendering', 'templates'], 'runtime': ['shared_runtime', 'environment_setup', 'shared', 'resource_management'], 'observability': ['metrics', 'telemetry', 'tracing', 'compliance', 'dashboard', 'alerting'], 'utils': ['core_extensions', 'wrappers', 'general_helpers', 'naming'], 'patterns': ['agent_roles', 'communication_flow', 'interaction_patterns', 'reasoning_patterns'], 'semantic_memory': ['store', 'embeddings', 'retrieval', 'index'], 'knowledge': ['document_loaders', 'static_index', 'ResearchCache'], 'bases': []}
...
MCP_CAPABILITIES: Any = {'router': {'enabled': True, 'path': 'agentic_core.L3_orchestration.mcp'}, 'marketplace_filter': {'enabled': True, 'path': 'agentic_core.L3_orchestration.mcp'}, 'filesystem': {'enabled': True, 'path': 'agentic_core.L4_state.filesystem'}, 'figma': {'enabled': True, 'path': 'agentic_core.L2_execution.mcp'}, 'fetch': {'enabled': True, 'path': 'agentic_core.L2_execution.mcp'}, 'SemanticCache': {'enabled': True, 'path': 'agentic_core.L2_execution.mcp'}}
