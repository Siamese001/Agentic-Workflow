...
CANON_KEY_EXCEPTIONS: Dict[int, Dict[str, Any]] = {23: {'files': {'AgenticCore/L2_execution/mcp/fetch_client_sovereign.py'}, 'patterns': ['if TYPE_CHECKING:', '\\"\\"\\".*requests.*\\"\\"\\"']}, 20: {'files': {'canon_validator_agentic_v2.py', 'pyproject.toml'}, 'patterns': []}}
ACTIVE_CANON_KEYS: Any = list(range(0, 20))
CANON_KEY_TO_FOLDER_MAP: Dict[int, List[str]] = {0: ['.'], 1: ['AgenticCore/prompt_governance'], 2: ['AgenticCore/schemas'], 3: ['AgenticCore/L1_cognition'], 4: ['AgenticCore/L3_orchestration'], 5: ['AgenticCore/L4_state'], 6: ['AgenticCore/L5_safety'], 7: ['AgenticCore/L0_maintenance'], 8: ['AgenticCore/L2_execution', 'AgenticCore/patterns', 'AgenticCore/semantic_memory', 'AgenticCore/knowledge'], 9: ['AgenticCore/config', 'AgenticCore/runtime'], 10: ['AgenticCore/utils', 'AgenticCore/observability'], 11: ['apps_shared', 'apps_rg', 'apps_lic'], 12: ['tests'], 13: ['*'], 14: ['*'], 15: ['*'], 16: ['*'], 17: ['*'], 18: ['*'], 19: ['*']}
SOVEREIGN_REGISTRY: Any = {'AgenticCore': {'depth': 3, 'subfolders': ['L0_maintenance', 'L1_cognition', 'L2_execution', 'L3_orchestration', 'L4_state', 'L5_safety', 'config', 'schemas', 'prompt_governance', 'runtime', 'observability', 'utils', 'patterns', 'semantic_memory', 'knowledge']}, 'apps_rg': {'depth': 2, 'subfolders': ['logic_nodes', 'asset_library', 'system_flow', 'engines', 'templates']}, 'apps_lic': {'depth': 2, 'subfolders': ['logic_nodes', 'asset_library', 'system_flow', 'engines', 'templates']}, 'apps_shared': {'depth': 2, 'subfolders': ['base_definitions', 'common_utils', 'core_components', 'base_agents', 'models', 'utils']}, 'tests': {'depth': 2, 'subfolders': ['unit', 'integration', 'e2e', 'functional', 'fixtures', 'automation', 'core', 'data', 'performance', 'security']}}
...
NAMING_CONVENTIONS: Dict[str, Dict[str, Any]] = {
    ...
    "script": {
        ...
        "examples": ["sovereign_ingestion.py", "CanonValidator.py", "healing_strategies.py"],
...
MCP_CAPABILITIES: Any = {'router': {'enabled': True, 'path': 'AgenticCore.L3_orchestration.mcp'}, 'marketplace_filter': {'enabled': True, 'path': 'AgenticCore.L3_orchestration.mcp'}, 'filesystem': {'enabled': True, 'path': 'AgenticCore.L4_state.filesystem'}, 'figma': {'enabled': True, 'path': 'AgenticCore.L2_execution.mcp'}, 'fetch': {'enabled': True, 'path': 'AgenticCore.L2_execution.mcp'}, 'SemanticCache': {'enabled': True, 'path': 'AgenticCore.L2_execution.mcp'}}
...
GRAVITY_CONFIG: Any = {'enabled': True, 'UPSTREAM_SOVEREIGN_ROOTS': ['AgenticCore'], 'downstream_domains': ['apps_rg', 'apps_lic', 'apps_shared', 'tests'], 'exemptions': []}
...
AST_PLACEMENT_SIGNALS: Dict[str, Dict[str, Any]] = {
    ...
    "AgenticCore/L1_cognition/thought_engine": {
    ...
    "AgenticCore/L1_cognition/intent_analysis": {
    ...
    "AgenticCore/L1_cognition/planning": {
    ...
    "AgenticCore/L2_execution/action_handlers": {
    ...
    "AgenticCore/L3_orchestration/workflow_engines": {
    ...
    "AgenticCore/L3_orchestration/fission_logic": {
    ...
    "AgenticCore/L3_orchestration/meta_learning": {
    ...
    # L4_state placements
    "AgenticCore/L4_state/ValidationContext": {
    ...
    # Utils placements
    "AgenticCore/utils/core_extensions": {
    ...
    "AgenticCore/observability/metrics": {
    ...
    "AgenticCore/observability/tracing": {
    ...
    "AgenticCore/observability/compliance": {
    ...
    "AgenticCore/prompt_governance/templates": {
...
AGENT_REGISTRY: Any = {"L0": [{"name": "BootstrapAgent", "file": "AgenticCore/L0_maintenance/scripts/BootstrapAgent.py", "methods": 6, "fingerprint": "fcfd5e27416abb4c"}], "L1": [{"name": "CanonBaseAgent", "file": "AgenticCore/L1_cognition/thought_engine/CognitionCanonBaseAgent.py", "methods": 8, "fingerprint": "ea8e7e56381918dc"}, {"name": "DependencySentinelAgent", "file": "AgenticCore/L1_cognition/thought_engine/DependencySentinelAgent.py", "methods": 9, "fingerprint": "3773a3e6e7e65f7d"}, {"name": "GovernanceAgent", "file": "AgenticCore/L1_cognition/thought_engine/GovernanceAgent.py", "methods": 12, "fingerprint": "3bab1afa3cbc06ee"}, {"name": "MetaLearningAgent", "file": "AgenticCore/L1_cognition/thought_engine/MetaLearningAgent.py", "methods": 6, "fingerprint": "da27f331da4c5e37"}, {"name": "ReflectionAgent", "file": "AgenticCore/L1_cognition/thought_engine/ReflectionAgent.py", "methods": 9, "fingerprint": "c58961965bf91d5c"}], "L2": [{"name": "CanonBaseAgent", "file": "AgenticCore/L2_execution/ToolRegistry/ExecutionCanonBaseAgent.py", "methods": 13, "fingerprint": "00b4b4376214468b"}, {"name": "CodeDeduplicationAgent", "file": "AgenticCore/L2_execution/ToolRegistry/CodeDeduplicationAgent.py", "methods": 11, "fingerprint": "1c26bf7b92ef3fb8"}, {"name": "CodeJanitorAgent", "file": "AgenticCore/L2_execution/ToolRegistry/CodeJanitorAgent.py", "methods": 12, "fingerprint": "ae825674e1abeb55"}, {"name": "ContextCuratorAgent", "file": "AgenticCore/L2_execution/ToolRegistry/ContextCuratorAgent.py", "methods": 13, "fingerprint": "b55bbeb3cc150054"}, {"name": "DependencyDiplomatAgent", "file": "AgenticCore/L2_execution/ToolRegistry/DependencyDiplomatAgent.py", "methods": 11, "fingerprint": "15bc567d77279e31"}, {"name": "DynamicModelRouterAgent", "file": "AgenticCore/L2_execution/ToolRegistry/DynamicModelRouterAgent.py", "methods": 11, "fingerprint": "e6532e4040366631"}, {"name": "GitAgent", "file": "AgenticCore/L2_execution/ToolRegistry/GitAgent.py", "methods": 12, "fingerprint": "82c9b049e6fd5597"}, {"name": "IntegrityGateExecutorAgent", "file": "AgenticCore/L2_execution/ToolRegistry/IntegrityGateExecutorAgent.py", "methods": 8, "fingerprint": "cc6465bde4266c9f"}, {"name": "MemoryArchitectAgent", "file": "AgenticCore/L2_execution/ToolRegistry/MemoryArchitectAgent.py", "methods": 13, "fingerprint": "b07bc5ecfbb20791"}, {"name": "SovereignActionPlaneAgent", "file": "AgenticCore/L2_execution/ToolRegistry/SovereignActionPlaneAgent.py", "methods": 11, "fingerprint": "91faa15364d0a1a5"}, {"name": "StructuralEngineerAgent", "file": "AgenticCore/L2_execution/ToolRegistry/StructuralEngineerAgent.py", "methods": 8, "fingerprint": "37d55e1531ee303e"}, {"name": "SystemArchitectAgent", "file": "AgenticCore/L2_execution/ToolRegistry/SystemArchitectAgent.py", "methods": 8, "fingerprint": "e340d23c73eb4451"}, {"name": "ToolsmithAgent", "file": "AgenticCore/L2_execution/ToolRegistry/ToolsmithAgent.py", "methods": 17, "fingerprint": "920d8dc7ea2d38d4"}], "L3": [{"name": "DagEngineAgent", "file": "AgenticCore/L3_orchestration/workflow_engines/DagEngineAgent.py", "methods": 14, "fingerprint": "e58f4699d9aa84e5"}, {"name": "MockAgent", "file": "AgenticCore/L3_orchestration/workflow_engines/NervousSystemAgent.py", "methods": 2, "fingerprint": "b644392cf05e5442"}, {"name": "NervousSystemAgent", "file": "AgenticCore/L3_orchestration/workflow_engines/NervousSystemAgent.py", "methods": 12, "fingerprint": "c3a187f4f4fd9eeb"}, {"name": "SemanticGatekeeperAgent", "file": "AgenticCore/L3_orchestration/workflow_engines/SemanticGatekeeperAgent.py", "methods": 6, "fingerprint": "40da7e8727c03cdc"}, {"name": "SubatomicHopAgent", "file": "AgenticCore/L3_orchestration/workflow_engines/SubatomicHopAgent.py", "methods": 14, "fingerprint": "7c2a442208c79cd7"}, {"name": "TestPilotAgent", "file": "AgenticCore/L3_orchestration/workflow_engines/TestPilotAgent.py", "methods": 15, "fingerprint": "5948ee871695c65f"}], "L4": [{"name": "AutonomousCheckpointManagerAgent", "file": "AgenticCore/L4_state/ValidationContext/AutonomousCheckpointManagerAgent.py", "methods": 13, "fingerprint": "41e505612b995ed9"}, {"name": "AutonomousStateGuardianAgent", "file": "AgenticCore/L4_state/ValidationContext/AutonomousStateGuardianAgent.py", "methods": 10, "fingerprint": "5ebb94cbbdf1aa58"}, {"name": "PineconeSovereignAgent", "file": "AgenticCore/L4_state/ValidationContext/PineconeSovereignAgent.py", "methods": 12, "fingerprint": "4dd0d1e4b0e3e220"}, {"name": "RedisSovereignAgent", "file": "AgenticCore/L4_state/ValidationContext/RedisSovereignAgent.py", "methods": 6, "fingerprint": "b040e351f725cddb"}, {"name": "SchemaEvolverAgent", "file": "AgenticCore/L4_state/ValidationContext/SchemaEvolverAgent.py", "methods": 14, "fingerprint": "895c1f48e33df32e"}, {"name": "SovereignPineconeStoreAgent", "file": "AgenticCore/L4_state/ValidationContext/SovereignPineconeStoreAgent.py", "methods": 10, "fingerprint": "f441583d3a2a4cd2"}, {"name": "SubAtomicRegistryAgent", "file": "AgenticCore/L4_state/ValidationContext/SubAtomicRegistryAgent.py", "methods": 7, "fingerprint": "78801bbc67f74db4"}], "L5": [{"name": "AdversarialRedTeamerAgent", "file": "AgenticCore/L5_safety/guardrails/AdversarialRedTeamerAgent.py", "methods": 24, "fingerprint": "f7b28e4a681e38f8"}, {"name": "AutonomousThreatEvolutionAgent", "file": "AgenticCore/L5_safety/guardrails/AutonomousThreatEvolutionAgent.py", "methods": 11, "fingerprint": "c181817ddf232911"}, {"name": "DocstringComplianceAgent", "file": "AgenticCore/L5_safety/validators/DocstringComplianceAgent.py", "methods": 3, "fingerprint": "667c2361a762cd69"}, {"name": "FilenameUniquenessGuardianAgent", "file": "AgenticCore/L5_safety/validators/FilenameUniquenessGuardianAgent.py", "methods": 5, "fingerprint": "823711cf0f58b0ff"}, {"name": "FilesystemAgent", "file": "AgenticCore/L5_safety/validators/FilesystemAgent.py", "methods": 6, "fingerprint": "404bc60482eb1646"}, {"name": "GravityLeakRepairAgent", "file": "AgenticCore/L5_safety/gravity/GravityLeakRepairAgent.py", "methods": 3, "fingerprint": "51dbad0a31ea9c72"}, {"name": "HallucinationHunterAgent", "file": "AgenticCore/L5_safety/guardrails/HallucinationHunterAgent.py", "methods": 9, "fingerprint": "88a8355c3b923aa1"}, {"name": "HealerAgent", "file": "AgenticCore/L5_safety/guardrails/HealerAgent.py", "methods": 14, "fingerprint": "f7be54e968a04313"}, {"name": "HierarchyAgent", "file": "AgenticCore/L5_safety/validators/HierarchyAgent.py", "methods": 14, "fingerprint": "c4ba74a74c6e27d2"}, {"name": "HygieneGuardianAgent", "file": "AgenticCore/L5_safety/validators/HygieneGuardianAgent.py", "methods": 4, "fingerprint": "3aa2327dde094b31"}, {"name": "ImportAgent", "file": "AgenticCore/L5_safety/gravity/ImportAgent.py", "methods": 7, "fingerprint": "f1dad62889a51085"}, {"name": "InferenceTypeHintAgent", "file": "AgenticCore/L5_safety/validators/InferenceTypeHintAgent.py", "methods": 3, "fingerprint": "0fd4fbfb4402be61"}, {"name": "L5IntegrityGateExecutorAgent", "file": "AgenticCore/L5_safety/guardrails/L5IntegrityGateExecutorAgent.py", "methods": 17, "fingerprint": "790a1b648be58757"}, {"name": "LocationAgent", "file": "AgenticCore/L5_safety/validators/LocationAgent.py", "methods": 9, "fingerprint": "5e49cfc8aebe839e"}, {"name": "NeuralAutoImmuneAgent", "file": "AgenticCore/L5_safety/guardrails/NeuralAutoImmuneAgent.py", "methods": 3, "fingerprint": "78dc1bb327996dcf"}, {"name": "RedTeamAgent", "file": "AgenticCore/L5_safety/red_teaming/RedTeamAgent.py", "methods": 3, "fingerprint": "d76f6932c53b7a77"}, {"name": "RegressionOracleAgent", "file": "AgenticCore/L5_safety/validators/RegressionOracleAgent.py", "methods": 4, "fingerprint": "65c42eea1de011b7"}, {"name": "SSOTRefactorAgent", "file": "AgenticCore/L5_safety/validators/SSOTRefactorAgent.py", "methods": 4, "fingerprint": "29f31ace7a8982fb"}, {"name": "SelfUpdatingSafetyEngineAgent", "file": "AgenticCore/L5_safety/guardrails/SelfUpdatingSafetyEngineAgent.py", "methods": 14, "fingerprint": "ce122c5e1c1fe306"}, {"name": "TerritoryHealerAgent", "file": "AgenticCore/L5_safety/guardrails/TerritoryHealerAgent.py", "methods": 7, "fingerprint": "6fdffa7306e70169"}, {"name": "TypeHintEnforcementAgent", "file": "AgenticCore/L5_safety/validators/TypeHintEnforcementAgent.py", "methods": 3, "fingerprint": "9bf27471e887b95c"}], "L6-OBS": [{"name": "BenchmarkingAgent", "file": "AgenticCore/observability/metrics/BenchmarkingAgent.py", "methods": 14, "fingerprint": "aaccf245087d7b9a"}, {"name": "CoordinateObservabilityOperationsAgent", "file": "AgenticCore/observability/metrics/CoordinateObservabilityOperationsAgent.py", "methods": 3, "fingerprint": "b79b37e264d36fb5"}, {"name": "MetricsAgent", "file": "AgenticCore/observability/metrics/MetricsAgent.py", "methods": 14, "fingerprint": "c857ceb2e36799b9"}, {"name": "PredictiveCostAuditorAgent", "file": "AgenticCore/observability/metrics/PredictiveCostAuditorAgent.py", "methods": 12, "fingerprint": "8ef66dd746dd7e50"}, {"name": "ReportingAgent", "file": "AgenticCore/observability/compliance/ReportingAgent.py", "methods": 5, "fingerprint": "2c9e248f2f70804b"}, {"name": "SignatureVerifierAgent", "file": "AgenticCore/observability/metrics/SignatureVerifierAgent.py", "methods": 3, "fingerprint": "60824e83630f2650"}, {"name": "TelemetryAgent", "file": "AgenticCore/observability/telemetry/TelemetryAgent.py", "methods": 11, "fingerprint": "d026b54bad957126"}, {"name": "TracingAgent", "file": "AgenticCore/observability/tracing/TracingAgent.py", "methods": 15, "fingerprint": "8c951c49ffa5b5ed"}, {"name": "TrackObservabilityCostAgent", "file": "AgenticCore/observability/metrics/TrackObservabilityCostAgent.py", "methods": 3, "fingerprint": "15b577bc8c1d7075"}], "UTILS": [{"name": "NamingAgent", "file": "AgenticCore/utils/naming/NamingAgent.py", "methods": 13, "fingerprint": "27645aed97c3aa01"}, {"name": "NamingNormalizationAgent", "file": "AgenticCore/utils/naming/NamingNormalizationAgent.py", "methods": 4, "fingerprint": "e09b6daa7f5988eb"}]}

semantic_l2_registry: Any = {'L5_safety': {'guardrails': {'purpose': 'Hard safety limits, mutation controls, deletion guards, circuit breakers, rate limits, throttling, and emergency stop mechanisms', 'entity_types': ['Class'], 'keywords': ['guardrail', 'safety', 'limit', 'constraint', 'circuit', 'breaker', 'throttle', 'rate', 'quota', 'mutate', 'delete', 'emergency', 'stop', 'block', 'prevent'], 'imports': ['AgenticCore.L5_safety.guardrails'], 'bases': ['BaseGuardrail', 'SafetyGuardrail', 'CircuitBreaker', 'RateLimiter'], 'examples': ['MutationGuardrail', 'DeletionGuardrail', 'RateLimitGuardrail', 'EmergencyStopGuardrail', 'ContentFilterGuardrail']}, 'red_teaming': {'purpose': 'Adversarial testing agents, automated threat simulation, exploit probing, jailbreak attempts, prompt injection testing, and attack vector generation', 'entity_types': ['Class', 'Function'], 'keywords': ['redteam', 'red_team', 'adversary', 'adversarial', 'attack', 'exploit', 'probe', 'jailbreak', 'threat', 'simulate', 'fuzz', 'injection', 'poison'], 'imports': ['AgenticCore.L5_safety.red_teaming'], 'bases': ['RedTeamAgent', 'AdversarialAgent', 'ThreatSimulator'], 'examples': ['JailbreakProber', 'PromptInjectionAttacker', 'ThreatSimulator', 'AdversarialFuzzer', 'ExploitGenerator']}, 'gravity': {'purpose': 'Import waterfall enforcement, dependency direction control, layer authority validation, gravity surgery execution, and upstream/downstream Violation detection', 'entity_types': ['Class', 'Function'], 'keywords': ['gravity', 'waterfall', 'import', 'dependency', 'direction', 'layer', 'authority', 'upstream', 'downstream', 'Violation', 'enforce', 'surgery'], 'imports': ['AgenticCore.L5_safety.gravity', 'AgenticCore.runtime.shared_runtime.void_compliance'], 'bases': ['GravityEnforcer', 'WaterfallValidator'], 'examples': ['GravityValidator', 'ImportWaterfallChecker', 'DependencyDirectionGuard', 'GravitySurgeryEngine', 'LayerAuthorityAuditor']}, 'validators': {'purpose': 'Canon constitution validators, structural policy enforcement, naming law validation, runtime compliance auditing, and architectural drift detection', 'entity_types': ['Class'], 'keywords': ['validator', 'canon', 'constitution', 'rule', 'policy', 'enforce', 'compliance', 'audit', 'drift', 'naming', 'law', 'check', 'verify'], 'imports': ['AgenticCore.L5_safety.validators', 'structure_blueprint'], 'bases': ['CanonBaseAgent', 'KeyValidator', 'StructureValidator', 'ComplianceAuditor', 'DriftDetector'], 'examples': ['CanonKeyValidator', 'NamingLawValidator', 'DepthValidator', 'GravityComplianceValidator', 'StructuralPolicyValidator', 'RuntimeComplianceAuditor']}}, 'L0_maintenance': {'scripts': {'purpose': 'Autonomous healing scripts, Checkpoint management, self-updating systems, neural immune agents, and sovereign improvement missions', 'entity_types': ['Class', 'Function'], 'keywords': ['autonomous', 'heal', 'repair', 'Checkpoint', 'guardian', 'self_update', 'immune', 'mission', 'surgery', 'refactor', 'evolution'], 'imports': ['AgenticCore.L0_maintenance.scripts', 'structure_blueprint'], 'bases': ['CanonBaseAgent', 'AutonomousAgent', 'HealingEngine'], 'examples': ['AutonomousCheckpointManager', 'AutonomousStateGuardian', 'SelfUpdatingSafetyEngine', 'NeuralAutoImmuneAgent', 'SovereignHealingMission']}, 'logs': {'purpose': 'Structured diagnostic logs, healing operation records, mission transcripts, and maintenance audit trails', 'entity_types': ['Class', 'Function'], 'keywords': ['log', 'diagnostic', 'record', 'transcript', 'audit', 'maintenance_log', 'healing_trace', 'mission_log'], 'imports': ['AgenticCore.L0_maintenance.logs', 'logging', 'json'], 'bases': ['DiagnosticLogger', 'MissionTranscript', 'MaintenanceAudit'], 'examples': ['HealingOperationLogger', 'AutonomousMissionLog', 'SovereignDiagnosticWriter', 'MaintenanceTrace']}, 'benchmarks': {'purpose': 'Performance benchmarking suites, timing profiles, resource usage metrics, and autonomous optimization baselines', 'entity_types': ['Class', 'Function'], 'keywords': ['benchmark', 'perf', 'timing', 'profile', 'Metric', 'baseline', 'optimize', 'resource', 'efficiency'], 'imports': ['AgenticCore.L0_maintenance.benchmarks', 'time', 'asyncio', 'psutil'], 'bases': ['BenchmarkSuite', 'PerformanceProfiler', 'ResourceMonitor'], 'examples': ['SovereignBenchmarkRunner', 'ReasoningSpeedTest', 'MemoryEfficiencyBenchmark', 'HealingCycleProfiler']}}, 'L1_cognition': {'thought_engine': {'purpose': 'Core reasoning primitives, thought nodes, chain-of-thought execution, internal monologue structures, and advanced deliberation patterns', 'entity_types': ['Class', 'Protocol'], 'keywords': ['thought', 'reason', 'node', 'chain', 'cot', 'tot', 'react', 'monologue', 'step', 'decompose', 'analyze', 'reflect', 'critique', 'socratic', 'deliberate', 'ponder', 'contemplate', 'self_reflect'], 'imports': ['AgenticCore.L1_cognition.thought_engine', 'pydantic', 'typing'], 'bases': ['ThoughtNode', 'ReasoningStep', 'BaseThought', 'ChainOfThought', 'TreeOfThoughts', 'ReActStep', 'BaseReasoningEngine'], 'examples': ['ReasoningNode', 'CritiqueStep', 'ReflectionThought', 'ChainOfThoughtExecutor', 'SocraticReasoner', 'TreeOfThoughtsNode', 'ReActAgentStep']}, 'intent_analysis': {'purpose': 'User intent detection, goal extraction, multi-turn request classification, ambiguity resolution, and command parsing', 'entity_types': ['Class', 'Function'], 'keywords': ['intent', 'goal', 'objective', 'request', 'classify', 'detect', 'extract', 'parse', 'understand', 'ambiguity', 'user_goal', 'TaskType', 'command', 'query_type', 'multi_turn', 'conversation'], 'imports': ['AgenticCore.L1_cognition.intent_analysis', 'google.generativeai', 're', 'pydantic'], 'bases': ['IntentClassifier', 'GoalExtractor', 'RequestParser', 'AmbiguityResolver'], 'examples': ['IntentClassifier', 'GoalDecomposer', 'AmbiguityResolver', 'UserRequestParser', 'TaskTypeDetector', 'MultiTurnIntentTracker']}, 'planning': {'purpose': 'Mission decomposition, strategy formulation, step sequencing, dependency mapping, plan validation, and execution roadmap generation', 'entity_types': ['Class', 'Function'], 'keywords': ['plan', 'strategy', 'decompose', 'sequence', 'step', 'Task', 'subtask', 'dependency', 'order', 'validate', 'breakdown', 'hierarchy', 'outline', 'roadmap', 'execute_order', 'priority', 'milestone'], 'imports': ['AgenticCore.L1_cognition.planning', 'networkx', 'pydantic', 'typing'], 'bases': ['Planner', 'DecompositionEngine', 'PlanValidator', 'StrategyBuilder', 'BasePlanner', 'TaskGraph'], 'examples': ['MissionDecomposer', 'TaskSequencer', 'DependencyResolver', 'PlanValidator', 'StrategicPlanner', 'StepHierarchyBuilder', 'PriorityScheduler']}}, 'L2_execution': {'ToolRegistry': {'purpose': 'Registration and discovery of external tools, base tool definitions, and tool metadata management', 'entity_types': ['Class', 'Function'], 'keywords': ['tool', 'registry', 'register', 'discover', 'metadata', 'available_tools', 'toolset'], 'imports': ['AgenticCore.L2_execution.ToolRegistry', 'pydantic', 'typing'], 'bases': ['BaseTool', 'ToolRegistry'], 'examples': ['ToolRegistry', 'register_tool', 'AvailableToolsList', 'ToolMetadata']}, 'action_handlers': {'purpose': 'Action dispatch logic, handler mapping, execution routing, and fallback strategies for tool calls', 'entity_types': ['Class', 'Function'], 'keywords': ['action', 'handler', 'execute', 'dispatch', 'Route', 'fallback', 'perform', 'invoke', 'call_action'], 'imports': ['AgenticCore.L2_execution.action_handlers'], 'bases': ['ActionHandler', 'BaseActionDispatcher'], 'examples': ['ActionDispatcher', 'HandlerMap', 'DefaultActionExecutor', 'ToolCallRouter', 'FallbackHandler']}, 'mcp': {'purpose': 'Multi-Component Protocol clients and tool implementations (figma, fetch, filesystem, SemanticCache, router, marketplace_filter)', 'entity_types': ['Class'], 'keywords': ['mcp', 'client', 'figma', 'fetch', 'filesystem', 'SemanticCache', 'router', 'marketplace', 'filter', 'protocol'], 'imports': ['AgenticCore.L2_execution.mcp', 'requests', 'playwright', 'selenium', 'pinecone'], 'bases': ['BaseTool', 'MCPClientBase'], 'examples': ['FigmaClient', 'FetchClientSovereign', 'FilesystemMCPClient', 'SemanticCacheClient', 'MCPRouter', 'MarketplaceFilter']}}, 'L3_orchestration': {'workflow_engines': {'purpose': 'High-level agent orchestration, multi-agent workflow engines, Task routing, mission lifecycle management, and coordination primitives', 'entity_types': ['Class'], 'keywords': ['orchestrator', 'coordinator', 'workflow', 'engine', 'manager', 'supervisor', 'crew', 'team', 'mission', 'lifecycle', 'Route', 'dispatch', 'schedule'], 'imports': ['AgenticCore.L3_orchestration.workflow_engines', 'langgraph', 'pydantic'], 'bases': ['CanonBaseAgent', 'WorkflowEngine', 'OrchestratorBase', 'MissionManager'], 'examples': ['SovereignOrchestrator', 'MultiAgentWorkflow', 'TaskRouter', 'MissionLifecycleManager', 'AgentSupervisor']}, 'fission_logic': {'purpose': 'Agent fission mechanics, dynamic sub-agent spawning, division of labor, and recursive self-delegation systems', 'entity_types': ['Class', 'Function'], 'keywords': ['fission', 'spawn', 'subagent', 'divide', 'delegate', 'recursive', 'split', 'branch', 'fork', 'proliferate'], 'imports': ['AgenticCore.L3_orchestration.fission_logic'], 'bases': ['FissionEngine', 'SubAgentSpawner', 'CanonBaseAgent'], 'examples': ['FissionManager', 'DynamicSubAgentCreator', 'RecursiveDelegator', 'TaskFissionLogic']}, 'S3_vitality': {'purpose': 'System vitality monitoring, health checks, self-preservation protocols, anomaly detection, and resilience mechanisms', 'entity_types': ['Class', 'Function'], 'keywords': ['vitality', 'health', 'monitor', 'heartbeat', 'anomaly', 'resilience', 'self_preserve', 'watchdog', 'liveness', 'readiness'], 'imports': ['AgenticCore.L3_orchestration.S3_vitality'], 'bases': ['VitalityMonitor', 'HealthChecker', 'CanonBaseAgent'], 'examples': ['VitalityGuardian', 'SystemHealthMonitor', 'AnomalyDetector', 'ResilienceEngine', 'WatchdogAgent']}, 'mcp': {'purpose': 'Orchestration-level Multi-Component Protocol components (router, marketplace_filter, coordination logic)', 'entity_types': ['Class'], 'keywords': ['mcp', 'router', 'marketplace', 'filter', 'orchestrate', 'coordinate', 'gateway', 'proxy'], 'imports': ['AgenticCore.L3_orchestration.mcp'], 'bases': ['MCPRouterBase', 'MarketplaceFilter', 'CanonBaseAgent'], 'examples': ['MCPRouter', 'MarketplaceToolFilter', 'OrchestrationGateway', 'MCPCoordinator']}}, 'L4_state': {'ValidationContext': {'purpose': 'Runtime validation contexts, state integrity containers, and scoped validation environments', 'entity_types': ['Class'], 'keywords': ['validation', 'context', 'scope', 'integrity', 'state_check', 'validate_in_context'], 'imports': ['AgenticCore.L4_state.ValidationContext', 'pydantic', 'typing'], 'bases': ['ValidationContext', 'BaseStateContext'], 'examples': ['SovereignValidationContext', 'MissionValidationScope', 'StateIntegrityContainer']}, 'ledger': {'purpose': 'Immutable audit ledgers, historical state records, event sourcing, and tamper-evident logs', 'entity_types': ['Class'], 'keywords': ['ledger', 'immutable', 'audit', 'trail', 'history', 'event_source', 'append_only', 'commit_log'], 'imports': ['AgenticCore.L4_state.ledger'], 'bases': ['ImmutableLedger', 'AuditTrail', 'EventLedger'], 'examples': ['SovereignLedger', 'MissionHistoryLedger', 'StateCommitLog', 'TamperEvidentRecord']}, 'filesystem': {'purpose': 'Sovereign filesystem abstractions, MCP filesystem operations, and persistent file state management', 'entity_types': ['Class'], 'keywords': ['filesystem', 'mcp', 'file', 'directory', 'path', 'persistent', 'storage', 'disk'], 'imports': ['AgenticCore.L4_state.filesystem', 'pathlib'], 'bases': ['FilesystemMCP', 'BaseFilesystemClient', 'BaseTool'], 'examples': ['SovereignFilesystemClient', 'PersistentStateStore', 'FileLedgerAdapter']}, 'memory': {'purpose': 'In-memory state stores, session management, ephemeral caches, and short-term memory systems', 'entity_types': ['Class'], 'keywords': ['memory', 'session', 'cache', 'ephemeral', 'short_term', 'in_memory', 'working_memory'], 'imports': ['AgenticCore.L4_state.memory', 'redis', 'typing'], 'bases': ['MemoryStore', 'SessionManager', 'EphemeralCache'], 'examples': ['SovereignWorkingMemory', 'SessionState', 'ShortTermCache', 'InMemoryLedger']}}, 'config': {'blueprint_sovereign': {'purpose': 'Sovereign structure blueprints, constitution enforcement, and registry of registries', 'entity_types': ['Dict', 'Class'], 'keywords': ['blueprint', 'sovereign', 'constitution', 'registry', 'structure', 'map', 'ssot'], 'imports': ['AgenticCore.config.blueprint_sovereign'], 'bases': ['BaseConfiguration', 'Constitution'], 'examples': ['StructureBlueprint', 'CanonRegistry', 'SovereignConstitution']}, 'environments': {'purpose': 'Environment-specific configuration loaders, .env parsers, and context switching', 'entity_types': ['Class', 'Function'], 'keywords': ['env', 'config', 'loader', 'dotenv', 'dev', 'prod', 'staging', 'variable'], 'imports': ['os', 'dotenv'], 'bases': ['ConfigLoader', 'EnvironmentContext'], 'examples': ['EnvLoader', 'ProductionConfig', 'DevContext', 'DotenvParser']}, 'feature_flags': {'purpose': 'Feature toggle management, rollout controls, and A/B testing switches', 'entity_types': ['Class'], 'keywords': ['flag', 'feature', 'toggle', 'rollout', 'switch', 'beta', 'enable', 'disable'], 'imports': ['AgenticCore.config.feature_flags'], 'bases': ['FeatureToggle', 'FlagManager'], 'examples': ['LaunchDarklyAdapter', 'FeatureFlagStore', 'BetaRolloutSwitch']}, 'secrets_manager': {'purpose': 'Secure secret retrieval, vault integration, and credential rotation', 'entity_types': ['Class'], 'keywords': ['secret', 'vault', 'key', 'credential', 'token', 'password', 'encrypt', 'decrypt'], 'imports': ['AgenticCore.config.secrets_manager'], 'bases': ['SecretsVault', 'CredentialProvider'], 'examples': ['VaultClient', 'AWSSystemManager', 'SecureTokenStore']}}, 'runtime': {'shared_runtime': {'purpose': 'Shared runtime environment setup, void compliance, and global initialization', 'entity_types': ['Class', 'Function'], 'keywords': ['runtime', 'shared', 'void', 'compliance', 'init', 'bootstrap', 'setup', 'global'], 'imports': ['AgenticCore.runtime.shared_runtime'], 'bases': ['RuntimeContext'], 'examples': ['VoidComplianceCheck', 'RuntimeBootstrapper', 'GlobalInit']}, 'resource_management': {'purpose': 'Resource allocation, throttling quotas, thread pool management, and cleanup', 'entity_types': ['Class'], 'keywords': ['resource', 'throttle', 'quota', 'cleanup', 'pool', 'thread', 'limit', 'allocate'], 'imports': ['concurrent.futures'], 'bases': ['ResourceManager', 'QuotaEnforcer'], 'examples': ['ThreadPoolManager', 'MemoryQuotaGuard', 'ResourceCleaner']}}, 'observability': {'metrics': {'purpose': 'Metric collection, counters, gauges, and prometheus exports', 'entity_types': ['Class'], 'keywords': ['Metric', 'counter', 'gauge', 'histogram', 'prometheus', 'stat'], 'imports': ['prometheus_client'], 'bases': ['MetricCollector'], 'examples': ['PerformanceMetrics', 'RequestCounter', 'SystemGauge']}, 'telemetry': {'purpose': 'Distributed telemetry, event emission, and structured observability events', 'entity_types': ['Class'], 'keywords': ['telemetry', 'event', 'emit', 'signal', 'observe'], 'imports': ['opentelemetry'], 'bases': ['TelemetryProvider'], 'examples': ['EventEmitter', 'TelemetrySignal', 'StructuredObserver']}, 'tracing': {'purpose': 'Span tracing, context propagation, and distributed trace ids', 'entity_types': ['Class'], 'keywords': ['trace', 'Span', 'context', 'propagate', 'id', 'parent'], 'imports': ['opentelemetry.trace'], 'bases': ['TracerBase'], 'examples': ['SpanContext', 'DistributedTracer', 'ContextPropagator']}, 'compliance': {'purpose': 'Compliance reporting, canon drift detection logs, and policy Violation records', 'entity_types': ['Class', 'Function'], 'keywords': ['compliance', 'drift', 'report', 'canon', 'Violation', 'audit'], 'imports': [], 'bases': ['ComplianceReporter'], 'examples': ['DriftReportGenerator', 'CanonComplianceLog', 'ViolationTracker']}}, 'utils': {'core_extensions': {'purpose': 'Core Python extensions, polyfills, and monkey-patches', 'entity_types': ['Function', 'Class'], 'keywords': ['extension', 'polyfill', 'monkey', 'patch', 'enhance'], 'imports': [], 'bases': [], 'examples': ['StringExtensions', 'DictMergePolyfill', 'CoreMonkeyPatch']}, 'wrappers': {'purpose': 'Decorators, generic wrappers, and function proxies', 'entity_types': ['Function'], 'keywords': ['wrapper', 'decorator', 'retry', 'cache', 'proxy', 'intercept'], 'imports': ['functools'], 'bases': [], 'examples': ['retry_with_backoff', 'cached_property_wrapper', 'LogExecutionDecorator']}, 'general_helpers': {'purpose': 'Domain-agnostic helper functions and miscellaneous core utilities', 'entity_types': ['Function'], 'keywords': ['helper', 'util', 'misc', 'common', 'format'], 'imports': [], 'bases': [], 'examples': ['date_helper', 'string_formatter', 'generic_util']}, 'naming': {'purpose': 'Naming law enforcement logic, casing validators, and canon signal checks', 'entity_types': ['Class', 'Function'], 'keywords': ['naming', 'canon', 'signal', 'law', 'case', 'snake', 'camel'], 'imports': ['AgenticCore.utils.naming', 're'], 'bases': ['NamingValidator'], 'examples': ['SnakeCaseValidator', 'CanonSignalChecker', 'NamingLawEnforcer']}}, 'patterns': {'agent_roles': {'purpose': 'Pre-defined agent personas, role templates, and behavioral archetypes', 'entity_types': ['Class', 'Dict'], 'keywords': ['role', 'persona', 'agent_type', 'Archetype', 'behavior'], 'imports': [], 'bases': ['CanonBaseAgent'], 'examples': ['SocraticPersona', 'CriticRole', 'ArchitectArchetype']}, 'communication_flow': {'purpose': 'Inter-agent message passing patterns and handoff protocols', 'entity_types': ['Class'], 'keywords': ['communication', 'message', 'flow', 'protocol', 'handoff', 'channel'], 'imports': [], 'bases': ['CommunicationProtocol'], 'examples': ['MessageBusPattern', 'HandoffProtocol', 'ChannelPattern']}, 'interaction_patterns': {'purpose': 'Common human-agent and agent-tool interaction patterns (CLI, Chat, etc)', 'entity_types': ['Class'], 'keywords': ['interaction', 'pattern', 'ui', 'cli', 'chat', 'ux'], 'imports': [], 'bases': [], 'examples': ['CliInteractionPattern', 'ChatLoopPattern', 'ToolUsePattern']}, 'reasoning_patterns': {'purpose': 'Reusable reasoning strategies (CoT, ToT, ReAct) as abstract patterns', 'entity_types': ['Class'], 'keywords': ['reasoning', 'strategy', 'cot', 'tot', 'react', 'chain', 'tree'], 'imports': ['AgenticCore.patterns.reasoning_patterns'], 'bases': ['BaseReasoningEngine'], 'examples': ['ChainOfThoughtPattern', 'TreeOfThoughtsStrategy', 'ReActLoopPattern']}}, 'knowledge': {'document_loaders': {'purpose': 'Document ingestion, parsing, and unstructured data loading utilities', 'entity_types': ['Class'], 'keywords': ['loader', 'ingest', 'parse', 'document', 'pdf', 'txt', 'html'], 'imports': ['unstructured', 'langchain'], 'bases': ['BaseLoader'], 'examples': ['PDFLoader', 'TextIngestor', 'HTMLParser']}, 'static_index': {'purpose': 'Hard-coded knowledge bases, static facts, and lookup tables', 'entity_types': ['Dict', 'Class'], 'keywords': ['static', 'index', 'facts', 'knowledge', 'lookup', 'table', 'constants'], 'imports': [], 'bases': [], 'examples': ['WorldFactsIndex', 'ConstantLookup', 'StaticKnowledgeBase']}, 'ResearchCache': {'purpose': 'Cached research results, external knowledge snapshots, and query history', 'entity_types': ['Class'], 'keywords': ['research', 'cache', 'snapshot', 'history', 'query', 'stored'], 'imports': [], 'bases': ['CacheStore'], 'examples': ['ResearchResultCache', 'KnowledgeSnapshot', 'QueryHistoryLog']}}, 'schemas': {'models': {'purpose': 'Pydantic data models, domain objects, and structured data contracts', 'entity_types': ['Class'], 'keywords': ['model', 'pydantic', 'dataclass', 'schema', 'dto', 'definition'], 'imports': ['pydantic'], 'bases': ['BaseModel']}, 'messages': {'purpose': 'API message formats, request/response schemas, and protocol buffers', 'entity_types': ['Class'], 'keywords': ['message', 'request', 'response', 'payload', 'packet'], 'imports': ['pydantic'], 'bases': ['BaseModel']}}, 'prompt_governance': {'templates': {'purpose': 'Reusable prompt fragments, system instructions, and jinja templates', 'entity_types': ['Class', 'str constant'], 'keywords': ['prompt', 'template', 'system', 'instruction', 'jinja', 'persona'], 'imports': ['jinja2'], 'bases': []}, 'rendering': {'purpose': 'Dynamic prompt assembly, variable substitution, and rendering logic', 'entity_types': ['Class', 'Function'], 'keywords': ['render', 'assemble', 'build', 'format', 'interpolate'], 'imports': ['jinja2'], 'bases': []}}, 'semantic_memory': {'embeddings': {'purpose': 'Embedding generation, caching, and dimension management', 'entity_types': ['Class', 'Function'], 'keywords': ['embedding', 'embed', 'vectorize', 'dimension', 'latent'], 'imports': ['google.generativeai'], 'bases': []}, 'retrieval': {'purpose': 'Semantic search, similarity scoring, and RAG retrieval', 'entity_types': ['Class', 'Function'], 'keywords': ['retriev', 'search', 'similarity', 'rag', 'query', 'lookup'], 'imports': ['pinecone'], 'bases': []}}, 'apps_rg': {'logic_nodes': {'purpose': 'Business logic nodes for resume extraction, parsing, and section formatting', 'entity_types': ['Class'], 'keywords': ['resume', 'cv', 'node', 'section', 'experience', 'education', 'skill', 'extract', 'format', 'parse'], 'imports': ['apps_rg.logic_nodes', 'pydantic'], 'bases': ['BaseNode', 'ResumeNode', 'ExtractionNode'], 'examples': ['ExperienceNode', 'SkillExtractNode', 'EducationFormatter', 'HeaderLogicNode']}, 'asset_library': {'purpose': 'Static assets, hardcoded strings, action verbs, and skill taxonomies for resumes', 'entity_types': ['Class', 'Dict'], 'keywords': ['asset', 'string', 'text', 'resource', 'copy', 'wording', 'verbs', 'skills', 'taxonomy'], 'imports': [], 'bases': ['BaseAsset'], 'examples': ['ResumeAssets', 'ActionVerbs', 'SkillTaxonomy', 'ResumeTemplateStrings']}, 'system_flow': {'purpose': 'Linear and branching pipelines for the resume generation lifecycle', 'entity_types': ['Class'], 'keywords': ['flow', 'pipeline', 'sequence', 'generate', 'create', 'process', 'workflow', 'lifecycle'], 'imports': ['apps_rg.system_flow'], 'bases': ['BaseFlow', 'ResumeGenerationFlow'], 'examples': ['GenerationFlow', 'ReviewPipeline', 'PdfGenerationWorkflow', 'ContentRefinementFlow']}, 'engines': {'purpose': 'Core rendering engines for document export (PDF, Docx, HTML)', 'entity_types': ['Class'], 'keywords': ['engine', 'render', 'export', 'pdf', 'docx', 'builder', 'latex', 'jinja'], 'imports': ['apps_rg.engines', 'jinja2'], 'bases': ['BaseEngine', 'DocumentBuilder'], 'examples': ['PdfEngine', 'DocxBuilder', 'HtmlRenderer', 'LatexCompiler']}, 'templates': {'purpose': 'Visual layouts, CSS/Style definitions, and structural blueprints for documents', 'entity_types': ['Class', 'Dict'], 'keywords': ['template', 'layout', 'style', 'theme', 'design', 'format', 'css', 'blueprint'], 'imports': [], 'bases': ['BaseTemplate', 'ResumeLayout'], 'examples': ['ModernTemplate', 'ClassicLayout', 'ExecutiveBlueprint', 'MinimalistStyle']}}, 'apps_lic': {'logic_nodes': {'purpose': 'Business logic nodes for profile analysis, connection requests, and message generation', 'entity_types': ['Class'], 'keywords': ['linkedin', 'lic', 'node', 'message', 'connect', 'invite', 'profile', 'scrutinize', 'analyze'], 'imports': ['apps_lic.logic_nodes'], 'bases': ['BaseNode', 'LicNode', 'MessagingNode'], 'examples': ['ConnectNode', 'MessageDraftNode', 'ProfileScrutinyNode', 'LeadValidationNode']}, 'asset_library': {'purpose': 'Outreach scripts, message templates, connection notes, and sequence assets', 'entity_types': ['Class', 'Dict'], 'keywords': ['asset', 'note', 'message', 'template', 'script', 'outreach', 'sequence', 'hook'], 'imports': [], 'bases': ['BaseAsset'], 'examples': ['ConnectionNotes', 'FollowUpScripts', 'OutreachTemplates', 'MessageHooks']}, 'system_flow': {'purpose': 'Outreach campaign management, multi-step drip sequences, and cadence logic', 'entity_types': ['Class'], 'keywords': ['flow', 'campaign', 'sequence', 'cadence', 'outreach', 'drip', 'funnel', 'pipeline'], 'imports': ['apps_lic.system_flow'], 'bases': ['BaseFlow', 'OutreachCampaign'], 'examples': ['OutreachCampaign', 'DailyFlow', 'DripSequenceFlow', 'FollowUpCadence']}, 'engines': {'purpose': 'Automated browser drivers for LinkedIn navigation and interaction', 'entity_types': ['Class'], 'keywords': ['engine', 'driver', 'navigate', 'automate', 'browser', 'playwright', 'selenium', 'scrape'], 'imports': ['apps_lic.engines', 'playwright', 'selenium'], 'bases': ['BaseEngine', 'BrowserDriver'], 'examples': ['NavigationEngine', 'BrowserDriver', 'ScrapingEngine', 'InteractionDriver']}, 'templates': {'purpose': 'Message formatting schemas and campaign structural blueprints', 'entity_types': ['Class'], 'keywords': ['template', 'structure', 'format', 'blueprint', 'schema'], 'imports': [], 'bases': ['BaseTemplate', 'LicTemplate'], 'examples': ['CampaignTemplate', 'MessageFormat', 'OutreachBlueprint']}}, 'apps_shared': {'base_definitions': {'purpose': 'Abstract base classes, core interfaces, and type contracts shared across all application domains', 'entity_types': ['Class', 'Protocol', 'TypeAlias'], 'keywords': ['base', 'definition', 'type', 'shared', 'interface', 'abstract', 'contract', 'blueprint', 'abc'], 'imports': ['abc', 'typing'], 'bases': ['ABC', 'Protocol'], 'examples': ['BaseNode', 'BaseFlow', 'BaseEngine', 'BaseTemplate', 'BaseAsset']}, 'common_utils': {'purpose': 'Shared application-level utility functions for data manipulation, formatting, and common logic', 'entity_types': ['Function', 'Class'], 'keywords': ['util', 'common', 'shared', 'helper', 'date', 'string', 'collection', 'formatter', 'converter'], 'imports': ['datetime', 're', 'json'], 'bases': [], 'examples': ['date_utils', 'string_helpers', 'collection_transformers', 'CurrencyFormatter']}, 'core_components': {'purpose': 'Reusable architectural widgets and modular components used across multiple app flows', 'entity_types': ['Class'], 'keywords': ['component', 'module', 'widget', 'part', 'element', 'plugin', 'extension'], 'imports': [], 'bases': ['BaseComponent'], 'examples': ['LoggerComponent', 'ConfigLoader', 'NotificationWidget', 'AppPluginBase']}, 'base_agents': {'purpose': 'Shared application-level agent templates and worker base classes', 'entity_types': ['Class'], 'keywords': ['agent', 'base_agent', 'worker', 'bot', 'task_executor', 'app_worker'], 'imports': ['AgenticCore.L3_orchestration.workflow_engines'], 'bases': ['CanonBaseAgent', 'AppBaseAgent'], 'examples': ['AppBaseAgent', 'TaskWorker', 'AsyncAppWorker', 'StatefulAppAgent']}, 'models': {'purpose': 'Shared Pydantic data models, Data Transfer Objects (DTOs), and domain-agnostic schemas', 'entity_types': ['Class'], 'keywords': ['model', 'dto', 'data', 'struct', 'object', 'payload', 'contract', 'pydantic'], 'imports': ['pydantic'], 'bases': ['BaseModel'], 'examples': ['UserProfile', 'TaskResult', 'CommonMetadata', 'SharedDataPacket']}}}