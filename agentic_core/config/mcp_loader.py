...
class MCPLoader:
    ...
    def __init__(
        ...
        if not self.config_path.exists():
            raise FileNotFoundError(
                ...
                f"Run: python ops_scripts/ci/extract_mcp_tools_to_yaml.py"
            )
    ...
    def get_server_by_prefix(self, prefix: str) -> Optional[MCPServer]:
    ...
    def get_tool_function(self, tool_name: str) -> Optional[str]:
...
_loader_instance: Optional[MCPLoader] = None
