        ...
        try:
            if self._should_use_fast_path(normalized_criteria):
                ...
                result = await self.circuit_breaker.call(
                    ...
                    content,
                    normalized_criteria,
                    context,    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context
                )
