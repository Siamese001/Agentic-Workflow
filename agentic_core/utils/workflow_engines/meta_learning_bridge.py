...
_emit_pulls_context("p1", "meta_learning_bridge", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "meta_learning_bridge", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "meta_learning_bridge", "uwg_term_2")
_emit_writes_through("p1", "meta_learning_bridge", "write_through")
_emit_writes_through("p1", "meta_learning_bridge", "write_through_2")
