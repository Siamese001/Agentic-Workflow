...
rewire_map: Any = [
    ("agentic_core\\.agents", "agentic_core.L2_execution.tool_registry"),
    ...
    (
        "agentic_core\\.L1_cognition\\.action_registry_modules",
        "agentic_core.L1_cognition.P1_sensing.action_registry_modules",
    ),
    ...
    ("from apps_rg\\.L3_orchestration\\.l5_autonomous_orchestrator import WorkflowSnapshot", ""),
]
