...
class ShadowModeEngine:
    ...
    def refine_pitch(self, pitch: PitchResult, error_reason: str) -> ShadowModeResult:
        ...
        refined_pitch = self.pitch_generator.refine_pitch(pitch, error_reason)

        # Analyze improvements
        improvements = self._analyze_improvements(pitch, refined_pitch, error_reason)
    ...
    def _analyze_improvements(self, original: PitchResult, refined: PitchResult,
                             error_reason: str) -> list:
        ...
        # Add reason-specific improvements
    ...
    def _calculate_confidence(self, improvements: list) -> float:
        ...
        # Add confidence based on number of improvements
    ...
    def simulate_refinement(self, pitch: PitchResult, error_reasons: list) -> list:
        ...
        for reason in error_reasons:
            result = self.refine_pitch(pitch, reason)
