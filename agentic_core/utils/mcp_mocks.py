...
def generate_draft_llm(draft_type: str, user_data: Dict, job_desc: str, 
                       current_draft: Optional[str] = None, 
                       required_keywords: Optional[list] = None) -> str:
