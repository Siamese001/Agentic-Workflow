...
class NS:  # noqa: N801 — intentionally short namespace class
    ...
    def build(
        ...
        *,
        ...
        trace_contract._emit_records_execution_trace(_trace_id, trace_contract.LayerSegment.L3_ORCHESTRATION, "NS.build")
...
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_13")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_14")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_15")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_16")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_17")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_18")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_19")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_20")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_21")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_22")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_23")
trace_contract._emit_reads_through("l4", "namespace_builder", "urg_read_24")
