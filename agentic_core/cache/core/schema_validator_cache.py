        ...
        *fetch_validator* is a zero-argument callable that compiles and returns
        ...
        if not replay_mode:
            try:
                ...
                raise
            except (OSError, TypeError) as e:  # guardian: allow-log-and-swallow -- cache read failure: non-fatal, falls through to compile
        ...
        if not replay_mode:
            try:
                ...
                pass
            except (OSError, TypeError) as e:  # guardian: allow-log-and-swallow -- cache write failure: non-fatal, compiled validator already returned
...
_emit_reads_through("l4", "schema_validator_cache", "urg_read_3")
_emit_reads_through("l4", "schema_validator_cache", "urg_read_4")
_emit_reads_through("l4", "schema_validator_cache", "urg_read_5")
_emit_reads_through("l4", "schema_validator_cache", "urg_read_6")
_emit_reads_through("l4", "schema_validator_cache", "urg_read_7")
_emit_reads_through("l4", "schema_validator_cache", "urg_read_8")
_emit_reads_through("l4", "schema_validator_cache", "urg_read_9")
_emit_reads_through("l4", "schema_validator_cache", "urg_read_10")
