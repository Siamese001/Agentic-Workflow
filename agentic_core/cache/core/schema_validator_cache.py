...
trace_contract._emit_applies_guardrail("p0", "schema_validator_cache", "p0_governance")
trace_contract._emit_reads_policy_state("p0", "schema_validator_cache", "policy_binding")
trace_contract._emit_snapshots_state("p0", "schema_validator_cache", "state_snapshot")
...
trace_contract._emit_escalates_to_human("p1", "schema_validator_cache", "human_escalation")
trace_contract._emit_routes_through("p1", "schema_validator_cache", "route_through")
    ...
    def get_or_fetch(self, schema: dict[str, Any], fetch_validator: Any, *, replay_mode: bool = False) -> Any:
        ...
        *fetch_validator* is a zero-argument callable that compiles and returns
        ...
        trace_contract._emit_records_execution_trace(
            _trace_id, trace_contract.LayerSegment.L3_ORCHESTRATION, "SchemaValidatorCache.get_or_fetch"
        )
...
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_1")
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_2")
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_3")
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_4")
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_5")
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_6")
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_7")
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_8")
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_9")
trace_contract._emit_reads_through("l4", "schema_validator_cache", "urg_read_10")
