...
trace_contract._emit_reads_policy_state("p0", "redis_cache_client", "policy_binding")
...
trace_contract._emit_pulls_context("p1", "redis_cache_client", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "redis_cache_client", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "redis_cache_client", "uwg_term_2")
trace_contract._emit_writes_through("p1", "redis_cache_client", "write_through")
trace_contract._emit_writes_through("p1", "redis_cache_client", "write_through_2")
...
trace_contract._emit_escalates_to_human("p1", "redis_cache_client", "human_escalation")
trace_contract._emit_routes_through("p1", "redis_cache_client", "route_through")
