    ...
    def get_or_fetch(
        ...
        *fetch_from_disk* is a zero-argument callable that reads and parses the
        ...
        if not replay_mode:
            ...
            # guardian: allow-silent-swallow - optional file resource    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access
