...
class CodeValidatorAgent(SovereignBaseAgent):
    ...
    def validate_project(self, project_root: Path = None) -> ValidationReport:
        ...
        summary = {
            ...
            "syntax_violations": len(
                [v for v in all_violations if v.violation_type == ViolationType.SYNTAX]
            ),
            "canon_violations": len(
                [v for v in all_violations if v.violation_type == ViolationType.CANON]
            ),
            "async_violations": len(
                [v for v in all_violations if v.violation_type == ViolationType.ASYNC]
            ),
            "print_violations": len(
                [v for v in all_violations if v.violation_type == ViolationType.PRINT]
            ),
