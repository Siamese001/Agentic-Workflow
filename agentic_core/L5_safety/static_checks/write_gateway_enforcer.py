...
def scan_file_for_writes(file_path: Path) -> list[tuple[int, str, str]]:
    ...
    return violations
_WRITE_SCAN_ROOTS = ['agentic_core/L3_orchestration/replay', 'agentic_core/L3_orchestration/arbitration', 'agentic_core/L3_orchestration/ptc', 'agentic_core/L4_state/storage']
