...
class SSOTRelocator:
    ...
    def _cleanup_empty_dirs(self, directory: Path) -> None:
        ...
        """
        if not directory.exists() or not directory.is_dir():    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling
            return
        try:
