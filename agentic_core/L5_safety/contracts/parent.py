"""Generated L5 contract dataclasses for ``00A_L5_Governance_Safety_detailed.md``.

Source doctrine: ``docs/reference/00_L5_Policy_Plane/00A_L5_Governance_Safety_detailed.md``
...
class AuthorityContextEvidenceRef(L5Ref):
    ...
    Source doctrine: ``00A_L5_Governance_Safety_detailed.md``.
    ...
    source_doc: ClassVar[str] = "00A_L5_Governance_Safety_detailed.md"
