...
class ArchivalGatekeeper:
    ...
    _instance: Optional['ArchivalGatekeeper'] = None
    ...
    def __init__(self, project_root: Path):
        ...
        self._l4_ledger_hook: Optional[Callable[[ArchivalResult], None]] = None
    ...
    @classmethod
    def get_instance(cls, project_root: Optional[Path] = None) -> 'ArchivalGatekeeper':
        """
    ...
    def _validate_path(self, path: Path, operation: str, allow_archive: bool = False) -> Optional[str]:
        """
