...
class HierarchyValidatorAgent:
    ...
    def scan_root_violations(self, target_territory: str | None = None) -> dict[str, Any]:
        ...
        _emit_records_execution_trace(_trace_id, LayerSegment.L5_POLICY, "HierarchyValidatorAgent.scan_root_violations")
        import hashlib as _hashlib  # noqa: PLC0415
        _seg_hash = _hashlib.sha256(f"{_trace_id}:HierarchyValidatorAgent.scan_root_violations".encode()).hexdigest()[:24]
