            ...
            if isinstance(v, tuple) and len(v) >= 2:
                ...
                if file_path and canonical_path:
                    ...
                    if not _batch and _is_interactive and _hitl_fn is None:
                        ...
                        print("  Options  : [V] Use validator path  [H] Let healer decide  [S] Skip")    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context    # guardian: EOFError should be handled with specific context
                        try:
        ...
        try:
            ...
            for py_file in python_files:
                if py_file == new_path or py_file == old_path:
                    continue  # Skip self    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling
