...
_emit_checks_agent_registry("p1", "ArchitectureGovernorValidatorAgent", "agent_registry")
_emit_validates_agent_capability("p1", "ArchitectureGovernorValidatorAgent", "capability")
_emit_dispatches_execution_plan("p1", "ArchitectureGovernorValidatorAgent", "exec_plan")
_emit_agent_executes_agent("p1", "ArchitectureGovernorValidatorAgent", "sub_agent")
_emit_routes_to_agent("p1", "ArchitectureGovernorValidatorAgent", "target_agent")
_emit_verifies_policy("p1", "ArchitectureGovernorValidatorAgent", "policy_check")
_emit_observes_runtime_state("p1", "ArchitectureGovernorValidatorAgent", "runtime_state")
_emit_verifies_boundary("p1", "ArchitectureGovernorValidatorAgent", "boundary_check")
_emit_transcripts_response("p1", "ArchitectureGovernorValidatorAgent", "transcript")
_emit_hard_fails_untranscripted("p1", "ArchitectureGovernorValidatorAgent")
_emit_gated_by_confidence("p1", "ArchitectureGovernorValidatorAgent", "confidence_gate")
