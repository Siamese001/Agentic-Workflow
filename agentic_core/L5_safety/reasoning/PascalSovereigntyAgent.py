    ...
    def resolve_collision_and_rename(self, src: Path, dest_name: str) -> bool:
        ...
        if dest.exists():
            try:
                ...
                dest_resolved = dest.resolve()    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
