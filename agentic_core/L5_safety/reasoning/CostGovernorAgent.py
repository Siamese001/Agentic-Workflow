...
_emit_checks_agent_registry("p1", "CostGovernorAgent", "agent_registry")
_emit_validates_agent_capability("p1", "CostGovernorAgent", "capability")
_emit_dispatches_execution_plan("p1", "CostGovernorAgent", "exec_plan")
_emit_agent_executes_agent("p1", "CostGovernorAgent", "sub_agent")
_emit_routes_to_agent("p1", "CostGovernorAgent", "target_agent")
_emit_verifies_policy("p1", "CostGovernorAgent", "policy_check")
_emit_observes_runtime_state("p1", "CostGovernorAgent", "runtime_state")
_emit_verifies_boundary("p1", "CostGovernorAgent", "boundary_check")
_emit_transcripts_response("p1", "CostGovernorAgent", "transcript")
_emit_hard_fails_untranscripted("p1", "CostGovernorAgent")
_emit_gated_by_confidence("p1", "CostGovernorAgent", "confidence_gate")
