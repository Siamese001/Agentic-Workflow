...
class SovereignSandbox:
    ...
    async def execute_tool(self, tool_path: str, args: list[str] | None=None) -> dict[str, Any]:
        ...
        try:
            ...
            process: Any = safe_popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True, cwd=os.getcwd())
            try:
...
class SovereignActionPlaneAgent(SovereignBaseAgent, IActionPlane):
    ...
    def _v15_build_operation_manifest(self, operation: str, target_layer: str='L2') -> SurgicalManifest | None:
    ...
    def heal(self, violation: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            return {'status': 'skipped', 'details': f'SovereignActionPlaneAgent heal() not yet implemented for {violation_type}', 'artifacts': [], 'errors': []}
        # guardian: allow-silent-swallow
        except Exception as e:
            return {'status': 'failed', 'details': f'SovereignActionPlaneAgent heal() failed: {str(e)}', 'artifacts': [], 'errors': [str(e)]}
