...
from agentic_core.prompt_governance.rendering.sovereign_prompt_renderer_validator import get_sovereign_prompt_renderer
...
@registers_prompt(template_name='red_team_governance.jinja', purpose='Red team evaluation and governance enforcement for adversarial testing', territory='templates', content=red_team_gov_content)
@registers_prompt(template_name='jailbreak_classic.jinja', purpose='Classic jailbreak prompt testing and hardening for safety validation', territory='templates', content=jailbreak_content)
class RedTeamAgent(SovereignBaseAgent):
    ...
    def heal_repository(self, dry_run: bool=True, execute: bool=False, depth: int=0, max_depth: int=3, _call_path: set | None=None) -> dict[str, int]:
        ...
        try:
            ...
            if not self._is_authorized():
                ...
                skipped += 1
                return {'violations_found': 0, 'violations_fixed': 0, 'errors': 0, 'skipped': 1, 'agent': agent_name, 'reason': 'Red team requires authorization'}
            ...
            return {'violations_found': violations_found, 'violations_fixed': violations_fixed, 'errors': errors, 'skipped': skipped, 'agent': agent_name, 'dry_run': dry_run, 'note': 'Red team findings require manual security review'}
        finally:
    ...
    def heal(self, violation: dict) -> dict:
        ...
        """
        violation.get('type', '')
        return {'violations_fixed': 0, 'violations_found': 1, 'errors': 0, 'skipped': 1, 'reason': 'Red team findings require manual security review'}
