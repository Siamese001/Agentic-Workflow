...
_emit_checks_agent_registry("p1", "CodeValidatorAgent", "agent_registry")
_emit_validates_agent_capability("p1", "CodeValidatorAgent", "capability")
_emit_dispatches_execution_plan("p1", "CodeValidatorAgent", "exec_plan")
_emit_agent_executes_agent("p1", "CodeValidatorAgent", "sub_agent")
_emit_routes_to_agent("p1", "CodeValidatorAgent", "target_agent")
_emit_verifies_policy("p1", "CodeValidatorAgent", "policy_check")
_emit_observes_runtime_state("p1", "CodeValidatorAgent", "runtime_state")
_emit_verifies_boundary("p1", "CodeValidatorAgent", "boundary_check")
_emit_transcripts_response("p1", "CodeValidatorAgent", "transcript")
_emit_hard_fails_untranscripted("p1", "CodeValidatorAgent")
_emit_gated_by_confidence("p1", "CodeValidatorAgent", "confidence_gate")
