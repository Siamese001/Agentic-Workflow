...
class GenerativeGuardAgent(SovereignBaseAgent, HealerMixin, CanonBaseAgentInterface, MCPHardenedMixin):
    ...
    async def _execute_guard(self) -> Any:
        ...
        if violations:
            ...
            self.ctx.signals.add("GENERATIVE_CLEAN")    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
