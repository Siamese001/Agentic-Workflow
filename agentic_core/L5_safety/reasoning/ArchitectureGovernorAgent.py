    ...
    def _cleanup_empty_dirs(self, path: Path) -> None:
        ...
        if not remaining:
            try:
                ...
                if pycache.exists():
                    _wg.remove_tree(pycache, ignore_errors=True)    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
                _wg.remove_dir(path)
                try:
