...
class RootHygieneHealerAgent(SovereignBaseAgent):
    ...
    def _cleanup_unused_temp_folders(self):
        ...
        for entry in self.project_root.iterdir():
            ...
            if name in ALWAYS_DELETE:
                ...
                try:    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
    ...
    def _evacuate_root_scripts(self):
        ...
        if root_scripts.exists():
            ...
            if not self.dry_run:
                try:
                    _wg.remove_dir(root_scripts)    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
                    ...
                    violations.append(
                        {
                            ...
                            "confidence": 0.8,    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
                        }
                    )
                    ...
                    if target and Path(target).exists():
                        ...
                        if target_path.is_dir() and target_path.name in {
                            ...
                            try:
                                ...
                                if age_days <= 7:
                                    return {
                                        "status": "skipped",    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
