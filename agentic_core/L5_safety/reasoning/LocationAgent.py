...
# ruff: noqa: E501, E402
"""
LocationAgent â€” DEPRECATED backward-compatibility shim (LCD+ Phase 0.3).
...
class LocationAgent(LocationHealerAgent):
    """DEPRECATED backward-compatibility shim â€” inherits all behavior from LocationHealerAgent.
