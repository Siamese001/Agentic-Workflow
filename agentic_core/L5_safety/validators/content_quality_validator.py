"""LEGACY_SHIM — canonical resume content-quality validator in the app runtime (W2 f8e3c1).

Historical import path: ``agentic_core.L5_safety.validators.content_quality_validator``.
...
def _load_public_symbols() -> dict[str, object]:
    ...
    module = import_module(".".join((app_pkg, "runtime", "validators", "content_quality_validator")))
