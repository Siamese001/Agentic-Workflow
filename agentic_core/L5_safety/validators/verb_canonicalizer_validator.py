"""LEGACY_SHIM — canonical resume verb canonicalizer in the app runtime (W2 f8e3c1).

Historical import path: ``agentic_core.L5_safety.validators.verb_canonicalizer_validator``.
...
def _load_public_symbols() -> dict[str, object]:
    ...
    module = import_module(".".join((app_pkg, "runtime", "validators", "verb_canonicalizer_validator")))
