...
class DirectPromptCompilationDetector(AntiPatternDetector):
    ...
    def detect(self, file_path: Path, tree: ast.Module) -> list[AntiPatternViolation]:
        ...
        _emit_records_execution_trace(_trace_id, LayerSegment.L5_POLICY, "DirectPromptCompilationDetector.detect")
        import hashlib as _hashlib  # noqa: PLC0415
        _seg_hash = _hashlib.sha256(f"{_trace_id}:DirectPromptCompilationDetector.detect".encode()).hexdigest()[:24]
