...
class DeliverabilityValidator:
    ...
    def validate_deliverability(self, messages: list[dict[str, Any]]) -> DeliverabilityResult:
        ...
        _emit_records_execution_trace(_trace_id, LayerSegment.L5_POLICY, "DeliverabilityValidator.validate_deliverability")
        import hashlib as _hashlib  # noqa: PLC0415
        _seg_hash = _hashlib.sha256(f"{_trace_id}:DeliverabilityValidator.validate_deliverability".encode()).hexdigest()[:24]
