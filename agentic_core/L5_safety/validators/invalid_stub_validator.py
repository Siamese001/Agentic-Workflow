...
_emit_authorize_and_execute("p2", "invalid_stub_validator", "execution_auth")
_emit_validates_capability("p2", "invalid_stub_validator", "capability_check")
_emit_routes_to_capability("p2", "invalid_stub_validator", "capability_route")
_emit_writes_via_uwg("p2", "invalid_stub_validator", "uwg_write")
_emit_blocks_direct_write("p2", "invalid_stub_validator", "direct_write_block")
_emit_records_tool_invocation("p2", "invalid_stub_validator", "tool_invocation")
_emit_captures_execution_output("p2", "invalid_stub_validator", "exec_output")
_emit_dispatches_agent("p3", "invalid_stub_validator", "agent_dispatch")
_emit_coordinates_agents("p3", "invalid_stub_validator", "agent_coordination")
_emit_records_workflow_lineage("p3", "invalid_stub_validator", "workflow_lineage")
_emit_records_healing_outcome("p3", "invalid_stub_validator", "healing_outcome")
_emit_escalates_failure("p3", "invalid_stub_validator", "failure_escalation")
_emit_orchestrates_workflow("p3", "invalid_stub_validator", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "invalid_stub_validator", "healing_dispatch")
_emit_invokes_evaluation("p3", "invalid_stub_validator", "evaluation_signal")
_emit_records_telemetry_event("p4", "invalid_stub_validator", "telemetry_event")
_emit_captures_evaluation_metric("p4", "invalid_stub_validator", "eval_metric")
_emit_stores_embedding("p4", "invalid_stub_validator", "embedding_store")
_emit_updates_meta_learning_state("p4", "invalid_stub_validator", "meta_learning")
_emit_links_execution_to_snapshot("p4", "invalid_stub_validator", "exec_snapshot_link")
...
emit_replay_key("p0", "invalid_stub_validator")
emit_determinism_digest("p0", "invalid_stub_validator")

_emit_dispatches_healing_run("p1", "invalid_stub_validator", "L5")
_emit_routes_through("p1", "invalid_stub_validator", "L5")
_emit_checks_agent_registry("p1", "invalid_stub_validator", "agent_registry")
_emit_validates_agent_capability("p1", "invalid_stub_validator", "capability")
_emit_dispatches_execution_plan("p1", "invalid_stub_validator", "exec_plan")
_emit_agent_executes_agent("p1", "invalid_stub_validator", "sub_agent")
_emit_routes_to_agent("p1", "invalid_stub_validator", "target_agent")
_emit_verifies_policy("p1", "invalid_stub_validator", "policy_check")
_emit_observes_runtime_state("p1", "invalid_stub_validator", "runtime_state")
_emit_verifies_boundary("p1", "invalid_stub_validator", "boundary_check")
_emit_transcripts_response("p1", "invalid_stub_validator", "transcript")
_emit_hard_fails_untranscripted("p1", "invalid_stub_validator")
_emit_gated_by_confidence("p1", "invalid_stub_validator", "confidence_gate")
_emit_escalates_to_human("p1", "invalid_stub_validator", "L5")
_emit_reads_policy_state("p1", "invalid_stub_validator", "L5")

_emit_applies_guardrail("p0", "invalid_stub_validator", "p0_governance")
_emit_snapshots_state("p0", "invalid_stub_validator", "state_snapshot")
from agentic_core.runtime.contracts.lifecycle_trace_contract import (
    _emit_agent_executes_agent,
...
_emit_emits_metric_event("invalid_stub_validator", "p4obs", "metric_3")
_emit_emits_metric_event("invalid_stub_validator", "p4obs", "metric_4")
_emit_emits_metric_event("invalid_stub_validator", "p4obs", "metric_5")
_emit_emits_metric_event("invalid_stub_validator", "p4obs", "metric_6")
_emit_records_incident_event("invalid_stub_validator", "p4obs", "incident")
_emit_captures_runtime_anomaly("invalid_stub_validator", "p4obs", "anomaly")
_emit_writes_observability_log("invalid_stub_validator", "p4obs", "obs_log")
_emit_updates_monitoring_state("invalid_stub_validator", "p4obs", "mon_state")
_emit_triggers_alert("invalid_stub_validator", "p4obs", "alert")
_emit_links_incident_trace("invalid_stub_validator", "p4obs", "trace_link")
_emit_captures_pattern("invalid_stub_validator", "p3lm", "pattern")
_emit_records_learning_event("invalid_stub_validator", "p3lm", "learning_event")
_emit_writes_learning_snapshot("invalid_stub_validator", "p3lm", "snapshot")
_emit_feeds_meta_learning("invalid_stub_validator", "p3lm", "meta_feed")
_emit_updates_routing_strategy("invalid_stub_validator", "p3lm", "routing")
_emit_improves_agent_policy("invalid_stub_validator", "p3lm", "policy")
_emit_stores_learning_state("invalid_stub_validator", "p3lm", "state")
_emit_records_execution_trace("invalid_stub_validator", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("invalid_stub_validator", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("invalid_stub_validator", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("invalid_stub_validator", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("invalid_stub_validator", "L4_STATE", "p2_trace_5")
_emit_reads_environ("invalid_stub_validator", "env_read", "p2_env_1")
_emit_reads_environ("invalid_stub_validator", "env_read", "p2_env_2")
_emit_reads_runtime_state("invalid_stub_validator", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("invalid_stub_validator", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "invalid_stub_validator", "context_pull")
_emit_pulls_context("p1", "invalid_stub_validator", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "invalid_stub_validator", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "invalid_stub_validator", "uwg_term_2")
_emit_writes_through("p1", "invalid_stub_validator", "write_through")
_emit_writes_through("p1", "invalid_stub_validator", "write_through_2")
_emit_validated_by_safety_plane("p1", "invalid_stub_validator", "safety_validation")
_emit_invokes_eval("p1", "invalid_stub_validator", "eval_call")
_emit_proposal_commits_routing("p1", "invalid_stub_validator", "routing_commit")
...
class InvalidStubDetector(AntiPatternDetector):
    ...
    def detect(self, file_path: Path, tree: ast.Module) -> list[AntiPatternViolation]:
        ...
        _emit_records_execution_trace(_trace_id, LayerSegment.L5_POLICY, "InvalidStubDetector.detect")
