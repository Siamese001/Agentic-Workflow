...
_emit_dispatches_healing_run("p1", "structure_drift_validator", "L5")
_emit_routes_through("p1", "structure_drift_validator", "L5")
...
_emit_escalates_to_human("p1", "structure_drift_validator", "L5")
_emit_reads_policy_state("p1", "structure_drift_validator", "L5")
...
def generate_structure_manifest() -> dict[str, Any]:
    ...
    _emit_snapshots_state(str(_uuid.uuid4()), "generate_structure_manifest", "state_snapshot")
    ...
    _emit_applies_guardrail(str(_uuid.uuid4()), "generate_structure_manifest", "p0_governance")
    import uuid as _uuid  # noqa: PLC0415
