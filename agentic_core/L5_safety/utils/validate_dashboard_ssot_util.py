...
HARDCODED_PATTERNS = [
    ...
    "Path\\([\"\\'].*L6_observability/dashboards.*[\"\\']\\)",
    "[\"\\']C:/Git/Agentic-Workflow/agentic_core/L6_observability/dashboards[\"\\']",
    "os\\.path\\.join\\(.*[\"\\']L6_observability[\"\\'].*[\"\\']dashboards[\"\\']\\)",
]
EXCLUDE_PATTERNS = list(GLOBAL_EXCLUDED_DIRS | SOVEREIGN_EXCLUDED_FOLDERS) + [
    "legacy_",
    "structure_blueprint.py",
    "validate_dashboard_ssot_util.py",
]
