...
_emit_pulls_context("p1", "decorators_util", "context_pull_secondary")
_emit_execution_terminates_at_uwg("p1", "decorators_util", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "decorators_util", "uwg_term_secondary")
_emit_writes_through("p1", "decorators_util", "write_through")
_emit_writes_through("p1", "decorators_util", "write_through_secondary")
