...
annexation_plan: Any = {'config': CORE / 'config/P1_core', 'observability': CORE / 'observability/P1_core', 'prompt_governance': CORE / 'prompt_governance/P1_core', 'schemas': CORE / 'schemas/P1_core', 'scripts': CORE / 'L0_routing/scripts', 'prompt_templates': CORE / 'prompt_governance/P2_prompts'}
