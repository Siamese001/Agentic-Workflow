...
class l5_safety_layer:
    ...
    def get_safety_stats(self) -> Dict[str, Any]:
        ...
        """
        return {'validations_performed': self.validation_count, 'actions_blocked': self.blocked_count, 'block_rate_percent': self.blocked_count / max(self.validation_count, 1) * 100, 'pii_vault_stats': self.pii_vault.get_stats(), 'cost_governor_stats': self.cost_governor.get_stats(), 'forbidden_patterns_count': len(self.overseer.get_forbidden_patterns())}
