...
def test_track_large_token_counts(cost_governor_agent):
    """Test tracking with large token counts."""
    # Very large token counts that could cause precision issues
    large_input = 1000000
    large_output = 500000
    
    cost = cost_governor_agent.track("gpt-4", large_input, large_output)
