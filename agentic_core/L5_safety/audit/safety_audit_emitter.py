...
_emit_checks_agent_registry("p1", "safety_audit_emitter", "agent_registry")
_emit_validates_agent_capability("p1", "safety_audit_emitter", "capability")
_emit_dispatches_execution_plan("p1", "safety_audit_emitter", "exec_plan")
_emit_agent_executes_agent("p1", "safety_audit_emitter", "sub_agent")
_emit_routes_to_agent("p1", "safety_audit_emitter", "target_agent")
_emit_verifies_policy("p1", "safety_audit_emitter", "policy_check")
_emit_observes_runtime_state("p1", "safety_audit_emitter", "runtime_state")
_emit_verifies_boundary("p1", "safety_audit_emitter", "boundary_check")
_emit_transcripts_response("p1", "safety_audit_emitter", "transcript")
_emit_hard_fails_untranscripted("p1", "safety_audit_emitter")
_emit_gated_by_confidence("p1", "safety_audit_emitter", "confidence_gate")
