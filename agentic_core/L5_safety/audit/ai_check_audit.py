...
_emit_checks_agent_registry("p1", "ai_check_audit", "agent_registry")
_emit_validates_agent_capability("p1", "ai_check_audit", "capability")
_emit_dispatches_execution_plan("p1", "ai_check_audit", "exec_plan")
_emit_agent_executes_agent("p1", "ai_check_audit", "sub_agent")
_emit_routes_to_agent("p1", "ai_check_audit", "target_agent")
_emit_verifies_policy("p1", "ai_check_audit", "policy_check")
_emit_observes_runtime_state("p1", "ai_check_audit", "runtime_state")
_emit_verifies_boundary("p1", "ai_check_audit", "boundary_check")
_emit_transcripts_response("p1", "ai_check_audit", "transcript")
_emit_hard_fails_untranscripted("p1", "ai_check_audit")
_emit_gated_by_confidence("p1", "ai_check_audit", "confidence_gate")
