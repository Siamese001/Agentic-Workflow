...
class SeverityLevel(Enum):
    ...
    ---------------------------------------
    ADG / Ruff: CRITICAL ΓåÆ P0, HIGH ΓåÆ P1, MEDIUM ΓåÆ P2, LOW ΓåÆ P3
    Pre-commit: CRITICAL/HIGH/MEDIUM/LOW/INFO ΓåÆ direct mapping
    ...
    MEDIUM (P2): Medium-severity anti-patterns (silent swallow, return-none,
        ...
        fixing ΓÇö technical debt accumulation.
    LOW (P3): Style warnings (global mutation, hardcoded paths,
        throw-for-normal-flow). Informational, can be deferred.
    INFO: No issue ΓÇö informational or passed gate status. Has no ADG band.
    """
    ...
    def ruff_category(self) -> str:
        """Ruff P0-P3 category (identical to ADG band ΓÇö single canonical mapping)."""
        return self.p_level
    ...
    def adg_category(self) -> str:
        ...
        CRITICAL ΓåÆ P0, HIGH ΓåÆ P1, MEDIUM ΓåÆ P2, LOW ΓåÆ P3. INFO returns 'N/A'.
        """
        return self.p_level
