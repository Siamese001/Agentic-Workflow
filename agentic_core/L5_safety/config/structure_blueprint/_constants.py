...
def build_sovereign_territories() -> dict[str, TerritoryDefinition]:
    ...
    territories["tests"] = {
        ...
        "subfolders": {
            ...
            "smoke": {
                "purpose": "Smoke and startup-path sanity tests",
                "subfolders": {
                    "adg": [],
                    "agents": [],
                    "config": [],
            ...
            "unit": {
                ...
                "subfolders": {
                    ...
                    # system_learning unit mirror lives at tests/system_learning/unit/ (not under tests/unit/)
                },
                "forbidden_zones": ["misc", "temp", "old", "deprecated", "archive", "scratch"],
            },
        },
    ...
    territories["tools"] = {
        "depth": 2,
        "purpose": "Developer tooling: analysis, repair, ADG wiring, wave scripts, CI validation, profiling.",
        "subfolders": {
            "adg": {"purpose": "ADG wiring, gap analysis, validation, and incremental update scripts"},
            "adg_backups": {"purpose": "Backup snapshots of ADG artifacts"},
            "analysis": {"purpose": "Audit, inventory, profiling, and investigation scripts"},
            "archive": {"purpose": "Archived and superseded tool scripts"},
            "ci": {"purpose": "CI validation, plan format checks, pre-execution validators"},
            "cleanup": {"purpose": "Cleanup and deduplication scripts"},
            "debug": {"purpose": "Debug and inspection utilities"},
            "diagnose": {"purpose": "Diagnostics for errors, imports, and test failures"},
            "evidence": {"purpose": "Evidence capture and runner scripts for phase verification"},
            "fix": {"purpose": "AST-based and batch fix scripts for imports, syntax, and wiring"},
            "generate": {"purpose": "Code and report generation scripts"},
            "governance": {"purpose": "Layer separation and governance tooling"},
            "guardian": {"purpose": "Guardian exemption and anti-pattern sweep tools"},
            "ingestion": {"purpose": "Data and artifact ingestion pipelines"},
            "learning": {"purpose": "Continuous learning and meta-learning pipeline tools"},
            "mcp": {"purpose": "MCP server wrappers, fixes, and configuration tools"},
            "memory": {"purpose": "ADG memory server and persistence tools"},
            "migrate": {"purpose": "Import migration, embedding upgrades, and module moves"},
            "monitoring": {"purpose": "Monitoring and observability utilities"},
            "otel": {"purpose": "OpenTelemetry integration and tracing tools"},
            "profiling": {"purpose": "ADG scanner and phase profiling scripts"},
            "repair": {"purpose": "Docstring and wiring repair scripts"},
            "runners": {"purpose": "Test and validation runner utilities"},
            "scripts": {"purpose": "General-purpose operational and one-off scripts"},
            "test_enforcement": {"purpose": "Test enforcement validation tools"},
            "testing": {"purpose": "Integration and smoke test scripts for tooling validation"},
            "waves": {"purpose": "Wave execution scripts for phased migration and wiring"},
            "windsurf": {"purpose": "Windsurf IDE integration and CI scripts"},
        },
