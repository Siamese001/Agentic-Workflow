"""
Territories Module - COLD PATH (Heavy Territory Definitions)

This module contains the SOVEREIGN_TERRITORIES definition built from
templates and layer-specific overrides to eliminate duplication.

Loaded lazily on first access via get_sovereign_territories().
"""
