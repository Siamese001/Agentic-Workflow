...
_emit_emits_metric_event("semantics", "p4obs", "metric_1")
_emit_emits_metric_event("semantics", "p4obs", "metric_2")
_emit_emits_metric_event("semantics", "p4obs", "metric_3")
_emit_emits_metric_event("semantics", "p4obs", "metric_4")
_emit_emits_metric_event("semantics", "p4obs", "metric_5")
_emit_emits_metric_event("semantics", "p4obs", "metric_6")
_emit_records_incident_event("semantics", "p4obs", "incident")
_emit_captures_runtime_anomaly("semantics", "p4obs", "anomaly")
_emit_writes_observability_log("semantics", "p4obs", "obs_log")
_emit_updates_monitoring_state("semantics", "p4obs", "mon_state")
_emit_triggers_alert("semantics", "p4obs", "alert")
_emit_links_incident_trace("semantics", "p4obs", "trace_link")
_emit_captures_pattern("semantics", "p3lm", "pattern")
_emit_records_learning_event("semantics", "p3lm", "learning_event")
_emit_writes_learning_snapshot("semantics", "p3lm", "snapshot")
_emit_feeds_meta_learning("semantics", "p3lm", "meta_feed")
_emit_updates_routing_strategy("semantics", "p3lm", "routing")
_emit_improves_agent_policy("semantics", "p3lm", "policy")
_emit_stores_learning_state("semantics", "p3lm", "state")
_emit_records_execution_trace("semantics", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("semantics", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("semantics", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("semantics", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("semantics", "L4_STATE", "p2_trace_5")
_emit_reads_environ("semantics", "env_read", "p2_env_1")
_emit_reads_environ("semantics", "env_read", "p2_env_2")
_emit_reads_runtime_state("semantics", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("semantics", "runtime_state", "p2_rt_2")

emit_replay_key("p0", "semantics")
emit_determinism_digest("p0", "semantics")

_emit_dispatches_healing_run("p1", "semantics", "L5")
_emit_routes_through("p1", "semantics", "L5")
_emit_checks_agent_registry("p1", "semantics", "agent_registry")
_emit_validates_agent_capability("p1", "semantics", "capability")
_emit_dispatches_execution_plan("p1", "semantics", "exec_plan")
_emit_agent_executes_agent("p1", "semantics", "sub_agent")
_emit_routes_to_agent("p1", "semantics", "target_agent")
_emit_verifies_policy("p1", "semantics", "policy_check")
_emit_observes_runtime_state("p1", "semantics", "runtime_state")
_emit_verifies_boundary("p1", "semantics", "boundary_check")
_emit_transcripts_response("p1", "semantics", "transcript")
_emit_hard_fails_untranscripted("p1", "semantics")
_emit_gated_by_confidence("p1", "semantics", "confidence_gate")
_emit_escalates_to_human("p1", "semantics", "L5")
_emit_reads_policy_state("p1", "semantics", "L5")
_emit_pulls_context("p1", "semantics", "context_pull")
_emit_pulls_context("p1", "semantics", "context_pull_secondary")
_emit_execution_terminates_at_uwg("p1", "semantics", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "semantics", "uwg_term_secondary")
_emit_writes_through("p1", "semantics", "write_through")
_emit_writes_through("p1", "semantics", "write_through_secondary")
_emit_validated_by_safety_plane("p1", "semantics", "safety_validation")
_emit_invokes_eval("p1", "semantics", "eval_call")
_emit_proposal_commits_routing("p1", "semantics", "routing_commit")
...
_emit_authorize_and_execute("p2", "semantics", "execution_auth")
_emit_validates_capability("p2", "semantics", "capability_check")
_emit_routes_to_capability("p2", "semantics", "capability_route")
_emit_writes_via_uwg("p2", "semantics", "uwg_write")
_emit_blocks_direct_write("p2", "semantics", "direct_write_block")
_emit_records_tool_invocation("p2", "semantics", "tool_invocation")
_emit_captures_execution_output("p2", "semantics", "exec_output")
_emit_dispatches_agent("p3", "semantics", "agent_dispatch")
_emit_coordinates_agents("p3", "semantics", "agent_coordination")
_emit_records_workflow_lineage("p3", "semantics", "workflow_lineage")
_emit_records_healing_outcome("p3", "semantics", "healing_outcome")
_emit_escalates_failure("p3", "semantics", "failure_escalation")
_emit_orchestrates_workflow("p3", "semantics", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "semantics", "healing_dispatch")
_emit_invokes_evaluation("p3", "semantics", "evaluation_signal")
_emit_records_telemetry_event("p4", "semantics", "telemetry_event")
_emit_captures_evaluation_metric("p4", "semantics", "eval_metric")
_emit_stores_embedding("p4", "semantics", "embedding_store")
_emit_updates_meta_learning_state("p4", "semantics", "meta_learning")
_emit_links_execution_to_snapshot("p4", "semantics", "exec_snapshot_link")
