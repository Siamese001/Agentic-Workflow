...
trace_contract.emit_replay_key("p0", "artifacts")
trace_contract.emit_determinism_digest("p0", "artifacts")

trace_contract._emit_dispatches_healing_run("p1", "artifacts", "L5")
trace_contract._emit_routes_through("p1", "artifacts", "L5")
trace_contract._emit_checks_agent_registry("p1", "artifacts", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "artifacts", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "artifacts", "exec_plan")
trace_contract._emit_agent_executes_agent("p1", "artifacts", "sub_agent")
trace_contract._emit_routes_to_agent("p1", "artifacts", "target_agent")
trace_contract._emit_verifies_policy("p1", "artifacts", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "artifacts", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "artifacts", "boundary_check")
trace_contract._emit_transcripts_response("p1", "artifacts", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "artifacts")
trace_contract._emit_gated_by_confidence("p1", "artifacts", "confidence_gate")
trace_contract._emit_escalates_to_human("p1", "artifacts", "L5")
trace_contract._emit_reads_policy_state("p1", "artifacts", "L5")
trace_contract._emit_authorize_and_execute("p2", "artifacts", "execution_auth")
trace_contract._emit_validates_capability("p2", "artifacts", "capability_check")
trace_contract._emit_routes_to_capability("p2", "artifacts", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "artifacts", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "artifacts", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "artifacts", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "artifacts", "exec_output")
trace_contract._emit_dispatches_agent("p3", "artifacts", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "artifacts", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "artifacts", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "artifacts", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "artifacts", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "artifacts", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "artifacts", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "artifacts", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "artifacts", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "artifacts", "eval_metric")
trace_contract._emit_stores_embedding("p4", "artifacts", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "artifacts", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "artifacts", "exec_snapshot_link")
from tqdm import tqdm

trace_contract._emit_emits_metric_event("artifacts", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("artifacts", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("artifacts", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("artifacts", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("artifacts", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("artifacts", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("artifacts", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("artifacts", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("artifacts", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("artifacts", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("artifacts", "p4obs", "alert")
trace_contract._emit_links_incident_trace("artifacts", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("artifacts", "p3lm", "pattern")
trace_contract._emit_records_learning_event("artifacts", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("artifacts", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("artifacts", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("artifacts", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("artifacts", "p3lm", "policy")
trace_contract._emit_stores_learning_state("artifacts", "p3lm", "state")
trace_contract._emit_records_execution_trace("artifacts", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("artifacts", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("artifacts", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("artifacts", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("artifacts", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("artifacts", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("artifacts", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("artifacts", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("artifacts", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "artifacts", "context_pull")
trace_contract._emit_pulls_context("p1", "artifacts", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "artifacts", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "artifacts", "uwg_term_2")
trace_contract._emit_writes_through("p1", "artifacts", "write_through")
trace_contract._emit_writes_through("p1", "artifacts", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "artifacts", "safety_validation")
trace_contract._emit_invokes_eval("p1", "artifacts", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "artifacts", "routing_commit")
...
def get_correct_app_folder(filename: str) -> str | None:
    ...
    trace_contract._emit_snapshots_state(str(_uuid.uuid4()), "get_correct_app_folder", "state_snapshot")
    ...
    trace_contract._emit_applies_guardrail(str(_uuid.uuid4()), "get_correct_app_folder", "p0_governance")
    import uuid as _uuid  # noqa: PLC0415

    _trace_id = str(_uuid.uuid4())
    trace_contract._emit_records_execution_trace(_trace_id, trace_contract.LayerSegment.L5_POLICY, "get_correct_app_folder")
