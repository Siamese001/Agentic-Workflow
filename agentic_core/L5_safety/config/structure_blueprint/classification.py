...
trace_contract.emit_replay_key("p0", "classification")
trace_contract.emit_determinism_digest("p0", "classification")

trace_contract._emit_dispatches_healing_run("p1", "classification", "L5")
trace_contract._emit_routes_through("p1", "classification", "L5")
trace_contract._emit_checks_agent_registry("p1", "classification", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "classification", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "classification", "exec_plan")
trace_contract._emit_agent_executes_agent("p1", "classification", "sub_agent")
trace_contract._emit_routes_to_agent("p1", "classification", "target_agent")
trace_contract._emit_verifies_policy("p1", "classification", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "classification", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "classification", "boundary_check")
trace_contract._emit_transcripts_response("p1", "classification", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "classification")
trace_contract._emit_gated_by_confidence("p1", "classification", "confidence_gate")
trace_contract._emit_escalates_to_human("p1", "classification", "L5")
trace_contract._emit_reads_policy_state("p1", "classification", "L5")
trace_contract._emit_authorize_and_execute("p2", "classification", "execution_auth")
trace_contract._emit_validates_capability("p2", "classification", "capability_check")
trace_contract._emit_routes_to_capability("p2", "classification", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "classification", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "classification", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "classification", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "classification", "exec_output")
trace_contract._emit_dispatches_agent("p3", "classification", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "classification", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "classification", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "classification", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "classification", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "classification", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "classification", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "classification", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "classification", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "classification", "eval_metric")
trace_contract._emit_stores_embedding("p4", "classification", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "classification", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "classification", "exec_snapshot_link")

trace_contract._emit_emits_metric_event("classification", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("classification", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("classification", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("classification", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("classification", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("classification", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("classification", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("classification", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("classification", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("classification", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("classification", "p4obs", "alert")
trace_contract._emit_links_incident_trace("classification", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("classification", "p3lm", "pattern")
trace_contract._emit_records_learning_event("classification", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("classification", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("classification", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("classification", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("classification", "p3lm", "policy")
trace_contract._emit_stores_learning_state("classification", "p3lm", "state")
trace_contract._emit_records_execution_trace("classification", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("classification", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("classification", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("classification", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("classification", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("classification", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("classification", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("classification", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("classification", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "classification", "context_pull")
trace_contract._emit_pulls_context("p1", "classification", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "classification", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "classification", "uwg_term_2")
trace_contract._emit_writes_through("p1", "classification", "write_through")
trace_contract._emit_writes_through("p1", "classification", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "classification", "safety_validation")
trace_contract._emit_invokes_eval("p1", "classification", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "classification", "routing_commit")
...
def get_compound_suffix_patterns_compiled() -> list[tuple[Pattern, str, str, str]]:
    ...
    trace_contract._emit_snapshots_state(str(_uuid.uuid4()), "get_compound_suffix_patterns_compiled", "state_snapshot")
    ...
    trace_contract._emit_applies_guardrail(str(_uuid.uuid4()), "get_compound_suffix_patterns_compiled", "p0_governance")
    import uuid as _uuid  # noqa: PLC0415

    _trace_id = str(_uuid.uuid4())
    trace_contract._emit_records_execution_trace(_trace_id, trace_contract.LayerSegment.L5_POLICY, "get_compound_suffix_patterns_compiled")
    return [
