...
try:
    ...
    Exception
):  # guardian: allow-broad-exception -- module-init fallback; discovery failure must not block import
    ...
    frozenset(
        {
            ...
            "docs/archive/windsurf/legacy-tree",  # legacy editor IDE data (intentional)
