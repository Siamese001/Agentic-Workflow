...
SSOT is now: agentic_core.L5_safety.config.structure_blueprint/
This file re-exports all public names for backward compatibility.
All 197+ existing importers will continue to work unchanged.
...
from agentic_core.L5_safety.config.structure_blueprint.governance import (  # noqa: F401
...
from agentic_core.L5_safety.config.structure_blueprint.semantics import (  # noqa: F401
    AGENT_REGISTRY,
    APP_DOMAIN_PREFIXES,
    APP_LIC_AST_TERMS,
