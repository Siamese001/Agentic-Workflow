...
trace_contract.emit_replay_key("p0", "agent_heal_audit")
trace_contract.emit_determinism_digest("p0", "agent_heal_audit")

trace_contract._emit_dispatches_healing_run("p1", "agent_heal_audit", "L5")
trace_contract._emit_routes_through("p1", "agent_heal_audit", "L5")
trace_contract._emit_checks_agent_registry("p1", "agent_heal_audit", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "agent_heal_audit", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "agent_heal_audit", "exec_plan")
trace_contract._emit_agent_executes_agent("p1", "agent_heal_audit", "sub_agent")
trace_contract._emit_routes_to_agent("p1", "agent_heal_audit", "target_agent")
trace_contract._emit_verifies_policy("p1", "agent_heal_audit", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "agent_heal_audit", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "agent_heal_audit", "boundary_check")
trace_contract._emit_transcripts_response("p1", "agent_heal_audit", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "agent_heal_audit")
trace_contract._emit_gated_by_confidence("p1", "agent_heal_audit", "confidence_gate")
trace_contract._emit_escalates_to_human("p1", "agent_heal_audit", "L5")
trace_contract._emit_reads_policy_state("p1", "agent_heal_audit", "L5")
trace_contract._emit_authorize_and_execute("p2", "agent_heal_audit", "execution_auth")
trace_contract._emit_validates_capability("p2", "agent_heal_audit", "capability_check")
trace_contract._emit_routes_to_capability("p2", "agent_heal_audit", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "agent_heal_audit", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "agent_heal_audit", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "agent_heal_audit", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "agent_heal_audit", "exec_output")
trace_contract._emit_dispatches_agent("p3", "agent_heal_audit", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "agent_heal_audit", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "agent_heal_audit", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "agent_heal_audit", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "agent_heal_audit", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "agent_heal_audit", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "agent_heal_audit", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "agent_heal_audit", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "agent_heal_audit", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "agent_heal_audit", "eval_metric")
trace_contract._emit_stores_embedding("p4", "agent_heal_audit", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "agent_heal_audit", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "agent_heal_audit", "exec_snapshot_link")
from tqdm import tqdm

trace_contract._emit_emits_metric_event("agent_heal_audit", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("agent_heal_audit", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("agent_heal_audit", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("agent_heal_audit", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("agent_heal_audit", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("agent_heal_audit", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("agent_heal_audit", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("agent_heal_audit", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("agent_heal_audit", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("agent_heal_audit", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("agent_heal_audit", "p4obs", "alert")
trace_contract._emit_links_incident_trace("agent_heal_audit", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("agent_heal_audit", "p3lm", "pattern")
trace_contract._emit_records_learning_event("agent_heal_audit", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("agent_heal_audit", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("agent_heal_audit", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("agent_heal_audit", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("agent_heal_audit", "p3lm", "policy")
trace_contract._emit_stores_learning_state("agent_heal_audit", "p3lm", "state")
trace_contract._emit_records_execution_trace("agent_heal_audit", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("agent_heal_audit", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("agent_heal_audit", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("agent_heal_audit", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("agent_heal_audit", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("agent_heal_audit", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("agent_heal_audit", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("agent_heal_audit", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("agent_heal_audit", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "agent_heal_audit", "context_pull")
trace_contract._emit_pulls_context("p1", "agent_heal_audit", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "agent_heal_audit", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "agent_heal_audit", "uwg_term_2")
trace_contract._emit_writes_through("p1", "agent_heal_audit", "write_through")
trace_contract._emit_writes_through("p1", "agent_heal_audit", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "agent_heal_audit", "safety_validation")
trace_contract._emit_invokes_eval("p1", "agent_heal_audit", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "agent_heal_audit", "routing_commit")
...
class AgentHealAuditScanner:
    ...
    def _is_runtime_agent(self, class_name: str, base_names: list[str], file_path: Path) -> tuple[bool, str]:
        ...
        trace_contract._emit_snapshots_state(str(_uuid.uuid4()), "AgentHealAuditScanner._is_runtime_agent", "state_snapshot")
