...
_emit_checks_agent_registry("p1", "AdapterBase", "agent_registry")
_emit_validates_agent_capability("p1", "AdapterBase", "capability")
_emit_dispatches_execution_plan("p1", "AdapterBase", "exec_plan")
_emit_agent_executes_agent("p1", "AdapterBase", "sub_agent")
_emit_routes_to_agent("p1", "AdapterBase", "target_agent")
_emit_verifies_policy("p1", "AdapterBase", "policy_check")
_emit_observes_runtime_state("p1", "AdapterBase", "runtime_state")
_emit_transcripts_response("p1", "AdapterBase", "transcript")
_emit_hard_fails_untranscripted("p1", "AdapterBase")
_emit_gated_by_confidence("p1", "AdapterBase", "confidence_gate")
