...
def assert_no_persistent_write(layer: str, op: str, path: str | None=None, trace_id: str | None=None) -> None:
...
def safe_write_text(filepath: Path | str, content: str, *, layer: str, trace_id: str | None=None, encoding: str='utf-8') -> None:
...
def safe_json_dump(obj: Any, filepath: Path | str, *, layer: str, trace_id: str | None=None, indent: int | None=2, sort_keys: bool=True, **kwargs: Any) -> None:
...
def safe_open_write(filepath: Path | str, mode: str='w', *, layer: str, trace_id: str | None=None, encoding: str | None='utf-8') -> Any:
...
def mutation_guard(layer: str) -> Generator[None, None, None]:
    ...
    yield
__all__ = ['FORBIDDEN_WRITE_LAYERS', 'assert_no_persistent_write', 'mutation_guard', 'safe_json_dump', 'safe_open_write', 'safe_os_remove', 'safe_os_rename', 'safe_shutil_move', 'safe_shutil_rmtree', 'safe_write_bytes', 'safe_write_text']
