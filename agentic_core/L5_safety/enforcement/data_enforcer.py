...
_CANDIDATE_PATHS = [_REPO_ROOT / 'artifacts' / 'discovery' / 'agent_discovery_full.json', _REPO_ROOT / 'data' / 'processed' / 'agent_discovery_full.json', _REPO_ROOT / 'agent_discovery_full.json']
...
class DataValidator:
    ...
    def check_base_agent_uniqueness(self):
        ...
        for agent in self.data:
            ...
            is_base = 'BaseAgent' in class_name or class_name in CANONICAL_BASE_AGENTS.values() or 'base_class' in agent.get('path', '').lower()
    ...
    def check_naming_conventions(self):
        ...
        for agent in self.data:
            ...
            if '_' in name and name not in ['L0RoutingBaseAgent', 'L1CognitionBase', 'L2Agent', 'L3Agent', 'L4Agent', 'L5Agent']:
