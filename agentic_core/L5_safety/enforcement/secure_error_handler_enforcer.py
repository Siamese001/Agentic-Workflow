...
def secure_exception(
    ...
    Returns:
        Decorated function
    """    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context
    ...
    def decorator(func):
        ...
        async def async_wrapper(*args, **kwargs):
            try:
                ...
                secure_error = ErrorSanitizer.create_secure_error(error_type, e, ErrorCode, context)    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context    # guardian: SecureError should be handled with specific context
                raise secure_error
