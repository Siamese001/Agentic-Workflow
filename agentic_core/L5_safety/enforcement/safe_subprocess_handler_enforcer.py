...
def safe_popen(
    ...
    **kwargs: Any,
    ...
    process = subprocess.Popen(command, stdout=stdout, stderr=stderr, cwd=cwd, env=env, **kwargs)  # guardian: allow-popen-leak -- safe_popen wrapper: caller owns the returned Popen and its lifecycle via ProcessGuard-registered PID
