...
class RiskDecision:
    ...
    allow: bool
    level: RiskLevel
    reasons: tuple[str, ...]  # deterministic sorted tuple
...
class ConfCalibRiskGate:
    ...
    def evaluate(self, *, payload_like: object, d0_injections: str) -> RiskDecision:
        ...
        """
        # Start with LOW risk, allow execution
