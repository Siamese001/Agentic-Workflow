...
class PytestEnforcementGuard:
    ...
    def _validate_markers(self, markers: set[str]) -> None:
        ...
        missing = required_markers - markers    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime
        if missing:
    ...
    def _get_used_test_markers(self) -> set[str]:
        ...
        for test_file in self.repo_root.rglob("test_*.py"):
            if ".venv" in str(test_file) or "__pycache__" in str(test_file):
                continue
            try:    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling
