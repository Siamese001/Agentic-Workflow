...
class SystemValidator:
    ...
    def check_mcp_hardened(self, code: str) -> bool:
        ...
        return "MCPHardenedMixin" in code or "mcp_hardened_mixin" in code    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime
