...
class SSOTMetaLearningMixin:
    ...
    def ml_read_patterns(
        self,
        domain: str,
        limit: int = 10,  # guardian: allow-magic-configuration
    ) -> list[dict[str, Any]]:
    ...
    def ml_store_pattern(
        ...
        # Precondition 4: Success required
        if not success:
