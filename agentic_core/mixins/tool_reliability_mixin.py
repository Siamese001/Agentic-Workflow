        ...
        for attempt in range(policy.max_retries + 1):
            try:
                ...
                if attempt < policy.max_retries:
                    ...
                    try:
                        self._check_circuit_breaker(tool_name)
                    # guardian: allow-silent-swallow - acceptable exception handling    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context    # guardian: CircuitBreakerError should be handled with specific context
