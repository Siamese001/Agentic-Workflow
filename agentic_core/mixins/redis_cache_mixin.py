...
from agentic_core.config.core.constants_config import CACHE_METRICS_ENABLED, GRACEFUL_DEGRADATION, USE_REDIS_CACHE
...
class RedisCacheMixin:
    ...
    def cache_stats(self) -> dict:
        ...
        return {'prefix': self._cache_prefix, 'local_cache_size': len(self._local_cache), 'redis_enabled': self.redis_enabled, 'redis_connected': self._redis_client is not None}
