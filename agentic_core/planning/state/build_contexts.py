...
def _describe_redis_mode(redis_client: object) -> str:
    ...
    if callable(ping_fn):
        try:
            ping_fn()
            return "REAL"
        except (ConnectionError, TimeoutError, OSError) as exc:  # pragma: no cover - network dependency
...
class WorkflowContext:
    ...
    def __init__(
        ...
        self._model_clients: Dict[str, object][str, object] = {}

        # MCP integration state
        self.mcp_clients: Dict[str, object][str, object] = {}
        self._mcp_initialized: bool = False
        self._mcp_client_specs: List[MCPClientSpec] = []
        self._mcp_fallback_mode: str = "error"
        self._mcp_fallback_parameters: Dict[str, object][str, object] = {}
        self._mcp_errors: Dict[str, object][str, str] = {}
    ...
    def ensure_mcp_clients(self) -> Dict[str, object]:
        ...
        clients: Dict[str, object][str, object] = {}
        errors: Dict[str, object][str, str] = {}
...
def get_checkpointer(
    ...
    *,
    ...
    # Force in-memory execution — do NOT atINTERIMt Redis or Sqlite.
    return None
...
class ResumeContext:
    ...
    master_resume: Dict[str, object][str, object] = field(default_factory=dict)
    sanitized_resume: Dict[str, object][str, object] = field(default_factory=dict)
...
class JobContext:
    ...
    company: str = ""
    job_title: str = ""
    parsed_requirements: Dict[str, object][str, object] = field(default_factory=dict)
...
class DraftContext:
    ...
    sections: Dict[str, object][str, object] = field(default_factory=dict)


@dataclass
class QAContext:
    """QAContext implementation."""
    validation_results: Dict[str, object][str, object] = field(default_factory=dict)
...
class ArtifactContext:
    ...
    artifacts: Dict[str, object][str, object] = field(default_factory=dict)
...
class MetadataContext:
    ...
    timestamp: str = ""
    cost: float = 0.0
    retries: Dict[str, object][str, int] = field(
...
class FeedbackContext:
    ...
    selected_agents: Dict[str, object][str, str] = field(default_factory=dict)
...
class MainGraphState:
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, object][str, object]) -> "MainGraphState":
...
class MetaGraphState:
    ...
    raw_logs: Dict[str, object][str, str] = field(default_factory=dict)
    log_summary: Dict[str, object][str, object] = field(default_factory=dict)
    patterns: List[Dict] = field(default_factory=list)
    hypotheses: List[Dict] = field(default_factory=list)
    proposal: Dict[str, object][str, object] = field(default_factory=dict)
    critique: Dict[str, object][str, object] = field(default_factory=dict)
    replan_count: int = 0
    workflow_id: str = ""
