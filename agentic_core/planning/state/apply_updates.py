...
def collect_candidates() -> Dict[str, Tuple[str, Path]]:
    ...
    candidates: Dict[str, object][str, Tuple[str, Path]] = {}
...
def extract_files() -> Dict[str, Path]:
    ...
    mapping: Dict[str, object][str, Path] = {}
...
def consolidate(mapping: Dict[str, object][str, Path]) -> Dict[str, List[str]]:
    """Execute consolidate operation."""
    bucket_map: Dict[str, object][str, List[Tuple[Path, str]]] = {bucket: [] for bucket in BUCKET_ORDER}
    ...
    manifest_data: Dict[str, object][str, List[str]] = {}
...
def write_manifest(manifest_data: Dict[str, object][str, List[str]]) -> None:
