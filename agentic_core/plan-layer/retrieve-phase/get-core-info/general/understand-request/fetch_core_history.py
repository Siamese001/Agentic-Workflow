"""
L1 Cognitive Planning Layer - fetch_core_history
Implements pure planning logic, query construction, intent analysis functionality for fetch_core_history
...
class FetchCoreHistoryType:
    """Pure planning logic, query construction, intent analysis component for fetchcorehistorytype operations.
...
class FetchCoreHistoryConstraints:
    """Pure planning logic, query construction, intent analysis component for fetchcorehistoryconstraints operations.
...
class FetchCoreHistoryResult:
    """Pure planning logic, query construction, intent analysis component for fetchcorehistoryresult operations.
...
class FetchCoreHistoryProcessor:
    """Pure planning logic, query construction, intent analysis component for fetchcorehistoryprocessor operations.
...
class FetchCoreHistoryImpl:
    """Pure planning logic, query construction, intent analysis component for fetchcorehistoryimpl operations.
