...
class DependenciesExtractionError(Exception):
    ...
    def __init__(self, message: str, error_code: Optional[str] = None, operation: Optional[str] = None, dependency_type: Optional[str] = None, context: Optional[Dict[str, Any]] = None):
        super().__init__(message)
        self.error_code = error_code or "DEPENDENCIES_EXTRACTION_ERROR"
    ...
    def __str__(self) -> str:
        ...
        type_info = f" for {self.dependency_type}" if self.dependency_type else ""
