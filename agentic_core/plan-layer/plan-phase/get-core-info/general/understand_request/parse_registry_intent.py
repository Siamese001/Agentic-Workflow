...
class IntentParsingError(Exception):
    ...
    def __init__(self, message: str, error_code: Optional[str] = None, operation: Optional[str] = None, intent_type: Optional[str] = None, context: Optional[Dict[str, Any]] = None):
        super().__init__(message)
        self.error_code = error_code or "INTENT_PARSING_ERROR"
    ...
    def __str__(self) -> str:
        ...
        type_info = f" for {self.intent_type}" if self.intent_type else ""
