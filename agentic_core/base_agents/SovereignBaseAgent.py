...
class SovereignBaseAgent(
    ...
    def _v15_enhanced_heal(self, violation: dict[str, Any], **kwargs) -> dict[str, Any]:
        ...
        def state_hash_fn() -> tuple[str, str, str]:
            ...
            _git_head = self.project_root / ".git" / "HEAD"    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
