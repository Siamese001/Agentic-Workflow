...
from agentic_core.L6_system_learning.engines.healing_config_optimizer import HealingConfigOptimizer
from agentic_core.L6_system_learning.engines.healing_outcome_aggregator import HealingOutcomeAggregator
from agentic_core.L6_system_learning.engines.healing_outcome_intake_adapter import HealingOutcomeIntakeAdapter
from agentic_core.L6_system_learning.engines.l4_state_writer import L4StateWriter
from agentic_core.L6_system_learning.engines.pattern_analysis_engine import PatternAnalysisEngine
from agentic_core.L6_system_learning.engines.policy_recommendation_engine import (
    PolicyRecommendation,
    PolicyRecommendationEngine,
)
from agentic_core.L6_system_learning.engines.retrieval_profile import RetrievalProfile
from agentic_core.L6_system_learning.engines.retrieval_profile_manager import get_active_retrieval_profile
from agentic_core.L6_system_learning.engines.retrieval_profile_proposal import RetrievalProfileProposal
from agentic_core.L6_system_learning.engines.retrieval_profile_proposal_manager import RetrievalProfileProposalManager
from agentic_core.L6_system_learning.engines.rlhf_optimizer import RLHFOptimizer
from agentic_core.L6_system_learning.engines.shadow_drift_analyzer import DriftSummary, ShadowDriftAnalyzer
from agentic_core.L6_system_learning.engine import FailureFingerprinter
from agentic_core.L6_system_learning.invariants.freeze_gate import FreezeStateReader
from agentic_core.L6_system_learning.snapshots.snapshot_factory import create_snapshot
from agentic_core.L6_system_learning.types.snapshot_types import MetaLearningSnapshot
from agentic_core.L6_system_learning.validators.oscillation_detector import OscillationPolicy
from agentic_core.L6_system_learning.shadow_evaluator import ShadowThresholds
...
def run_pipeline(
    ...
    from agentic_core.L6_system_learning.engines.telemetry_consumer import consume_telemetry
    ...
    from agentic_core.L6_system_learning.engines.rca_engine import analyze_failures_and_persist as analyze_failures
    ...
    from agentic_core.prompt_governance.security import InjectionDetector
    ...
    if deps.resource_predictor_bytes is not None:
        try:
            ...
            from agentic_core.L6_system_learning.types.proposal_types import ChangePackage
    ...
    if deps.dpo_batch_bytes is not None and deps.rlhf_optimizer is not None:
        try:
            ...
            from agentic_core.L6_system_learning.engines.change_package_impl import ChangePackage as _CP
    ...
    from agentic_core.L6_system_learning.constraints.dampening import assert_cooldown_ok, assert_min_sample_size
    from agentic_core.L6_system_learning.validators.oscillation_detector import compute_freeze_decision
    from agentic_core.L6_system_learning.replay_validator import replay_validate
    from agentic_core.L6_system_learning.shadow_evaluator import evaluate_shadow
    ...
    if deps.healing_outcome_intake_adapter is not None:
        ...
        if _window_records:
            from agentic_core.L6_system_learning.types.healing_outcome_types import HealingOutcomeEvent as _WHE
    ...
    if (
        ...
        try:
            from agentic_core.L6_system_learning.adapters.system_learning_memory_bridge import (
    ...
    from .approval_gates import ApprovalDecision
