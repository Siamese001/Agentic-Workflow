...
from agentic_core.L6_system_learning.engines.cross_repo_system_learning_import import (
...
def build_pipeline_config(*, proposal_only: bool = True) -> Any:
    ...
    from .meta_learning_pipeline import PipelineConfig
...
def build_pipeline_deps(
    *,
    ...
    """
    from agentic_core.L6_system_learning.engines.l0_threshold_tuner import L0ProposerAdapter
    from agentic_core.L6_system_learning.engines.l1_model_proposer import L1ModelProposer
    from agentic_core.L6_system_learning.engines.l4_state_writer import FileBackedL4StateWriter
    from agentic_core.L6_system_learning.engines.l5_policy_proposer import L5PolicyProposer
    from agentic_core.L6_system_learning.engines.rag_proposer import RAGParameterProposer
    from .meta_learning_pipeline import PipelineDependencies
    from agentic_core.L6_system_learning.stores.audit_store import FileBackedAuditStore
    from agentic_core.L6_system_learning.stores.config_provider import (
        FileBackedConfigProvider,
        InMemoryBaselineMetricsProvider,
    )
    from agentic_core.L6_system_learning.stores.telemetry_store import InMemoryTelemetryStore
    ...
    rlhf_optimizer = None
    try:
        from agentic_core.L6_system_learning.engines.rlhf_optimizer import DefaultDeterministicRLHFOptimizer
    ...
    freeze_reader = None
    try:
        from agentic_core.L6_system_learning.invariants.freeze_gate import JsonFileBackedFreezeReader
    ...
    try:
        from agentic_core.L6_system_learning.adapters.otel_telemetry_store_adapter import OTelTelemetryStoreAdapter
