...
try:  # Wave 1: Core Pipeline Infrastructure
    from .approval_gauntlet_engine import (  # noqa: F401
        ApprovalDecision,
        ApprovalGauntletEngine,
        ApprovalGauntletResult,
    )
except ImportError:  # guardian: allow-silent-swallow -- transitive dep may be absent under shimmed pytest collection; safe to skip
    pass
try:
    from .case_compilation_engine import (  # noqa: F401
...
try:  # Wave 2: Evaluation Components (B, C, D)
    from .g_gate_regression_checker import (  # noqa: F401
        GGateRegressionChecker,
    )
except ImportError:  # guardian: allow-silent-swallow -- transitive dep may be absent under shimmed pytest collection; safe to skip
    pass
try:
    from .human_calibration_engine import (  # noqa: F401
        CalibrationRecord,
...
try:  # Wave 4: Control & Calibration (Components A, F)
    from .live_exit_control_gate import (  # noqa: F401
        ExitControlResult,
        LiveExitControlGate,
    )
except ImportError:  # guardian: allow-silent-swallow -- transitive dep may be absent under shimmed pytest collection; safe to skip
    pass
try:
    from .outcome_evaluation_engine import (  # noqa: F401
...
try:  # Wave 3: System Learning Pipeline (Steps 6-7)
    from .rule_drafting_engine import (  # noqa: F401
        RuleDraftingEngine,
        RuleDraftingResult,
        RuleProposal,
    )
    ...
    pass
try:
    from .signal_aggregator_engine import (  # noqa: F401
    ...
    pass
try:
    from .stage_barrier_enforcer import (  # noqa: F401
        MetaLearningStage,
    ...
    pass
try:
    from .trajectory_evaluation_engine import (  # noqa: F401
