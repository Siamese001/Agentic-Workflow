...
class ShadowDriftAnalyzer:
    ...
    def analyze_batch(
        ...
        *,
        ...
        with sl_span(
            "agentic_core.L6_system_learning.v1.shadow_drift_analyzer.analyze_batch",
        ...
        try:
            ...
            if summary.drift_flag:
                try:
                    ...
                    from agentic_core.L6_system_learning.ports.meta_learning_change_package import MetaLearningChangePackage
