...
class L0ProposerAdapter:
    ...
    def propose(
        ...
        if cooldown is None:
            from agentic_core.L6_system_learning.constraints.dampening import CooldownPolicy

            # guardian: allow-magic-config
            cooldown = CooldownPolicy(min_seconds_between_updates=3600)

        if sample is None:
            from agentic_core.L6_system_learning.constraints.dampening import SampleSizePolicy
