...
class FailureEvent:
    ...
    def canonical_bytes(self) -> bytes:
        ...
        trace_contract._emit_records_execution_trace(
            _trace_id, trace_contract.LayerSegment.L3_ORCHESTRATION, "FailureEvent.canonical_bytes"
        )
...
class FailureFingerprint:
    ...
    def from_canonical_bytes(cls, canonical_bytes: bytes) -> FailureFingerprint:
        ...
        _trace_id = str(_uuid.uuid4())
        trace_contract._emit_records_execution_trace(
            _trace_id, trace_contract.LayerSegment.L3_ORCHESTRATION, "FailureFingerprint.from_canonical_bytes"
        )
