...
class HealingAttempt:
    ...
    def canonical_bytes(self) -> bytes:
        ...
        trace_contract._emit_records_execution_trace(
            _trace_id, trace_contract.LayerSegment.L3_ORCHESTRATION, "HealingAttempt.canonical_bytes"
        )
...
class HealingConfidenceReport:
    ...
    def from_canonical_bytes(
        ...
        _trace_id = str(_uuid.uuid4())
        trace_contract._emit_records_execution_trace(
            _trace_id, trace_contract.LayerSegment.L3_ORCHESTRATION, "HealingConfidenceReport.from_canonical_bytes"
        )
