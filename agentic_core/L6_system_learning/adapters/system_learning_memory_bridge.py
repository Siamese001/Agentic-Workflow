...
trace_contract._emit_applies_guardrail("p0", "system_learning_memory_bridge", "p0_governance")

trace_contract._emit_emits_metric_event("system_learning_memory_bridge", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("system_learning_memory_bridge", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("system_learning_memory_bridge", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("system_learning_memory_bridge", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("system_learning_memory_bridge", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("system_learning_memory_bridge", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("system_learning_memory_bridge", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("system_learning_memory_bridge", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("system_learning_memory_bridge", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("system_learning_memory_bridge", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("system_learning_memory_bridge", "p4obs", "alert")
trace_contract._emit_links_incident_trace("system_learning_memory_bridge", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("system_learning_memory_bridge", "p3lm", "pattern")
trace_contract._emit_records_learning_event("system_learning_memory_bridge", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("system_learning_memory_bridge", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("system_learning_memory_bridge", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("system_learning_memory_bridge", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("system_learning_memory_bridge", "p3lm", "policy")
trace_contract._emit_stores_learning_state("system_learning_memory_bridge", "p3lm", "state")
trace_contract._emit_records_execution_trace("system_learning_memory_bridge", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("system_learning_memory_bridge", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("system_learning_memory_bridge", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("system_learning_memory_bridge", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("system_learning_memory_bridge", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("system_learning_memory_bridge", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("system_learning_memory_bridge", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("system_learning_memory_bridge", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("system_learning_memory_bridge", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "system_learning_memory_bridge", "context_pull")
trace_contract._emit_pulls_context("p1", "system_learning_memory_bridge", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "system_learning_memory_bridge", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "system_learning_memory_bridge", "uwg_term_2")
trace_contract._emit_writes_through("p1", "system_learning_memory_bridge", "write_through")
trace_contract._emit_writes_through("p1", "system_learning_memory_bridge", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "system_learning_memory_bridge", "safety_validation")
trace_contract._emit_invokes_eval("p1", "system_learning_memory_bridge", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "system_learning_memory_bridge", "routing_commit")
trace_contract._emit_escalates_to_human("p1", "system_learning_memory_bridge", "human_escalation")
trace_contract._emit_routes_through("p1", "system_learning_memory_bridge", "route_through")
trace_contract._emit_checks_agent_registry("p1", "system_learning_memory_bridge", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "system_learning_memory_bridge", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "system_learning_memory_bridge", "exec_plan")
trace_contract._emit_agent_executes_agent("p1", "system_learning_memory_bridge", "sub_agent")
trace_contract._emit_routes_to_agent("p1", "system_learning_memory_bridge", "target_agent")
trace_contract._emit_verifies_policy("p1", "system_learning_memory_bridge", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "system_learning_memory_bridge", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "system_learning_memory_bridge", "boundary_check")
trace_contract._emit_transcripts_response("p1", "system_learning_memory_bridge", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "system_learning_memory_bridge")
trace_contract._emit_gated_by_confidence("p1", "system_learning_memory_bridge", "confidence_gate")
trace_contract.emit_replay_key("p0", "system_learning_memory_bridge")
trace_contract.emit_determinism_digest("p0", "system_learning_memory_bridge")
trace_contract._emit_signs_execution_trace("p0", "p0hash", "p0_trace", 0)
trace_contract._emit_authorize_and_execute("p2", "system_learning_memory_bridge", "execution_auth")
trace_contract._emit_validates_capability("p2", "system_learning_memory_bridge", "capability_check")
trace_contract._emit_routes_to_capability("p2", "system_learning_memory_bridge", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "system_learning_memory_bridge", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "system_learning_memory_bridge", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "system_learning_memory_bridge", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "system_learning_memory_bridge", "exec_output")
trace_contract._emit_dispatches_agent("p3", "system_learning_memory_bridge", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "system_learning_memory_bridge", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "system_learning_memory_bridge", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "system_learning_memory_bridge", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "system_learning_memory_bridge", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "system_learning_memory_bridge", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "system_learning_memory_bridge", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "system_learning_memory_bridge", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "system_learning_memory_bridge", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "system_learning_memory_bridge", "eval_metric")
trace_contract._emit_stores_embedding("p4", "system_learning_memory_bridge", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "system_learning_memory_bridge", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "system_learning_memory_bridge", "exec_snapshot_link")
...
class SystemLearningMemoryBridge:
    ...
    def _get_unified_memory_manager(self) -> Any:
        ...
        except ImportError:  # guardian: allow-return-none-swallow -- tools.implement_unified_memory moved to archive in W5.12; None signals unified memory unavailable, caller uses fallback path
