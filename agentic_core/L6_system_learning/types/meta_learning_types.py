...
trace_contract._emit_records_execution_trace("p0", "evidence", "meta_learning_types")
trace_contract._emit_applies_guardrail("p0", "meta_learning_types", "p0_governance")
trace_contract._emit_snapshots_state("p0", "meta_learning_types", "state_snapshot")
trace_contract._emit_pulls_context("p1", "meta_learning_types", "context_pull")
trace_contract._emit_pulls_context("p1", "meta_learning_types", "context_pull_secondary")
trace_contract._emit_execution_terminates_at_uwg("p1", "meta_learning_types", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "meta_learning_types", "uwg_term_secondary")
trace_contract._emit_writes_through("p1", "meta_learning_types", "write_through")
trace_contract._emit_writes_through("p1", "meta_learning_types", "write_through_secondary")
...
trace_contract._emit_escalates_to_human("p1", "meta_learning_types", "human_escalation")
trace_contract._emit_routes_through("p1", "meta_learning_types", "route_through")
