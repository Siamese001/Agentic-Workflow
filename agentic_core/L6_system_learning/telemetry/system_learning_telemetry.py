    ...
    def start_operation(
        ...
        **context_kwargs: Any,
        ...
        _emit_records_execution_trace(
            ...
            f"{self.component_name}.{operation_type.value}",
        )
        ...
        **additional_metrics: Any,
        ...
        if error:
            ...
            _emit_captures_runtime_anomaly(
                "p4obs",
                self.component_name,
                f"operation_error:{context.operation_type.value}",
            )
        ...
        if success and context.operation_type in [
            ...
            _emit_records_learning_event(
                "p3lm",
                self.component_name,
                f"operation_completed:{context.operation_type.value}",
            )
