...
_emit_checks_agent_registry("p1", "path_router", "agent_registry")
_emit_validates_agent_capability("p1", "path_router", "capability")
_emit_dispatches_execution_plan("p1", "path_router", "exec_plan")
_emit_agent_executes_agent("p1", "path_router", "sub_agent")
_emit_routes_to_agent("p1", "path_router", "target_agent")
_emit_verifies_policy("p1", "path_router", "policy_check")
_emit_observes_runtime_state("p1", "path_router", "runtime_state")
_emit_verifies_boundary("p1", "path_router", "boundary_check")
_emit_transcripts_response("p1", "path_router", "transcript")
_emit_hard_fails_untranscripted("p1", "path_router")
_emit_gated_by_confidence("p1", "path_router", "confidence_gate")
