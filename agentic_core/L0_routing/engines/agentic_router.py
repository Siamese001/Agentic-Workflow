...
class AgenticRouter:
    ...
    async def route(self, user_input: str, context: dict[str, Any] | None = None) -> RoutingDecision:
        ...
        if len(_candidate_routes) > 1:
            ...
            # guardian: allow-silent-swallow - acceptable exception handling    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context    # guardian: RoutingCapacityError should be handled with specific context
