...
class ComponentFactory:
    ...
    def get_verification_gate(cls, use_adapter: bool = True) -> VerificationGateProtocol | None:
        ...
        if use_adapter:
            try:
                from agentic_core.L0_routing.enforcement.safety_reasoning_seam import load_verification_gate_adapter
    ...
    def get_human_review_queue(cls, use_adapter: bool = True) -> HumanReviewProtocol | None:
        ...
        if use_adapter:
            try:
                from agentic_core.L0_routing.enforcement.safety_reasoning_seam import load_human_review_adapter
