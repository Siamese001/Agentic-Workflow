...
update QWEN_VLLM_MODEL; VLLM_MODEL_NAME is read only as a compatibility
fallback. Do NOT edit this file unless adding a new tier.
...
# QWEN_VLLM_MODEL is the canonical env var. VLLM_MODEL_NAME remains accepted
...
QWEN_LOCAL_MODEL_ID: Final[str] = os.getenv(
    "QWEN_VLLM_MODEL",
    os.getenv("VLLM_MODEL_NAME", CATALOG_QWEN_LOCAL_MODEL_ID),
)
