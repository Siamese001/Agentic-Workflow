...
def _check_l5_cert_ref_c0(ref: str) -> None:
    ...
    except Exception as exc:  # guardian: allow-log-and-swallow -- L5 registry must not crash C0 pipeline; treat as unverified  # guardian: allow-broad-exception -- P1 ADG burndown
