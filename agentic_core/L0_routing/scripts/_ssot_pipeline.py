...
emit_replay_key("p0", "_ssot_pipeline")
emit_determinism_digest("p0", "_ssot_pipeline")

_emit_dispatches_healing_run("p1", "_ssot_pipeline", "L0")
_emit_routes_through("p1", "_ssot_pipeline", "L0")
_emit_agent_executes_agent("p1", "_ssot_pipeline", "sub_agent")
_emit_verifies_policy("p1", "_ssot_pipeline", "policy_check")
_emit_observes_runtime_state("p1", "_ssot_pipeline", "runtime_state")
_emit_verifies_boundary("p1", "_ssot_pipeline", "boundary_check")
_emit_transcripts_response("p1", "_ssot_pipeline", "transcript")
_emit_hard_fails_untranscripted("p1", "_ssot_pipeline")
_emit_gated_by_confidence("p1", "_ssot_pipeline", "confidence_gate")
_emit_escalates_to_human("p1", "_ssot_pipeline", "L0")
_emit_reads_policy_state("p1", "_ssot_pipeline", "L0")
...
_emit_authorize_and_execute("p2", "_ssot_pipeline", "execution_auth")
_emit_validates_capability("p2", "_ssot_pipeline", "capability_check")
_emit_routes_to_capability("p2", "_ssot_pipeline", "capability_route")
_emit_writes_via_uwg("p2", "_ssot_pipeline", "uwg_write")
_emit_blocks_direct_write("p2", "_ssot_pipeline", "direct_write_block")
_emit_records_tool_invocation("p2", "_ssot_pipeline", "tool_invocation")
_emit_captures_execution_output("p2", "_ssot_pipeline", "exec_output")
_emit_dispatches_agent("p3", "_ssot_pipeline", "agent_dispatch")
_emit_coordinates_agents("p3", "_ssot_pipeline", "agent_coordination")
_emit_records_workflow_lineage("p3", "_ssot_pipeline", "workflow_lineage")
_emit_records_healing_outcome("p3", "_ssot_pipeline", "healing_outcome")
_emit_escalates_failure("p3", "_ssot_pipeline", "failure_escalation")
_emit_orchestrates_workflow("p3", "_ssot_pipeline", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "_ssot_pipeline", "healing_dispatch")
_emit_invokes_evaluation("p3", "_ssot_pipeline", "evaluation_signal")
_emit_records_telemetry_event("p4", "_ssot_pipeline", "telemetry_event")
_emit_captures_evaluation_metric("p4", "_ssot_pipeline", "eval_metric")
...
_emit_emits_metric_event("_ssot_pipeline", "p4obs", "metric_1")
_emit_emits_metric_event("_ssot_pipeline", "p4obs", "metric_2")
_emit_emits_metric_event("_ssot_pipeline", "p4obs", "metric_3")
_emit_emits_metric_event("_ssot_pipeline", "p4obs", "metric_4")
_emit_emits_metric_event("_ssot_pipeline", "p4obs", "metric_5")
_emit_emits_metric_event("_ssot_pipeline", "p4obs", "metric_6")
_emit_records_incident_event("_ssot_pipeline", "p4obs", "incident")
_emit_captures_runtime_anomaly("_ssot_pipeline", "p4obs", "anomaly")
_emit_writes_observability_log("_ssot_pipeline", "p4obs", "obs_log")
_emit_updates_monitoring_state("_ssot_pipeline", "p4obs", "mon_state")
_emit_triggers_alert("_ssot_pipeline", "p4obs", "alert")
_emit_links_incident_trace("_ssot_pipeline", "p4obs", "trace_link")
_emit_captures_pattern("_ssot_pipeline", "p3lm", "pattern")
_emit_records_learning_event("_ssot_pipeline", "p3lm", "learning_event")
_emit_writes_learning_snapshot("_ssot_pipeline", "p3lm", "snapshot")
_emit_feeds_meta_learning("_ssot_pipeline", "p3lm", "meta_feed")
_emit_updates_routing_strategy("_ssot_pipeline", "p3lm", "routing")
_emit_improves_agent_policy("_ssot_pipeline", "p3lm", "policy")
_emit_stores_learning_state("_ssot_pipeline", "p3lm", "state")
_emit_records_execution_trace("_ssot_pipeline", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("_ssot_pipeline", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("_ssot_pipeline", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("_ssot_pipeline", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("_ssot_pipeline", "L4_STATE", "p2_trace_5")
_emit_reads_environ("_ssot_pipeline", "env_read", "p2_env_1")
_emit_reads_environ("_ssot_pipeline", "env_read", "p2_env_2")
_emit_reads_runtime_state("_ssot_pipeline", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("_ssot_pipeline", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "_ssot_pipeline", "context_pull")
_emit_pulls_context("p1", "_ssot_pipeline", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "_ssot_pipeline", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "_ssot_pipeline", "uwg_term_2")
_emit_writes_through("p1", "_ssot_pipeline", "write_through")
_emit_writes_through("p1", "_ssot_pipeline", "write_through_2")
