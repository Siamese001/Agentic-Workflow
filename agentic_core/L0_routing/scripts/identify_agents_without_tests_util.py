...
layer_priority = {'L6_Observability': 1, 'L5 Safety': 2, 'L4 State': 3, 'L3 Orchestration': 4, 'L2 Execution': 5, 'L1 Cognition': 6, 'L0 Maintenance': 7, 'Apps': 8, 'Utils': 9}
...
high_layer = [a for a in agents_without_tests if any((a.get('territory', '').startswith(layer) for layer in ['L6_Observability', 'L5 Safety', 'L4 State'])) and a not in base_agents]
