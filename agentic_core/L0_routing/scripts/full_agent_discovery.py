...
def main() -> bool:
    ...
    try:
        ...
        if not check_compliance_gate(validation_stats):    # guardian: DiscoveryError should be handled with specific context    # guardian: DiscoveryError should be handled with specific context    # guardian: DiscoveryError should be handled with specific context    # guardian: DiscoveryError should be handled with specific context    # guardian: DiscoveryError should be handled with specific context    # guardian: DiscoveryError should be handled with specific context    # guardian: DiscoveryError should be handled with specific context
...
def analyze_agent_integrity(file_path: Path) -> AgentIntegrityReport:
    ...
    try:
        ...
        if file_type == "IGNORE":    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime    # guardian: Syntax errors should be caught at parser level, not runtime
