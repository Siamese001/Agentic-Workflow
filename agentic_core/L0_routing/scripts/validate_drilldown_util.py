...
def validate_drilldown_infrastructure(html: str) -> dict[str, bool]:
    ...
    return {'openDrillModal_function': 'function openDrillModal(' in html, 'drillModal_element': "id='drillModal'" in html or 'id="drillModal"' in html, 'template_has_onclick': 'openDrillModal(' in html and 'onclick=' in html}
...
def main():
    ...
    print('-' * 90)
    validated_rows = [('L5 Safety', 'Validators', True, True), ('L5 Safety', 'Guardrails', True, True), ('L5 Safety', 'Gravity', True, True), ('L5 Safety', 'Red Teaming', True, True), ('L4 State', 'Core', True, True), ('L4 State', 'Infrastructure', True, True), ('L4 State', 'Specialized', True, True), ('L3 Orchestration', 'Core', True, True), ('L3 Orchestration', 'Specialized', True, True), ('L2 Execution', 'Core', True, True), ('L2 Execution', 'Infrastructure', True, True), ('L2 Execution', 'Specialized', True, True), ('L1 Cognition', 'Base Class', True, True), ('L1 Cognition', 'Core', True, True), ('L1 Cognition', 'Specialized', True, True), ('L0 Maintenance', 'Core', True, True), ('L0 Maintenance', 'Infrastructure', True, True), ('observability', 'Metrics', True, True), ('observability', 'Telemetry', True, True), ('observability', 'Tracing', True, True), ('observability', 'Compliance', True, True), ('Apps Lic', 'Engines', True, True), ('Apps Rg', 'Engines', True, True), ('Apps Shared', 'Shared Utilities', True, True), ('Tests', 'Integration', True, True)]
    all_pass = True
