...
CANONICAL_BASE_AGENTS = {'L0': 'L0RoutingBaseAgent', 'L1': 'L1CognitionBase', 'L2': 'L2Agent', 'L3': 'L3Agent', 'L4': 'L4Agent', 'L5': 'L5Agent', 'L6': 'L6ObservabilityBase'}
...
def find_base_agents() -> dict[str, list[dict]]:
    ...
    for agent in data:
        ...
        is_base_agent = 'BaseAgent' in class_name or class_name in CANONICAL_BASE_AGENTS.values() or 'base_class' in agent.get('path', '').lower()
