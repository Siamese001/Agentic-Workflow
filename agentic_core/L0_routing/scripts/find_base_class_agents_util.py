...
print(f"{'=' * 70}\n")
territory_mappings = {'Base/Base Class': 'Sovereign Base Agent', 'L6_Observability/Base Class': 'L6_Observability/Base Agent', 'L5 Safety/Base Class': 'L5 Safety/Base Agent', 'L4 State/Base Class': 'L4 State/Base Agent', 'L3 Orchestration/Base Class': 'L3 Orchestration/Base Agent', 'L2 Execution/Base Class': 'L2 Execution/Base Agent', 'L1 Cognition/Base Class': 'L1 Cognition/Base Agent', 'L0 Maintenance/Base Class': 'L0 Maintenance/Base Agent'}
