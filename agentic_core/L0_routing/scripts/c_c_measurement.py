...
class CCMeasurement:
    ...
    def analyze_results(self, data: dict) -> dict:
        ...
        Returns:
            Analyzed metrics
        """
        metrics = {'total_functions': 0, 'total_cc': 0, 'average_cc': 0.0, 'functions_cc_gt_10': [], 'functions_cc_gt_15': [], 'functions_cc_gt_20': [], 'files_analyzed': 0}
        if not data:
            return metrics
        all_functions = []
    ...
    def compare_reports(self, baseline: dict, current: dict) -> dict:
        ...
        Returns:
            Comparison results
        """
        comparison = {'total_cc_change': current['total_cc'] - baseline['total_cc'], 'total_cc_percent_change': 0.0, 'average_cc_change': current['average_cc'] - baseline['average_cc'], 'functions_cc_gt_10_change': len(current['functions_cc_gt_10']) - len(baseline['functions_cc_gt_10']), 'functions_cc_gt_15_change': len(current['functions_cc_gt_15']) - len(baseline['functions_cc_gt_15']), 'functions_cc_gt_20_change': len(current['functions_cc_gt_20']) - len(baseline['functions_cc_gt_20'])}
