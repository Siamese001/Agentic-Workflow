                ...
                candidates.append(
                    {
                        ...
                        "signals": signals,    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling    # guardian: File operations with encoding need error-specific handling
                    },
                )
        # guardian: allow-silent-swallow - acceptable exception handling
        except (OSError, UnicodeDecodeError) as e:
