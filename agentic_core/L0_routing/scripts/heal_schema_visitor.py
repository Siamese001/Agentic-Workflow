...
NON_CANONICAL_MAPPINGS = {'total_violations': 'violations_found', 'violations': 'violations_found', 'count': 'violations_found', 'issues': 'violations_found', 'problems': 'violations_found', 'findings': 'violations_found', 'fixed_count': 'violations_fixed', 'fixed': 'violations_fixed', 'healed': 'violations_fixed', 'repaired': 'violations_fixed', 'resolved': 'violations_fixed', 'renamed': 'violations_fixed', 'moved': 'violations_fixed', 'deleted': 'violations_fixed', 'created': 'violations_fixed', 'error_count': 'errors', 'failures': 'errors', 'skip_count': 'skipped', 'ignored': 'skipped'}
        ...
        for key in dict_node.keys:
            if isinstance(key, ast.Constant) and isinstance(key.value, str):
                ...
                if key_name in NON_CANONICAL_MAPPINGS:
                    ...
                    self.violations.append({'file': self.filepath, 'line': lineno, 'method': self.current_method_name, 'key': key_name, 'canonical': canonical, 'message': f"Use '{canonical}' instead of '{key_name}'"})
