...
emit_replay_key("p0", "_ssot_phases")
emit_determinism_digest("p0", "_ssot_phases")

_emit_dispatches_healing_run("p1", "_ssot_phases", "L0")
_emit_routes_through("p1", "_ssot_phases", "L0")
_emit_checks_agent_registry("p1", "_ssot_phases", "agent_registry")
_emit_validates_agent_capability("p1", "_ssot_phases", "capability")
_emit_dispatches_execution_plan("p1", "_ssot_phases", "exec_plan")
_emit_agent_executes_agent("p1", "_ssot_phases", "sub_agent")
_emit_routes_to_agent("p1", "_ssot_phases", "target_agent")
_emit_verifies_policy("p1", "_ssot_phases", "policy_check")
_emit_observes_runtime_state("p1", "_ssot_phases", "runtime_state")
_emit_verifies_boundary("p1", "_ssot_phases", "boundary_check")
_emit_transcripts_response("p1", "_ssot_phases", "transcript")
_emit_hard_fails_untranscripted("p1", "_ssot_phases")
_emit_gated_by_confidence("p1", "_ssot_phases", "confidence_gate")
_emit_escalates_to_human("p1", "_ssot_phases", "L0")
_emit_reads_policy_state("p1", "_ssot_phases", "L0")
_emit_authorize_and_execute("p2", "_ssot_phases", "execution_auth")
_emit_validates_capability("p2", "_ssot_phases", "capability_check")
_emit_routes_to_capability("p2", "_ssot_phases", "capability_route")
_emit_writes_via_uwg("p2", "_ssot_phases", "uwg_write")
_emit_blocks_direct_write("p2", "_ssot_phases", "direct_write_block")
_emit_records_tool_invocation("p2", "_ssot_phases", "tool_invocation")
_emit_captures_execution_output("p2", "_ssot_phases", "exec_output")
_emit_dispatches_agent("p3", "_ssot_phases", "agent_dispatch")
_emit_coordinates_agents("p3", "_ssot_phases", "agent_coordination")
_emit_records_workflow_lineage("p3", "_ssot_phases", "workflow_lineage")
_emit_records_healing_outcome("p3", "_ssot_phases", "healing_outcome")
_emit_escalates_failure("p3", "_ssot_phases", "failure_escalation")
_emit_orchestrates_workflow("p3", "_ssot_phases", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "_ssot_phases", "healing_dispatch")
_emit_invokes_evaluation("p3", "_ssot_phases", "evaluation_signal")
_emit_records_telemetry_event("p4", "_ssot_phases", "telemetry_event")
_emit_captures_evaluation_metric("p4", "_ssot_phases", "eval_metric")
...
_emit_emits_metric_event("_ssot_phases", "p4obs", "metric_1")
_emit_emits_metric_event("_ssot_phases", "p4obs", "metric_2")
_emit_emits_metric_event("_ssot_phases", "p4obs", "metric_3")
_emit_emits_metric_event("_ssot_phases", "p4obs", "metric_4")
_emit_emits_metric_event("_ssot_phases", "p4obs", "metric_5")
_emit_emits_metric_event("_ssot_phases", "p4obs", "metric_6")
_emit_records_incident_event("_ssot_phases", "p4obs", "incident")
_emit_captures_runtime_anomaly("_ssot_phases", "p4obs", "anomaly")
_emit_writes_observability_log("_ssot_phases", "p4obs", "obs_log")
_emit_updates_monitoring_state("_ssot_phases", "p4obs", "mon_state")
_emit_triggers_alert("_ssot_phases", "p4obs", "alert")
_emit_links_incident_trace("_ssot_phases", "p4obs", "trace_link")
_emit_captures_pattern("_ssot_phases", "p3lm", "pattern")
_emit_records_learning_event("_ssot_phases", "p3lm", "learning_event")
_emit_writes_learning_snapshot("_ssot_phases", "p3lm", "snapshot")
_emit_feeds_meta_learning("_ssot_phases", "p3lm", "meta_feed")
_emit_updates_routing_strategy("_ssot_phases", "p3lm", "routing")
_emit_improves_agent_policy("_ssot_phases", "p3lm", "policy")
_emit_stores_learning_state("_ssot_phases", "p3lm", "state")
_emit_records_execution_trace("_ssot_phases", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("_ssot_phases", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("_ssot_phases", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("_ssot_phases", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("_ssot_phases", "L4_STATE", "p2_trace_5")
_emit_reads_environ("_ssot_phases", "env_read", "p2_env_1")
_emit_reads_environ("_ssot_phases", "env_read", "p2_env_2")
_emit_reads_runtime_state("_ssot_phases", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("_ssot_phases", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "_ssot_phases", "context_pull")
_emit_pulls_context("p1", "_ssot_phases", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "_ssot_phases", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "_ssot_phases", "uwg_term_2")
_emit_writes_through("p1", "_ssot_phases", "write_through")
_emit_writes_through("p1", "_ssot_phases", "write_through_2")
...
class RuntimeStateManager:
    ...
    def save(self):
        ...
        try:
            ...
            self.state["runtime_state_digest_sha256"] = compute_runtime_state_digest(self.state)    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation    # guardian: Permission errors should validate access before operation
        ...
        for idx, (agent_key, agent_violations) in enumerate(agent_items, 1):
            ...
            try:
                ...
                logging.warning(
                    ...
                    agent_key,    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context
