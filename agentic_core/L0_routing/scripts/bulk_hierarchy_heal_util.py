...
from agentic_core.L0_routing.enforcement.mutation_prohibition import assert_no_persistent_write, safe_shutil_rmtree
        ...
        for layer_folder in target_dir.iterdir():
            ...
            for legacy in legacy_partitions:
                ...
                if legacy_path.exists():
                    remaining: Any = [f for f in legacy_path.iterdir() if f.name != '__pycache__' and f.name != '__init__.py']
                    if not remaining:
                        try:
