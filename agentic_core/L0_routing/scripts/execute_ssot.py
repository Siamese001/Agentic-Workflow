...
def _configure_logging(verbosity: int) -> None:
    ...
    if verbosity >= 2:
        level = logging.DEBUG    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access    # guardian: File operations should check existence before access
    elif verbosity == 1:
        level = logging.INFO
...
class ReconciliationManifest:
    ...
    def finalize(self) -> dict[str, Any]:
        ...
        }    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling    # guardian: Multiple exceptions (OSError, SyntaxError) need specific handling
        ...
        for idx, (agent_key, agent_violations) in enumerate(agent_items, 1):
            ...
            try:
                ...
                state_mgr.update_agent(
                    agent_key, f"[{reason.split('(')[0].strip()}] Healing {len(agent_violations)} violations"    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context    # guardian: FuturesTimeoutError should be handled with specific context
                )
                logging.warning(
...
def main() -> int:
    ...
    pre_parser.add_argument(    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context    # guardian: SystemExit should be handled with specific context
        "--v15-enforcement",
        type=int,
        choices=(0, 1),
        default=None,
...
def _compute_pipeline_digest(targets: "list[str]") -> str:    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context    # guardian: SourceMutationBlocked should be handled with specific context
