...
_emit_checks_agent_registry("p1", "boundary_contracts", "agent_registry")
_emit_validates_agent_capability("p1", "boundary_contracts", "capability")
_emit_dispatches_execution_plan("p1", "boundary_contracts", "exec_plan")
_emit_agent_executes_agent("p1", "boundary_contracts", "sub_agent")
_emit_routes_to_agent("p1", "boundary_contracts", "target_agent")
_emit_verifies_policy("p1", "boundary_contracts", "policy_check")
_emit_observes_runtime_state("p1", "boundary_contracts", "runtime_state")
_emit_verifies_boundary("p1", "boundary_contracts", "boundary_check")
_emit_transcripts_response("p1", "boundary_contracts", "transcript")
_emit_hard_fails_untranscripted("p1", "boundary_contracts")
_emit_gated_by_confidence("p1", "boundary_contracts", "confidence_gate")
