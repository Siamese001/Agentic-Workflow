...
def get_default_protected_root_policy() -> ProtectedRootPolicy:
    ...
    return ProtectedRootPolicy(
        immutable_roots=(AGENTIC_CORE_DIR, TESTS_DIR, ".github", ".codex/rules"),
...
def assert_no_persistent_write(
    ...
    if path is not None:
        try:
            from agentic_core.L2_execution.utils.write_gateway import (  # guardian: allow-layer-violation -- L0 module uses L2 type/utility; intentional cross-layer dependency in enforcement/routing layer
