...
_emit_dispatches_healing_run("p1", "routing_contract", "L0")
_emit_routes_through("p1", "routing_contract", "L0")
_emit_checks_agent_registry("p1", "routing_contract", "agent_registry")
_emit_validates_agent_capability("p1", "routing_contract", "capability")
_emit_dispatches_execution_plan("p1", "routing_contract", "exec_plan")
_emit_agent_executes_agent("p1", "routing_contract", "sub_agent")
_emit_routes_to_agent("p1", "routing_contract", "target_agent")
_emit_observes_runtime_state("p1", "routing_contract", "runtime_state")
_emit_verifies_boundary("p1", "routing_contract", "boundary_check")
_emit_transcripts_response("p1", "routing_contract", "transcript")
_emit_hard_fails_untranscripted("p1", "routing_contract")
_emit_gated_by_confidence("p1", "routing_contract", "confidence_gate")
_emit_escalates_to_human("p1", "routing_contract", "L0")
_emit_reads_policy_state("p1", "routing_contract", "L0")

_emit_applies_guardrail("p0", "routing_contract", "p0_governance")
_emit_authorize_and_execute("p2", "routing_contract", "execution_auth")
_emit_validates_capability("p2", "routing_contract", "capability_check")
_emit_routes_to_capability("p2", "routing_contract", "capability_route")
_emit_writes_via_uwg("p2", "routing_contract", "uwg_write")
_emit_blocks_direct_write("p2", "routing_contract", "direct_write_block")
_emit_records_tool_invocation("p2", "routing_contract", "tool_invocation")
_emit_captures_execution_output("p2", "routing_contract", "exec_output")
_emit_dispatches_agent("p3", "routing_contract", "agent_dispatch")
_emit_coordinates_agents("p3", "routing_contract", "agent_coordination")
_emit_records_workflow_lineage("p3", "routing_contract", "workflow_lineage")
_emit_records_healing_outcome("p3", "routing_contract", "healing_outcome")
_emit_escalates_failure("p3", "routing_contract", "failure_escalation")
_emit_orchestrates_workflow("p3", "routing_contract", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "routing_contract", "healing_dispatch")
_emit_invokes_evaluation("p3", "routing_contract", "evaluation_signal")
_emit_records_telemetry_event("p4", "routing_contract", "telemetry_event")
_emit_captures_evaluation_metric("p4", "routing_contract", "eval_metric")
...
_emit_emits_metric_event("routing_contract", "p4obs", "metric_1")
_emit_emits_metric_event("routing_contract", "p4obs", "metric_2")
_emit_emits_metric_event("routing_contract", "p4obs", "metric_3")
_emit_emits_metric_event("routing_contract", "p4obs", "metric_4")
_emit_emits_metric_event("routing_contract", "p4obs", "metric_5")
_emit_emits_metric_event("routing_contract", "p4obs", "metric_6")
_emit_records_incident_event("routing_contract", "p4obs", "incident")
_emit_captures_runtime_anomaly("routing_contract", "p4obs", "anomaly")
_emit_writes_observability_log("routing_contract", "p4obs", "obs_log")
_emit_updates_monitoring_state("routing_contract", "p4obs", "mon_state")
_emit_triggers_alert("routing_contract", "p4obs", "alert")
_emit_links_incident_trace("routing_contract", "p4obs", "trace_link")
_emit_captures_pattern("routing_contract", "p3lm", "pattern")
_emit_records_learning_event("routing_contract", "p3lm", "learning_event")
_emit_writes_learning_snapshot("routing_contract", "p3lm", "snapshot")
_emit_feeds_meta_learning("routing_contract", "p3lm", "meta_feed")
_emit_updates_routing_strategy("routing_contract", "p3lm", "routing")
_emit_improves_agent_policy("routing_contract", "p3lm", "policy")
_emit_stores_learning_state("routing_contract", "p3lm", "state")
_emit_records_execution_trace("routing_contract", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("routing_contract", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("routing_contract", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("routing_contract", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("routing_contract", "L4_STATE", "p2_trace_5")
_emit_reads_environ("routing_contract", "env_read", "p2_env_1")
_emit_reads_environ("routing_contract", "env_read", "p2_env_2")
_emit_reads_runtime_state("routing_contract", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("routing_contract", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "routing_contract", "context_pull")
_emit_pulls_context("p1", "routing_contract", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "routing_contract", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "routing_contract", "uwg_term_2")
_emit_writes_through("p1", "routing_contract", "write_through")
_emit_writes_through("p1", "routing_contract", "write_through_2")
_emit_validated_by_safety_plane("p1", "routing_contract", "safety_validation")
_emit_invokes_eval("p1", "routing_contract", "eval_call")
_emit_proposal_commits_routing("p1", "routing_contract", "routing_commit")
...
def create_and_commit_routing_contract(
    ...
    *,
    ...
    except Exception as _optimization_exc:
