...
class TraceIdGenerator:
    ...
    def generate_trace_id(self, semantic_clock: SemanticClockSnapshot, operation: str, additional_context: str | None=None) -> str:
    ...
    def is_replay_deterministic(self, trace_id1: str, trace_id2: str, semantic_clock: SemanticClockSnapshot, operation: str, additional_context: str | None=None) -> bool:
...
def generate_trace_id(semantic_clock: SemanticClockSnapshot, operation: str, additional_context: str | None=None, replay_mode: bool=False) -> str:
    """Generate a TraceID.
