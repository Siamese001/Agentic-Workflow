...
_emit_checks_agent_registry("p1", "RootCustomsAgent", "agent_registry")
_emit_validates_agent_capability("p1", "RootCustomsAgent", "capability")
_emit_dispatches_execution_plan("p1", "RootCustomsAgent", "exec_plan")
_emit_agent_executes_agent("p1", "RootCustomsAgent", "sub_agent")
_emit_routes_to_agent("p1", "RootCustomsAgent", "target_agent")
_emit_verifies_policy("p1", "RootCustomsAgent", "policy_check")
_emit_observes_runtime_state("p1", "RootCustomsAgent", "runtime_state")
_emit_verifies_boundary("p1", "RootCustomsAgent", "boundary_check")
_emit_transcripts_response("p1", "RootCustomsAgent", "transcript")
_emit_hard_fails_untranscripted("p1", "RootCustomsAgent")
_emit_gated_by_confidence("p1", "RootCustomsAgent", "confidence_gate")
