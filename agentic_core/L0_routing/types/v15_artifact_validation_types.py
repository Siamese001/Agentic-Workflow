...
def _require_str(d: dict[str, Any], key: str, artifact_name: str) -> None:
    ...
    if not isinstance(val, str) or not val:
        raise ValueError(
            f"VALIDATE_{artifact_name}:MISSING_OR_INVALID_FIELD|"
            f"field={key}|value={val!r}|expected=non_empty_str"
        )
...
def _require_sequence_of_str(d: dict[str, Any], key: str, artifact_name: str) -> None:
    ...
    if not isinstance(val, (list, tuple)):
        raise ValueError(
            f"VALIDATE_{artifact_name}:MISSING_OR_INVALID_FIELD|"
            f"field={key}|value={val!r}|expected=sequence_of_str"
        )
...
# ─────────────────────────────────────────────────────────────────────
# §10.4 — ResultArtifact validator + bridge
# ─────────────────────────────────────────────────────────────────────
...
def validate_result_artifact(obj: object) -> dict[str, Any]:
    ...
    # emitting_layer defaults to "L2" if absent
...
# ─────────────────────────────────────────────────────────────────────
# §1.7 — HealingPlan validator + bridge
# ─────────────────────────────────────────────────────────────────────
...
def validate_healing_plan(obj: object) -> dict[str, Any]:
    ...
    # Coerce tuple manifests to list for JSON alignment
...
# ─────────────────────────────────────────────────────────────────────
# §15.6 — IncidentArtifact validator + bridge
# ─────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────
# §2.5 — StaleWriteIncident validator + bridge
# ─────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────
# Factory helpers (construction-time validation from dataclass)
# ─────────────────────────────────────────────────────────────────────
