...
trace_contract._emit_authorize_and_execute("p2", "TemplateRegistry", "execution_auth")
trace_contract._emit_validates_capability("p2", "TemplateRegistry", "capability_check")
trace_contract._emit_routes_to_capability("p2", "TemplateRegistry", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "TemplateRegistry", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "TemplateRegistry", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "TemplateRegistry", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "TemplateRegistry", "exec_output")
trace_contract._emit_dispatches_agent("p3", "TemplateRegistry", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "TemplateRegistry", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "TemplateRegistry", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "TemplateRegistry", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "TemplateRegistry", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "TemplateRegistry", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "TemplateRegistry", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "TemplateRegistry", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "TemplateRegistry", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "TemplateRegistry", "eval_metric")
trace_contract._emit_stores_embedding("p4", "TemplateRegistry", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "TemplateRegistry", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "TemplateRegistry", "exec_snapshot_link")
trace_contract._emit_dispatches_healing_run("p1", "TemplateRegistry", "L0")
trace_contract._emit_routes_through("p1", "TemplateRegistry", "L0")
trace_contract._emit_checks_agent_registry("p1", "TemplateRegistry", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "TemplateRegistry", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "TemplateRegistry", "exec_plan")
trace_contract._emit_routes_to_agent("p1", "TemplateRegistry", "target_agent")
trace_contract._emit_verifies_policy("p1", "TemplateRegistry", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "TemplateRegistry", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "TemplateRegistry", "boundary_check")
trace_contract._emit_transcripts_response("p1", "TemplateRegistry", "transcript")
trace_contract._emit_gated_by_confidence("p1", "TemplateRegistry", "confidence_gate")
trace_contract._emit_escalates_to_human("p1", "TemplateRegistry", "L0")
trace_contract._emit_reads_policy_state("p1", "TemplateRegistry", "L0")
trace_contract._emit_signs_execution_trace("p0", "p0hash", "p0_trace", 0)
trace_contract._emit_applies_guardrail("p0", "TemplateRegistry", "p0_governance")
trace_contract._emit_snapshots_state("p0", "TemplateRegistry", "state_snapshot")
