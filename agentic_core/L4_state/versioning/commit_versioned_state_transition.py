...
def commit_versioned_state_transition(
    ...
    *,
    ...
    except StateVersionMissingError:    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context    # guardian: StateVersionMissingError should be handled with specific context
