    ...
    def read(
        ...
        *,
        ...
        if state_namespace:
            ...
            except (StateVersionMissingError, UnversionedStateError) as exc:    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, UnversionedStateError) need specific handling
                logger.warning(
