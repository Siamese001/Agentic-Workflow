...
class RunStateAuthority(WriteGovernorMixin):
    ...
    def read(self, key: str, default: Any = None, state_namespace: str = "") -> tuple[Any, int]:
        ...
        if state_namespace:
            ...
            except (StateVersionMissingError, StateNamespaceError, UnversionedStateError) as exc:    # guardian: Multiple exceptions (StateVersionMissingError, StateNamespaceError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, StateNamespaceError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, StateNamespaceError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, StateNamespaceError) need specific handling    # guardian: Multiple exceptions (StateVersionMissingError, StateNamespaceError) need specific handling
                logger.warning(
    ...
    def commit(
        ...
        except (StateNamespaceError, StateVersionMissingError, StateConflictError) as exc:    # guardian: Multiple exceptions (StateNamespaceError, StateVersionMissingError) need specific handling    # guardian: Multiple exceptions (StateNamespaceError, StateVersionMissingError) need specific handling    # guardian: Multiple exceptions (StateNamespaceError, StateVersionMissingError) need specific handling    # guardian: Multiple exceptions (StateNamespaceError, StateVersionMissingError) need specific handling    # guardian: Multiple exceptions (StateNamespaceError, StateVersionMissingError) need specific handling
            logger.error(
