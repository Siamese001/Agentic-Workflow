...
_emit_checks_agent_registry("p1", "memory_authority", "agent_registry")
_emit_validates_agent_capability("p1", "memory_authority", "capability")
_emit_dispatches_execution_plan("p1", "memory_authority", "exec_plan")
_emit_agent_executes_agent("p1", "memory_authority", "sub_agent")
_emit_routes_to_agent("p1", "memory_authority", "target_agent")
_emit_verifies_policy("p1", "memory_authority", "policy_check")
_emit_observes_runtime_state("p1", "memory_authority", "runtime_state")
_emit_verifies_boundary("p1", "memory_authority", "boundary_check")
_emit_transcripts_response("p1", "memory_authority", "transcript")
_emit_hard_fails_untranscripted("p1", "memory_authority")
_emit_gated_by_confidence("p1", "memory_authority", "confidence_gate")
