...
class L2SemanticCache:
    ...
    def _get_embedding(self, text: str) -> list[float] | None:
        ...
        try:
            ...
            TypeError,
            ValueError,
        ) as e:  # guardian: allow-return-none-swallow allow-log-and-swallow -- embedding: non-fatal, caller treats None as unavailable
...
class L3SemanticRAG:
    ...
    def _get_embedding(self, text: str) -> list[float] | None:
        ...
        try:
            ...
            RuntimeError,
            ImportError,
        ) as e:  # guardian: allow-return-none-swallow allow-log-and-swallow -- BGE-M3 embedding: non-fatal, caller handles None as unavailable source
