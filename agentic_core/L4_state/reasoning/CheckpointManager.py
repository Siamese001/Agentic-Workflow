...
class CheckpointManager(SovereignBaseAgent):
    ...
    def create_checkpoint(
        ...
        if self.mode == "SYNC":  # review: Runtime errors should be prevented with proper validation
    ...
    def _run_self_tests(self) -> dict[str, Any]:
        """Run internal self-tests for the unified checkpoint manager."""  # review: AssertionError should be handled with specific context
