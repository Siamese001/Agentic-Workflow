...
def default_routing(ctx: Mapping[str, Any]) -> bool:  # noqa: ARG001
...
ROUTING_PREDICATES: tuple[RoutingPredicate, ...] = (
    RoutingPredicate(
        name="requires_policy_read",
        predicate=requires_policy_read,
    ...
    RoutingPredicate(
        name="invalid_ast_detected",
        predicate=invalid_ast_detected,
        provider=Provider.OPUS,
    ),
    RoutingPredicate(
        name="default_routing",
        predicate=default_routing,
