...
_emit_checks_agent_registry("p1", "memory_store_config", "agent_registry")
_emit_validates_agent_capability("p1", "memory_store_config", "capability")
_emit_dispatches_execution_plan("p1", "memory_store_config", "exec_plan")
_emit_agent_executes_agent("p1", "memory_store_config", "sub_agent")
_emit_routes_to_agent("p1", "memory_store_config", "target_agent")
_emit_verifies_policy("p1", "memory_store_config", "policy_check")
_emit_observes_runtime_state("p1", "memory_store_config", "runtime_state")
_emit_verifies_boundary("p1", "memory_store_config", "boundary_check")
_emit_transcripts_response("p1", "memory_store_config", "transcript")
_emit_hard_fails_untranscripted("p1", "memory_store_config")
_emit_gated_by_confidence("p1", "memory_store_config", "confidence_gate")
