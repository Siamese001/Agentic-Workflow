...
trace_contract._emit_dispatches_healing_run("p1", "policy_registry_cache", "L4")
trace_contract._emit_routes_through("p1", "policy_registry_cache", "L4")
...
trace_contract._emit_escalates_to_human("p1", "policy_registry_cache", "L4")
trace_contract._emit_reads_policy_state("p1", "policy_registry_cache", "L4")
...
class PolicyRegistryCache:
    ...
    def get_or_fetch(self, policy_id: str, fetch_policy: Any, *, replay_mode: bool = False) -> dict[str, Any]:
        ...
        *fetch_policy* is a zero-argument callable that fetches the policy
        ...
        trace_contract._emit_snapshots_state(str(_uuid.uuid4()), "PolicyRegistryCache.get_or_fetch", "state_snapshot")
        ...
        trace_contract._emit_applies_guardrail(str(_uuid.uuid4()), "PolicyRegistryCache.get_or_fetch", "p0_governance")
        import uuid as _uuid  # noqa: PLC0415

        _trace_id = str(_uuid.uuid4())
        trace_contract._emit_records_execution_trace(_trace_id, trace_contract.LayerSegment.L4_STATE, "PolicyRegistryCache.get_or_fetch")
