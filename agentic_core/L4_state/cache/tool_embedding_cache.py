...
_emit_dispatches_healing_run("p1", "tool_embedding_cache", "L4")
_emit_routes_through("p1", "tool_embedding_cache", "L4")
...
_emit_escalates_to_human("p1", "tool_embedding_cache", "L4")
_emit_reads_policy_state("p1", "tool_embedding_cache", "L4")
...
class ToolEmbeddingCache:
    ...
    def get_or_fetch(
        ...
        *fetch_embeddings* is a zero-argument callable that computes and returns
        ...
        _emit_records_execution_trace(_trace_id, LayerSegment.L4_STATE, "ToolEmbeddingCache.get_or_fetch")
