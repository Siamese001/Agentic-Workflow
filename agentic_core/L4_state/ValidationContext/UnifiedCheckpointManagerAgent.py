...
def get_sync_checkpoint_manager(storage_path: Optional[Path] = None) -> UnifiedCheckpointManagerAgent:
...
def get_autonomous_checkpoint_manager(storage_path: Optional[Path] = None) -> UnifiedCheckpointManagerAgent:
