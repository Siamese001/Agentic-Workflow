...
Migration:
    ...
    # For synchronous checkpoints (legacy behavior):
    manager = get_sync_checkpoint_manager()
"""
import warnings
warnings.warn(
    "CheckpointManagerAgent is deprecated. Use UnifiedCheckpointManagerAgent instead.",
    DeprecationWarning,
    stacklevel=2
)
