...
class ReplayBundle:
    ...
    def __post_init__(self) -> None:
        ...
        if self.execution_end_tick < self.execution_start_tick:
            raise ValueError(
                f"ReplayBundle: execution_end_tick ({self.execution_end_tick}) "
                f"must be >= execution_start_tick ({self.execution_start_tick})"
            )
        ...
        # Normalise: sort all list fields for determinism
        ...
        # Compute replay_hash after all validation and normalisation
