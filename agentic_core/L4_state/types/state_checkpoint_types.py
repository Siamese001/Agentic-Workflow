...
_emit_pulls_context("p1", "state_checkpoint_types", "context_pull_secondary")
_emit_execution_terminates_at_uwg("p1", "state_checkpoint_types", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "state_checkpoint_types", "uwg_term_secondary")
_emit_writes_through("p1", "state_checkpoint_types", "write_through")
_emit_writes_through("p1", "state_checkpoint_types", "write_through_secondary")
