...
class GraphMemoryBridge:
    ...
    _instance: Optional[GraphMemoryBridge] = None
    ...
    def __init__(self):
        ...
        self._create_entities_fn: Optional[Callable] = None
        self._create_relations_fn: Optional[Callable] = None
        self._add_observations_fn: Optional[Callable] = None
        self._search_nodes_fn: Optional[Callable] = None
    ...
    def set_mcp_functions(
        self,
        create_entities: Optional[Callable] = None,
        create_relations: Optional[Callable] = None,
        add_observations: Optional[Callable] = None,
        search_nodes: Optional[Callable] = None,
    ) -> None:
        """
    ...
    def create_mastered_task_relation(
        ...
        if result is not None or self._create_relations_fn is None:
            ...
            Logger.info(
                f"[GraphMemoryBridge] MASTERED_TASK relation created: "
                f"{agent_name} -> {task_entity_name}"
            )
            return True
