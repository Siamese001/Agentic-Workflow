...
_emit_checks_agent_registry("p1", "genealogy_registry", "agent_registry")
_emit_validates_agent_capability("p1", "genealogy_registry", "capability")
_emit_dispatches_execution_plan("p1", "genealogy_registry", "exec_plan")
_emit_agent_executes_agent("p1", "genealogy_registry", "sub_agent")
_emit_routes_to_agent("p1", "genealogy_registry", "target_agent")
_emit_verifies_policy("p1", "genealogy_registry", "policy_check")
_emit_observes_runtime_state("p1", "genealogy_registry", "runtime_state")
_emit_verifies_boundary("p1", "genealogy_registry", "boundary_check")
_emit_transcripts_response("p1", "genealogy_registry", "transcript")
_emit_hard_fails_untranscripted("p1", "genealogy_registry")
_emit_gated_by_confidence("p1", "genealogy_registry", "confidence_gate")
