...
class ElevatorShaftConsistencyEnforcer:
    ...
    def summary(self) -> dict[str, Any]:
        ...
        except (ImportError, OSError, RuntimeError, TypeError, ValueError) as e:  # guardian: allow-log-and-swallow -- behavioral profile unavailable: non-fatal; consistency check continues without ADG scoring
            import logging
