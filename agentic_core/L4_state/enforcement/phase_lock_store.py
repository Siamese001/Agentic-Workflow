...
_emit_checks_agent_registry("p1", "phase_lock_store", "agent_registry")
_emit_validates_agent_capability("p1", "phase_lock_store", "capability")
_emit_dispatches_execution_plan("p1", "phase_lock_store", "exec_plan")
_emit_agent_executes_agent("p1", "phase_lock_store", "sub_agent")
_emit_routes_to_agent("p1", "phase_lock_store", "target_agent")
_emit_verifies_policy("p1", "phase_lock_store", "policy_check")
_emit_observes_runtime_state("p1", "phase_lock_store", "runtime_state")
_emit_verifies_boundary("p1", "phase_lock_store", "boundary_check")
_emit_transcripts_response("p1", "phase_lock_store", "transcript")
_emit_hard_fails_untranscripted("p1", "phase_lock_store")
_emit_gated_by_confidence("p1", "phase_lock_store", "confidence_gate")
...
_emit_emits_metric_event("phase_lock_store", "p4obs", "metric_1")
_emit_emits_metric_event("phase_lock_store", "p4obs", "metric_2")
_emit_emits_metric_event("phase_lock_store", "p4obs", "metric_3")
_emit_emits_metric_event("phase_lock_store", "p4obs", "metric_4")
_emit_emits_metric_event("phase_lock_store", "p4obs", "metric_5")
_emit_emits_metric_event("phase_lock_store", "p4obs", "metric_6")
_emit_records_incident_event("phase_lock_store", "p4obs", "incident")
_emit_captures_runtime_anomaly("phase_lock_store", "p4obs", "anomaly")
_emit_writes_observability_log("phase_lock_store", "p4obs", "obs_log")
_emit_updates_monitoring_state("phase_lock_store", "p4obs", "mon_state")
_emit_triggers_alert("phase_lock_store", "p4obs", "alert")
_emit_links_incident_trace("phase_lock_store", "p4obs", "trace_link")
_emit_captures_pattern("phase_lock_store", "p3lm", "pattern")
_emit_records_learning_event("phase_lock_store", "p3lm", "learning_event")
_emit_writes_learning_snapshot("phase_lock_store", "p3lm", "snapshot")
_emit_feeds_meta_learning("phase_lock_store", "p3lm", "meta_feed")
_emit_updates_routing_strategy("phase_lock_store", "p3lm", "routing")
_emit_improves_agent_policy("phase_lock_store", "p3lm", "policy")
_emit_stores_learning_state("phase_lock_store", "p3lm", "state")
_emit_records_execution_trace("phase_lock_store", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("phase_lock_store", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("phase_lock_store", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("phase_lock_store", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("phase_lock_store", "L4_STATE", "p2_trace_5")
_emit_reads_environ("phase_lock_store", "env_read", "p2_env_1")
_emit_reads_environ("phase_lock_store", "env_read", "p2_env_2")
_emit_reads_runtime_state("phase_lock_store", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("phase_lock_store", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "phase_lock_store", "context_pull")
_emit_pulls_context("p1", "phase_lock_store", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "phase_lock_store", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "phase_lock_store", "uwg_term_2")
_emit_writes_through("p1", "phase_lock_store", "write_through")
_emit_writes_through("p1", "phase_lock_store", "write_through_2")
_emit_validated_by_safety_plane("p1", "phase_lock_store", "safety_validation")
_emit_invokes_eval("p1", "phase_lock_store", "eval_call")
_emit_proposal_commits_routing("p1", "phase_lock_store", "routing_commit")
