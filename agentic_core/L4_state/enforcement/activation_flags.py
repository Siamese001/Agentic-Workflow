...
emit_replay_key("p0", "activation_flags")
emit_determinism_digest("p0", "activation_flags")

_emit_dispatches_healing_run("p1", "activation_flags", "L4")
_emit_routes_through("p1", "activation_flags", "L4")
_emit_checks_agent_registry("p1", "activation_flags", "agent_registry")
_emit_validates_agent_capability("p1", "activation_flags", "capability")
_emit_dispatches_execution_plan("p1", "activation_flags", "exec_plan")
_emit_agent_executes_agent("p1", "activation_flags", "sub_agent")
_emit_routes_to_agent("p1", "activation_flags", "target_agent")
_emit_verifies_policy("p1", "activation_flags", "policy_check")
_emit_observes_runtime_state("p1", "activation_flags", "runtime_state")
_emit_verifies_boundary("p1", "activation_flags", "boundary_check")
_emit_transcripts_response("p1", "activation_flags", "transcript")
_emit_hard_fails_untranscripted("p1", "activation_flags")
_emit_gated_by_confidence("p1", "activation_flags", "confidence_gate")
_emit_escalates_to_human("p1", "activation_flags", "L4")
_emit_reads_policy_state("p1", "activation_flags", "L4")
_emit_authorize_and_execute("p2", "activation_flags", "execution_auth")
_emit_validates_capability("p2", "activation_flags", "capability_check")
_emit_routes_to_capability("p2", "activation_flags", "capability_route")
_emit_writes_via_uwg("p2", "activation_flags", "uwg_write")
_emit_blocks_direct_write("p2", "activation_flags", "direct_write_block")
_emit_records_tool_invocation("p2", "activation_flags", "tool_invocation")
_emit_captures_execution_output("p2", "activation_flags", "exec_output")
_emit_dispatches_agent("p3", "activation_flags", "agent_dispatch")
_emit_coordinates_agents("p3", "activation_flags", "agent_coordination")
_emit_records_workflow_lineage("p3", "activation_flags", "workflow_lineage")
_emit_records_healing_outcome("p3", "activation_flags", "healing_outcome")
_emit_escalates_failure("p3", "activation_flags", "failure_escalation")
_emit_orchestrates_workflow("p3", "activation_flags", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "activation_flags", "healing_dispatch")
_emit_invokes_evaluation("p3", "activation_flags", "evaluation_signal")
_emit_records_telemetry_event("p4", "activation_flags", "telemetry_event")
_emit_captures_evaluation_metric("p4", "activation_flags", "eval_metric")
_emit_stores_embedding("p4", "activation_flags", "embedding_store")
_emit_updates_meta_learning_state("p4", "activation_flags", "meta_learning")
_emit_links_execution_to_snapshot("p4", "activation_flags", "exec_snapshot_link")
from agentic_core.L_CONTRACTS.lifecycle_trace_contract import (
    _emit_agent_executes_agent,
...
_emit_emits_metric_event("activation_flags", "p4obs", "metric_1")
_emit_emits_metric_event("activation_flags", "p4obs", "metric_2")
_emit_emits_metric_event("activation_flags", "p4obs", "metric_3")
_emit_emits_metric_event("activation_flags", "p4obs", "metric_4")
_emit_emits_metric_event("activation_flags", "p4obs", "metric_5")
_emit_emits_metric_event("activation_flags", "p4obs", "metric_6")
_emit_records_incident_event("activation_flags", "p4obs", "incident")
_emit_captures_runtime_anomaly("activation_flags", "p4obs", "anomaly")
_emit_writes_observability_log("activation_flags", "p4obs", "obs_log")
_emit_updates_monitoring_state("activation_flags", "p4obs", "mon_state")
_emit_triggers_alert("activation_flags", "p4obs", "alert")
_emit_links_incident_trace("activation_flags", "p4obs", "trace_link")
_emit_captures_pattern("activation_flags", "p3lm", "pattern")
_emit_records_learning_event("activation_flags", "p3lm", "learning_event")
_emit_writes_learning_snapshot("activation_flags", "p3lm", "snapshot")
_emit_feeds_meta_learning("activation_flags", "p3lm", "meta_feed")
_emit_updates_routing_strategy("activation_flags", "p3lm", "routing")
_emit_improves_agent_policy("activation_flags", "p3lm", "policy")
_emit_stores_learning_state("activation_flags", "p3lm", "state")
_emit_records_execution_trace("activation_flags", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("activation_flags", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("activation_flags", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("activation_flags", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("activation_flags", "L4_STATE", "p2_trace_5")
_emit_reads_environ("activation_flags", "env_read", "p2_env_1")
_emit_reads_environ("activation_flags", "env_read", "p2_env_2")
_emit_reads_runtime_state("activation_flags", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("activation_flags", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "activation_flags", "context_pull")
_emit_pulls_context("p1", "activation_flags", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "activation_flags", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "activation_flags", "uwg_term_2")
_emit_writes_through("p1", "activation_flags", "write_through")
_emit_writes_through("p1", "activation_flags", "write_through_2")
_emit_validated_by_safety_plane("p1", "activation_flags", "safety_validation")
_emit_invokes_eval("p1", "activation_flags", "eval_call")
_emit_proposal_commits_routing("p1", "activation_flags", "routing_commit")
