...
class ActivationFlagsStore:
    ...
    def _load_flags(self) -> None:
        ...
        ) as e:  # guardian: allow-return-none-swallow -- fail-closed: reset to safe default ActivationFlags and clear proof; downstream will observe flags disabled
        ...
        if self.proof_file.exists():
            try:
                ...
                TypeError,
                json.JSONDecodeError,
            ) as e:  # guardian: allow-return-none-swallow -- fail-closed: clear proof so flags operate unattested; caller treats missing proof as non-authoritative
