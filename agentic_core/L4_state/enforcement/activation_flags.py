...
class ActivationFlagsStore:
    ...
    def update_flags(self, flags: ActivationFlags, guardian_signature: str='', activated_by: str='system') -> ActivationProof:
        ...
        now = time.time()
        updated_flags = ActivationFlags(execution_hardened=flags.execution_hardened, mutation_surface_zero=flags.mutation_surface_zero, guardian_coverage=flags.guardian_coverage, freeze_authority_active=flags.freeze_authority_active, meta_learning_prepared=flags.meta_learning_prepared, blast_radius_containment_active=flags.blast_radius_containment_active, meta_learning_enabled=flags.meta_learning_enabled, semantic_clock_tick=flags.semantic_clock_tick, replay_digest_hash=flags.replay_digest_hash, signature=guardian_signature, activation_timestamp=now, activated_by=activated_by)
        new_flags_hash = self._compute_flags_hash(updated_flags)
        proof = ActivationProof(flags_hash=new_flags_hash, guardian_signature=guardian_signature, timestamp=now, previous_flags_hash=previous_hash)
...
def update_activation_flags(flags: ActivationFlags, signature: str='', activated_by: str='system') -> ActivationProof:
