...
_emit_checks_agent_registry("p1", "citation_enforcement", "agent_registry")
_emit_validates_agent_capability("p1", "citation_enforcement", "capability")
_emit_dispatches_execution_plan("p1", "citation_enforcement", "exec_plan")
_emit_agent_executes_agent("p1", "citation_enforcement", "sub_agent")
_emit_routes_to_agent("p1", "citation_enforcement", "target_agent")
_emit_verifies_policy("p1", "citation_enforcement", "policy_check")
_emit_observes_runtime_state("p1", "citation_enforcement", "runtime_state")
_emit_verifies_boundary("p1", "citation_enforcement", "boundary_check")
_emit_transcripts_response("p1", "citation_enforcement", "transcript")
_emit_hard_fails_untranscripted("p1", "citation_enforcement")
_emit_gated_by_confidence("p1", "citation_enforcement", "confidence_gate")
