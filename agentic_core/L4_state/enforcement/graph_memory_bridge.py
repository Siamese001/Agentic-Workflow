...
_emit_checks_agent_registry("p1", "graph_memory_bridge", "agent_registry")
_emit_validates_agent_capability("p1", "graph_memory_bridge", "capability")
_emit_dispatches_execution_plan("p1", "graph_memory_bridge", "exec_plan")
_emit_agent_executes_agent("p1", "graph_memory_bridge", "sub_agent")
_emit_routes_to_agent("p1", "graph_memory_bridge", "target_agent")
_emit_verifies_policy("p1", "graph_memory_bridge", "policy_check")
_emit_observes_runtime_state("p1", "graph_memory_bridge", "runtime_state")
_emit_verifies_boundary("p1", "graph_memory_bridge", "boundary_check")
_emit_transcripts_response("p1", "graph_memory_bridge", "transcript")
_emit_hard_fails_untranscripted("p1", "graph_memory_bridge")
_emit_gated_by_confidence("p1", "graph_memory_bridge", "confidence_gate")
...
_emit_emits_metric_event("graph_memory_bridge", "p4obs", "metric_1")
_emit_emits_metric_event("graph_memory_bridge", "p4obs", "metric_2")
_emit_emits_metric_event("graph_memory_bridge", "p4obs", "metric_3")
_emit_emits_metric_event("graph_memory_bridge", "p4obs", "metric_4")
_emit_emits_metric_event("graph_memory_bridge", "p4obs", "metric_5")
_emit_emits_metric_event("graph_memory_bridge", "p4obs", "metric_6")
_emit_records_incident_event("graph_memory_bridge", "p4obs", "incident")
_emit_captures_runtime_anomaly("graph_memory_bridge", "p4obs", "anomaly")
_emit_writes_observability_log("graph_memory_bridge", "p4obs", "obs_log")
_emit_updates_monitoring_state("graph_memory_bridge", "p4obs", "mon_state")
_emit_triggers_alert("graph_memory_bridge", "p4obs", "alert")
_emit_links_incident_trace("graph_memory_bridge", "p4obs", "trace_link")
_emit_captures_pattern("graph_memory_bridge", "p3lm", "pattern")
_emit_records_learning_event("graph_memory_bridge", "p3lm", "learning_event")
_emit_writes_learning_snapshot("graph_memory_bridge", "p3lm", "snapshot")
_emit_feeds_meta_learning("graph_memory_bridge", "p3lm", "meta_feed")
_emit_updates_routing_strategy("graph_memory_bridge", "p3lm", "routing")
_emit_improves_agent_policy("graph_memory_bridge", "p3lm", "policy")
_emit_stores_learning_state("graph_memory_bridge", "p3lm", "state")
_emit_records_execution_trace("graph_memory_bridge", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("graph_memory_bridge", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("graph_memory_bridge", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("graph_memory_bridge", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("graph_memory_bridge", "L4_STATE", "p2_trace_5")
_emit_reads_environ("graph_memory_bridge", "env_read", "p2_env_1")
_emit_reads_environ("graph_memory_bridge", "env_read", "p2_env_2")
_emit_reads_runtime_state("graph_memory_bridge", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("graph_memory_bridge", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "graph_memory_bridge", "context_pull")
_emit_pulls_context("p1", "graph_memory_bridge", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "graph_memory_bridge", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "graph_memory_bridge", "uwg_term_2")
_emit_writes_through("p1", "graph_memory_bridge", "write_through")
_emit_writes_through("p1", "graph_memory_bridge", "write_through_2")
_emit_validated_by_safety_plane("p1", "graph_memory_bridge", "safety_validation")
_emit_invokes_eval("p1", "graph_memory_bridge", "eval_call")
_emit_proposal_commits_routing("p1", "graph_memory_bridge", "routing_commit")
