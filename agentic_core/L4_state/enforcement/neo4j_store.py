...
class Neo4jGraphStore:
    ...
    def upsert_entity(self, entity_id: str, etype: str, name: str, metadata: dict[str, object] | None=None) -> None:
        """
        ...
        try:
            ...
            raise
            fallback_cypher = '\n            MERGE (e:Entity {id: $id})\n            SET e.type = $type,\n                E.NAME = $name,\n                E += $metadata\n            RETURN e\n            '
            self.run(fallback_cypher, {'id': entity_id, 'type': etype, 'name': name, 'metadata': metadata or {}})

    def upsert_relation(self, rel_id: str, subject_id: str, predicate: str, object_id: str, valid_at: str | None, invalid_at: str | None, attrs: dict[str, object] | None=None) -> None:
        """
        ...
        params: dict[str, object] = {'rel_id': rel_id, 'subject_id': subject_id, 'object_id': object_id, 'predicate': predicate}
    ...
    def update_relation_invalidity(self, rel_id: str, invalid_at: str | None, invalidated_by: str | None) -> None:
        """
