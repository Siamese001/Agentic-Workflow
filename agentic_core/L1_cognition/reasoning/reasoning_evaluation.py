...
trace_contract.emit_replay_key("p0", "reasoning_evaluation")
trace_contract.emit_determinism_digest("p0", "reasoning_evaluation")

trace_contract._emit_dispatches_healing_run("p1", "reasoning_evaluation", "L1")
trace_contract._emit_routes_through("p1", "reasoning_evaluation", "L1")
trace_contract._emit_checks_agent_registry("p1", "reasoning_evaluation", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "reasoning_evaluation", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "reasoning_evaluation", "exec_plan")
trace_contract._emit_agent_executes_agent("p1", "reasoning_evaluation", "sub_agent")
trace_contract._emit_routes_to_agent("p1", "reasoning_evaluation", "target_agent")
trace_contract._emit_verifies_policy("p1", "reasoning_evaluation", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "reasoning_evaluation", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "reasoning_evaluation", "boundary_check")
trace_contract._emit_transcripts_response("p1", "reasoning_evaluation", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "reasoning_evaluation")
trace_contract._emit_gated_by_confidence("p1", "reasoning_evaluation", "confidence_gate")
trace_contract._emit_escalates_to_human("p1", "reasoning_evaluation", "L1")
trace_contract._emit_reads_policy_state("p1", "reasoning_evaluation", "L1")
trace_contract._emit_authorize_and_execute("p2", "reasoning_evaluation", "execution_auth")
trace_contract._emit_validates_capability("p2", "reasoning_evaluation", "capability_check")
trace_contract._emit_routes_to_capability("p2", "reasoning_evaluation", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "reasoning_evaluation", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "reasoning_evaluation", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "reasoning_evaluation", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "reasoning_evaluation", "exec_output")
trace_contract._emit_dispatches_agent("p3", "reasoning_evaluation", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "reasoning_evaluation", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "reasoning_evaluation", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "reasoning_evaluation", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "reasoning_evaluation", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "reasoning_evaluation", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "reasoning_evaluation", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "reasoning_evaluation", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "reasoning_evaluation", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "reasoning_evaluation", "eval_metric")
trace_contract._emit_stores_embedding("p4", "reasoning_evaluation", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "reasoning_evaluation", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "reasoning_evaluation", "exec_snapshot_link")

trace_contract._emit_emits_metric_event("reasoning_evaluation", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("reasoning_evaluation", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("reasoning_evaluation", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("reasoning_evaluation", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("reasoning_evaluation", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("reasoning_evaluation", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("reasoning_evaluation", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("reasoning_evaluation", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("reasoning_evaluation", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("reasoning_evaluation", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("reasoning_evaluation", "p4obs", "alert")
trace_contract._emit_links_incident_trace("reasoning_evaluation", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("reasoning_evaluation", "p3lm", "pattern")
trace_contract._emit_records_learning_event("reasoning_evaluation", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("reasoning_evaluation", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("reasoning_evaluation", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("reasoning_evaluation", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("reasoning_evaluation", "p3lm", "policy")
trace_contract._emit_stores_learning_state("reasoning_evaluation", "p3lm", "state")
trace_contract._emit_records_execution_trace("reasoning_evaluation", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("reasoning_evaluation", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("reasoning_evaluation", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("reasoning_evaluation", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("reasoning_evaluation", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("reasoning_evaluation", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("reasoning_evaluation", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("reasoning_evaluation", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("reasoning_evaluation", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "reasoning_evaluation", "context_pull")
trace_contract._emit_pulls_context("p1", "reasoning_evaluation", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "reasoning_evaluation", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "reasoning_evaluation", "uwg_term_2")
trace_contract._emit_writes_through("p1", "reasoning_evaluation", "write_through")
trace_contract._emit_writes_through("p1", "reasoning_evaluation", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "reasoning_evaluation", "safety_validation")
trace_contract._emit_invokes_eval("p1", "reasoning_evaluation", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "reasoning_evaluation", "routing_commit")
...
class ReasoningEvaluationRecord:
    ...
    def create(
        ...
        *,
        ...
        trace_contract._emit_snapshots_state(str(_uuid.uuid4()), "ReasoningEvaluationRecord.create", "state_snapshot")
        ...
        trace_contract._emit_applies_guardrail(str(_uuid.uuid4()), "ReasoningEvaluationRecord.create", "p0_governance")
