"""
Convert Content Embedding package initialization.

Provides core functionality and exports for the Convert Content Embedding module.
"""
...
__description__: str = "Core Convert Content Embedding functionality"
...
def get_module_info() -> Dict[str, Union[str, List[str]]]:
    ...
    """
    return {
        "name": "Convert Content Embedding",
        "version": __version__,
        "author": __author__,
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Convert Content Embedding instance with config: {final_config}")
    return final_config
