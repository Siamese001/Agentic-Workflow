...
emit_replay_key("p0", "CognitiveNode")
emit_determinism_digest("p0", "CognitiveNode")

_emit_dispatches_healing_run("p1", "CognitiveNode", "L1")
_emit_routes_through("p1", "CognitiveNode", "L1")
_emit_checks_agent_registry("p1", "CognitiveNode", "agent_registry")
_emit_validates_agent_capability("p1", "CognitiveNode", "capability")
_emit_dispatches_execution_plan("p1", "CognitiveNode", "exec_plan")
_emit_agent_executes_agent("p1", "CognitiveNode", "sub_agent")
_emit_routes_to_agent("p1", "CognitiveNode", "target_agent")
_emit_verifies_policy("p1", "CognitiveNode", "policy_check")
_emit_observes_runtime_state("p1", "CognitiveNode", "runtime_state")
_emit_verifies_boundary("p1", "CognitiveNode", "boundary_check")
_emit_transcripts_response("p1", "CognitiveNode", "transcript")
_emit_hard_fails_untranscripted("p1", "CognitiveNode")
_emit_gated_by_confidence("p1", "CognitiveNode", "confidence_gate")
_emit_escalates_to_human("p1", "CognitiveNode", "L1")
_emit_reads_policy_state("p1", "CognitiveNode", "L1")
_emit_authorize_and_execute("p2", "CognitiveNode", "execution_auth")
_emit_validates_capability("p2", "CognitiveNode", "capability_check")
_emit_routes_to_capability("p2", "CognitiveNode", "capability_route")
_emit_writes_via_uwg("p2", "CognitiveNode", "uwg_write")
_emit_blocks_direct_write("p2", "CognitiveNode", "direct_write_block")
_emit_records_tool_invocation("p2", "CognitiveNode", "tool_invocation")
_emit_captures_execution_output("p2", "CognitiveNode", "exec_output")
_emit_dispatches_agent("p3", "CognitiveNode", "agent_dispatch")
_emit_coordinates_agents("p3", "CognitiveNode", "agent_coordination")
_emit_records_workflow_lineage("p3", "CognitiveNode", "workflow_lineage")
_emit_records_healing_outcome("p3", "CognitiveNode", "healing_outcome")
_emit_escalates_failure("p3", "CognitiveNode", "failure_escalation")
_emit_orchestrates_workflow("p3", "CognitiveNode", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "CognitiveNode", "healing_dispatch")
_emit_invokes_evaluation("p3", "CognitiveNode", "evaluation_signal")
_emit_records_telemetry_event("p4", "CognitiveNode", "telemetry_event")
_emit_captures_evaluation_metric("p4", "CognitiveNode", "eval_metric")
_emit_stores_embedding("p4", "CognitiveNode", "embedding_store")
_emit_updates_meta_learning_state("p4", "CognitiveNode", "meta_learning")
_emit_links_execution_to_snapshot("p4", "CognitiveNode", "exec_snapshot_link")
...
_emit_emits_metric_event("CognitiveNode", "p4obs", "metric_1")
_emit_emits_metric_event("CognitiveNode", "p4obs", "metric_2")
_emit_emits_metric_event("CognitiveNode", "p4obs", "metric_3")
_emit_emits_metric_event("CognitiveNode", "p4obs", "metric_4")
_emit_emits_metric_event("CognitiveNode", "p4obs", "metric_5")
_emit_emits_metric_event("CognitiveNode", "p4obs", "metric_6")
_emit_records_incident_event("CognitiveNode", "p4obs", "incident")
_emit_captures_runtime_anomaly("CognitiveNode", "p4obs", "anomaly")
_emit_writes_observability_log("CognitiveNode", "p4obs", "obs_log")
_emit_updates_monitoring_state("CognitiveNode", "p4obs", "mon_state")
_emit_triggers_alert("CognitiveNode", "p4obs", "alert")
_emit_links_incident_trace("CognitiveNode", "p4obs", "trace_link")
_emit_captures_pattern("CognitiveNode", "p3lm", "pattern")
_emit_records_learning_event("CognitiveNode", "p3lm", "learning_event")
_emit_writes_learning_snapshot("CognitiveNode", "p3lm", "snapshot")
_emit_feeds_meta_learning("CognitiveNode", "p3lm", "meta_feed")
_emit_updates_routing_strategy("CognitiveNode", "p3lm", "routing")
_emit_improves_agent_policy("CognitiveNode", "p3lm", "policy")
_emit_stores_learning_state("CognitiveNode", "p3lm", "state")
_emit_records_execution_trace("CognitiveNode", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("CognitiveNode", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("CognitiveNode", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("CognitiveNode", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("CognitiveNode", "L4_STATE", "p2_trace_5")
_emit_reads_environ("CognitiveNode", "env_read", "p2_env_1")
_emit_reads_environ("CognitiveNode", "env_read", "p2_env_2")
_emit_reads_runtime_state("CognitiveNode", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("CognitiveNode", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "CognitiveNode", "context_pull")
_emit_pulls_context("p1", "CognitiveNode", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "CognitiveNode", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "CognitiveNode", "uwg_term_2")
_emit_writes_through("p1", "CognitiveNode", "write_through")
_emit_writes_through("p1", "CognitiveNode", "write_through_2")
_emit_validated_by_safety_plane("p1", "CognitiveNode", "safety_validation")
_emit_invokes_eval("p1", "CognitiveNode", "eval_call")
_emit_proposal_commits_routing("p1", "CognitiveNode", "routing_commit")
