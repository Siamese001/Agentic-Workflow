...
class ReasoningCache:
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        return {'size': len(self.cache), 'maxsize': self.maxsize, 'hits': self.hits, 'misses': self.misses, 'hit_rate': hit_rate, 'total_requests': total}
...
def cached_reasoning(func):
    ...
    def wrapper(self, problem: str, context: dict[str, Any], *args, **kwargs):
        params = (context.get('temperature', 0.7), context.get('model', 'default'), context.get('max_steps', 8))
