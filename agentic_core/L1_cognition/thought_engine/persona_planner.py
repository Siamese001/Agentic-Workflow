...
class persona_planner:
    ...
    def plan(self, *, archetype: str, recipient_profile: Dict[str, object], grounding_plan: Optional[Any]=None, outreach_context: Dict[str, object]=None) -> PersonaPlan:
