...
_emit_emits_metric_event("rag_types", "p4obs", "metric_3")
_emit_emits_metric_event("rag_types", "p4obs", "metric_4")
_emit_emits_metric_event("rag_types", "p4obs", "metric_5")
_emit_emits_metric_event("rag_types", "p4obs", "metric_6")
_emit_records_incident_event("rag_types", "p4obs", "incident")
_emit_captures_runtime_anomaly("rag_types", "p4obs", "anomaly")
_emit_writes_observability_log("rag_types", "p4obs", "obs_log")
_emit_updates_monitoring_state("rag_types", "p4obs", "mon_state")
_emit_triggers_alert("rag_types", "p4obs", "alert")
_emit_links_incident_trace("rag_types", "p4obs", "trace_link")
_emit_captures_pattern("rag_types", "p3lm", "pattern")
_emit_records_learning_event("rag_types", "p3lm", "learning_event")
_emit_writes_learning_snapshot("rag_types", "p3lm", "snapshot")
_emit_feeds_meta_learning("rag_types", "p3lm", "meta_feed")
_emit_updates_routing_strategy("rag_types", "p3lm", "routing")
_emit_improves_agent_policy("rag_types", "p3lm", "policy")
_emit_stores_learning_state("rag_types", "p3lm", "state")
_emit_records_execution_trace("rag_types", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("rag_types", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("rag_types", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("rag_types", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("rag_types", "L4_STATE", "p2_trace_5")
_emit_reads_environ("rag_types", "env_read", "p2_env_1")
_emit_reads_environ("rag_types", "env_read", "p2_env_2")
_emit_reads_runtime_state("rag_types", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("rag_types", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "rag_types", "context_pull")
_emit_pulls_context("p1", "rag_types", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "rag_types", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "rag_types", "uwg_term_2")
_emit_writes_through("p1", "rag_types", "write_through")
_emit_writes_through("p1", "rag_types", "write_through_2")
_emit_validated_by_safety_plane("p1", "rag_types", "safety_validation")
_emit_invokes_eval("p1", "rag_types", "eval_call")
_emit_proposal_commits_routing("p1", "rag_types", "routing_commit")
emit_determinism_digest("trace_rag_types", "rag_types_dispatch_entry")
emit_determinism_digest("trace_rag_types", "rag_types_dispatch_exit")
emit_determinism_digest("trace_rag_types", "rag_types_tool_invoke")
emit_determinism_digest("trace_rag_types", "rag_types_tool_complete")
emit_determinism_digest("trace_rag_types", "rag_types_agent_entry")
emit_determinism_digest("trace_rag_types", "rag_types_agent_exit")
emit_determinism_digest("trace_rag_types", "rag_types_uwg_write")
emit_determinism_digest("trace_rag_types", "rag_types_trace_sign")
emit_determinism_digest("trace_rag_types", "rag_types_guardrail_check")
emit_determinism_digest("trace_rag_types", "rag_types_policy_verify")
