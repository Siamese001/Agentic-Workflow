"""
Refinement Adjust Scores package initialization.

Provides core functionality and exports for the Refinement Adjust Scores module.
"""
...
__description__: str = "Core Refinement Adjust Scores functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Refinement Adjust Scores instance with config: {final_config}")
    return final_config
