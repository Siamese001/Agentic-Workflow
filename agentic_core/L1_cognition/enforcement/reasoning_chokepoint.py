...
def reason_and_record(
    ...
    *,
    ...
    try:
        ...
        )    # guardian: ReasoningPlanError should be handled with specific context    # guardian: ReasoningPlanError should be handled with specific context    # guardian: ReasoningPlanError should be handled with specific context    # guardian: ReasoningPlanError should be handled with specific context    # guardian: ReasoningPlanError should be handled with specific context    # guardian: ReasoningPlanError should be handled with specific context    # guardian: ReasoningPlanError should be handled with specific context    # guardian: ReasoningPlanError should be handled with specific context    # guardian: ReasoningPlanError should be handled with specific context
    ...
    try:
        _rubric = ReasoningEvaluationRubric(
            ...
            coherence=1.0,    # guardian: OrphanReasoningEvaluationError should be handled with specific context    # guardian: OrphanReasoningEvaluationError should be handled with specific context    # guardian: OrphanReasoningEvaluationError should be handled with specific context    # guardian: OrphanReasoningEvaluationError should be handled with specific context    # guardian: OrphanReasoningEvaluationError should be handled with specific context    # guardian: OrphanReasoningEvaluationError should be handled with specific context    # guardian: OrphanReasoningEvaluationError should be handled with specific context    # guardian: OrphanReasoningEvaluationError should be handled with specific context    # guardian: OrphanReasoningEvaluationError should be handled with specific context
            actionability=1.0,
        )
        evaluate_reasoning_step_from_trace(
            trace,
