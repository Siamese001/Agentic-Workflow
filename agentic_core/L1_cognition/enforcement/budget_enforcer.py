...
_emit_hard_fails_untranscripted("p1", "budget_enforcer")
...
_emit_pulls_context("p1", "budget_enforcer", "context_pull_secondary")
_emit_execution_terminates_at_uwg("p1", "budget_enforcer", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "budget_enforcer", "uwg_term_secondary")
_emit_writes_through("p1", "budget_enforcer", "write_through")
_emit_writes_through("p1", "budget_enforcer", "write_through_secondary")
