...
_emit_checks_agent_registry("p1", "mission_status", "agent_registry")
_emit_validates_agent_capability("p1", "mission_status", "capability")
_emit_dispatches_execution_plan("p1", "mission_status", "exec_plan")
_emit_agent_executes_agent("p1", "mission_status", "sub_agent")
_emit_routes_to_agent("p1", "mission_status", "target_agent")
_emit_verifies_policy("p1", "mission_status", "policy_check")
_emit_observes_runtime_state("p1", "mission_status", "runtime_state")
_emit_verifies_boundary("p1", "mission_status", "boundary_check")
_emit_transcripts_response("p1", "mission_status", "transcript")
_emit_hard_fails_untranscripted("p1", "mission_status")
_emit_gated_by_confidence("p1", "mission_status", "confidence_gate")
