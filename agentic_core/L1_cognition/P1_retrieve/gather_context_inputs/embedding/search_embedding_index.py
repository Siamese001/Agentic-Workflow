...
class TemporalFilter:
    ...
    Attributes:
        field: Field name for timestamp filtering.
        start_time: Start of time range (inclusive).
        end_time: End of time range (inclusive).
        recent_only: Whether to filter to recent items only.
...
class SearchResult:
    ...
    Attributes:
        ...
        dense_score: Score from dense search.
        sparse_score: Score from sparse search.
        fused_score: Combined score after fusion.
    """
