...
class EnforceScriptsLimitsSafetySafety(ABC):
    ...
    @abstractmethod
    def apply_safety(self, data: Dict[str, Any]) -> EnforceScriptsLimitsSafetyResult:
...
def enforce_scripts_limits(data: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    """
    factory = EnforceScriptsLimitsSafetyFactory()
