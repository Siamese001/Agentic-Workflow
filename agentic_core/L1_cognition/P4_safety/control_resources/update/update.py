# AUTO-HYDRATED FINAL (substring) score=0.950 from scripts\security_controls\guardrails\check_rules\manage_scripts_costs_state_update_ops\update_safety_usage.py
...
class UpdateDataUsageSafetySafety(ABC):
    ...
    @abstractmethod
    def apply_safety(self, data: Dict[str, Any]) -> UpdateDataUsageSafetyResult:
...
def update_data_usage(data: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    """
    factory = UpdateDataUsageSafetyFactory()
