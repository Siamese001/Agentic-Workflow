...
def validate() -> int:
    ...
    for module in sorted_modules:
        ...
        if actual_hash != module['sha256']:
            errors.append(f"Module hash mismatch: {module['path']}\n  manifest: {module['sha256']}\n  actual:   {actual_hash}")
        ...
        if canonical_rel:
            ...
            if canonical_path.exists():
                ...
                if assembled != canonical_bytes:
                    ...
                    errors.append(f'Assembled output differs from canonical artifact\n  canonical: {canonical_hash}\n  assembled: {assembled_hash}')
