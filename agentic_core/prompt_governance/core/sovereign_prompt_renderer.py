...
class SovereignPromptRenderer:
    ...
    def render(
        ...
        except TemplateNotFound:    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context    # guardian: TemplateNotFound should be handled with specific context
