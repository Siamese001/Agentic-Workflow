...
class PromptAssembler:
    ...
    def assemble(
        ...
        except SecurityIntegrityError as e:    # guardian: SecurityIntegrityError should be handled with specific context    # guardian: SecurityIntegrityError should be handled with specific context    # guardian: SecurityIntegrityError should be handled with specific context    # guardian: SecurityIntegrityError should be handled with specific context    # guardian: SecurityIntegrityError should be handled with specific context    # guardian: SecurityIntegrityError should be handled with specific context    # guardian: SecurityIntegrityError should be handled with specific context    # guardian: SecurityIntegrityError should be handled with specific context    # guardian: SecurityIntegrityError should be handled with specific context    # guardian: SecurityIntegrityError should be handled with specific context
