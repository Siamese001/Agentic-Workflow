...
_ZERO_WIDTH_CHARS: frozenset[int] = frozenset({8203, 8204, 8205, 8206, 8207, 8288, 8289, 8290, 8291, 8292, 65279})
_LEET_MAP: dict[str, str] = {'0': 'o', '1': 'i', '3': 'e', '4': 'a', '5': 's', '7': 't', '@': 'a', '$': 's', '!': 'i', '(': 'c', '|': 'l'}
