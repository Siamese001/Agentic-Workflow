...
def compile_template(env: Environment, template_path: Path, relative_to: Path) -> dict:
    ...
    try:
        ...
        return {    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context    # guardian: TemplateSyntaxError should be handled with specific context
            "status": "FAIL",
            "template_path": relative_path,
            "full_path": str(template_path),
        ...
        return {    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context    # guardian: TemplateError should be handled with specific context
            "status": "FAIL",
            "template_path": relative_path,
            "full_path": str(template_path),
