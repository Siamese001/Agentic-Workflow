...
class HandoffDispatcher:
    ...
    def dispatch(
        ...
        **kwargs: Any,
        ...
        except (CapabilityNotFoundError, CapabilityPermissionError) as exc:    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling    # guardian: Multiple exceptions (CapabilityNotFoundError, CapabilityPermissionError) need specific handling
