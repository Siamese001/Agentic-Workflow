...
_emit_checks_agent_registry("p1", "orchestration_context", "agent_registry")
_emit_validates_agent_capability("p1", "orchestration_context", "capability")
_emit_dispatches_execution_plan("p1", "orchestration_context", "exec_plan")
_emit_routes_to_agent("p1", "orchestration_context", "target_agent")
_emit_verifies_policy("p1", "orchestration_context", "policy_check")
_emit_observes_runtime_state("p1", "orchestration_context", "runtime_state")
_emit_verifies_boundary("p1", "orchestration_context", "boundary_check")
_emit_transcripts_response("p1", "orchestration_context", "transcript")
_emit_hard_fails_untranscripted("p1", "orchestration_context")
_emit_gated_by_confidence("p1", "orchestration_context", "confidence_gate")
