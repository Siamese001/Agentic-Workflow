...
_emit_checks_agent_registry("p1", "advisors", "agent_registry")
_emit_validates_agent_capability("p1", "advisors", "capability")
_emit_dispatches_execution_plan("p1", "advisors", "exec_plan")
_emit_agent_executes_agent("p1", "advisors", "sub_agent")
_emit_routes_to_agent("p1", "advisors", "target_agent")
_emit_verifies_policy("p1", "advisors", "policy_check")
_emit_observes_runtime_state("p1", "advisors", "runtime_state")
_emit_verifies_boundary("p1", "advisors", "boundary_check")
_emit_transcripts_response("p1", "advisors", "transcript")
_emit_hard_fails_untranscripted("p1", "advisors")
