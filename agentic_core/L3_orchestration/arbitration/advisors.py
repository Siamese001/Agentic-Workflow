...
def risk_averse_advisor(task: dict[str, str]) -> AdvisorProposal:
    ...
    # Deterministic logic based on task kind
...
# Registry of available advisors
ADVISORS: dict[str, callable] = {
    "risk_averse": risk_averse_advisor,
    "throughput": throughput_advisor,
}
...
def run_advisor(advisor_id: str, task: dict[str, str]) -> AdvisorProposal:
    ...
    # Validate that advisor returned correct ID
