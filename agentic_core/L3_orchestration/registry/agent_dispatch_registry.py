...
class AgentDispatchRegistry:
    ...
    def dispatch(
        ...
        except GuardrailViolationError as gve:    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context    # guardian: GuardrailViolationError should be handled with specific context
        ...
        if _run_id and get_coordination_ledger(_run_id) is not None:
            ...
            except (MissingCoordinationLedger, Exception) as _cl_exc:    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling    # guardian: Multiple exceptions (MissingCoordinationLedger, Exception) need specific handling
