...
_emit_checks_agent_registry("p1", "rl_strategy", "agent_registry")
_emit_validates_agent_capability("p1", "rl_strategy", "capability")
_emit_dispatches_execution_plan("p1", "rl_strategy", "exec_plan")
_emit_agent_executes_agent("p1", "rl_strategy", "sub_agent")
_emit_routes_to_agent("p1", "rl_strategy", "target_agent")
_emit_verifies_policy("p1", "rl_strategy", "policy_check")
_emit_observes_runtime_state("p1", "rl_strategy", "runtime_state")
_emit_verifies_boundary("p1", "rl_strategy", "boundary_check")
_emit_transcripts_response("p1", "rl_strategy", "transcript")
_emit_hard_fails_untranscripted("p1", "rl_strategy")
_emit_gated_by_confidence("p1", "rl_strategy", "confidence_gate")
...
_emit_emits_metric_event("rl_strategy", "p4obs", "metric_1")
_emit_emits_metric_event("rl_strategy", "p4obs", "metric_2")
_emit_emits_metric_event("rl_strategy", "p4obs", "metric_3")
_emit_emits_metric_event("rl_strategy", "p4obs", "metric_4")
_emit_emits_metric_event("rl_strategy", "p4obs", "metric_5")
_emit_emits_metric_event("rl_strategy", "p4obs", "metric_6")
_emit_records_incident_event("rl_strategy", "p4obs", "incident")
_emit_captures_runtime_anomaly("rl_strategy", "p4obs", "anomaly")
_emit_writes_observability_log("rl_strategy", "p4obs", "obs_log")
_emit_updates_monitoring_state("rl_strategy", "p4obs", "mon_state")
_emit_triggers_alert("rl_strategy", "p4obs", "alert")
_emit_links_incident_trace("rl_strategy", "p4obs", "trace_link")
_emit_captures_pattern("rl_strategy", "p3lm", "pattern")
_emit_records_learning_event("rl_strategy", "p3lm", "learning_event")
_emit_writes_learning_snapshot("rl_strategy", "p3lm", "snapshot")
_emit_feeds_meta_learning("rl_strategy", "p3lm", "meta_feed")
_emit_updates_routing_strategy("rl_strategy", "p3lm", "routing")
_emit_improves_agent_policy("rl_strategy", "p3lm", "policy")
_emit_stores_learning_state("rl_strategy", "p3lm", "state")
_emit_records_execution_trace("rl_strategy", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("rl_strategy", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("rl_strategy", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("rl_strategy", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("rl_strategy", "L4_STATE", "p2_trace_5")
_emit_reads_environ("rl_strategy", "env_read", "p2_env_1")
_emit_reads_environ("rl_strategy", "env_read", "p2_env_2")
_emit_reads_runtime_state("rl_strategy", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("rl_strategy", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "rl_strategy", "context_pull")
_emit_pulls_context("p1", "rl_strategy", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "rl_strategy", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "rl_strategy", "uwg_term_2")
_emit_writes_through("p1", "rl_strategy", "write_through")
_emit_writes_through("p1", "rl_strategy", "write_through_2")
_emit_validated_by_safety_plane("p1", "rl_strategy", "safety_validation")
_emit_invokes_eval("p1", "rl_strategy", "eval_call")
_emit_proposal_commits_routing("p1", "rl_strategy", "routing_commit")
