        ...
        "records": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "decision": {
                        "type": "string",
                        "enum": sorted(APPROVAL_DECISION_VALUES),
                    },
...
BUNDLE_SCHEMA_KEYS: frozenset[str] = frozenset(
...
class ApprovalRecord:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.decision, ApprovalDecision):
            raise ValueError(
                f"decision must be an ApprovalDecision enum, got {type(self.decision).__name__}",
            )
