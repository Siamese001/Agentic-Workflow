...
Canonical replacement: agentic_core.L3_orchestration.utils.subatomic_agent_util
...
Target archive path on or after eligibility date:
  archives/agents/2026-07-23/agentic_core__L3_orchestration__reasoning__SubAtomicAgent.py
Cooling-timer artifact: artifacts/agent_deprecation/w_final_SubAtomicAgent.json
"""
