...
trace_contract.emit_replay_key("p0", "agent_gym_engine")
trace_contract.emit_determinism_digest("p0", "agent_gym_engine")

trace_contract._emit_dispatches_healing_run("p1", "agent_gym_engine", "L3")
trace_contract._emit_routes_through("p1", "agent_gym_engine", "L3")
trace_contract._emit_checks_agent_registry("p1", "agent_gym_engine", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "agent_gym_engine", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "agent_gym_engine", "exec_plan")
trace_contract._emit_agent_executes_agent("p1", "agent_gym_engine", "sub_agent")
trace_contract._emit_routes_to_agent("p1", "agent_gym_engine", "target_agent")
trace_contract._emit_verifies_policy("p1", "agent_gym_engine", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "agent_gym_engine", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "agent_gym_engine", "boundary_check")
trace_contract._emit_transcripts_response("p1", "agent_gym_engine", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "agent_gym_engine")
trace_contract._emit_gated_by_confidence("p1", "agent_gym_engine", "confidence_gate")
trace_contract._emit_escalates_to_human("p1", "agent_gym_engine", "L3")
trace_contract._emit_reads_policy_state("p1", "agent_gym_engine", "L3")
trace_contract._emit_authorize_and_execute("p2", "agent_gym_engine", "execution_auth")
trace_contract._emit_validates_capability("p2", "agent_gym_engine", "capability_check")
trace_contract._emit_routes_to_capability("p2", "agent_gym_engine", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "agent_gym_engine", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "agent_gym_engine", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "agent_gym_engine", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "agent_gym_engine", "exec_output")
trace_contract._emit_dispatches_agent("p3", "agent_gym_engine", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "agent_gym_engine", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "agent_gym_engine", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "agent_gym_engine", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "agent_gym_engine", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "agent_gym_engine", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "agent_gym_engine", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "agent_gym_engine", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "agent_gym_engine", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "agent_gym_engine", "eval_metric")
trace_contract._emit_stores_embedding("p4", "agent_gym_engine", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "agent_gym_engine", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "agent_gym_engine", "exec_snapshot_link")
from tqdm import tqdm

trace_contract._emit_emits_metric_event("agent_gym_engine", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("agent_gym_engine", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("agent_gym_engine", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("agent_gym_engine", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("agent_gym_engine", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("agent_gym_engine", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("agent_gym_engine", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("agent_gym_engine", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("agent_gym_engine", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("agent_gym_engine", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("agent_gym_engine", "p4obs", "alert")
trace_contract._emit_links_incident_trace("agent_gym_engine", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("agent_gym_engine", "p3lm", "pattern")
trace_contract._emit_records_learning_event("agent_gym_engine", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("agent_gym_engine", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("agent_gym_engine", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("agent_gym_engine", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("agent_gym_engine", "p3lm", "policy")
trace_contract._emit_stores_learning_state("agent_gym_engine", "p3lm", "state")
trace_contract._emit_records_execution_trace("agent_gym_engine", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("agent_gym_engine", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("agent_gym_engine", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("agent_gym_engine", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("agent_gym_engine", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("agent_gym_engine", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("agent_gym_engine", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("agent_gym_engine", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("agent_gym_engine", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "agent_gym_engine", "context_pull")
trace_contract._emit_pulls_context("p1", "agent_gym_engine", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "agent_gym_engine", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "agent_gym_engine", "uwg_term_2")
trace_contract._emit_writes_through("p1", "agent_gym_engine", "write_through")
trace_contract._emit_writes_through("p1", "agent_gym_engine", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "agent_gym_engine", "safety_validation")
trace_contract._emit_invokes_eval("p1", "agent_gym_engine", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "agent_gym_engine", "routing_commit")
...
class AgentGym(SovereignBaseAgent):
    ...
    def __init__(
        ...
        trace_contract._emit_snapshots_state(str(_uuid.uuid4()), "AgentGym.__init__", "state_snapshot")
        ...
        trace_contract._emit_applies_guardrail(str(_uuid.uuid4()), "AgentGym.__init__", "p0_governance")
