...
emit_replay_key("p0", "dag_manager")
emit_determinism_digest("p0", "dag_manager")

_emit_dispatches_healing_run("p1", "dag_manager", "L3")
_emit_routes_through("p1", "dag_manager", "L3")
_emit_checks_agent_registry("p1", "dag_manager", "agent_registry")
_emit_validates_agent_capability("p1", "dag_manager", "capability")
_emit_dispatches_execution_plan("p1", "dag_manager", "exec_plan")
_emit_agent_executes_agent("p1", "dag_manager", "sub_agent")
_emit_routes_to_agent("p1", "dag_manager", "target_agent")
_emit_verifies_policy("p1", "dag_manager", "policy_check")
_emit_observes_runtime_state("p1", "dag_manager", "runtime_state")
_emit_verifies_boundary("p1", "dag_manager", "boundary_check")
_emit_transcripts_response("p1", "dag_manager", "transcript")
_emit_hard_fails_untranscripted("p1", "dag_manager")
_emit_gated_by_confidence("p1", "dag_manager", "confidence_gate")
_emit_escalates_to_human("p1", "dag_manager", "L3")
_emit_reads_policy_state("p1", "dag_manager", "L3")
_emit_authorize_and_execute("p2", "dag_manager", "execution_auth")
_emit_validates_capability("p2", "dag_manager", "capability_check")
_emit_routes_to_capability("p2", "dag_manager", "capability_route")
_emit_writes_via_uwg("p2", "dag_manager", "uwg_write")
_emit_blocks_direct_write("p2", "dag_manager", "direct_write_block")
_emit_records_tool_invocation("p2", "dag_manager", "tool_invocation")
_emit_captures_execution_output("p2", "dag_manager", "exec_output")
_emit_dispatches_agent("p3", "dag_manager", "agent_dispatch")
_emit_coordinates_agents("p3", "dag_manager", "agent_coordination")
_emit_records_workflow_lineage("p3", "dag_manager", "workflow_lineage")
_emit_records_healing_outcome("p3", "dag_manager", "healing_outcome")
_emit_escalates_failure("p3", "dag_manager", "failure_escalation")
_emit_orchestrates_workflow("p3", "dag_manager", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "dag_manager", "healing_dispatch")
_emit_invokes_evaluation("p3", "dag_manager", "evaluation_signal")
_emit_records_telemetry_event("p4", "dag_manager", "telemetry_event")
_emit_captures_evaluation_metric("p4", "dag_manager", "eval_metric")
_emit_stores_embedding("p4", "dag_manager", "embedding_store")
_emit_updates_meta_learning_state("p4", "dag_manager", "meta_learning")
_emit_links_execution_to_snapshot("p4", "dag_manager", "exec_snapshot_link")
...
_emit_emits_metric_event("dag_manager", "p4obs", "metric_3")
_emit_emits_metric_event("dag_manager", "p4obs", "metric_4")
_emit_emits_metric_event("dag_manager", "p4obs", "metric_5")
_emit_emits_metric_event("dag_manager", "p4obs", "metric_6")
_emit_records_incident_event("dag_manager", "p4obs", "incident")
_emit_captures_runtime_anomaly("dag_manager", "p4obs", "anomaly")
_emit_writes_observability_log("dag_manager", "p4obs", "obs_log")
_emit_updates_monitoring_state("dag_manager", "p4obs", "mon_state")
_emit_triggers_alert("dag_manager", "p4obs", "alert")
_emit_links_incident_trace("dag_manager", "p4obs", "trace_link")
_emit_captures_pattern("dag_manager", "p3lm", "pattern")
_emit_records_learning_event("dag_manager", "p3lm", "learning_event")
_emit_writes_learning_snapshot("dag_manager", "p3lm", "snapshot")
_emit_feeds_meta_learning("dag_manager", "p3lm", "meta_feed")
_emit_updates_routing_strategy("dag_manager", "p3lm", "routing")
_emit_improves_agent_policy("dag_manager", "p3lm", "policy")
_emit_stores_learning_state("dag_manager", "p3lm", "state")
_emit_records_execution_trace("dag_manager", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("dag_manager", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("dag_manager", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("dag_manager", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("dag_manager", "L4_STATE", "p2_trace_5")
_emit_reads_environ("dag_manager", "env_read", "p2_env_1")
_emit_reads_environ("dag_manager", "env_read", "p2_env_2")
_emit_reads_runtime_state("dag_manager", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("dag_manager", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "dag_manager", "context_pull")
_emit_pulls_context("p1", "dag_manager", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "dag_manager", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "dag_manager", "uwg_term_2")
_emit_writes_through("p1", "dag_manager", "write_through")
_emit_writes_through("p1", "dag_manager", "write_through_2")
_emit_validated_by_safety_plane("p1", "dag_manager", "safety_validation")
_emit_invokes_eval("p1", "dag_manager", "eval_call")
...
class DAGManager(
    ...
    def __init__(self, config: DAGConfig | None = None) -> None:
        ...
        _emit_snapshots_state(str(_uuid.uuid4()), "DAGManager.__init__", "state_snapshot")
        ...
        _emit_applies_guardrail(str(_uuid.uuid4()), "DAGManager.__init__", "p0_governance")
