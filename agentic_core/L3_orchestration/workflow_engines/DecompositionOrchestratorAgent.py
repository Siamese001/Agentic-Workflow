"""
DecompositionOrchestratorAgent - Multi-Agent Task Decomposition Engine
...
3. Inheritance: L3OrchestrationBaseAgent with proper HealerMixin chain
...
@dataclass
class DecompositionOrchestratorAgent(AtomicExecutionMixin, SubatomicTestingMixin, SovereignBaseAgent):
    """
    ...
    def heal(self, violation: dict[str, Any]) -> dict[str, Any]:
        """
        Heal violations detected by DecompositionOrchestratorAgent.
