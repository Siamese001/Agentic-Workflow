...
@dataclass
class SovereignRagOrchestrator(AtomicExecutionMixin, SubatomicTestingMixin, SovereignBaseAgent, IRagProvider):
    """
    Sovereign RAG Orchestrator - L3 Self-Optimizing RAG System.
    ...
    async def red_team_critique(self, answer: str, documents: list[Any], query: str) -> dict[str, Any]:
        ...
        def _parse_critique(raw) -> Any:
            """Parse critique."""
            try:
                from agentic_core.L1_cognition.engine.query_planner import query_planner
