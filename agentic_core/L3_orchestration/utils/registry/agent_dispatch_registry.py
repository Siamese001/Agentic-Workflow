...
trace_contract.emit_replay_key("p0", "agent_dispatch_registry")
trace_contract.emit_determinism_digest("p0", "agent_dispatch_registry")

trace_contract._emit_dispatches_healing_run("p1", "agent_dispatch_registry", "L3")
trace_contract._emit_routes_through("p1", "agent_dispatch_registry", "L3")
trace_contract._emit_agent_executes_agent("p1", "agent_dispatch_registry", "sub_agent")
trace_contract._emit_verifies_policy("p1", "agent_dispatch_registry", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "agent_dispatch_registry", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "agent_dispatch_registry", "boundary_check")
trace_contract._emit_transcripts_response("p1", "agent_dispatch_registry", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "agent_dispatch_registry")
trace_contract._emit_gated_by_confidence("p1", "agent_dispatch_registry", "confidence_gate")
trace_contract._emit_escalates_to_human("p1", "agent_dispatch_registry", "L3")
trace_contract._emit_reads_policy_state("p1", "agent_dispatch_registry", "L3")
trace_contract._emit_snapshots_state("p0", "agent_dispatch_registry", "state_snapshot")
trace_contract._emit_applies_guardrail("p0", "agent_dispatch_registry", "p0_governance")
trace_contract._emit_routes_to_agent("p1", "agent_dispatch_registry", "L3")
trace_contract._emit_dispatches_execution_plan("p1", "agent_dispatch_registry", "L3")
trace_contract._emit_checks_agent_registry("p1", "agent_dispatch_registry", "L3")
trace_contract._emit_validates_agent_capability("p1", "agent_dispatch_registry", "L3")
trace_contract._emit_orchestrates_workflow("p1", "agent_dispatch_registry", "L3")
trace_contract._emit_authorize_and_execute("p2", "agent_dispatch_registry", "execution_auth")
trace_contract._emit_validates_capability("p2", "agent_dispatch_registry", "capability_check")
trace_contract._emit_routes_to_capability("p2", "agent_dispatch_registry", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "agent_dispatch_registry", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "agent_dispatch_registry", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "agent_dispatch_registry", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "agent_dispatch_registry", "exec_output")
trace_contract._emit_dispatches_agent("p3", "agent_dispatch_registry", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "agent_dispatch_registry", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "agent_dispatch_registry", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "agent_dispatch_registry", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "agent_dispatch_registry", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "agent_dispatch_registry", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "agent_dispatch_registry", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "agent_dispatch_registry", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "agent_dispatch_registry", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "agent_dispatch_registry", "eval_metric")
trace_contract._emit_stores_embedding("p4", "agent_dispatch_registry", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "agent_dispatch_registry", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "agent_dispatch_registry", "exec_snapshot_link")

trace_contract._emit_emits_metric_event("agent_dispatch_registry", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("agent_dispatch_registry", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("agent_dispatch_registry", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("agent_dispatch_registry", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("agent_dispatch_registry", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("agent_dispatch_registry", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("agent_dispatch_registry", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("agent_dispatch_registry", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("agent_dispatch_registry", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("agent_dispatch_registry", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("agent_dispatch_registry", "p4obs", "alert")
trace_contract._emit_links_incident_trace("agent_dispatch_registry", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("agent_dispatch_registry", "p3lm", "pattern")
trace_contract._emit_records_learning_event("agent_dispatch_registry", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("agent_dispatch_registry", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("agent_dispatch_registry", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("agent_dispatch_registry", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("agent_dispatch_registry", "p3lm", "policy")
trace_contract._emit_stores_learning_state("agent_dispatch_registry", "p3lm", "state")
trace_contract._emit_records_execution_trace("agent_dispatch_registry", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("agent_dispatch_registry", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("agent_dispatch_registry", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("agent_dispatch_registry", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("agent_dispatch_registry", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("agent_dispatch_registry", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("agent_dispatch_registry", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("agent_dispatch_registry", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("agent_dispatch_registry", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "agent_dispatch_registry", "context_pull")
trace_contract._emit_pulls_context("p1", "agent_dispatch_registry", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "agent_dispatch_registry", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "agent_dispatch_registry", "uwg_term_2")
trace_contract._emit_writes_through("p1", "agent_dispatch_registry", "write_through")
trace_contract._emit_writes_through("p1", "agent_dispatch_registry", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "agent_dispatch_registry", "safety_validation")
trace_contract._emit_invokes_eval("p1", "agent_dispatch_registry", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "agent_dispatch_registry", "routing_commit")
...
class AgentDispatchRegistry:
    ...
    def dispatch(
        ...
        trace_contract._emit_records_execution_trace(_rtid, "L3", f"dispatch:{caller}->{target_class}.{method}")
        trace_contract._emit_signs_execution_trace(_rtid, f"{caller}:{target_class}:{method}", result_type, 0)
