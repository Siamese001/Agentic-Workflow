...
trace_contract.emit_replay_key("p0", "deterministic_replay")
trace_contract.emit_determinism_digest("p0", "deterministic_replay")

trace_contract._emit_dispatches_healing_run("p1", "deterministic_replay", "L3")
trace_contract._emit_routes_through("p1", "deterministic_replay", "L3")
trace_contract._emit_checks_agent_registry("p1", "deterministic_replay", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "deterministic_replay", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "deterministic_replay", "exec_plan")
trace_contract._emit_agent_executes_agent("p1", "deterministic_replay", "sub_agent")
trace_contract._emit_routes_to_agent("p1", "deterministic_replay", "target_agent")
trace_contract._emit_verifies_policy("p1", "deterministic_replay", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "deterministic_replay", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "deterministic_replay", "boundary_check")
trace_contract._emit_transcripts_response("p1", "deterministic_replay", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "deterministic_replay")
trace_contract._emit_gated_by_confidence("p1", "deterministic_replay", "confidence_gate")
trace_contract._emit_escalates_to_human("p1", "deterministic_replay", "L3")
trace_contract._emit_reads_policy_state("p1", "deterministic_replay", "L3")
trace_contract._emit_authorize_and_execute("p2", "deterministic_replay", "execution_auth")
trace_contract._emit_validates_capability("p2", "deterministic_replay", "capability_check")
trace_contract._emit_routes_to_capability("p2", "deterministic_replay", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "deterministic_replay", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "deterministic_replay", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "deterministic_replay", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "deterministic_replay", "exec_output")
trace_contract._emit_dispatches_agent("p3", "deterministic_replay", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "deterministic_replay", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "deterministic_replay", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "deterministic_replay", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "deterministic_replay", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "deterministic_replay", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "deterministic_replay", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "deterministic_replay", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "deterministic_replay", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "deterministic_replay", "eval_metric")
trace_contract._emit_stores_embedding("p4", "deterministic_replay", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "deterministic_replay", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "deterministic_replay", "exec_snapshot_link")

trace_contract.record_execution_trace("deterministic_replay", "deterministic_replay_trace")


trace_contract._emit_emits_metric_event("deterministic_replay", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("deterministic_replay", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("deterministic_replay", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("deterministic_replay", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("deterministic_replay", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("deterministic_replay", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("deterministic_replay", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("deterministic_replay", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("deterministic_replay", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("deterministic_replay", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("deterministic_replay", "p4obs", "alert")
trace_contract._emit_links_incident_trace("deterministic_replay", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("deterministic_replay", "p3lm", "pattern")
trace_contract._emit_records_learning_event("deterministic_replay", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("deterministic_replay", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("deterministic_replay", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("deterministic_replay", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("deterministic_replay", "p3lm", "policy")
trace_contract._emit_stores_learning_state("deterministic_replay", "p3lm", "state")
trace_contract._emit_records_execution_trace("deterministic_replay", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("deterministic_replay", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("deterministic_replay", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("deterministic_replay", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("deterministic_replay", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("deterministic_replay", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("deterministic_replay", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("deterministic_replay", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("deterministic_replay", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "deterministic_replay", "context_pull")
trace_contract._emit_pulls_context("p1", "deterministic_replay", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "deterministic_replay", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "deterministic_replay", "uwg_term_2")
trace_contract._emit_writes_through("p1", "deterministic_replay", "write_through")
trace_contract._emit_writes_through("p1", "deterministic_replay", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "deterministic_replay", "safety_validation")
trace_contract._emit_invokes_eval("p1", "deterministic_replay", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "deterministic_replay", "routing_commit")
...
def _hash_command_result(command: ReplayCommand, result: ReplayResult) -> str:
    ...
    trace_contract._emit_snapshots_state(str(_uuid.uuid4()), "_hash_command_result", "state_snapshot")
    ...
    trace_contract._emit_applies_guardrail(str(_uuid.uuid4()), "_hash_command_result", "p0_governance")
    import uuid as _uuid  # noqa: PLC0415

    _trace_id = str(_uuid.uuid4())
    trace_contract._emit_records_execution_trace(_trace_id, trace_contract.LayerSegment.L3_ORCHESTRATION, "_hash_command_result")
    data = {
        "argv": command.argv,
        "cwd": command.cwd,
