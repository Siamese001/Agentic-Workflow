...
class ToolArg:
    ...
    name: str
    kind: str  # "str", "int", "bool", "list[str]", "dict"
    required: bool
...
class ToolSpec:
    ...
    tool_id: str
    description: str
    side_effect_class: str  # "PURE", "READONLY", "WRITE_FS", "SUBPROCESS"
    args: tuple[ToolArg, ...]
    output_kind: str  # "TEXT", "JSON"
    version: int = 1
    ...
    def __post_init__(self):
        ...
        # Args must be sorted by name for determinism
...
class ToolCall:
    ...
    call_id: str  # SHA256 of (tool_id + canonical args json)
    tool_id: str
    args: dict[str, Any]
    ...
    def __post_init__(self):
        ...
        if not self.tool_id:
            raise ValueError("tool_id cannot be empty")
        # Args can be empty for tools with no arguments
