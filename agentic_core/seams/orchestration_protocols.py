...
class OrchestrationResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {'success': self.success, 'route_mode': self.route_mode, 'plan_hash': self.plan_hash, 'execution_trace': self.execution_trace, 'handshake_state': self.handshake_state.value if hasattr(self.handshake_state, 'value') else str(self.handshake_state), 'determinism_digest': self.determinism_digest, 'human_decision_artifact': self.human_decision_artifact, 'metadata': self.metadata or {}}
...
class IOrchestrator(Protocol):
    ...
    def orchestrate(self, governed_payload: GovernedPayload, route_mode: str, trace_id: str, policy_hash: str, allowed_tools: tuple[str, ...]) -> OrchestrationResult:
        """
