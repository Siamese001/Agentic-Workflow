...
class BoundaryStressTest:
    def __init__(self):
        ...
        self.test_files = {
            "rogue_script": self.project_root / "agentic_core" / "L0_maintenance" / "rogue_script.py",
    ...
    def test_a_structural_realignment(self) -> Dict:
        ...
        try:
            ...
            potential_targets = [
                self.project_root / "agentic_core" / "L0_maintenance" / "depth_aligned" / "rogue_script.py",
                self.project_root / "agentic_core" / "L0_maintenance" / "scripts" / "rogue_script.py",
            ]
    ...
    def test_b_archival_enforcement(self) -> Dict:
        ...
        try:
            ...
            has_prompt = any(indicator in stdout for indicator in [
                "Approve archive?",
                "[y/n/s",
                "y/n/skip",
                "Approve",
    ...
    def test_c_cli_flag_interaction(self) -> Dict:
        ...
        print(f"\n🔧 Running command: {' '.join(cmd)}")
        print(f"🔧 Environment: ARCHIVE_BATCH_ACCEPT=0")
        result["details"].append(f"Command: {' '.join(cmd)}")
    ...
    def run_all_tests(self):
        ...
        print("\n" + "="*80)
        print(f"📄 Full report: STRESS_TEST_MOVEMENT_ARCHIVAL_FINDINGS.md")
        print("="*80)
