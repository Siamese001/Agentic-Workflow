...
def test_1_l4_subfolder_map_exists() -> Tuple[bool, str]:
    ...
    try:
        from agentic_core.config.blueprint_sovereign.structure_blueprint import L4_SUBFOLDER_MAP
...
def test_2_l4_approved_folders_exists() -> Tuple[bool, str]:
    ...
    try:
        from agentic_core.config.blueprint_sovereign.structure_blueprint import L4_APPROVED_FOLDERS
