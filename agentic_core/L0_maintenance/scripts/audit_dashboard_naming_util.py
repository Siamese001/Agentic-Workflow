...
def audit_main_js():
    ...
    mappings = {
        "globalAgentData → realAgentData": "window.globalAgentData" in content
        and "window.realAgentData = window.globalAgentData" in content,
        "agentData → realAgentData": "window.agentData" in content
        and "window.realAgentData = window.agentData" in content,
        "strategicObservationsData → observations": "window.strategicObservationsData" in content
        and "window.observations = window.strategicObservationsData" in content,
        "recommendationsData → recommendations": "window.recommendationsData" in content
        and "window.recommendations = window.recommendationsData" in content,
    }
