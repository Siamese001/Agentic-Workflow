...
MCP_IMPORT = "from agentic_core.L2_execution.mcp.mcp_hardened_mixin_1 import MCPHardenedMixin"
    ...
    try:
        ...
        if not match:
            ...
            if match2:
                ...
                new_content = (
                    content[: match2.start(2)] + "(MCPHardenedMixin)" + content[match2.start(2) :]
                )
                # Add import
