...
sections = [('CORE_L0', 'L0 - MAINTENANCE'), ('CORE_L1', 'L1 - COGNITION'), ('CORE_L2', 'L2 - EXECUTION'), ('CORE_L3', 'L3 - ORCHESTRATION'), ('CORE_L4', 'L4 - STATE'), ('CORE_L5', 'L5 - SAFETY'), ('CORE_L6', 'L6 - OBSERVABILITY'), ('BASE_AGENTS', 'BASE AGENTS'), ('APPS_LIC', 'APPS - LIC'), ('APPS_RG', 'APPS - RG'), ('APPS_SHARED', 'APPS - SHARED'), ('APPS_OTHER', 'APPS - OTHER'), ('OTHER_Utils', 'UTILS'), ('OTHER_tests', 'TESTS'), ('OTHER_Unknown', 'UNKNOWN')]
total = 0
