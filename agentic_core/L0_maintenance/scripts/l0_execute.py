...
CLI:
    python -m agentic_core.L0_maintenance.scripts.l0_execute --scan
    python -m agentic_core.L0_maintenance.scripts.l0_execute --dry-run
    python -m agentic_core.L0_maintenance.scripts.l0_execute --apply --repo-root /path/to/sandbox
"""
