...
async def example_full_pipeline() -> Any:
    ...
    job_description: Any = 'Looking for a senior engineer with Python and ML experience'
    query_embedding: Any = (await batch_service.embed_batch(texts=[job_description], model_func=mock_embedding_function))[0].tolist()
