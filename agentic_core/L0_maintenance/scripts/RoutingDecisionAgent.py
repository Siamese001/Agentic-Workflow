...
class RootCustomsAgent:
    ...
    def run_inspection(self) -> dict[str, Any]:
        ...
        return {
            ...
            "ast_routed_files": sum(
                1 for d in self.routing_decisions if d.destination and "AST" in d.reason
            ),
            "unmatched_files": sum(
                1
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Enhanced Root Customs Agent - AST-Powered Routing"
    )
