...
Usage:
    python scripts/sync_mcp_config.py           # Dry run (show changes)
    python scripts/sync_mcp_config.py --apply   # Apply changes
    python scripts/sync_mcp_config.py --verify  # Verify sync status only
...
def convert_registry_to_windsurf_format(registry: dict[str, Any]) -> dict[str, Any]:
    ...
    # required by the npx runner or MCP package conventions
    NAME_MAP = {
