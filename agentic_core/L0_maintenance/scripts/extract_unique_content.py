...
def main():
    ...
    high_priority_files = [
        ...
        ('archives/legacy_agents/legacy_detectors/DuplicateCodeDetectorAgent.py', 'apps_shared/base_agents'),
        ('archives/legacy_agents/legacy_detectors/PerformanceBottleneckAgent.py', 'apps_shared/base_agents'),
        ('archives/legacy_agents/legacy_detectors/SecurityVulnerabilityAgent.py', 'apps_shared/base_agents'),
        ('archives/legacy_agents/legacy_detectors/UnusedImportCleanerAgent.py', 'apps_shared/base_agents'),
        ('archives/legacy_agents/legacy_detectors/DeprecatedAPIDetectorAgent.py', 'apps_shared/base_agents'),
        ('archives/legacy_agents/legacy_detectors/MemoryLeakDetectorAgent.py', 'apps_shared/base_agents'),
        ...
        ('archives/legacy_validators/ContentCleanlinessValidatorAgent.py', 'apps_shared/base_agents'),
        ...
        ('archives/legacy_orchestrators/SelfRecoveringOrchestratorAgent.py', 'apps_shared/base_agents'),
    ]
    ...
    for archive_path, target_dir in high_priority_files:
        ...
        if unique_agents:
            ...
            print(f"  [EXTRACT] {file_path.name} - {len(unique_other)} classes, {len(unique_functions)} functions")
        else:
            skip_files.append({
                'source': archive_path,
                'existing': existing,
