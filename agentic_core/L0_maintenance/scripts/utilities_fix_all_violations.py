...
micro_fragments: Any = ['shared/result_types.py', 'shared/configuration/config.py', 'shared/core/config.py', 'shared/core/exceptions.py', 'shared/core/models.py', 'shared/errors/exceptions.py', 'shared/resilience/error_recovery.py', 'shared/safety/constitutional_ai.py', 'shared/types/models.py', 'shared/types/workflow_types.py']
            ...
            try:
                ...
                if len(defs) > 5:
                    ...
                    for i in range(0, len(defs), 5):
                        ...
                        SUFFIX: Any = '' if ConfigurationService().i == 0 else f'_{ConfigurationService().i // 5 + 1}'
