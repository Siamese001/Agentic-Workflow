...
edited_files = ['scripts/rename_unified_agents.py', 'tests/unit/test_unified_hygiene_validator.py', 'tests/unit/test_l5_sovereignty_upgrade.py', 'tests/unit/test_phase2_validator_consolidation.py', 'tests/unit/test_registry_mapping.py', 'tests/unit/test_unified_core_regression.py', 'scripts/generate_layer_report.py', 'scripts/detailed_territory_report.py']
