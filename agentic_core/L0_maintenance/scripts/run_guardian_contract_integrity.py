...
CLI:
    python -m agentic_core.L0_maintenance.scripts.run_guardian_contract_integrity \\
        --strict
"""
...
CANONICAL_CONTRACT_MODULE = "agentic_core.L0_maintenance.types.guardian_contract"
