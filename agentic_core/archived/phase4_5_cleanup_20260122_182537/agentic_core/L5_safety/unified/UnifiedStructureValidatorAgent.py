...
# Phase 4.3 Upgrade: Added tests/* and apps_* territories for Universal Sovereignty
LAYER_HIERARCHY = {
    "L0": 0,
    "L1": 1,
    "L2": 2,
    ...
    "L5": 5,
    "L6": 6,
    # Apps territories (can import from all core layers)
    "apps_shared": 7,
    "apps_rg": 7,
    "apps_lic": 7,
    # Test territories (can import from all layers for testing)
    "tests_unit": 8,
    "tests_integration": 8,
    "tests_e2e": 8,
    "tests_functional": 8,
...
# Phase 4.3 Upgrade: Added apps_* and tests/* territories
GRAVITY_RULES = {
    "L0": {"L0"},
    "L1": {"L0", "L1"},
    "L2": {"L0", "L1", "L2"},
    ...
    # Apps can import from all core layers but NOT from each other's internal modules
    "apps_shared": {"L0", "L1", "L2", "L3", "L4", "L5", "L6", "apps_shared"},
    "apps_rg": {"L0", "L1", "L2", "L3", "L4", "L5", "L6", "apps_shared", "apps_rg"},
    "apps_lic": {"L0", "L1", "L2", "L3", "L4", "L5", "L6", "apps_shared", "apps_lic"},
    # Tests can import from everything (for testing purposes)
    "tests_unit": {
        "L0",
        "L1",
        "L2",
    ...
    "tests_fixtures": {"L0", "L1", "L2", "L3", "L4", "L5", "L6", "tests_fixtures"},
    # Legacy alias
    "Apps": {"L0", "L1", "L2", "L3", "L4", "L5", "L6", "Apps"},
}

# Test isolation rules: unit tests should NOT import from integration/e2e
TEST_ISOLATION_RULES = {
    "tests_unit": {
        "tests_integration",
        "tests_e2e",
        "tests_functional",
    },  # unit cannot import these
    "tests_fixtures": set(),  # fixtures can be imported by anyone
}
