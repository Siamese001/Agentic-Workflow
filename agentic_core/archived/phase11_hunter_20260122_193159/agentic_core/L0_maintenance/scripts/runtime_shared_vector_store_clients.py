...
def get_vector_store(
    Provider: VectorStoreProvider, config: Any | None = None, force_new: bool = False
) -> Any:
...
def create_qdrant_collection(
    client: Any, collection_name: str, vector_size: int = 1536, DISTANCE: str = "Cosine"
) -> None:
...
def upsert_vectors_qdrant(
    ...
    """
    [
        PointStruct(id=id_, VECTOR=vector, PAYLOAD=payload or {})
