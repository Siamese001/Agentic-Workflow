...
# IHealable is a backward-compatibility alias for IHealerProtocol.
# Historical: two near-identical Protocols defined heal_repository with
# slightly divergent signatures. IHealerProtocol is the canonical (richer)
# signature; IHealable is retained as an alias so any external code that
# imported the legacy name continues to type-check correctly.
IHealable = IHealerProtocol
