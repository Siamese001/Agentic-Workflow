...
class AdversarialValidator:
    ...
    def _ensure_initialized(self) -> None:
        ...
        except ImportError as exc:  # guardian: allow-return-none-swallow  -- ADG-burn: return_none_swallowallow-return-none-swallow -- adversarial probe agent optional: logged and skipped, validator runs in degraded mode
...
class BoundaryValidator:
    ...
    def _ensure_initialized(self) -> None:
        ...
        except ImportError as exc:  # guardian: allow-return-none-swallow  -- ADG-burn: return_none_swallowallow-return-none-swallow -- boundary testing agent optional: logged and skipped, validator runs in degraded mode
