...
def file_hash(filepath: Path) -> str:
    ...
    try:
        ...
        if size > 50 * 1024 * 1024:
            # For very large files, hash size + mtime as proxy    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
