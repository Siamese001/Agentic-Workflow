...
_emit_escalates_to_human("p1", "boundary_verifier", "human_escalation")
_emit_routes_through("p1", "boundary_verifier", "route_through")
...
_emit_verifies_boundary("p1", "boundary_verifier", "boundary_check")
