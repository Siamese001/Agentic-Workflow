...
def _create_latest_symlinks(
    ...
    """
    import shutil
    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (OSError, NotImplementedError) need specific handling
    symlink_map = {
