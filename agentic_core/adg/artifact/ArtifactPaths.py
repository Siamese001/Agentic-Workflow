...
from agentic_core.adg.artifact.sqlite_schema import DDL, DDL_SHA256
...
# Private compatibility alias; sqlite_schema.DDL is the sole DDL authority.
_DDL = DDL
...
def _write_sqlite(ng_full, db_path: Path) -> Path:
    ...
    try:
                ...
                CASE
                    ...
                    WHEN relation_type = 'antipattern'
                     ...
                     AND (source_file LIKE 'ops_scripts/%'
                       ...
                       OR source_file LIKE 'apps_%/validators/%'
        ...
        meta_rows = [
            ...
            (
                "writer_authority",
                "agentic_core.adg.artifact.ArtifactPaths._write_sqlite",
            ),
