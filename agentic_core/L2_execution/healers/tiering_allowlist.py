...
TIERING_ALLOWLIST: frozenset[tuple[str, str]] = frozenset({('CodeHealerAgent', 'agentic_core/L5_safety/reasoning/CodeHealerAgent.py'), ('GravityLeakRepairAgent', 'agentic_core/L5_safety/reasoning/GravityLeakRepairAgent.py'), ('IntegrityGateExecutorAgent', 'agentic_core/L5_safety/reasoning/IntegrityGateExecutorAgent.py'), ('LocationHealerAgent', 'agentic_core/L5_safety/reasoning/LocationHealerAgent.py'), ('SafetyExecutorAgent', 'agentic_core/L5_safety/reasoning/SafetyExecutorAgent.py'), ('StructureHealerAgent', 'agentic_core/L5_safety/reasoning/StructureHealerAgent.py'), ('TypeHintFixerAgent', 'agentic_core/L5_safety/reasoning/TypeHintFixerAgent.py'), ('DispatchOutreachToolsAgent', 'apps_lic/reasoning/DispatchOutreachToolsAgent.py'), ('OutreachValidationExecutorAgent', 'apps_lic/reasoning/OutreachValidationExecutorAgent.py'), ('DispatchResumeToolsAgent', 'apps_rg/reasoning/DispatchResumeToolsAgent.py'), ('remediation_dispatcher', 'agentic_core/L2_execution/scripts/remediation_dispatcher.py')})
...
def _validate_allowlist_sovereignty() -> None:
    ...
    logger.info(f'TIERING_ALLOWLIST validated: {len(TIERING_ALLOWLIST)} agents, {len(TIERING_ALLOWLIST_AGENT_NAMES)} unique names')
...
__all__ = ['TIERING_ALLOWLIST', 'TIERING_ALLOWLIST_AGENT_NAMES', 'TIERING_ALLOWLIST_FILE_PATHS', 'is_tiering_allowed', 'is_tiering_allowed_by_path']
