...
# Exhaustive write-vector registry
_WRITE_VECTORS: list[_PatchTarget] = [
    ...
    # --- Dynamic (opt-in via register_target) ---
    # importlib.import_module excluded from defaults because
    # the sandbox itself uses it in _resolve_module().
    # Register explicitly if needed for a specific replay.
]
