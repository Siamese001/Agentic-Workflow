...
_emit_checks_agent_registry("p1", "providers", "agent_registry")
_emit_validates_agent_capability("p1", "providers", "capability")
_emit_dispatches_execution_plan("p1", "providers", "exec_plan")
_emit_agent_executes_agent("p1", "providers", "sub_agent")
_emit_routes_to_agent("p1", "providers", "target_agent")
_emit_verifies_policy("p1", "providers", "policy_check")
_emit_observes_runtime_state("p1", "providers", "runtime_state")
_emit_verifies_boundary("p1", "providers", "boundary_check")
_emit_transcripts_response("p1", "providers", "transcript")
_emit_hard_fails_untranscripted("p1", "providers")
_emit_gated_by_confidence("p1", "providers", "confidence_gate")
