...
_emit_checks_agent_registry("p1", "promotion_token", "agent_registry")
_emit_validates_agent_capability("p1", "promotion_token", "capability")
_emit_dispatches_execution_plan("p1", "promotion_token", "exec_plan")
_emit_agent_executes_agent("p1", "promotion_token", "sub_agent")
_emit_routes_to_agent("p1", "promotion_token", "target_agent")
_emit_verifies_policy("p1", "promotion_token", "policy_check")
_emit_observes_runtime_state("p1", "promotion_token", "runtime_state")
_emit_verifies_boundary("p1", "promotion_token", "boundary_check")
_emit_transcripts_response("p1", "promotion_token", "transcript")
_emit_hard_fails_untranscripted("p1", "promotion_token")
_emit_gated_by_confidence("p1", "promotion_token", "confidence_gate")
