...
class DigestCalculator:
    ...
    COMPONENT_KEYS = ('policy_hash', 'registry_hash', 'config_surface_hash', 'transcript_hash', 'dependency_lock_hash')

    @classmethod
    def compute(self, *, policy_hash: str, registry_hash: str, config_surface_hash: str, transcript_hash: str, dependency_lock_hash: str) -> str:
        ...
        """
        for name, value in [('policy_hash', policy_hash), ('registry_hash', registry_hash), ('config_surface_hash', config_surface_hash), ('transcript_hash', transcript_hash), ('dependency_lock_hash', dependency_lock_hash)]:
        ...
        material = {'config_surface_hash': config_surface_hash, 'dependency_lock_hash': dependency_lock_hash, 'policy_hash': policy_hash, 'registry_hash': registry_hash, 'transcript_hash': transcript_hash}
