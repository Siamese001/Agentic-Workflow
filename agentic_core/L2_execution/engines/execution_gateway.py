...
class ExecutionGateway:
    ...
    async def execute_with_trace(
        ...
        except SignatureVerificationError:    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context    # guardian: SignatureVerificationError should be handled with specific context
        ...
        except BudgetExceeded as e:    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context    # guardian: BudgetExceeded should be handled with specific context
            builder.validation_decision = "FAIL"
            builder.error = f"Budget exceeded: {e}"
            raise
        except ToolContractViolation as e:    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context    # guardian: ToolContractViolation should be handled with specific context
            builder.validation_decision = "FAIL"
