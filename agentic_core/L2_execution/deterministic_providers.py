...
emit_replay_key("p0", "deterministic_providers")
emit_determinism_digest("p0", "deterministic_providers")

_emit_dispatches_healing_run("p1", "deterministic_providers", "L2")
_emit_routes_through("p1", "deterministic_providers", "L2")
_emit_checks_agent_registry("p1", "deterministic_providers", "agent_registry")
_emit_validates_agent_capability("p1", "deterministic_providers", "capability")
_emit_dispatches_execution_plan("p1", "deterministic_providers", "exec_plan")
_emit_agent_executes_agent("p1", "deterministic_providers", "sub_agent")
_emit_routes_to_agent("p1", "deterministic_providers", "target_agent")
_emit_verifies_policy("p1", "deterministic_providers", "policy_check")
_emit_observes_runtime_state("p1", "deterministic_providers", "runtime_state")
_emit_verifies_boundary("p1", "deterministic_providers", "boundary_check")
_emit_transcripts_response("p1", "deterministic_providers", "transcript")
_emit_hard_fails_untranscripted("p1", "deterministic_providers")
_emit_gated_by_confidence("p1", "deterministic_providers", "confidence_gate")
_emit_escalates_to_human("p1", "deterministic_providers", "L2")
_emit_reads_policy_state("p1", "deterministic_providers", "L2")
_emit_authorize_and_execute("p2", "deterministic_providers", "execution_auth")
_emit_validates_capability("p2", "deterministic_providers", "capability_check")
_emit_routes_to_capability("p2", "deterministic_providers", "capability_route")
_emit_writes_via_uwg("p2", "deterministic_providers", "uwg_write")
_emit_blocks_direct_write("p2", "deterministic_providers", "direct_write_block")
_emit_records_tool_invocation("p2", "deterministic_providers", "tool_invocation")
_emit_captures_execution_output("p2", "deterministic_providers", "exec_output")
_emit_dispatches_agent("p3", "deterministic_providers", "agent_dispatch")
_emit_coordinates_agents("p3", "deterministic_providers", "agent_coordination")
_emit_records_workflow_lineage("p3", "deterministic_providers", "workflow_lineage")
_emit_records_healing_outcome("p3", "deterministic_providers", "healing_outcome")
_emit_escalates_failure("p3", "deterministic_providers", "failure_escalation")
_emit_orchestrates_workflow("p3", "deterministic_providers", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "deterministic_providers", "healing_dispatch")
_emit_invokes_evaluation("p3", "deterministic_providers", "evaluation_signal")
_emit_records_telemetry_event("p4", "deterministic_providers", "telemetry_event")
_emit_captures_evaluation_metric("p4", "deterministic_providers", "eval_metric")
...
_emit_emits_metric_event("deterministic_providers", "p4obs", "metric_1")
_emit_emits_metric_event("deterministic_providers", "p4obs", "metric_2")
_emit_emits_metric_event("deterministic_providers", "p4obs", "metric_3")
_emit_emits_metric_event("deterministic_providers", "p4obs", "metric_4")
_emit_emits_metric_event("deterministic_providers", "p4obs", "metric_5")
_emit_emits_metric_event("deterministic_providers", "p4obs", "metric_6")
_emit_records_incident_event("deterministic_providers", "p4obs", "incident")
_emit_captures_runtime_anomaly("deterministic_providers", "p4obs", "anomaly")
_emit_writes_observability_log("deterministic_providers", "p4obs", "obs_log")
_emit_updates_monitoring_state("deterministic_providers", "p4obs", "mon_state")
_emit_triggers_alert("deterministic_providers", "p4obs", "alert")
_emit_links_incident_trace("deterministic_providers", "p4obs", "trace_link")
_emit_captures_pattern("deterministic_providers", "p3lm", "pattern")
_emit_records_learning_event("deterministic_providers", "p3lm", "learning_event")
_emit_writes_learning_snapshot("deterministic_providers", "p3lm", "snapshot")
_emit_feeds_meta_learning("deterministic_providers", "p3lm", "meta_feed")
_emit_updates_routing_strategy("deterministic_providers", "p3lm", "routing")
_emit_improves_agent_policy("deterministic_providers", "p3lm", "policy")
_emit_stores_learning_state("deterministic_providers", "p3lm", "state")
_emit_records_execution_trace("deterministic_providers", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("deterministic_providers", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("deterministic_providers", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("deterministic_providers", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("deterministic_providers", "L4_STATE", "p2_trace_5")
_emit_reads_environ("deterministic_providers", "env_read", "p2_env_1")
_emit_reads_environ("deterministic_providers", "env_read", "p2_env_2")
_emit_reads_runtime_state("deterministic_providers", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("deterministic_providers", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "deterministic_providers", "context_pull")
_emit_pulls_context("p1", "deterministic_providers", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "deterministic_providers", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "deterministic_providers", "uwg_term_2")
_emit_writes_through("p1", "deterministic_providers", "write_through")
_emit_writes_through("p1", "deterministic_providers", "write_through_2")
_emit_validated_by_safety_plane("p1", "deterministic_providers", "safety_validation")
_emit_invokes_eval("p1", "deterministic_providers", "eval_call")
_emit_proposal_commits_routing("p1", "deterministic_providers", "routing_commit")
