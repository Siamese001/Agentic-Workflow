"""
Invoke execution actions via external service APIs.

This module provides the core execution layer for invoking external services,
including the Gemini API for LLM-based operations. It handles request
formatting, response parsing, error handling, and retry logic.
"""
# AUTO-HYDRATED FINAL (substring) score=0.950 from scripts\pipeline_ops\synthesis\use_tools\use_a_tool\invoke_service.py
...
from utils_RES_v2 import text_utils, reasoning_config_to_api_params, enhance_system_prompt_with_reasoning
