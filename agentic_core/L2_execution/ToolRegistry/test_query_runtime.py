...
class TestQueryTerminalHardening(unittest.TestCase):
    def test_timeout_termination_logic(self):
        ...
        with patch(
            "agentic_core.L2_execution.ToolRegistry.query_runtime.execute_sql",
    ...
    def test_retry_logic_on_transient_failure(self):
        ...
        with patch(
            ...
            with patch(
                "agentic_core.L2_execution.ToolRegistry.query_runtime.time.sleep"
    ...
    def test_high_frequency_execution(self):
        ...
        with patch(
            "agentic_core.L2_execution.ToolRegistry.query_runtime.execute_sql", return_value="ok"
        ):
            for _ in range(10):
    ...
    def test_concurrent_animation_thread_isolation(self):
        ...
        with patch(
            "agentic_core.L2_execution.ToolRegistry.query_runtime.Progress"
