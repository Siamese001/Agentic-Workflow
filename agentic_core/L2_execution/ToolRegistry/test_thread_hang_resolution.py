...
class TestThreadHangResolution(unittest.TestCase):
    ...
    def test_non_blocking_exit_on_timeout(self):
        ...
        with patch('agentic_core.L2_execution.ToolRegistry.query_runtime.execute_sql', side_effect=infinite_worker):
    ...
    def test_retry_decorator_interaction_with_hang(self):
        ...
        with patch('agentic_core.L2_execution.ToolRegistry.query_runtime.execute_sql', side_effect=hang_on_first):
    ...
    def test_clean_error_propagation(self):
        ...
        with patch('agentic_core.L2_execution.ToolRegistry.query_runtime.execute_sql', side_effect=ValueError("Test")):
