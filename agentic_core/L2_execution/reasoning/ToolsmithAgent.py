        ...
        for rel_path, files in self.TERRITORY_SEED_CONTENT.items():
            ...
            for filename, content in files.items():
                ...
                if file_path.exists():
                    ...
                    continue
                if dry_run:    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
