...
AGENT_TAXONOMY_MAP: dict[str, AgentClassification] = {
    ...
    "SectionBalanceAgent": AgentClassification(
        ...
        is_shim=True,
        implements_l2_contract=False,
        notes="SHIM → RGValidationExecutor. Backward compatibility only.",
    ),
    ...
    "LeadQualityAgent": AgentClassification(
        ...
        is_shim=True,
        implements_l2_contract=False,
        notes="RETIRED/EMPTY. Consolidated out of active agent pool (2026-02-08). Zero functional value.",
    ),
    "DeliverabilityAgent": AgentClassification(
        ...
        is_shim=True,
        implements_l2_contract=False,
        notes="SHIM → LICValidationExecutor. Backward compatibility only.",
    ),
