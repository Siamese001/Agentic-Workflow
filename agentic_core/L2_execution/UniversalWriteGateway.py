...
emit_replay_key("p0", "UniversalWriteGateway")
emit_determinism_digest("p0", "UniversalWriteGateway")

_emit_dispatches_healing_run("p1", "UniversalWriteGateway", "L2")
_emit_routes_through("p1", "UniversalWriteGateway", "L2")
_emit_checks_agent_registry("p1", "UniversalWriteGateway", "agent_registry")
_emit_validates_agent_capability("p1", "UniversalWriteGateway", "capability")
_emit_dispatches_execution_plan("p1", "UniversalWriteGateway", "exec_plan")
_emit_agent_executes_agent("p1", "UniversalWriteGateway", "sub_agent")
_emit_routes_to_agent("p1", "UniversalWriteGateway", "target_agent")
_emit_verifies_policy("p1", "UniversalWriteGateway", "policy_check")
_emit_observes_runtime_state("p1", "UniversalWriteGateway", "runtime_state")
_emit_verifies_boundary("p1", "UniversalWriteGateway", "boundary_check")
_emit_transcripts_response("p1", "UniversalWriteGateway", "transcript")
_emit_hard_fails_untranscripted("p1", "UniversalWriteGateway")
_emit_gated_by_confidence("p1", "UniversalWriteGateway", "confidence_gate")
_emit_escalates_to_human("p1", "UniversalWriteGateway", "L2")
_emit_reads_policy_state("p1", "UniversalWriteGateway", "L2")
_emit_authorize_and_execute("p2", "UniversalWriteGateway", "execution_auth")
_emit_validates_capability("p2", "UniversalWriteGateway", "capability_check")
_emit_routes_to_capability("p2", "UniversalWriteGateway", "capability_route")
_emit_writes_via_uwg("p2", "UniversalWriteGateway", "uwg_write")
_emit_blocks_direct_write("p2", "UniversalWriteGateway", "direct_write_block")
_emit_records_tool_invocation("p2", "UniversalWriteGateway", "tool_invocation")
_emit_captures_execution_output("p2", "UniversalWriteGateway", "exec_output")
_emit_dispatches_agent("p3", "UniversalWriteGateway", "agent_dispatch")
_emit_coordinates_agents("p3", "UniversalWriteGateway", "agent_coordination")
_emit_records_workflow_lineage("p3", "UniversalWriteGateway", "workflow_lineage")
_emit_records_healing_outcome("p3", "UniversalWriteGateway", "healing_outcome")
_emit_escalates_failure("p3", "UniversalWriteGateway", "failure_escalation")
_emit_orchestrates_workflow("p3", "UniversalWriteGateway", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "UniversalWriteGateway", "healing_dispatch")
_emit_invokes_evaluation("p3", "UniversalWriteGateway", "evaluation_signal")
_emit_records_telemetry_event("p4", "UniversalWriteGateway", "telemetry_event")
_emit_captures_evaluation_metric("p4", "UniversalWriteGateway", "eval_metric")
...
_emit_emits_metric_event("UniversalWriteGateway", "p4obs", "metric_1")
_emit_emits_metric_event("UniversalWriteGateway", "p4obs", "metric_2")
_emit_emits_metric_event("UniversalWriteGateway", "p4obs", "metric_3")
_emit_emits_metric_event("UniversalWriteGateway", "p4obs", "metric_4")
_emit_emits_metric_event("UniversalWriteGateway", "p4obs", "metric_5")
_emit_emits_metric_event("UniversalWriteGateway", "p4obs", "metric_6")
_emit_records_incident_event("UniversalWriteGateway", "p4obs", "incident")
_emit_captures_runtime_anomaly("UniversalWriteGateway", "p4obs", "anomaly")
_emit_writes_observability_log("UniversalWriteGateway", "p4obs", "obs_log")
_emit_updates_monitoring_state("UniversalWriteGateway", "p4obs", "mon_state")
_emit_triggers_alert("UniversalWriteGateway", "p4obs", "alert")
_emit_links_incident_trace("UniversalWriteGateway", "p4obs", "trace_link")
_emit_captures_pattern("UniversalWriteGateway", "p3lm", "pattern")
_emit_records_learning_event("UniversalWriteGateway", "p3lm", "learning_event")
_emit_writes_learning_snapshot("UniversalWriteGateway", "p3lm", "snapshot")
_emit_feeds_meta_learning("UniversalWriteGateway", "p3lm", "meta_feed")
_emit_updates_routing_strategy("UniversalWriteGateway", "p3lm", "routing")
_emit_improves_agent_policy("UniversalWriteGateway", "p3lm", "policy")
_emit_stores_learning_state("UniversalWriteGateway", "p3lm", "state")
_emit_records_execution_trace("UniversalWriteGateway", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("UniversalWriteGateway", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("UniversalWriteGateway", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("UniversalWriteGateway", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("UniversalWriteGateway", "L4_STATE", "p2_trace_5")
_emit_reads_environ("UniversalWriteGateway", "env_read", "p2_env_1")
_emit_reads_environ("UniversalWriteGateway", "env_read", "p2_env_2")
_emit_reads_runtime_state("UniversalWriteGateway", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("UniversalWriteGateway", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "UniversalWriteGateway", "context_pull")
_emit_pulls_context("p1", "UniversalWriteGateway", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "UniversalWriteGateway", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "UniversalWriteGateway", "uwg_term_2")
_emit_writes_through("p1", "UniversalWriteGateway", "write_through")
_emit_writes_through("p1", "UniversalWriteGateway", "write_through_2")
_emit_validated_by_safety_plane("p1", "UniversalWriteGateway", "safety_validation")
_emit_invokes_eval("p1", "UniversalWriteGateway", "eval_call")
_emit_proposal_commits_routing("p1", "UniversalWriteGateway", "routing_commit")
