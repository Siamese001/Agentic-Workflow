...
emit_replay_key("p0", "execution_adaptation")
emit_determinism_digest("p0", "execution_adaptation")

_emit_dispatches_healing_run("p1", "execution_adaptation", "L2")
_emit_routes_through("p1", "execution_adaptation", "L2")
_emit_checks_agent_registry("p1", "execution_adaptation", "agent_registry")
_emit_validates_agent_capability("p1", "execution_adaptation", "capability")
_emit_dispatches_execution_plan("p1", "execution_adaptation", "exec_plan")
_emit_agent_executes_agent("p1", "execution_adaptation", "sub_agent")
_emit_routes_to_agent("p1", "execution_adaptation", "target_agent")
_emit_verifies_policy("p1", "execution_adaptation", "policy_check")
_emit_observes_runtime_state("p1", "execution_adaptation", "runtime_state")
_emit_verifies_boundary("p1", "execution_adaptation", "boundary_check")
_emit_transcripts_response("p1", "execution_adaptation", "transcript")
_emit_hard_fails_untranscripted("p1", "execution_adaptation")
_emit_gated_by_confidence("p1", "execution_adaptation", "confidence_gate")
_emit_escalates_to_human("p1", "execution_adaptation", "L2")
_emit_reads_policy_state("p1", "execution_adaptation", "L2")
...
_emit_authorize_and_execute("p2", "execution_adaptation", "execution_auth")
_emit_validates_capability("p2", "execution_adaptation", "capability_check")
_emit_routes_to_capability("p2", "execution_adaptation", "capability_route")
_emit_writes_via_uwg("p2", "execution_adaptation", "uwg_write")
_emit_blocks_direct_write("p2", "execution_adaptation", "direct_write_block")
_emit_records_tool_invocation("p2", "execution_adaptation", "tool_invocation")
_emit_captures_execution_output("p2", "execution_adaptation", "exec_output")
_emit_dispatches_agent("p3", "execution_adaptation", "agent_dispatch")
_emit_coordinates_agents("p3", "execution_adaptation", "agent_coordination")
_emit_records_workflow_lineage("p3", "execution_adaptation", "workflow_lineage")
_emit_records_healing_outcome("p3", "execution_adaptation", "healing_outcome")
_emit_escalates_failure("p3", "execution_adaptation", "failure_escalation")
_emit_orchestrates_workflow("p3", "execution_adaptation", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "execution_adaptation", "healing_dispatch")
_emit_invokes_evaluation("p3", "execution_adaptation", "evaluation_signal")
_emit_records_telemetry_event("p4", "execution_adaptation", "telemetry_event")
_emit_captures_evaluation_metric("p4", "execution_adaptation", "eval_metric")
_emit_stores_embedding("p4", "execution_adaptation", "embedding_store")
_emit_updates_meta_learning_state("p4", "execution_adaptation", "meta_learning")
_emit_links_execution_to_snapshot("p4", "execution_adaptation", "exec_snapshot_link")
from agentic_core.L_CONTRACTS.lifecycle_trace_contract import (
    _emit_agent_executes_agent,
...
_emit_emits_metric_event("execution_adaptation", "p4obs", "metric_1")
_emit_emits_metric_event("execution_adaptation", "p4obs", "metric_2")
_emit_emits_metric_event("execution_adaptation", "p4obs", "metric_3")
_emit_emits_metric_event("execution_adaptation", "p4obs", "metric_4")
_emit_emits_metric_event("execution_adaptation", "p4obs", "metric_5")
_emit_emits_metric_event("execution_adaptation", "p4obs", "metric_6")
_emit_records_incident_event("execution_adaptation", "p4obs", "incident")
_emit_captures_runtime_anomaly("execution_adaptation", "p4obs", "anomaly")
_emit_writes_observability_log("execution_adaptation", "p4obs", "obs_log")
_emit_updates_monitoring_state("execution_adaptation", "p4obs", "mon_state")
_emit_triggers_alert("execution_adaptation", "p4obs", "alert")
_emit_links_incident_trace("execution_adaptation", "p4obs", "trace_link")
_emit_captures_pattern("execution_adaptation", "p3lm", "pattern")
_emit_records_learning_event("execution_adaptation", "p3lm", "learning_event")
_emit_writes_learning_snapshot("execution_adaptation", "p3lm", "snapshot")
_emit_feeds_meta_learning("execution_adaptation", "p3lm", "meta_feed")
_emit_updates_routing_strategy("execution_adaptation", "p3lm", "routing")
_emit_improves_agent_policy("execution_adaptation", "p3lm", "policy")
_emit_stores_learning_state("execution_adaptation", "p3lm", "state")
_emit_records_execution_trace("execution_adaptation", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("execution_adaptation", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("execution_adaptation", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("execution_adaptation", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("execution_adaptation", "L4_STATE", "p2_trace_5")
_emit_reads_environ("execution_adaptation", "env_read", "p2_env_1")
_emit_reads_environ("execution_adaptation", "env_read", "p2_env_2")
_emit_reads_runtime_state("execution_adaptation", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("execution_adaptation", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "execution_adaptation", "context_pull")
_emit_pulls_context("p1", "execution_adaptation", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "execution_adaptation", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "execution_adaptation", "uwg_term_2")
_emit_writes_through("p1", "execution_adaptation", "write_through")
_emit_writes_through("p1", "execution_adaptation", "write_through_2")
_emit_validated_by_safety_plane("p1", "execution_adaptation", "safety_validation")
_emit_invokes_eval("p1", "execution_adaptation", "eval_call")
_emit_proposal_commits_routing("p1", "execution_adaptation", "routing_commit")
