...
def _check_l5_cert_ref_l2(ref: str) -> None:
    ...
    except Exception as exc:  # guardian: allow-log-and-swallow -- L5 registry must not crash L2 executor; treat as unverified  # guardian: allow-broad-exception -- P1 ADG burndown
