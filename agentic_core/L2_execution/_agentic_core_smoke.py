...
def import_attr_or_skip(module_path: str, attr_name: str) -> Any:
    ...
    return getattr(module, attr_name)  # guardian: allow-hallucinated-tool-name -- getattr is Python stdlib builtin, not a hallucinated tool; detector false positive
