...
_emit_dispatches_healing_run("p1", "determinism", "L2")
_emit_routes_through("p1", "determinism", "L2")
...
_emit_escalates_to_human("p1", "determinism", "L2")
_emit_reads_policy_state("p1", "determinism", "L2")
_emit_pulls_context("p1", "determinism", "context_pull")
_emit_pulls_context("p1", "determinism", "context_pull_secondary")
_emit_execution_terminates_at_uwg("p1", "determinism", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "determinism", "uwg_term_secondary")
_emit_writes_through("p1", "determinism", "write_through")
_emit_writes_through("p1", "determinism", "write_through_secondary")
