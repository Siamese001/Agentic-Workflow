...
def create_mcp_registry(specs: list[MCPClientSpec], fail_on_error: bool = False) -> MCPClientRegistry:
    ...
    for spec in specs:
        ...
        except MCPClientInitializationError as exc:    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context    # guardian: MCPClientInitializationError should be handled with specific context
