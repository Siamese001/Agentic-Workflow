#!/usr/bin/env python3
"""
post_cursor_agent_plan_lifecycle_audit.py — Unified Plan Lifecycle audit hook (W2.P3).

Consolidates 5 Plan Lifecycle hooks into a single hook with subcommands:
- creation: Plan creation audit with auto-correction (from post_cursor_agent_plan_creation_audit)
- scope: Plan scope authorization audit (from post_cursor_agent_plan_scope_audit)
- complete: Plan completion marker audit (from post_cursor_agent_plan_complete_audit)
- duplicate: Duplicate plan POST detection (from post_cursor_agent_plans_dup_audit)
- evidence: Graph-layer evidence gate (from post_cursor_agent_plan_evidence_gate)
...
# =============================================================================
# SUBCOMMAND: creation (from post_cursor_agent_plan_creation_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: scope (from post_cursor_agent_plan_scope_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: complete (from post_cursor_agent_plan_complete_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: duplicate (from post_cursor_agent_plans_dup_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: evidence (from post_cursor_agent_plan_evidence_gate.py)
# =============================================================================
...
def cmd_evidence(args: argparse.Namespace) -> int:
    ...
    for slug in plan_slugs:
        plan_path = REPO_ROOT / ".windsurf" / "plans" / f"{slug}.md"
        if plan_path.exists():
            try:
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="post_cursor_agent_plan_lifecycle_audit",
