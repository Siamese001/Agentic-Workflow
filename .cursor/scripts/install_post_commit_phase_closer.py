...
Usage:
    python .cursor/scripts/install_post_commit_phase_closer.py
    python .cursor/scripts/install_post_commit_phase_closer.py --uninstall
    python .cursor/scripts/install_post_commit_phase_closer.py --status
"""
...
python "$(git rev-parse --show-toplevel)/.cursor/scripts/post_commit_phase_closer.py" >&2 || true
{MARKER_END}
"""
