#!/usr/bin/env python3
"""
post_cursor_agent_author_gate_schema_audit.py — AG-10 packet shape conformance audit.

Sibling of ``post_cursor_agent_author_gate_ui_audit.py``. The UI audit checks that
...
parser ``post_cursor_agent_author_gate_capture.py`` keys on (``decision_id``,
...
# ---------------------------------------------------------------------------
# IO helpers (mirrored from post_cursor_agent_author_gate_ui_audit.py for behavioral
        ...
        findings.append(
            {
                ...
                "observed": policy,
                "remediation": (
                    "Pipe spec to .cursor/skills/author-gate-packet-builder/"
