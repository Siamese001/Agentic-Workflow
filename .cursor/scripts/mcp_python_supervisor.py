...
Usage::
    ...
    MCP_SUPERVISOR_ENABLED=1 python .cursor/scripts/mcp_python_supervisor.py
    python .cursor/scripts/mcp_python_supervisor.py --dry-run
    python .cursor/scripts/mcp_python_supervisor.py --json --min-interval 60
