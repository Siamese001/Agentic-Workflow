...
is detected (most-recently-modified `.cursor/plans/*.md` within the last
...
Scope-containment rule reference: `.cursor/rules/scope-containment.md`.
"""
...
def main() -> int:
    ...
    try:
        ...
        msg = (
            ...
            f"See .cursor/rules/scope-containment.md. "
