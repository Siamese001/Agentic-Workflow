...
just edited a file under .cursor/plans/*.md. Any other write → immediate
...
CLOSER_SCRIPT = REPO_ROOT / ".cursor" / "scripts" / "plan_driven_closer.py"
...
def main() -> int:
    ...
    if ".cursor/plans/" not in file_path or not file_path.endswith(".md"):
        return 0
