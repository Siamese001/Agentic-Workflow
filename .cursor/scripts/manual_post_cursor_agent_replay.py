...
-----
    ...
    python .cursor/scripts/manual_post_cursor_agent_replay.py < response.txt

    # From clipboard (Windows / pyperclip):
    python .cursor/scripts/manual_post_cursor_agent_replay.py --clipboard

    # From a file:
    python .cursor/scripts/manual_post_cursor_agent_replay.py --file response.txt

    # Dry-run (show what would run without invoking hooks):
    python .cursor/scripts/manual_post_cursor_agent_replay.py --file response.txt --dry-run
