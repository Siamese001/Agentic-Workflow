...
**SSOT chain:** `.cursor/hooks/after_agent_governance_dispatch.py` → active `.cursor/scripts/post_cursor_agent_*.py`
...
Manual replay: `python .cursor/scripts/manual_post_cursor_agent_replay.py` (point at legacy path if needed).
