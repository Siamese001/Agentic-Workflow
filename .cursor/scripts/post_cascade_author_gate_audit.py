#!/usr/bin/env python3
"""
post_cascade_author_gate_audit.py — Unified Author-Gate audit hook (W2.P2).
...
# =============================================================================
# SUBCOMMAND: capture (from post_cascade_author_gate_capture.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: ui (from post_cascade_author_gate_ui_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: schema (from post_cascade_author_gate_schema_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: pipeline (from post_cascade_author_gate_pipeline_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: miss_detector (from post_cascade_author_gate_miss_detector.py)
# =============================================================================
...
def cmd_miss_detector(args: argparse.Namespace) -> int:
    ...
    # Plan file creation
    if re.search(r'\.windsurf/plans/', response_text):
...
# =============================================================================
# SUBCOMMAND: ask_packet (from post_cascade_ask_user_question_packet_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: queue_drain (from post_cascade_ag_queue_drain_audit.py)
# =============================================================================
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="post_cascade_author_gate_audit",
