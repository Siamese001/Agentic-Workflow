#!/usr/bin/env python3
"""
post_cursor_agent_plan_complete_audit.py — Warn when Cursor Agent closes a plan without
emitting a PLAN_COMPLETE: marker.

Hook: post_cursor_agent_response (show_output=true).
...
``artifacts/cursor/plan_complete_audit.jsonl``.
