...
_fs_launcher = repo_root / ".cursor" / "scripts" / "filesystem_mcp_launcher.js"
...
def check_mcp_whitelist(server_name: str, tool_name: str) -> int:
    ...
    if server_name not in allowed:
        return _exit_block(
            ...
            f"Add the server to mcp.json (via .cursor/scripts/sync_mcp_config.py) "
...
def check_notion_wave_deferral(tool_name: str) -> int:
    ...
    return _exit_block(
        ...
        "Per .cursor/rules/notion-plan-wave-deferral.md, batch ALL Notion "
