...
Usage:
    python .cursor/scripts/apply_append_only_triggers.py           # apply to all
    python .cursor/scripts/apply_append_only_triggers.py --check   # verify without changes
    python .cursor/scripts/apply_append_only_triggers.py --db <path>  # single DB
