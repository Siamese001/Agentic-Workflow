...
USAGE AS CLI
------------
    python .cursor/scripts/author_gate_ledger_integrity.py --verify
    python .cursor/scripts/author_gate_ledger_integrity.py --backfill
    python .cursor/scripts/author_gate_ledger_integrity.py --report
