...
is detected (most-recently-modified `.windsurf/plans/*.md` within the last
...
Scope-containment rule reference: `.windsurf/rules/scope-containment.md`.
"""
...
def main() -> int:
    ...
    try:
        ...
        msg = (
            ...
            f"See .windsurf/rules/scope-containment.md. "
