...
Pure extraction: Bypass environment variable handling for Windsurf hooks.
...
def get_bypass_var(hook_name: str) -> str:
    ...
    - post_cascade_notion_plans_status_audit.py -> NOTION_PLANS_STATUS_BYPASS
    ...
    prefixes_to_strip = ["pre_", "post_", "post_cascade_", "check_"]
