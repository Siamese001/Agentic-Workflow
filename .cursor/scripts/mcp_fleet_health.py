...
Usage:
    python .cursor/scripts/mcp_fleet_health.py
    python .cursor/scripts/mcp_fleet_health.py --json   (machine-readable)
    python .cursor/scripts/mcp_fleet_health.py --quiet  (exit code only)
"""
