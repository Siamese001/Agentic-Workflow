...
- Constitutional Rule: `.cursor/rules/constitutional.md` §9
- Enforcement Skill: `.cursor/skills/artifact-management/SKILL.md` (progress display protocol covers timeout+progress)

> **Skill directory note:** The `timeout-progress-enforcement` skill directory is not present in the current `.cursor/skills/` layout (7 canonical skills as of 2026-04-14). References to `.cursor/skills/timeout-progress-enforcement/` are stale and should not be used.
