---
description: Scaffold a new Cursor Agent skill (.cursor/skills/<slug>/SKILL.md) from the house-style template. Use when authoring a new skill so it inherits the canonical frontmatter, trigger table, hard rules, procedure, forbidden patterns, and references shape.
---
...
- You are about to author a new skill in `.cursor/skills/<slug>/SKILL.md`.
...
Copy `.cursor/templates/skill-template.md` to `.cursor/skills/<slug>/SKILL.md` and fill in:
...
- Frontmatter precedent: `.cursor/skills/tavily-research/SKILL.md`, `.cursor/skills/adg-sqlite/SKILL.md`
