...
rule_files = [f for f in changed_files if f.startswith('.cursor/rules/')]
skill_files = [f for f in changed_files if f.startswith('.cursor/skills/')]
```
...
| `.cursor/rules/*.md` | Rule changes |
| `.cursor/skills/**/SKILL.md` | Skill changes |
...
- Rule: `.cursor/rules/boundary-audit-required.md`
- Rule: `.cursor/rules/agentic-core-glob-lock.md`
