...
**Invariant / tuning:** [author-gate-svp-calibration.mdc](../rules/author-gate-svp-calibration.mdc) · output `docs/reports/calibration/<YYYY-Www>.md`
...
3. Apply `author-gate-svp-calibration.mdc` if CI miss bands require Author-Gate triggers.
