...
1. Read the `tavily-research` skill at `.cursor/skills/tavily-research/SKILL.md` and its decision tree at `.cursor/skills/tavily-research/tool_decision_tree.md`.
...
- Skill: `.cursor/skills/tavily-research/SKILL.md`
- Decision tree: `.cursor/skills/tavily-research/tool_decision_tree.md`
