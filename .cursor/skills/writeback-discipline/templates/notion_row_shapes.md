...
**Trigger**: Modified `.cursor/mcp.json` or gate behavior in `.cursor/scripts/*_gate.py`
...
|---|---|---|
| Constitutional Rules Registry | `1c1379bc-32ca-4216-898a-3672f0316f69` | Rule added/modified in `.cursor/rules/` |
