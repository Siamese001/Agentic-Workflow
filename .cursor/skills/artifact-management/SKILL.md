...
- When a path contains `C:\Users\`, `.cursor/plans/`, or any absolute user-home path
...
Each phase produces exactly one evidence file under `.cursor/plans/`.
