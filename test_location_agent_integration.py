...
""")
    ...
    try:
        ...
        print(f"Testing heal with violation:")
        ...
        required_keys = ['success', 'violations_fixed', 'violations_found', 'message', 'target', 'agent', 'execution_time_ms']
        ...
        violations = [
            (test_file, 'File in invalid location: temp_test_dir')
        ]
