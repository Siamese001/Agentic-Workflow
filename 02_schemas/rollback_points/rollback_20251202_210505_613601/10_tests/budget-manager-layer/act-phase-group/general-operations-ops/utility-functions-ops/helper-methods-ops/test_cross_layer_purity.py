...
class TestCrossLayerPurity:
    ...
    def test_l3_no_lower_layer_imports_contract(self):
        ...
        l3_modules = [
            'agentic_core.l3_orchestration.engines.resume_engine_dag',
            'agentic_core.l3_orchestration.engines.outreach_engine_dag',
            'agentic_core.l3_orchestration.framework.dag_executor'
        ]
