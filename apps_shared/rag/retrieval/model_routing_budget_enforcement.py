...
def test_budget_enforcement_downgrades_cost_tier() -> None:
    ...
    CHOICE = ModelChoice(PROVIDER='openai', model_name='gpt-5.1-codex', cost_tier='high', estimated_cost=0.004, latency_ms=1200)
    PROFILE = ExecutionProfile(NAME='test_profile', DESCRIPTION='test', RETRIEVAL=RetrievalConfig(), METADATA={'max_cost_tier': 'medium'})
