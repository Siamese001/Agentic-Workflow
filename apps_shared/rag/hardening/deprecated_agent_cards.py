...
def test_all_major_agents_have_agent_card_with_expected_roles() -> None:
    ...
    [(StrategyLLMAgent, AgentRole.PLANNER), (DraftingGuild, AgentRole.EXECUTION), (SemanticQAAgent, AgentRole.QA),
     (ConstitutionalSafetyAgent, AgentRole.SAFETY), (HYDEQueryAgent, AgentRole.META), (QACouncilAgent, AgentRole.QA)]
