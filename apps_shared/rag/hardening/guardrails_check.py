"""
Guardrails Check package initialization.

Provides core functionality and exports for the Guardrails Check module.
"""
...
__description__: str = "Core Guardrails Check functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Guardrails Check instance with config: {final_config}")
    return final_config
