"""
Guardrails Manage Costs package initialization.

Provides core functionality and exports for the Guardrails Manage Costs module.
"""
...
__description__: str = "Core Guardrails Manage Costs functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Guardrails Manage Costs instance with config: {final_config}")
    return final_config
