...
trace_contract._emit_applies_guardrail("p0", "FewshotregistryStrategy", "p0_governance")
trace_contract._emit_reads_policy_state("p0", "FewshotregistryStrategy", "policy_binding")
trace_contract._emit_snapshots_state("p0", "FewshotregistryStrategy", "state_snapshot")
from tqdm import tqdm

trace_contract._emit_emits_metric_event("FewshotregistryStrategy", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("FewshotregistryStrategy", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("FewshotregistryStrategy", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("FewshotregistryStrategy", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("FewshotregistryStrategy", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("FewshotregistryStrategy", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("FewshotregistryStrategy", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("FewshotregistryStrategy", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("FewshotregistryStrategy", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("FewshotregistryStrategy", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("FewshotregistryStrategy", "p4obs", "alert")
trace_contract._emit_links_incident_trace("FewshotregistryStrategy", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("FewshotregistryStrategy", "p3lm", "pattern")
trace_contract._emit_records_learning_event("FewshotregistryStrategy", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("FewshotregistryStrategy", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("FewshotregistryStrategy", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("FewshotregistryStrategy", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("FewshotregistryStrategy", "p3lm", "policy")
trace_contract._emit_stores_learning_state("FewshotregistryStrategy", "p3lm", "state")
trace_contract._emit_records_execution_trace("FewshotregistryStrategy", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("FewshotregistryStrategy", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("FewshotregistryStrategy", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("FewshotregistryStrategy", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("FewshotregistryStrategy", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("FewshotregistryStrategy", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("FewshotregistryStrategy", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("FewshotregistryStrategy", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("FewshotregistryStrategy", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "FewshotregistryStrategy", "context_pull")
trace_contract._emit_pulls_context("p1", "FewshotregistryStrategy", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "FewshotregistryStrategy", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "FewshotregistryStrategy", "uwg_term_2")
trace_contract._emit_writes_through("p1", "FewshotregistryStrategy", "write_through")
trace_contract._emit_writes_through("p1", "FewshotregistryStrategy", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "FewshotregistryStrategy", "safety_validation")
trace_contract._emit_invokes_eval("p1", "FewshotregistryStrategy", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "FewshotregistryStrategy", "routing_commit")
trace_contract._emit_escalates_to_human("p1", "FewshotregistryStrategy", "human_escalation")
trace_contract._emit_routes_through("p1", "FewshotregistryStrategy", "route_through")
trace_contract._emit_checks_agent_registry("p1", "FewshotregistryStrategy", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "FewshotregistryStrategy", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "FewshotregistryStrategy", "exec_plan")
trace_contract._emit_agent_executes_agent("p1", "FewshotregistryStrategy", "sub_agent")
trace_contract._emit_routes_to_agent("p1", "FewshotregistryStrategy", "target_agent")
trace_contract._emit_verifies_policy("p1", "FewshotregistryStrategy", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "FewshotregistryStrategy", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "FewshotregistryStrategy", "boundary_check")
trace_contract._emit_transcripts_response("p1", "FewshotregistryStrategy", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "FewshotregistryStrategy")
trace_contract._emit_gated_by_confidence("p1", "FewshotregistryStrategy", "confidence_gate")
trace_contract.emit_replay_key("p0", "FewshotregistryStrategy")
trace_contract.emit_determinism_digest("p0", "FewshotregistryStrategy")
trace_contract._emit_signs_execution_trace("p0", "p0hash", "p0_trace", 0)
trace_contract._emit_authorize_and_execute("p2", "FewshotregistryStrategy", "execution_auth")
trace_contract._emit_validates_capability("p2", "FewshotregistryStrategy", "capability_check")
trace_contract._emit_routes_to_capability("p2", "FewshotregistryStrategy", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "FewshotregistryStrategy", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "FewshotregistryStrategy", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "FewshotregistryStrategy", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "FewshotregistryStrategy", "exec_output")
trace_contract._emit_dispatches_agent("p3", "FewshotregistryStrategy", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "FewshotregistryStrategy", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "FewshotregistryStrategy", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "FewshotregistryStrategy", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "FewshotregistryStrategy", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "FewshotregistryStrategy", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "FewshotregistryStrategy", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "FewshotregistryStrategy", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "FewshotregistryStrategy", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "FewshotregistryStrategy", "eval_metric")
trace_contract._emit_stores_embedding("p4", "FewshotregistryStrategy", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "FewshotregistryStrategy", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "FewshotregistryStrategy", "exec_snapshot_link")
...
class FewShotRegistry(BaseModel):
    ...
    def add_example(self, example: FewShotExample) -> None:
        ...
        trace_contract._emit_records_execution_trace(_trace_id, trace_contract.LayerSegment.L3_ORCHESTRATION, "FewShotRegistry.add_example")
