...
class ServiceRegistry:
    ...
    def __init__(self):
        ...
        self._domain_services: dict[AppDomain, list[str]] = {AppDomain.LIC: [], AppDomain.RG: [], AppDomain.SHARED: []}
...
class ConfigurationLoader:
    ...
    def get_value(self, key: str, domain: AppDomain=AppDomain.SHARED, config_name: str='settings', default: Any=None) -> Any:
...
class IntegrationBridge:
    ...
    def _register_default_services(self) -> None:
        ...
        default_services = [ServiceEndpoint(name='config', domain=AppDomain.SHARED, metadata={'description': 'Configuration service'}), ServiceEndpoint(name='logging', domain=AppDomain.SHARED, metadata={'description': 'Logging service'}), ServiceEndpoint(name='metrics', domain=AppDomain.SHARED, metadata={'description': 'Metrics collection service'})]
    ...
    def get_config_value(self, key: str, domain: AppDomain=AppDomain.SHARED, config_name: str='settings', default: Any=None) -> Any:
    ...
    def list_services(self, domain: AppDomain | None=None) -> list[dict[str, Any]]:
        ...
        return [{'name': s.name, 'domain': s.domain.value, 'enabled': s.enabled, 'metadata': s.metadata} for s in services]
