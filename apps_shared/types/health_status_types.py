...
trace_contract._emit_applies_guardrail("p0", "health_status_types", "p0_governance")
trace_contract._emit_reads_policy_state("p0", "health_status_types", "policy_binding")
trace_contract._emit_snapshots_state("p0", "health_status_types", "state_snapshot")
...
trace_contract._emit_escalates_to_human("p1", "health_status_types", "human_escalation")
trace_contract._emit_routes_through("p1", "health_status_types", "route_through")
...
class BulkheadHealthChecker(HealthChecker):
    ...
    async def check_health(self) -> HealthCheckResult:
        ...
        trace_contract._emit_records_execution_trace(
            str(uuid.uuid4()), trace_contract.LayerSegment.L3_ORCHESTRATION, "BulkheadHealthChecker.check_health"
        )
        try:
