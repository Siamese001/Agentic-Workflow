...
# guardian: allow-magic-config
def tool_use_observability_execution(tool_id: str, command: str, parameters: dict[str, Any], execution_id: str | None=None, execution_type: str='sync', timeout: float=30.0) -> dict[str, Any]:
