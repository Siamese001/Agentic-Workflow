...
class RAGConfig:
    ...
    def __post_init__(self) -> None:
        ...
        try:
            ...
            self.chroma_persist_dir.mkdir(parents=True, exist_ok=True)    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling
