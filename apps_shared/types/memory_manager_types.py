    ...
    def _check_memory_limits(self) -> None:
        ...
        try:
            ...
            if memory_mb > self.limits.max_memory_mb:
                ...
                gc.collect()
                self._stats["gc_count"] += 1
        except (psutil.NoSuchProcess, psutil.AccessDenied):    # guardian:  should be handled with specific context    # guardian:  should be handled with specific context    # guardian:  should be handled with specific context    # guardian:  should be handled with specific context    # guardian:  should be handled with specific context    # guardian:  should be handled with specific context    # guardian:  should be handled with specific context    # guardian:  should be handled with specific context    # guardian:  should be handled with specific context    # guardian:  should be handled with specific context
            pass
