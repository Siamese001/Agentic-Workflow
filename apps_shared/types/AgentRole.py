...
trace_contract._emit_applies_guardrail("p0", "AgentRole", "p0_governance")
trace_contract._emit_reads_policy_state("p0", "AgentRole", "policy_binding")
trace_contract._emit_snapshots_state("p0", "AgentRole", "state_snapshot")

trace_contract._emit_emits_metric_event("AgentRole", "p4obs", "metric_1")
trace_contract._emit_emits_metric_event("AgentRole", "p4obs", "metric_2")
trace_contract._emit_emits_metric_event("AgentRole", "p4obs", "metric_3")
trace_contract._emit_emits_metric_event("AgentRole", "p4obs", "metric_4")
trace_contract._emit_emits_metric_event("AgentRole", "p4obs", "metric_5")
trace_contract._emit_emits_metric_event("AgentRole", "p4obs", "metric_6")
trace_contract._emit_records_incident_event("AgentRole", "p4obs", "incident")
trace_contract._emit_captures_runtime_anomaly("AgentRole", "p4obs", "anomaly")
trace_contract._emit_writes_observability_log("AgentRole", "p4obs", "obs_log")
trace_contract._emit_updates_monitoring_state("AgentRole", "p4obs", "mon_state")
trace_contract._emit_triggers_alert("AgentRole", "p4obs", "alert")
trace_contract._emit_links_incident_trace("AgentRole", "p4obs", "trace_link")
trace_contract._emit_captures_pattern("AgentRole", "p3lm", "pattern")
trace_contract._emit_records_learning_event("AgentRole", "p3lm", "learning_event")
trace_contract._emit_writes_learning_snapshot("AgentRole", "p3lm", "snapshot")
trace_contract._emit_feeds_meta_learning("AgentRole", "p3lm", "meta_feed")
trace_contract._emit_updates_routing_strategy("AgentRole", "p3lm", "routing")
trace_contract._emit_improves_agent_policy("AgentRole", "p3lm", "policy")
trace_contract._emit_stores_learning_state("AgentRole", "p3lm", "state")
trace_contract._emit_records_execution_trace("AgentRole", "L0_ROUTING", "p2_trace_1")
trace_contract._emit_records_execution_trace("AgentRole", "L1_REASONING", "p2_trace_2")
trace_contract._emit_records_execution_trace("AgentRole", "L2_EXECUTION", "p2_trace_3")
trace_contract._emit_records_execution_trace("AgentRole", "L3_ORCHESTRATION", "p2_trace_4")
trace_contract._emit_records_execution_trace("AgentRole", "L4_STATE", "p2_trace_5")
trace_contract._emit_reads_environ("AgentRole", "env_read", "p2_env_1")
trace_contract._emit_reads_environ("AgentRole", "env_read", "p2_env_2")
trace_contract._emit_reads_runtime_state("AgentRole", "runtime_state", "p2_rt_1")
trace_contract._emit_reads_runtime_state("AgentRole", "runtime_state", "p2_rt_2")
trace_contract._emit_pulls_context("p1", "AgentRole", "context_pull")
trace_contract._emit_pulls_context("p1", "AgentRole", "context_pull_2")
trace_contract._emit_execution_terminates_at_uwg("p1", "AgentRole", "uwg_term")
trace_contract._emit_execution_terminates_at_uwg("p1", "AgentRole", "uwg_term_2")
trace_contract._emit_writes_through("p1", "AgentRole", "write_through")
trace_contract._emit_writes_through("p1", "AgentRole", "write_through_2")
trace_contract._emit_validated_by_safety_plane("p1", "AgentRole", "safety_validation")
trace_contract._emit_invokes_eval("p1", "AgentRole", "eval_call")
trace_contract._emit_proposal_commits_routing("p1", "AgentRole", "routing_commit")
trace_contract._emit_escalates_to_human("p1", "AgentRole", "human_escalation")
trace_contract._emit_routes_through("p1", "AgentRole", "route_through")
trace_contract._emit_checks_agent_registry("p1", "AgentRole", "agent_registry")
trace_contract._emit_validates_agent_capability("p1", "AgentRole", "capability")
trace_contract._emit_dispatches_execution_plan("p1", "AgentRole", "exec_plan")
trace_contract._emit_agent_executes_agent("p1", "AgentRole", "sub_agent")
trace_contract._emit_routes_to_agent("p1", "AgentRole", "target_agent")
trace_contract._emit_verifies_policy("p1", "AgentRole", "policy_check")
trace_contract._emit_observes_runtime_state("p1", "AgentRole", "runtime_state")
trace_contract._emit_verifies_boundary("p1", "AgentRole", "boundary_check")
trace_contract._emit_transcripts_response("p1", "AgentRole", "transcript")
trace_contract._emit_hard_fails_untranscripted("p1", "AgentRole")
trace_contract._emit_gated_by_confidence("p1", "AgentRole", "confidence_gate")
trace_contract.emit_replay_key("p0", "AgentRole")
trace_contract.emit_determinism_digest("p0", "AgentRole")
trace_contract._emit_signs_execution_trace("p0", "p0hash", "p0_trace", 0)
trace_contract._emit_authorize_and_execute("p2", "AgentRole", "execution_auth")
trace_contract._emit_validates_capability("p2", "AgentRole", "capability_check")
trace_contract._emit_routes_to_capability("p2", "AgentRole", "capability_route")
trace_contract._emit_writes_via_uwg("p2", "AgentRole", "uwg_write")
trace_contract._emit_blocks_direct_write("p2", "AgentRole", "direct_write_block")
trace_contract._emit_records_tool_invocation("p2", "AgentRole", "tool_invocation")
trace_contract._emit_captures_execution_output("p2", "AgentRole", "exec_output")
trace_contract._emit_dispatches_agent("p3", "AgentRole", "agent_dispatch")
trace_contract._emit_coordinates_agents("p3", "AgentRole", "agent_coordination")
trace_contract._emit_records_workflow_lineage("p3", "AgentRole", "workflow_lineage")
trace_contract._emit_records_healing_outcome("p3", "AgentRole", "healing_outcome")
trace_contract._emit_escalates_failure("p3", "AgentRole", "failure_escalation")
trace_contract._emit_orchestrates_workflow("p3", "AgentRole", "workflow_orchestration")
trace_contract._emit_dispatches_healing_run("p3", "AgentRole", "healing_dispatch")
trace_contract._emit_invokes_evaluation("p3", "AgentRole", "evaluation_signal")
trace_contract._emit_records_telemetry_event("p4", "AgentRole", "telemetry_event")
trace_contract._emit_captures_evaluation_metric("p4", "AgentRole", "eval_metric")
trace_contract._emit_stores_embedding("p4", "AgentRole", "embedding_store")
trace_contract._emit_updates_meta_learning_state("p4", "AgentRole", "meta_learning")
trace_contract._emit_links_execution_to_snapshot("p4", "AgentRole", "exec_snapshot_link")
...
class AgentRegistry:
    ...
    def register_agent(self, spec: AgentSpec) -> None:
        ...
        trace_contract._emit_records_execution_trace(
            _trace_id, trace_contract.LayerSegment.L3_ORCHESTRATION, "AgentRegistry.register_agent"
        )
