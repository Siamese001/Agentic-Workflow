...
class SSOTRelocator:
    ...
    def _cleanup_empty_dirs(self, directory: Path) -> None:
        ...
        except (OSError, PermissionError):    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling    # guardian: Multiple exceptions (OSError, PermissionError) need specific handling
