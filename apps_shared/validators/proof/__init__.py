...
:class:`~apps_shared.validators.proof.proof_contracts.AppRunEvidencePacket`.

Public surface (W1 foundation):

* :mod:`apps_shared.validators.proof.proof_contracts` — evidence packet + hashing
* :mod:`apps_shared.validators.proof.app_inventory` — ADG-driven app discovery
* :mod:`apps_shared.validators.proof.adg_queries` — bypass-class queries
* :mod:`apps_shared.validators.proof.bypass_validator` — PASS/FAIL gate over ADG
* :mod:`apps_shared.validators.proof.proof_runner` — CLI entrypoint
