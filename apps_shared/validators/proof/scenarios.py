...
:func:`apps_shared.validators.proof.scenario_base.run_app_scenario` drives the spine.
...
from apps_shared.validators.proof.scenario_base import ScenarioContext, ScenarioSpec
...
def _customize_apps_lic(ctx: ScenarioContext) -> None:
    ...
    :func:`apps_shared.validators.proof.sandbox_writer.write_sandbox_artifact`, proving
    the W6.2 classification path.
    """
    from apps_shared.validators.proof.sandbox_writer import write_sandbox_artifact
...
def _customize_apps_underwriting_ai(ctx: ScenarioContext) -> None:
    ...
    but never approved.
    """
    from apps_shared.validators.proof.sandbox_writer import (
        request_uwg_commit,
