...
def build_librarian_strategic_analysis_prompt(job_description: str, rag_mission: 'RAGMission', previous_context: str | None=None) -> str:
    """
...
def build_phase1_prompt(job_description: str, mission: 'RAGMission', master_resume_index: 'MasterResumeIndex', company_name: str | None=None, librarian_context: str | None=None) -> str:
    """
...
def build_phase2_prompt(job_description: str, mission: 'RAGMission', industry: str, librarian_context: str | None=None) -> str:
    """
...
def build_phase3_prompt(job_description: str, mission: 'RAGMission', master_resume_index: 'MasterResumeIndex', peer_companies: list[str], comp_config: 'CompetitiveAnalysisConfig', industry: str, librarian_context: str | None=None) -> str:
    """
