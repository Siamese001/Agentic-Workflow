...
_emit_escalates_to_human("p1", "fix_all_violations", "human_escalation")
_emit_routes_through("p1", "fix_all_violations", "route_through")
_emit_checks_agent_registry("p1", "fix_all_violations", "agent_registry")
_emit_validates_agent_capability("p1", "fix_all_violations", "capability")
_emit_dispatches_execution_plan("p1", "fix_all_violations", "exec_plan")
_emit_agent_executes_agent("p1", "fix_all_violations", "sub_agent")
_emit_routes_to_agent("p1", "fix_all_violations", "target_agent")
_emit_verifies_policy("p1", "fix_all_violations", "policy_check")
_emit_observes_runtime_state("p1", "fix_all_violations", "runtime_state")
_emit_verifies_boundary("p1", "fix_all_violations", "boundary_check")
_emit_transcripts_response("p1", "fix_all_violations", "transcript")
_emit_hard_fails_untranscripted("p1", "fix_all_violations")
_emit_gated_by_confidence("p1", "fix_all_violations", "confidence_gate")
