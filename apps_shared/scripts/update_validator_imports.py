...
IMPORT_REPLACEMENTS: dict[str, tuple[str, str]] = {'SyntaxValidatorAgent': ('agentic_core.L5_safety.unified.CodeValidatorAgent', 'CodeValidatorAgent'), 'CanonValidatorAgent': ('agentic_core.L5_safety.unified.CodeValidatorAgent', 'CodeValidatorAgent'), 'CanonAstValidatorAgent': ('agentic_core.L5_safety.unified.CodeValidatorAgent', 'CodeValidatorAgent'), 'AsyncBlockingValidatorAgent': ('agentic_core.L5_safety.unified.CodeValidatorAgent', 'CodeValidatorAgent'), 'PrintStatementValidatorAgent': ('agentic_core.L5_safety.unified.CodeValidatorAgent', 'CodeValidatorAgent'), 'GravityValidatorAgent': ('agentic_core.L5_safety.unified.StructureValidatorAgent', 'StructureValidatorAgent'), 'HygieneValidatorAgent': ('agentic_core.L5_safety.unified.StructureValidatorAgent', 'StructureValidatorAgent'), 'AgentRegistryValidatorAgent': ('agentic_core.L5_safety.unified.StructureValidatorAgent', 'StructureValidatorAgent'), 'CognitiveContractValidatorAgent': ('agentic_core.L5_safety.unified.StructureValidatorAgent', 'StructureValidatorAgent'), 'ContactValidatorAgent': ('apps_lic.shared.validation.AppContentValidatorAgent', 'AppContentValidatorAgent'), 'ContentCleanlinessValidatorAgent': ('apps_lic.shared.validation.AppContentValidatorAgent', 'AppContentValidatorAgent'), 'MessageDiversityValidator': ('apps_lic.shared.validation.AppContentValidatorAgent', 'AppContentValidatorAgent')}
