...
MISSING_TESTS = [
    {"class": "SovereignFilesystemMcpClient", "path": "agentic_core\\L0_maintenance\\scripts\\filesystem_mcp_client.py"},
    {"class": "SovereignGitKrakenMcpClient", "path": "agentic_core\\L0_maintenance\\scripts\\gitkraken_mcp_client.py"},
    {"class": "CognitiveContractValidatorAgent", "path": "agentic_core\\schemas\\models\\CognitiveContractManagerAgent.py"},
    ...
    {"class": "L1CognitionBaseAgent", "path": "agentic_core\\L1_cognition\\thought_engine\\L1CognitionBaseAgent.py"},
    {"class": "L1CognitionExerciserAgent", "path": "agentic_core\\L1_cognition\\thought_engine\\L1CognitionExerciserAgent.py"},
    {"class": "MetaLearningAgent", "path": "agentic_core\\L1_cognition\\learning\\MetaLearningAgent.py"},
    {"class": "SovereignCognitivePlaneAgent", "path": "agentic_core\\L1_cognition\\thought_engine\\sovereign_cognitive_plane.py"},
    {"class": "StrategicPlannerAgent", "path": "agentic_core\\L1_cognition\\thought_engine\\strategic_planner.py"},
    ...
    {"class": "CodeSSOTEnforcerAgent", "path": "agentic_core\\config\\blueprint_sovereign\\CodeSSOTEnforcerAgent.py"},
    {"class": "CognitiveContractManagerAgent", "path": "agentic_core\\L2_execution\\ToolRegistry\\CognitiveContractManagerAgent.py"},
    {"class": "DocstringComplianceAgent", "path": "agentic_core\\config\\blueprint_sovereign\\DocstringComplianceAgent.py"},
    {"class": "FilenameUniquenessGuardianAgent", "path": "agentic_core\\config\\blueprint_sovereign\\FilenameUniquenessGuardianAgent.py"},
    ...
    {"class": "HealValidatorAgent", "path": "agentic_core\\config\\blueprint_sovereign\\heal_validator.py"},
    {"class": "HierarchyAgent", "path": "agentic_core\\config\\blueprint_sovereign\\HierarchyAgent.py"},
    {"class": "HygieneGuardianAgent", "path": "agentic_core\\config\\blueprint_sovereign\\HygieneGuardianAgent.py"},
    {"class": "InferenceTypeHintAgent", "path": "agentic_core\\config\\blueprint_sovereign\\InferenceTypeHintAgent.py"},
    {"class": "LocationAgent", "path": "agentic_core\\config\\blueprint_sovereign\\LocationAgent.py"},
    {"class": "PascalSovereigntyEnforcerAgent", "path": "agentic_core\\config\\blueprint_sovereign\\PascalSovereigntyEnforcerAgent.py"},
    {"class": "PromptGovernorAgent", "path": "agentic_core\\L2_execution\\ToolRegistry\\PromptGovernorAgent.py"},
    {"class": "SovereignFigmaClient", "path": "agentic_core\\L2_execution\\ToolRegistry\\figma_client_sovereign.py"},
    ...
    {"class": "TestSovereigntyAgent", "path": "agentic_core\\config\\blueprint_sovereign\\TestSovereigntyAgent.py"},
    {"class": "TypeHintEnforcementAgent", "path": "agentic_core\\config\\blueprint_sovereign\\TypeHintEnforcementAgent.py"},
    {"class": "TypeHintFixerAgent", "path": "agentic_core\\config\\blueprint_sovereign\\TypeHintEnforcementAgent.py"},
    {"class": "ActorCriticOrchestratorAgent", "path": "agentic_core\\L3_orchestration\\workflow_engines\\ActorCriticOrchestratorAgent.py"},
    {"class": "AgentFactory", "path": "agentic_core\\L3_orchestration\\workflow_engines\\agent_factory.py"},
    {"class": "AgentGym", "path": "agentic_core\\L3_orchestration\\workflow_engines\\agent_gym_impl.py"},
    {"class": "ContextCurator", "path": "agentic_core\\L3_orchestration\\workflow_engines\\context_curator_impl.py"},
    {"class": "CoverageAgent", "path": "agentic_core\\observability\\metrics\\CoverageAgent.py"},
    {"class": "GeneralExerciserAgent", "path": "agentic_core\\observability\\metrics\\GeneralExerciserAgent.py"},
    {"class": "MetaCoverageOptimizerAgent", "path": "agentic_core\\observability\\metrics\\MetaCoverageOptimizerAgent.py"},
    {"class": "PPOOrchestratorAgent", "path": "agentic_core\\L3_orchestration\\workflow_engines\\PPOOrchestratorAgent.py"},
    {"class": "QLearningOrchestratorAgent", "path": "agentic_core\\L3_orchestration\\workflow_engines\\QLearningOrchestratorAgent.py"},
    {"class": "RLOrchestratorAgent", "path": "agentic_core\\L3_orchestration\\workflow_engines\\RLOrchestratorAgent.py"},
    {"class": "ReinforceCriticOrchestratorAgent", "path": "agentic_core\\L3_orchestration\\workflow_engines\\ReinforceCriticOrchestratorAgent.py"},
    {"class": "SovereignMcpRouter", "path": "agentic_core\\L3_orchestration\\workflow_engines\\mcp_router_sovereign.py"},
    {"class": "CheckpointManagerAgent", "path": "agentic_core\\L4_state\\ValidationContext\\CheckpointManagerAgent.py"},
    {"class": "FileManagerAgent", "path": "agentic_core\\L4_state\\filesystem\\FileManagerAgent.py"},
    {"class": "L4StateExerciserAgent", "path": "agentic_core\\L4_state\\ValidationContext\\L4StateExerciserAgent.py"},
    ...
    {"class": "SovereignGraphClient", "path": "agentic_core\\L4_state\\ValidationContext\\knowledge_graph_sovereign_graph_client.py"},
    {"class": "BiasDetectorAgent", "path": "agentic_core\\L5_safety\\guardrails\\BiasDetectorAgent.py"},
    {"class": "CompositeGuardrailAgent", "path": "agentic_core\\L5_safety\\guardrails\\UnifiedGuardrailAgent.py"},
    {"class": "ConstitutionalReviewerAgent", "path": "agentic_core\\L5_safety\\guardrails\\ConstitutionalReviewerAgent.py"},
    {"class": "L5SafetyExerciserAgent", "path": "agentic_core\\L5_safety\\guardrails\\L5SafetyExerciserAgent.py"},
    {"class": "MultiProviderRouterAgent", "path": "agentic_core\\L5_safety\\guardrails\\multi_provider_router_agent.py"},
    {"class": "PIISanitizerAgent", "path": "agentic_core\\L5_safety\\guardrails\\PIISanitizerAgent.py"},
    {"class": "PromptInjectionDetectorAgent", "path": "agentic_core\\L5_safety\\guardrails\\PromptInjectionDetectorAgent.py"},
    {"class": "SovereignLlmRouterMcpClient", "path": "agentic_core\\L5_safety\\guardrails\\llm_router_mcp_client.py"},
