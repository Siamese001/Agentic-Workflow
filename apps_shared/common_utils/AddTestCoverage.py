...
def add_test_to_file(filepath: Path, class_name: str) -> bool:
    ...
    indented_test = "\n".join(
        method_indent + line.strip() if line.strip() else "" for line in test_lines
    )
...
MISSING_TESTS = [
    {
        ...
        "path": "agentic_core\\L0_maintenance\\scripts\\filesystem_mcp_client.py",
    },
    {
        "class": "SovereignGitKrakenMcpClient",
        "path": "agentic_core\\L0_maintenance\\scripts\\gitkraken_mcp_client.py",
    },
    {
    ...
    },
    {
        ...
        "path": "agentic_core\\L2_execution\\ToolRegistry\\CognitiveContractManagerAgent.py",
    },
    {
    ...
    },
    {
        ...
        "path": "agentic_core\\L2_execution\\ToolRegistry\\PromptGovernorAgent.py",
    },
    {
        "class": "SovereignFigmaClient",
        "path": "agentic_core\\L2_execution\\ToolRegistry\\figma_client_sovereign.py",
    },
