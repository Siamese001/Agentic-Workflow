...
class TestInjectionDetector(HealerMixin):
    ...
    def setup_method(self) -> Any:
        ...
        self.CONTEXT = SafetyContext(content_type='test', SOURCE='test_source', DESTINATION='test_destination', CONTENT='', user_id='test_user', session_id='test_session')
...
class TestIntegrationWithOtherLayers:
    ...
    def test_simple_injection_detector_integration(self) -> Any:
        ...
        context: Any = SafetyContext(content_type='test', SOURCE='test_source', DESTINATION='test_destination', CONTENT='', user_id='test_user', session_id='test_session')
