...
def validate_with_pydantic(data: dict[str, Any], model_class: type[ValidatedInput]) -> ValidatedInput:
    ...
    except ValidationError as e:    # guardian: ValidationError should be handled with specific context    # guardian: ValidationError should be handled with specific context    # guardian: ValidationError should be handled with specific context    # guardian: ValidationError should be handled with specific context    # guardian: ValidationError should be handled with specific context    # guardian: ValidationError should be handled with specific context    # guardian: ValidationError should be handled with specific context    # guardian: ValidationError should be handled with specific context    # guardian: ValidationError should be handled with specific context    # guardian: ValidationError should be handled with specific context
        errors = []
