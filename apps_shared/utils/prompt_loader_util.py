...
class PromptLoader:
    ...
    def build_full_prompt(self, agent_role: str, task: str, code: str, original_line_count: int, lesson_learned: str='') -> str:
        """
        ...
        if global_constraints:
            constraints_with_count = global_constraints.replace('{original_line_count}', str(original_line_count))
            constraints_with_count = constraints_with_count.replace('{int(original_line_count * 0.1)}', str(int(original_line_count * 0.1)))
...
def load_prompt_for_agent(agent_role: str, task: str, code: str, original_line_count: int, lesson_learned: str='') -> str:
    """
