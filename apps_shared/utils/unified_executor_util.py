...
class LLMExecutionStrategy(ExecutionStrategy):
    ...
    async def execute(self, context: ExecutionContext) -> ExecutionResult:
        ...
        except CircuitOpenError:    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context    # guardian: CircuitOpenError should be handled with specific context
            return ExecutionResult(
