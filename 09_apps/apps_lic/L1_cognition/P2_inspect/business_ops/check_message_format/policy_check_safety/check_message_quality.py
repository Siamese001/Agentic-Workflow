"""
check_message_quality.py - Policy Enforcement Module

Domain: outreach
Generated: 2025-12-07T13:28:54.046612
"""
...
def evaluate_policy(data: Any, config: Optional[Dict] = None) -> PolicyResult:
    ...
    return CheckMessageQuality(config).evaluate(data)
