"""
check_message_compliance.py - Policy Enforcement Module

Domain: outreach
Generated: 2025-12-07T13:28:54.073698
"""
...
def evaluate_policy(data: Any, config: Optional[Dict] = None) -> PolicyResult:
    ...
    return CheckMessageCompliance(config).evaluate(data)
