"""
enforce_length_limits.py - Policy Enforcement Module

Domain: resume
Generated: 2025-12-07T13:29:00.507370
"""
...
def evaluate_policy(data: Any, config: Optional[Dict] = None) -> PolicyResult:
    ...
    return EnforceLengthLimits(config).evaluate(data)
