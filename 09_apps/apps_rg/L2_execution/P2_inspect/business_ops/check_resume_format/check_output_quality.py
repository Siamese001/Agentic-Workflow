"""
check_output_quality.py - Policy Enforcement Module

Domain: resume
Generated: 2025-12-07T13:29:00.506806
"""
...
def evaluate_policy(data: Any, config: Optional[Dict] = None) -> PolicyResult:
    ...
    return CheckOutputQuality(config).evaluate(data)
