"""
search_similar_resumes.py - Embedding Operations Module

Domain: resume
Generated: 2025-12-07T13:28:54.198059
"""
...
class SearchSimilarResumes:
    """Embedding operations for resume domain."""
...
def compute_embedding(text: str, config: Optional[Dict] = None) -> EmbeddingResult:
    ...
    return SearchSimilarResumes(config).embed(text)
