...
## Purpose
This card encodes Acme-specific facts, vocabulary, and anchors. It does not answer questions on its own; it sharpens other route answers so they sound native to Acme.
