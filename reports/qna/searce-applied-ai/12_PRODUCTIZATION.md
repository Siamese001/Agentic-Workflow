# 12 Productization and ROI


<!-- card-meta
card_id: 12_PRODUCTIZATION
card_type: skill
priority: should
paste_order: 12
...
## Purpose
Primary card for **Route 7 — Product, client value, and ROI**. When the question is about client impact, adoption, ROI, or 90-day plan, this card drives the answer.
...
## Core principle
**Adoption is the only ROI metric that survives a board review.** A model with no users has no impact.

## Talking points


## KPI anchors that hold up under cross-exam


## Honest patterns
- "I would not promise lift. I would promise a measurement protocol."
- "The first KPI is whether the user opens the tool twice."
- "Repeatability across clients is the platform test, not feature richness."

## Anti-patterns
- Do not list features. Name the decision the feature unblocks.
- Do not invent ROI numbers without an experiment.
- Do not confuse pilot success with platform readiness.

## Hand-off
- If the question turns to 90-day plan specifics, hand to **17_QUESTIONS_AND_90_DAY_PLAN.md**.
