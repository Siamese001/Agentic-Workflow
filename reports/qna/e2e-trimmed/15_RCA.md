...
**Root cause**: The fallback hierarchy collapsed two tiers into one.
...
**Operating-model change**: Every fallback now requires an explicit reason code.
