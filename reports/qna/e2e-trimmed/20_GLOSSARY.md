...
## Purpose
A compact glossary of Acme-specific and role-specific terms. The runtime should use these terms naturally and avoid undefined acronyms.


## Acme terms
*No glossary entries supplied. Populate `extra_context.glossary_entries` to seed company- and role-specific terms.*
