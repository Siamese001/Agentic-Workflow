...
class RetrieveDataSimilarityMemoryProcessor(ABC):
    ...
    @abstractmethod
    def process(self, input_data: Dict[str, object][str, object]) -> RetrieveDataSimilarityMemoryResult:
...
def retrieve_data_similarity(input_data: Dict[str, object][str, object]) -> Dict[str, object]:
    """
