...
class SortScriptsResultsPlanProcessor(ABC):
    ...
    @abstractmethod
    def process(self, input_data: Dict[str, object]) -> SortScriptsResultsPlanResult:
...
class SortScriptsResultsPlanInterface:
    ...
    def __init__(self, engine: SortScriptsResultsPlanProcessor):
...
class SortScriptsResultsPlanFactory:
    ...
    def create_processor(safety_level: str = "strict") -> SortScriptsResultsPlanInterface:
        ...
        engine = SortScriptsResultsPlanImpl(constraints)
        return SortScriptsResultsPlanInterface(engine)

# L5 Main execution point
def sort_scripts_results(input_data: Dict[str, object]) -> Dict[str, object]:
    """
    ...
    """
    builder = SortScriptsResultsPlanFactory()
