"""
Convert Prompt package initialization.

Provides core functionality and exports for the Convert Prompt module.
"""
...
__description__: str = "Core Convert Prompt functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Convert Prompt instance with config: {final_config}")
    return final_config
