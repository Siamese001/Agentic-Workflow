"""
Prompt Governance package initialization.

Provides core functionality and exports for the Prompt Governance module.
"""
...
__description__: str = "Core Prompt Governance functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Prompt Governance instance with config: {final_config}")
    return final_config
