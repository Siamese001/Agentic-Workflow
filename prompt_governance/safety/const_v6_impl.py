...
class RuleEngine:
    ...
    def _check_rule(self, content: str, rule: ConstitutionalRule) -> Optional[ViolationReport]:
        ...
        if confidence > 0.5:
            ...
            return ViolationReport(rule_id=rule.id,
                rule_name=rule.name,
    ...
    def _determine_violation_type(self,
        ...
        confidence: float) -> ViolationType:
...
class ContentValidator:
    ...
    def _setup_default_rules(self) -> None:
        ...
        default_rules = [ConstitutionalRule(id='harmful_content',
            ...
            ConstitutionalRule(id='bias_detection',
            name='Bias Detection',
            type=RuleType.BIAS,
            ...
            ConstitutionalRule(id='privacy_protection',
...
class ConstitutionalAISystem:
    ...
    def _load_default_principles(self) -> None:
        ...
        principles = [ConstitutionalPrinciple(id='harmlessness',
            name='Harmlessness',
    ...
    def evaluate_compliance(self, content: str, principle_ids: List[str]) -> List[LLMJudgment]:
        ...
        for principle_id in principle_ids:
            ...
            if not principle:
                principle = ConstitutionalPrinciple(id=principle_id,
            ...
            if hasattr(self.llm_client, 'generate'):
                try:
                    ...
                    judgment = LLMJudgment(principle=principle_id,
                        is_compliant=response.get('is_compliant',
                        False),
