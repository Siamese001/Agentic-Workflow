"""Rule pattern extractor — parses .windsurf/rules/*.md for hardening patterns.

Plan: ``.windsurf/plans/apps-architect-pattern-hardening-d7e4f9.md`` W2.P3.
"""
...
_SKILL_RE = re.compile(r"\.windsurf/skills/(\w[\w-]*)/")
