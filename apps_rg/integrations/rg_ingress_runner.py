...
Original: apps_rg/integrations\rg_ingress_runner.py
...
raise RuntimeError(
    ...
    "apps_rg.integrations\rg_ingress_runner is QUARANTINED. "
    "apps_rg may NOT contain runtime authority. "
    "Core L2/L5/L6 owns execution. apps_rg is ingress-only. "
    "See: .windsurf/plans/apps-rg-declarative-ingress-only-spinal-governance-c8b3e1.md §19"
)

# Original code archived to: archives/apps_rg/quarantine_w4_20260509/integrations\rg_ingress_runner.py.ORIGINAL

# QUARANTINED — Original content below for reference only — NOT EXECUTABLE:
# """Apps_rg ingress-wired runner — proof of pattern for W7.1.
# 
...
# :class:`GovernedRgRun`. The existing governed runner is NOT modified — this
# wrapper is a new, optional adoption path that other apps_* runners can copy.
# 
# Responsibility split::
# 
#     raw envelope → IngressEnvelopeCheck → StampedRequest / Clarification / Rejection
#                                         │
#                                         └→ ResumeRequest parser
#                                            │
