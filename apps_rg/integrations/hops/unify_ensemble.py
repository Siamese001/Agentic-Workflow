...
Original: apps_rg/integrations/hops/unify_ensemble.py
...
raise RuntimeError(
    ...
    "apps_rg.integrations.hops.unify_ensemble is QUARANTINED. "
...
# archives/apps_rg/quarantine_w4_20260509/integrations/hops/unify_ensemble.py.ORIGINAL

# QUARANTINED — Original content below for reference only — NOT EXECUTABLE:
"""HOP-4D-UNIFY — ORIGINAL (QUARANTINED)"""
