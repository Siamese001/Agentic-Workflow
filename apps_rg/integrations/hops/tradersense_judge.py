...
Original: apps_rg/integrations/hops/tradersense_judge.py
...
raise RuntimeError(
    ...
    "apps_rg.integrations.hops.tradersense_judge is QUARANTINED. "
...
# archives/apps_rg/quarantine_w4_20260509/integrations/hops/tradersense_judge.py.ORIGINAL

# QUARANTINED — Original content below for reference only — NOT EXECUTABLE:
"""HOP-4F-TRADERSENSE — ORIGINAL (QUARANTINED)"""
