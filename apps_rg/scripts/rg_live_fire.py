...
MOCK_RESUME = {'contact_info': {'name': 'Your Name', 'email': 'your.email@example.com'}, 'experience': [{'company': 'Previous Company', 'title': 'Your Previous Role', 'bullets': ['Your achievement 1 with metrics', 'Your achievement 2 with metrics']}], 'education': [{'degree': 'Your Degree', 'school': 'Your University'}], 'skills': ['skill1', 'skill2', 'skill3']}
