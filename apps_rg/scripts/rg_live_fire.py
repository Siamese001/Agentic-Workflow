...
Original: apps_rg/scripts\rg_live_fire.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\rg_live_fire.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts.rg_live_fire is QUARANTINED. "
