...
Original: apps_rg/scripts\rg_json_miner.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\rg_json_miner.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts.rg_json_miner is QUARANTINED. "
