...
Original: apps_rg/scripts\rg_inject_archives.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\rg_inject_archives.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts.rg_inject_archives is QUARANTINED. "
