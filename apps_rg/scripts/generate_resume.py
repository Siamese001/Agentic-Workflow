...
Original: apps_rg/scripts\generate_resume.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\generate_resume.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts.generate_resume is QUARANTINED. "
