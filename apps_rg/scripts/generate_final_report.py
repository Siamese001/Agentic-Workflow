...
Original: apps_rg/scripts\generate_final_report.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\generate_final_report.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts.generate_final_report is QUARANTINED. "
