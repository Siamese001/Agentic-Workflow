...
Original: apps_rg/scripts\_pdf_to_brief.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\_pdf_to_brief.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts._pdf_to_brief is QUARANTINED. "
