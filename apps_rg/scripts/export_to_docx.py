...
Original: apps_rg/scripts\export_to_docx.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\export_to_docx.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts.export_to_docx is QUARANTINED. "
