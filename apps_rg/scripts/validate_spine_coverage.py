...
Original: apps_rg/scripts\validate_spine_coverage.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\validate_spine_coverage.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts.validate_spine_coverage is QUARANTINED. "
