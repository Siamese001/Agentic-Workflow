...
Original: apps_rg/scripts\_rca_against_ranked.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\_rca_against_ranked.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts._rca_against_ranked is QUARANTINED. "
