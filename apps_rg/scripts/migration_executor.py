...
Original: apps_rg/scripts\migration_executor.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\migration_executor.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts.migration_executor is QUARANTINED. "
