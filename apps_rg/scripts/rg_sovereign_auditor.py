...
Original: apps_rg/scripts\rg_sovereign_auditor.py
...
archives/apps_rg/quarantine_w4_20260509/scripts\rg_sovereign_auditor.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.scripts.rg_sovereign_auditor is QUARANTINED. "
