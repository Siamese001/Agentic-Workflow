...
_emit_escalates_to_human("p1", "SovereigncontextStrategy", "human_escalation")
_emit_routes_through("p1", "SovereigncontextStrategy", "route_through")
_emit_checks_agent_registry("p1", "SovereigncontextStrategy", "agent_registry")
_emit_validates_agent_capability("p1", "SovereigncontextStrategy", "capability")
_emit_dispatches_execution_plan("p1", "SovereigncontextStrategy", "exec_plan")
_emit_agent_executes_agent("p1", "SovereigncontextStrategy", "sub_agent")
_emit_routes_to_agent("p1", "SovereigncontextStrategy", "target_agent")
_emit_verifies_policy("p1", "SovereigncontextStrategy", "policy_check")
_emit_observes_runtime_state("p1", "SovereigncontextStrategy", "runtime_state")
_emit_verifies_boundary("p1", "SovereigncontextStrategy", "boundary_check")
_emit_transcripts_response("p1", "SovereigncontextStrategy", "transcript")
_emit_hard_fails_untranscripted("p1", "SovereigncontextStrategy")
_emit_gated_by_confidence("p1", "SovereigncontextStrategy", "confidence_gate")
