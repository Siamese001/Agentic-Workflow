...
Original: apps_rg/engines\search_filter_builder.py
...
archives/apps_rg/quarantine_w4_20260509/engines\search_filter_builder.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.search_filter_builder is QUARANTINED. "
