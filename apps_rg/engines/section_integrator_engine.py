...
Original: apps_rg/engines\section_integrator_engine.py
...
archives/apps_rg/quarantine_w4_20260509/engines\section_integrator_engine.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.section_integrator_engine is QUARANTINED. "
