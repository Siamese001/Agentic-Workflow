...
Original: apps_rg/engines\optimization_strategy_engine.py
...
archives/apps_rg/quarantine_w4_20260509/engines\optimization_strategy_engine.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.optimization_strategy_engine is QUARANTINED. "
