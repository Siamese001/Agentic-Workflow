...
Original: apps_rg/engines\competency_item.py
...
archives/apps_rg/quarantine_w4_20260509/engines\competency_item.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.competency_item is QUARANTINED. "
