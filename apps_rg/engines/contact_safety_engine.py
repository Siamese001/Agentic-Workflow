...
Original: apps_rg/engines\contact_safety_engine.py
...
archives/apps_rg/quarantine_w4_20260509/engines\contact_safety_engine.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.contact_safety_engine is QUARANTINED. "
