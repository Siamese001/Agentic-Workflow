...
Original: apps_rg/engines\message_generation_task.py
...
archives/apps_rg/quarantine_w4_20260509/engines\message_generation_task.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.message_generation_task is QUARANTINED. "
