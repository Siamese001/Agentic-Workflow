...
def organize_all_files() -> Any:
    ...
    file_mappings: Any = {
        ...
        "docs": [".md", ".txt", ".rst"],
        SCRIPTS_DIR: [".sh", ".ps1", ".bat"],
        "docker": [".dockerignore", "Dockerfile.*"],
        ARCHIVES_DIR: [".backup", ".old", ".bak"],
        "data": [".csv", ".jsonl", ".parquet", ".db", ".sqlite"],
        AGENTIC_CORE_DIR: ["ActionNode.py", "agent_logic.py", "CognitiveNode.py"],
        APPS_RG_DIR: ["orchestrator.py", "llm_client.py"],
        APPS_SHARED_DIR: ["db_manager.py", "etl_pipeline.py"],
        TESTS_DIR: ["test_*.py", "*_test.py"],
        SCRIPTS_DIR: ["fix_*.py", "clean_*.py", "assess_*.py"],
    }
    moved_count: Any = 0
