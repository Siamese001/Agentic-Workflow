...
Original: apps_rg/engines\bullet_generation_task.py
...
archives/apps_rg/quarantine_w4_20260509/engines\bullet_generation_task.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.bullet_generation_task is QUARANTINED. "
