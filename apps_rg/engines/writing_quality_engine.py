...
Original: apps_rg/engines\writing_quality_engine.py
...
archives/apps_rg/quarantine_w4_20260509/engines\writing_quality_engine.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.writing_quality_engine is QUARANTINED. "
