...
Original: apps_rg/engines\rg_spine_adapter.py
...
archives/apps_rg/quarantine_w4_20260509/engines\rg_spine_adapter.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.rg_spine_adapter is QUARANTINED. "
