...
Original: apps_rg/engines\clerk_extraction_engine.py
...
archives/apps_rg/quarantine_w4_20260509/engines\clerk_extraction_engine.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.clerk_extraction_engine is QUARANTINED. "
