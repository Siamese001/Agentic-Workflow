...
Original: apps_rg/engines\role_archetype_classifier.py
...
archives/apps_rg/quarantine_w4_20260509/engines\role_archetype_classifier.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.role_archetype_classifier is QUARANTINED. "
