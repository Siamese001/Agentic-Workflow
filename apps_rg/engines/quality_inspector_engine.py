...
Original: apps_rg/engines\quality_inspector_engine.py
...
archives/apps_rg/quarantine_w4_20260509/engines\quality_inspector_engine.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.quality_inspector_engine is QUARANTINED. "
