...
Original: apps_rg/engines\hop_pipeline_adapters.py
...
archives/apps_rg/quarantine_w4_20260509/engines\hop_pipeline_adapters.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.engines.hop_pipeline_adapters is QUARANTINED. "
