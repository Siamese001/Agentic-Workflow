...
class TestPhase4ProductionHardening:
    ...
    def test_regeneration_expansion_strategy(self):
        ...
        assert word_count >= min_required, f"Expansion failed. Got {word_count}, needed {min_required}"
    ...
    def test_regeneration_condensation_strategy(self):
        ...
        word_count = len(regenerated.split())
        assert word_count == max_allowed, f"Condensation failed. Got {word_count}, expected {max_allowed}"
