"""
check_resume_compliance.py - Policy Enforcement Module

Domain: resume
Generated: 2025-12-07T13:28:54.231490
"""
...
def evaluate_policy(data: Any, config: Optional[Dict] = None) -> PolicyResult:
    ...
    return CheckResumeCompliance(config).evaluate(data)
