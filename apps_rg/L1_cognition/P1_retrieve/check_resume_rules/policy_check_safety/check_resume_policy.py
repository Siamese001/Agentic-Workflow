"""
check_resume_policy.py - Policy Enforcement Module

Domain: resume
Generated: 2025-12-07T13:28:54.183319
"""
...
def evaluate_policy(data: Any, config: Optional[Dict] = None) -> PolicyResult:
    ...
    return CheckResumePolicy(config).evaluate(data)
