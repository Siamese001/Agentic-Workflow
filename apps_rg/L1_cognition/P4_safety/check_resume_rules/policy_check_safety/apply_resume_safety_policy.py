"""
apply_resume_safety_policy.py - Policy Enforcement Module

Domain: resume
Generated: 2025-12-07T13:28:54.255002
"""
...
def evaluate_policy(data: Any, config: Optional[Dict] = None) -> PolicyResult:
    ...
    return ApplyResumeSafetyPolicy(config).evaluate(data)
