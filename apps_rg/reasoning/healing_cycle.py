...
Original: apps_rg/reasoning\healing_cycle.py
...
archives/apps_rg/quarantine_w4_20260509/reasoning\healing_cycle.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.reasoning.healing_cycle is QUARANTINED. "
