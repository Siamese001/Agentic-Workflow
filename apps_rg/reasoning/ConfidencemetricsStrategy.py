...
Original: apps_rg/reasoning\ConfidencemetricsStrategy.py
...
archives/apps_rg/quarantine_w4_20260509/reasoning\ConfidencemetricsStrategy.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.reasoning.ConfidencemetricsStrategy is QUARANTINED. "
