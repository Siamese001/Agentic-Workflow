...
Original: apps_rg/reasoning\ExecutiveSummaryOutputAgent.py
...
archives/apps_rg/quarantine_w4_20260509/reasoning\ExecutiveSummaryOutputAgent.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.reasoning.ExecutiveSummaryOutputAgent is QUARANTINED. "
