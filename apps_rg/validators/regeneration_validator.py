...
Original: apps_rg/validators\regeneration_validator.py
...
archives/apps_rg/quarantine_w4_20260509/validators\regeneration_validator.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.validators.regeneration_validator is QUARANTINED. "
