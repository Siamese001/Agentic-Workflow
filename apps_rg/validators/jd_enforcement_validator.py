...
Original: apps_rg/validators\jd_enforcement_validator.py
...
archives/apps_rg/quarantine_w4_20260509/validators\jd_enforcement_validator.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.validators.jd_enforcement_validator is QUARANTINED. "
