...
Original: apps_rg/validators\validation_result_validator.py
...
archives/apps_rg/quarantine_w4_20260509/validators\validation_result_validator.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.validators.validation_result_validator is QUARANTINED. "
