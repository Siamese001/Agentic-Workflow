...
Core L2/L5 owns all provider interaction and enforcement strategies.
\"\"\"
...
raise RuntimeError(
    ...
    \"See: .windsurf/plans/apps-rg-declarative-ingress-only-spinal-governance-c8b3e1.md section 19\"
)

# Original code archived to:
# archives/apps_rg/quarantine_w4_20260509/enforcement/HardenedanthropicexecutorStrategy.py.ORIGINAL
