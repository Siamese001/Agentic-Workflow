    ...
    return [
        {
            ...
            "miss_behavior": "run_integrated_r4_deterministic_pipeline",
        ...
        },
        {
            ...
            "delegates_to": "run_integrated_r4_deterministic_pipeline",
            "uses_r1a": True,
            "uses_r1b": True,
            "order": list(PREFLIGHT_ORDER),
        ...
        },
        {
            ...
            "delegates_to": "run_integrated_r4_deterministic_pipeline (test shim)",
            "uses_r1a": True,
            "uses_r1b": True,
            "order": list(PREFLIGHT_ORDER),
        ...
        {
            "entrypoint": "apps_rg.runtime.orchestrate_full_resume",
            "uses_r1a": False,
            "uses_r1b": False,
