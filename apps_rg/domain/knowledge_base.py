...
class PromptTemplate(BaseModel):
    ...
    def validate_placeholders(cls, v):
        # Strict validation to ensure we don't have broken f-strings in production
...
# =============================================================================
# 🧊 FROZEN KNOWLEDGE DATA (EXTRACTED 2026-01-23)
# =============================================================================

FROZEN_SNAPSHOT = SovereignKnowledge(
    prompts={
        # --- INPUT ACQUISITION PROMPTS ---
...
def get_prompt(prompt_id: str) -> str:
    ...
    # Mapping shorthand keys to full prompt objects
    mapping = {
