...
class ResumeSectionNode:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.section_templates = {
            "technology": {
                ...
                "weights": {"skills": 0.3, "experience": 0.25, "projects": 0.2, "summary": 0.15, "education": 0.1}
            },
            "finance": {
            ...
            "healthcare": {
                ...
                "weights": {"licenses": 0.3, "experience": 0.25, "education": 0.2, "skills": 0.15, "summary": 0.1}
            },
            "default": {
    ...
    def generate_experience_section(
        ...
        # Phase A: Bullets
        bullet_out = self.two_phase_node.generate_bullets_phase_a(
            thematic_output, 
            role_data
        )
