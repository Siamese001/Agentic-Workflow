...
Original: apps_rg/types\rg_flow_router_types.py
...
archives/apps_rg/quarantine_w4_20260509/types\rg_flow_router_types.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.types.rg_flow_router_types is QUARANTINED. "
