...
Original: apps_rg/types\resume_analysis_plan_types.py
...
archives/apps_rg/quarantine_w4_20260509/types\resume_analysis_plan_types.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.types.resume_analysis_plan_types is QUARANTINED. "
