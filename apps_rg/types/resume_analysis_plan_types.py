...
class RGPlanner:
    ...
    def plan_resume_processing(self, *, job_input: dict[str, object], resume_input: dict[str, object], processing_options: dict[str, object] | None=None) -> ResumeProcessingPlan:
        ...
        processing_strategy = self._determine_processing_strategy(job_analysis, resume_analysis, processing_options)
