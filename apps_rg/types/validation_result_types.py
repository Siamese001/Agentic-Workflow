...
Original: apps_rg/types\validation_result_types.py
...
archives/apps_rg/quarantine_w4_20260509/types\validation_result_types.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.types.validation_result_types is QUARANTINED. "
