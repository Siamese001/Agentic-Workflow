...
Original: apps_rg/types\intent_payload.py
...
archives/apps_rg/quarantine_w4_20260509/types\intent_payload.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.types.intent_payload is QUARANTINED. "
