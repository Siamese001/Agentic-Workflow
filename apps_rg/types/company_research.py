...
Original: apps_rg/types\company_research.py
...
archives/apps_rg/quarantine_w4_20260509/types\company_research.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.types.company_research is QUARANTINED. "
