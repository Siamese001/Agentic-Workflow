...
Original: apps_rg/types\SovereignContext.py
...
archives/apps_rg/quarantine_w4_20260509/types\SovereignContext.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.types.SovereignContext is QUARANTINED. "
