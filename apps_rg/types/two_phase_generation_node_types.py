...
Original: apps_rg/types\two_phase_generation_node_types.py
...
archives/apps_rg/quarantine_w4_20260509/types\two_phase_generation_node_types.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.types.two_phase_generation_node_types is QUARANTINED. "
