...
class TwoPhaseGenerationNode:
    ...
    def generate_bullets_phase_a(self, thematic_output: ThematicAnalysisOutput, role_data: dict[str, Any]) -> BulletGenerationOutput:
        """
        ...
        return BulletGenerationOutput(bullets=bullets, provenance_counts={'3V': 3, '3T': 3, '1S': 1}, thematic_alignment_score=0.95)

    def synthesize_overview_phase_b(self, bullet_output: BulletGenerationOutput, thematic_output: ThematicAnalysisOutput, target_section: str='resume_overview') -> OverviewSynthesisOutput:
        """
        ...
        enforcement_result = self.word_enforcer.enforce_with_regeneration(overview_text, content_type=target_section)
        return OverviewSynthesisOutput(overview=enforcement_result['content'], word_count=enforcement_result['validation_payload']['word_count'], validation_result=enforcement_result['signature'])
