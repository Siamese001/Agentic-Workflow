...
Original: apps_rg/types\PromptTemplate.py
...
archives/apps_rg/quarantine_w4_20260509/types\PromptTemplate.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.types.PromptTemplate is QUARANTINED. "
