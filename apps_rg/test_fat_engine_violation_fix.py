...
class TestLogicNodesFunctionality:
    ...
    def test_resume_section_node_extraction_logic(self):
        ...
        job_description = "Senior Software Engineer at Google Cloud focusing on Python and machine learning"
            ...
            "experience": [
                {
                    ...
                    "bullets": ["Developed Python applications", "Used Docker for containerization"]
                }
            ],
...
class TestNoMonolithicLogicRemains:
    ...
    def test_engines_no_longer_contain_extraction_methods(self):
        ...
        from apps_rg.engines.orchestration.resume_planning_engine import ResumePlanningEngine
        planning_methods = [name for name, method in inspect.getmembers(ResumePlanningEngine, predicate=inspect.isfunction)]
        assert '_extract_role' not in planning_methods
        assert '_extract_industry' not in planning_methods
        
        # Check GapClosureEngine
        from apps_rg.engines.generation.k9_gap_closure_engine import GapClosureEngine
        gap_methods = [name for name, method in inspect.getmembers(GapClosureEngine, predicate=inspect.isfunction)]
    ...
    def test_logic_nodes_contain_all_extraction_logic(self):
        ...
        section_methods = [name for name, method in inspect.getmembers(ResumeSectionNode, predicate=inspect.isfunction)]
        ...
        skill_methods = [name for name, method in inspect.getmembers(SkillExtractorNode, predicate=inspect.isfunction)]
