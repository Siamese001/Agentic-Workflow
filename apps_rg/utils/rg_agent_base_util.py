...
emit_replay_key("p0", "rg_agent_base_util")
emit_determinism_digest("p0", "rg_agent_base_util")
_emit_signs_execution_trace("p0", "p0hash", "p0_trace", 0)
_emit_authorize_and_execute("p2", "rg_agent_base_util", "execution_auth")
_emit_validates_capability("p2", "rg_agent_base_util", "capability_check")
_emit_routes_to_capability("p2", "rg_agent_base_util", "capability_route")
_emit_writes_via_uwg("p2", "rg_agent_base_util", "uwg_write")
_emit_blocks_direct_write("p2", "rg_agent_base_util", "direct_write_block")
_emit_records_tool_invocation("p2", "rg_agent_base_util", "tool_invocation")
_emit_captures_execution_output("p2", "rg_agent_base_util", "exec_output")
_emit_dispatches_agent("p3", "rg_agent_base_util", "agent_dispatch")
_emit_coordinates_agents("p3", "rg_agent_base_util", "agent_coordination")
_emit_records_workflow_lineage("p3", "rg_agent_base_util", "workflow_lineage")
_emit_records_healing_outcome("p3", "rg_agent_base_util", "healing_outcome")
_emit_escalates_failure("p3", "rg_agent_base_util", "failure_escalation")
_emit_orchestrates_workflow("p3", "rg_agent_base_util", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "rg_agent_base_util", "healing_dispatch")
_emit_invokes_evaluation("p3", "rg_agent_base_util", "evaluation_signal")
_emit_records_telemetry_event("p4", "rg_agent_base_util", "telemetry_event")
_emit_captures_evaluation_metric("p4", "rg_agent_base_util", "eval_metric")
...
_emit_emits_metric_event("rg_agent_base_util", "p4obs", "metric_1")
_emit_emits_metric_event("rg_agent_base_util", "p4obs", "metric_2")
_emit_emits_metric_event("rg_agent_base_util", "p4obs", "metric_3")
_emit_emits_metric_event("rg_agent_base_util", "p4obs", "metric_4")
_emit_emits_metric_event("rg_agent_base_util", "p4obs", "metric_5")
_emit_emits_metric_event("rg_agent_base_util", "p4obs", "metric_6")
_emit_records_incident_event("rg_agent_base_util", "p4obs", "incident")
_emit_captures_runtime_anomaly("rg_agent_base_util", "p4obs", "anomaly")
_emit_writes_observability_log("rg_agent_base_util", "p4obs", "obs_log")
_emit_updates_monitoring_state("rg_agent_base_util", "p4obs", "mon_state")
_emit_triggers_alert("rg_agent_base_util", "p4obs", "alert")
_emit_links_incident_trace("rg_agent_base_util", "p4obs", "trace_link")
_emit_captures_pattern("rg_agent_base_util", "p3lm", "pattern")
_emit_records_learning_event("rg_agent_base_util", "p3lm", "learning_event")
_emit_writes_learning_snapshot("rg_agent_base_util", "p3lm", "snapshot")
_emit_feeds_meta_learning("rg_agent_base_util", "p3lm", "meta_feed")
_emit_updates_routing_strategy("rg_agent_base_util", "p3lm", "routing")
_emit_improves_agent_policy("rg_agent_base_util", "p3lm", "policy")
_emit_stores_learning_state("rg_agent_base_util", "p3lm", "state")
_emit_records_execution_trace("rg_agent_base_util", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("rg_agent_base_util", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("rg_agent_base_util", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("rg_agent_base_util", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("rg_agent_base_util", "L4_STATE", "p2_trace_5")
_emit_reads_environ("rg_agent_base_util", "env_read", "p2_env_1")
_emit_reads_environ("rg_agent_base_util", "env_read", "p2_env_2")
_emit_reads_runtime_state("rg_agent_base_util", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("rg_agent_base_util", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "rg_agent_base_util", "context_pull")
_emit_pulls_context("p1", "rg_agent_base_util", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "rg_agent_base_util", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "rg_agent_base_util", "uwg_term_2")
_emit_writes_through("p1", "rg_agent_base_util", "write_through")
_emit_writes_through("p1", "rg_agent_base_util", "write_through_2")
_emit_validated_by_safety_plane("p1", "rg_agent_base_util", "safety_validation")
_emit_invokes_eval("p1", "rg_agent_base_util", "eval_call")
_emit_proposal_commits_routing("p1", "rg_agent_base_util", "routing_commit")
_emit_escalates_to_human("p1", "rg_agent_base_util", "human_escalation")
_emit_routes_through("p1", "rg_agent_base_util", "route_through")
_emit_checks_agent_registry("p1", "rg_agent_base_util", "agent_registry")
_emit_validates_agent_capability("p1", "rg_agent_base_util", "capability")
_emit_dispatches_execution_plan("p1", "rg_agent_base_util", "exec_plan")
_emit_agent_executes_agent("p1", "rg_agent_base_util", "sub_agent")
_emit_routes_to_agent("p1", "rg_agent_base_util", "target_agent")
_emit_verifies_policy("p1", "rg_agent_base_util", "policy_check")
_emit_observes_runtime_state("p1", "rg_agent_base_util", "runtime_state")
_emit_verifies_boundary("p1", "rg_agent_base_util", "boundary_check")
_emit_transcripts_response("p1", "rg_agent_base_util", "transcript")
_emit_hard_fails_untranscripted("p1", "rg_agent_base_util")
_emit_gated_by_confidence("p1", "rg_agent_base_util", "confidence_gate")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_1")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_2")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_3")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_4")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_5")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_6")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_7")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_8")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_9")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_10")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_11")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_12")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_13")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_14")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_15")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_16")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_17")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_18")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_19")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_20")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_21")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_22")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_23")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_24")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_25")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_26")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_27")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_28")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_29")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_30")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_31")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_32")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_33")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_34")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_35")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_36")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_37")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_38")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_39")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_40")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_41")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_42")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_43")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_44")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_45")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_46")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_47")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_48")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_49")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_50")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_51")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_52")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_53")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_54")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_55")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_56")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_57")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_58")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_59")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_60")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_61")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_62")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_63")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_64")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_65")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_66")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_67")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_68")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_69")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_70")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_71")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_72")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_73")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_74")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_75")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_76")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_77")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_78")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_79")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_80")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_81")
_emit_reads_through("l4", "rg_agent_base_util", "urg_read_82")
