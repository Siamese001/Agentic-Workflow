...
Original: apps_rg/utils/rg_core_mixins_util.py
...
archives/apps_rg/quarantine_w4_20260509/utils/rg_core_mixins_util.py.ORIGINAL
"""

raise RuntimeError(
    "QUARANTINE VIOLATION (AG-RGGOV-8): "
    "apps_rg.utils.rg_core_mixins_util is QUARANTINED. "
