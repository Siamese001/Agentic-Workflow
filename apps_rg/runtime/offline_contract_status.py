...
Relocated from the retired ``qwen_offline_contract_stub`` module (Qwen/vLLM removal).
...
so gate semantics are preserved without any Qwen coupling.
"""
from __future__ import annotations

# Proof/gate runtime status marker. Value preserved verbatim so X2/X3 and proof-accounting
# comparisons that key on this string remain byte-stable across the Qwen removal.
