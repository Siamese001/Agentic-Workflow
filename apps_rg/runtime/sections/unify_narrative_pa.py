...
def _legacy_i0(runtime_payload: dict[str, Any]) -> str:
    ...
    return (
        ...
        "Good: Led platform roadmap and commercialization of a production-grade agentic AI platform at Unify Consulting, "
        "converting bespoke delivery into reusable platform services for regulated financial-services adoption.\n"
        "Bad: metric recap of $22M/20%/six-months-to-three-weeks; JD-as-proof; bullet-label paste."
    )
