...
def format_graph_proof_pool_appendix(runtime_payload: dict[str, Any]) -> str:
    ...
    return (
        ...
        "Prefer platform, governance, lifecycle, and commercial facts when the 5–6 sentence / 140-word budget is tight. "
...
def build_executive_summary_assembly_input(
    ...
    *,
    ...
    u0 = (
        ...
        f"{strategy_voice}"
        "Return bare JSON (see R0 keys). resume_display_text: 5 or 6 sentences, one paragraph (max 140 words) "
