...
def _legacy_i0(runtime_payload: dict[str, Any]) -> str:
    ...
    return (
        ...
        "POOL: each Qwen path emits 5 bullets; Claude selector picks best variant per bul_ibm_* slot. "
        "Preserve metrics as tokens: $15M, 99.9%, 30%, 25%, 50%.\n"
    ...
    *,
    ...
    assembly = PromptAssemblyInput(
        ...
        u0_user_task=(
            ...
            "exactly 5 bullets (bul_ibm_001..005) with complete claim_ledger; "
