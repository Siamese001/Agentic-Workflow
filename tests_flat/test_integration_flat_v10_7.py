...
# ------------------------------------------------------------------
# ----- BEGIN: tests/integration/test_integration_flow_v10_7.py -----
import pytest
...
# ----- END: tests/integration/test_integration_flow_v10_7.py -----
# ----- BEGIN: tests/integration/test_end_to_end_paths_v10_7.py -----
import pytest
from workflow.runner import run_workflow
...
# ----- END: tests/integration/test_end_to_end_paths_v10_7.py -----
