...
# ------------------------------------------------------------------
# ----- BEGIN: tests/mcp/test_mcp_context_v10_7.py -----
...
# ----- END: tests/mcp/test_mcp_context_v10_7.py -----
# ----- BEGIN: tests/mcp/test_mcp_matrix_v10_7.py -----
import asyncio
import asyncio
import sys
import types
...
def test_get_mcp_client_returns_fallback_stub_when_configured(workflow_context: WorkflowContext):
    ...
    try:
        ...
        workflow_context._load_mcp_config()
        workflow_context.reset_mcp_clients()
# ----- END: tests/mcp/test_mcp_matrix_v10_7.py -----
