"""Auto-generated flattened view for conftest.py.
...
SOURCE_REL_PATH = "conftest.py"
SOURCE_PATH = REPO_ROOT / SOURCE_REL_PATH

# Embedded canonical source
EMBEDDED_SOURCES = {
    SOURCE_REL_PATH: '''import asyncio, sys, types, pytest
from pathlib import Path
...
ORIGINAL_MODULE_NAME = "tests.conftest"
FLAT_MODULE_NAME = "tests_flat.conftest"
