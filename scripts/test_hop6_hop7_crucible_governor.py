...
class TestValidationCrucible:
    ...
    def test_hop6_placeholder_critical_failure(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Hello [Name], I noticed your work."}
        })
        ...
        assert any(r["rule_id"] == "LIC-E001" and not r["passed"] for r in report["validation_results"]), "LIC-E001 should fail"
    ...
    def test_hop6_placeholder_pass_clean_text(self):
        ...
        lic_e001 = next((r for r in report["validation_results"] if r["rule_id"] == "LIC-E001"), None)
    ...
    def test_hop6_strategic_alignment_failure(self):
        ...
        buffer, registry = ImmutableStagingBuffer(), TraceRegistry()
        buffer.write_once("hop2_research", {"strategic_brief": "Cloud migration digital transformation"})
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Hello, I sell widgets."}
        })
        ...
        lic_e015 = next((r for r in report["validation_results"] if r["rule_id"] == "LIC-E015"), None)
    ...
    def test_hop6_strategic_alignment_pass(self):
        ...
        buffer.write_once("hop2_research", {"strategic_brief": "Cloud migration digital transformation"})
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Your cloud migration initiatives align with our expertise."}
        })
    ...
    def test_hop6_forbidden_verbs_detection(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "We will revolutionize your business."}
        })
        ...
        lic_e008 = next((r for r in report["validation_results"] if r["rule_id"] == "LIC-E008"), None)
    ...
    def test_hop6_externalized_config_placeholder_regex(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Hello {Name}"}
        })
    ...
    def test_hop7_factual_vs_creative_routing(self):
        ...
        buffer.write_once("hop6_validation_report", {
            "passed": False,
            "validation_results": [{"rule_id": "LIC-E015", "passed": False, "severity": "CRITICAL"}]
        })
        ...
        assert any(t.get("type") == "FACTUAL_LOOP_TRIGGERED" for t in traces), "Should log factual loop"
    ...
    def test_hop7_creative_routing(self):
        ...
        buffer.write_once("hop6_validation_report", {
            "passed": False,
            "validation_results": [{"rule_id": "LIC-E001", "passed": False, "severity": "CRITICAL"}]
        })
    ...
    def test_hop6_all_rules_executed(self):
        ...
        buffer.write_once("hop2_research", {"strategic_brief": "Test"})
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Clean text"}
        })
    ...
    def test_hop6_stats_tracking(self):
        ...
        buffer.write_once("hop2_research", {"strategic_brief": "Test"})
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "[Name] placeholder"}
        })
