...
class OrchestrateScriptsPlanningOrchestratorProcessor(ABC):
    ...
    @abstractmethod
    def process(self, input_data: Dict[str, Any]) -> OrchestrateScriptsPlanningOrchestratorResult:
...
def orchestrate_scripts_planning(input_data: Dict[str, Any]) -> Dict[str, Any]:
    """
