...
class TestKeyDeprecationFast:
    ...
    def test_agent_discovery_json_clean(self):
        ...
        assert not violations, "agent_discovery_full.json violations:\n" + "\n".join(violations)
    ...
    def test_active_code_directories_clean(self):
        ...
        for directory in active_dirs:
            ...
            for py_file in directory.rglob("*.py"):
                ...
                if "test_downstream_deprecation" in str(py_file) or "test_key_deprecation" in str(
                    py_file
                ):
                    continue
        ...
        assert not violations, "Active code violations:\n" + "\n".join(violations[:10])
    ...
    def test_documentation_references(self):
        ...
        assert not violations, "Documentation violations:\n" + "\n".join(violations)
