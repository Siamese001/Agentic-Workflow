...
def test_autonomous_mode_propagation():
    ...
    assert healer._autonomous_mode == True, f"Autonomous mode not propagated: {healer._autonomous_mode}"
...
def test_mission_script_configuration():
    ...
    spec = importlib.util.spec_from_file_location(
        "mission", 
        project_root / "ops_scripts" / "sovereign_healing_mission.py"
    )
...
def test_confidence_scoring():
    ...
    try:
        ...
        confidence = healer._calculate_subfolder_confidence("test_helpers", ["test_data", "scripts"])
        ...
        confidence = healer._calculate_subfolder_confidence("test_data", ["test_scripts", "test_utils"])
