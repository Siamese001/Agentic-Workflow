...
SSOT_IMPORT = """from agentic_core.config.blueprint_sovereign.structure_blueprint import (
...
def has_ssot_import(content: str) -> bool:
    ...
    return 'from agentic_core.config.blueprint_sovereign.structure_blueprint import' in content
