"""Backward compatibility shim for constitutional_ai_types.
...
# from .constitutional_ai_types_part import *  # Star import removed
# from .constitutional_ai_types_part_2 import *  # Star import removed
