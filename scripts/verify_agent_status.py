...
Usage: python scripts/verify_agent_status.py
"""
...
SUSPECT_FILES = [
    ...
    "agentic_core/L0_maintenance/scripts/auto_remediate_signatures.py",
...
def analyze_file(file_path: Path) -> dict[str, Any]:
    ...
    if sovereign_classes:
        ...
        result["reason"] = (
            f"Contains sovereign agent class(es): {[c['name'] for c in sovereign_classes]}"
        )
    elif mixin_classes:
