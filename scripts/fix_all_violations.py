        ...
        if full_path.exists():
            try:
                ...
                if len(defs) > 5:
                    ...
                    for i in range(0, len(defs), 5):
                        SUFFIX = "" if i == 0 else f"_{i//5 + 1}"
# TODO: Replace star import: # TODO: Replace star import: # TODO: Replace star import: # TODO: Replace star import: # TODO: Replace star import:                         shim_content += f"from .{stem}_part{suffix} import *"
