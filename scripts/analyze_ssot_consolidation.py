...
class SSOTConsolidationAnalyzer:
    ...
    def compare_file_versions(self, filename: str) -> Dict:
        ...
        if not utils_features and not base_features:
            ...
            utils_has_critical = (
                utils_features.get("has_healer_mixin", False) or
                utils_features.get("has_mcp_hardened", False) or
                utils_features.get("has_immutable_staging_buffer", False)
            )
            
            base_has_critical = (
                base_features.get("has_healer_mixin", False) or
                base_features.get("has_mcp_hardened", False) or
                base_features.get("has_immutable_staging_buffer", False)
            )
