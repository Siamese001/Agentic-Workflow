...
DOCSTRING_DEBT = {
    ...
    'agentic_core/L1_cognition/P3_aggregate/consolidate_core_updates.py:consolidate',
    'agentic_core/L1_cognition/P3_aggregate/consolidate_core_updates.py:determine_version',
    'agentic_core/L1_cognition/P3_aggregate/consolidate_core_updates.py:extract_files',
    'agentic_core/L1_cognition/P3_aggregate/consolidate_core_updates.py:is_whitelisted',
    'agentic_core/L1_cognition/P3_aggregate/consolidate_core_updates.py:main',
    'agentic_core/L1_cognition/P3_aggregate/consolidate_core_updates.py:merge_sources',
    'agentic_core/L1_cognition/P3_aggregate/consolidate_core_updates.py:normalize_key',
    ...
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:consolidate',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:determine_version',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:extract_files',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:is_whitelisted',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:main',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:merge_sources',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:normalize_key',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:safe_copy',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:sha256_for_file',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/consolidate.py:write_manifest',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:A2AContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:A2AMessage',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:ArtifactContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:BulletContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:DraftContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:FeedbackContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:HILContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:JobContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:MetadataContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:PromptContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:QAContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:ResumeContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:SafetyContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:StrategyContext',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:append',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:get_mcp_client',
    'agentic_core/L1_cognition/P3_aggregate/sync_status/update/merge.py:get_model_client',
    ...
    'agentic_core/L2_execution/apply_execution_action.py:sanitize_node',
    'agentic_core/L2_execution/format_execution_output.py:A2AContext',
    'agentic_core/L2_execution/format_execution_output.py:A2AMessage',
    'agentic_core/L2_execution/format_execution_output.py:ArtifactContext',
    'agentic_core/L2_execution/format_execution_output.py:BulletContext',
    'agentic_core/L2_execution/format_execution_output.py:DraftContext',
    'agentic_core/L2_execution/format_execution_output.py:FeedbackContext',
    'agentic_core/L2_execution/format_execution_output.py:HILContext',
    'agentic_core/L2_execution/format_execution_output.py:JobContext',
    'agentic_core/L2_execution/format_execution_output.py:MetadataContext',
    'agentic_core/L2_execution/format_execution_output.py:PromptContext',
    'agentic_core/L2_execution/format_execution_output.py:QAContext',
    'agentic_core/L2_execution/format_execution_output.py:ResumeContext',
    'agentic_core/L2_execution/format_execution_output.py:SafetyContext',
    'agentic_core/L2_execution/format_execution_output.py:StrategyContext',
    'agentic_core/L2_execution/format_execution_output.py:append',
    'agentic_core/L2_execution/format_execution_output.py:get_mcp_client',
    'agentic_core/L2_execution/format_execution_output.py:get_model_client',
    'agentic_core/L2_execution/format_execution_output.py:is_mcp_enabled',
    'agentic_core/L2_execution/format_execution_output.py:model_dump',
    'agentic_core/L2_execution/format_execution_output.py:to_dict',
    'agentic_core/L2_execution/perform_execution_task.py:test_latency_smoke',
    'agentic_core/L2_execution/validate_1.py:ValidationStep',
    'agentic_core/L2_execution/validate_1.py:fail',
    'agentic_core/L2_execution/validate_1.py:ok',
    'agentic_core/L2_execution/validate_1.py:read_json',
    'agentic_core/L2_execution/validate_1.py:run',
    'agentic_core/L2_execution/validate_1.py:run_enhanced',
    'agentic_core/L2_execution/validate_1.py:sha256_of',
    'agentic_core/L2_execution/validate_execution_output.py:ValidationStep',
    'agentic_core/L2_execution/validate_execution_output.py:fail',
    'agentic_core/L2_execution/validate_execution_output.py:ok',
    'agentic_core/L2_execution/validate_execution_output.py:read_json',
    'agentic_core/L2_execution/validate_execution_output.py:run',
    'agentic_core/L2_execution/validate_execution_output.py:run_enhanced',
    'agentic_core/L2_execution/validate_execution_output.py:sha256_of',
    'agentic_core/L3_orchestration/apply_orchestration_action.py:PIDetectionOutput',
    'agentic_core/L3_orchestration/apply_orchestration_action.py:run',
    'agentic_core/L3_orchestration/apply_orchestration_action.py:run_async',
    'agentic_core/L3_orchestration/apply_orchestration_action.py:sanitize_node',
    'agentic_core/L3_orchestration/dispatch_orchestration_tools.py:run_async',
    'agentic_core/L3_orchestration/dispatch_orchestration_tools_1.py:run_async',
    'agentic_core/L3_orchestration/validate_orchestration_output.py:ValidationStep',
    'agentic_core/L3_orchestration/validate_orchestration_output.py:fail',
    'agentic_core/L3_orchestration/validate_orchestration_output.py:ok',
    'agentic_core/L3_orchestration/validate_orchestration_output.py:read_json',
    ...
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:BulletContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:DraftContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:FeedbackContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:HILContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:JobContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:MetadataContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:PromptContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:QAContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:ResumeContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:SafetyContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:StrategyContext',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:append',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:get_mcp_client',
    'agentic_core/L4_memory/P1_retrieve/gather_context_inputs/embedding/find.py:get_model_client',
    ...
    'agentic_core/L5_safety/apply_safety_action.py:run_async',
    'agentic_core/L5_safety/apply_safety_action.py:sanitize_node',
    'agentic_core/L5_safety/apply_safety_policy.py:PIDetectionOutput',
    'agentic_core/L5_safety/apply_safety_policy.py:run',
    'agentic_core/L5_safety/apply_safety_policy.py:run_async',
    'agentic_core/L5_safety/apply_safety_policy.py:sanitize_node',
    'agentic_core/L5_safety/evaluate_safety_risk.py:test_evaluate_case_output_basic',
    'agentic_core/L5_safety/validate_safety_output.py:ValidationStep',
    'agentic_core/L5_safety/validate_safety_output.py:fail',
    'agentic_core/L5_safety/validate_safety_output.py:ok',
    'agentic_core/L5_safety/validate_safety_output.py:read_json',
    ...
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:GateDecision',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:GateDecisionEngine',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:HopExecutionError',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:HopStatus',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:PreFlightValidator',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:ResumeSection',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:SignalControlConfig',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:StagingBufferError',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:ThematicAnalysis',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:ValidationSeverity',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:create_error_message_lambda',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:default_serializer',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:fallback_phase1',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:fallback_phase2',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:fallback_phase3',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:fallback_phase4',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:main_phase1',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:main_phase2',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:main_phase3',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:main_phase4',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:timeout_handler',
    'apps_rg/L3_orchestration/orchestrate_resume_generation.py:validate',
    'tests/unit/agentic_core/test_architectural_compliance.py:AgentProtocol',
    'tests/unit/agentic_core/test_architectural_compliance.py:BadAgent',
    'tests/unit/agentic_core/test_architectural_compliance.py:BaseAgent',
    'tests/unit/agentic_core/test_architectural_compliance.py:ConcreteAgent',
    'tests/unit/agentic_core/test_architectural_compliance.py:DataRepository',
    'tests/unit/agentic_core/test_architectural_compliance.py:FocusedAgent',
    'tests/unit/agentic_core/test_architectural_compliance.py:GoodAgent',
    'tests/unit/agentic_core/test_architectural_compliance.py:provider',
    'tests/unit/agentic_core/test_architectural_compliance.py:WorkflowContext',
    'tests/unit/agentic_core/test_architectural_compliance.py:dfs',
    'tests/unit/agentic_core/test_architectural_compliance.py:execute',
    'tests/unit/agentic_core/test_architectural_compliance.py:find',
    'tests/unit/agentic_core/test_architectural_compliance.py:generate_report',
    'tests/unit/agentic_core/test_architectural_compliance.py:get_setting',
    'tests/unit/agentic_core/test_architectural_compliance.py:good_function',
    'tests/unit/agentic_core/test_architectural_compliance.py:has_cycle',
    'tests/unit/agentic_core/test_architectural_compliance.py:process',
    'tests/unit/agentic_core/test_architectural_compliance.py:process_data',
    'tests/unit/agentic_core/test_architectural_compliance.py:render_html',
    'tests/unit/agentic_core/test_architectural_compliance.py:save',
    'tests/unit/agentic_core/test_architectural_compliance.py:send_email',
    'tests/unit/agentic_core/test_architectural_compliance.py:update_database',
    'tests/unit/agentic_core/test_architectural_compliance.py:validate',
    'tests/unit/agentic_core/test_constitutional_review.py:SafetyLevel',
    'tests/unit/agentic_core/test_constitutional_review.py:SafetyResult',
    'tests/unit/agentic_core/test_contract_enforcement.py:ContractViolation',
    'tests/unit/agentic_core/test_contract_enforcement.py:log_operation',
    'tests/unit/agentic_core/test_contract_enforcement.py:process',
    'tests/unit/agentic_core/test_contract_enforcement.py:process_once',
    'tests/unit/agentic_core/test_contract_enforcement.py:safe_function',
    'tests/unit/agentic_core/test_contract_enforcement.py:save_to_db',
    'tests/unit/agentic_core/test_contract_enforcement.py:send_notification',
    'tests/unit/agentic_core/test_contract_enforcement.py:transfer',
    'tests/unit/agentic_core/test_design_validation.py:DesignEdge',
    'tests/unit/agentic_core/test_design_validation.py:DesignNode',
    'tests/unit/agentic_core/test_design_validation.py:NodeType',
    'tests/unit/agentic_core/test_execution_planning.py:ToolStatus',
    'tests/unit/agentic_core/test_functional_behavior.py:AgentOutput',
    'tests/unit/agentic_core/test_functional_behavior.py:validate_input',
    'tests/unit/agentic_core/test_l5_enforcement.py:SafetyAction',
    'tests/unit/agentic_core/test_memory_operations.py:MemoryEntry',
    'tests/unit/agentic_core/test_mock_detection.py:MockDatabase',
    'tests/unit/agentic_core/test_mock_detection.py:get',
    'tests/unit/agentic_core/test_mock_detection.py:mock_analyzer',
    'tests/unit/agentic_core/test_mock_detection.py:mock_audit',
    'tests/unit/agentic_core/test_mock_detection.py:mock_classifier',
    'tests/unit/agentic_core/test_mock_detection.py:mock_enricher',
    'tests/unit/agentic_core/test_mock_detection.py:mock_generator',
    'tests/unit/agentic_core/test_mock_detection.py:mock_notify',
    'tests/unit/agentic_core/test_mock_detection.py:mock_pii_detector',
    'tests/unit/agentic_core/test_mock_detection.py:mock_processor',
    'tests/unit/agentic_core/test_mock_detection.py:mock_random_selector',
    'tests/unit/agentic_core/test_mock_detection.py:mock_sanitizer',
    'tests/unit/agentic_core/test_mock_detection.py:mock_save',
    'tests/unit/agentic_core/test_mock_detection.py:mock_search',
    'tests/unit/agentic_core/test_mock_detection.py:mock_selector',
    'tests/unit/agentic_core/test_mock_detection.py:mock_semantic_search',
    'tests/unit/agentic_core/test_mock_detection.py:mock_validator',
    'tests/unit/agentic_core/test_mock_detection.py:real_selector',
    'tests/unit/agentic_core/test_mock_detection.py:save',
    'tests/unit/agentic_core/test_tool_calls.py:get_default_seed',
    'tests/unit/agentic_core/test_tool_calls.py:mock_generate',
    'tests/unit/agentic_core/test_workflow_orchestration.py:WorkflowContext',
    'tests/unit/agentic_core/test_workflow_orchestration.py:WorkflowState',
    'tests/unit/apps_lic/test_lic_memory_mappings.py:test_known_malicious_prompt_remains_blocked',
    'tests/unit/apps_lic/test_lic_message_generation_executor.py:EmptyPlan',
    'tests/unit/apps_lic/test_lic_message_generation_executor.py:StaticTool',
    'tests/unit/apps_lic/test_lic_message_generation_executor.py:budget',
