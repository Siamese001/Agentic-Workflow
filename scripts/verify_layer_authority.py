...
def main():
    ...
    except LayerAuthorityError as e:    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context    # guardian: LayerAuthorityError should be handled with specific context
