...
def execute_phase1_discovery(agents, territory):
    ...
    location_validator = agents['location'](root_path=Path("agentic_core"))
    location_report = location_validator.validate_territory_compliance(territory=territory)
    ...
    return drift_report, location_report
...
def main():
    ...
    # Execute for first territory (prompt_governance) as test
    target_territories = ['prompt_governance']  # Start with one territory for testing
