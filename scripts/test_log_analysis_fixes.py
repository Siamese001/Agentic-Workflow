...
def test_2_signature_compliance():
    ...
    agents_to_check = [
        ("BiasAuditorAgent", PROJECT_ROOT / "agentic_core" / "L5_safety" / "validators" / "BiasAuditorAgent.py"),
        ("L5Agent", PROJECT_ROOT / "agentic_core" / "L5_safety" / "validators" / "L5Agent.py"),
        ("MethodChangeDetectorAgent", PROJECT_ROOT / "agentic_core" / "L5_safety" / "validators" / "MethodChangeDetectorAgent.py"),
    ]
            ...
            for i, line in enumerate(lines):
                if "def heal_repository" in line:
                    ...
                    assert "**kwargs" in signature, \
                        f"{agent_name} heal_repository missing **kwargs"
...
def test_5_mixin_metrics_check():
    ...
    assert "self._healer_metrics = {" in content, \
        "Defensive initialization missing"
...
def test_6_import_typo_fix():
    ...
    files_to_check = [
        ...
        PROJECT_ROOT / "agentic_core" / "L0_maintenance" / "scripts" / "recalculate_health_scores.py",
