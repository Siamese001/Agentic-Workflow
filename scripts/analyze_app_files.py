...
RESUME_KEYWORDS = ['resume', 'cv ', 'ats', 'job description', 'bullet point', 'work experience', 'resume generator']
OUTREACH_KEYWORDS = ['outreach', 'linkedin', 'recipient', 'campaign', 'personalization', 'sender', 'inmail', 'message generation']
