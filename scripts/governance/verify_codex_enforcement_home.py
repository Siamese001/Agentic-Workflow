...
PUBLICATION_REQUIRED_PROMPT_SNIPPETS = (
    ...
    "HEAD == origin/main",
    "git status --short --branch has no unresolved conflict rows",
    "ordinary dirty files on local main are workspace_topology_closeout evidence, not publication failure",
...
APPS_RG_S2E_REQUIRED_PROMPT_SNIPPETS = (
    ...
    "research/research_artifact_ref.json",
    "APPS_RESEARCH_ARTIFACT_MISSING",
