...
MINIMUM_AGENT_COUNT = 283  # Phase B COMPLETE - Final 283 hardening achieved (Jan 06, 2026)
MAX_AGENT_DROP_PERCENT = 0   # Zero tolerance for agent loss - strict enforcement
EXPECTED_AGENT_COUNT = 283  # Phase B COMPLETE - Target reached with 1:1 sovereign file structure
