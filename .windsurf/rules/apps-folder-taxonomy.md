...
description: Apps folder taxonomy (ADR-082) enforcement — load when editing any apps_*/ tree, authoring new files under apps_*, moving files within apps_*, or discussing apps_* structure/layout decisions.
---
