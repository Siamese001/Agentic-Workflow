...
description: Apply when relying on an LLM-rubric judge at runtime (§5 trace-grader) or in shadow (§6B). Enforces periodic human calibration and an unknown-budget watchdog.
---
...
`artifacts/windsurf/judge_calibration_bypass.jsonl`. Reserved for scripted
...
- Plan — `.windsurf/plans/exit-eval-spine-gap-ce683b.md` §W5.2
