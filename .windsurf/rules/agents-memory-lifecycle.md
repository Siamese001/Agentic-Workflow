...
| Before Author-Gate decisions | Call `search_nodes` to check for historical precedent on similar decisions |
...
| **Author-Gate decision resolved** | `add_observations` to record the chosen option and reasoning |
