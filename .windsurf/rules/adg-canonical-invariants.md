...
All four have guardian exemption paths BUT require explicit HITL approval per `anti-pattern-hitl-gate.md` (§constitutional 8). No new instances without approval.
