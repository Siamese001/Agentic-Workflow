---
workflow_id: core-boundary-audit
slash_command: /core-boundary-audit
version: "1.0"
tier: 2
description: |
  Run git diff, classify changed files, scan for app-specific leakage,
  and write boundary receipt. Blocks if leakage found.
---
...
rule_files = [f for f in changed_files if f.startswith('.windsurf/rules/')]
skill_files = [f for f in changed_files if f.startswith('.windsurf/skills/')]
```
...
| `.windsurf/rules/*.md` | Rule changes |
| `.windsurf/skills/**/SKILL.md` | Skill changes |
