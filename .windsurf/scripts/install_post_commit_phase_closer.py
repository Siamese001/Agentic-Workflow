...
Usage:
    python .windsurf/scripts/install_post_commit_phase_closer.py
    python .windsurf/scripts/install_post_commit_phase_closer.py --uninstall
    python .windsurf/scripts/install_post_commit_phase_closer.py --status
"""
...
python "$(git rev-parse --show-toplevel)/.windsurf/scripts/post_commit_phase_closer.py" >&2 || true
{MARKER_END}
"""
