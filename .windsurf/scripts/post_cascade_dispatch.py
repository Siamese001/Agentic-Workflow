...
Activation: env `POST_CASCADE_DISPATCHER=1`.
...
any standalone script entry from `.windsurf/hooks.json`.
...
#
# Order matches `.windsurf/hooks.json` post_cascade_response chain so the
...
LEGACY_SCRIPTS: list[str] = [
    ...
    # Slot 7
    "post_cascade_scope_drift_detector.py",
    # Slot 8
    "post_cascade_writeback_audit.py",
    # Slot 9
    "post_cascade_deferred_scope_capture.py",
    # Slot 10
    "post_cascade_next_step_capture.py",
    # Slot 11
    "post_cascade_adr_registry_capture.py",
    # Slot 12-13
    ...
    # Slot 16
    "post_cascade_fortknox_integrity_audit.py",
]
...
def main() -> int:
    if os.environ.get("POST_CASCADE_DISPATCHER") != "1":
