...
.windsurf/plans/ execution patterns and wave state management.
...
PLAN_DIR: str = ".windsurf/plans"
PLAN_TEMPLATE: str = ".windsurf/templates/execution-plan-template.md"
...
def is_valid_plan_slug(slug: str) -> bool:
    ...
    Example: windsurf-governance-consolidation-a7c3e9
    """
    import re
