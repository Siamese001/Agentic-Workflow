...
Shared by:
  - post_cascade_ag_queue_drain_audit.py (post-hook audit)
  - pre_user_prompt_ag_queue_surface.py (pre-hook proactive surface)
  - post_cascade_ag_queue_seed_capture.py (AG_QUEUE_SEED marker capture)
  - ops_scripts/ci/check_ag_queue_drain_freshness.py (weekly drift gate)

State file: .windsurf/state/author_gate_queue/<plan-slug>.jsonl (append-only)
...
STATE_DIR = REPO_ROOT / ".windsurf" / "state" / "author_gate_queue"
