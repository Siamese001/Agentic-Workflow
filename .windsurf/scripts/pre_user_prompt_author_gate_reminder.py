...
VIOLATIONS_PATH = REPO_ROOT / "artifacts" / "windsurf" / "author_gate_ui_violations.jsonl"
ASK_VIOLATIONS_PATH = REPO_ROOT / "artifacts" / "windsurf" / "ask_user_question_packet_violations.jsonl"
