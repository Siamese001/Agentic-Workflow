...
- post_cascade_plan_creation_audit.py (post-flight advisory audit with auto-correction)
...
# Audit log paths
_AUDIT_LOG_PATH = Path("artifacts/windsurf/plan_creation_corrections.jsonl")
_ALERT_LOG_PATH = Path("artifacts/windsurf/plan_creation_alerts.jsonl")
...
# =============================================================================
# POST-FLIGHT AUDIT (from post_cascade_plan_creation_audit)
# =============================================================================
...
def run_pre_flight() -> int:
    ...
    Runs in pre-cascade or pre-mcp chain.
