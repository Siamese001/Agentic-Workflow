...
-------
    All verification attempts append to:
        artifacts/windsurf/plan_identity_verifications.jsonl
...
def extract_slug_from_context(context: str) -> Optional[str]:
    ...
    - plan file paths: .windsurf/plans/xxx-xxx.md
    ...
    match = re.search(r'\.windsurf/plans/([a-z0-9-]+-[a-f0-9]{6,})\.md', context)
    if match:
        return match.group(1)
