...
Usage:
    python .windsurf/scripts/apply_append_only_triggers.py           # apply to all
    python .windsurf/scripts/apply_append_only_triggers.py --check   # verify without changes
    python .windsurf/scripts/apply_append_only_triggers.py --db <path>  # single DB
