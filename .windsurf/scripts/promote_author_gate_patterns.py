...
USAGE
-----
    python .windsurf/scripts/promote_author_gate_patterns.py            # promote + backfill
    python .windsurf/scripts/promote_author_gate_patterns.py --dry-run  # report only
    python .windsurf/scripts/promote_author_gate_patterns.py --backfill-only
    python .windsurf/scripts/promote_author_gate_patterns.py --promote-only
