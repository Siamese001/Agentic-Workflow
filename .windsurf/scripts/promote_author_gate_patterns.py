...
USAGE
-----
    python .windsurf/scripts/promote_author_gate_patterns.py
    python .windsurf/scripts/promote_author_gate_patterns.py --dry-run
    python .windsurf/scripts/promote_author_gate_patterns.py --skip-quarantine
