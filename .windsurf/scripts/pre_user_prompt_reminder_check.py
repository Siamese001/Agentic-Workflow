#!/usr/bin/env python3
"""
pre_user_prompt_reminder_check.py — scan .windsurf/reminders/ for due items.
...
Move resolved reminders to .windsurf/reminders/archived/ to stop surfacing.
...
REMINDERS_DIR = REPO_ROOT / ".windsurf" / "reminders"
