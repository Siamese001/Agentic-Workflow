...
AUDIT_LOG = REPO_ROOT / "artifacts" / "windsurf" / "plan_reconcile_hook.jsonl"
CLOSER_SCRIPT = REPO_ROOT / ".windsurf" / "scripts" / "plan_driven_closer.py"
...
def main() -> int:
    ...
    if ".windsurf/plans/" not in file_path or not file_path.endswith(".md"):
        return 0
