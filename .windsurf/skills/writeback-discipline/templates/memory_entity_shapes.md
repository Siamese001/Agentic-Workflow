...
- `ProceduralPattern:WindsurfHookSessionIdConsistency`
...
```json
{
  "entities": [{
    ...
    "observations": [
      ...
      "plan_path: @c:/Git/Agentic-Workflow/.windsurf/plans/<name>-<6hex>.md",
...
```json
{
  "entities": [{
    ...
    "observations": [
      ...
      "linked_artifacts: [<docs/reports/rca/<file>.md>, <.windsurf/plans/<name>-<hex>.md>]",
