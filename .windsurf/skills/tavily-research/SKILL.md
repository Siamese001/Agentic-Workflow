...
|---|---|---|
| `/tavily-search <query>` | `.windsurf/workflows/tavily-search.md` | `tavily-search` |
| `/tavily-extract <url(s)>` | `.windsurf/workflows/tavily-extract.md` | `tavily-extract` |
| `/tavily-map <url>` | `.windsurf/workflows/tavily-map.md` | `tavily-map` |
| `/tavily-crawl <url>` | `.windsurf/workflows/tavily-crawl.md` | `tavily-crawl` |
| `/tavily-research <topic>` | `.windsurf/workflows/tavily-research.md` | `tavily-research` |
| `/tavily-best-practices` | `.windsurf/workflows/tavily-best-practices.md` | meta — read this skill + linked decision tree |
...
- Tavily MCP server config: `.windsurf/mcp_config.json` → `tavily`
- Auth gate: `.windsurf/scripts/pre_mcp_gate.py::check_tavily_gate`
- Intent detection: `.windsurf/scripts/pre_prompt_classifier.py` (`_TAVILY_SIGNALS`)
...
- Constitutional rule §25 (MCP serialization): `.windsurf/rules/mcp-serialization.md`
