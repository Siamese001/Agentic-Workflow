...
Context7 also maintains a public skill registry at https://context7.com/skills covering library-specific workflows (React best practices, web design, PDF processing, etc.). Those are project-installable via `ctx7` CLI; this Windsurf skill governs the MCP routing layer above them.
