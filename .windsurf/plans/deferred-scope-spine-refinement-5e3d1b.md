...
|----------|------|-----------|
| P1 | GAP-7: Enable D2 by default or add auto-enable logic | W3 learn() is dead code without this |
| P2 | GAP-5: Wire apps_qna product mode into spine | Largest user-facing gap |
| P3 | GAP-6: Add spine envelope inside apps_research | Needed for full audit trail |
