...
| 3.3 | `python -m apps_qna lint <pack-dir>` subcommand | `apps_qna/scripts/lint_pack.py` | Exit non-zero on any violation | ~1K | 🔲 TODO |
| 3.4 | Tests: 6 negative fixtures (each violates one invariant) + 1 positive fixture | `apps_qna/tests/test_validators.py`, `apps_qna/tests/fixtures/invalid_packs/*` | Each validator gets its own red-then-green proof | ~2K | 🔲 TODO |
