...
class BaseRfpEngine(SemanticCacheMixin, EmbeddingMixin, ABC):
    ...
    def __init__(self, config: Any = None, **kwargs: Any) -> None:
        ...
        self._semantic_namespace = "apps_rfp"
        ...
        try:
            from apps_rfp.config.knowledge_base import FROZEN_SNAPSHOT
...
_emit_records_telemetry_event("p4", 'apps_rfp.engines.base_rfp_engine', "module_loaded")
