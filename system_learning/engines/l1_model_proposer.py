...
_CONFIDENCE_DRIFT_THRESHOLD = 0.15  # Drift > 15% triggers recalibration
_MIN_OBSERVATIONS = 5
...
class L1ModelProposer:
    ...
    def propose(
        ...
        # Positive drift (overconfident) → increase temperature
        # Negative drift (underconfident) → decrease temperature
        ...
        return L1ModelChangePackage(
            ...
            new_value=new_temp,
            justification=(
                f"L1 confidence drift {confidence_drift:.3f} exceeds threshold "
                f"{_CONFIDENCE_DRIFT_THRESHOLD}; {direction} temperature from "
