...
_emit_authorize_and_execute("p2", "retrieval_case_embedder", "execution_auth")
_emit_validates_capability("p2", "retrieval_case_embedder", "capability_check")
_emit_routes_to_capability("p2", "retrieval_case_embedder", "capability_route")
_emit_writes_via_uwg("p2", "retrieval_case_embedder", "uwg_write")
_emit_blocks_direct_write("p2", "retrieval_case_embedder", "direct_write_block")
_emit_records_tool_invocation("p2", "retrieval_case_embedder", "tool_invocation")
_emit_captures_execution_output("p2", "retrieval_case_embedder", "exec_output")
_emit_dispatches_agent("p3", "retrieval_case_embedder", "agent_dispatch")
_emit_coordinates_agents("p3", "retrieval_case_embedder", "agent_coordination")
_emit_records_workflow_lineage("p3", "retrieval_case_embedder", "workflow_lineage")
_emit_records_healing_outcome("p3", "retrieval_case_embedder", "healing_outcome")
_emit_escalates_failure("p3", "retrieval_case_embedder", "failure_escalation")
_emit_orchestrates_workflow("p3", "retrieval_case_embedder", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "retrieval_case_embedder", "healing_dispatch")
_emit_invokes_evaluation("p3", "retrieval_case_embedder", "evaluation_signal")
_emit_records_telemetry_event("p4", "retrieval_case_embedder", "telemetry_event")
_emit_captures_evaluation_metric("p4", "retrieval_case_embedder", "eval_metric")
_emit_stores_embedding("p4", "retrieval_case_embedder", "embedding_store")
_emit_updates_meta_learning_state("p4", "retrieval_case_embedder", "meta_learning")
_emit_links_execution_to_snapshot("p4", "retrieval_case_embedder", "exec_snapshot_link")
...
_emit_applies_guardrail("p0", "retrieval_case_embedder", "p0_governance")
...
_emit_emits_metric_event("retrieval_case_embedder", "p4obs", "metric_1")
_emit_emits_metric_event("retrieval_case_embedder", "p4obs", "metric_2")
_emit_emits_metric_event("retrieval_case_embedder", "p4obs", "metric_3")
_emit_emits_metric_event("retrieval_case_embedder", "p4obs", "metric_4")
_emit_emits_metric_event("retrieval_case_embedder", "p4obs", "metric_5")
_emit_emits_metric_event("retrieval_case_embedder", "p4obs", "metric_6")
_emit_records_incident_event("retrieval_case_embedder", "p4obs", "incident")
_emit_captures_runtime_anomaly("retrieval_case_embedder", "p4obs", "anomaly")
_emit_writes_observability_log("retrieval_case_embedder", "p4obs", "obs_log")
_emit_updates_monitoring_state("retrieval_case_embedder", "p4obs", "mon_state")
_emit_triggers_alert("retrieval_case_embedder", "p4obs", "alert")
_emit_links_incident_trace("retrieval_case_embedder", "p4obs", "trace_link")
_emit_captures_pattern("retrieval_case_embedder", "p3lm", "pattern")
_emit_records_learning_event("retrieval_case_embedder", "p3lm", "learning_event")
_emit_writes_learning_snapshot("retrieval_case_embedder", "p3lm", "snapshot")
_emit_feeds_meta_learning("retrieval_case_embedder", "p3lm", "meta_feed")
_emit_updates_routing_strategy("retrieval_case_embedder", "p3lm", "routing")
_emit_improves_agent_policy("retrieval_case_embedder", "p3lm", "policy")
_emit_stores_learning_state("retrieval_case_embedder", "p3lm", "state")
_emit_records_execution_trace("retrieval_case_embedder", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("retrieval_case_embedder", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("retrieval_case_embedder", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("retrieval_case_embedder", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("retrieval_case_embedder", "L4_STATE", "p2_trace_5")
_emit_reads_environ("retrieval_case_embedder", "env_read", "p2_env_1")
_emit_reads_environ("retrieval_case_embedder", "env_read", "p2_env_2")
_emit_reads_runtime_state("retrieval_case_embedder", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("retrieval_case_embedder", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "retrieval_case_embedder", "context_pull")
_emit_pulls_context("p1", "retrieval_case_embedder", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "retrieval_case_embedder", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "retrieval_case_embedder", "uwg_term_2")
_emit_writes_through("p1", "retrieval_case_embedder", "write_through")
_emit_writes_through("p1", "retrieval_case_embedder", "write_through_2")
_emit_validated_by_safety_plane("p1", "retrieval_case_embedder", "safety_validation")
_emit_invokes_eval("p1", "retrieval_case_embedder", "eval_call")
_emit_proposal_commits_routing("p1", "retrieval_case_embedder", "routing_commit")
_emit_escalates_to_human("p1", "retrieval_case_embedder", "human_escalation")
_emit_routes_through("p1", "retrieval_case_embedder", "route_through")
_emit_checks_agent_registry("p1", "retrieval_case_embedder", "agent_registry")
_emit_validates_agent_capability("p1", "retrieval_case_embedder", "capability")
_emit_dispatches_execution_plan("p1", "retrieval_case_embedder", "exec_plan")
_emit_agent_executes_agent("p1", "retrieval_case_embedder", "sub_agent")
_emit_routes_to_agent("p1", "retrieval_case_embedder", "target_agent")
_emit_verifies_policy("p1", "retrieval_case_embedder", "policy_check")
_emit_observes_runtime_state("p1", "retrieval_case_embedder", "runtime_state")
_emit_verifies_boundary("p1", "retrieval_case_embedder", "boundary_check")
_emit_transcripts_response("p1", "retrieval_case_embedder", "transcript")
_emit_hard_fails_untranscripted("p1", "retrieval_case_embedder")
_emit_gated_by_confidence("p1", "retrieval_case_embedder", "confidence_gate")
emit_replay_key("p0", "retrieval_case_embedder")
emit_determinism_digest("p0", "retrieval_case_embedder")
