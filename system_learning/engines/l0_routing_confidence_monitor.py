...
def propose_routing_confidence_change(
    *,
    ...
    # Adjust p10 trigger based on ADG territory score    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context    # guardian: CooldownViolation should be handled with specific context
