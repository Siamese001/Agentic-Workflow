...
class EnhancedRagRetrievalCache:
    ...
    def _get_default_embedding_client(self) -> EmbeddingClient | None:
        ...
        except (EmbeddingDisabledError, NotImplementedError, Exception) as e:    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling    # guardian: Multiple exceptions (EmbeddingDisabledError, NotImplementedError) need specific handling
