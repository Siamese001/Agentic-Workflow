...
class EmbeddingArtifact:
    ...
    def canonical_bytes(self) -> bytes:
        ...
        """
        data = {'namespace': self.namespace, 'seed_index_version_hash': self.seed_index_version_hash, 'supporting_trace_ids': self.supporting_trace_ids, 'supporting_content_hashes': self.supporting_content_hashes, 'k': self.k, 'similarity_metric': self.similarity_metric, 'embedding_model_version': self.embedding_model_version, 'vector_hash': self.vector_hash}
