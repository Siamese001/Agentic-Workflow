...
_FORBIDDEN_LAYER_PREFIXES = ('agentic_core.L0_routing', 'agentic_core.L1_cognition', 'agentic_core.L2_execution', 'agentic_core.L3_orchestration', 'agentic_core.L4_state', 'agentic_core.L5_safety', 'agentic_core.L6_observability')
...
def assert_isolation() -> None:
    ...
    if violations:
        raise RuntimeError(f"system_learning isolation violated: forbidden modules loaded: {violations[:10]}{('...' if len(violations) > 10 else '')}")
