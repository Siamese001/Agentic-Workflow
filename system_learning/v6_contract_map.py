...
``"system_learning.engines.telemetry_consumer"``) rather than class names so
...
_V6_CONTRACT_RAW: tuple[V6PhaseContract, ...] = (
    V6PhaseContract(
        ...
        modules=(
            "system_learning.engines.telemetry_consumer",
            "system_learning.engines.historical_ingestion_orchestrator",
            "system_learning.engines.historical_backfill_engine",
            "system_learning.engines.prompt_execution_tracer",
    ...
    V6PhaseContract(
        ...
        modules=(
            "system_learning.engines.trace_feature_extractor",
            "system_learning.engines.meta_learning_bus",
            "system_learning.engines.prompt_provenance_builder",
    ...
    V6PhaseContract(
        ...
        modules=(
            "system_learning.engines.outcome_evaluation_engine",
    ...
    V6PhaseContract(
        ...
        modules=(
            "system_learning.engines.trajectory_evaluation_engine",
            "system_learning.engines.trajectory_divergence_scorer",
        ),
    ),
    V6PhaseContract(
        phase_id="S2C",
        ...
        modules=(
            "system_learning.engines.g_gate_regression_checker",
            "system_learning.engines.prompt_drift_detector",
            "system_learning.engines.shadow_drift_analyzer",
        ),
    ),
    V6PhaseContract(
        phase_id="S2D",
        ...
        modules=(
            "system_learning.engines.human_calibration_engine",
            "system_learning.engines.hitl_decision_logger",
        ),
    ),
    V6PhaseContract(
        phase_id="S3A",
        ...
        modules=(
            "system_learning.engines.signal_aggregator_engine",
            "system_learning.engines.signal_grouping_engine",
        ),
    ),
    V6PhaseContract(
        phase_id="S3B",
        ...
        modules=(
            "system_learning.engines.rca_engine",
            "system_learning.engines.rca_cluster_engine",
    ...
    V6PhaseContract(
        ...
        modules=(
            "system_learning.engines.rule_drafting_engine",
            "system_learning.engines.l1_model_proposer",
            "system_learning.engines.l5_policy_proposer",
            "system_learning.engines.rag_proposer",
            "system_learning.engines.retrieval_profile_proposal",
        ),
    ),
    V6PhaseContract(
        phase_id="S4A",
        ...
        modules=(
            "system_learning.engines.approval_gauntlet_engine",
            "system_learning.engines.deterministic_replay_engine",
            "system_learning.engines.gauntlet_gate",
            "system_learning.engines.retrieval_profile_replay_check",
        ),
    ),
    V6PhaseContract(
        phase_id="S4B",
        ...
        modules=(
            ...
            "system_learning.engines.eval_freshness_gate",
            "system_learning.engines.eval_gated_l4_writer",
        ),
    ),
    V6PhaseContract(
        phase_id="S4C",
        ...
        modules=(
            "system_learning.engines.l4_state_writer",
            "system_learning.engines.l4_audit_reader",
            "system_learning.engines.l4_version_store",
        ),
    ),
    V6PhaseContract(
        phase_id="S4D",
        ...
        modules=(
            "system_learning.engines.meta_learning_replay_binding",
            "system_learning.engines.meta_learning_state_digest",
            "system_learning.engines.faiss_startup_integrity",
        ),
    ),
)
