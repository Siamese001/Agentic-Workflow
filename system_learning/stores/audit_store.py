        ...
        for report_path in sorted(self._reports_dir.glob("*.json")):
            try:
                ...
                if window_start_utc <= ts <= window_end_utc:
                    ...
                    matched.append(data)
            except (json.JSONDecodeError, OSError) as exc:    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
