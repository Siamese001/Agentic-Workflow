...
class SystemLearningStateManager:
    ...
    async def _cache_snapshot(
        ...
        except (  # guardian: allow-log-and-swallow -- snapshot cache best-effort: non-fatal, authoritative snapshot already persisted
            AttributeError,
            RuntimeError,
            TypeError,
            ValueError,
    ...
    async def _get_cached_snapshot(
        ...
        except (  # guardian: allow-return-none-swallow -- cached snapshot read: non-fatal, caller falls back to authoritative store
            AttributeError,
            KeyError,
            RuntimeError,
            TypeError,
