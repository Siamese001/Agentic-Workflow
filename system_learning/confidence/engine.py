...
class HealingConfidenceScorer:
    ...
    def score(self, attempts: Sequence[HealingAttempt]) -> HealingConfidenceReport:
        ...
        for attempt in sorted_attempts:
            ...
            decisions.append(ConfidenceDecision(attempt_id=attempt.attempt_id, confidence=confidence, action=action))
        canonical_data = {'decisions': [{'attempt_id': d.attempt_id, 'confidence': d.confidence, 'action': d.action} for d in decisions]}
