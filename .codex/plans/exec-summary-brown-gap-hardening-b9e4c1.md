...
PLAN_CREATED: slug=exec-summary-brown-gap-hardening-b9e4c1 path=.codex/plans/exec-summary-brown-gap-hardening-b9e4c1.md status=Completed notion=36d27693-f55c-81ab-879e-def5569f1007
...
|-------|-------|---------------|-------------|-------------|--------|
| W0.1 | Register plan (Notion + `PLAN_CREATED`) | `.codex/plans/`, Notion Plans | — | ~8K | ✅ DONE |
...
**Acceptance**
- [x] [`.codex/plans/exec-summary-brown-gap-hardening-b9e4c1.md`](exec-summary-brown-gap-hardening-b9e4c1.md) on disk.
- [x] Notion Plans row: `Status=Completed`, `Exists On Disk=true`, `Plan File Path=.codex/plans/exec-summary-brown-gap-hardening-b9e4c1.md` — [Notion page](https://www.notion.so/exec-summary-brown-gap-hardening-b9e4c1-36d27693f55c81ab879edef5569f1007) (`36d27693-f55c-81ab-879e-def5569f1007`).
...
```
PLAN_CREATED: slug=exec-summary-brown-gap-hardening-b9e4c1 path=.codex/plans/exec-summary-brown-gap-hardening-b9e4c1.md status=Completed
