...
PLAN_CREATED: slug=governance-dedup-closeout-e8a4c2 path=.codex/plans/governance-dedup-closeout-e8a4c2.md status=Not Started
...
| W3.2 | Move completed plans to `.codex/plans/_archive/` | ✅ DONE |
...
- **W3.2** — 76 plans moved to `.codex/plans/_archive/2026-05/`; registration cache refreshed | ~4k | PHASE_STATUS: DONE
...
- Evidence: `.codex/plans/governance-dedup-closeout-e8a4c2.md`; audit §6 updated; Notion Completed via wave-exec
- Status: PASS
