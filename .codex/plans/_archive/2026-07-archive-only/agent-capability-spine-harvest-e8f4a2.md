...
PLAN_CREATED: slug=agent-capability-spine-harvest-e8f4a2 path=.codex/plans/agent-capability-spine-harvest-e8f4a2.md status=Not Started notion_page=36b27693-f55c-8175-b7ee-c1042f686bdf
...
```bash
git diff -- .codex/plans/agent-capability-spine-harvest-e8f4a2.md
```
