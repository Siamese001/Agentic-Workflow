...
> **Related:** [qwen-vllm-topology.md](docs/architecture/qwen-vllm-topology.md), [local-llm-wsl2-gpu.mdc](.codex/rules/local-llm-wsl2-gpu.mdc), [exec-summary-qwen-regen-token-budget-c4e8a1.md](exec-summary-qwen-regen-token-budget-c4e8a1.md) (completed)
...
- Evidence: diff in `docs/architecture/qwen-vllm-topology.md`, `.codex/rules/local-llm-wsl2-gpu.mdc`
- Status: TODO
...
```
PLAN_CREATED: slug=qwen3-32b-vllm-upgrade-d7a3f1 path=.codex/plans/qwen3-32b-vllm-upgrade-d7a3f1.md status=Lower Priority
