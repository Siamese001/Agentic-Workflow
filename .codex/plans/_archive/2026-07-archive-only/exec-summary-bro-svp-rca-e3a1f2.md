...
PLAN_CREATED: slug=exec-summary-bro-svp-rca-e3a1f2 path=.codex/plans/exec-summary-bro-svp-rca-e3a1f2.md status=Not Started notion=36d27693-f55c-8139-aaa6-da41e0c3dca8
...
|-------|-------|---------------|-------------|--------|
| W0.1 | Register plan (disk + Notion) | `.codex/plans/`, Notion Plans DB | ~6K | ✅ Done |
