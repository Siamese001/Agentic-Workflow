...
_REMEDY = (
    ...
    ".codex/rules/001-runtime-seam-execution.md § Runtime failure ⇒ RCA mandatory; "
    "constitutional §37."
)
...
_MISSING_FLOOR_REMEDY = (
    ...
    ".codex/rules/001-runtime-seam-execution.md § Canonical post-turn output; § Response floor."
)
...
_PASS_PROOF_REMEDY = (
    ...
    ".codex/rules/002-pass-blocked-proof-contract.md § PASS is expensive."
)
_SPECULATIVE_REMEDY = (
    ...
    "SSOT: .codex/rules/002-pass-blocked-proof-contract.md § Forbidden status behavior."
)
_PLAN_WAVES_REMEDY = (
    ...
    "file's disk-side status table. SSOT: .codex/rules/001-runtime-seam-execution.md § Response floor."
)
