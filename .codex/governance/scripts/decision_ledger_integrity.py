...
USAGE AS CLI
------------
    python .codex/governance/scripts/author_gate_ledger_integrity.py --verify
    python .codex/governance/scripts/author_gate_ledger_integrity.py --backfill
    python .codex/governance/scripts/author_gate_ledger_integrity.py --report
