...
Usage:
    python .codex/governance/scripts/mcp_fleet_health.py
    python .codex/governance/scripts/mcp_fleet_health.py --json   (machine-readable)
    python .codex/governance/scripts/mcp_fleet_health.py --quiet  (exit code only)
"""
