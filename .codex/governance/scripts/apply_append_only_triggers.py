...
Usage:
    python .codex/governance/scripts/apply_append_only_triggers.py           # apply to all
    python .codex/governance/scripts/apply_append_only_triggers.py --check   # verify without changes
    python .codex/governance/scripts/apply_append_only_triggers.py --db <path>  # single DB
...
AUTHOR_GATE_DB = REPO_ROOT / ".codex" / "state" / "refactor_decisions" / "refactor_decision_ledger.sqlite"
