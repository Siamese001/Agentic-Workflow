...
def scan_skills() -> List[Dict]:
    """Scan .codex/skills/*/SKILL.md and extract metadata."""
    skills = []
...
def scan_hooks() -> Optional[Dict]:
    """Scan .codex/hooks.json and extract counts."""
...
def generate_index(rules: List[Dict], skills: List[Dict], workflows: List[Dict], hooks: Optional[Dict]) -> str:
    ...
    lines.append("")
    lines.append("This file is auto-generated by `.codex/governance/scripts/generate_rules_index.py`.")
