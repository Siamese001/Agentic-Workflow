...
Currently installs:
    - post-commit: invokes .codex/governance/scripts/post_commit_outcome_binder.py --head

Idempotent: re-running refreshes the hook to latest content.

Usage:
    python .codex/governance/scripts/install_git_hooks.py           # install
    python .codex/governance/scripts/install_git_hooks.py --check   # verify installed
    python .codex/governance/scripts/install_git_hooks.py --uninstall
...
{MARKER}
# Installed by .codex/governance/scripts/install_git_hooks.py
...
set +e
python .codex/governance/scripts/post_commit_outcome_binder.py --head >/dev/null 2>&1 &
