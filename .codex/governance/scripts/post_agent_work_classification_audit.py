        ...
        if wave_count is not None:
            _append_violation({
                ...
                "remedy": (
                    ...
                    "plan mode persists nothing durable. Rule: .codex/rules/work-item-classification.md"
                ),
            })
            print(
                ...
                "See .codex/rules/work-item-classification.md",
                file=sys.stderr,
            )
            ...
            if m:
                ...
                violation = {
                    ...
                    "remedy": (
                        ...
                        "Rule: .codex/rules/work-item-classification.md"
                    ),
                }
                ...
                print(
                    ...
                    f"matched {m.group()!r}. "
                    "Classify work first; see .codex/rules/work-item-classification.md",
                    file=sys.stderr,
                )
