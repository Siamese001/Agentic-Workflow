...
``.codex/governance/scripts/post_agent_runtime_rca_audit.py`` so the contract stays SSOT;
...
from lib.codex_hook_common import allow, block, read_payload, resolve_response_text, warn, write_receipt

_REPO_ROOT = Path(__file__).resolve().parents[2]  # .codex/hooks/<this> -> repo root
...
_BLOCK_REASON = (
    ...
    "SSOT: .codex/rules/001-runtime-seam-execution.md § Runtime failure ⇒ RCA mandatory; "
    "constitutional §37.\n"
