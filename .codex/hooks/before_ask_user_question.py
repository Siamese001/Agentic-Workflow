...
# This hook is self-contained by design (no lib.codex_hook_common import — absent in some
# checkouts), so it writes the fail-open ledger inline rather than via write_failopen_receipt.
# Schema matches lib.codex_hook_common.write_failopen_receipt so the budget gate reads both.
