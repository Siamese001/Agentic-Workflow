...
# L4 Components
from agentic_core.l4_memory_state.temporal.triplet_store import (
    TripletStore,
    TripletQuery,
    TripletStatus,
    create_triplet,
...
# L3 Components
from agentic_core.l3_orchestration.kg_retrieval_orchestration import (
...
class TestKGRetrievalExecutor:
    ...
    def test_execute_multi_hop(self):
        ...
        from agentic_core.l2_execution.engines.outreach.lic_kg_retrieval_executor import execute_multi_hop_query
