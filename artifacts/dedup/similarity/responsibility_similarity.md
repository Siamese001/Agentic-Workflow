...
| Agent A | Agent B | Overlap | Shared Keywords |
|---------|---------|---------|----------------|
| HistorianAgent | DynamicSealAgent | 1.000 | validation |
...
| FactCheckAgent | SectionBalanceAgent | 1.000 | checks |
| MetaLearningAgent | TelemetryAgent | 0.667 | observability, telemetry |
| SystemArchitectAgent | CampaignBalanceAgent | 0.667 | structure, validates |
| BudgetAgent | TypeMechanicAgent | 0.600 | code, enforcement, validates |
