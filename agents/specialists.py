...
class PlannerAgent(BaseAgent):
    ...
    def _generate_plan(self, objective: str, context: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if "refactor" in objective.lower():
            return [
                {"step": 1, "action": "analyze_current_code", "description": "Analyze existing code structure"},
                {"step": 2, "action": "identify_refactor_opportunities", "description": "Identify areas for improvement"},
                {"step": 3, "action": "create_refactor_plan", "description": "Create detailed refactor plan"},
                {"step": 4, "action": "implement_changes", "description": "Implement refactor changes"},
                {"step": 5, "action": "validate_changes", "description": "Validate and test changes"}
            ]
        
        elif "implement" in objective.lower():
            return [
                {"step": 1, "action": "define_requirements", "description": "Define clear requirements"},
                {"step": 2, "action": "design_solution", "description": "Design the solution architecture"},
                {"step": 3, "action": "implement_core", "description": "Implement core functionality"},
                {"step": 4, "action": "add_tests", "description": "Add comprehensive tests"},
                {"step": 5, "action": "document_solution", "description": "Document the implementation"}
            ]
        
        else:
            # Generic plan
            return [
                {"step": 1, "action": "understand_requirements", "description": "Understand and clarify requirements"},
                {"step": 2, "action": "design_approach", "description": "Design the approach"},
                {"step": 3, "action": "implement_solution", "description": "Implement the solution"},
                {"step": 4, "action": "test_and_validate", "description": "Test and validate the solution"}
            ]
...
class CoderAgent(BaseAgent):
    ...
    def _execute_task(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(f"Coding agent implementing: {spec.get('description', 'unnamed task')}")
...
class AuditorAgent(BaseAgent):
    ...
    def _execute_task(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        validation_result = self._validate_code(code, language, validation_type)
    ...
    def _validate_canon_rules(self, code: str) -> Dict[str, Any]:
        ...
        for rule in self.validation_rules:
            if not self._check_rule(code, rule):
                violations.append(f"Canon rule violation: {rule['description']}")
