...
class ThermalProfile(str, Enum):
    ...
    CREATIVITY_MAX = "creativity_max"      # Temp 0.9, top_p 0.95 - Brainstorming
    CREATIVITY_HIGH = "creativity_high"    # Temp 0.8, top_p 0.90 - Ideation
    BALANCED = "balanced"                  # Temp 0.7, top_p 0.85 - General
    STRUCTURED = "structured"              # Temp 0.3, top_p 0.70 - Formatting
    PRECISION = "precision"                # Temp 0.1, top_p 0.50 - Validation
