"""
Check Schema Safety package initialization.

Provides core functionality and exports for the Check Schema Safety module.
"""
...
__description__: str = "Core Check Schema Safety functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Check Schema Safety instance with config: {final_config}")
    return final_config
