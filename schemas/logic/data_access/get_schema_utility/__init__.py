"""
Get Schema helper package initialization.

Provides core functionality and exports for the Get Schema helper module.
"""
...
__description__: str = "Core Get Schema helper functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Get Schema helper instance with config: {final_config}")
    return final_config
