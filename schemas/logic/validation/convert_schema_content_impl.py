...
# Dummy classes/types to make the code runnable for syntax checking
class ProcessingResult:
    def __init__(self, success: bool, DATA: Any = None, error_message: str = None, execution_context: Any = None, additional_info: Dict = None):
