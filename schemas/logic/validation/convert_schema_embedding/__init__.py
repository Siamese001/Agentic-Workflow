"""
Convert Schema Embedding package initialization.

Provides core functionality and exports for the Convert Schema Embedding module.
"""
...
__description__: str = "Core Convert Schema Embedding functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Convert Schema Embedding instance with config: {final_config}")
    return final_config
