"""
Pick Best Refinement package initialization.

Provides core functionality and exports for the Pick Best Refinement module.
"""
...
__description__: str = "Core Pick Best Refinement functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Pick Best Refinement instance with config: {final_config}")
    return final_config
