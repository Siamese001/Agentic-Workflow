"""
Use Schema Retry package initialization.

Provides core functionality and exports for the Use Schema Retry module.
"""
...
__description__: str = "Core Use Schema Retry functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Use Schema Retry instance with config: {final_config}")
    return final_config
