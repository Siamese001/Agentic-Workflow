...
class ResumeResearchWorkflow:
    ...
    def _perform_thematic_analysis(self, job_description: str,
        ...
        try:
            ...
            self.engine_adapter.process(LLMRequest(
    ...
    def _extract_skills(self, text: str, required: bool = True) -> List[str]:
        ...
        skill_patterns = [
            (r'\b(?:Python|Java|JavaScript|TypeScript|React|Angular|Vue|Node\.js|Django|Flask|Spring|'
             r'\.NET|SQL|NoSQL|MongoDB|PostgreSQL|MySQL|AWS|Azure|GCP|Docker|Kubernetes|Git|CI/CD|'
             r'Agile|Scrum|REST|GraphQL|Microservices|Machine Learning|AI|Data Science|Analytics|'
             r'DevOps|Security|Testing|Unit Testing|Integration Testing)\b'),
