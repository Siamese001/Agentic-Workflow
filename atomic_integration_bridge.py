...
class AtomicWorkflowBridge:
    ...
    def __init__(self, routing_policy: RoutingPolicy, sandbox: SandboxConfig):
        ...
        # Create L3 orchestrator with injected L4/L5 dependencies
        self.unified_orchestrator = UnifiedWorkflowOrchestrator(
            routing_policy, sandbox, state_manager, safety_validator
        )
...
class AtomicStrategyAgent:
    ...
    def __init__(self, routing_policy: RoutingPolicy, sandbox: SandboxConfig):
        self.bridge = AtomicWorkflowBridge(routing_policy, sandbox)
