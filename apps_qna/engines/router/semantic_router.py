...
sibling module ``apps_qna.engines.router.route_seeding`` already embedded routes via
...
from apps_qna.engines.router.route_seeding import build_route_descriptor
