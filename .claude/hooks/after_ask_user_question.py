...
``.claude/governance/scripts/post_ask_user_question_capture.py`` (the testable SSOT), which
...
Self-contained on purpose — no dependency on ``lib.claude_hook_common``. PostToolUse never
