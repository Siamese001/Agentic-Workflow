...
<!-- Converted from `.claude/rules/query-progress-bar.md`. Original Cursor trigger: `model_decision`. -->
...
- **Skill**: `.claude/skills/artifact-management/progress_display_protocol.md`
- **Workflow**: `.claude/commands/progress-display-enforcement.md`
