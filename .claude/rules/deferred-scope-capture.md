...
<!-- Converted from `.claude/rules/deferred-scope-capture.md`. Original Cursor trigger: `model_decision`. -->
...
§24 (Deferred-scope capture mandatory). Sibling rule `.claude/rules/next-step-capture.md` covers `NEXT_STEP:` markers (P2..P5; voluntary follow-ups).
