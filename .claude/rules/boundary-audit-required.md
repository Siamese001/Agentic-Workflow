...
<!-- Converted from `.claude/rules/boundary-audit-required.md`. Original Cursor trigger: `model_decision`. -->
...
- `.claude/rules/agentic-core-static.md` — Core law
- `.claude/rules/agentic-core-glob-lock.md` — Editing guard
