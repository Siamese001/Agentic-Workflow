-- =====================================================================
-- Router L2/cursor_agent Ledger — extends ledger_base.schema.sql
-- =====================================================================
...
--
-- See plan: .cursor/plans/l2-cursor_agent-router-closed-loop-wiring-c4d8a1.md
-- See rule: .cursor/rules/closed-loop-router-enforcement.md (row #4)
--
-- event_kind values:
...
--     "cost_demoted":    bool,
--     "fingerprint":     "<sha256-12hex>",     -- per cursor_agent_calibrator.fingerprint
...
--     "tier_used":         "HIGH"|"MEDIUM"|"LOW",       -- differs on cursor_agent fallback
...
-- Indexes specific to L2/cursor_agent router queries
CREATE INDEX IF NOT EXISTS idx_router_l2_cursor_agent_kind_band
...
CREATE INDEX IF NOT EXISTS idx_router_l2_cursor_agent_status_kind
...
VALUES (110, strftime('%Y-%m-%dT%H:%M:%SZ','now'),
        'router_l2_cursor_agent: HealingRouter closed-loop §29 ledger v1');
