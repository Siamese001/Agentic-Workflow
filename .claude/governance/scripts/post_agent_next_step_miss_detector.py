#!/usr/bin/env python3
"""
post_agent_next_step_miss_detector.py — Retroactive NEXT_STEP miss audit.

Hooks post_agent_response. Scans the response for prose that suggests
...
This is the sibling of ``post_agent_author_gate_miss_detector.py``:
