...
Usage:
    python .claude/governance/scripts/mcp_fleet_health.py
    python .claude/governance/scripts/mcp_fleet_health.py --json   (machine-readable)
    python .claude/governance/scripts/mcp_fleet_health.py --quiet  (exit code only)
"""
