...
Usage:
    python .claude/governance/scripts/install_git_hooks.py           # install
    python .claude/governance/scripts/install_git_hooks.py --check   # verify installed
    python .claude/governance/scripts/install_git_hooks.py --uninstall
...
{MARKER}
# Installed by .claude/governance/scripts/install_git_hooks.py
...
set +e
python .claude/governance/scripts/post_commit_outcome_binder.py --head >/dev/null 2>&1 &
