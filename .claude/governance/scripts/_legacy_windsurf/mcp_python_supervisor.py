...
*respawns* them using the argv and env declared in `.windsurf/mcp_config.json`.
...
4. **Never fights Windsurf.** When Windsurf respawns a server itself, the
...
Usage::
    ...
    MCP_SUPERVISOR_ENABLED=1 python .windsurf/scripts/mcp_python_supervisor.py
    python .windsurf/scripts/mcp_python_supervisor.py --dry-run
    python .windsurf/scripts/mcp_python_supervisor.py --json --min-interval 60
