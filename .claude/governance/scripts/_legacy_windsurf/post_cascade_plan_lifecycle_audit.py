#!/usr/bin/env python3
"""
post_cascade_plan_lifecycle_audit.py — Unified Plan Lifecycle audit hook (W2.P3).

Consolidates 5 Plan Lifecycle hooks into a single hook with subcommands:
- creation: Plan creation audit with auto-correction (from post_cascade_plan_creation_audit)
- scope: Plan scope authorization audit (from post_cascade_plan_scope_audit)
- complete: Plan completion marker audit (from post_cascade_plan_complete_audit)
- duplicate: Duplicate plan POST detection (from post_cascade_plans_dup_audit)
- evidence: Graph-layer evidence gate (from post_cascade_plan_evidence_gate)
...
# =============================================================================
# SUBCOMMAND: creation (from post_cascade_plan_creation_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: scope (from post_cascade_plan_scope_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: complete (from post_cascade_plan_complete_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: duplicate (from post_cascade_plans_dup_audit.py)
# =============================================================================
...
# =============================================================================
# SUBCOMMAND: evidence (from post_cascade_plan_evidence_gate.py)
# =============================================================================
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="post_cascade_plan_lifecycle_audit",
