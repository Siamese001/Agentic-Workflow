...
USAGE
    python .claude/governance/scripts/audit_ledger_coverage.py              # prose report, exit 0/1/2
    python .claude/governance/scripts/audit_ledger_coverage.py --json       # JSON for CI parsing
    python .claude/governance/scripts/audit_ledger_coverage.py --ci         # machine-readable, exit 2 on FAIL only
