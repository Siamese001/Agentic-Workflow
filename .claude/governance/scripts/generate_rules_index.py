...
def scan_rules() -> List[Dict]:
    """Scan .claude/rules/*.mdc (and legacy *.md) and extract metadata."""
    rules = []
...
def scan_skills() -> List[Dict]:
    """Scan .claude/skills/*/SKILL.md and extract metadata."""
    skills = []
...
def generate_index(rules: List[Dict], skills: List[Dict], workflows: List[Dict], hooks: Optional[Dict]) -> str:
    ...
    lines.append("")
    lines.append("This file is auto-generated by `.claude/governance/scripts/generate_rules_index.py`.")
