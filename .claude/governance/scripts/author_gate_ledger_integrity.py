...
USAGE AS CLI
------------
    python .claude/governance/scripts/author_gate_ledger_integrity.py --verify
    python .claude/governance/scripts/author_gate_ledger_integrity.py --backfill
    python .claude/governance/scripts/author_gate_ledger_integrity.py --report
