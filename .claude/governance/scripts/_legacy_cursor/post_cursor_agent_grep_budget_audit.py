"""post_cursor_agent_grep_budget_audit.py — advisory grep/code_search budget cap.
...
the soft cap. This exists because:
  ...
  3. Advisory-only: this hook NEVER blocks; it logs. Deterministic-but-soft,
     mirroring `post_cursor_agent_adg_audit.py`.
...
Violations log: `artifacts/cursor/grep_budget_violations.jsonl`
"""
...
# detection shape as post_cursor_agent_adg_audit.py.
