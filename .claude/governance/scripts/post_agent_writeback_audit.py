#!/usr/bin/env python3
"""
post_agent_writeback_audit.py — Windsurf post_agent_response writeback discipline audit.
...
Policy SSOT: .claude/rules/memory-notion-writeback.md
Entity/row templates: .claude/skills/writeback-discipline/
