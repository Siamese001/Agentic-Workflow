#!/usr/bin/env python3
"""
post_agent_deferred_scope_capture.py — Windsurf post_agent_response hook.
...
def _read_stdin_response() -> str:
    ...
    # (documented Windsurf post_agent_response shape).
...
def main() -> int:
    ...
    if sys.stdin.isatty():
        print(
            ...
            "exiting 0. This script is a post_agent_response hook and "
