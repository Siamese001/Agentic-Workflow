#!/usr/bin/env python3
"""post_agent_next_step_capture.py — Windsurf post_agent_response hook.

Sibling to post_agent_deferred_scope_capture.py. Parses `NEXT_STEP:`
...
def _read_stdin_response() -> str:
    ...
    try:
        ...
        from _post_agent_payload import extract_response_text  # noqa: PLC0415
...
def main() -> int:
    ...
    if sys.stdin.isatty():
        print(
            ...
            "This script is a post_agent_response hook.",
            file=sys.stderr,
        )
        return 0
