...
Usage::
    ...
    MCP_SUPERVISOR_ENABLED=1 python .claude/governance/scripts/mcp_python_supervisor.py
    python .claude/governance/scripts/mcp_python_supervisor.py --dry-run
    python .claude/governance/scripts/mcp_python_supervisor.py --json --min-interval 60
