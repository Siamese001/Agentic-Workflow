#!/usr/bin/env python3
"""
post_agent_author_gate_ui_audit.py — Windsurf post_agent_response UI conformance audit.
...
The hook reads the response payload from stdin in the Windsurf post_agent_response
...
def _read_stdin_text() -> str:
    ...
    if not raw.strip():
        return ""
    # Windsurf post_agent_response delivers a JSON payload; grab text fields
    try:
