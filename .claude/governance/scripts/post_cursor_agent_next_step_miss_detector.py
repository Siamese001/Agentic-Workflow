#!/usr/bin/env python3
"""
post_cursor_agent_next_step_miss_detector.py — Retroactive NEXT_STEP miss audit.

Hooks post_cursor_agent_response. Scans the response for prose that suggests
...
This is the sibling of ``post_cursor_agent_author_gate_miss_detector.py``:
