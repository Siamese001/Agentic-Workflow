...
class ComputeDataEmbeddingsPlanInterface:
    ...
    def __init__(self, engine: ComputeDataEmbeddingsPlanProcessor):
...
class ComputeDataEmbeddingsPlanFactory:
    ...
    def create_processor(safety_level: str = "strict") -> ComputeDataEmbeddingsPlanInterface:
        ...
        engine = ComputeDataEmbeddingsPlanImpl(constraints)
        return ComputeDataEmbeddingsPlanInterface(engine)
...
def compute_data_embeddings(input_data: Dict[str, object]) -> Dict[str, object]:
    ...
    """
    builder = ComputeDataEmbeddingsPlanFactory()
