...
"
  ...
  tools\run_static_invariants.py:86 - PS_STRING_LITERAL - "1. Scanning for PowerShell usage..."
  tools\run_static_invariants.py:88 - PS_STRING_LITERAL - "PowerShell Ban"

2. Scanning for direct file writes...
FAIL: Write Gateway Enforcement: 191 violations found:
