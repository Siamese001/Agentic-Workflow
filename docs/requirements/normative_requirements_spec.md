...
| Source | Relation |
|--------|---------|
| `.codex/rules/constitutional.md` | Supersedes these requirements where they conflict |
...
- Constitutional hard constraints — per `.codex/rules/constitutional.md`
...
- `.codex/rules/constitutional.md` — constitutional floor (supersedes this document on conflict)
- `.codex/plans/wave_c_plan.md` — Wave C execution plan
