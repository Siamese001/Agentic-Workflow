...
See [ADR-079](../architecture/adr/ADR-079-adg-pipeline-three-bucket-opt-in.md) and plan [adg-three-bucket-pipeline-redesign-c8e4f1.md](../../.cursor/plans/adg-three-bucket-pipeline-redesign-c8e4f1.md).
