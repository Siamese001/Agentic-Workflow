...
| L5 | 17 | `ADG::Symbol::agentic_core.L5_safety.enforcement.ingress_envelope_check.IngressEnvelopeCheck` | `agentic_core/L5_safety/enforcement/ingress_envelope_check.py` |
