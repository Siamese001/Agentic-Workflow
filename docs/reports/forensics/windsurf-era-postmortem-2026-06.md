...
| Claude Code era | 2026-06-07 → | `.codex` SSOT migration; cursor decommissioned in ~1 day; operating-model review 2026-06-10 |
...
| May–Jun 2026 | PA contracts, canonical dispatch, Claude Code operating model | `apps_rg_pa_prompt_contract.md`; `apps_rg/AGENTIC_SPINE.md`; `apps_rg_canonical_runtime_boundary.md`; `.codex/rules/apps-rg-execution-bias.md` | App prompts live in app domain; core owns contracts; product proof is executable path | 102 DOCX window, then certification ice | Plan minting blocked; DOCX-in-hand becomes only success metric |
