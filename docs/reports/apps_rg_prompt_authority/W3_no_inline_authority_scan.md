...
| Path | Notes |
|------|--------|
| `apps_rg/runtime/dispatch/competencies_dispatch.py` | Primary inline prompt assembly for competencies lane |
...
| `apps_rg/runtime/dispatch/ibm_bullets_dispatch.py` | Primary inline prompt assembly IBM bullets |
