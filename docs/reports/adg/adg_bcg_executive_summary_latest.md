...
| What blocks merge? | 3 P0 wave file row(s): agentic_core/L1_cognition/__init__.py, agentic_core/L1_cognition/apps_research_c0_binding.py, agentic_core/L1_cognition/apps_research_l1_binding.py. Live P0 gate drivers=0; top red FIX gate=H1_new_orphans_delta_ratchet; rows=1. |
...
| Metric | Value |
|---|---|
| Run ID | 07022026_2303 |
| Snapshot | 2026-07-03T03:17:52.441617+00:00 |
| SQLite snapshot | artifacts/adg/adg_indexed_07022026_2303.sqlite |
