...
| 6 | Burn down ratchet G_REACH_l0_reachability. Burn down the ratchet after the current red gates clear. | 1,453 floor-row(s) remain on the ratchet gate. | Rerun ADG and confirm the relevant gate/test/report status is green or explicitly waived. |
...
| Metric | Value |
|---|---|
| Run ID | 07062026_0048 |
| Snapshot | 2026-07-06T04:53:18.136776+00:00 |
| SQLite snapshot | artifacts/adg/adg_indexed_07062026_0048.sqlite |
