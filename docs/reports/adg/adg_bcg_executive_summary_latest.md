...
| What blocks merge? | 1 P0 blocker row(s); 3 candidate-blocker row(s): G_REACH_l0_reachability, agentic_core/L1_cognition/bridges/u0_to_l1_planning.py, agentic_core/L1_cognition/c0_context/__init__.py, +1 more. Live blocker drivers=1; top red FIX gate=G_REACH_l0_reachability; rows=1,453. |
...
| Merge decision | 1 P0 blocker row(s); 3 candidate-blocker row(s): G_REACH_l0_reachability, agentic_core/L1_cognition/bridges/u0_to_l1_planning.py, agentic_core/L1_cognition/c0_context/__init__.py, +1 more. Live blocker drivers=1; top red FIX gate=G_REACH_l0_reachability; rows=1,453. | What blocks merge? | Resolve before lower-severity ranking. |
...
| Metric | Value |
|---|---|
| Run ID | 07122026_0907 |
| Snapshot | 2026-07-12T13:13:51.912301+00:00 |
| SQLite snapshot | artifacts/adg/adg_indexed_07122026_0907.sqlite |
...
| Top FIX gate | G_REACH_l0_reachability; rows=1,453 |
| Action rows | 5 |
| Decision ledgers | foundation candidate inventory=200; critical audit net=11; live blocker drivers=1 |
...
|---|---|---|---|---|---|---|
| P0 | critical | 43 | 32 | 11 | 200 | 1 |
| P1 | high | 1,143 | 1,143 | 0 | n/a | 0 |
| P2 | medium | 731 | 697 | 34 | n/a | 0 |
| P3 | low | 19,562 | 87 | 19,475 | n/a | 0 |
