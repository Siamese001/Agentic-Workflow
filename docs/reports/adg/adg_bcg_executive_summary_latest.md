...
| Merge decision | 3 P0 wave file row(s): agentic_core/L1_cognition/__init__.py, agentic_core/L1_cognition/apps_research_c0_binding.py, agentic_core/L1_cognition/apps_research_l1_binding.py. Live P0 gate drivers=0; top red FIX gate=none. | What blocks merge? | Resolve before lower-severity ranking. |
| Merge decision | Clear P0 foundation wave. Burn down the listed P0 rows first, then rerun ADG before ranking P1-P3. | First engineering move | Resolve before lower-severity ranking. |
