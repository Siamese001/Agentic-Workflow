...
| 6 | Burn down ratchet C3_silent_writes_ratchet. Burn down the ratchet after the current red gates clear. | 2,063 floor-row(s) remain on the ratchet gate. | Rerun ADG and confirm the relevant gate/test/report status is green or explicitly waived. |
...
| Metric | Value |
|---|---|
| Run ID | 07052026_0127 |
| Snapshot | 2026-07-05T05:37:33.314299+00:00 |
| SQLite snapshot | artifacts/adg/adg_indexed_07052026_0127.sqlite |
