...
- **Generated:** 2026-05-25T09:41:15+00:00
- **Gate-results source:** `artifacts\adg\adg_gate_results_20260525_083528.json`
- **Burndown source:** `artifacts\adg\adg_burndown_table.json`
- **Snapshot timestamp:** 2026-05-25T08:35:28.501455+00:00
- **Total gates:** 48
...
|------|-------|------:|---------:|----:|-------------:|
| P0 | layer_violations | 63 | 38 | 25 | +38 |
| P1 | anti_patterns_high | 1198 | 1101 | 97 | +1101 |
| P2 | anti_patterns_medium | 659 | 656 | 3 | +656 |
| P3 | style_warnings | 18241 | 44 | 18197 | +44 |
...
|---------|:----:|:---:|:------:|-----------:|-------------|
| `G_REACH_l0_reachability` | P0 | ratchet | REGR | 2791 | Graph Reach (auto-derived) |
...
| `3_write_sovereignty` | P0 | block | PASS | 847 | Every state mutation flows through UWG; no direct infra writes from apps_*. |
...
| `S2_uwg_bypass_ratchet` | P0 | ratchet | PASS | 1599 | Uwg Bypass Ratchet (auto-derived) |
...
| `H1_new_orphans_delta_ratchet` | P1 | ratchet | REGR | 14 | New Orphans Delta (auto-derived) |
...
| `8_trace_replay_eval` | P1 | ratchet | PASS | 0 | Trace Replay Eval (auto-derived) |
| `B2_layer_skip_ratchet` | P1 | ratchet | PASS | 893 | Layer Skip (auto-derived) |
| `C3_silent_writes_ratchet` | P1 | ratchet | PASS | 1927 | Silent Writes (auto-derived) |
...
| `O_tool_call_parity_ratchet` | P1 | ratchet | PASS | 310 | Tool Call Parity (auto-derived) |
...
| `I2_replay_surface_gaps_ratchet` | P2 | ratchet | PASS | 1053 | Replay Surface Gaps (auto-derived) |
...
| `Q2_cyclomatic_complexity_ratchet` | P3 | ratchet | PASS | 907 | Cyclomatic Ceiling (auto-derived) |
| `S4_unused_imports_ratchet` | P3 | ratchet | PASS | 10694 | Unused Imports Ratchet (auto-derived) |
...
| ratchet_regressed | 2 | Ratchet-class gates with NEW violations beyond baseline. |
...
|------|:----:|:---:|-----------:|-------------|
| `G_REACH_l0_reachability` | P0 | ratchet | 2791 | Graph Reach (auto-derived) |
| `H1_new_orphans_delta_ratchet` | P1 | ratchet | 14 | New Orphans Delta (auto-derived) |
