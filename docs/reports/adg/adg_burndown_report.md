...
- **Generated:** 2026-06-13T17:43:15+00:00
- **Gate-results source:** `artifacts\adg\adg_gate_results_20260613_172949.json`
- **Burndown source:** `artifacts\adg\adg_burndown_table.json`
- **Snapshot timestamp:** 2026-06-13T17:29:49.770012+00:00
- **Total gates:** 48
...
|------|:------:|--------:|-----------------|------------|-----------|
| P0 | PASS | 0 | 5 gates / 5,345 rows | green; tracked backlog | work ranked queue; do not treat as new failures |
| P1 | PASS | 0 | 9 gates / 5,970 rows | green; tracked backlog | work ranked queue; do not treat as new failures |
| P2 | PASS | 0 | 3 gates / 2,276 rows | green; tracked backlog | work ranked queue; do not treat as new failures |
| P3 | PASS | 0 | 4 gates / 12,482 rows | green; tracked backlog | work ranked queue; do not treat as new failures |
...
|---------|------:|---------|
| TRACK | 21 | CI passed this gate; rows are backlog — plan hygiene, not a halt. |
...
- **Queue:** `artifacts\adg\adg_action_queue_06132026_1324.json`
- **emit_status:** `ok`
- **degraded:** `False`
