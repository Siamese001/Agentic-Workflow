...
- **Generated**: 2026-07-03T08:15:30.138343+00:00
- **Snapshot**: `adg_indexed_07032026_0358.sqlite`
- **Runtime view present**: True
- **Runtime-attested edges**: 0
- **Runtime proof status**: `view_present_zero_attested`
- **Total edges classified**: 566,821
...
| P3 | **DEAD_PATH** | 241 | 0.04% | Wired in code AND declared in registry, but never traced at runtime. Untested code path or vestigial policy. |
| P3 | **UNOBSERVED_CODE** | 566,558 | 99.95% | Static-only — orphan import, dead code, or never-traced path. |
...
| src | dst | relation |
|---|---|---|
| `<id=8>` | `<id=15019>` | `implements` |
| `<id=8>` | `<id=18466>` | `reads_from` |
| `<id=8>` | `<id=20796>` | `reads_from` |
| `<id=8>` | `<id=28171>` | `exports` |
| `<id=8>` | `<id=28171>` | `reads_from` |
| `<id=8>` | `<id=28182>` | `exports` |
| `<id=8>` | `<id=28182>` | `reads_from` |
| `<id=8>` | `<id=28608>` | `covers` |
| `<id=8>` | `<id=28609>` | `imports` |
| `<id=8>` | `<id=55743>` | `unused_import` |
