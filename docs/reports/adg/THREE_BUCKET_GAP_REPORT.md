...
- **Generated**: 2026-07-04T14:34:34.378824+00:00
- **Snapshot**: `adg_indexed_07042026_1025.sqlite`
- **Runtime view present**: True
- **Runtime-attested edges**: 0
- **Runtime proof status**: `view_present_zero_attested`
- **Total edges classified**: 567,690
...
| P3 | **UNOBSERVED_CODE** | 567,415 | 99.95% | Static-only — orphan import, dead code, or never-traced path. |
...
| src | dst | relation |
|---|---|---|
| `<id=27>` | `<id=187890>` | `references_mcp_server` |
| `<id=27>` | `<id=187891>` | `references_mcp_server` |
| `<id=27>` | `<id=187894>` | `references_mcp_server` |
| `<id=27>` | `<id=187895>` | `references_mcp_server` |
| `<id=28>` | `<id=187891>` | `references_mcp_server` |
| `<id=31>` | `<id=187890>` | `references_mcp_server` |
| `<id=31>` | `<id=187891>` | `references_mcp_server` |
| `<id=31>` | `<id=187894>` | `references_mcp_server` |
| `<id=31>` | `<id=187895>` | `references_mcp_server` |
| `<id=32>` | `<id=187890>` | `references_mcp_server` |

### UNOBSERVED_CODE  (severity P3)

| src | dst | relation |
|---|---|---|
| `<id=7>` | `<id=15057>` | `implements` |
| `<id=7>` | `<id=18507>` | `reads_from` |
| `<id=7>` | `<id=20837>` | `reads_from` |
| `<id=7>` | `<id=28215>` | `exports` |
| `<id=7>` | `<id=28215>` | `reads_from` |
| `<id=7>` | `<id=28226>` | `exports` |
| `<id=7>` | `<id=28226>` | `reads_from` |
| `<id=7>` | `<id=28652>` | `covers` |
| `<id=7>` | `<id=28653>` | `imports` |
| `<id=7>` | `<id=55805>` | `unused_import` |

### CONFIG_BLOAT  (severity P4)

| src | dst | relation |
|---|---|---|
| `<id=187889>` | `<id=187890>` | `MCP_SERVER_DECLARED` |
| `<id=187889>` | `<id=187891>` | `MCP_SERVER_DECLARED` |
| `<id=187889>` | `<id=187892>` | `MCP_SERVER_DECLARED` |
| `<id=187889>` | `<id=187893>` | `MCP_SERVER_DECLARED` |
| `<id=187889>` | `<id=187894>` | `MCP_SERVER_DECLARED` |
| `<id=187889>` | `<id=187895>` | `MCP_SERVER_DECLARED` |
| `<id=187889>` | `<id=187896>` | `MCP_SERVER_DECLARED` |
| `<id=187889>` | `<id=187897>` | `MCP_SERVER_DECLARED` |
| `<id=187889>` | `<id=187898>` | `MCP_SERVER_DECLARED` |
| `<id=187899>` | `<id=187900>` | `AGENT_SPEC_DECLARED` |
