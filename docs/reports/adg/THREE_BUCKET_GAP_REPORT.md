...
- **Generated**: 2026-07-09T02:47:07.983524+00:00
- **Snapshot**: `adg_indexed_07082026_2238.sqlite`
- **Runtime view present**: True
- **Runtime-attested edges**: 0
- **Runtime proof status**: `view_present_zero_attested`
- **Total edges classified**: 510,549
...
| P3 | **UNOBSERVED_CODE** | 510,270 | 99.95% | Static-only — orphan import, dead code, or never-traced path. |
...
| src | dst | relation |
|---|---|---|
| `<id=27>` | `<id=189187>` | `references_mcp_server` |
| `<id=27>` | `<id=189188>` | `references_mcp_server` |
| `<id=27>` | `<id=189191>` | `references_mcp_server` |
| `<id=27>` | `<id=189192>` | `references_mcp_server` |
| `<id=28>` | `<id=189188>` | `references_mcp_server` |
| `<id=31>` | `<id=189187>` | `references_mcp_server` |
| `<id=31>` | `<id=189188>` | `references_mcp_server` |
| `<id=31>` | `<id=189191>` | `references_mcp_server` |
| `<id=31>` | `<id=189192>` | `references_mcp_server` |
| `<id=32>` | `<id=189187>` | `references_mcp_server` |

### UNOBSERVED_CODE  (severity P3)

| src | dst | relation |
|---|---|---|
| `<id=7>` | `<id=15132>` | `implements` |
| `<id=7>` | `<id=18585>` | `reads_from` |
| `<id=7>` | `<id=20921>` | `reads_from` |
| `<id=7>` | `<id=28299>` | `exports` |
| `<id=7>` | `<id=28299>` | `reads_from` |
| `<id=7>` | `<id=28310>` | `exports` |
| `<id=7>` | `<id=28310>` | `reads_from` |
| `<id=7>` | `<id=28738>` | `covers` |
| `<id=7>` | `<id=28739>` | `imports` |
| `<id=7>` | `<id=55908>` | `unused_import` |

### CONFIG_BLOAT  (severity P4)

| src | dst | relation |
|---|---|---|
| `<id=189186>` | `<id=189187>` | `MCP_SERVER_DECLARED` |
| `<id=189186>` | `<id=189188>` | `MCP_SERVER_DECLARED` |
| `<id=189186>` | `<id=189189>` | `MCP_SERVER_DECLARED` |
| `<id=189186>` | `<id=189190>` | `MCP_SERVER_DECLARED` |
| `<id=189186>` | `<id=189191>` | `MCP_SERVER_DECLARED` |
| `<id=189186>` | `<id=189192>` | `MCP_SERVER_DECLARED` |
| `<id=189186>` | `<id=189193>` | `MCP_SERVER_DECLARED` |
| `<id=189186>` | `<id=189194>` | `MCP_SERVER_DECLARED` |
| `<id=189186>` | `<id=189195>` | `MCP_SERVER_DECLARED` |
| `<id=189196>` | `<id=189197>` | `AGENT_SPEC_DECLARED` |
