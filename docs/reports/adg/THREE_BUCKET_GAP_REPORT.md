...
- **Generated**: 2026-07-03T12:28:32.866574+00:00
- **Snapshot**: `adg_indexed_07032026_0812.sqlite`
- **Runtime view present**: True
- **Runtime-attested edges**: 0
- **Runtime proof status**: `view_present_zero_attested`
- **Total edges classified**: 567,287
...
| P3 | **UNOBSERVED_CODE** | 567,013 | 99.95% | Static-only — orphan import, dead code, or never-traced path. |
...
| src | dst | relation |
|---|---|---|
| `<id=28>` | `<id=187691>` | `references_mcp_server` |
| `<id=28>` | `<id=187692>` | `references_mcp_server` |
| `<id=28>` | `<id=187695>` | `references_mcp_server` |
| `<id=28>` | `<id=187696>` | `references_mcp_server` |
| `<id=29>` | `<id=187692>` | `references_mcp_server` |
| `<id=32>` | `<id=187691>` | `references_mcp_server` |
| `<id=32>` | `<id=187692>` | `references_mcp_server` |
| `<id=32>` | `<id=187695>` | `references_mcp_server` |
| `<id=32>` | `<id=187696>` | `references_mcp_server` |
| `<id=33>` | `<id=187691>` | `references_mcp_server` |

### UNOBSERVED_CODE  (severity P3)

| src | dst | relation |
|---|---|---|
| `<id=8>` | `<id=15041>` | `implements` |
| `<id=8>` | `<id=18488>` | `reads_from` |
| `<id=8>` | `<id=20818>` | `reads_from` |
| `<id=8>` | `<id=28193>` | `exports` |
| `<id=8>` | `<id=28193>` | `reads_from` |
| `<id=8>` | `<id=28204>` | `exports` |
| `<id=8>` | `<id=28204>` | `reads_from` |
| `<id=8>` | `<id=28630>` | `covers` |
| `<id=8>` | `<id=28631>` | `imports` |
| `<id=8>` | `<id=55767>` | `unused_import` |

### CONFIG_BLOAT  (severity P4)

| src | dst | relation |
|---|---|---|
| `<id=187690>` | `<id=187691>` | `MCP_SERVER_DECLARED` |
| `<id=187690>` | `<id=187692>` | `MCP_SERVER_DECLARED` |
| `<id=187690>` | `<id=187693>` | `MCP_SERVER_DECLARED` |
| `<id=187690>` | `<id=187694>` | `MCP_SERVER_DECLARED` |
| `<id=187690>` | `<id=187695>` | `MCP_SERVER_DECLARED` |
| `<id=187690>` | `<id=187696>` | `MCP_SERVER_DECLARED` |
| `<id=187690>` | `<id=187697>` | `MCP_SERVER_DECLARED` |
| `<id=187690>` | `<id=187698>` | `MCP_SERVER_DECLARED` |
| `<id=187690>` | `<id=187699>` | `MCP_SERVER_DECLARED` |
| `<id=187700>` | `<id=187701>` | `AGENT_SPEC_DECLARED` |
