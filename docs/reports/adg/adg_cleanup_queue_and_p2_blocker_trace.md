...
- **Failed-run manifest:** `artifacts/adg/adg_gate_invocation_manifest_06262026_0552.json`
...
- **Technical evidence:**
  - Published sqlite snapshot: artifacts/adg/adg_indexed_06262026_0552.sqlite
  - P2 ceiling: 19
