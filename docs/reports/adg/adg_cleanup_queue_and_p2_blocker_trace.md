...
- **Generated:** 2026-07-13T10:10:11+00:00
- **Report status:** degraded
- **Dead-code source:** `artifacts/adg/dead_code_zone_control_report_latest.json`
- **Published sqlite:** `artifacts/adg/adg_indexed_07132026_0555.sqlite`
- **P2 ratchet:** `missing`
- **Failed-run manifest:** `artifacts/adg/adg_gate_invocation_manifest_07132026_0555.json`
...
- **Technical evidence:**
  - ADG source: artifacts/adg/adg_indexed_07132026_0555.sqlite (snapshot 07132026_0555)
...
- **Technical evidence:**
  - Published sqlite snapshot: artifacts/adg/adg_indexed_07132026_0555.sqlite
  - P2 ceiling: 0
  - Current MEDIUM hygiene count: 42
  - Delta vs ceiling: +42
  - Baseline snapshot: missing
  - Latest failed run: 2026-07-13T10:10:10Z (failed)
...
- **Delta:** +42
- **Baseline snapshot:** missing
- **Published snapshot:** artifacts/adg/adg_indexed_07132026_0555.sqlite
- **Latest failed run:** 2026-07-13T10:10:10Z (failed)
