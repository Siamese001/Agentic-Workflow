...
- **Generated:** 2026-07-04T14:33:41+00:00
- **Policy:** `2026-06-28.high_signal_burndown_v1`
- **Source timestamp:** 2026-07-04T14:31:05.273609+00:00
- **Work sections:** 15 gate(s) / 11,426 row(s)
- **KPI/watchlist:** 5 gate(s) / 12,557 row(s)
...
| `C3_silent_writes_ratchet` | architecture_backlog | P1 | ratchet | TRACK | floor | 2,062 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
...
| `S4_unused_imports_ratchet` | governance_hygiene | P3 | ratchet | TRACK | floor | 10,792 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
| `Q2_cyclomatic_complexity_ratchet` | governance_hygiene | P3 | ratchet | TRACK | floor | 1,188 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
