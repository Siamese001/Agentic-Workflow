...
- **Generated:** 2026-07-09T10:34:39+00:00
- **Policy:** `2026-06-28.high_signal_burndown_v1`
- **Source timestamp:** 2026-07-09T10:32:13.479226+00:00
- **Work sections:** 9 gate(s) / 4,586 row(s)
- **KPI/watchlist:** 8 gate(s) / 14,994 row(s)
...
| Gate | Materiality | Band | Enforcement | Verdict | Sub | Rows | Next step |
|------|-------------|:----:|-------------|:-------:|:---:|-----:|-----------|
| `G_REACH_l0_reachability` | governance_hygiene | P0 | ratchet | TRACK | floor | 1,450 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
| `3_write_sovereignty` | governance_hygiene | P0 | block | TRACK | inventory | 765 | Advisory inventory: monitor; reduce opportunistically. Does not block CI. |
| `S2_uwg_bypass_ratchet` | governance_hygiene | P0 | ratchet | TRACK | floor | 755 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
...
| `S4_unused_imports_ratchet` | governance_hygiene | P3 | ratchet | TRACK | floor | 10,244 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
