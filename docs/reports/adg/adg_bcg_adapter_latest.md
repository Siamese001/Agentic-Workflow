...
- **Generated:** 2026-07-14T04:42:51+00:00
- **Policy:** `2026-06-28.high_signal_burndown_v1`
- **Source timestamp:** 2026-07-14T04:40:04.942970+00:00
- **Work sections:** 12 gate(s) / 6,189 row(s)
- **KPI/watchlist:** 5 gate(s) / 12,227 row(s)
...
|------|-------------|:----:|-------------|:-------:|:---:|-----:|-----------|
| `G_REACH_l0_reachability` | architecture_backlog | P0 | ratchet | TRACK | floor | 1,370 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
| `3_write_sovereignty` | architecture_backlog | P0 | block | TRACK | inventory | 100 | Advisory inventory: monitor; reduce opportunistically. Does not block CI. |
| `S2_uwg_bypass_ratchet` | architecture_backlog | P0 | ratchet | TRACK | floor | 100 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
...
| `M_taint_actionable_ratchet` | architecture_backlog | P1 | ratchet | TRACK | floor | 699 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
...
| `I2_replay_surface_gaps_ratchet` | architecture_backlog | P2 | ratchet | TRACK | floor | 1,023 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
...
| `S4_unused_imports_ratchet` | governance_hygiene | P3 | ratchet | TRACK | floor | 10,351 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
| `Q2_cyclomatic_complexity_ratchet` | governance_hygiene | P3 | ratchet | TRACK | floor | 1,317 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
| `M1_module_loc_ratchet` | governance_hygiene | P3 | ratchet | TRACK | floor | 451 | Backlog (within ratchet ceiling): shrink over time, defer to a plan wave. No action needed to pass CI. |
