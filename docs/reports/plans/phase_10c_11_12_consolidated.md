...
## CODE_COMMIT
c44a4b2bab78b4e70ed51880e5e44b370599d5d1
...
tests/unit_min_deps/system_learning/test_config_surface_constraints.py::TestUnknownSurfaces::test_unknown_surface_rejected [32mPASSED[0m[32m [  2%][0m
...
tests/unit_min_deps/system_learning/test_config_surface_constraints.py::TestL0RoutingIntConstraints::test_depth_breaker_delta_too_large_raises [32mPASSED[0m[32m [  3%][0m
...
tests/unit_min_deps/system_learning/test_config_surface_constraints.py::TestDeterminism::test_validation_order_independent [32mPASSED[0m[32m [  5%][0m
...
tests/unit_min_deps/system_learning/test_l0_threshold_tuner.py::TestL0ThresholdTuner::test_cooldown_violated_returns_none [32mPASSED[0m[32m [  6%][0m
...
tests/unit_min_deps/system_learning/test_l4_audit_reader.py::TestPullAuditDataValid::test_returns_bytes_unmodified [32mPASSED[0m[32m [  7%][0m
...
tests/unit_min_deps/system_learning/test_lineage_validator.py::TestValidateLineage::test_valid_parent_child_chain [32mPASSED[0m[32m [  8%][0m
...
tests/unit_min_deps/system_learning/test_meta_learning_pipeline_commit_path.py::TestDeterminism::test_commit_path_deterministic [32mPASSED[0m[32m [  9%][0m
...
tests/unit_min_deps/system_learning/test_oscillation_detector.py::TestDetectOscillation::test_non_oscillation_three_values [32mPASSED[0m[32m [ 10%][0m
...
tests/unit_min_deps/system_learning/test_rag_optimizer.py::TestRAGChangePackage::test_canonical_bytes_deterministic [32mPASSED[0m[32m [ 11%][0m
tests/unit_min_deps/system_learning/test_rag_optimizer.py::TestRAGChangePackage::test_content_hash_deterministic [32mPASSED[0m[32m [ 11%][0m
...
tests/unit_min_deps/system_learning/test_rca_types.py::TestRCATypes::test_deterministic_hash_stability [32mPASSED[0m[32m [ 12%][0m
tests/unit_min_deps/system_learning/test_rca_types.py::TestRCATypes::test_findings_ordering_canonical [32mPASSED[0m[32m [ 12%][0m
...
tests/unit_min_deps/system_learning/test_shadow_evaluator.py::TestShadowEvaluator::test_pass_within_thresholds [32mPASSED[0m[32m [ 13%][0m
...
tests/unit_min_deps/system_learning/test_snapshot_determinism.py::TestSnapshotDeterminism::test_snapshot_id_stability_across_calls [32mPASSED[0m[32m [ 14%][0m
tests/unit_min_deps/system_learning/test_snapshot_determinism.py::TestSnapshotDeterminism::test_snapshot_fields_match_inputs [32mPASSED[0m[32m [ 14%][0m
...
tests/unit_min_deps/system_learning/test_snapshot_determinism.py::TestSnapshotValidation::test_start_greater_than_end_raises [32mPASSED[0m[32m [ 15%][0m
tests/unit_min_deps/system_learning/test_snapshot_determinism.py::TestSnapshotValidation::test_valid_window_does_not_raise [32mPASSED[0m[32m [ 15%][0m
...
tests/unit_min_deps/system_learning/test_telemetry_consumer.py::TestTelemetryConsumer::test_same_timestamp_different_kind_sorted [32mPASSED[0m[32m [ 16%][0m
tests/unit_min_deps/system_learning/test_telemetry_consumer.py::TestDeterminism::test_consume_telemetry_deterministic [32mPASSED[0m[32m [ 16%][0m
...
tests/unit_min_deps/system_learning/test_version_store.py::TestGetChangePackage::test_retrieved_package_is_immutable [32mPASSED[0m[32m [ 17%][0m
tests/unit_min_deps/system_learning/test_version_store.py::TestListVersions::test_list_all_versions [32mPASSED[0m[32m [ 17%][0m
...
tests/unit_min_deps/system_learning/test_version_store.py::TestRollback::test_rollback_is_o1_pointer_reversion [32mPASSED[0m[32m [ 18%][0m
tests/unit_min_deps/system_learning/test_version_store.py::TestRollback::test_rollback_to_nonexistent_version_raises [32mPASSED[0m[32m [ 18%][0m
...
tests/unit_min_deps/test_apps_rg_spine_adapter.py::test_adapter_returns_cid [32mPASSED[0m[32m [ 19%][0m
tests/unit_min_deps/test_apps_rg_spine_adapter.py::test_cid_has_rg_prefix [32mPASSED[0m[32m [ 19%][0m
tests/unit_min_deps/test_apps_rg_spine_adapter.py::test_cid_is_deterministic [32mPASSED[0m[32m [ 19%][0m
...
tests/unit_min_deps/test_config_property_contract.py::TestNoSelfConfigAssignInInit::test_no_self_config_assign[SprawlInspectorAgent] [32mPASSED[0m[32m [ 20%][0m
tests/unit_min_deps/test_config_property_contract.py::TestConfigMixinPropertyContract::test_config_is_property [32mPASSED[0m[32m [ 20%][0m
...
tests/unit_min_deps/test_contract_gates.py::test_run_cmd_detects_powershell [32mPASSED[0m[32m [ 21%][0m
tests/unit_min_deps/test_contract_gates.py::test_run_cmd_accepts_python [32mPASSED[0m[32m [ 21%][0m
tests/unit_min_deps/test_contract_gates.py::test_run_cmd_uses_argv_arrays [32mPASSED[0m[32m [ 21%][0m
tests/unit_min_deps/test_contract_gates.py::test_run_cmd_returns_output [32mPASSED[0m[32m [ 21%][0m
tests/unit_min_deps/test_contract_gates.py::test_run_cmd_encoding_safe [32mPASSED[0m[32m [ 21%][0m
...
tests/unit_min_deps/test_evidence_contract_v2.py::test_validate_commit_hash_invalid_length [32mPASSED[0m[32m [ 25%][0m
tests/unit_min_deps/test_evidence_contract_v2.py::test_validate_commit_hash_invalid_chars [32mPASSED[0m[32m [ 25%][0m
...
tests/unit_min_deps/test_evidence_contract_v2.py::test_validate_evidence_contract_structure_requires_evidence_commit [32mPASSED[0m[32m [ 26%][0m
...
tests/unit_min_deps/test_phase2_unsafe_io_enforcement.py::TestPhase2UnsafeIOEnforcement::test_detector_still_works [32mPASSED[0m[32m [ 27%][0m
tests/unit_min_deps/test_phase2_unsafe_io_enforcement.py::TestPhase2UnsafeIOEnforcement::test_remediated_files_clean [32mPASSED[0m[32m [ 27%][0m
...
tests/unit_min_deps/test_ptc_write_contract.py::TestPTCWriteContract::test_tool_registry_exists_and_must_route_via_write_gateway [32mPASSED[0m[32m [ 28%][0m
tests/unit_min_deps/test_ptc_write_contract.py::TestPTCWriteContract::test_write_gateway_is_canonical_write_layer [32mPASSED[0m[32m [ 28%][0m
...
tests/unit_min_deps/test_spine_cross_app_contract.py::test_cross_app_cid_prefixes [32mPASSED[0m[32m [ 29%][0m
...
tests/unit_min_deps/test_ssot_mutation_fence.py::TestPolicyContract::test_policy_none_uses_default [32mPASSED[0m[32m [ 31%][0m
tests/unit_min_deps/test_ssot_mutation_fence.py::TestEnvVarIsolation::test_env_allow_mutation_does_not_bypass_protected_root [32mPASSED[0m[32m [ 31%][0m
...
tests/unit_min_deps/test_testpaths_contract.py::TestPytestIniHeader::test_no_tool_pytest_section [32mPASSED[0m[32m [ 32%][0m
...
tests/unit_min_deps/test_tooling_apps_boundary.py::test_clean_tooling_imports_allowed [32mPASSED[0m[32m [ 32%][0m
tests/unit_min_deps/test_tooling_apps_boundary.py::test_apps_lic_import_forbidden [32mPASSED[0m[32m [ 32%][0m
tests/unit_min_deps/test_tooling_apps_boundary.py::test_apps_rg_from_import_forbidden [32mPASSED[0m[32m [ 32%][0m
tests/unit_min_deps/test_tooling_apps_boundary.py::test_apps_shared_import_forbidden [32mPASSED[0m[32m [ 32%][0m
tests/unit_min_deps/test_tooling_apps_boundary.py::test_string_references_allowed [32mPASSED[0m[32m [ 32%][0m
tests/unit_min_deps/test_tooling_apps_boundary.py::test_multiple_violations_reported [32mPASSED[0m[32m [ 32%][0m
tests/unit_min_deps/test_tooling_apps_boundary.py::test_syntax_error_reported [32mPASSED[0m[32m [ 32%][0m
...
tests/unit_min_deps/test_unsafe_io_subprocess_detector.py::TestUnsafeIOSubprocessDetector::test_detector_finds_subprocess_calls [32mPASSED[0m[32m [ 33%][0m
tests/unit_min_deps/test_unsafe_io_subprocess_detector.py::TestUnsafeIOSubprocessDetector::test_detector_ignores_safe_operations [32mPASSED[0m[32m [ 33%][0m
tests/unit_min_deps/test_unsafe_io_subprocess_detector.py::TestUnsafeIOSubprocessDetector::test_detector_scans_actual_agent_code [32mPASSED[0m[32m [ 33%][0m
tests/unit_min_deps/test_unsafe_io_subprocess_detector.py::TestUnsafeIOSubprocessDetector::test_detector_enforcement [32mPASSED[0m[32m [ 33%][0m
tests/integration/agentic_core/test_inspector_agents_runtime.py::TestDagRuntimeInspectorAgent::test_importable [32mPASSED[0m[32m [ 33%][0m
...
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 17:33:43 [[32m    INFO[0m] agentic_core.L5_safety.reasoning.InspectorExecutor: [InspectorExecutor] Inspector
[32mPASSED[0m[32m                                                                   [ 33%][0m
tests/integration/agentic_core/test_inspector_agents_runtime.py::TestDecoratorRuntimeImports::test_standard_heal_importable_with_full_deps [32mPASSED[0m[32m [ 33%][0m
tests/integration/agentic_core/test_inspector_agents_runtime.py::TestDecoratorRuntimeImports::test_timeout_importable_with_full_deps [32mPASSED[0m[32m [ 33%][0m
...
tests/enforcement/test_folder_purity_governance.py::TestFolderPurityGovernanceRules::test_mixins_requires_mixin_suffix [32mPASSED[0m[32m [ 34%][0m
tests/enforcement/test_folder_purity_governance.py::TestFolderPurityGovernanceRules::test_interfaces_requires_i_prefix [32mPASSED[0m[32m [ 34%][0m
tests/enforcement/test_folder_purity_governance.py::TestFolderPurityGovernanceRules::test_folder_aliases_knowledge_to_reasoning [32mPASSED[0m[32m [ 34%][0m
tests/enforcement/test_folder_purity_governance.py::TestFolderPurityGovernanceRules::test_folder_aliases_validation_to_validators [32mPASSED[0m[32m [ 34%][0m
tests/enforcement/test_folder_purity_governance.py::TestEnforcementFolderRules::test_enforcement_folder_exists_in_rules [32mPASSED[0m[32m [ 34%][0m
tests/enforcement/test_folder_purity_governance.py::TestEnforcementFolderRules::test_enforcement_allows_strategy_suffix [32mPASSED[0m[32m [ 34%][0m
tests/enforcement/test_folder_purity_governance.py::TestUtilsFileSuffixCompliance::test_utils_files_have_util_suffix [32mPASSED[0m[32m [ 34%][0m
tests/enforcement/test_folder_purity_governance.py::TestAgentConfigsFileSuffixCompliance::test_agent_configs_files_have_valid_suffix [32mPASSED[0m[32m [ 34%][0m
...
tests/enforcement/test_folder_purity_governance.py::TestGlobalNoRootFilesInvariant::test_security_has_approved_subfolders [32mPASSED[0m[32m [ 35%][0m
tests/enforcement/test_folder_purity_governance.py::TestGlobalNoRootFilesInvariant::test_global_invariant_covers_all_governed_roots [32mPASSED[0m[32m [ 35%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityPositiveInvariants::test_folder_purity_positive_invariant[validators] [32mPASSED[0m[32m [ 35%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityPositiveInvariants::test_folder_purity_positive_invariant[scripts] [32mPASSED[0m[32m [ 35%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityPositiveInvariants::test_folder_purity_positive_invariant[dashboards] [32mPASSED[0m[32m [ 35%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityPositiveInvariants::test_folder_purity_positive_invariant[base_agents] [32mPASSED[0m[32m [ 35%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityPositiveInvariants::test_folder_purity_positive_invariant[mixins] [32mPASSED[0m[32m [ 35%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityPositiveInvariants::test_folder_purity_positive_invariant[interfaces] [32mPASSED[0m[32m [ 35%][0m
...
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityNegativeInvariants::test_folder_purity_negative_invariant[engines] [32mPASSED[0m[32m [ 36%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityNegativeInvariants::test_folder_purity_negative_invariant[tools] [32mPASSED[0m[32m [ 36%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityCoverage::test_all_existing_folders_are_governed [32mPASSED[0m[32m [ 36%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityRulesIntegrity::test_engines_and_tools_have_rules [32mPASSED[0m[32m [ 36%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityRulesIntegrity::test_engines_and_tools_have_disallowed [32mPASSED[0m[32m [ 36%][0m
tests/enforcement/test_folder_purity_invariants.py::TestFolderPurityRulesIntegrity::test_no_catchall_patterns [32mPASSED[0m[32m [ 36%][0m
tests/enforcement/test_folder_purity_invariants.py::TestRCANegativeTests::test_config_folder_rejects_non_config_suffix [32mPASSED[0m[32m [ 36%][0m
tests/enforcement/test_folder_purity_invariants.py::TestRCANegativeTests::test_engines_folder_rejects_non_engine_suffix [32mPASSED[0m[32m [ 36%][0m
...
tests/enforcement/test_folder_purity_invariants.py::TestRCANegativeTests::test_state_util_location_ssot [32mPASSED[0m[32m [ 37%][0m
tests/enforcement/test_phase_acceptance_guard.py::TestPhaseAcceptanceGuard::test_missing_pytest_ini [32mPASSED[0m[32m [ 37%][0m
tests/enforcement/test_phase_acceptance_guard.py::TestPhaseAcceptanceGuard::test_testpaths_contract_sync_missing_contract [32mPASSED[0m[32m [ 37%][0m
tests/enforcement/test_phase_acceptance_guard.py::TestPhaseAcceptanceGuard::test_testpaths_contract_sync_mismatch [32mPASSED[0m[32m [ 37%][0m
tests/enforcement/test_phase_acceptance_guard.py::TestPhaseAcceptanceGuard::test_testpaths_contract_sync_match [32mPASSED[0m[32m [ 37%][0m
tests/enforcement/test_phase_acceptance_guard.py::TestPhaseAcceptanceGuard::test_evidence_truncation_detection [32mPASSED[0m[32m [ 37%][0m
tests/enforcement/test_phase_acceptance_guard.py::TestPhaseAcceptanceGuard::test_evidence_missing_exit_code [32mPASSED[0m[32m [ 37%][0m
tests/enforcement/test_phase_acceptance_guard.py::TestPhaseAcceptanceGuard::test_phase_evidence_missing_git_history [32mPASSED[0m[32m [ 37%][0m
...
tests/enforcement/test_pytest_config_guard.py::TestPytestEnforcementGuard::test_valid_pytest_configuration [32mPASSED[0m[32m [ 38%][0m
tests/enforcement/test_pytest_config_guard.py::TestPytestEnforcementGuard::test_missing_required_markers [32mPASSED[0m[32m [ 38%][0m
tests/enforcement/test_pytest_config_guard.py::TestPytestEnforcementGuard::test_unregistered_markers_in_tests [32mPASSED[0m[32m [ 38%][0m
tests/enforcement/test_pytest_config_guard.py::TestPytestEnforcementGuard::test_conftest_hook_without_docstring [32mPASSED[0m[32m [ 38%][0m
tests/governance/test_agent_heal_audit.py::TestDeterminism::test_byte_identical_json_runs [32mPASSED[0m[32m [ 38%][0m
tests/governance/test_agent_heal_audit.py::TestDeterminism::test_deterministic_ordering [32mPASSED[0m[32m [ 38%][0m
tests/governance/test_agent_heal_audit.py::TestDeterminism::test_no_nondeterministic_fields [32mPASSED[0m[32m [ 38%][0m
...
tests/governance/test_agent_heal_audit.py::TestEnumerationIntegrity::test_base_class_name_extraction [32mPASSED[0m[32m [ 39%][0m
tests/governance/test_agent_heal_audit.py::TestNoRuntimeImports::test_source_code_imports [32mPASSED[0m[32m [ 39%][0m
tests/governance/test_agent_heal_audit.py::TestNoRuntimeImports::test_stdlib_only_imports [32mPASSED[0m[32m [ 39%][0m
tests/governance/test_agent_heal_audit.py::TestMarkdownGeneration::test_markdown_generation [32mPASSED[0m[32m [ 39%][0m
tests/governance/test_agent_heal_audit.py::TestMarkdownGeneration::test_markdown_determinism [32mPASSED[0m[32m [ 39%][0m
tests/governance/test_authority_boundaries.py::TestMutationAuthorityBoundary::test_l2_execution_exists_and_has_mutations [32mPASSED[0m[32m [ 39%][0m
tests/governance/test_authority_boundaries.py::TestMutationAuthorityBoundary::test_l1_has_zero_mutation_primitives [32mPASSED[0m[32m [ 39%][0m
...
tests/governance/test_authority_boundaries.py::TestAuthorityNegativeRegression::test_detects_l2_fileio_import [32mPASSED[0m[32m [ 40%][0m
tests/governance/test_authority_boundaries.py::TestAuthorityNegativeRegression::test_detects_l2_save_file_import [32mPASSED[0m[32m [ 40%][0m
tests/governance/test_authority_boundaries.py::TestAuthorityNegativeRegression::test_ignores_non_mutation_l2_import [32mPASSED[0m[32m [ 40%][0m
tests/governance/test_canonical_serializer.py::TestGoldenDeterminism::test_dict_10x_identical [32mPASSED[0m[32m [ 40%][0m
tests/governance/test_canonical_serializer.py::TestGoldenDeterminism::test_nested_dict_10x_identical [32mPASSED[0m[32m [ 40%][0m
tests/governance/test_canonical_serializer.py::TestGoldenDeterminism::test_tuple_input_10x_identical [32mPASSED[0m[32m [ 40%][0m
tests/governance/test_canonical_serializer.py::TestGoldenDeterminism::test_empty_dict_10x_identical [32mPASSED[0m[32m [ 40%][0m
...
tests/governance/test_canonical_serializer.py::TestTupleNormalization::test_nested_tuple [32mPASSED[0m[32m [ 41%][0m
tests/governance/test_canonical_serializer.py::TestNullEncoding::test_none_encoded [32mPASSED[0m[32m [ 41%][0m
tests/governance/test_canonical_serializer.py::TestNullEncoding::test_none_not_omitted [32mPASSED[0m[32m [ 41%][0m
tests/governance/test_canonical_serializer.py::TestSortedKeys::test_top_level_sorted [32mPASSED[0m[32m [ 41%][0m
tests/governance/test_canonical_serializer.py::TestSortedKeys::test_nested_sorted [32mPASSED[0m[32m [ 41%][0m
tests/governance/test_canonical_serializer.py::TestCrossObjectConsistency::test_audit_and_intent_same_serializer [32mPASSED[0m[32m [ 41%][0m
tests/governance/test_canonical_serializer.py::TestASTNoDirectJsonDumps::test_no_json_dumps_in_audit_log [32mPASSED[0m[32m [ 41%][0m
...
tests/governance/test_cross_layer_import_freeze.py::TestRegressionDetection::test_persistence_client_detected [32mPASSED[0m[32m [ 42%][0m
tests/governance/test_execute_ssot_mutation_fence.py::TestProtectedRootEnforcement::test_protected_root_blocks_write_under_agentic_core [32mPASSED[0m[32m [ 42%][0m
tests/governance/test_execute_ssot_mutation_fence.py::TestProtectedRootEnforcement::test_protected_root_blocks_rename_under_agentic_core [32mPASSED[0m[32m [ 42%][0m
tests/governance/test_execute_ssot_mutation_fence.py::TestProtectedRootEnforcement::test_protected_root_allows_write_outside_agentic_core [32mPASSED[0m[32m [ 42%][0m
tests/governance/test_execute_ssot_mutation_fence.py::TestProtectedRootEnforcement::test_protected_root_respects_override_flag [32mPASSED[0m[32m [ 42%][0m
tests/governance/test_execute_ssot_mutation_fence.py::TestStartupFenceSelfTest::test_startup_self_test_aborts_if_fence_inactive [32mPASSED[0m[32m [ 42%][0m
tests/governance/test_execute_ssot_mutation_fence.py::TestStartupFenceSelfTest::test_startup_self_test_passes_if_fence_active [32mPASSED[0m[32m [ 42%][0m
...
tests/governance/test_guardian_heal_routing_containment.py::TestNoNewUpwardImportsInInitFiles::test_l3_scripts_init_no_upward_imports [32mPASSED[0m[32m [ 43%][0m
tests/governance/test_guardian_heal_routing_containment.py::TestNoNewUpwardImportsInInitFiles::test_l3_engines_init_no_upward_imports [32mPASSED[0m[32m [ 43%][0m
tests/governance/test_guardian_heal_routing_containment.py::TestGHONoDirectWrites::test_no_open_write_calls [32mPASSED[0m[32m [ 43%][0m
tests/governance/test_guardian_heal_routing_containment.py::TestGHOMutationDelegation::test_no_direct_mutation_primitives [32mPASSED[0m[32m [ 43%][0m
tests/governance/test_guardian_heal_routing_containment.py::TestGHOMutationDelegation::test_write_gateway_is_sole_mutation_path [32mPASSED[0m[32m [ 43%][0m
tests/governance/test_guardian_heal_routing_containment.py::TestDirectoryWideUpwardImportFreeze::test_no_l5_imports_in_l3_init_files [32mPASSED[0m[32m [ 43%][0m
...
tests/governance/test_hash_chain_audit_log.py::TestChainIntegrity::test_chain_links_previous_hash [32mPASSED[0m[32m [ 44%][0m
tests/governance/test_hash_chain_audit_log.py::TestChainIntegrity::test_empty_log_verifies [32mPASSED[0m[32m [ 44%][0m
tests/governance/test_hash_chain_audit_log.py::TestChainIntegrity::test_each_entry_hash_is_sha256 [32mPASSED[0m[32m [ 44%][0m
tests/governance/test_hash_chain_audit_log.py::TestChainBreakDetection::test_tampered_hash_detected 
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 17:34:03 [[1m[31m   ERROR[0m] agentic_core.L2_execution.audit.hash_chain_audit_log: [audit] hash mismatch at entry 1
[32mPASSED[0m[32m                                                                   [ 44%][0m
tests/governance/test_hash_chain_audit_log.py::TestSeal::test_seal_returns_root_hash [32mPASSED[0m[32m [ 44%][0m
tests/governance/test_hash_chain_audit_log.py::TestSeal::test_append_after_seal_raises [32mPASSED[0m[32m [ 44%][0m
tests/governance/test_hash_chain_audit_log.py::TestSeal::test_seal_empty_log_raises [32mPASSED[0m[32m [ 44%][0m
...
tests/governance/test_hash_chain_audit_log.py::TestLogProperties::test_entries_returns_tuple [32mPASSED[0m[32m [ 45%][0m
tests/governance/test_heal_escalation_flag_contract.py::TestFlagDefaultOff::test_no_escalation_log_without_env_var [32mPASSED[0m[32m [ 45%][0m
tests/governance/test_heal_escalation_flag_contract.py::TestFlagDefaultOff::test_observer_not_invoked_without_env_var [32mPASSED[0m[32m [ 45%][0m
tests/governance/test_heal_escalation_flag_contract.py::TestObserverSeamSafety::test_observer_default_is_none_at_import [32mPASSED[0m[32m [ 45%][0m
tests/governance/test_heal_escalation_flag_contract.py::TestObserverSeamSafety::test_observer_not_reassigned_at_module_scope [32mPASSED[0m[32m [ 45%][0m
tests/governance/test_heal_llm_seam_invocation.py::test_heal_llm_seam_default_off [32mPASSED[0m[32m [ 45%][0m
tests/governance/test_heal_llm_seam_invocation.py::test_heal_llm_seam_enabled_no_caller [32mPASSED[0m[32m [ 45%][0m
...
tests/governance/test_heal_model_routing_enabled_path.py::TestModelRoutingDefaultOff::test_no_routed_model_log_when_disabled [32mPASSED[0m[32m [ 46%][0m
tests/governance/test_heal_model_routing_enabled_path.py::TestModelRoutingEnabledLow::test_router_invoked_with_low_tier [32mPASSED[0m[32m [ 46%][0m
tests/governance/test_heal_model_routing_enabled_path.py::TestModelRoutingEnabledLow::test_routed_model_log_contains_local_low [32mPASSED[0m[32m [ 46%][0m
tests/governance/test_heal_model_routing_enabled_path.py::TestModelRoutingEnabledHigh::test_router_invoked_with_high_tier [32mPASSED[0m[32m [ 46%][0m
tests/governance/test_heal_model_routing_enabled_path.py::TestModelRoutingEnabledHigh::test_routed_model_log_contains_local_high [32mPASSED[0m[32m [ 46%][0m
tests/governance/test_heal_policy_model_escalation_flag.py::TestEscalationFlagDefaultOff::test_no_escalation_log_when_disabled [32mPASSED[0m[32m [ 46%][0m
...
tests/governance/test_heal_policy_runtime_integration.py::TestHealPolicyRuntimeIntegration::test_decide_reasoning_tier_is_invoked [32mPASSED[0m[32m [ 47%][0m
tests/governance/test_heal_policy_runtime_integration.py::TestHealPolicyRuntimeIntegration::test_policy_decision_is_logged [32mPASSED[0m[32m [ 47%][0m
tests/governance/test_heal_policy_runtime_integration.py::TestHealPolicyRuntimeIntegration::test_output_unchanged_by_policy_integration [32mPASSED[0m[32m [ 47%][0m
tests/governance/test_heal_policy_types.py::TestClassifyConfidence::test_high_boundary [32mPASSED[0m[32m [ 47%][0m
tests/governance/test_heal_policy_types.py::TestClassifyConfidence::test_high_boundary_exact [32mPASSED[0m[32m [ 47%][0m
tests/governance/test_heal_policy_types.py::TestClassifyConfidence::test_medium_boundary [32mPASSED[0m[32m [ 47%][0m
...
tests/governance/test_heal_policy_types.py::TestDecideHealEscalation::test_medium_confidence_llm_enabled_judicious_gate_met [32mPASSED[0m[32m [ 48%][0m
tests/governance/test_heal_policy_types.py::TestDecideHealEscalation::test_medium_confidence_llm_enabled_judicious_gate_not_met [32mPASSED[0m[32m [ 48%][0m
tests/governance/test_heal_policy_types.py::TestDecideHealEscalation::test_medium_confidence_llm_disabled [32mPASSED[0m[32m [ 48%][0m
tests/governance/test_heal_policy_types.py::TestDecideHealEscalation::test_low_confidence_llm_enabled_complexity_gate [32mPASSED[0m[32m [ 48%][0m
tests/governance/test_heal_policy_types.py::TestDecideHealEscalation::test_low_confidence_llm_enabled_failure_gate [32mPASSED[0m[32m [ 48%][0m
tests/governance/test_heal_policy_types.py::TestDecideHealEscalation::test_low_confidence_llm_enabled_judicious_gate_not_met [32mPASSED[0m[32m [ 48%][0m
tests/governance/test_heal_policy_types.py::TestDecideHealEscalation::test_low_confidence_llm_disabled [32mPASSED[0m[32m [ 48%][0m
...
tests/governance/test_heal_policy_types.py::TestDecideReasoningTierLegacy::test_trivial_rule_returns_low_even_with_low_confidence [32mPASSED[0m[32m [ 49%][0m
tests/governance/test_heal_policy_types.py::TestDecideReasoningTierLegacy::test_trivial_rule_order [32mPASSED[0m[32m [ 49%][0m
tests/governance/test_heal_policy_types.py::TestDecideReasoningTierLegacy::test_escalation_confidence_low [32mPASSED[0m[32m [ 49%][0m
tests/governance/test_heal_policy_types.py::TestDecideReasoningTierLegacy::test_escalation_complexity_high [32mPASSED[0m[32m [ 49%][0m
tests/governance/test_heal_policy_types.py::TestDecideReasoningTierLegacy::test_escalation_safety_risk_high [32mPASSED[0m[32m [ 49%][0m
tests/governance/test_heal_policy_types.py::TestDecideReasoningTierLegacy::test_escalation_retry_count_high [32mPASSED[0m[32m [ 49%][0m
...
tests/governance/test_heal_policy_wiring.py::TestEnableLlmHardGate::test_enable_llm_false_medium_confidence_blocked [32mPASSED[0m[32m [ 50%][0m
tests/governance/test_heal_policy_wiring.py::TestEnableLlmHardGate::test_enable_llm_false_low_confidence_blocked [32mPASSED[0m[32m [ 50%][0m
tests/governance/test_heal_policy_wiring.py::TestTierSelection::test_medium_confidence_selects_low_tier [32mPASSED[0m[32m [ 50%][0m
tests/governance/test_heal_policy_wiring.py::TestTierSelection::test_low_confidence_selects_high_tier [32mPASSED[0m[32m [ 50%][0m
tests/governance/test_heal_policy_wiring.py::TestTierSelection::test_low_confidence_with_prior_failures_selects_high_tier [32mPASSED[0m[32m [ 50%][0m
tests/governance/test_heal_policy_wiring.py::TestJudiciousGate::test_medium_confidence_low_complexity_blocked [32mPASSED[0m[32m [ 50%][0m
...
tests/governance/test_heal_policy_wiring.py::TestCanonicalSeamEnforcement::test_standard_heal_sets_capability_token [32mPASSED[0m[32m [ 51%][0m
tests/governance/test_heal_policy_wiring.py::TestCanonicalSeamEnforcement::test_llm_escalation_only_via_standard_heal [32mPASSED[0m[32m [ 51%][0m
tests/governance/test_heal_policy_wiring.py::TestPolicyDecisionRecord::test_policy_decision_record_schema [32mPASSED[0m[32m [ 51%][0m
tests/governance/test_heal_policy_wiring.py::TestPolicyDecisionRecord::test_policy_decision_record_deterministic_hash [32mPASSED[0m[32m [ 51%][0m
tests/governance/test_heal_policy_wiring.py::TestPolicyDecisionRecord::test_standard_heal_emits_policy_record 
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 17:34:04 [[33m WARNING[0m] agentic_core.utils.decorators_util: [standard_heal] MockAgent: Non-canonical key '_policy_from_kwargs' detected. Consider using canonical keys for better schema compliance.
[32mPASSED[0m[32m                                                                   [ 51%][0m
tests/governance/test_heal_policy_wiring.py::TestNetworkTripwire::test_network_tripwire_blocks_socket [32mPASSED[0m[32m [ 51%][0m
...
tests/governance/test_heal_routed_model_id_propagation.py::test_heal_routed_model_id_enabled_with_router [32mPASSED[0m[32m [ 52%][0m
tests/governance/test_heal_routed_model_id_propagation.py::test_heal_routed_model_id_enabled_no_router [32mPASSED[0m[32m [ 52%][0m
tests/governance/test_heal_routed_model_id_propagation.py::test_heal_routed_model_id_logging_enabled [32mPASSED[0m[32m [ 52%][0m
tests/governance/test_heal_routed_model_id_propagation.py::test_heal_routed_model_id_disabled_no_logging [32mPASSED[0m[32m [ 52%][0m
tests/governance/test_heal_surface_enforcement.py::TestHealSurfaceEnforcement::test_all_agents_have_heal_surface [32mPASSED[0m[32m [ 52%][0m
...
tests/governance/test_heal_telemetry_and_budgets.py::TestTelemetryEmission::test_emit_creates_artifact [32mPASSED[0m[32m [ 53%][0m
tests/governance/test_heal_telemetry_and_budgets.py::TestTelemetryEmission::test_emit_idempotent_same_content [32mPASSED[0m[32m [ 53%][0m
tests/governance/test_heal_telemetry_and_budgets.py::TestTelemetryEmission::test_emit_fails_on_conflict [32mPASSED[0m[32m [ 53%][0m
tests/governance/test_heal_telemetry_and_budgets.py::TestHealBudgetCaps::test_budget_caps_from_env_defaults [32mPASSED[0m[32m [ 53%][0m
tests/governance/test_heal_telemetry_and_budgets.py::TestHealBudgetCaps::test_budget_caps_from_env_custom [32mPASSED[0m[32m [ 53%][0m
tests/governance/test_heal_telemetry_and_budgets.py::TestHealBudgetCaps::test_escalation_budget_enforcement [32mPASSED[0m[32m [ 53%][0m
...
tests/governance/test_healing_reentry.py::TestNoDirectL5Import::test_no_static_l3_import [32mPASSED[0m[32m [ 54%][0m
tests/governance/test_healing_reentry.py::TestApprovalViaSeamStaticProof::test_load_activation_gate_helper_present [32mPASSED[0m[32m [ 54%][0m
tests/governance/test_healing_reentry.py::TestApprovalViaSeamStaticProof::test_load_activation_gate_called_in_smart_fix [32mPASSED[0m[32m [ 54%][0m
tests/governance/test_healing_reentry.py::TestApprovalViaSeamStaticProof::test_seam_exposes_load_activation_gate [32mPASSED[0m[32m [ 54%][0m
tests/governance/test_healing_reentry.py::TestApprovalViaSeamStaticProof::test_seam_uses_importlib_not_static [32mPASSED[0m[32m [ 54%][0m
tests/governance/test_healing_reentry.py::TestDirectL2WritesStaticProof::test_get_file_io_helper_present [32mPASSED[0m[32m [ 54%][0m
...
tests/governance/test_healing_reentry.py::TestHealingWriteCallPath::test_save_file_called_on_file_io_result [32mPASSED[0m[33m [ 55%][0m
tests/governance/test_healing_reentry.py::TestHealingWriteCallPath::test_no_open_write_anywhere_in_orchestrator [32mPASSED[0m[33m [ 55%][0m
tests/governance/test_intent_emission_no_mutation.py::TestAllowlistEnforcement::test_total_hits_equals_zero [32mPASSED[0m[33m [ 55%][0m
tests/governance/test_intent_emission_no_mutation.py::TestAllowlistEnforcement::test_every_hit_is_allowlisted [32mPASSED[0m[33m [ 55%][0m
tests/governance/test_intent_emission_no_mutation.py::TestAllowlistEnforcement::test_every_allowlist_entry_still_exists [32mPASSED[0m[33m [ 55%][0m
...
tests/governance/test_intent_emission_no_mutation.py::TestNegativeRegressionDetectors::test_detects_os_remove [32mPASSED[0m[33m [ 56%][0m
tests/governance/test_intent_emission_no_mutation.py::TestNegativeRegressionDetectors::test_detects_json_dump_to_file [32mPASSED[0m[33m [ 56%][0m
tests/governance/test_intent_emission_no_mutation.py::TestNegativeRegressionDetectors::test_detects_fileio_import [32mPASSED[0m[33m [ 56%][0m
tests/governance/test_intent_emission_no_mutation.py::TestNegativeRegressionDetectors::test_ignores_read_only_open [32mPASSED[0m[33m [ 56%][0m
tests/governance/test_intent_emission_no_mutation.py::TestNegativeRegressionDetectors::test_new_open_write_in_l5_is_flagged [32mPASSED[0m[33m [ 56%][0m
...
tests/governance/test_l0_upward_import_isolation.py::TestImportlibAllowlistEnforcement::test_negative_regression_importlib_higher_layer_detected [32mPASSED[0m[33m [ 57%][0m
tests/governance/test_l0_upward_import_isolation.py::TestImportlibAllowlistEnforcement::test_negative_regression_importlib_dynamic_var_not_flagged [32mPASSED[0m[33m [ 57%][0m
tests/governance/test_l6_purity.py::TestL6WritePrimitiveRatchet::test_l6_does_not_exceed_write_ceiling [32mPASSED[0m[33m [ 57%][0m
tests/governance/test_l6_purity.py::TestL6NoFileIoImports::test_no_fileio_imports_in_l6 [32mPASSED[0m[33m [ 57%][0m
tests/governance/test_l6_purity.py::TestL6NegativeRegression::test_detects_open_append [32mPASSED[0m[33m [ 57%][0m
tests/governance/test_l6_purity.py::TestL6NegativeRegression::test_detects_write_text [32mPASSED[0m[33m [ 57%][0m
...
tests/governance/test_layer_inventory.py::TestLayerInventory::test_classify_file_identifies_utils [32mPASSED[0m[33m [ 58%][0m
tests/governance/test_layer_inventory.py::TestLayerInventory::test_classify_file_identifies_layer_files [32mPASSED[0m[33m [ 58%][0m
tests/governance/test_layer_inventory.py::TestLayerInventory::test_all_layer_directories_have_files [32mPASSED[0m[33m [ 58%][0m
tests/governance/test_layer_inventory.py::TestLayerInventory::test_enumerate_python_files_is_sorted [32mPASSED[0m[33m [ 58%][0m
tests/governance/test_layer_inventory.py::TestLayerInventory::test_inventory_summary [32mPASSED[0m[33m [ 58%][0m
...
tests/governance/test_lazy_seam_silent_swallow.py::TestScanCodebaseContinuesAfterError::test_valid_files_still_scanned [32mPASSED[0m[33m [ 59%][0m
tests/governance/test_lazy_seam_silent_swallow.py::TestNoMutationOnSwallow::test_no_files_created_on_syntax_error [32mPASSED[0m[33m [ 59%][0m
tests/governance/test_lazy_seam_silent_swallow.py::TestSwallowDoesNotWeakenEnforcement::test_corrupt_file_not_treated_as_compliant [32mPASSED[0m[33m [ 59%][0m
tests/governance/test_learning_artifact_intent.py::TestFrozenImmutability::test_cannot_set_field_after_construction [32mPASSED[0m[33m [ 59%][0m
tests/governance/test_learning_artifact_intent.py::TestFrozenImmutability::test_cannot_delete_field [32mPASSED[0m[33m [ 59%][0m
...
tests/governance/test_learning_seam_compliance.py::TestNoDirectPersistenceImport::test_no_persistence_imports_in_agents [32mPASSED[0m[33m [ 60%][0m
tests/governance/test_learning_seam_compliance.py::TestNoForbiddenWriteCalls::test_no_direct_write_calls_in_agents [32mPASSED[0m[33m [ 60%][0m
tests/governance/test_learning_seam_compliance.py::TestLearningSeamExists::test_learning_seam_file_exists [32mPASSED[0m[33m [ 60%][0m
tests/governance/test_learning_seam_compliance.py::TestLearningSeamExists::test_learning_seam_exports_intent [32mPASSED[0m[33m [ 60%][0m
...
tests/governance/test_llm_replay_enforcement.py::TestReplayBundle::test_verify_checksum_fails_on_tampered [32mPASSED[0m[33m [ 61%][0m
tests/governance/test_llm_replay_enforcement.py::TestReplayModePolicy::test_production_only_allows_recorded_output [32mPASSED[0m[33m [ 61%][0m
tests/governance/test_llm_replay_enforcement.py::TestReplayModePolicy::test_dev_test_allows_both_modes [32mPASSED[0m[33m [ 61%][0m
tests/governance/test_llm_replay_enforcement.py::TestReplayModePolicy::test_validate_production_passes_recorded_output [32mPASSED[0m[33m [ 61%][0m
tests/governance/test_llm_replay_enforcement.py::TestReplayModePolicy::test_validate_production_rejects_deterministic [32mPASSED[0m[33m [ 61%][0m
...
tests/governance/test_llm_replay_enforcement.py::TestLLMReplayStrategy::test_strategy_governance_label [32mPASSED[0m[33m [ 62%][0m
tests/governance/test_preventative_sandbox.py::TestSandboxBlocking::test_os_remove_blocked [32mPASSED[0m[33m [ 62%][0m
tests/governance/test_preventative_sandbox.py::TestSandboxBlocking::test_subprocess_run_blocked [32mPASSED[0m[33m [ 62%][0m
tests/governance/test_preventative_sandbox.py::TestSandboxBlocking::test_os_system_blocked [32mPASSED[0m[33m [ 62%][0m
tests/governance/test_preventative_sandbox.py::TestSandboxBlocking::test_builtins_open_blocked [32mPASSED[0m[33m [ 62%][0m
...
tests/governance/test_replay_integrity.py::TestReplayHashComputed::test_replay_hash_is_sha256 [32mPASSED[0m[33m [ 63%][0m
tests/governance/test_replay_integrity.py::TestReplayHashComputed::test_integrity_verified_true_on_create [32mPASSED[0m[33m [ 63%][0m
tests/governance/test_replay_integrity.py::TestReplayHashComputed::test_replay_hash_deterministic [32mPASSED[0m[33m [ 63%][0m
tests/governance/test_replay_integrity.py::TestTamperDetection::test_tampered_response_fails [32mPASSED[0m[33m [ 63%][0m
...
tests/governance/test_repo_heal_pipeline.py::TestRepoHealApplyIdempotency::test_apply_handles_missing_files [32mPASSED[0m[33m [ 64%][0m
tests/governance/test_repo_heal_pipeline.py::TestRepoHealApplyIdempotency::test_dry_run_makes_no_changes [32mPASSED[0m[33m [ 64%][0m
tests/governance/test_repo_heal_pipeline.py::TestRepoHealPlanSchema::test_plan_to_dict_schema [32mPASSED[0m[33m [ 64%][0m
tests/governance/test_repo_heal_pipeline.py::TestRepoHealPlanSchema::test_result_to_dict_schema [32mPASSED[0m[33m [ 64%][0m
...
tests/governance/test_routing_config_seal.py::TestSealDeterminism::test_different_config_different_hash [32mPASSED[0m[33m [ 65%][0m
tests/governance/test_routing_config_seal.py::TestSealVerification::test_unchanged_config_passes [32mPASSED[0m[33m [ 65%][0m
tests/governance/test_routing_config_seal.py::TestSealVerification::test_mutated_config_fails [32mPASSED[0m[33m [ 65%][0m
tests/governance/test_routing_config_seal.py::TestSealVerification::test_removed_key_fails [32mPASSED[0m[33m [ 65%][0m
...
tests/governance/test_seam_contracts.py::TestForwardRollingContractImportParity::test_contract_symbols_match_originals [32mPASSED[0m[33m [ 66%][0m
tests/governance/test_seam_contracts.py::TestActivationContractImportParity::test_assert_activation_allowed_importable [32mPASSED[0m[33m [ 66%][0m
tests/governance/test_seam_contracts.py::TestActivationContractImportParity::test_contract_symbol_matches_original [32mPASSED[0m[33m [ 66%][0m
tests/governance/test_seam_contracts.py::TestMcpContractImportParity::test_mcp_connection_manager_importable [32mPASSED[0m[33m [ 66%][0m
...
tests/governance/test_seam_contracts.py::TestNervousSystemAgentProtocolDefaultWiring::test_nervous_system_agent_protocol_fake_injection [32mPASSED[0m[33m [ 67%][0m
tests/governance/test_seam_dynamic_enforcement.py::TestSeamDynamicEnforcement::test_seam_file_detection [32mPASSED[0m[33m [ 67%][0m
tests/governance/test_seam_dynamic_enforcement.py::TestSeamDynamicEnforcement::test_approved_loader_detection [32mPASSED[0m[33m [ 67%][0m
tests/governance/test_seam_dynamic_enforcement.py::TestSeamDynamicEnforcement::test_scan_produces_deterministic_results [32mPASSED[0m[33m [ 67%][0m
...
tests/governance/test_seam_dynamic_enforcement.py::TestConvergenceConfidence::test_convergence_confidence_calculation [32mPASSED[0m[33m [ 68%][0m
tests/governance/test_shift_report.py::TestShiftReportImmutability::test_cannot_mutate_field [32mPASSED[0m[33m [ 68%][0m
tests/governance/test_shift_report.py::TestShiftReportImmutability::test_timestamp_is_set [32mPASSED[0m[33m [ 68%][0m
tests/governance/test_shift_report.py::TestMinimumSampleGuard::test_min_sample_size_is_30 [32mPASSED[0m[33m [ 68%][0m
...
tests/governance/test_shift_report.py::TestJointShiftLogic::test_joint_true_when_psi_exceeds [32mPASSED[0m[33m [ 69%][0m
tests/governance/test_standard_heal_no_routing_contract.py::TestStandardHealNoRoutingContract::test_no_banned_imports [32mPASSED[0m[33m [ 69%][0m
tests/governance/test_standard_heal_no_routing_contract.py::TestStandardHealNoRoutingContract::test_standard_heal_no_routing_calls [32mPASSED[0m[33m [ 69%][0m
...
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L0-L1] [32mPASSED[0m[33m [ 70%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L0-L2] [32mPASSED[0m[33m [ 70%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L0-L3] [32mPASSED[0m[33m [ 70%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L0-L4] [32mPASSED[0m[33m [ 70%][0m
...
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L2-L0] [32mPASSED[0m[33m [ 71%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L2-L1] [32mPASSED[0m[33m [ 71%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L2-L3] [32mPASSED[0m[33m [ 71%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L2-L4] [32mPASSED[0m[33m [ 71%][0m
...
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L4-L0] [32mPASSED[0m[33m [ 72%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L4-L1] [32mPASSED[0m[33m [ 72%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L4-L2] [32mPASSED[0m[33m [ 72%][0m
...
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L6-L0] [32mPASSED[0m[33m [ 73%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L6-L1] [32mPASSED[0m[33m [ 73%][0m
tests/governance/test_tier_lattice.py::TestAntisymmetry::test_antisymmetry[L6-L2] [32mPASSED[0m[33m [ 73%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L0-L2-L1] [32mPASSED[0m[33m [ 74%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L0-L2-L3] [32mPASSED[0m[33m [ 74%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L0-L2-L4] [32mPASSED[0m[33m [ 74%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L0-L2-L5] [32mPASSED[0m[33m [ 74%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L0-L4-L3] [32mPASSED[0m[33m [ 75%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L0-L4-L5] [32mPASSED[0m[33m [ 75%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L0-L4-L6] [32mPASSED[0m[33m [ 75%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L0-L6-L5] [32mPASSED[0m[33m [ 76%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L1-L0-L2] [32mPASSED[0m[33m [ 76%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L1-L0-L3] [32mPASSED[0m[33m [ 76%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L1-L3-L2] [32mPASSED[0m[33m [ 77%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L1-L3-L4] [32mPASSED[0m[33m [ 77%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L1-L3-L5] [32mPASSED[0m[33m [ 77%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L1-L5-L4] [32mPASSED[0m[33m [ 78%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L1-L5-L6] [32mPASSED[0m[33m [ 78%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L2-L0-L6] [32mPASSED[0m[33m [ 79%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L2-L1-L0] [32mPASSED[0m[33m [ 79%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L2-L1-L3] [32mPASSED[0m[33m [ 79%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L2-L4-L1] [32mPASSED[0m[33m [ 80%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L2-L4-L3] [32mPASSED[0m[33m [ 80%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L2-L6-L4] [32mPASSED[0m[33m [ 81%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L2-L6-L5] [32mPASSED[0m[33m [ 81%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L3-L2-L0] [32mPASSED[0m[33m [ 82%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L3-L2-L1] [32mPASSED[0m[33m [ 82%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L3-L5-L1] [32mPASSED[0m[33m [ 83%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L3-L5-L2] [32mPASSED[0m[33m [ 83%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L4-L0-L5] [32mPASSED[0m[33m [ 84%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L4-L0-L6] [32mPASSED[0m[33m [ 84%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L4-L3-L0] [32mPASSED[0m[33m [ 85%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L4-L3-L1] [32mPASSED[0m[33m [ 85%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L4-L6-L2] [32mPASSED[0m[33m [ 86%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L5-L1-L4] [32mPASSED[0m[33m [ 87%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L5-L1-L6] [32mPASSED[0m[33m [ 87%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L5-L4-L0] [32mPASSED[0m[33m [ 88%][0m
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L5-L4-L1] [32mPASSED[0m[33m [ 88%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L6-L0-L3] [32mPASSED[0m[33m [ 89%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L6-L2-L5] [32mPASSED[0m[33m [ 90%][0m
...
tests/governance/test_tier_lattice.py::TestTransitivity::test_transitivity[L6-L5-L1] [32mPASSED[0m[33m [ 91%][0m
...
tests/governance/test_tier_lattice.py::TestDropPolicy::test_l2_plus_never_drop[2] [32mPASSED[0m[33m [ 92%][0m
...
tests/governance/test_tier_lattice.py::TestLatticeCompleteness::test_21_distinct_pairs [32mPASSED[0m[33m [ 93%][0m
...
tests/governance/test_upward_import_enforcement.py::TestUpwardImportMutation::test_mutation_l2_imports_l6 [32mPASSED[0m[33m [ 94%][0m
...
tests/governance/test_vllm_determinism.py::test_set_ordering_stability [32mPASSED[0m[33m [ 96%][0m
...
tests/governance/test_vllm_determinism.py::test_cross_process_determinism [32mPASSED[0m[33m [ 97%][0m
...
2.59s call     tests/governance/test_upward_import_enforcement.py::TestLazySeamMetric::test_lazy_upward_import_metric_is_deterministic
...
2.16s call     tests/governance/test_upward_import_enforcement.py::TestUpwardImportEnforcement::test_scan_produces_deterministic_results
...
[33m================= [32m1177 passed[0m, [33m[1m4 warnings[0m[33m in 62.76s (0:01:02)[0m[33m =================[0m
```
...
tests/integration/agentic_core/test_inspector_agents_runtime.py::TestDagRuntimeInspectorAgent::test_diagnose_returns_inspection_result 
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 17:34:46 [[32m    INFO[0m] agentic_core.L5_safety.reasoning.InspectorExecutor: [InspectorExecutor] Inspector
[32mPASSED[0m[32m                                                                   [ 33%][0m
tests/integration/agentic_core/test_inspector_agents_runtime.py::TestDecoratorRuntimeImports::test_standard_heal_importable_with_full_deps [32mPASSED[0m[32m [ 33%][0m
tests/integration/agentic_core/test_inspector_agents_runtime.py::TestDecoratorRuntimeImports::test_timeout_importable_with_full_deps [32mPASSED[0m[32m [ 33%][0m
tests/integration/agentic_core/test_inspector_agents_runtime.py::TestDecoratorRuntimeImports::test_shim_identity_with_full_deps [32mPASSED[0m[32m [ 33%][0m
...
tests/governance/test_hash_chain_audit_log.py::TestChainBreakDetection::test_tampered_hash_detected 
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 17:35:07 [[1m[31m   ERROR[0m] agentic_core.L2_execution.audit.hash_chain_audit_log: [audit] hash mismatch at entry 1
[32mPASSED[0m[32m                                                                   [ 44%][0m
tests/governance/test_hash_chain_audit_log.py::TestSeal::test_seal_returns_root_hash [32mPASSED[0m[32m [ 44%][0m
tests/governance/test_hash_chain_audit_log.py::TestSeal::test_append_after_seal_raises [32mPASSED[0m[32m [ 44%][0m
tests/governance/test_hash_chain_audit_log.py::TestSeal::test_seal_empty_log_raises [32mPASSED[0m[32m [ 44%][0m
...
tests/governance/test_heal_policy_wiring.py::TestPolicyDecisionRecord::test_standard_heal_emits_policy_record 
[1m-------------------------------- live log call --------------------------------[0m
2026-02-22 17:35:07 [[33m WARNING[0m] agentic_core.utils.decorators_util: [standard_heal] MockAgent: Non-canonical key '_policy_from_kwargs' detected. Consider using canonical keys for better schema compliance.
[32mPASSED[0m[32m                                                                   [ 51%][0m
tests/governance/test_heal_policy_wiring.py::TestNetworkTripwire::test_network_tripwire_blocks_socket [32mPASSED[0m[32m [ 51%][0m
tests/governance/test_heal_policy_wiring.py::TestNetworkTripwire::test_heal_paths_make_no_network_calls [32mPASSED[0m[32m [ 51%][0m
tests/governance/test_heal_policy_wiring.py::TestHealRepositoryBaseline::test_heal_repository_deterministic_output [32mPASSED[0m[32m [ 51%][0m
...
2.97s call     tests/governance/test_agent_heal_audit.py::TestMarkdownGeneration::test_markdown_determinism
...
2.20s call     tests/governance/test_upward_import_enforcement.py::TestLazySeamMetric::test_lazy_upward_import_metric_is_deterministic
1.94s call     tests/governance/test_upward_import_enforcement.py::TestUpwardImportEnforcement::test_scan_produces_deterministic_results
...
1.54s call     tests/governance/test_agent_heal_audit.py::TestDeterminism::test_deterministic_ordering
1.53s call     tests/governance/test_agent_heal_audit.py::TestStructureContract::test_top_level_schema
1.52s call     tests/governance/test_heal_surface_enforcement.py::TestHealSurfaceEnforcement::test_all_agents_have_heal_surface
[33m================= [32m1177 passed[0m, [33m[1m4 warnings[0m[33m in 61.40s (0:01:01)[0m[33m =================[0m
