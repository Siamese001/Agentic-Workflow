...
|----------|-------|-------------|
| Implements heal_repository | 114 | Overrides base method |
| Inherits Baseline | 0 | Uses SovereignBaseAgent baseline |
| Raises NotImplementedError | 0 | Explicitly unimplemented |
...
| agent_class | Deterministic |
| target_path | Deterministic |
| inputs_hash | Deterministic |
| policy_hash | Deterministic |
| baseline_ops_count | Deterministic |
| applied_ops_count | Deterministic |
| changed_files_count | Deterministic |
| idempotent_second_pass | Deterministic |
...
Outcome values: plan_only, applied, blocked_budget, blocked_policy
...
| Total Records | 5 |
| heal runs | 2 |
| heal_repository runs | 3 |
| plan_only outcomes | 2 |
| applied outcomes | 2 |
| blocked_policy outcomes | 1 |
| blocked_budget outcomes | 0 |
| Total Baseline Ops | 25 |
| Total Applied Ops | 15 |
| Idempotent Passes | 4 |
