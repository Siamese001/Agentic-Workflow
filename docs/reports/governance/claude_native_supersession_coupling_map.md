...
| **Rules** | `003-cursor-author-gate-hitl.md`, `author-gate-enforcement.md`, `author-gate-decision-points.md`, `author-gate-svp-calibration.md`, `author-gate-queue-drain.md`, `anti-pattern-author-gate.md` (already deprecated) |
