# Runtime ADG Coverage Audit — 20260423_210630
...
- Files using lifecycle emit contract (`emit_*` / `record_execution_trace`): **1481**
- Files calling `.persist(<snapshot>)`: **3**
- Union of any emit signature: **1485** files
...
|---|---|---|---|---|---|
| `6e4a4f4005da972a` | 1210 | ✅ | ✅ | 1 | 1 |
| `f778d4e19f0d54df` | 1210 | ✅ | ✅ | 1 | 1 |
| `16e9009910f9fa47` | 1210 | ✅ | ✅ | 1 | 1 |
| `4d2763f946a0690c` | 1210 | ✅ | ✅ | 1 | 1 |
| `1e08ad0ecc4d3ad3` | 1210 | ✅ | ✅ | 1 | 1 |
