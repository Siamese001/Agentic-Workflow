...
> These tables are auto-updated by `post_cascade_wave_lifecycle_capture.py` when
...
> by `post_cascade_wave_lifecycle_capture.py`. Manual edits only needed if hook was
