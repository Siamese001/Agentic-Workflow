...
description: Use this rule when performing ADG analysis, refactoring planning, hotspot assessment, graph-layer queries, P7 artifact consumption, repair loops, or test acceleration. Consolidated procedural guidance for ADG workflows.
---

# ADG Analysis Procedures

> Procedural companion to `adg-canonical-invariants.md` (always-on invariants).  
