...
description: Apply when authoring or modifying any of the 10 routing/promotion/calibration/feedback decision points (L0/bandit, L0/r5, L1/c0, L2/cascade, L3/shape, L3/reroute, L4/uwg, L5/hitl, L6/promo, L6/regret). Demoted from always_on 2026-05-01 per Anthropic two-tier compliance.
---
...
| Audit hook | `.windsurf/scripts/post_cascade_router_decision_audit.py` → `artifacts/windsurf/router_enforcement_violations.jsonl` |
...
| Per-router consulting skills | `.windsurf/skills/ledger-consulter-router-l*/` (12 skills) |
