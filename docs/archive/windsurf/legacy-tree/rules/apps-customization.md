...
tier: 1
description: |
  App-specific behavior belongs in apps_* directories. Guide customization 
  through U0 runtime_customization_package and app-owned profile refs.
---
...
- `.windsurf/rules/agentic-core-static.md` — Core guidance
