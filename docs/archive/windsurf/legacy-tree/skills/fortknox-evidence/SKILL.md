...
**Parent rule:** `.windsurf/rules/fortknox-certification-discipline.md`
...
| `.windsurf/scripts/pre_write_fortknox_guard.py` | Blocks direct report edits (exit 2) |
| `.windsurf/scripts/post_cascade_fortknox_integrity_audit.py` | Retroactive claim-without-compiler detection |
...
- Rule: `.windsurf/rules/fortknox-certification-discipline.md`
- Author-Gate trigger: `.windsurf/rules/author-gate-decision-points.md` §1.11
