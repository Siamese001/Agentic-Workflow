#!/usr/bin/env python3
"""
post_cascade_ask_user_question_packet_audit.py — Vacuum-closure audit.
...
Output: ``artifacts/windsurf/ask_user_question_packet_violations.jsonl``
        ...
        return [
            {
                ...
                "remediation": (
                    ...
                    "Use .windsurf/skills/author-gate-packet-builder/emit_packet.py."
                ),
            }
        ]
