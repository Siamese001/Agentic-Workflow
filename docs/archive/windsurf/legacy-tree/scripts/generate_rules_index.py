...
def scan_rules() -> List[Dict]:
    """Scan .windsurf/rules/*.md and extract metadata."""
    rules = []
...
def scan_skills() -> List[Dict]:
    """Scan .windsurf/skills/*/SKILL.md and extract metadata."""
    skills = []
...
def scan_workflows() -> List[Dict]:
    """Scan .windsurf/workflows/*.md and extract metadata."""
    workflows = []
...
def scan_hooks() -> Optional[Dict]:
    """Scan .windsurf/hooks.json and extract counts."""
...
def generate_index(rules: List[Dict], skills: List[Dict], workflows: List[Dict], hooks: Optional[Dict]) -> str:
    ...
    lines.append("")
    lines.append("This file is auto-generated by `.windsurf/scripts/generate_rules_index.py`.")
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate RULES_INDEX.md from Windsurf governance sources",
...
Examples:
    ...
    if args.write:
        ...
        # Normalize for comparison (remove generated timestamp)
        def normalize(content: str) -> str:
            lines = content.split("\n")
            filtered = [l for l in lines if not l.startswith("**Generated**: ")]
            return "\n".join(filtered)
