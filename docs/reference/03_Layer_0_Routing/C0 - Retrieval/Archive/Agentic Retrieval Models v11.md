# UNIFIED ARCHITECTURAL SPEC: AGENTIC RETRIEVAL & RAG PIPELINES (v12 - RAG HUB ALIGNMENT)
...
| INFRA:  Redis (Key=SHA256)       | INFRA:  Redis (Ephemeral/Stale)  | INFRA:  FAISS / Pinecone         | INFRA:  LangGraph Process Heap   | INFRA:  Token Matrix Weights     |
| BUDGET: Zero Token               | BUDGET: Low Token                | BUDGET: High Token               | BUDGET: Max Token                | BUDGET: Med/High Token           |
| STATE:  Read-Only / Non-Auth     | STATE:  Read-Only / Non-Auth     | STATE:  Read-Only / Grnd Truth   | STATE:  Read/Write / Exec Engine | STATE:  Read-Only / Parametric   |
+----------------------------------+----------------------------------+----------------------------------+----------------------------------+----------------------------------+
