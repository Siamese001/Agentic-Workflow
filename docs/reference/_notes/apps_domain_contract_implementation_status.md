...
- `.windsurf/plans/apps-domain-contract-fortknox-c4d8e2.md`
...
- **Plan SSOT**: Plan at `.windsurf/plans/apps-domain-contract-fortknox-c4d8e2.md`; discovery at `docs/reference/apps_domain_contract_discovery.md`; this status at `docs/reference/apps_domain_contract_implementation_status.md`. No plan-file drift.
