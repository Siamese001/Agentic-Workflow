...
SOURCE OWNERS:
- Evaluation_Runtime_Gates_detailed.md = live gate dispositions and G01-G29 runtime decisions
- 05_Live_Runtime_Exit_Control_&_Evaluation_detailed.md = final current-run checkout and sealed-result disposition
- 04_L2_Execute_detailed.md = execution lifecycle, sandbox execution mechanics, E1-E5 and sealing implementation
- C0_Context_Engine_detailed.md = retrieval, evidence scoring, hydration, support status, and source lineage
- C0.3_Graph_RAG_detailed.md = graph traversal and GraphRAG mechanics
- Prompt_Assembly_detailed.md = signed prompt construction and slot assembly
- 06_Shadow_Evaluation_System_Learning_detailed.md = completed-run RCA, learning proposals, promotion, and future-run updates
...
00.1_L5_Safety_Enforcement_Plane_detailed.md
...
00.2_L5_Authority_Context_and_Registry_Binding_detailed.md
...
00.3_L5_Origin_Trust_and_Content_Boundary_detailed.md
...
00.4_L5_HITL_Reclearance_and_Human_Input_Governance_detailed.md
...
00.7_L5_Static_Governance_and_Structure_Drift_detailed.md
...
========================================================================================================================
END 00_L5_Governance_Safety_detailed.md
========================================================================================================================
