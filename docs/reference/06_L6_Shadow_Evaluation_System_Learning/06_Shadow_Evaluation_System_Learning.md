...
Canonical file: 06_Shadow_Evaluation_System_Learning.md
Overwrite mode: full-file, no-overlap, implementation-grade, source-refreshed
Source refreshed from: 06_Shadow_Evaluation_System_Learning.md
...
========================================================================================================================
06_Shadow_Evaluation_System_Learning.md
...
- 00A_L5_Governance_Safety/00A_L5_Governance_Safety.md and children: certification evidence, policy/auth/egress/replay evidence.
- 00B_L4_State_Archive_and_UWG/00B_L4_State_Archive_and_UWG.md and children: durable state, UWG write admission, read-surface refresh.
- 01_request_intake.md and children: validated request envelope only.
- 02_L1_Reasoning_Plan_Generation.md and children: notepad plan only.
- 03_L0_Route_Decision_Switching_L3.md and children: route and managed workflow authority.
- C0_Context_Engine.md and children: evidence retrieval and FinalEvidenceContract.
- Prompt_Assembly.md and children: signed prompt packet assembly.
- 04_L2_Execute.md and children: bounded execution and sealed artifacts.
- 05_Live_Runtime_Exit_Control_&_Evaluation.md and children: current-run checkout and X3 disposition.
...
06.6_L6_Proposal_Drafting_and_Admission_Gate.md
...
06.8_L6_Observability_KPI_Tests_and_Anti_Bypass.md
