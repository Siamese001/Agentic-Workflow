...
[ START ]         [ THINK ]         [ ROUTE ]         [ ORCH ]          [ CHECK ]         [ EXEC ]          [ SCORE ]         [ VERIFY ]        [ STORE ]         [ LEARN ]
┌───────────┐     ┌───────────┐     ┌───────────┐     ┌───────────┐     ┌───────────┐     ┌───────────┐     ┌───────────┐     ┌───────────┐     ┌───────────┐     ┌───────────┐
│  🗣️  U0   │────>│  🤖  L1   │────>│  🚦  L0   │────>│  🎼  L3   │────>│  🛡️  L5   │────>│  ⚙️  L2   │────>│  ⚖️ Eval  │────>│  👁️  L6   │────>│  💾  L4   │────>│  🧠  ML   │
└───────────┘     └─────┬─────┘     └───────────┘     └───────────┘     └───────────┘     └───────────┘     └───────────┘     └─────┬─────┘     └─────┬─────┘     └─────┬─────┘
      │                 │                                                                                                         │                 │                 │
      ▼                 ▼                                                                                                         ▼                 ▼                 │
┌───────────┐     ┌───────────┐                                                                                             (BUS C: CTRL)     (BUS T: TELEM)      │
│  🧰 APPS  │     │  🔍  C0   │                                                                                                   │                 │                 │
└───────────┘     └───────────┘                                                                                                   ▼                 ▼                 │
      │                 ^                                                                                                   ┌───────────┐     ┌───────────┐           │
      │        (Context Assembly)                                                                                           │ 🚦 L0 Reroute │     │ 📥  UWG   │           │
      └─────────────────┘                                                                                                   └───────────┘     └─────┬─────┘           │
                                                                                                                                                    │                 │
                                                                                                                                             (BUS U: UPDATE)          │
