...
```
python -m pytest tests/e2e/test_runtime_proof_harness.py tests/e2e/test_boundary_fault_matrix.py tests/e2e/test_fixture_families.py tests/e2e/test_requirements_traceability.py tests/proof/test_end_to_end_runtime_proof.py -v
```
...
| §RECOMMENDED COMMAND — validate_trace_tree | `test_validate_axis_runners_pass_on_clean_bundle[tests.e2e.validate_trace_tree]` | same |
| §RECOMMENDED COMMAND — validate_replay --strict | `test_validate_axis_runners_pass_on_clean_bundle[tests.e2e.validate_replay]` | same |
| §RECOMMENDED COMMAND — validate_no_bypass | `test_validate_axis_runners_pass_on_clean_bundle[tests.e2e.validate_no_bypass]` | same |
| §RECOMMENDED COMMAND — validate_grounded_output | `test_validate_axis_runners_pass_on_clean_bundle[tests.e2e.validate_grounded_output]` | same |
