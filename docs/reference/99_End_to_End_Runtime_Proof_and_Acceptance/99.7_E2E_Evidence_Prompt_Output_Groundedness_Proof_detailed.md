...
Canonical file: 99.7_E2E_Evidence_Prompt_Output_Groundedness_Proof_detailed.md
Overwrite mode: full-file, no-overlap, implementation-grade, source-refreshed
Source refreshed from: 99.7_E2E_Evidence_Prompt_Output_Groundedness_Proof_detailed.md
