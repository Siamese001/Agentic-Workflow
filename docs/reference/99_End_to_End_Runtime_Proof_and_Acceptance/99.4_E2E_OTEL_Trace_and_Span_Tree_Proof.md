...
Canonical file: 99.4_E2E_OTEL_Trace_and_Span_Tree_Proof.md
Overwrite mode: full-file, no-overlap, implementation-grade, source-refreshed
Source refreshed from: 99.4_E2E_OTEL_Trace_and_Span_Tree_Proof.md
Owner summary: Owns OTEL trace and span-tree proof only.
