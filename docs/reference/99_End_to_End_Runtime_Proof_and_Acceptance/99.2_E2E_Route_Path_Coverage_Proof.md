...
Owner summary: Owns route-family coverage proof only.
...
| R4_SINGLE_ACTION | one reversible bounded action | one L2 action artifact, no L3, UWG only if Exit emits CommitRequest |
