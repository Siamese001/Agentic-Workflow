...
Canonical folder: 98_Contextual_Refinement_Model_Primers
Canonical file: Contextual Refinement in Transformer Models v4.md
Overwrite mode: full-file, no-overlap, implementation-grade, source-refreshed
Source refreshed from: Contextual Refinement in Transformer Models v4.md
Owner summary: Didactic model-mechanics reference. Owns transformer contextual refinement explanations only, not runtime layer authority.
