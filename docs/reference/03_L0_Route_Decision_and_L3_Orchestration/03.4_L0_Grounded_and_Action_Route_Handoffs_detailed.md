...
Canonical file: 03.4_L0_Grounded_and_Action_Route_Handoffs_detailed.md
Overwrite mode: full-file, no-overlap, implementation-grade, source-refreshed
Source refreshed from: 03.4_L0_Grounded_and_Action_Route_Handoffs_detailed.md
...
- C0/PA_Prompt_Assembly/L2 handoff references as route obligations only.
