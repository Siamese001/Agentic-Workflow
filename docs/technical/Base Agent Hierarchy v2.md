...
==================================================================================================================================================
                    HITL ADG OVERLAY (v2) — BASE AGENT ESCALATION & SAFETY BINDING
==================================================================================================================================================
...
| Lifecycle Signals: enters_sandbox=39 | freezes_context=5 | unfreezes_context=2 | Learning: proposal_commits_routing=3029 | updates_routing_strategy=3011 |
--------------------------------------------------------------------------------------------------------------------------------------------------
| HIERARCHY IMPLICATIONS                                                                                                                          |
| - Base classes and inherited mixins must preserve human-review gating invariants regardless of concrete agent specialization.                  |
| - Confidence-gated escalation is an independent trigger path and must be representable in base contracts, not only app-level policies.         |
| - Runtime authority remains bounded: escalation/review at L3/L5, execution at L2, with freeze/unfreeze lifecycle observed before re-entry.     |
==================================================================================================================================================
