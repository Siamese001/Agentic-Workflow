...
**Location**: Referenced by `.codex/rules/adg-repair-discipline.md` and `.codex/rules/.windsurfrules` §2.5
...
- `.codex/rules/adg-repair-discipline.md` — ADG-controlled repair loop
- `.codex/rules/.windsurfrules` §2.5 — Repair classification and evidence requirements
- `.codex/rules/hitl-enforcement.md` §1.4 — Test modification strategy HITL prompt
