...
======================================================================================================================================================================
  HITL ADG OVERLAY (v2) — HEALING / ESCALATION CONVERGENCE
======================================================================================================================================================================
...
| Lifecycle Signals: enters_sandbox=39 | freezes_context=5 | unfreezes_context=2 | Learning linkage: proposal_commits_routing=3029 | updates_routing_strategy=3011            |
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
| HEALING-LOOP IMPLICATIONS                                                                                                                                         |
| - Confidence-tier healing escalation and HITL confidence gating are complementary: low-confidence routes should converge into explicit human review paths.         |
| - Reentry from failed/remediated paths must continue to honor `reenters_safety` semantics before execution can resume.                                           |
| - Human decisions captured in escalation loops are inputs to DPO/meta-learning updates, preserving deterministic replayable audit lineage.                         |
======================================================================================================================================================================
