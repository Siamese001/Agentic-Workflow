...
**Consumer**: `apps_rg/integrations/company_research_loader.py` (mode 2 of the 4-mode CompanyBrief loader; see HOP-0.6-COMPANY-RESEARCH in `.codex/plans/apps-rg-narrative-and-company-research-e3f8c1.md`)
...
- `.codex/plans/apps-rg-narrative-and-company-research-e3f8c1.md` (HOP-0.6 design)
- `.codex/plans/dormant-facade-cleanup-b2d4f7.md` (the plan that produced this doc)
- `.codex/plans/apps-portfolio-integrated-evaluation-7d3a91.md` (closed; established that no producer→consumer integration existed pre-2026-05-01)
