...
This ADR does not redefine the HITL gate's input or decision semantics — those remain in `.codex/rules/hitl-enforcement.md`.
...
- `.codex/rules/hitl-enforcement.md` — HITL gate semantics
