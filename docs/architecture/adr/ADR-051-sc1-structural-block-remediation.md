...
canonical-invariant doctrine (`.windsurf/rules/adg-canonical-invariants.md`)
...
The remediation plan (`.windsurf/plans/sc1-structural-block-closure-f9e3b1.md`)
...
Per `.windsurf/rules/author-gate-enforcement.md`, every one of the following
...
- `.windsurf/rules/adg-canonical-invariants.md` — layer multipliers, surfaces, archetypes
- `.windsurf/rules/adg-graph-layer-enforcement.md` — §22 plan section requirements
- ADR-049 — L5 v4 governance plane (the canonical safety-plane ADR)
- Companion plan: `.windsurf/plans/sc1-structural-block-closure-f9e3b1.md`
