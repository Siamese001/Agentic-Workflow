...
- **Related**:
  - `.codex/rules/deferred-scope-capture.md`
  - `.codex/rules/adg-canonical-invariants.md` §6 (layer multipliers)
...
- Marker grammar (`.codex/rules/deferred-scope-capture.md`) documents the 5 optional v2 fields.
- Hook parser (`.codex/governance/scripts/post_cursor_agent_deferred_scope_capture.py`) parses optional keys and forwards them to `score_deferred_scope`.
...
| `.codex/rules/deferred-scope-capture.md` | Marker grammar extended with 5 optional v2 fields table |
| `.codex/governance/scripts/post_cursor_agent_deferred_scope_capture.py` | Hook parses optional v2 keys and forwards to scorer |
