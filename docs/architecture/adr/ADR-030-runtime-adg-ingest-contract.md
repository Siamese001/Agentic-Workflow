...
- **Related**:
  ...
  - `@c:/Git/Agentic-Workflow/.codex/rules/adg-canonical-invariants.md` §8 (static-vs-runtime ADG)
  - ADR-025 (unified heal_router OTEL schema)
  - ADR-026 (consensus validator governance)
  - ADR-027 (OTel Anthropic alignment)
- **Plan**: `@c:/Git/Agentic-Workflow/.codex/plans/otel-runtime-adg-ingest-7a3f12.md`
