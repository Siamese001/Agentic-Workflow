...
- **Plan**: `.codex/plans/intelligence-ledgers-ten-a7c3e2.md`
...
- A **consulting skill** at `.codex/skills/ledger-consulter-<name>/SKILL.md` invoked
...
- Precedent for this pattern: `.windsurf/schemas/decision_ledger.schema.sql`,
  `.codex/skills/refactor-decision-memory/SKILL.md`
