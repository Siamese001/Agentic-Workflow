...
**Relates to:** ADR-025 (heal_router.v1 OTEL schema — sibling pattern); `.windsurf/plans/consensus-validator-unification-5e9f3a.md`
...
- Plan: `.windsurf/plans/consensus-validator-unification-5e9f3a.md`
