...
> **Plan**: `.codex/plans/apps-rfp-first-principles-refactor-9c8d3f.md` (W0/W1.1 evidence) + `.codex/plans/apps-portfolio-integrated-evaluation-7d3a91.md` (W0.1 verification, W2 acceptance)
...
- `.codex/plans/apps-rfp-first-principles-refactor-9c8d3f.md` (W1.2)
