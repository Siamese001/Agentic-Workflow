...
- **Related**:
  ...
  - `@c:/Git/Agentic-Workflow/.codex/rules/adg-graph-layer-enforcement.md`
  - `@c:/Git/Agentic-Workflow/.codex/rules/adg-canonical-invariants.md`
- **Plan**: `@c:/Git/Agentic-Workflow/.codex/plans/adg-pipeline-e2e-5287a1.md`
