...
| B7-G6-05 | 2 | 3 | Ownership matrix formalization updated so unresolved mixed-control set (`requires_wave_h_formalization=yes` among mixed-control rows) measures `0`; validated by `test_h13_mixed_control_threshold.py` (`1 passed`). | n/a |
