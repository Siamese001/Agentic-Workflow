...
When a turn still needs user input, ask a plain-text clarifying question in the assistant response; `request_user_input` is only available in Plan mode and is not a repo-owned route.
