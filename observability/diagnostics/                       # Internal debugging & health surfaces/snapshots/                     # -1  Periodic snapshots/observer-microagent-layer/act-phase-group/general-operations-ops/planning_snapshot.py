...
def plan_council_review(
    ...
    *,
    ...
    """
    Plans council review for comprehensive r̩sum̩ assessment.

    Coordinates multi-perspective evaluation to ensure optimal r̩sum̩ enhancement recommendations.
    """
    prompt = build_qa_prompt(
        plan=council_plan,
        ctx=ctx,
