...
Provides core functionality and exports for the Metrics module.
"""
...
__description__: str = "Core Metrics functionality"
...
def create_instance(config: Optional[Dict[str,
    ...
    logger.info(f"Created Metrics instance with config: {final_config}")
    return final_config
