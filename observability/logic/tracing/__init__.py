...
Provides core functionality and exports for the Tracing module.
"""
...
__description__: str = "Core Tracing functionality"
...
def create_instance(config: Optional[Dict[str,
    ...
    logger.info(f"Created Tracing instance with config: {final_config}")
    return final_config
