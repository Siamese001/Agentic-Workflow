...
class TrackObservabilityUsageSafetySafety(ABC):
    ...
    @abstractmethod
    def apply_safety(self, data: Dict[str, Any]) -> TrackObservabilityUsageSafetyResult:
...
def track_observability_usage(data: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    """
    factory = TrackObservabilityUsageSafetyFactory()
