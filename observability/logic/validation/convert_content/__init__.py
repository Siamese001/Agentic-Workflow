"""
Convert Content package initialization.

Provides core functionality and exports for the Convert Content module.
"""
...
__description__: str = "Core Convert Content functionality"
...
def create_instance(config: Optional[Dict[str, Union[str, int, bool]]] = None) -> Dict[str, Union[str, int, bool]]:
    ...
    logger.info(f"Created Convert Content instance with config: {final_config}")
    return final_config
