...
# TODO: Replace star import: # TODO: Replace star import: # TODO: Replace star import: # TODO: Replace star import: # TODO: Replace star import: # from .tools_routing_retry_task_types import *  # Star import removed

class ToolsRoutingRetryTask:
    """
    Main executor class for tools routing retry task operations.
...
def create_processor(config: Optional[Dict[str, Any]]=None) -> ToolsRoutingRetryTask:
    """module function to create configured executor instance."""
    return ToolsRoutingRetryTask(config or {})
