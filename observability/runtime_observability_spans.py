...
def start_span(name: str, ctx: Optional[Dict[str, object]] = None) -> Dict[str, object]:
    ...
    # push_span(record) # Assuming push_span and append_event are defined elsewhere or commented out for now
...
def end_span(span_record: Dict[str, object]) -> None:
    ...
    # if span_record not in span_stack(): # Assuming span_stack is defined elsewhere or commented out for now
    #     return

    # pop_span(span_record) # Assuming pop_span is defined elsewhere or commented out for now
    end_ms = _now_ms()
    ...
    #             "event_type": "span_end",
    #             "span_id": span_record["span_id"],
    #             "duration_ms": duration, # Assuming 'duration' is meant to be DURATION
