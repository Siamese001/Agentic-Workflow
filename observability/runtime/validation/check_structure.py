"""
Check Structure package initialization.

Provides core functionality and exports for the Check Structure module.
"""
...
__description__: str = "Core Check Structure functionality"
...
def create_instance(config: Optional[Dict[str,
    ...
    logger.info(f"Created Check Structure instance with config: {final_config}")
    return final_config
