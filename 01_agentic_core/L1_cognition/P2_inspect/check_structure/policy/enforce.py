# AUTO-HYDRATED FINAL (substring) score=0.950 from 08_scripts\security_controls\guardrails\check_rules\manage_scripts_costs_state_update_ops\enforce_safety_budget.py
