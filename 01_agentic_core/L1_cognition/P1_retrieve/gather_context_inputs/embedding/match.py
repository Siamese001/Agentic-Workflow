"""
01_agentic_core/L1_cognition/P1_retrieve/gather_context_inputs/embedding/match.py
AUTO-HARDENED BY ZERO-LOSS MERGE ENGINE
L5 CANONICAL — WINDSURF Ω — 2025-12-07
MERKLE-INTENDED: d84924dd0cb8f177933f7da1368262d383be902bce9ad6475d45b5abd542bbd8
"""
...
@dataclass
class ResumeContext:
    """Context for resume data in workflow state."""
...
@dataclass
class JobContext:
    """Context for job description data in workflow state."""
    raw_jd: str = ""
    company: str = ""
    job_title: str = ""
...
class StrategyContext:
    """Context for strategy planning in workflow state."""
...
@dataclass
class PromptContext:
    """Context for generated prompts in workflow state."""
    prompts: Optional[GeneratedPrompts] = None


@dataclass
class BulletContext:
    """Context for bullet generation in workflow state."""
...
@dataclass
class DraftContext:
    """Context for draft sections in workflow state."""
    sections: Dict[str, Any] = field(default_factory=dict)


@dataclass
class QAContext:
    """Context for QA validation in workflow state."""
...
class ArtifactContext:
    """Context for generated artifacts in workflow state."""
...
@dataclass
class SafetyContext:
    """Context for safety checks in workflow state."""
...
class FeedbackContext:
    """Context for feedback and rules in workflow state."""
...
class MainGraphState:
    """Main workflow state container (v10.7)."""
