---
name: "source-command-progress-display-enforcement"
...
# source-command-progress-display-enforcement

Use this skill when the user asks to run the migrated source command `progress-display-enforcement`.
...
Migrated from source command `progress-display-enforcement` into a Codex skill. Invoke it as `$source-command-progress-display-enforcement` and manually rewrite any slash-command behavior that depended on provider-specific runtime expansion.
