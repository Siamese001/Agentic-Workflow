...
from phase05.ssot_loader import SSoTLoader
from phase05.archive_scanner import ArchiveScanner, FileInfo
from phase05.semantic_artifact_generator import SemanticArtifactGenerator
from phase05.dual_write_coordinator import DualWriteCoordinator
from phase05.validation_engine import ValidationEngine
...
class Phase05Orchestrator:
    ...
    def _run_validation(self, step: PipelineStep) -> bool:
        ...
        success = self.validation_engine.validate_all()
