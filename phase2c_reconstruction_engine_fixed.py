#!/usr/bin/env python3
"""
Phase 2C: Agentic Core Full Reconstruction Engine (Fixed)
...
class ReconstructionEngine:
    ...
    def {func_name}(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return f'''
    def {func_name}(self, query: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def {func_name}(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return f'''
    def {func_name}(self, tool_name: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def {func_name}(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise SafetyError(f"Safety policy application failed: {{e}}")'''
...
{chr(10).join(functions)}'''
    ...
    def _generate_exceptions(self, layer_behavior: LayerBehavior) -> str:
        ...
        # Sanitize layer name to remove invalid characters
        layer_name = layer_name.replace('/', '').replace('\\', '').replace('-', '_')
