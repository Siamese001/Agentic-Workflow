"""Regenerate ADG and run P1/L0 routing governance gate."""
...
print("\n=== Step 2: Run P1/L0 gate ===")
r2 = subprocess.run(
    [sys.executable, "ops_scripts/ci/_routing_governance_gate.py"], capture_output=True, text=True
)
print(r2.stdout)
if r2.stderr:
...
print("\n=== Step 3: Verify P0/L6 gate still passes ===")
r3 = subprocess.run(
