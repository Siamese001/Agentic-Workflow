"""LLM client adapter shim — sanctioned infra import wrapper for apps_eval.

This module provides a thin adapter layer that re-exports from the sanctioned
infrastructure.sdks_mcps location, allowing apps_eval to use LLM clients
...
# guardian: allow-layer-violation -- sanctioned LLM client shim; apps_eval/integrations is the approved cross-layer seam for infra SDK access
...
# This allows existing code patterns (openai.OpenAI) to work via adapter
try:
