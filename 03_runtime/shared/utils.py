"""
03_runtime/shared/utils.py
AUTO-HARDENED BY ZERO-LOSS MERGE ENGINE
L5 CANONICAL — WINDSURF Ω — 2025-12-07
MERKLE-INTENDED: 911d305d7f1e6a2afd0a099cc23456a6295c19a85fe52a64204f3722f43d33ff
"""
...
class TelemetryLogger:
    ...
    def log(self, telemetry_data: Any) -> None:
        ...
        try:
            ...
            elif hasattr(telemetry_data, 'to_dict'):
...
def enhance_system_prompt_with_reasoning(
    ...
    if reasoning_config.reflexion:
        reflexion_template = get_directive(
            reasoning_config.max_reflexion_loops,
            PROMPT_ADDENDUM_CONFIG.REFLEXION_DIRECTIVES,
        )
