...
Core data models and dataclasses for the Agentic Workflow system.

This module defines all shared data structures, enumerations, and model classes
used throughout the system. It serves as the single source of truth for data types.
