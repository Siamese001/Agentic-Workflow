...
Centralized configuration for the Agentic Workflow system.

This module provides all configuration constants, dataclasses, and the
global CONFIG instance. It serves as the single source of truth for
