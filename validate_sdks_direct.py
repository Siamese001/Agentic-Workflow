...
def main():
    print("=" * 60)
    print("AGENTIC WORKFLOW - DIRECT SDK VALIDATION")
    print("=" * 60)
    ...
    for sdk_name, (module, env_var) in sdks.items():
        ...
        print(f"{status} {key_status} {sdk_name:<20} {module:<30}")
    ...
    print("-" * 40)
    print(f"Summary: {available}/21 installed, {missing} missing, {missing_keys} missing keys")
    ...
    try:
        ...
        print(f"✅ MCP Server: Operational")
        print(f"✅ Tool Registration: OK")
        print(f"✅ Tool Execution: OK (21 * 2 = {result.result})")
    ...
    try:
        ...
        print(f"✅ Multi-Provider Client: Operational")
    ...
    print("\n" + "=" * 60)
    if missing == 0:
        print("✅ ALL 21 SDKs INSTALLED")
        if missing_keys == 0:
            print("✅ ALL REQUIRED API KEYS CONFIGURED")
            print("\n🎉 SYSTEM FULLY OPERATIONAL!")
        else:
            print("⚠️  SOME API KEYS MISSING - CHECK ABOVE")
    else:
        print(f"❌ {missing} SDKs MISSING")
