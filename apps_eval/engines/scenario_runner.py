...
def _scenario_policy_hash_valid() -> tuple[ScenarioOutcome, float, str]:
    try:
        ...
        return ScenarioOutcome.PASS, 1.0, "PolicyHashEnforcer instantiated successfully"    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
...
def _scenario_missing_hash() -> tuple[ScenarioOutcome, float, str]:
    try:
        ...
        if not result.passed:
            return ScenarioOutcome.PASS, 1.0, "Empty hash correctly rejected"    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context    # guardian: PolicyHashViolation should be handled with specific context
    ...
    except _SCENARIO_EXCEPTIONS as exc:    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
        return ScenarioOutcome.FAIL, 0.0, str(exc)
...
def _scenario_nondeterministic_time_call() -> tuple[ScenarioOutcome, float, str]:
    try:
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".py", delete=False) as f:
            f.write(test_code)    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
            tmp_path = f.name
        try:
...
def _scenario_exec_recruiter_brief() -> tuple[ScenarioOutcome, float, str]:
    ...
    except ImportError as e:    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
...
def _scenario_multi_hop_pass() -> tuple[ScenarioOutcome, float, str]:
    try:
        ...
        return ScenarioOutcome.SKIP, _SKIP_SCORE, f"apps_rg not available: {e}"    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
    except _SCENARIO_EXCEPTIONS as exc:
        return ScenarioOutcome.FAIL, 0.0, str(exc)
...
def _scenario_binary_f1_harmonic_mean() -> tuple[ScenarioOutcome, float, str]:
    try:
        ...
        r = r_metric.compute(preds, truth)    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
...
def _scenario_multiclass_macro_f1() -> tuple[ScenarioOutcome, float, str]:
    try:
        ...
        if abs(score - expected) < 1e-5:
            return ScenarioOutcome.PASS, 1.0, f"macro_f1={score:.6f} == mean of per-class F1"    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
...
def _scenario_multiclass_weighted_f1() -> tuple[ScenarioOutcome, float, str]:
    try:
        ...
        total_support = sum(v["support"] for v in per_class.values())    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
...
def _scenario_confusion_matrix_invariants() -> tuple[ScenarioOutcome, float, str]:
    try:
        ...
        if total != expected_total:
            return ScenarioOutcome.FAIL, 0.0, f"TP+FP+TN+FN={total} != {expected_total}"    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
...
_SCENARIO_FN_MAP: dict[str, Any] = {
    ...
    "multi_hop_pass": _scenario_multi_hop_pass,    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions    # guardian: Test exceptions should use proper test assertions
