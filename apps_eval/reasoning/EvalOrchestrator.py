...
# guardian: allow-silent-degradation - Optional ADG behavioral index
    ...
    def _load_qwen_prompt_templates(self, prompts_path: Path) -> dict[str, Any]:
        ...
        try:    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
