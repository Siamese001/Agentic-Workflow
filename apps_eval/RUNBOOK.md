...
`apps_eval/config/domain_contract/` and are authoritative via the L4
`AppEvalRubricRecord` + `AppThresholdProfileRecord` registered through
UWG.

**Rubric**: `apps_eval/config/domain_contract/eval_rubrics.yaml`
**Threshold profile**: `apps_eval/config/domain_contract/threshold_profiles.yaml`
**Grader roster**: `apps_eval/config/domain_contract/grader_roster.yaml`
