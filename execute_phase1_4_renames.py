#!/usr/bin/env python3
"""Execute Phase 1.4: Rename CONFIG files in core configuration"""
import json
import subprocess
import re
...
for v in report['violations']:
    ...
    if stem.endswith('_config'):
        continue
    configs_to_rename.append(path)

print(f"Found {len(configs_to_rename)} CONFIG files to rename")
