...
_emit_records_execution_trace("p0", "evidence", "_contract_gate_ssot")
...
_emit_emits_metric_event("_contract_gate_ssot", "p4obs", "metric_1")
_emit_emits_metric_event("_contract_gate_ssot", "p4obs", "metric_2")
_emit_emits_metric_event("_contract_gate_ssot", "p4obs", "metric_3")
_emit_emits_metric_event("_contract_gate_ssot", "p4obs", "metric_4")
_emit_emits_metric_event("_contract_gate_ssot", "p4obs", "metric_5")
_emit_emits_metric_event("_contract_gate_ssot", "p4obs", "metric_6")
_emit_records_incident_event("_contract_gate_ssot", "p4obs", "incident")
_emit_captures_runtime_anomaly("_contract_gate_ssot", "p4obs", "anomaly")
_emit_writes_observability_log("_contract_gate_ssot", "p4obs", "obs_log")
_emit_updates_monitoring_state("_contract_gate_ssot", "p4obs", "mon_state")
_emit_triggers_alert("_contract_gate_ssot", "p4obs", "alert")
_emit_links_incident_trace("_contract_gate_ssot", "p4obs", "trace_link")
_emit_captures_pattern("_contract_gate_ssot", "p3lm", "pattern")
_emit_records_learning_event("_contract_gate_ssot", "p3lm", "learning_event")
_emit_writes_learning_snapshot("_contract_gate_ssot", "p3lm", "snapshot")
_emit_feeds_meta_learning("_contract_gate_ssot", "p3lm", "meta_feed")
_emit_updates_routing_strategy("_contract_gate_ssot", "p3lm", "routing")
_emit_improves_agent_policy("_contract_gate_ssot", "p3lm", "policy")
_emit_stores_learning_state("_contract_gate_ssot", "p3lm", "state")
_emit_records_execution_trace("_contract_gate_ssot", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("_contract_gate_ssot", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("_contract_gate_ssot", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("_contract_gate_ssot", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("_contract_gate_ssot", "L4_STATE", "p2_trace_5")
_emit_reads_environ("_contract_gate_ssot", "env_read", "p2_env_1")
_emit_reads_environ("_contract_gate_ssot", "env_read", "p2_env_2")
_emit_reads_runtime_state("_contract_gate_ssot", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("_contract_gate_ssot", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "_contract_gate_ssot", "context_pull")
_emit_pulls_context("p1", "_contract_gate_ssot", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "_contract_gate_ssot", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "_contract_gate_ssot", "uwg_term_2")
_emit_writes_through("p1", "_contract_gate_ssot", "write_through")
_emit_writes_through("p1", "_contract_gate_ssot", "write_through_2")
_emit_validated_by_safety_plane("p1", "_contract_gate_ssot", "safety_validation")
_emit_invokes_eval("p1", "_contract_gate_ssot", "eval_call")
_emit_proposal_commits_routing("p1", "_contract_gate_ssot", "routing_commit")
_emit_escalates_to_human("p1", "_contract_gate_ssot", "human_escalation")
_emit_routes_through("p1", "_contract_gate_ssot", "route_through")
_emit_checks_agent_registry("p1", "_contract_gate_ssot", "agent_registry")
_emit_validates_agent_capability("p1", "_contract_gate_ssot", "capability")
_emit_dispatches_execution_plan("p1", "_contract_gate_ssot", "exec_plan")
_emit_agent_executes_agent("p1", "_contract_gate_ssot", "sub_agent")
_emit_routes_to_agent("p1", "_contract_gate_ssot", "target_agent")
_emit_verifies_policy("p1", "_contract_gate_ssot", "policy_check")
_emit_observes_runtime_state("p1", "_contract_gate_ssot", "runtime_state")
_emit_verifies_boundary("p1", "_contract_gate_ssot", "boundary_check")
_emit_transcripts_response("p1", "_contract_gate_ssot", "transcript")
_emit_hard_fails_untranscripted("p1", "_contract_gate_ssot")
_emit_gated_by_confidence("p1", "_contract_gate_ssot", "confidence_gate")
emit_replay_key("p0", "_contract_gate_ssot")
emit_determinism_digest("p0", "_contract_gate_ssot")
_emit_signs_execution_trace("p0", "p0hash", "p0_trace", 0)
_emit_authorize_and_execute("p2", "_contract_gate_ssot", "execution_auth")
_emit_validates_capability("p2", "_contract_gate_ssot", "capability_check")
_emit_routes_to_capability("p2", "_contract_gate_ssot", "capability_route")
_emit_writes_via_uwg("p2", "_contract_gate_ssot", "uwg_write")
_emit_blocks_direct_write("p2", "_contract_gate_ssot", "direct_write_block")
_emit_records_tool_invocation("p2", "_contract_gate_ssot", "tool_invocation")
_emit_captures_execution_output("p2", "_contract_gate_ssot", "exec_output")
_emit_dispatches_agent("p3", "_contract_gate_ssot", "agent_dispatch")
_emit_coordinates_agents("p3", "_contract_gate_ssot", "agent_coordination")
_emit_records_workflow_lineage("p3", "_contract_gate_ssot", "workflow_lineage")
_emit_records_healing_outcome("p3", "_contract_gate_ssot", "healing_outcome")
_emit_escalates_failure("p3", "_contract_gate_ssot", "failure_escalation")
_emit_orchestrates_workflow("p3", "_contract_gate_ssot", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "_contract_gate_ssot", "healing_dispatch")
_emit_invokes_evaluation("p3", "_contract_gate_ssot", "evaluation_signal")
_emit_records_telemetry_event("p4", "_contract_gate_ssot", "telemetry_event")
_emit_captures_evaluation_metric("p4", "_contract_gate_ssot", "eval_metric")
_emit_stores_embedding("p4", "_contract_gate_ssot", "embedding_store")
_emit_updates_meta_learning_state("p4", "_contract_gate_ssot", "meta_learning")
_emit_links_execution_to_snapshot("p4", "_contract_gate_ssot", "exec_snapshot_link")
