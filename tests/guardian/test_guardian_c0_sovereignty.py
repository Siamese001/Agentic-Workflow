...
_emit_escalates_to_human("p1", "test_guardian_c0_sovereignty", "human_escalation")
_emit_routes_through("p1", "test_guardian_c0_sovereignty", "route_through")
_emit_checks_agent_registry("p1", "test_guardian_c0_sovereignty", "agent_registry")
_emit_validates_agent_capability("p1", "test_guardian_c0_sovereignty", "capability")
_emit_dispatches_execution_plan("p1", "test_guardian_c0_sovereignty", "exec_plan")
_emit_agent_executes_agent("p1", "test_guardian_c0_sovereignty", "sub_agent")
_emit_routes_to_agent("p1", "test_guardian_c0_sovereignty", "target_agent")
_emit_verifies_policy("p1", "test_guardian_c0_sovereignty", "policy_check")
_emit_observes_runtime_state("p1", "test_guardian_c0_sovereignty", "runtime_state")
_emit_verifies_boundary("p1", "test_guardian_c0_sovereignty", "boundary_check")
_emit_transcripts_response("p1", "test_guardian_c0_sovereignty", "transcript")
_emit_hard_fails_untranscripted("p1", "test_guardian_c0_sovereignty")
_emit_gated_by_confidence("p1", "test_guardian_c0_sovereignty", "confidence_gate")
