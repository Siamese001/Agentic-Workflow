...
class TestImportSafety:
            ...
            try:
                ...
                for line_num, line in enumerate(lines, 1):
                    ...
                    if line.startswith("from ") and " import " in line:
                        ...
                        if import_path.startswith("apps_rg") or import_path.startswith(
                            "apps_shared"
                        ):
    ...
    def test_ssot_dependency_flow(self):
            ...
            try:
                ...
                for line_num, line in enumerate(lines, 1):
                    if line.strip().startswith("from apps_rg"):
                        violations.append(
                            {"file": str(file_path), "line": line_num, "violation": line.strip()}
                        )
        ...
        if violations:
            ...
            error_msg += (
                "❌ apps_shared (Utilities) MUST NOT import from apps_rg (Business Logic)\n\n"
            )
