...
_emit_escalates_to_human("p1", "test_manifest_verify_hash_enforced", "human_escalation")
_emit_routes_through("p1", "test_manifest_verify_hash_enforced", "route_through")
_emit_checks_agent_registry("p1", "test_manifest_verify_hash_enforced", "agent_registry")
_emit_validates_agent_capability("p1", "test_manifest_verify_hash_enforced", "capability")
_emit_dispatches_execution_plan("p1", "test_manifest_verify_hash_enforced", "exec_plan")
_emit_agent_executes_agent("p1", "test_manifest_verify_hash_enforced", "sub_agent")
_emit_routes_to_agent("p1", "test_manifest_verify_hash_enforced", "target_agent")
_emit_verifies_policy("p1", "test_manifest_verify_hash_enforced", "policy_check")
_emit_observes_runtime_state("p1", "test_manifest_verify_hash_enforced", "runtime_state")
_emit_verifies_boundary("p1", "test_manifest_verify_hash_enforced", "boundary_check")
_emit_transcripts_response("p1", "test_manifest_verify_hash_enforced", "transcript")
_emit_hard_fails_untranscripted("p1", "test_manifest_verify_hash_enforced")
_emit_gated_by_confidence("p1", "test_manifest_verify_hash_enforced", "confidence_gate")
