...
_emit_escalates_to_human("p1", "test_guardian_cross_layer_mutation", "human_escalation")
_emit_routes_through("p1", "test_guardian_cross_layer_mutation", "route_through")
_emit_checks_agent_registry("p1", "test_guardian_cross_layer_mutation", "agent_registry")
_emit_validates_agent_capability("p1", "test_guardian_cross_layer_mutation", "capability")
_emit_dispatches_execution_plan("p1", "test_guardian_cross_layer_mutation", "exec_plan")
_emit_agent_executes_agent("p1", "test_guardian_cross_layer_mutation", "sub_agent")
_emit_routes_to_agent("p1", "test_guardian_cross_layer_mutation", "target_agent")
_emit_verifies_policy("p1", "test_guardian_cross_layer_mutation", "policy_check")
_emit_observes_runtime_state("p1", "test_guardian_cross_layer_mutation", "runtime_state")
_emit_verifies_boundary("p1", "test_guardian_cross_layer_mutation", "boundary_check")
_emit_transcripts_response("p1", "test_guardian_cross_layer_mutation", "transcript")
_emit_hard_fails_untranscripted("p1", "test_guardian_cross_layer_mutation")
_emit_gated_by_confidence("p1", "test_guardian_cross_layer_mutation", "confidence_gate")
