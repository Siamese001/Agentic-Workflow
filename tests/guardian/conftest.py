...
_emit_records_execution_trace("p0", "evidence", "conftest_guardian")
_emit_applies_guardrail("p0", "conftest_guardian", "p0_governance")
_emit_reads_policy_state("p0", "conftest_guardian", "policy_binding")
_emit_snapshots_state("p0", "conftest_guardian", "state_snapshot")
emit_replay_key("p0", "conftest_guardian")
emit_determinism_digest("p0", "conftest_guardian")
