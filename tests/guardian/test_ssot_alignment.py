                    ...
                    for subfolder_name in subfolders.keys():
                        ...
                        if not subfolder_path.exists():
                            ...
                            if isinstance(subfolder_def, dict) and subfolder_def.get("required_dirs"):
                                ...
                                print(f"  [INFO] Optional subfolder '{territory_name}/{subfolder_name}' does not exist")
                ...
                for file in files:
                        ...
                        if not file.endswith("Agent.py") and not file.endswith("_agent.py"):
                            ...
                            if file_stem not in agent_classes:
                                naming_violations.append({
                                    ...
                                    "issue": f"File contains Agent class(es) but doesn't follow naming convention",
                                })
                    ...
                    if mixin_classes:
                        if "mixin" not in file.lower():
                            naming_violations.append({
                                ...
                                "issue": f"File contains Mixin class(es) but filename doesn't contain 'mixin'",
                            })
                    ...
                    if file.endswith("Agent.py") and not agent_classes:
                        naming_violations.append({
                            ...
                            "type": "false_agent",
                            "classes": classes,
                            "issue": f"File ends in 'Agent.py' but contains no Agent class",
                        })
    ...
    def test_orphan_file_detection(self):
        ...
        for item in self.project_root.iterdir():
            ...
            if item.is_dir():
                ...
                allowed_root_files = {
                    "pyproject.toml", "pytest.ini", "setup.py", "conftest.py",
                }
