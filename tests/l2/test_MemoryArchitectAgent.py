#!/usr/bin/env python3
"""
Test suite for MemoryArchitectAgent
...
from agentic_core.L2_execution.ToolRegistry.MemoryArchitectAgent import MemoryArchitectAgent
...
class TestMemoryArchitectAgent:
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'MemoryArchitectAgent'
