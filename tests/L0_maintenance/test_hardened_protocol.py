...
class TestHardenedProtocol(unittest.TestCase):
    ...
    def test_path_resolution_robustness(self):
        ...
        discovery_data = [
            ...
            {"class_name": "AbsAgent", "path": str(self.project_root / "agentic_core/L5_safety/Abs.py")}
        ]
    ...
    def test_crash_recovery_state(self):
        ...
        self.assertEqual(mgr.state["status"], "interrupted", "State should update to interrupted on crash")
    ...
    def test_live_discovery_fallback_path_resolution(self):
        ...
        with patch('agentic_core.L0_maintenance.scripts.execute_ssot.discover_all_agents') as mock_discover:
