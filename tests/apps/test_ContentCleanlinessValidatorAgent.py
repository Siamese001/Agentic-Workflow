...
class TestContentCleanlinessValidatorAgent:
    ...
    def agent(self):
        ...
        return ContentCleanlinessValidatorAgent()
    
    def test_instantiation(self, agent):
        """Test that agent can be instantiated."""
        assert agent is not None
        assert isinstance(agent, ContentCleanlinessValidatorAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'ContentCleanlinessValidatorAgent'
