...
from system_learning.engines.retrieval_profile_activation_gate import RetrievalProfileActivationGate, ActivationResult
...
class TestActivationGateW4F:
    ...
    def test_replay_check_determinism(self):
        ...
        result1 = gate.replay_checker.replay_check_profile_change(
            base_profile=base_profile,
            proposed_profile=proposed_profile,
        )
        
        result2 = gate.replay_checker.replay_check_profile_change(
            base_profile=base_profile,
            proposed_profile=proposed_profile,
        )
        ...
        assert len(result1.digest) == 64  # SHA-256 hex length
