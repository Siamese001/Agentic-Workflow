...
_emit_records_execution_trace("p0", "evidence", "w1_strong_negative_control")
_emit_applies_guardrail("p0", "w1_strong_negative_control", "p0_governance")
_emit_reads_policy_state("p0", "w1_strong_negative_control", "policy_binding")
_emit_snapshots_state("p0", "w1_strong_negative_control", "state_snapshot")
emit_replay_key("p0", "w1_strong_negative_control")
emit_determinism_digest("p0", "w1_strong_negative_control")
_emit_signs_execution_trace("p0", "p0hash", "p0_trace", 0)
_emit_authorize_and_execute("p2", "w1_strong_negative_control", "execution_auth")
_emit_validates_capability("p2", "w1_strong_negative_control", "capability_check")
_emit_routes_to_capability("p2", "w1_strong_negative_control", "capability_route")
_emit_writes_via_uwg("p2", "w1_strong_negative_control", "uwg_write")
_emit_blocks_direct_write("p2", "w1_strong_negative_control", "direct_write_block")
_emit_records_tool_invocation("p2", "w1_strong_negative_control", "tool_invocation")
_emit_captures_execution_output("p2", "w1_strong_negative_control", "exec_output")
_emit_dispatches_agent("p3", "w1_strong_negative_control", "agent_dispatch")
_emit_coordinates_agents("p3", "w1_strong_negative_control", "agent_coordination")
_emit_records_workflow_lineage("p3", "w1_strong_negative_control", "workflow_lineage")
_emit_records_healing_outcome("p3", "w1_strong_negative_control", "healing_outcome")
_emit_escalates_failure("p3", "w1_strong_negative_control", "failure_escalation")
_emit_orchestrates_workflow("p3", "w1_strong_negative_control", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "w1_strong_negative_control", "healing_dispatch")
_emit_invokes_evaluation("p3", "w1_strong_negative_control", "evaluation_signal")
_emit_records_telemetry_event("p4", "w1_strong_negative_control", "telemetry_event")
_emit_captures_evaluation_metric("p4", "w1_strong_negative_control", "eval_metric")
_emit_stores_embedding("p4", "w1_strong_negative_control", "embedding_store")
_emit_updates_meta_learning_state("p4", "w1_strong_negative_control", "meta_learning")
_emit_links_execution_to_snapshot("p4", "w1_strong_negative_control", "exec_snapshot_link")
...
_emit_escalates_to_human("p1", "w1_strong_negative_control", "human_escalation")
_emit_routes_through("p1", "w1_strong_negative_control", "route_through")
_emit_checks_agent_registry("p1", "w1_strong_negative_control", "agent_registry")
_emit_validates_agent_capability("p1", "w1_strong_negative_control", "capability")
_emit_dispatches_execution_plan("p1", "w1_strong_negative_control", "exec_plan")
_emit_agent_executes_agent("p1", "w1_strong_negative_control", "sub_agent")
_emit_routes_to_agent("p1", "w1_strong_negative_control", "target_agent")
_emit_verifies_policy("p1", "w1_strong_negative_control", "policy_check")
_emit_observes_runtime_state("p1", "w1_strong_negative_control", "runtime_state")
_emit_verifies_boundary("p1", "w1_strong_negative_control", "boundary_check")
_emit_transcripts_response("p1", "w1_strong_negative_control", "transcript")
_emit_hard_fails_untranscripted("p1", "w1_strong_negative_control")
_emit_gated_by_confidence("p1", "w1_strong_negative_control", "confidence_gate")
