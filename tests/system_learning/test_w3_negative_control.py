...
class TestW3NegativeControl:
    ...
    def test_precision_rounding_violation_negative_control(self) -> None:
        ...
        if _TAMPER:
            pytest.xfail("W3_NEGCTRL_TAMPER=1: precision rounding intentionally broken to prove detectability")
        ...
        print(f"W3-NEGCTRL-GUARD-INTACT: precision_rounded correctly")
