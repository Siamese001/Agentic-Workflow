"""
Unit tests for FormatObservabilityContextPlanType
...
class TestFormatObservabilityContextPlanTypeInitialization:
...
class TestFormatObservabilityContextPlanTypeCoreMethods:
...
class TestFormatObservabilityContextPlanTypeEdgeCases:
...
class TestFormatObservabilityContextPlanTypeTypeBoundaries:
