"""
Unit tests for LogObservabilityMetrics
...
class TestLogObservabilityMetricsInitialization:
...
class TestLogObservabilityMetricsCoreMethods:
...
class TestLogObservabilityMetricsEdgeCases:
...
class TestLogObservabilityMetricsTypeBoundaries:
