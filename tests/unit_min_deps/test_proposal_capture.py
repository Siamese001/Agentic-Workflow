...
_emit_escalates_to_human("p1", "test_proposal_capture", "human_escalation")
_emit_routes_through("p1", "test_proposal_capture", "route_through")
_emit_checks_agent_registry("p1", "test_proposal_capture", "agent_registry")
_emit_validates_agent_capability("p1", "test_proposal_capture", "capability")
_emit_dispatches_execution_plan("p1", "test_proposal_capture", "exec_plan")
_emit_agent_executes_agent("p1", "test_proposal_capture", "sub_agent")
_emit_routes_to_agent("p1", "test_proposal_capture", "target_agent")
_emit_verifies_policy("p1", "test_proposal_capture", "policy_check")
_emit_observes_runtime_state("p1", "test_proposal_capture", "runtime_state")
_emit_verifies_boundary("p1", "test_proposal_capture", "boundary_check")
_emit_transcripts_response("p1", "test_proposal_capture", "transcript")
_emit_hard_fails_untranscripted("p1", "test_proposal_capture")
_emit_gated_by_confidence("p1", "test_proposal_capture", "confidence_gate")
