...
_emit_records_execution_trace("p0", "evidence", "test_meta_learning_pipeline_wiring")
_emit_applies_guardrail("p0", "test_meta_learning_pipeline_wiring", "p0_governance")
_emit_snapshots_state("p0", "test_meta_learning_pipeline_wiring", "state_snapshot")
emit_replay_key("p0", "test_meta_learning_pipeline_wiring")
emit_determinism_digest("p0", "test_meta_learning_pipeline_wiring")
_emit_signs_execution_trace("p0", "p0hash", "p0_trace", 0)
_emit_authorize_and_execute("p2", "test_meta_learning_pipeline_wiring", "execution_auth")
_emit_validates_capability("p2", "test_meta_learning_pipeline_wiring", "capability_check")
_emit_routes_to_capability("p2", "test_meta_learning_pipeline_wiring", "capability_route")
_emit_writes_via_uwg("p2", "test_meta_learning_pipeline_wiring", "uwg_write")
_emit_blocks_direct_write("p2", "test_meta_learning_pipeline_wiring", "direct_write_block")
_emit_records_tool_invocation("p2", "test_meta_learning_pipeline_wiring", "tool_invocation")
_emit_captures_execution_output("p2", "test_meta_learning_pipeline_wiring", "exec_output")
_emit_dispatches_agent("p3", "test_meta_learning_pipeline_wiring", "agent_dispatch")
_emit_coordinates_agents("p3", "test_meta_learning_pipeline_wiring", "agent_coordination")
_emit_records_workflow_lineage("p3", "test_meta_learning_pipeline_wiring", "workflow_lineage")
_emit_records_healing_outcome("p3", "test_meta_learning_pipeline_wiring", "healing_outcome")
_emit_escalates_failure("p3", "test_meta_learning_pipeline_wiring", "failure_escalation")
_emit_orchestrates_workflow("p3", "test_meta_learning_pipeline_wiring", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "test_meta_learning_pipeline_wiring", "healing_dispatch")
_emit_invokes_evaluation("p3", "test_meta_learning_pipeline_wiring", "evaluation_signal")
_emit_records_telemetry_event("p4", "test_meta_learning_pipeline_wiring", "telemetry_event")
_emit_captures_evaluation_metric("p4", "test_meta_learning_pipeline_wiring", "eval_metric")
_emit_stores_embedding("p4", "test_meta_learning_pipeline_wiring", "embedding_store")
_emit_updates_meta_learning_state("p4", "test_meta_learning_pipeline_wiring", "meta_learning")
_emit_links_execution_to_snapshot("p4", "test_meta_learning_pipeline_wiring", "exec_snapshot_link")
...
_emit_emits_metric_event("test_meta_learning_pipeline_wiring", "p4obs", "metric_1")
_emit_emits_metric_event("test_meta_learning_pipeline_wiring", "p4obs", "metric_2")
_emit_emits_metric_event("test_meta_learning_pipeline_wiring", "p4obs", "metric_3")
_emit_emits_metric_event("test_meta_learning_pipeline_wiring", "p4obs", "metric_4")
_emit_emits_metric_event("test_meta_learning_pipeline_wiring", "p4obs", "metric_5")
_emit_emits_metric_event("test_meta_learning_pipeline_wiring", "p4obs", "metric_6")
_emit_records_incident_event("test_meta_learning_pipeline_wiring", "p4obs", "incident")
_emit_captures_runtime_anomaly("test_meta_learning_pipeline_wiring", "p4obs", "anomaly")
_emit_writes_observability_log("test_meta_learning_pipeline_wiring", "p4obs", "obs_log")
_emit_updates_monitoring_state("test_meta_learning_pipeline_wiring", "p4obs", "mon_state")
_emit_triggers_alert("test_meta_learning_pipeline_wiring", "p4obs", "alert")
_emit_links_incident_trace("test_meta_learning_pipeline_wiring", "p4obs", "trace_link")
_emit_captures_pattern("test_meta_learning_pipeline_wiring", "p3lm", "pattern")
_emit_records_learning_event("test_meta_learning_pipeline_wiring", "p3lm", "learning_event")
_emit_writes_learning_snapshot("test_meta_learning_pipeline_wiring", "p3lm", "snapshot")
_emit_feeds_meta_learning("test_meta_learning_pipeline_wiring", "p3lm", "meta_feed")
_emit_updates_routing_strategy("test_meta_learning_pipeline_wiring", "p3lm", "routing")
_emit_improves_agent_policy("test_meta_learning_pipeline_wiring", "p3lm", "policy")
_emit_stores_learning_state("test_meta_learning_pipeline_wiring", "p3lm", "state")
_emit_records_execution_trace("test_meta_learning_pipeline_wiring", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("test_meta_learning_pipeline_wiring", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("test_meta_learning_pipeline_wiring", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("test_meta_learning_pipeline_wiring", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("test_meta_learning_pipeline_wiring", "L4_STATE", "p2_trace_5")
_emit_reads_environ("test_meta_learning_pipeline_wiring", "env_read", "p2_env_1")
_emit_reads_environ("test_meta_learning_pipeline_wiring", "env_read", "p2_env_2")
_emit_reads_runtime_state("test_meta_learning_pipeline_wiring", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("test_meta_learning_pipeline_wiring", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "test_meta_learning_pipeline_wiring", "context_pull")
_emit_pulls_context("p1", "test_meta_learning_pipeline_wiring", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "test_meta_learning_pipeline_wiring", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "test_meta_learning_pipeline_wiring", "uwg_term_2")
_emit_writes_through("p1", "test_meta_learning_pipeline_wiring", "write_through")
_emit_writes_through("p1", "test_meta_learning_pipeline_wiring", "write_through_2")
_emit_validated_by_safety_plane("p1", "test_meta_learning_pipeline_wiring", "safety_validation")
_emit_invokes_eval("p1", "test_meta_learning_pipeline_wiring", "eval_call")
_emit_proposal_commits_routing("p1", "test_meta_learning_pipeline_wiring", "routing_commit")
_emit_escalates_to_human("p1", "test_meta_learning_pipeline_wiring", "human_escalation")
_emit_routes_through("p1", "test_meta_learning_pipeline_wiring", "route_through")
_emit_checks_agent_registry("p1", "test_meta_learning_pipeline_wiring", "agent_registry")
_emit_validates_agent_capability("p1", "test_meta_learning_pipeline_wiring", "capability")
_emit_dispatches_execution_plan("p1", "test_meta_learning_pipeline_wiring", "exec_plan")
_emit_agent_executes_agent("p1", "test_meta_learning_pipeline_wiring", "sub_agent")
_emit_routes_to_agent("p1", "test_meta_learning_pipeline_wiring", "target_agent")
_emit_verifies_policy("p1", "test_meta_learning_pipeline_wiring", "policy_check")
_emit_observes_runtime_state("p1", "test_meta_learning_pipeline_wiring", "runtime_state")
_emit_verifies_boundary("p1", "test_meta_learning_pipeline_wiring", "boundary_check")
_emit_transcripts_response("p1", "test_meta_learning_pipeline_wiring", "transcript")
_emit_hard_fails_untranscripted("p1", "test_meta_learning_pipeline_wiring")
_emit_gated_by_confidence("p1", "test_meta_learning_pipeline_wiring", "confidence_gate")
