...
_emit_applies_guardrail("p0", "test_llm_workflow_creative", "p0_governance")
_emit_reads_policy_state("p0", "test_llm_workflow_creative", "policy_binding")
_emit_routes_to_agent("p1", "test_llm_workflow_creative", "test")
_emit_orchestrates_workflow("p1", "test_llm_workflow_creative", "test")
_emit_dispatches_execution_plan("p1", "test_llm_workflow_creative", "test")
...
_emit_emits_metric_event("test_llm_workflow_creative", "p4obs", "metric_2")
_emit_emits_metric_event("test_llm_workflow_creative", "p4obs", "metric_3")
_emit_emits_metric_event("test_llm_workflow_creative", "p4obs", "metric_4")
_emit_emits_metric_event("test_llm_workflow_creative", "p4obs", "metric_5")
_emit_emits_metric_event("test_llm_workflow_creative", "p4obs", "metric_6")
_emit_records_incident_event("test_llm_workflow_creative", "p4obs", "incident")
_emit_captures_runtime_anomaly("test_llm_workflow_creative", "p4obs", "anomaly")
_emit_writes_observability_log("test_llm_workflow_creative", "p4obs", "obs_log")
_emit_updates_monitoring_state("test_llm_workflow_creative", "p4obs", "mon_state")
_emit_triggers_alert("test_llm_workflow_creative", "p4obs", "alert")
_emit_links_incident_trace("test_llm_workflow_creative", "p4obs", "trace_link")
_emit_captures_pattern("test_llm_workflow_creative", "p3lm", "pattern")
_emit_records_learning_event("test_llm_workflow_creative", "p3lm", "learning_event")
_emit_writes_learning_snapshot("test_llm_workflow_creative", "p3lm", "snapshot")
_emit_feeds_meta_learning("test_llm_workflow_creative", "p3lm", "meta_feed")
_emit_updates_routing_strategy("test_llm_workflow_creative", "p3lm", "routing")
_emit_improves_agent_policy("test_llm_workflow_creative", "p3lm", "policy")
_emit_stores_learning_state("test_llm_workflow_creative", "p3lm", "state")
_emit_records_execution_trace("test_llm_workflow_creative", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("test_llm_workflow_creative", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("test_llm_workflow_creative", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("test_llm_workflow_creative", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("test_llm_workflow_creative", "L4_STATE", "p2_trace_5")
_emit_reads_environ("test_llm_workflow_creative", "env_read", "p2_env_1")
_emit_reads_environ("test_llm_workflow_creative", "env_read", "p2_env_2")
_emit_reads_runtime_state("test_llm_workflow_creative", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("test_llm_workflow_creative", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "test_llm_workflow_creative", "context_pull")
_emit_pulls_context("p1", "test_llm_workflow_creative", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "test_llm_workflow_creative", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "test_llm_workflow_creative", "uwg_term_2")
_emit_writes_through("p1", "test_llm_workflow_creative", "write_through")
_emit_writes_through("p1", "test_llm_workflow_creative", "write_through_2")
...
_emit_authorize_and_execute("p2", "test_llm_workflow_creative", "execution_auth")
_emit_validates_capability("p2", "test_llm_workflow_creative", "capability_check")
_emit_routes_to_capability("p2", "test_llm_workflow_creative", "capability_route")
_emit_writes_via_uwg("p2", "test_llm_workflow_creative", "uwg_write")
_emit_blocks_direct_write("p2", "test_llm_workflow_creative", "direct_write_block")
_emit_records_tool_invocation("p2", "test_llm_workflow_creative", "tool_invocation")
_emit_captures_execution_output("p2", "test_llm_workflow_creative", "exec_output")
_emit_dispatches_agent("p3", "test_llm_workflow_creative", "agent_dispatch")
_emit_coordinates_agents("p3", "test_llm_workflow_creative", "agent_coordination")
_emit_records_workflow_lineage("p3", "test_llm_workflow_creative", "workflow_lineage")
_emit_records_healing_outcome("p3", "test_llm_workflow_creative", "healing_outcome")
_emit_escalates_failure("p3", "test_llm_workflow_creative", "failure_escalation")
_emit_orchestrates_workflow("p3", "test_llm_workflow_creative", "workflow_orchestration")
_emit_dispatches_healing_run("p3", "test_llm_workflow_creative", "healing_dispatch")
_emit_invokes_evaluation("p3", "test_llm_workflow_creative", "evaluation_signal")
_emit_records_telemetry_event("p4", "test_llm_workflow_creative", "telemetry_event")
_emit_captures_evaluation_metric("p4", "test_llm_workflow_creative", "eval_metric")
_emit_stores_embedding("p4", "test_llm_workflow_creative", "embedding_store")
_emit_updates_meta_learning_state("p4", "test_llm_workflow_creative", "meta_learning")
_emit_links_execution_to_snapshot("p4", "test_llm_workflow_creative", "exec_snapshot_link")
