...
def test_canonical_payload_stability_pass():
    ...
    print(f"PASS: payload_digest_deterministic={replay_hash_1 == replay_hash_2 and canonical_payload_hash_1 == canonical_payload_hash_2}")
...
def test_canonical_payload_drift_detection_fail():
    ...
    assert mutated_canonical_payload_hash != original_canonical_payload_hash, "canonical_payload_hash must change"
    ...
    print(f"FAIL: drift_detected={mutated_replay_hash != original_replay_hash and mutated_canonical_payload_hash != original_canonical_payload_hash}")
...
def test_negative_control_canonical_payload_disabled():
    ...
    assert disabled_report["canonical_payload_hash"] == original_canonical_hash, "Canonical hash should be accessible"
    ...
    print(f"NEGATIVE CONTROL: canonical_payload_accessible={disabled_report['canonical_payload_hash'] == original_canonical_hash}")
