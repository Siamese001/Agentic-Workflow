...
_emit_escalates_to_human("p1", "test_handshake_state_machine", "human_escalation")
_emit_routes_through("p1", "test_handshake_state_machine", "route_through")
_emit_agent_executes_agent("p1", "test_handshake_state_machine", "sub_agent")
_emit_verifies_policy("p1", "test_handshake_state_machine", "policy_check")
_emit_observes_runtime_state("p1", "test_handshake_state_machine", "runtime_state")
_emit_verifies_boundary("p1", "test_handshake_state_machine", "boundary_check")
_emit_transcripts_response("p1", "test_handshake_state_machine", "transcript")
_emit_hard_fails_untranscripted("p1", "test_handshake_state_machine")
_emit_gated_by_confidence("p1", "test_handshake_state_machine", "confidence_gate")
