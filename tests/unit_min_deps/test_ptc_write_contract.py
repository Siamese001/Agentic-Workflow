...
class TestPTCWriteContract:
    ...
    def test_future_tool_contract_enforcement_ready(self):
        ...
        assert 'enforce_protected_root' in content, (
            "write_gateway must import and use enforce_protected_root"
        )
                            ...
                            for child in ast.walk(node):
                                if isinstance(child, ast.Call):
                                    ...
                                    if isinstance(child.func, ast.Attribute):
                                        ...
                                        if attr_name in ['write_text', 'write_bytes', 'unlink', 'mkdir', 'rmdir']:
