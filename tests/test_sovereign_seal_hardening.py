...
class TestAgentHardening(unittest.TestCase):
    ...
    def test_mro_root_injection(self):
        ...
        self.assertEqual(hop1_mro[1].__name__, 'LICAgentBase', "HOP1 MRO Violation: LICAgentBase must be second in MRO")
        self.assertEqual(hop2_mro[1].__name__, 'LICAgentBase', "HOP2 MRO Violation: LICAgentBase must be second in MRO")
    ...
    def test_sovereign_seal_immutability(self):
        ...
        self.assertIn("Sovereign Seal Active", str(cm.exception), "Seal failed to block config modification")
    ...
    def test_sovereign_seal_hop2(self):
        ...
        self.assertIn("Sovereign Seal Active", str(cm.exception), "HOP2 Seal failed to block mutation")
    ...
    def test_defensive_config_resolution(self):
        ...
        try:
            ...
            self.assertIsNotNone(agent.vector_params, "Vector params should be loaded regardless of config key name")
    ...
    def test_seal_timing(self):
        ...
        self.assertIsNotNone(hop2.critique_params, "Critique params must be set before seal engages")
