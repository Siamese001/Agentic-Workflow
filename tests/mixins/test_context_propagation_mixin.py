import unittest
import asyncio
from agentic_core.utils.core_extensions.context_propagation_mixin import (
...
class TestContextPropagationMixin(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_tc22_async_isolation(self):
        ...
        self.assertNotEqual(traces[0], traces[1], "Trace IDs must be isolated across concurrent tasks")
