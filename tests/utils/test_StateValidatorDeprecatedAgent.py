...
class TestStateValidatorDeprecatedAgent:
    ...
    def agent(self):
        ...
        return StateValidatorDeprecatedAgent()
    
    def test_instantiation(self, agent):
        """Test that agent can be instantiated."""
        assert agent is not None
        assert isinstance(agent, StateValidatorDeprecatedAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'StateValidatorDeprecatedAgent'
