...
from canon_validator_engine import execute_cost_governed_vulnerability_check, execute_dependency_refactor
...
""")
    ...
    def test_cross_layer_error_propagation(self, mock_validator_with_all_dependencies):
        ...
        validator.pinecone.query.side_effect = Exception("Pinecone unavailable")
        validator.llm.generate_plan.return_value = {"status": "valid", "reasoning": "OK"}
