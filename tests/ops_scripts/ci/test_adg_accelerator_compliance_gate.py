...
class TestGetStagedFiles:
    ...
    def test_returns_list(self):
        ...
        from ops_scripts.ci.adg_accelerator_compliance_gate import _get_staged_files, ROOT
...
class TestRuffSeverityGate:
    ...
    def test_run_ruff_returns_int(self):
        ...
        from ops_scripts.ci.ruff_severity_gate import _run_ruff, _BLOCKING_RULES
