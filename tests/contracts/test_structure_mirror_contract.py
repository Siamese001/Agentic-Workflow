...
KNOWN_MISSING_DEBT: frozenset[str] = frozenset(
    {
        "agentic_core/L0_maintenance/enforcement/execution_gateway.py",
        "agentic_core/L0_maintenance/enforcement/governance_contracts.py",
        "agentic_core/L0_maintenance/enforcement/traceability_contracts.py",
        "agentic_core/L0_maintenance/enforcement/crypto_trust_contracts.py",
        "agentic_core/L0_maintenance/enforcement/boundary_contracts.py",
        "agentic_core/L0_maintenance/enforcement/runtime_guard.py",
        ...
        "agentic_core/L0_maintenance/types/routing_contracts.py",
        "agentic_core/L0_maintenance/types/determinism_contracts.py",
        "agentic_core/L0_maintenance/types/determinism_types.py",
        "agentic_core/L0_maintenance/types/governance_types.py",
        "agentic_core/L0_maintenance/types/traceability_types.py",
        "agentic_core/L0_maintenance/types/crypto_trust_types.py",
        "agentic_core/L0_maintenance/types/boundary_types.py",
        "agentic_core/L0_maintenance/types/routing_artifact_types.py",
