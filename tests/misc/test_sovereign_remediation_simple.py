...
def test_method_source():
    ...
    for module_path, class_name in AGENTS_TO_TEST:
        try:
            ...
            except OSError:  # guardian: allow-silent-swallower    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
