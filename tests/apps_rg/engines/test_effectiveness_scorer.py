...
class TestEffectivenessScorerInitialization:
...
class TestEffectivenessScorerCoreMethods:
...
class TestEffectivenessScorerEdgeCases:
...
class TestEffectivenessScorerTypeBoundaries:
