"""
Unit tests for ExecutiveSummaryOutputAgent
...
class TestExecutiveSummaryOutputAgentInitialization:
...
class TestExecutiveSummaryOutputAgentCoreMethods:
...
class TestExecutiveSummaryOutputAgentEdgeCases:
...
class TestExecutiveSummaryOutputAgentTypeBoundaries:
