...
_emit_escalates_to_human("p1", "test_run_grand_unification_tests", "human_escalation")
_emit_routes_through("p1", "test_run_grand_unification_tests", "route_through")
_emit_checks_agent_registry("p1", "test_run_grand_unification_tests", "agent_registry")
_emit_validates_agent_capability("p1", "test_run_grand_unification_tests", "capability")
_emit_dispatches_execution_plan("p1", "test_run_grand_unification_tests", "exec_plan")
_emit_agent_executes_agent("p1", "test_run_grand_unification_tests", "sub_agent")
_emit_routes_to_agent("p1", "test_run_grand_unification_tests", "target_agent")
_emit_verifies_policy("p1", "test_run_grand_unification_tests", "policy_check")
_emit_observes_runtime_state("p1", "test_run_grand_unification_tests", "runtime_state")
_emit_verifies_boundary("p1", "test_run_grand_unification_tests", "boundary_check")
_emit_transcripts_response("p1", "test_run_grand_unification_tests", "transcript")
_emit_hard_fails_untranscripted("p1", "test_run_grand_unification_tests")
_emit_gated_by_confidence("p1", "test_run_grand_unification_tests", "confidence_gate")
