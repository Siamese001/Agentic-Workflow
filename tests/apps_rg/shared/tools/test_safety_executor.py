...
class TestSafetyExecutorInitialization:
...
class TestSafetyExecutorCoreMethods:
...
class TestSafetyExecutorEdgeCases:
...
class TestSafetyExecutorTypeBoundaries:
