"""
Unit tests for AdjustSectionWeights
...
class TestAdjustSectionWeightsInitialization:
...
class TestAdjustSectionWeightsCoreMethods:
...
class TestAdjustSectionWeightsEdgeCases:
...
class TestAdjustSectionWeightsTypeBoundaries:
