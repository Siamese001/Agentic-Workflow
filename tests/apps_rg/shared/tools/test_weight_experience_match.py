"""
Unit tests for WeightExperienceMatch
...
class TestWeightExperienceMatchInitialization:
...
class TestWeightExperienceMatchCoreMethods:
...
class TestWeightExperienceMatchEdgeCases:
...
class TestWeightExperienceMatchTypeBoundaries:
