...
def test_provider_prompt_forbids_markdown_fences():
    from apps_rg.runtime.sections.executive_summary_lane import build_prompt_messages
...
def test_l2_resume_voice_rejects_first_person():
    from apps_rg.runtime.sections.executive_summary_lane import check_l2_resume_voice
