...
class TestLogReaderAgentInitialization:
...
class TestLogReaderAgentCoreMethods:
...
class TestLogReaderAgentEdgeCases:
...
class TestLogReaderAgentTypeBoundaries:
