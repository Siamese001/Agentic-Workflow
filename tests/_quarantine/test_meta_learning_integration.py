...
def reset_all_singletons():
    ...
    import agentic_core.L1_cognition.reasoning.engine.cache_manager as csm
    import agentic_core.L1_cognition.reasoning.engine.domain_manager as dcm
...
class TestFullStackIntegration:
    ...
    def test_full_healing_workflow(self):
        ...
        from agentic_core.L1_cognition.reasoning.engine.cache_manager import (
            get_cache_strategy_manager,
        )
        from agentic_core.L1_cognition.reasoning.engine.meta_client import (
            MetaLearningClient,
            get_meta_learning_client,
        )
        from agentic_core.L1_cognition.reasoning.engine.meta_observability import (
    ...
    def test_cross_domain_pattern_sharing(self):
        ...
        from agentic_core.L1_cognition.reasoning.engine.domain_manager import (
