...
PROTECTED_SUFFIXES = (
    ...
    "Registry.py", "Engine.py", "Model.py"
)
...
class TestRemediationLogic:
    ...
    def test_verb_heuristic_identification(self, disable_path_shield):
        ...
        candidates = [
            "FixAllAgenticImports", "RunHardenedJob", 
            "UtilitiesFixAllViolations", "AnalyzeDashboardColorBug"
        ]
        for c in candidates:
    ...
    def test_protection_heuristic(self, disable_path_shield):
        ...
        protected = [
            "StrategicPlannerAgent.py", "CanonValidatorEngine.py",
            "SecureErrorHandlerAgent.py", "DataProcessorFactory.py"
        ]
        for p in protected:
