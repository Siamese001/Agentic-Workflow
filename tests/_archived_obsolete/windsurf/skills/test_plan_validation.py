"""Archived tests for deleted Cursor plan-validation/main.py skill.

Archived by cursor-deletion-final-cleanup-c7d4a9 W3. The live plan SSOT is
`plans/`, and this deleted skill's API no longer exists.
