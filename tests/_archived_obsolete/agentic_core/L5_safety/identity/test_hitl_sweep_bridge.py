"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.identity.hitl_sweep_bridge` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L5_safety.identity.hitl_sweep_bridge"
