"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.identity.llm_gateway_v4` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L5_safety.identity.llm_gateway_v4"
