"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.exit_eval.disposition` (fanin=7).
...
MODULE_PATH = "agentic_core.L3_orchestration.exit_eval.disposition"
