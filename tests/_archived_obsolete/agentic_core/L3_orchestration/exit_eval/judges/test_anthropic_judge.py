"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.exit_eval.judges.anthropic_judge` (fanin=3).
...
MODULE_PATH = "agentic_core.L3_orchestration.exit_eval.judges.anthropic_judge"
