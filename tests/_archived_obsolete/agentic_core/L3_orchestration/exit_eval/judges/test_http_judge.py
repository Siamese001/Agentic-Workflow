"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.exit_eval.judges.http_judge` (fanin=2).
...
MODULE_PATH = "agentic_core.L3_orchestration.exit_eval.judges.http_judge"
