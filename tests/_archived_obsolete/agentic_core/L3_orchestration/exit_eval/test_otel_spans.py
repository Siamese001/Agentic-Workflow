"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.exit_eval.otel_spans` (fanin=6).
...
MODULE_PATH = "agentic_core.L3_orchestration.exit_eval.otel_spans"
