"""Tests for the Windsurf post_cursor_agent_next_step_miss_detector hook.
...
def _load_detector():
    path = REPO_ROOT / ".claude" / "governance/scripts" / "_legacy_windsurf" / "post_cursor_agent_next_step_miss_detector.py"
