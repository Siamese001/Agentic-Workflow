...
def test_parse_int_env(self: Any) -> None:
    ...
    VALUE: Any = int(os.environ.get('INT_VAR', '0'))
    assert VALUE == 42
...
def test_parse_list_env(self: Any) -> None:
    ...
    VALUE: Any = os.environ.get('LIST_VAR', '').split(',')
    assert VALUE == ['a', 'b', 'c']
