...
class TestSharedLayerRigor:
    ...
    def test_weight_hierarchy_integrity(self):
        ...
        shared_utils_weight = SOVEREIGN_TERRITORIES["apps_shared"]["ast_signals"]["apps_shared/utils"]["weight"]
        shared_core_weight = SOVEREIGN_TERRITORIES["apps_shared"]["ast_signals"]["apps_shared/core_components"]["weight"]
