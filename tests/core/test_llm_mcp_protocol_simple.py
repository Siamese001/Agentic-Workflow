    ...
    try:
        ...
        test_cases = [
            ...
            },
            {
                ...
                "args": ["Invalid/Timezone"],
                "should_fail": False,
                "description": "Invalid timezone"
            },
            {
                "tool": "convert_time",
                "args": ["UTC", "25:00", "Europe/London"],
                "should_fail": False,
        ...
        workflow_steps = [
            {
                "step": 1,
                "tool": "write_file",
                "args": ["/tmp/workflow_test.txt", "Step 1: Initial content"],
            ...
            },
            {
                "step": 3,
                "tool": "convert_time",
                "args": ["America/New_York", "09:00", "Asia/Tokyo"],
                "description": "Convert time to Tokyo"
            },
            {
                "step": 4,
                "tool": "read_text_file",
                "args": ["/tmp/workflow_test.txt"],
...
def test_mock_llm_response_format():
    ...
    try:
        ...
        tool_results = [
            ...
            '{"datetime": "2025-12-15T11:35:58+00:00"}',
        ...
        for result in tool_results:
            try:
                # All results must be JSON serializable or strings
