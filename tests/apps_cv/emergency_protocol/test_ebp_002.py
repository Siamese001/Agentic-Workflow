...
class TestEBP002:
    ...
    def test_codebase_reversion(self, validator):
        ...
        git_history = [
            {"commit_id": "abc123", "message": "Last good state",
                "timestamp": "2025-12-15T10:00:00Z"},
            {"commit_id": "def456", "message": "Broken change",
                "timestamp": "2025-12-15T11:00:00Z"},
            {"commit_id": "ghi789", "message": "Current broken state",
    ...
    def test_quota_freeze(self, validator):
        ...
        def mock_freeze_quota():
            ...
            redis_state["quota:frozen_at"] = datetime.now(
