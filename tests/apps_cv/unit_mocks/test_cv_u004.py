...
class TestCVU004:
    ...
    def test_memeory_payload_schema_compliance(self, validator):
        ...
        mock_payload = [{
            ...
            "contents": [validation_result.get("reasoning", "Valid code")],
    ...
    def test_complex_nested_payload_handling(self, validator):
        ...
        mock_payload = [{
            ...
            "contents": [json.dumps(complex_violation)],
            "corpusNames": ["canon_validator"],
    ...
    def test_payload_data_integrity(self, validator):
        ...
        original_data = {
            "status": "repaired",
            "reasoning": "Fixed security issue",
            "repaired_code": "def safe_function():\n    pass",
            "metadata": {
                "validation_time": datetime.now(timezone.utc).isoformat(),
                "validator_version": "1.0.0",
                "layers_checked": ["L1", "L2", "L3", "L4", "L5"],
                "violations_count": 1
            }
        }
        ...
        mock_payload = [{
            "entityName": "validation_result",
            "contents": [json.dumps(original_data)],
            "corpusNames": ["canon_validator"],
    ...
    def test_payload_size_limits(self, validator):
        ...
        mock_payload = [{
            ...
            "contents": [json.dumps(large_violation)],
            "corpusNames": ["canon_validator"],
