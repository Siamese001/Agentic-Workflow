...
try:
    from system_learning.fingerprinting.engine import (  # noqa: F401
    ...
    _AVAILABLE = False
    FailureFingerprinter = None  # type: ignore[assignment,misc]
...
class TestEngineImportability:
    ...
    def test_failurefingerprinter_is_type(self) -> None:
        assert FailureFingerprinter is not None
