#!/usr/bin/env python3
"""
Test for test_purge_legacy_archive
...
def test_test_purge_legacy_archive_can_import():
    """Test that the module can be imported successfully."""
    try:
        mod = importlib.import_module("apps_lic.scripts.purge_legacy_archive")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module apps_lic.scripts.purge_legacy_archive: {e}")


def test_test_purge_legacy_archive_has_file_attribute():
    """Test that module has __file__ attribute."""
    try:
        mod = importlib.import_module("apps_lic.scripts.purge_legacy_archive")
        assert hasattr(mod, "__file__")
    except ImportError:
        pytest.skip("Cannot import module apps_lic.scripts.purge_legacy_archive")


def test_test_purge_legacy_archive_has_public_attributes():
