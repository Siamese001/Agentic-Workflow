"""
Unit tests for HallucinationDetectorValidator
...
class TestHallucinationDetectorValidatorInitialization:
...
class TestHallucinationDetectorValidatorCoreMethods:
...
class TestHallucinationDetectorValidatorEdgeCases:
...
class TestHallucinationDetectorValidatorTypeBoundaries:
