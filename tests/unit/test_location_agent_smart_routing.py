...
class TestLocationAgentSmartRouting:
    ...
    def mock_agent(self, tmp_path):
        ...
        with patch('agentic_core.L5_safety.validators.structure_blueprint.get_validated_project_root') as mock_validate:
            ...
            with patch.object(LocationAgent, '_validate_project_root'):
                ...
                with patch('agentic_core.domain.CoreIntegrityVerifier.CoreIntegrityVerifier.verify_core_integrity'):
                    with patch('agentic_core.base_agents.SovereignBaseAgent.SovereignBaseAgent.__post_init__'):
