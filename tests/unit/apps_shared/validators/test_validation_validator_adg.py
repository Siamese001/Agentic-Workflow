...
@pytest.mark.skipif(not _AVAILABLE, reason="validation_validator.py deps unavailable")
...
class TestValidation:
    def test_is_class(self):
        assert isinstance(Validation, type)
    def test_importable(self):
...
def test_module_importable():
    """Module validation_validator.py is importable (or deps unavailable)."""
