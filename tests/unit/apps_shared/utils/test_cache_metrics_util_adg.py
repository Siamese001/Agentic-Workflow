...
try:
    from apps_shared.utils.cache_metrics_util import (  # noqa: F401
        CacheMetrics,
        get_cache_metrics,
        MAX_RETRIES,
        DEFAULT_SLEEP,
...
@pytest.mark.skipif(not _AVAILABLE, reason="cache_metrics_util.py deps unavailable")
class TestCacheMetrics:
    def test_is_class(self):
        assert isinstance(CacheMetrics, type)
...
def test_module_importable():
    """Module cache_metrics_util.py is importable (or deps unavailable)."""
