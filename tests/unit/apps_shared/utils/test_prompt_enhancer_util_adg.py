...
class TestPromptEnhancer:
    ...
    def test_importable(self):
        assert PromptEnhancer is not None

@pytest.mark.skipif(not _AVAILABLE, reason="prompt_enhancer_util.py deps unavailable")
class TestGetPromptEnhancer:
...
@pytest.mark.skipif(not _AVAILABLE, reason="prompt_enhancer_util.py deps unavailable")
class TestEnhancePromptAdvanced:
    def test_is_callable(self):
...
def test_module_importable():
    """Module prompt_enhancer_util.py is importable (or deps unavailable)."""
