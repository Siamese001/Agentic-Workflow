"""
Unit tests for EmbedMessageTemplate
...
class TestEmbedMessageTemplateInitialization:
...
class TestEmbedMessageTemplateCoreMethods:
...
class TestEmbedMessageTemplateEdgeCases:
...
class TestEmbedMessageTemplateTypeBoundaries:
