"""
Unit tests for EmbedRecipientProfile
...
class TestEmbedRecipientProfileInitialization:
...
class TestEmbedRecipientProfileCoreMethods:
...
class TestEmbedRecipientProfileEdgeCases:
...
class TestEmbedRecipientProfileTypeBoundaries:
