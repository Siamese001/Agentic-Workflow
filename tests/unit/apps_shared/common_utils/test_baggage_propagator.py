"""
Unit tests for BaggagePropagator
...
class TestBaggagePropagatorInitialization:
...
class TestBaggagePropagatorCoreMethods:
...
class TestBaggagePropagatorEdgeCases:
...
class TestBaggagePropagatorTypeBoundaries:
