"""
Unit tests for UnderscoreVisitor
...
class TestUnderscoreVisitorInitialization:
...
class TestUnderscoreVisitorCoreMethods:
...
class TestUnderscoreVisitorEdgeCases:
...
class TestUnderscoreVisitorTypeBoundaries:
