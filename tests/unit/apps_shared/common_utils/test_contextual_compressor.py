...
class TestContextualCompressorInitialization:
...
class TestContextualCompressorCoreMethods:
...
class TestContextualCompressorEdgeCases:
...
class TestContextualCompressorTypeBoundaries:
