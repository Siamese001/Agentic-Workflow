"""
Unit tests for RuntimeObservabilityAgenticSpans
...
class TestRuntimeObservabilityAgenticSpansInitialization:
...
class TestRuntimeObservabilityAgenticSpansCoreMethods:
...
class TestRuntimeObservabilityAgenticSpansEdgeCases:
...
class TestRuntimeObservabilityAgenticSpansTypeBoundaries:
