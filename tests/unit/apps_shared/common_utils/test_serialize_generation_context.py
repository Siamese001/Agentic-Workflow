"""
Unit tests for SerializeGenerationContext
...
class TestSerializeGenerationContextInitialization:
...
class TestSerializeGenerationContextCoreMethods:
...
class TestSerializeGenerationContextEdgeCases:
...
class TestSerializeGenerationContextTypeBoundaries:
