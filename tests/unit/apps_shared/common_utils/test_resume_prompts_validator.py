"""
Unit tests for ResumePromptsValidator
...
class TestResumePromptsValidatorInitialization:
...
class TestResumePromptsValidatorCoreMethods:
...
class TestResumePromptsValidatorEdgeCases:
...
class TestResumePromptsValidatorTypeBoundaries:
