...
class TestRuntimeMetricsCollectorInitialization:
...
class TestRuntimeMetricsCollectorCoreMethods:
...
class TestRuntimeMetricsCollectorEdgeCases:
...
class TestRuntimeMetricsCollectorTypeBoundaries:
