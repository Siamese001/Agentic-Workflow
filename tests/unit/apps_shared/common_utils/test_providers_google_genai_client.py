"""
Unit tests for ProvidersGoogleGenaiClient
...
class TestProvidersGoogleGenaiClientInitialization:
...
class TestProvidersGoogleGenaiClientCoreMethods:
...
class TestProvidersGoogleGenaiClientEdgeCases:
...
class TestProvidersGoogleGenaiClientTypeBoundaries:
