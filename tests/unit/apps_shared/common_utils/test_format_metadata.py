...
class TestFormatMetadataInitialization:
...
class TestFormatMetadataCoreMethods:
...
class TestFormatMetadataEdgeCases:
...
class TestFormatMetadataTypeBoundaries:
