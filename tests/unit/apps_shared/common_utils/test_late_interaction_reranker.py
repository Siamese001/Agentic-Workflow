"""
Unit tests for LateInteractionReranker
...
class TestLateInteractionRerankerInitialization:
...
class TestLateInteractionRerankerCoreMethods:
...
class TestLateInteractionRerankerEdgeCases:
...
class TestLateInteractionRerankerTypeBoundaries:
