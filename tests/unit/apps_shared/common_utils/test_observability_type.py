"""
Unit tests for ObservabilityType
...
class TestObservabilityTypeInitialization:
...
class TestObservabilityTypeCoreMethods:
...
class TestObservabilityTypeEdgeCases:
...
class TestObservabilityTypeTypeBoundaries:
