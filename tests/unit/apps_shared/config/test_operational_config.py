"""
Unit tests for OperationalConfig
...
class TestOperationalConfigInitialization:
...
class TestOperationalConfigCoreMethods:
...
class TestOperationalConfigEdgeCases:
...
class TestOperationalConfigTypeBoundaries:
