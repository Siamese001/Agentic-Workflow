...
_emit_escalates_to_human("p1", "test_reasoning_output_adg", "human_escalation")
_emit_routes_through("p1", "test_reasoning_output_adg", "route_through")
_emit_checks_agent_registry("p1", "test_reasoning_output_adg", "agent_registry")
_emit_validates_agent_capability("p1", "test_reasoning_output_adg", "capability")
_emit_dispatches_execution_plan("p1", "test_reasoning_output_adg", "exec_plan")
_emit_agent_executes_agent("p1", "test_reasoning_output_adg", "sub_agent")
_emit_routes_to_agent("p1", "test_reasoning_output_adg", "target_agent")
_emit_verifies_policy("p1", "test_reasoning_output_adg", "policy_check")
_emit_observes_runtime_state("p1", "test_reasoning_output_adg", "runtime_state")
_emit_verifies_boundary("p1", "test_reasoning_output_adg", "boundary_check")
_emit_transcripts_response("p1", "test_reasoning_output_adg", "transcript")
_emit_hard_fails_untranscripted("p1", "test_reasoning_output_adg")
_emit_gated_by_confidence("p1", "test_reasoning_output_adg", "confidence_gate")
