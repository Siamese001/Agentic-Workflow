...
_emit_escalates_to_human("p1", "test_semantic_cache_deep", "human_escalation")
_emit_routes_through("p1", "test_semantic_cache_deep", "route_through")
_emit_checks_agent_registry("p1", "test_semantic_cache_deep", "agent_registry")
_emit_validates_agent_capability("p1", "test_semantic_cache_deep", "capability")
_emit_dispatches_execution_plan("p1", "test_semantic_cache_deep", "exec_plan")
_emit_agent_executes_agent("p1", "test_semantic_cache_deep", "sub_agent")
_emit_routes_to_agent("p1", "test_semantic_cache_deep", "target_agent")
_emit_verifies_policy("p1", "test_semantic_cache_deep", "policy_check")
_emit_observes_runtime_state("p1", "test_semantic_cache_deep", "runtime_state")
_emit_verifies_boundary("p1", "test_semantic_cache_deep", "boundary_check")
_emit_transcripts_response("p1", "test_semantic_cache_deep", "transcript")
_emit_hard_fails_untranscripted("p1", "test_semantic_cache_deep")
_emit_gated_by_confidence("p1", "test_semantic_cache_deep", "confidence_gate")
