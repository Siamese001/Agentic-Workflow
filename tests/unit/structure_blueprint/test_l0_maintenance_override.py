"""
Invariant test: L0_maintenance LAYER_OVERRIDES must encode Model A
...
class TestL0MaintenanceOverrideModelA:
    """Assert LAYER_OVERRIDES['L0_maintenance'] encodes Model A exactly."""
    ...
    @staticmethod
    def _l0() -> dict:
        return dict(LAYER_OVERRIDES["L0_maintenance"])

    # ------------------------------------------------------------------
    # 1. Key existence
    # ------------------------------------------------------------------
    def test_layer_overrides_has_l0_maintenance(self):
        assert "L0_maintenance" in LAYER_OVERRIDES
    ...
    def test_routing_rules_key_exists(self):
        assert "routing_rules" in self._l0(), "L0_maintenance must declare routing_rules"
