"""Enhanced behavioral tests for agentic_core.agents.types.agent_execution_profile_types."""
...
def test_compute_registry_digest_is_callable():
    """compute_registry_digest is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
