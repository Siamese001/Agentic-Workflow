"""Enhanced behavioral tests for agentic_core.adg.client.__init__."""
from __future__ import annotations

import importlib
import pytest

MODULE_PATH = "agentic_core.adg.client.__init__"
...
def test_adgmcpclient_is_instantiable():
    """ADGMCPClient can be instantiated (if it's a class)."""
    try:
        mod = importlib.import_module(MODULE_PATH)
