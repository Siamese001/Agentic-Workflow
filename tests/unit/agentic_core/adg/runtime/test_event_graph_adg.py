"""Enhanced behavioral tests for agentic_core.adg.runtime.event_graph."""
...
def test_agentlooprecorder_is_instantiable():
    """AgentLoopRecorder can be instantiated (if it's a class)."""
    try:
        mod = importlib.import_module(MODULE_PATH)
