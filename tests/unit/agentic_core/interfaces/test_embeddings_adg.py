"""Enhanced behavioral tests for agentic_core.interfaces.embeddings."""
...
def test_similarityresult_is_instantiable():
    """SimilarityResult can be instantiated (if it's a class)."""
    try:
        mod = importlib.import_module(MODULE_PATH)
