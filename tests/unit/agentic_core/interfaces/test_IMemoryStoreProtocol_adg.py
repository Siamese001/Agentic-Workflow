"""Enhanced behavioral tests for agentic_core.interfaces.IMemoryStoreProtocol."""
from __future__ import annotations

import importlib
import pytest

MODULE_PATH = "agentic_core.interfaces.IMemoryStoreProtocol"
...
def test_imemorystoreprotocol_is_instantiable():
    """IMemoryStoreProtocol can be instantiated (if it's a class)."""
    try:
        mod = importlib.import_module(MODULE_PATH)
        cls = getattr(mod, class_name)
    except (ImportError, AttributeError) as e:
