...
#  # MOVED: from agentic_core.interfaces.determinism import DETERMINISM_EXCLUDED_FIELDS
#  # MOVED: from agentic_core.L_CONTRACTS.lifecycle_trace_contract import (
    _emit_agent_executes_agent,
...
# REMOVED: _emit_pulls_context("p1", "test_determinism_adg", "context_pull_2")
# REMOVED: _emit_execution_terminates_at_uwg("p1", "test_determinism_adg", "uwg_term")
# REMOVED: _emit_execution_terminates_at_uwg("p1", "test_determinism_adg", "uwg_term_2")
# REMOVED: _emit_writes_through("p1", "test_determinism_adg", "write_through")
# REMOVED: _emit_writes_through("p1", "test_determinism_adg", "write_through_2")
