...
class TestTerritoryIntegrity(unittest.TestCase):
    ...
    def test_json_payload_format(self):
        ...
        self.assertIn("sitting in prompt_governance root", violation["message"], "Message should be descriptive")
    ...
    def test_empty_territory_grace(self):
        ...
        self.assertEqual(len(report["territory_root_files"]), 0, "Should detect no violations in clean territory")
    ...
    def test_approved_subfolders_ignored(self):
        ...
        self.assertEqual(len(report["territory_root_files"]), 3, "Should only detect root files, not subfolder files")
    ...
    def test_multiple_territories_isolation(self):
        ...
        self.assertEqual(len(report_pg["territory_root_files"]), 3, "prompt_governance should have 3 violations")
        self.assertEqual(len(report_other["territory_root_files"]), 1, "other_territory should have 1 violation")
