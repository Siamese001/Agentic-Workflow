...
class TestIntegrityScope(unittest.TestCase):
    def test_integrity_respects_territory(self):
        ...
        with patch('agentic_core.L5_safety.validators.ArchitectureGovernorAgent.ArchitectureGovernorAgent') as MockGov:
            ...
            mock_instance.run_audit.assert_called_once_with(target_territories=["prompt_governance"])
