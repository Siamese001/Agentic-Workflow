...
ADG import-hygiene is covered separately by test_invariant_registry_adg.py.
...
@pytest.mark.skipif(not _AVAILABLE, reason="invariant_registry.py deps unavailable")
class TestValidateInvariantRegistryFunction:
    def test_is_callable(self):
        assert callable(validate_invariant_registry)

    def test_has_return_annotation(self):
        import inspect
        sig = inspect.signature(validate_invariant_registry)
