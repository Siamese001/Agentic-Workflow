...
@pytest.mark.skipif(not _AVAILABLE, reason="detect_template_drift.py deps unavailable")
...
class TestDetectTemplateDrift:
    def test_is_callable(self):
        assert callable(detect_template_drift)
...
def test_module_importable():
    """Module detect_template_drift.py is importable (or deps unavailable)."""
