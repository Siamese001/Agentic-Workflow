"""ADG importability contract for agentic_core/prompt_governance/contracts/__init__.py.
...
try:
    import agentic_core.prompt_governance.contracts.__init__ as _mod  # noqa: F401
    _AVAILABLE = True
except Exception:
    _AVAILABLE = False
    _mod = None
