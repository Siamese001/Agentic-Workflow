...
class TestQueryTerminalHardening(unittest.TestCase):
    ...
    def test_high_frequency_execution(self):
        ...
        with patch("agentic_core.L2_execution.reasoning.query_runtime.execute_sql", return_value="ok"):
            for _ in range(10):
    ...
    def test_concurrent_animation_thread_isolation(self):
        ...
        with patch("agentic_core.L2_execution.reasoning.query_runtime.Progress") as mock_progress_class:
