"""Runtime-hardened public-surface tests for vigilance seam."""
...
MODULE_CANDIDATES = ["agentic_core.L0_routing.seams.vigilance_seam"]
CLASS_CANDIDATES = ["LayerSegment", "VigilanceEventArtifact"]
CALLABLE_CANDIDATES = ["get_vigilance_event_artifact", "get_vigilance_severity", "load_vigilance_types"]
