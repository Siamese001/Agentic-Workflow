"""Enhanced behavioral tests for agentic_core.L0_routing.seams.safety_kernel_seam."""
...
def test_get_classification_cache_context_is_callable():
    """get_classification_cache_context is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
        func = getattr(mod, func_name)
    except (ImportError, AttributeError) as e:
