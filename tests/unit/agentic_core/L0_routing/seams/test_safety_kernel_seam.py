"""Runtime-hardened public-surface tests for safety kernel seam."""
...
MODULE_CANDIDATES = ["agentic_core.L0_routing.seams.safety_kernel_seam"]
CLASS_CANDIDATES = ["LayerSegment", "SafetyKernelContext"]
CALLABLE_CANDIDATES = ["get_classification_cache_context", "load_classification_kernel"]
