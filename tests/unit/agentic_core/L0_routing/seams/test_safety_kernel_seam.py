...
ADG import-hygiene is covered separately by test_safety_kernel_seam_adg.py.
...
@pytest.mark.skipif(not _AVAILABLE, reason="safety_kernel_seam.py deps unavailable")
class TestLoadClassificationKernelFunction:
    def test_is_callable(self):
        assert callable(load_classification_kernel)

@pytest.mark.skipif(not _AVAILABLE, reason="safety_kernel_seam.py deps unavailable")
class TestGetClassificationCacheContextFunction:
    def test_is_callable(self):
