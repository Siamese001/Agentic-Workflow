"""Runtime-hardened public-surface tests for BootstrapAgent."""
...
MODULE_CANDIDATES = ["bootstrap_agent", "BootstrapAgent"]
CLASS_CANDIDATES = ["BootstrapAgent", "BootstrapAgent"]
VALIDATOR_CANDIDATES = ["validate_bootstrap_agent", "validate_BootstrapAgent"]
