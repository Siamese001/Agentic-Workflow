"""Enhanced behavioral tests for agentic_core.L0_routing.reasoning.RootCustomsAgent."""
...
def test_astanalyzer_is_instantiable():
    """ASTAnalyzer can be instantiated (if it's a class)."""
    try:
        mod = importlib.import_module(MODULE_PATH)
