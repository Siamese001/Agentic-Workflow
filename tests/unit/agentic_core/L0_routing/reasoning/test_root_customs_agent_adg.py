"""Runtime-hardened public-surface tests for root customs agent adg."""
...
MODULE_CANDIDATES = ["root_customs_agent_adg"]
CLASS_CANDIDATES = ["RootCustomsAgentAdg"]
VALIDATOR_CANDIDATES = ["validate_root_customs_agent_adg"]
