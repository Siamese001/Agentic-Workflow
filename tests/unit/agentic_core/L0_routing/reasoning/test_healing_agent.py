"""Runtime-hardened public-surface tests for healing agent."""
...
MODULE_CANDIDATES = ["healing_agent"]
CLASS_CANDIDATES = ["HealingAgent"]
VALIDATOR_CANDIDATES = ["validate_healing_agent"]
