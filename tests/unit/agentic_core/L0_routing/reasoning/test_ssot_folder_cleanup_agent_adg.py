"""Runtime-hardened public-surface tests for ssot folder cleanup agent adg."""
...
MODULE_CANDIDATES = ["ssot_folder_cleanup_agent_adg"]
CLASS_CANDIDATES = ["SsotFolderCleanupAgentAdg"]
VALIDATOR_CANDIDATES = ["validate_ssot_folder_cleanup_agent_adg"]
