"""Runtime-hardened public-surface tests for core control spine."""
...
MODULE_CANDIDATES = ["core_control_spine"]
CLASS_CANDIDATES = ["CoreControlSpine"]
VALIDATOR_CANDIDATES = ["validate_core_control_spine"]
