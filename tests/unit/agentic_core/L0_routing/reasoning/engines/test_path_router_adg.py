"""Runtime-hardened public-surface tests for path router adg."""
...
MODULE_CANDIDATES = ["path_router_adg"]
CLASS_CANDIDATES = ["PathRouterAdg"]
VALIDATOR_CANDIDATES = ["validate_path_router_adg"]
