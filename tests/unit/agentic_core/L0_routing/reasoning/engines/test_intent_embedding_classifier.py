"""Runtime-hardened public-surface tests for intent embedding classifier."""
...
MODULE_CANDIDATES = ["intent_embedding_classifier"]
CLASS_CANDIDATES = ["IntentEmbeddingClassifier"]
VALIDATOR_CANDIDATES = ["validate_intent_embedding_classifier"]
