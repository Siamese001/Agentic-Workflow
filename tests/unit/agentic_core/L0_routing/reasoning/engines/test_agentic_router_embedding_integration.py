"""Runtime-hardened public-surface tests for agentic router embedding integration."""
...
MODULE_CANDIDATES = ["agentic_router_embedding_integration"]
CLASS_CANDIDATES = ["AgenticRouterEmbeddingIntegration"]
VALIDATOR_CANDIDATES = ["validate_agentic_router_embedding_integration"]
