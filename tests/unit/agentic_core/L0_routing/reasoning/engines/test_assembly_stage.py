"""Runtime-hardened public-surface tests for assembly stage."""
...
MODULE_CANDIDATES = ["assembly_stage"]
CLASS_CANDIDATES = ["AssemblyStage"]
VALIDATOR_CANDIDATES = ["validate_assembly_stage"]
