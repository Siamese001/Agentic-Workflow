"""Runtime-hardened public-surface tests for routing outcome adapter."""
...
MODULE_CANDIDATES = ["routing_outcome_adapter"]
CLASS_CANDIDATES = ["RoutingOutcomeAdapter"]
VALIDATOR_CANDIDATES = ["validate_routing_outcome_adapter"]
