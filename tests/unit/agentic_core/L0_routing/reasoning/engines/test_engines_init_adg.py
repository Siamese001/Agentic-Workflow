"""Runtime-hardened public-surface tests for engines init adg."""
...
MODULE_CANDIDATES = ["engines_init_adg"]
CLASS_CANDIDATES = ["EnginesInitAdg"]
VALIDATOR_CANDIDATES = ["validate_engines_init_adg"]
