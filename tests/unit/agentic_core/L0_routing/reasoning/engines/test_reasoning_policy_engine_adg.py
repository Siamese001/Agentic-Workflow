"""Runtime-hardened public-surface tests for reasoning policy engine adg."""
...
MODULE_CANDIDATES = ["reasoning_policy_engine_adg"]
CLASS_CANDIDATES = ["ReasoningPolicyEngineAdg"]
VALIDATOR_CANDIDATES = ["validate_reasoning_policy_engine_adg"]
