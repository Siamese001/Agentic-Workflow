"""Runtime-hardened public-surface tests for reasoning init adg."""
...
MODULE_CANDIDATES = ["reasoning_init_adg"]
CLASS_CANDIDATES = ["ReasoningInitAdg"]
VALIDATOR_CANDIDATES = ["validate_reasoning_init_adg"]
