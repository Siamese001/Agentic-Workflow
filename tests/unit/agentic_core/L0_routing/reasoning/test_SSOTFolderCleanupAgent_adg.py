"""Runtime-hardened public-surface tests for SSOTFolderCleanupAgent adg."""
...
MODULE_CANDIDATES = ["ssot_folder_cleanup_agent_adg", "SSOTFolderCleanupAgent_adg"]
CLASS_CANDIDATES = ["SSOTFolderCleanupAgent_adg", "SsotFolderCleanupAgentAdg"]
VALIDATOR_CANDIDATES = ["validate_ssot_folder_cleanup_agent_adg", "validate_SSOTFolderCleanupAgent_adg"]
