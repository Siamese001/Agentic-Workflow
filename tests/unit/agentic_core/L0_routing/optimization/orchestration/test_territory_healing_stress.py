...
class TestTerritoryHealingBasics:
    ...
    def test_coordinator_creation(self):
        ...
        from agentic_core.L0_routing.optimization.territory_healer_adapters import create_adapter_coordinator
...
class TestAgentSpecificHealing:
    ...
    def test_hierarchy_healer_adapter(self):
        ...
        from agentic_core.L0_routing.optimization.territory_healer_adapters import HierarchyHealerAdapter
    ...
    def test_location_healer_adapter(self):
        ...
        from agentic_core.L0_routing.optimization.territory_healer_adapters import LocationHealerAdapter
    ...
    def test_gravity_healer_adapter(self):
        ...
        from agentic_core.L0_routing.optimization.territory_healer_adapters import GravityHealerAdapter
