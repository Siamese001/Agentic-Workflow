"""Runtime-hardened public-surface tests for config surface constraints."""
...
MODULE_CANDIDATES = [
    "agentic_core.L0_routing.config.config_surface_constraints",
    "agentic_core.L0_routing.config.surface_constraints",
]
CLASS_CANDIDATES = ["ConfigSurfaceConstraints"]
CALLABLE_CANDIDATES = ["validate_config_surface_constraints", "validate_surface_constraints"]
