...
fan_in=100 — imported by 100 other modules.
ADG import-hygiene is covered separately by test_path_constants_adg.py.
...
@pytest.mark.skipif(not _AVAILABLE, reason="path_constants.py deps unavailable")
...
def test_module_importable():
    """Smoke: path_constants importable or gracefully unavailable."""
    pass