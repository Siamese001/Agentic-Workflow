...
Run with:
    pytest tests/unit/agentic_core/L0_routing/test_execute_ssot_enhancements.py -v
"""
...
class TestSemanticIntelligence:
    ...
    def test_semantic_jaccard_scoring(self):
        ...
        # No match
        score = engine._calculate_semantic_similarity("banana_bread", ["rocket_science"])
        assert score == 0.0
...
class TestReconciliationViolation:
    ...
    def test_violation_optional_fields(self):
        ...
        violation = ReconciliationViolation(is_valid=True, message="OK")
...
class TestNonInteractiveGuard:
    ...
    def test_guard_blocks_input(self):
        ...
        from agentic_core.L0_routing.scripts.execute_ssot import NonInteractiveGuard
...
class TestWithRetryDecorator:
    ...
    def test_retry_succeeds_on_first_attempt(self):
        ...
        from agentic_core.L0_routing.scripts.execute_ssot import with_retry
...
class TestAgentDiscovery:
    ...
    def test_list_available_agents_from_cache(self, tmp_path):
        ...
        from agentic_core.L0_routing.scripts.execute_ssot import list_available_agents
