"""Runtime-hardened public-surface tests for manifest analysis."""
...
MODULE_CANDIDATES = [
    "agentic_core.L0_routing.core.manifest_analysis",
    "agentic_core.L0_routing.core.manifest_analyzer",
]
CLASS_CANDIDATES = ["ManifestAnalysis", "ManifestAnalyzer"]
CALLABLE_CANDIDATES = ["analyze_manifest", "build_manifest_analysis"]
