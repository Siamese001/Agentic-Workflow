"""Runtime-hardened public-surface tests for meta apply ops adg."""
...
MODULE_CANDIDATES = ["meta_apply_ops_adg"]
CLASS_CANDIDATES = ["MetaApplyOpsAdg"]
VALIDATOR_CANDIDATES = ["validate_meta_apply_ops_adg"]
