"""Runtime-hardened public-surface tests for config store."""
...
MODULE_CANDIDATES = ["config_store"]
CLASS_CANDIDATES = ["ConfigStore"]
VALIDATOR_CANDIDATES = ["validate_config_store"]
