"""Runtime-hardened public-surface tests for meta apply adg."""
...
MODULE_CANDIDATES = ["meta_apply_adg"]
CLASS_CANDIDATES = ["MetaApplyAdg"]
VALIDATOR_CANDIDATES = ["validate_meta_apply_adg"]
