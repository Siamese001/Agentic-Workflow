"""Runtime-hardened public-surface tests for meta control init adg."""
...
MODULE_CANDIDATES = ["meta_control_init_adg"]
CLASS_CANDIDATES = ["MetaControlInitAdg"]
VALIDATOR_CANDIDATES = ["validate_meta_control_init_adg"]
