"""Runtime-hardened public-surface tests for meta learning bus."""
...
MODULE_CANDIDATES = ["meta_learning_bus"]
CLASS_CANDIDATES = ["MetaLearningBus"]
VALIDATOR_CANDIDATES = ["validate_meta_learning_bus"]
