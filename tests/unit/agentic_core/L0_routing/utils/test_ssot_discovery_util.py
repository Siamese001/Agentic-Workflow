"""Runtime-hardened public-surface tests for ssot discovery util."""
...
MODULE_CANDIDATES = ["agentic_core.L0_routing.utils.ssot_discovery_util"]
CLASS_CANDIDATES = ["SSOTDiscoveryResult"]
CALLABLE_CANDIDATES = ["discover_ssot", "find_ssot_root", "load_ssot_manifest"]
