"""Runtime-hardened public-surface tests for json formatter util."""
...
MODULE_CANDIDATES = ["agentic_core.L0_routing.utils.json_formatter_util"]
CLASS_CANDIDATES = ["JsonFormatter"]
CALLABLE_CANDIDATES = ["format_json", "canonical_json", "to_json"]
