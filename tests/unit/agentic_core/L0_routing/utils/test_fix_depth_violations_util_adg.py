"""Runtime-hardened public-surface tests for fix depth violations util."""
...
MODULE_CANDIDATES = ["agentic_core.L0_routing.utils.fix_depth_violations_util"]
CLASS_CANDIDATES = ["DepthViolationFix"]
CALLABLE_CANDIDATES = ["fix_depth_violations", "repair_depth_violations"]
