"""Runtime-hardened public-surface tests for boot sequence enforcer module."""
...
MODULE_CANDIDATES = ["agentic_core.L0_routing.enforcement.boot_sequence_enforcer"]
CLASS_CANDIDATES = ["BootSequenceEnforcer"]
CALLABLE_CANDIDATES = ["enforce_boot_sequence", "validate_boot_sequence"]
