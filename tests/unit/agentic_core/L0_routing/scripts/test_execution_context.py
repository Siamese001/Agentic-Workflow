...
def test_test_execution_context_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L0_routing.scripts.execution_context")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L0_routing.scripts.execution_context: {e}")
...
def test_test_execution_context_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L0_routing.scripts.execution_context")
