"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.identify_low_quality_agents_util."""
...
def test_calculate_quality_score_is_callable():
    """calculate_quality_score is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
