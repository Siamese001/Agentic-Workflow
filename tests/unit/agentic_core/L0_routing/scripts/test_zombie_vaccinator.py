...
def test_test_zombie_vaccinator_can_import():
    ...
    try:
        mod = load_dev_script("zombie_vaccinator.py")
        assert mod is not None
    except Exception as e:
        pytest.skip(f"Cannot load dev_tools/l0_scripts/zombie_vaccinator.py: {e}")
...
def test_test_zombie_vaccinator_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/zombie_vaccinator.py")
