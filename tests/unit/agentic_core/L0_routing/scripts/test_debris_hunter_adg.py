"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.debris_hunter."""
...
def test_debrishunter_is_instantiable():
    """DebrisHunter can be instantiated (if it's a class)."""
    try:
        mod = importlib.import_module(MODULE_PATH)
