...
def test_test_base_tool_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L0_routing.scripts.base_tool")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L0_routing.scripts.base_tool: {e}")
...
def test_test_base_tool_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L0_routing.scripts.base_tool")
