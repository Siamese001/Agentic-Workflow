...
@pytest.mark.skipif(not _AVAILABLE, reason="compare_ui_components_util.py deps unavailable")
...
class TestCompareComponents:
    def test_is_callable(self):
        assert callable(compare_components)
...
def test_module_importable():
    """Module compare_ui_components_util.py is importable (or deps unavailable)."""
