"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.compare_ui_components_util."""
...
def test_compare_components_is_callable():
    """compare_components is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
