...
def test_test_root_hygiene_util_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L0_routing.scripts.root_hygiene_util")
        assert mod is not None
    except Exception as e:
        pytest.skip(f"Cannot import module agentic_core.L0_routing.scripts.root_hygiene_util: {e}")
...
def test_test_root_hygiene_util_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L0_routing.scripts.root_hygiene_util")
