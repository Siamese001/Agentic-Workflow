"""Behavioral contract tests for agentic_core.L0_routing.scripts.flatten_scripts_directory_util."""
from __future__ import annotations

import importlib
import pytest

MODULE_PATH = "agentic_core.L0_routing.scripts.flatten_scripts_directory_util"
