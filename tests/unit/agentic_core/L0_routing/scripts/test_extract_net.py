...
def test_test_extract_net_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L0_routing.scripts.extract_net")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L0_routing.scripts.extract_net: {e}")
...
def test_test_extract_net_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L0_routing.scripts.extract_net")
