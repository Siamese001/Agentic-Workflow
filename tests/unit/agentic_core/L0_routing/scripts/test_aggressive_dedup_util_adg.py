"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.aggressive_dedup_util."""
...
def test_find_low_value_files_is_callable():
    """find_low_value_files is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
        func = getattr(mod, func_name)
    except (ImportError, AttributeError) as e:
