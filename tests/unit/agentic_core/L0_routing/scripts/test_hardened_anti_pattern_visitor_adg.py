"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.hardened_anti_pattern_visitor."""
...
def test_hardenedantipatternvisitor_is_instantiable():
    """HardenedAntiPatternVisitor can be instantiated (if it's a class)."""
    try:
        mod = importlib.import_module(MODULE_PATH)
