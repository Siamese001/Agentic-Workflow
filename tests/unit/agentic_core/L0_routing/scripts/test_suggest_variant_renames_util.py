...
def test_test_suggest_variant_renames_util_can_import():
    ...
    try:
        mod = load_dev_script("suggest_variant_renames_util.py")
        assert mod is not None
    except Exception as e:
        pytest.skip(
            f"Cannot load dev_tools/l0_scripts/suggest_variant_renames_util.py: {e}",
        )
...
def test_test_suggest_variant_renames_util_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/suggest_variant_renames_util.py")
