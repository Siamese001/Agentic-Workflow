"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.demo_cli_functionality_util."""
...
def test_demo_cli_functionality_is_callable():
    """demo_cli_functionality is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
