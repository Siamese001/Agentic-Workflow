"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.check_rglob_usage_util."""
...
def test_count_rglob_in_file_is_callable():
    """count_rglob_in_file is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
