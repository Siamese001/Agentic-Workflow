...
_emit_escalates_to_human("p1", "test_final_sovereignty_harness", "human_escalation")
_emit_routes_through("p1", "test_final_sovereignty_harness", "route_through")
_emit_checks_agent_registry("p1", "test_final_sovereignty_harness", "agent_registry")
_emit_validates_agent_capability("p1", "test_final_sovereignty_harness", "capability")
_emit_dispatches_execution_plan("p1", "test_final_sovereignty_harness", "exec_plan")
_emit_agent_executes_agent("p1", "test_final_sovereignty_harness", "sub_agent")
_emit_routes_to_agent("p1", "test_final_sovereignty_harness", "target_agent")
_emit_verifies_policy("p1", "test_final_sovereignty_harness", "policy_check")
_emit_observes_runtime_state("p1", "test_final_sovereignty_harness", "runtime_state")
_emit_verifies_boundary("p1", "test_final_sovereignty_harness", "boundary_check")
_emit_transcripts_response("p1", "test_final_sovereignty_harness", "transcript")
_emit_hard_fails_untranscripted("p1", "test_final_sovereignty_harness")
_emit_gated_by_confidence("p1", "test_final_sovereignty_harness", "confidence_gate")
