"""ADG-driven tests for agentic_core/L0_routing/scripts/verify_agent_status_util.py — fan_in=0."""
...
def test_module_importable():
    """Module verify_agent_status_util.py is importable (or deps unavailable)."""
