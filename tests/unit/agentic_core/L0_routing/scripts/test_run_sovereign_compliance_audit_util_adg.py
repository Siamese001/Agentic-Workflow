"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.run_sovereign_compliance_audit_util."""
...
def test_invoke_code_validator_is_callable():
    """invoke_code_validator is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
        func = getattr(mod, func_name)
    except (ImportError, AttributeError) as e:
