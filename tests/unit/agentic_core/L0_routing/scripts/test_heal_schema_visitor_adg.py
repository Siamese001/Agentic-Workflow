"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.heal_schema_visitor."""
...
def test_healschemavisitor_is_instantiable():
    """HealSchemaVisitor can be instantiated (if it's a class)."""
    try:
        mod = importlib.import_module(MODULE_PATH)
