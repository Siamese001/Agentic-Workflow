...
def test_test_pascal_sovereignty_fixer_can_import():
    ...
    try:
        mod = load_dev_script("pascal_sovereignty_fixer.py")
        assert mod is not None
    except Exception as e:
        pytest.skip(f"Cannot load dev_tools/l0_scripts/pascal_sovereignty_fixer.py: {e}")
...
def test_test_pascal_sovereignty_fixer_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/pascal_sovereignty_fixer.py")
