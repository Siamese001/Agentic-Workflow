...
def test_test_heal_schema_visitor_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L0_routing.scripts.heal_schema_visitor")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L0_routing.scripts.heal_schema_visitor: {e}")
...
def test_test_heal_schema_visitor_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L0_routing.scripts.heal_schema_visitor")
