"""Enhanced behavioral tests for agentic_core.L0_routing.scripts.add_dataclass_to_agents_util."""
...
def test_add_dataclass_to_file_is_callable():
    """add_dataclass_to_file is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
