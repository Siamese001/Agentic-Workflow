...
# tests\l0\test_AutonomousPromptEvolutionAgent.py was depth 3, MUST be 2.
...
from agentic_core.L0_maintenance.evolution.AutonomousPromptEvolutionAgent import (
...
class TestAutonomousPromptEvolutionAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, AutonomousPromptEvolutionAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "AutonomousPromptEvolutionAgent"
