...
# tests\l3\test_StrategicRecommendationAgent.py was depth 3, MUST be 2.
...
class TestStrategicRecommendationAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, StrategicRecommendationAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'StrategicRecommendationAgent'
