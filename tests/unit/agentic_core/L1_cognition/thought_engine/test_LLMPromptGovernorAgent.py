...
# tests\l2\test_LLMPromptGovernorAgent.py was depth 3, MUST be 2.
...
from agentic_core.L2_execution.tool_registry.LLMPromptGovernorAgent import LLMPromptGovernorAgent
...
class TestLLMPromptGovernorAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, LLMPromptGovernorAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'LLMPromptGovernorAgent'
