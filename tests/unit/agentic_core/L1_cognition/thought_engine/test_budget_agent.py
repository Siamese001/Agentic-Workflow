"""
Unit tests for BudgetAgent - Validator in L1.
...
class TestBudgetAgent:
    ...
    def agent_class(self):
        ...
        try:
            ...
            pytest.skip(f"Cannot import BudgetAgent: {e}")

    def test_class_exists(self, agent_class):
        """Verify BudgetAgent exists and is importable."""
        assert agent_class is not None, "BudgetAgent should exist"
