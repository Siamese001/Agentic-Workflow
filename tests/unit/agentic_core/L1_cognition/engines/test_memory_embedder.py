...
def test_test_memory_embedder_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L1_cognition.engines.memory_embedder")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L1_cognition.engines.memory_embedder: {e}")
...
def test_test_memory_embedder_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L1_cognition.engines.memory_embedder")
