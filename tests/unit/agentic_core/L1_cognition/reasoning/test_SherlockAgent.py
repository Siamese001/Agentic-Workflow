...
def test_test_SherlockAgent_can_import():
    ...
    try:
        mod = importlib.import_module("tests.support.l1_cognition.SherlockAgent")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module tests.support.l1_cognition.SherlockAgent: {e}")
...
def test_test_SherlockAgent_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module tests.support.l1_cognition.SherlockAgent")
