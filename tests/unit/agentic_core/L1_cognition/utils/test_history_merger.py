...
def test_test_history_merger_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L1_cognition.utils.history_merger_util")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L1_cognition.utils.history_merger_util: {e}")
...
def test_test_history_merger_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L1_cognition.utils.history_merger_util")
