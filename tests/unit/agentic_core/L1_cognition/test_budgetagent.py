...
class TestBudgetAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L1_cognition.thought_engine.BudgetAgent import BudgetAgent
            # Check it's a class
            assert isinstance(BudgetAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(BudgetAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(BudgetAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(BudgetAgent) if not m.startswith('_')]
