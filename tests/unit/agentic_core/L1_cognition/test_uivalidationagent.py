...
class TestUiValidationAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L1_cognition.thought_engine.UiValidationAgent import UiValidationAgent
            # Check it's a class
            assert isinstance(UiValidationAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(UiValidationAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(UiValidationAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(UiValidationAgent) if not m.startswith('_')]
