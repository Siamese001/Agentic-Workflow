...
class TestPromptGovernanceRigor:
    ...
    def test_version_registry_artifact_identification(self):
        ...
        assert "version_registry" in l4_specs, (
            "FAIL: version_registry specialization missing from L3 parent."
        )
    ...
    def test_legacy_l3_prefix_blocked(self):
        ...
        assert is_path_allowed(legacy_path) is False, (
            "FAIL: Legacy L3_ prefix still recognized as valid."
        )
    ...
    def test_negative_signal_enforcement_in_pg(self):
        ...
        signals = SOVEREIGN_TERRITORIES["agentic_core"]["ast_signals"].get(
