"""Enhanced behavioral tests for agentic_core.knowledge.research_cache.__init__."""
...
def test_researchcache_is_instantiable():
    """ResearchCache can be instantiated (if it's a class)."""
    try:
        mod = importlib.import_module(MODULE_PATH)
