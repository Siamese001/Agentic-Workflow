"""Enhanced behavioral tests for agentic_core.knowledge.engine.rag_orchestrator."""
...
def test_clear_embedding_cache_is_callable():
    """clear_embedding_cache is callable."""
    try:
        mod = importlib.import_module(MODULE_PATH)
