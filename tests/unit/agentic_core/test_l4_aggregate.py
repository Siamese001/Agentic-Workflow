...
def test_aggregate_related_memories(self: Any) -> None:
    ...
    MEMORIES = [{'topic': 'preferences', 'content': 'likes coffee'}, {'topic': 'preferences', 'content': 'prefers morning meetings'}, {'topic': 'history', 'content': 'visited Paris'}]
...
def test_aggregate_summarize(self: Any) -> None:
    ...
    MEMORIES = [{'content': 'User asked about weather'}, {'content': 'User asked about news'}, {'content': 'User asked about sports'}]
...
def test_aggregate_rank_by_importance(self: Any) -> None:
    ...
    MEMORIES = [{'content': 'A', 'importance': 0.5}, {'content': 'B', 'importance': 0.9}, {'content': 'C', 'importance': 0.7}]
