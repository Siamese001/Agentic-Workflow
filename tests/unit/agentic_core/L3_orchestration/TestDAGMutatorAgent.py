...
class TestDAGMutatorAgent:
    """Test suite for DAGMutatorAgent."""
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(DAGMutatorAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(DAGMutatorAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(DAGMutatorAgent) if not m.startswith('_')]
