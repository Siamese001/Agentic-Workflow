...
try:
    from agentic_core.L3_orchestration.engines.AgentFactory import (  # noqa: F401
        AgentFactory,
        create_all_agents,
        MAX_RETRIES,
        DEFAULT_SLEEP,
...
@pytest.mark.skipif(not _AVAILABLE, reason="AgentFactory.py deps unavailable")
...
def test_module_importable():
    """Module AgentFactory.py is importable (or deps unavailable)."""
