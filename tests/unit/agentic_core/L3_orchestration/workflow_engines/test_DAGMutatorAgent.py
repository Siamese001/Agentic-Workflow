...
# tests\l3\test_DAGMutatorAgent.py was depth 3, MUST be 2.
...
# from agentic_core.L3_orchestration.workflow_engines.dag_mutator_agent_config  # Module removed import DAGMutatorAgent
...
class TestDAGMutatorAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, DAGMutatorAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "DAGMutatorAgent"
