...
class TestDomainPlannerAgent:
    """Test suite for DomainPlannerAgent."""
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(DomainPlannerAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(DomainPlannerAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(DomainPlannerAgent) if not m.startswith('_')]
