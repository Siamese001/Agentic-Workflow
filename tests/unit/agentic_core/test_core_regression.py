...
class TestCoreRegressionInitialization:
...
class TestCoreRegressionCoreMethods:
...
class TestCoreRegressionEdgeCases:
...
class TestCoreRegressionTypeBoundaries:
