...
@pytest.mark.skipif(not _AVAILABLE, reason="sovereign_dependency_error_util.py deps unavailable")
...
def test_module_importable():
    """Module sovereign_dependency_error_util.py is importable (or deps unavailable)."""
