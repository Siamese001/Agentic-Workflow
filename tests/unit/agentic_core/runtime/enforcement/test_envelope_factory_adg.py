...
@pytest.mark.skipif(not _AVAILABLE, reason="envelope_factory.py deps unavailable")
class Testenvelope:
...
class TestEnvelopeFactory:
    def test_is_class(self):
        assert isinstance(EnvelopeFactory, type)
    def test_importable(self):
        assert EnvelopeFactory is not None
...
def test_module_importable():
    """Module envelope_factory.py is importable (or deps unavailable)."""
