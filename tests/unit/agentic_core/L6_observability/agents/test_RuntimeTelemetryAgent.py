...
# tests\L6\test_RuntimeTelemetryAgent.py was depth 3, MUST be 2.
...
class TestRuntimeTelemetryAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, RuntimeTelemetryAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'RuntimeTelemetryAgent'
