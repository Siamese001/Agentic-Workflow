...
# tests\L6\test_StrategicObservationAgent.py was depth 3, MUST be 2.
...
class TestStrategicObservationAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, StrategicObservationAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "StrategicObservationAgent"
