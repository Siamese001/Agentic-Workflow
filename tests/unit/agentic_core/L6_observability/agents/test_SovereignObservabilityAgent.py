...
# tests\L6\test_SovereignObservabilityAgent.py was depth 3, MUST be 2.

#!/usr/bin/env python3
"""
Test suite for SovereignObservabilityAgent
...
from agentic_core.L6_observability.SovereignObservabilityAgent import SovereignObservabilityAgent
...
class TestSovereignObservabilityAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, SovereignObservabilityAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "SovereignObservabilityAgent"
