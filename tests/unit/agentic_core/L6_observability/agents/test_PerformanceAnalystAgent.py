...
# tests\L6\test_PerformanceAnalystAgent.py was depth 3, MUST be 2.
...
class TestPerformanceAnalystAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, PerformanceAnalystAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'PerformanceAnalystAgent'
