...
class TestSovereignObservabilityAgent:
    ...
    def agent_class(self):
        ...
        try:
            from agentic_core.L6_observability.agents.SovereignObservabilityAgent import SovereignObservabilityAgent
    ...
    def test_has_collect_metrics_method(self, agent_class):
        ...
        assert hasattr(agent_class, 'collect_metrics') or \
               hasattr(agent_class, 'execute') or \
               hasattr(agent_class, 'observe'), \
