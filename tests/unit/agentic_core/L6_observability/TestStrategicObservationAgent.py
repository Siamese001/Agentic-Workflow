...
class TestStrategicObservationAgent:
    """Test suite for StrategicObservationAgent."""
    ...
    def test_class_exists(self):
        ...
        try:
            ...
            assert StrategicObservationAgent is not None
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L6_observability.agents.StrategicObservationAgent import StrategicObservationAgent
            # Check it's a class
            assert isinstance(StrategicObservationAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(StrategicObservationAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(StrategicObservationAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(StrategicObservationAgent) if not m.startswith('_')]
