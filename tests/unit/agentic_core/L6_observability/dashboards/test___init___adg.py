"""ADG importability contract for agentic_core/L6_observability/dashboards/__init__.py.
...
try:
    import agentic_core.L6_observability.dashboards.__init__ as _mod  # noqa: F401
    _AVAILABLE = True
except Exception:
    _AVAILABLE = False
    _mod = None
