...
class TestRuntimeTelemetryAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L6_observability.agents.RuntimeTelemetryAgent import RuntimeTelemetryAgent
            # Check it's a class
            assert isinstance(RuntimeTelemetryAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(RuntimeTelemetryAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(RuntimeTelemetryAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(RuntimeTelemetryAgent) if not m.startswith('_')]
