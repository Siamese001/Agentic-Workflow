...
class TestBootstrapAgent:
    ...
    def agent_class(self):
        ...
        try:
            from agentic_core.L0_routing.scripts.bootstrap_agent_validator import (  # noqa: F401
                bootstrap_agent,
            )
    ...
    def test_has_bootstrap_method(self, agent_class):
        ...
        assert (
            hasattr(agent_class, "bootstrap")
            or hasattr(agent_class, "execute")
            or hasattr(agent_class, "run")
    ...
    def test_no_network_calls_on_import(self):
        ...
        with patch("requests.get", track_call), patch("requests.post", track_call):
            try:
                from agentic_core.L0_routing.scripts.bootstrap_agent_validator import (
