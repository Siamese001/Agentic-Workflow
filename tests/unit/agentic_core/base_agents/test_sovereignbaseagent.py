...
class TestSovereignBaseAgent:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(SovereignBaseAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(SovereignBaseAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(SovereignBaseAgent) if not m.startswith('_')]
