...
_emit_escalates_to_human("p1", "test_commit_with_retry", "human_escalation")
_emit_routes_through("p1", "test_commit_with_retry", "route_through")
_emit_checks_agent_registry("p1", "test_commit_with_retry", "agent_registry")
_emit_validates_agent_capability("p1", "test_commit_with_retry", "capability")
_emit_dispatches_execution_plan("p1", "test_commit_with_retry", "exec_plan")
_emit_agent_executes_agent("p1", "test_commit_with_retry", "sub_agent")
_emit_routes_to_agent("p1", "test_commit_with_retry", "target_agent")
_emit_verifies_policy("p1", "test_commit_with_retry", "policy_check")
_emit_observes_runtime_state("p1", "test_commit_with_retry", "runtime_state")
_emit_verifies_boundary("p1", "test_commit_with_retry", "boundary_check")
_emit_transcripts_response("p1", "test_commit_with_retry", "transcript")
_emit_hard_fails_untranscripted("p1", "test_commit_with_retry")
_emit_gated_by_confidence("p1", "test_commit_with_retry", "confidence_gate")
