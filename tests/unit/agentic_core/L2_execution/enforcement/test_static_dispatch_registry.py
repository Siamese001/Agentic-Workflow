...
_emit_escalates_to_human("p1", "test_static_dispatch_registry", "human_escalation")
_emit_routes_through("p1", "test_static_dispatch_registry", "route_through")
_emit_agent_executes_agent("p1", "test_static_dispatch_registry", "sub_agent")
_emit_verifies_policy("p1", "test_static_dispatch_registry", "policy_check")
_emit_observes_runtime_state("p1", "test_static_dispatch_registry", "runtime_state")
_emit_verifies_boundary("p1", "test_static_dispatch_registry", "boundary_check")
_emit_transcripts_response("p1", "test_static_dispatch_registry", "transcript")
_emit_hard_fails_untranscripted("p1", "test_static_dispatch_registry")
_emit_gated_by_confidence("p1", "test_static_dispatch_registry", "confidence_gate")
