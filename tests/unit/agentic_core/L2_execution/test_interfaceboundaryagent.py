...
class TestInterfaceBoundaryAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L2_execution.ToolRegistry.InterfaceBoundaryAgent import InterfaceBoundaryAgent
            # Check it's a class
            assert isinstance(InterfaceBoundaryAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(InterfaceBoundaryAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(InterfaceBoundaryAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(InterfaceBoundaryAgent) if not m.startswith('_')]
