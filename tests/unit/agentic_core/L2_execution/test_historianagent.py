...
class TestHistorianAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L2_execution.tool_registry.HistorianAgent import HistorianAgent
            # Check it's a class
            assert isinstance(HistorianAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(HistorianAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(HistorianAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(HistorianAgent) if not m.startswith('_')]
