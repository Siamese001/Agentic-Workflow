...
@pytest.mark.skipif(not _AVAILABLE, reason="data_serializer_util.py deps unavailable")
class TestSerializeData:
    def test_is_class(self):
        assert isinstance(SerializeData, type)
    def test_importable(self):
        assert SerializeData is not None
...
def test_module_importable():
    """Module data_serializer_util.py is importable (or deps unavailable)."""
