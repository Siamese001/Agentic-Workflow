...
ADG import-hygiene is covered separately by test_infra_error_types_adg.py.
...
@pytest.mark.skipif(not _AVAILABLE, reason="infra_error_types.py deps unavailable")
class TestInfrastructureDependencyErrorContract:
    def test_is_class(self):
        assert isinstance(InfrastructureDependencyError, type)
