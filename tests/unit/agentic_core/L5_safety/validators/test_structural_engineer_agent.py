...
class TestStructuralEngineerAgent:
    ...
    def agent_class(self):
        ...
        try:
            from agentic_core.L5_safety.validators.StructuralEngineerAgent import StructuralEngineerAgent
    ...
    def test_has_check_cyclomatic_complexity_method(self, agent_class):
        ...
        assert hasattr(agent_class, 'check_cyclomatic_complexity'), "Should have check_cyclomatic_complexity method"
