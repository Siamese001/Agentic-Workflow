...
# tests\l2\test_MemoryArchitectAgent.py was depth 3, MUST be 2.
...
from agentic_core.L2_execution.tool_registry.MemoryArchitectAgent import MemoryArchitectAgent
