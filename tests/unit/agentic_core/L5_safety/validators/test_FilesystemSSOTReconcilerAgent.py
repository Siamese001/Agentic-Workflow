...
# tests\l0\test_FilesystemSSOTReconcilerAgent.py was depth 3, MUST be 2.
...
class TestFilesystemSSOTReconcilerAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, FilesystemSSOTReconcilerAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "FilesystemSSOTReconcilerAgent"
