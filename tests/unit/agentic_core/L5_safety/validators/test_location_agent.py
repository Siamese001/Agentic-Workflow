...
class TestLocationAgent:
    ...
    def test_has_validate_file_location_method(self, agent_class):
        ...
        assert hasattr(agent_class, "validate_file_location") or hasattr(agent_class, "validate"), (
    ...
    def test_sovereign_territories_defined(self):
        ...
        try:
            from agentic_core.L5_safety.validators.location_agent import SOVEREIGN_TERRITORIES
