...
@pytest.mark.skipif(not _AVAILABLE, reason="silent_swallower_validator.py deps unavailable")
class TestSilentSwallowerValidatorImportability:
    def test_module_importable(self) -> None:
        """ADG contract: silent_swallower_validator.py must be importable."""
        assert _AVAILABLE

    def test_silentswallowerdetector_is_type(self) -> None:
