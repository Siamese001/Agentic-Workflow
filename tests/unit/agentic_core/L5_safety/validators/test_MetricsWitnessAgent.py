...
# tests\l0\test_MetricsWitnessAgent.py was depth 3, MUST be 2.
...
class TestMetricsWitnessAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, MetricsWitnessAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'MetricsWitnessAgent'
