...
class TestHierarchyAgent:
    ...
    def test_auto_approve_sets_gatekeeper(self, mock_project):
        ...
        agent2 = HierarchyAgent(mock_project, healing_enabled=True, auto_approve=False)
    ...
    def test_relocate_misplaced_files_returns_structure(self, mock_project):
        ...
        expected_keys = ["files_relocated", "folders_removed", "violations_found", "errors", "roots_processed"]
    ...
    def test_create_missing_structure(self, mock_project):
        ...
        # Should return expected keys
        expected_keys = ["created", "errors", "violations_found"]
        for key in results:
            assert key in results
    ...
    def test_heal_method_interface(self, mock_project):
        ...
        expected_keys = ["status", "details", "artifacts", "errors"]
        for key in result:
