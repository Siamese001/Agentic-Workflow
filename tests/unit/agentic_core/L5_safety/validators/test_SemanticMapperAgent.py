...
# tests\l1\test_SemanticMapperAgent.py was depth 3, MUST be 2.
...
class TestSemanticMapperAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, SemanticMapperAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'SemanticMapperAgent'
