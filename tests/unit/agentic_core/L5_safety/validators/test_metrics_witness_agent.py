...
class TestMetricsWitnessAgent:
    ...
    def test_has_calculate_structural_ssot_score_method(self, agent_class):
        ...
        assert hasattr(agent_class, 'calculate_structural_ssot_score'), "Should have calculate_structural_ssot_score method"
    ...
    def test_has_calculate_healing_resilience_score_method(self, agent_class):
        ...
        assert hasattr(agent_class, 'calculate_healing_resilience_score'), "Should have calculate_healing_resilience_score method"
