...
@pytest.mark.skipif(not _AVAILABLE, reason="config_with_logic_validator.py deps unavailable")
class TestConfigWithLogicValidatorImportability:
    def test_module_importable(self) -> None:
        """ADG contract: config_with_logic_validator.py must be importable."""
        assert _AVAILABLE

    def test_configwithlogicdetector_is_type(self) -> None:
