...
# tests\l2\test_ContextCuratorAgent.py was depth 3, MUST be 2.
...
class TestContextCuratorAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, ContextCuratorAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'ContextCuratorAgent'
