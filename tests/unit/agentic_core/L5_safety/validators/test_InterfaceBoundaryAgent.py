...
# tests\l2\test_InterfaceBoundaryAgent.py was depth 3, MUST be 2.

#!/usr/bin/env python3
"""
Test suite for InterfaceBoundaryAgent
...
from agentic_core.L2_execution.tool_registry.InterfaceBoundaryAgent import InterfaceBoundaryAgent
...
class TestInterfaceBoundaryAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, InterfaceBoundaryAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "InterfaceBoundaryAgent"
