...
# tests\l0\test_GospelSyncAgent.py was depth 3, MUST be 2.

#!/usr/bin/env python3
"""
Test suite for GospelSyncAgent
...
class TestGospelSyncAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, GospelSyncAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "GospelSyncAgent"
