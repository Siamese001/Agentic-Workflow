...
def run_all_tests():
    ...
    tests = [
        ...
        (
            "Test 17: Thought engine has reasoning subfolder",
            test_17_thought_engine_has_reasoning_subfolder,
        ),
        ...
        (
            "Test 20: Core extensions has mixins subfolder",
            test_20_core_extensions_has_mixins_subfolder,
        ),
    ]
