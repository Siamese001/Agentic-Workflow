...
# tests\l0\test_PreCommitSovereignAgent.py was depth 3, MUST be 2.

#!/usr/bin/env python3
"""
Test suite for PreCommitSovereignAgent
...
class TestPreCommitSovereignAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, PreCommitSovereignAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'PreCommitSovereignAgent'
