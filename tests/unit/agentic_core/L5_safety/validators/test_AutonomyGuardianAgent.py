...
# tests\l5\test_AutonomyGuardianAgent.py was depth 3, MUST be 2.
...
class TestAutonomyGuardianAgent:
    ...
    def agent(self):
        ...
        return AutonomyGuardianAgent()

    def test_instantiation(self, agent):
        """Test that agent can be instantiated."""
        assert agent is not None
        assert isinstance(agent, AutonomyGuardianAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "AutonomyGuardianAgent"
