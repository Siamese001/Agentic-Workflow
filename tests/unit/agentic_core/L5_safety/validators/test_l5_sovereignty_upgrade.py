...
class TestPhase4GravityMaps:
    ...
    def test_gravity_rules_include_apps_territories(self):
        ...
        from agentic_core.L5_safety.reasoning.StructureValidatorAgent import GRAVITY_RULES
...
class TestPhase6HygieneGuardian:
    ...
    def test_hygiene_guardian_no_structural_checks(self):
        ...
        from agentic_core.L5_safety.enforcement.hygiene_guardian_config_script import HygieneGuardianAgent
