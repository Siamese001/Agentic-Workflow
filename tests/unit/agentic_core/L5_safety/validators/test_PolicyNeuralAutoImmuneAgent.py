...
# tests\l5\test_PolicyNeuralAutoImmuneAgent.py was depth 3, MUST be 2.
...
from agentic_core.L5_safety.guardrails.PolicyNeuralAutoImmuneAgent import (
...
class TestPolicyNeuralAutoImmuneAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, PolicyNeuralAutoImmuneAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "PolicyNeuralAutoImmuneAgent"
