...
@pytest.mark.skipif(not _AVAILABLE, reason="direct_prompt_compilation_validator.py deps unavailable")
class TestDirectPromptCompilationValidatorImportability:
    def test_module_importable(self) -> None:
        """ADG contract: direct_prompt_compilation_validator.py must be importable."""
        assert _AVAILABLE

    def test_directpromptcompilationdetector_is_type(self) -> None:
