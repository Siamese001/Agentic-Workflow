...
try:
    from agentic_core.L5_safety.config.input_config import (  # noqa: F401
        InputValidator,
        validate_input,
        MAX_RETRIES,
        DEFAULT_SLEEP,
...
@pytest.mark.skipif(not _AVAILABLE, reason="input_config.py deps unavailable")
...
def test_module_importable():
    """Module input_config.py is importable (or deps unavailable)."""
