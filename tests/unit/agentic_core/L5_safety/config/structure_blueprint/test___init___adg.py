"""ADG importability contract for agentic_core/L5_safety/config/structure_blueprint/__init__.py.
...
try:
    from agentic_core.L5_safety.config.structure_blueprint.__init__ import (  # noqa: F401
        MAX_RETRIES,
        DEFAULT_SLEEP,
        THRESHOLD,
        BUFFER_SIZE,
