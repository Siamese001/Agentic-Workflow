...
class TestRedSentinelAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.guardrails.RedSentinelAgent import RedSentinelAgent
            # Check it's a class
            assert isinstance(RedSentinelAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(RedSentinelAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(RedSentinelAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(RedSentinelAgent) if not m.startswith('_')]
