...
@pytest.mark.skipif(not _AVAILABLE, reason="location_path_util.py deps unavailable")
class TestIsPathCompliant:
    def test_is_callable(self):
        assert callable(is_path_compliant)

@pytest.mark.skipif(not _AVAILABLE, reason="location_path_util.py deps unavailable")
class TestGetLocationAgent:
    def test_is_callable(self):
        assert callable(get_location_agent)
...
def test_module_importable():
    """Module location_path_util.py is importable (or deps unavailable)."""
