"""ADG-driven tests for agentic_core/L5_safety/utils/canonical_truth_util.py — fan_in=0."""
...
@pytest.mark.skipif(not _AVAILABLE, reason="canonical_truth_util.py deps unavailable")
class TestValidateHealthComponents:
    def test_is_callable(self):
...
class TestCategorizeAgent:
    def test_is_callable(self):
        assert callable(categorize_agent)
...
def test_module_importable():
    """Module canonical_truth_util.py is importable (or deps unavailable)."""
