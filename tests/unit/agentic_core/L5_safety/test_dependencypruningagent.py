#!/usr/bin/env python3
"""
Unit tests for DependencyPruningAgent.
...
class TestDependencyPruningAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.guardrails.DependencyPruningAgent import DependencyPruningAgent
            # Check it's a class
            assert isinstance(DependencyPruningAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(DependencyPruningAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(DependencyPruningAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(DependencyPruningAgent) if not m.startswith('_')]
