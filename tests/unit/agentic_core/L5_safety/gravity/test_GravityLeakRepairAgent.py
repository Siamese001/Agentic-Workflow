...
# tests\l5\test_GravityLeakRepairAgent.py was depth 3, MUST be 2.
...
class TestGravityLeakRepairAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, GravityLeakRepairAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'GravityLeakRepairAgent'
