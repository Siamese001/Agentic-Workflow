...
try:
    from agentic_core.L5_safety.enforcement.airlock_trimmer_enforcer import (  # noqa: F401
        BATCH_SIZE,
        BUFFER_SIZE,
        DEFAULT_SLEEP,
        MAX_DEPTH,
...
@pytest.mark.skipif(not _AVAILABLE, reason="airlock_trimmer_enforcer.py deps unavailable")
...
def test_module_importable():
    """Module airlock_trimmer_enforcer.py is importable (or deps unavailable)."""
