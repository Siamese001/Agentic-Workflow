...
@pytest.mark.skipif(not _AVAILABLE, reason="BootstrapAgent.py deps unavailable")
class TestBootstrapagentImportability:
    def test_module_importable(self) -> None:
        """ADG contract: BootstrapAgent.py must be importable."""
        assert _AVAILABLE

    def test_bootstrapagent_is_type(self) -> None:
