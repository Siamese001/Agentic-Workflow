...
@pytest.mark.skipif(not _AVAILABLE, reason="hierarchy_validator.py deps unavailable")
class TestHierarchyValidatorImportability:
    def test_module_importable(self) -> None:
        """ADG contract: hierarchy_validator.py must be importable."""
        assert _AVAILABLE

    def test_hierarchyvalidatoragent_is_type(self) -> None:
