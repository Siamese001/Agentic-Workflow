...
class TestGitHygieneAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.guardrails.GitHygieneAgent import GitHygieneAgent
            # Check it's a class
            assert isinstance(GitHygieneAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(GitHygieneAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(GitHygieneAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(GitHygieneAgent) if not m.startswith('_')]
