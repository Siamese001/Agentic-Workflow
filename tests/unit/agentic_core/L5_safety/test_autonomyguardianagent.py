#!/usr/bin/env python3
"""
Unit tests for AutonomyGuardianAgent.
...
class TestAutonomyGuardianAgent:
    """Test suite for AutonomyGuardianAgent."""
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.validators.AutonomyGuardianAgent import AutonomyGuardianAgent
            # Check it's a class
            assert isinstance(AutonomyGuardianAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(AutonomyGuardianAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(AutonomyGuardianAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(AutonomyGuardianAgent) if not m.startswith('_')]
