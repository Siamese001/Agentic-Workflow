...
class TestCostGovernorAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.guardrails.CostGovernorAgent import CostGovernorAgent
            # Check it's a class
            assert isinstance(CostGovernorAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(CostGovernorAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(CostGovernorAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(CostGovernorAgent) if not m.startswith('_')]
