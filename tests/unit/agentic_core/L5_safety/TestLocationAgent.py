...
class TestLocationAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.validators.LocationAgent import LocationAgent
            # Check it's a class
            assert isinstance(LocationAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(LocationAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(LocationAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(LocationAgent) if not m.startswith('_')]
