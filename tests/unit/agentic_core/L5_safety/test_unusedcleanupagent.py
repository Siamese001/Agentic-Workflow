...
class TestUnusedCleanupAgent:
    """Test suite for UnusedCleanupAgent."""
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.guardrails.UnusedCleanupAgent import UnusedCleanupAgent
            # Check it's a class
            assert isinstance(UnusedCleanupAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(UnusedCleanupAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(UnusedCleanupAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(UnusedCleanupAgent) if not m.startswith('_')]
