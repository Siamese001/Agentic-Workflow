...
class TestSovereignPurification(unittest.TestCase):
    def test_registry_consistency(self):
        ...
        self.assertNotIn("unified", CORE_SUBFOLDER_MAP["L5_safety"], "L5_safety map still contains legacy 'unified' folder")
    ...
    def test_integrity_hash_verification(self):
        ...
        self.assertTrue(verifier.verify_core_integrity(), "Core integrity lock failed post-Phase 7 migration.")
