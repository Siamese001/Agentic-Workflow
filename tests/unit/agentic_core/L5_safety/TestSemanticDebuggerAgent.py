#!/usr/bin/env python3
"""
Unit tests for SemanticDebuggerAgent.
...
class TestSemanticDebuggerAgent:
    """Test suite for SemanticDebuggerAgent."""
    ...
    def test_class_exists(self):
        ...
        try:
            from agentic_core.L5_safety.agents.SemanticDebuggerAgent import SemanticDebuggerAgent
            assert SemanticDebuggerAgent is not None
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.agents.SemanticDebuggerAgent import SemanticDebuggerAgent
            # Check it's a class
            assert isinstance(SemanticDebuggerAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(SemanticDebuggerAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(SemanticDebuggerAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(SemanticDebuggerAgent) if not m.startswith('_')]
