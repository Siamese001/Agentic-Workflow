...
class TestReportingAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.validators.ReportingAgent import ReportingAgent
            # Check it's a class
            assert isinstance(ReportingAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(ReportingAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(ReportingAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(ReportingAgent) if not m.startswith('_')]
