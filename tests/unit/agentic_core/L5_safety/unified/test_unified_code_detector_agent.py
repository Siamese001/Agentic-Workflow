"""
Unit tests for UnifiedCodeDetectorAgent - Validator in L5.
...
class TestUnifiedCodeDetectorAgent:
    """Unit tests for UnifiedCodeDetectorAgent."""
    ...
    def agent_class(self):
        ...
        try:
            ...
            return UnifiedCodeDetectorAgent
        except (ImportError, NameError, AttributeError, TypeError) as e:
            pytest.skip(f"Cannot import UnifiedCodeDetectorAgent: {e}")

    def test_class_exists(self, agent_class):
        """Verify UnifiedCodeDetectorAgent exists and is importable."""
        assert agent_class is not None, "UnifiedCodeDetectorAgent should exist"
    ...
    def test_no_network_calls_on_import(self):
        ...
        with patch("requests.get", track_call), patch("requests.post", track_call):
            try:
                from agentic_core.L5_safety.unified.UnifiedCodeDetectorAgent import (
                    UnifiedCodeDetectorAgent,  # noqa: F401
                )
