...
class TestGitSafetyHandlerAgent:
    ...
    def agent_class(self):
        ...
        try:
            from agentic_core.L5_safety.guardrails.GitSafetyHandlerAgent import GitSafetyHandlerAgent
    ...
    def test_has_create_rollback_point_method(self, agent_class):
        ...
        assert hasattr(agent_class, 'create_rollback_point'), "Should have create_rollback_point method"
