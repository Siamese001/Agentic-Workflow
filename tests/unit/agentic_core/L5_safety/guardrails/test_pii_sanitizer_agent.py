...
class TestPIISanitizerAgent:
    """Unit tests for PIISanitizerAgent."""
    ...
    def agent_class(self):
        ...
        try:
            ...
            return PIISanitizerAgent
        except (ImportError, NameError, AttributeError, TypeError) as e:
            pytest.skip(f"Cannot import PIISanitizerAgent: {e}")

    def test_class_exists(self, agent_class):
        """Verify PIISanitizerAgent exists and is importable."""
        assert agent_class is not None, "PIISanitizerAgent should exist"
    ...
    def test_no_network_calls_on_import(self):
        ...
        with patch("requests.get", track_call), patch("requests.post", track_call):
            try:
                from agentic_core.L5_safety.guardrails.PIISanitizerAgent import (
                    PIISanitizerAgent,  # noqa: F401
                )
