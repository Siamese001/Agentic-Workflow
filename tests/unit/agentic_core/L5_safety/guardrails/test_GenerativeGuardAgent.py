...
# tests\l1\test_GenerativeGuardAgent.py was depth 3, MUST be 2.
...
class TestGenerativeGuardAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, GenerativeGuardAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "GenerativeGuardAgent"
