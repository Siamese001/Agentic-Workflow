...
class TestCodeFormatterAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L5_safety.guardrails.CodeFormatterAgent import CodeFormatterAgent
            # Check it's a class
            assert isinstance(CodeFormatterAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(CodeFormatterAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(CodeFormatterAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(CodeFormatterAgent) if not m.startswith('_')]
