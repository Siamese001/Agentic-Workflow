...
class TestAutonomousDecisionEngine:
    ...
    def test_complex_territory_penalty(self, decision_engine):
        ...
        confidence = decision_engine.calculate_healing_confidence(
            violations_count=5, violation_types=["SHALLOW"], territory="L5_safety"
        )
    ...
    def test_simple_territory_boost(self, decision_engine):
        ...
        confidence = decision_engine.calculate_healing_confidence(
            violations_count=5, violation_types=["SHALLOW"], territory="prompt_governance"
        )
...
class TestAgentDiscovery:
    ...
    def test_list_agents_returns_tuples(self, tmp_path):
        ...
        cache_data = [{"class_name": "TestAgent", "path": "agentic_core/test/agent.py"}]
        cache_file = tmp_path / "agent_discovery_full.json"
        cache_file.write_text(json.dumps(cache_data))
...
class TestPhaseExecution:
    ...
    def test_phase2_with_violations_high_confidence(
        self, mock_agents, decision_engine, mock_state_manager
    ):
    ...
    def test_phase2_low_confidence_skip(self, mock_agents, mock_state_manager):
        ...
        result = execute_phase2_alignment(mock_agents, "test_territory", engine, mock_state_manager)
    ...
    def test_phase3_success(self, mock_agents, mock_state_manager):
        ...
        mock_sys_arch = Mock()
        mock_sys_arch.validate_core_architecture.return_value = {"imports_valid": True}
        mock_agents["system_architect"].return_value = mock_sys_arch

        gov, arch = execute_phase3_validation(mock_agents, "test_territory", mock_state_manager)
    ...
    def test_phase5_certification(self, mock_agents, mock_state_manager):
        ...
        cert = execute_phase5_final(mock_agents, "test_territory", mock_state_manager)
    ...
    def test_state_updates_during_phases(self, mock_agents, decision_engine, mock_state_manager):
        ...
        with patch("pathlib.Path.exists", return_value=False):
            execute_phase1_discovery(mock_agents, "test", decision_engine, mock_state_manager)
...
class TestIntegration:
    ...
    def test_confidence_factors_all_present(self, decision_engine):
        ...
        confidence = decision_engine.calculate_healing_confidence(
            violations_count=5, violation_types=["SHALLOW"], territory="test"
        )
    ...
    def test_confidence_reasoning_format(self, decision_engine):
        ...
        confidence = decision_engine.calculate_healing_confidence(
            violations_count=10, violation_types=["SHALLOW", "UNKNOWN"], territory="test"
        )
