...
class TestDocumentationConsistency:
    ...
    def test_implementation_matches_documentation(self, documented_flags, implemented_flags):
        ...
        assert not undocumented, f"Found UNDOCUMENTED flags in code: {undocumented}. Update EXECUTE_SSOT_README.md."
    ...
    def test_runbook_step_consistency(self):
        ...
        assert "scripts/execute_ssot.py" in content, "Runbook Step 1 missing execute script reference"
        
        # Check Step 2 references verify_manifest.py
        assert "scripts/verify_manifest.py" in content, "Runbook Step 2 missing verify script reference"
