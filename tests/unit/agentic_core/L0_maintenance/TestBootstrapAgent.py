...
class TestBootstrapAgent:
    ...
    def test_class_is_agent(self):
        ...
        try:
            from agentic_core.L0_maintenance.scripts.BootstrapAgent import BootstrapAgent
            # Check it's a class
            assert isinstance(BootstrapAgent, type)
        except ImportError:
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(BootstrapAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(BootstrapAgent))
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(BootstrapAgent) if not m.startswith('_')]
