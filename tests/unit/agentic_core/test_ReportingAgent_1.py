...
def test_test_ReportingAgent_can_import():
    ...
    try:
        mod = importlib.import_module("tests.support.l6_observability.ReportingAgent")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module tests.support.l6_observability.ReportingAgent: {e}")
...
def test_test_ReportingAgent_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module tests.support.l6_observability.ReportingAgent")
