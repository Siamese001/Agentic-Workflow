...
def test_test_refactor_l1_mcp_imports_util_can_import():
    ...
    try:
        mod = load_dev_script("refactor_l1_mcp_imports_util.py")
        assert mod is not None
    except ImportError as e:
        pytest.skip(
            f"Cannot load dev_tools/l0_scripts/refactor_l1_mcp_imports_util.py: {e}",
        )
...
def test_test_refactor_l1_mcp_imports_util_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/refactor_l1_mcp_imports_util.py")
