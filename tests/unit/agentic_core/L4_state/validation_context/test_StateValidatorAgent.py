# TESTS DEPTH VIOLATION — 2026-01-18 05:21:44
# tests\utils\test_StateValidatorAgent.py was depth 3, MUST be 2.
...
class TestStateValidatorAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, StateValidatorAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == 'StateValidatorAgent'
