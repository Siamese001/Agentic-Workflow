...
def test_test_local_disk_adapter_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L4_state.utils.local_disk_adapter")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L4_state.utils.local_disk_adapter: {e}")
...
def test_test_local_disk_adapter_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L4_state.utils.local_disk_adapter")
