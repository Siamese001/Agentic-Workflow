...
_emit_escalates_to_human("p1", "test_environment", "human_escalation")
_emit_routes_through("p1", "test_environment", "route_through")
_emit_checks_agent_registry("p1", "test_environment", "agent_registry")
_emit_validates_agent_capability("p1", "test_environment", "capability")
_emit_dispatches_execution_plan("p1", "test_environment", "exec_plan")
_emit_agent_executes_agent("p1", "test_environment", "sub_agent")
_emit_routes_to_agent("p1", "test_environment", "target_agent")
_emit_verifies_policy("p1", "test_environment", "policy_check")
_emit_observes_runtime_state("p1", "test_environment", "runtime_state")
_emit_verifies_boundary("p1", "test_environment", "boundary_check")
_emit_transcripts_response("p1", "test_environment", "transcript")
_emit_hard_fails_untranscripted("p1", "test_environment")
_emit_gated_by_confidence("p1", "test_environment", "confidence_gate")
