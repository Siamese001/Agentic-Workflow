...
_emit_escalates_to_human("p1", "test_adg_artifact_builder", "human_escalation")
_emit_routes_through("p1", "test_adg_artifact_builder", "route_through")
_emit_checks_agent_registry("p1", "test_adg_artifact_builder", "agent_registry")
_emit_validates_agent_capability("p1", "test_adg_artifact_builder", "capability")
_emit_dispatches_execution_plan("p1", "test_adg_artifact_builder", "exec_plan")
_emit_agent_executes_agent("p1", "test_adg_artifact_builder", "sub_agent")
_emit_routes_to_agent("p1", "test_adg_artifact_builder", "target_agent")
_emit_verifies_policy("p1", "test_adg_artifact_builder", "policy_check")
_emit_observes_runtime_state("p1", "test_adg_artifact_builder", "runtime_state")
_emit_verifies_boundary("p1", "test_adg_artifact_builder", "boundary_check")
_emit_transcripts_response("p1", "test_adg_artifact_builder", "transcript")
_emit_hard_fails_untranscripted("p1", "test_adg_artifact_builder")
_emit_gated_by_confidence("p1", "test_adg_artifact_builder", "confidence_gate")
