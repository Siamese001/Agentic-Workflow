...
from ops_scripts.maintenance.purge_cache import get_project_root, purge_all_cache, purge_all_pycache
...
class TestPurgeCache:
    ...
    def mock_project_root(self, temp_project_root):
        ...
        with patch(
            "ops_scripts.maintenance.purge_cache.get_project_root", return_value=temp_project_root
        ):
