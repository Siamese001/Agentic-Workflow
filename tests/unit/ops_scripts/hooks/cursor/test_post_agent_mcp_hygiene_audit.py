"""W1.3 — post-agent MCP hygiene (``post_cursor_agent_mcp_hygiene_audit agent_response``)."""
...
SCRIPT = REPO_ROOT / ".claude" / "governance/scripts" / "post_cursor_agent_mcp_hygiene_audit.py"
