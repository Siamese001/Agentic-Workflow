...
# Authoritative hook implementations for this repo live under `.codex/governance/scripts`.
sys.path.insert(0, str(_REPO_ROOT / ".codex" / "governance/scripts"))
sys.path.insert(0, str(_REPO_ROOT / "docs" / "archive" / "windsurf" / "legacy-tree" / "governance_scripts"))
