"""Smoke tests for post_cascade_heartbeat latency telemetry (P5)."""
...
HOOK = REPO_ROOT / ".windsurf" / "scripts" / "post_cascade_heartbeat.py"
...
def test_heartbeat_writes_record_with_latency_field():
    ...
    log_path = REPO_ROOT / "artifacts" / "windsurf" / "post_cascade_heartbeat.jsonl"
...
def test_heartbeat_disable_env_returns_zero_with_no_output():
    ...
    r = _run(env_overrides={"POST_CASCADE_HEARTBEAT_DISABLE": "1"})
