...
class TestArchitectureGapAnalyzerSSOT:
    ...
    def test_report_saved_to_ssot_location(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert "docs/reports/plans" in str(json_path), f"Path should contain SSOT structure: {json_path}"
            assert "docs/reports/plans" in str(md_path), f"Path should contain SSOT structure: {md_path}"
    ...
    def test_path_contains_ssot_structure(self):
        ...
        script_path = Path(__file__).parent.parent.parent.parent / "ops_scripts" / "architecture_gap_analyzer.py"
