"""Unit tests for CodeSSOTEnforcerAgent - L5 Safety Validator."""
...
class TestCodeSSOTEnforcerAgent:
    """Test suite for CodeSSOTEnforcerAgent SSOT validation."""
    ...
    def agent(self, mock_ctx):
        """Create CodeSSOTEnforcerAgent instance."""
        from agentic_core.L5_safety.validators.CodeSSOTEnforcerAgent import CodeSSOTEnforcerAgent
        return CodeSSOTEnforcerAgent(ctx=mock_ctx, project_root=Path('.'))
