...
def run_self_tests() -> dict[str, Any]:
    """Run the StateManagementAgent's internal self-tests."""
...
def main():
    parser = argparse.ArgumentParser(description="Test StateManagementAgent")
    ...
    print("=" * 60)
    print("StateManagementAgent Test Suite (Phase 5)")
    print("=" * 60)
