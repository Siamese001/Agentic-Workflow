"""
Unit tests for CreateMessageBody
...
class TestCreateMessageBodyInitialization:
...
class TestCreateMessageBodyCoreMethods:
...
class TestCreateMessageBodyEdgeCases:
...
class TestCreateMessageBodyTypeBoundaries:
