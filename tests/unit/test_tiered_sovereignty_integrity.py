...
from agentic_core.L0_maintenance.scripts.execute_ssot import SovereignDecisionEngine, ConfidenceScore
...
class TestTieredSovereigntyIntegrity(unittest.TestCase):
    ...
    @patch.dict(os.environ, {
        "SOVEREIGN_HIGH_CONFIDENCE": "0.90",
        "SOVEREIGN_MEDIUM_CONFIDENCE": "0.60"
    })
    ...
    @patch.dict(os.environ, {
        "GEMINI_MODEL": "custom-flash-model",
        "GEMINI_PRO_MODEL": "custom-pro-model"
    })
