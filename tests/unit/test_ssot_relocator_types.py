...
def test_test_ssot_relocator_types_can_import():
    ...
    try:
        mod = importlib.import_module("apps_shared.types.ssot_relocator_types")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module apps_shared.types.ssot_relocator_types: {e}")
...
def test_test_ssot_relocator_types_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module apps_shared.types.ssot_relocator_types")
