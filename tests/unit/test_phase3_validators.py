...
class TestPerformanceOptimization:
    ...
    def test_cache_size_efficiency(self):
        ...
        for i in range(100):
            client.cache_set(f"efficiency_test_{i}", {"index": i, "data": "x" * 100}, "agentic_core")
...
class TestValidatorIntegration:
    ...
    def test_cross_validator_pattern_sharing(self):
        ...
        client.cache_set("shared_resume_pattern", {
            "source": "ats_validator",
            "pattern": "keyword_optimization"
        }, "apps_rg")
