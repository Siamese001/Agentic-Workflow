...
def test_test_AgentSpec_can_import():
    """Test that the module can be imported successfully."""
    try:
        mod = importlib.import_module("apps_rg.config.AgentSpec")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module apps_rg.config.AgentSpec: {e}")


def test_test_AgentSpec_has_file_attribute():
    """Test that module has __file__ attribute."""
    try:
        mod = importlib.import_module("apps_rg.config.AgentSpec")
        assert hasattr(mod, "__file__")
    except ImportError:
        pytest.skip("Cannot import module apps_rg.config.AgentSpec")


def test_test_AgentSpec_has_public_attributes():
