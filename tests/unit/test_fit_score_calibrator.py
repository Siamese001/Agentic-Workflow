"""
Unit tests for FitScoreCalibrator
...
class TestFitScoreCalibratorInitialization:
...
class TestFitScoreCalibratorCoreMethods:
...
class TestFitScoreCalibratorEdgeCases:
...
class TestFitScoreCalibratorTypeBoundaries:
