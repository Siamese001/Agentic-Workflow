...
try:
    from agentic_core.schemas.models.ReasoningConfig import ModelConfig, RAGConfig, GovernorConfig
except ImportError:
...
class TestEnvironmentDrivenConfiguration(unittest.TestCase):
    ...
    @patch.dict(os.environ, {
        "GOVERNOR_SAFETY_THRESHOLD": "0.98"
    })
    ...
    @patch.dict(os.environ, {
        "VALIDATION_MAX_SIMILARITY_THRESHOLD": "0.80",
    ...
    @patch.dict(os.environ, {
        "SIGNAL_MIN_CLAIM_CONFIDENCE": "0.8"
    })
