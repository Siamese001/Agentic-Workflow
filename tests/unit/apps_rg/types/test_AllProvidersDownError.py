#!/usr/bin/env python3
"""
Test for test_AllProvidersDownError
...
def test_test_AllProvidersDownError_can_import():
    """Test that the module can be imported successfully."""
    try:
        mod = importlib.import_module("apps_rg.types.AllProvidersDownError")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module apps_rg.types.AllProvidersDownError: {e}")


def test_test_AllProvidersDownError_has_file_attribute():
    """Test that module has __file__ attribute."""
    try:
        mod = importlib.import_module("apps_rg.types.AllProvidersDownError")
        assert hasattr(mod, "__file__")
    except ImportError:
        pytest.skip("Cannot import module apps_rg.types.AllProvidersDownError")


def test_test_AllProvidersDownError_has_public_attributes():
