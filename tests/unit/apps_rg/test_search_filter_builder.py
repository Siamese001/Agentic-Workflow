...
class TestSearchFilterBuilderInitialization:
...
class TestSearchFilterBuilderCoreMethods:
...
class TestSearchFilterBuilderEdgeCases:
...
class TestSearchFilterBuilderTypeBoundaries:
