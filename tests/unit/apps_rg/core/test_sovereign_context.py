"""
Unit tests for SovereignContext
...
class TestSovereignContextInitialization:
...
class TestSovereignContextCoreMethods:
...
class TestSovereignContextEdgeCases:
...
class TestSovereignContextTypeBoundaries:
