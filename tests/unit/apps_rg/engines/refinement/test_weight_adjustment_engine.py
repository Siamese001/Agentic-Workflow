"""
Unit tests for WeightAdjustmentEngine
...
class TestWeightAdjustmentEngineInitialization:
...
class TestWeightAdjustmentEngineCoreMethods:
...
class TestWeightAdjustmentEngineEdgeCases:
...
class TestWeightAdjustmentEngineTypeBoundaries:
