"""
Unit tests for AllProvidersDownError
...
class TestAllProvidersDownErrorInitialization:
...
class TestAllProvidersDownErrorCoreMethods:
...
class TestAllProvidersDownErrorEdgeCases:
...
class TestAllProvidersDownErrorTypeBoundaries:
