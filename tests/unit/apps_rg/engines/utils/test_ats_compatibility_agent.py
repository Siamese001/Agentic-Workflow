...
class TestAtsCompatibilityAgentInitialization:
...
class TestAtsCompatibilityAgentCoreMethods:
...
class TestAtsCompatibilityAgentEdgeCases:
...
class TestAtsCompatibilityAgentTypeBoundaries:
