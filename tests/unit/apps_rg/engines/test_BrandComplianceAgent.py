...
# tests\apps\test_BrandComplianceAgent.py was depth 3, MUST be 2.
...
class TestBrandComplianceAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, BrandComplianceAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "BrandComplianceAgent"
