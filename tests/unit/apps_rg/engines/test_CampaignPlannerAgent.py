...
# tests\apps\test_CampaignPlannerAgent.py was depth 3, MUST be 2.
...
from apps_lic.engines.outreach_engine.CampaignPlannerAgent import CampaignPlannerAgent
...
class TestCampaignPlannerAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, CampaignPlannerAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "CampaignPlannerAgent"
