...
class TestCompetencyItemInitialization:
...
class TestCompetencyItemCoreMethods:
...
class TestCompetencyItemEdgeCases:
...
class TestCompetencyItemTypeBoundaries:
