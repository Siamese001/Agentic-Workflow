"""
Unit tests for ExperienceWeightingEngine
...
class TestExperienceWeightingEngineInitialization:
...
class TestExperienceWeightingEngineCoreMethods:
...
class TestExperienceWeightingEngineEdgeCases:
...
class TestExperienceWeightingEngineTypeBoundaries:
