...
# tests\l0\test_GapClosureArchitectAgent.py was depth 3, MUST be 2.
...
class TestGapClosureArchitectAgent:
    ...
    def test_instantiation(self, agent):
        ...
        assert isinstance(agent, GapClosureArchitectAgent)
    ...
    def test_class_name(self, agent):
        ...
        assert agent.__class__.__name__ == "GapClosureArchitectAgent"
