"""
Unit tests for WordCounterTool
...
class TestWordCounterToolInitialization:
...
class TestWordCounterToolCoreMethods:
...
class TestWordCounterToolEdgeCases:
...
class TestWordCounterToolTypeBoundaries:
