"""
Unit tests for InvokeGenerationService
...
class TestInvokeGenerationServiceInitialization:
...
class TestInvokeGenerationServiceCoreMethods:
...
class TestInvokeGenerationServiceEdgeCases:
...
class TestInvokeGenerationServiceTypeBoundaries:
