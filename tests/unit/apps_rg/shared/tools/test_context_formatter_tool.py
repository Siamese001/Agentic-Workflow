"""
Unit tests for ContextFormatterTool
...
class TestContextFormatterToolInitialization:
...
class TestContextFormatterToolCoreMethods:
...
class TestContextFormatterToolEdgeCases:
...
class TestContextFormatterToolTypeBoundaries:
