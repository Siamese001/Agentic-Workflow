...
@pytest.mark.skipif(not _AVAILABLE, reason="text_util.py deps unavailable")
class TestSanitizeCampaignText:
    def test_is_callable(self):
        assert callable(sanitize_campaign_text)
...
def test_module_importable():
    """Module text_util.py is importable (or deps unavailable)."""
