...
@pytest.mark.skipif(not _AVAILABLE, reason="NormalizeSkillScores.py deps unavailable")
class TestNormalizeSkillScores:
    def test_is_class(self):
        assert isinstance(NormalizeSkillScores, type)
    def test_importable(self):
        assert NormalizeSkillScores is not None
...
def test_module_importable():
    """Module NormalizeSkillScores.py is importable (or deps unavailable)."""
