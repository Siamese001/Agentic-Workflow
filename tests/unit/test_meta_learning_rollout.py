...
_emit_escalates_to_human("p1", "test_meta_learning_rollout", "human_escalation")
_emit_routes_through("p1", "test_meta_learning_rollout", "route_through")
_emit_checks_agent_registry("p1", "test_meta_learning_rollout", "agent_registry")
_emit_validates_agent_capability("p1", "test_meta_learning_rollout", "capability")
_emit_dispatches_execution_plan("p1", "test_meta_learning_rollout", "exec_plan")
_emit_agent_executes_agent("p1", "test_meta_learning_rollout", "sub_agent")
_emit_routes_to_agent("p1", "test_meta_learning_rollout", "target_agent")
_emit_verifies_policy("p1", "test_meta_learning_rollout", "policy_check")
_emit_observes_runtime_state("p1", "test_meta_learning_rollout", "runtime_state")
_emit_verifies_boundary("p1", "test_meta_learning_rollout", "boundary_check")
_emit_transcripts_response("p1", "test_meta_learning_rollout", "transcript")
_emit_hard_fails_untranscripted("p1", "test_meta_learning_rollout")
_emit_gated_by_confidence("p1", "test_meta_learning_rollout", "confidence_gate")
