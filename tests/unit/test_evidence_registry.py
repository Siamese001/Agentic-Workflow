...
def test_evidence_registry_list_filters_scope():
    ...
    a1 = registry.upsert("company", "ACME", "http://example.com/a", "Summary A", "2025-01-01", 0.9, "value_wedge")
    _ = registry.upsert("contact", "ACME", "http://example.com/b", "Summary B", "2025-01-02", 0.8, "personalization")
    ...
    registry.upsert("company", "ACME", "http://example.com/c", "Summary C", "2025-01-03", 0.7, "value_wedge", artifact_id=manual_id)
