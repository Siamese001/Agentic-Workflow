"""Unit tests for .claude/governance/scripts/_legacy_windsurf/post_cursor_agent_wave_completion_audit.py.
...
HOOK_PATH = REPO_ROOT / ".claude" / "governance/scripts" / "_legacy_windsurf" / "post_cursor_agent_wave_completion_audit.py"
