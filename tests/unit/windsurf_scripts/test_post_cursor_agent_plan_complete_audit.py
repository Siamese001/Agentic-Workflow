"""
Unit tests for .cursor/scripts/_legacy_windsurf/post_cursor_agent_plan_complete_audit.py
...
_SCRIPT = REPO_ROOT / ".cursor" / "scripts" / "_legacy_windsurf" / "post_cursor_agent_plan_complete_audit.py"
