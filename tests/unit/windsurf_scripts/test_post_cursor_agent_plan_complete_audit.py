"""
Unit tests for .claude/governance/scripts/_legacy_windsurf/post_cursor_agent_plan_complete_audit.py
...
_SCRIPT = REPO_ROOT / ".claude" / "governance/scripts" / "_legacy_windsurf" / "post_cursor_agent_plan_complete_audit.py"
