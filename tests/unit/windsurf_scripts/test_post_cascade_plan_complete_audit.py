"""
Unit tests for .windsurf/scripts/post_cascade_plan_complete_audit.py
...
_SCRIPT = REPO_ROOT / ".windsurf" / "scripts" / "post_cascade_plan_complete_audit.py"

spec = importlib.util.spec_from_file_location("post_cascade_plan_complete_audit", _SCRIPT)
