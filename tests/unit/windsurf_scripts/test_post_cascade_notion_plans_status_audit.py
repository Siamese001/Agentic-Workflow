#!/usr/bin/env python3
"""Unit tests for post_cascade_notion_plans_status_audit.py — Waiting-For path.
...
_SCRIPTS_DIR = _REPO_ROOT / ".windsurf" / "scripts"
if str(_SCRIPTS_DIR) not in sys.path:
    sys.path.insert(0, str(_SCRIPTS_DIR))

import pytest

from post_cascade_notion_plans_status_audit import detect_violations  # type: ignore
...
def _make_invoke(
    ...
    """Return a minimal Cascade API-post-page invoke block string."""
    waiting_for_block = ""
...
class TestExtractResponseText:
    ...
    def test_plain_string_passthrough(self):
        from post_cascade_notion_plans_status_audit import _extract_response_text
...
class TestIsPlansId:
    ...
    def test_plans_db_id_dashed(self):
        from post_cascade_notion_plans_status_audit import _is_plans_id
