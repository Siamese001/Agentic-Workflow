"""Unit tests for HygieneGuardianAgent - L5 Safety Validator."""
...
class TestHygieneGuardianAgent:
    """Test suite for HygieneGuardianAgent hygiene validation."""
    
    @pytest.fixture
    def agent(self):
        """Create HygieneGuardianAgent instance."""
        from agentic_core.L5_safety.validators.HygieneGuardianAgent import HygieneGuardianAgent
        return HygieneGuardianAgent(project_root=Path('.'))
