"""Tests for `.cursor/scripts/_legacy_windsurf/post_cursor_agent_router_decision_audit.py`.
...
SCRIPT = REPO / ".cursor" / "scripts" / "_legacy_windsurf" / "post_cursor_agent_router_decision_audit.py"
