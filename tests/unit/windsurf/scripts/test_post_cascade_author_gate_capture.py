...
class TestExtractResponseText:
    ...
    def test_tool_info_response_key(self):
        """Real post_cascade_response format: text lives at tool_info.response."""
        payload = {
            "agent_action_name": "post_cascade_response",
            "trajectory_id": "traj-abc123",
            "tool_info": {"response": "the actual cascade response text"},
        }
        assert _extract_response_text(payload) == "the actual cascade response text"
