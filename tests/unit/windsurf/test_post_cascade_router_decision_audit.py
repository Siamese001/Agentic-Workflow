"""Tests for `.windsurf/scripts/post_cascade_router_decision_audit.py`.

Constitutional §28 / closed-loop-router-enforcement.md.
Audits Cascade responses for missing/malformed router-decision evidence.
"""
...
SCRIPT = REPO / ".windsurf" / "scripts" / "post_cascade_router_decision_audit.py"


def _load_module():
    spec = importlib.util.spec_from_file_location("post_cascade_router_decision_audit", SCRIPT)
