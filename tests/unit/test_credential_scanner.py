...
class TestCredentialScannerAgent:
    ...
    def test_detect_stripe_key(self, scanner, temp_repo):
        ...
        test_file.write_text('STRIPE_SECRET = "sk_live_1234567890abcdefghijklmnop"\n')
    ...
    def test_scan_multiple_files(self, scanner, temp_repo):
        ...
        (temp_repo / "file2.js").write_text(
            'const token = "ghp_1234567890abcdefghijklmnopqrstuv";\n'
        )
        (temp_repo / "file3.yaml").write_text(
    ...
    def test_oauth_client_secret_detection(self, scanner, temp_repo):
        ...
        test_file.write_text('CLIENT_SECRET = "my_oauth_secret_1234567890"\n')
