...
def test_verify_lightweight_state_exists():
    ...
    try:
        func = LightweightAgentBase.verify_lightweight_state
...
def test_get_lightweight_status_exists():
    ...
    try:
        func = LightweightAgentBase.get_lightweight_status
        assert callable(func)
    except AttributeError:
...
def test_module_has_minimum_coverage():
    ...
    module_dict = agentic_core.base_agents.LightweightBase.__dict__
