...
class TestHOP5SpecialistAssembly:
    ...
    def test_k3_transition_phrase_persistence(self):
        ...
        buffer.write_once("hop2_research", {
            "strategic_signals": ["AI Growth", "Cloud Migration"],
            "signal_score": 0.9
        })
        ...
        buffer.write_once("hop4_routing", {
            "route": "INMAIL",
            "constraints": {"char_limit": 500, "word_range": [50, 100]}
        })
    ...
    def test_k5a_provenance_enforcement(self):
        ...
        buffer.write_once("hop4_routing", {
            ...
            "constraints": {"char_limit": 300, "word_range": [30, 50]}
        })
    ...
    def test_k7_signature_immutability(self):
        ...
        buffer.write_once("hop2_research", {
            "strategic_signals": ["Financial Innovation"],
            "signal_score": 0.95
        })
        buffer.write_once("hop3_sender_grounding", {
            "sender_grounding": {
                "products": ["FinTech Platform"],
                "capabilities": []
            }
        })
        buffer.write_once("hop4_routing", {
            "route": "INMAIL",
            "constraints": {"char_limit": 600, "word_range": [80, 120]}
        })
    ...
    def test_trace_registry_granularity(self):
        ...
        buffer.write_once("hop2_research", {
            "strategic_signals": ["Market Expansion"],
            "signal_score": 0.88
        })
        buffer.write_once("hop3_sender_grounding", {
            "sender_grounding": {
        ...
        buffer.write_once("hop4_routing", {
            "route": "INMAIL",
            "constraints": {"char_limit": 500, "word_range": [60, 90]}
        })
    ...
    def test_k5a_bullet_content_structure(self):
        ...
        buffer.write_once("hop2_research", {
            "strategic_signals": ["Innovation", "Growth"],
            "signal_score": 0.8
        })
        buffer.write_once("hop3_sender_grounding", {
            "sender_grounding": {
    ...
    def test_k3_non_c_level_transition(self):
        ...
        buffer.write_once("hop2_research", {
            "strategic_signals": ["Tech Stack Modernization"],
            "signal_score": 0.75
        })
        buffer.write_once("hop3_sender_grounding", {
            "sender_grounding": {
        ...
        buffer.write_once("hop4_routing", {
            "route": "INMAIL",
            "constraints": {"char_limit": 400, "word_range": [50, 80]}
        })
    ...
    def test_k5_cta_word_count_compliance(self):
        ...
        buffer.write_once("hop2_research", {
            "strategic_signals": ["Cloud Strategy"],
            "signal_score": 0.92
        })
        buffer.write_once("hop3_sender_grounding", {
            "sender_grounding": {
    ...
    def test_full_specialist_assembly_output_structure(self):
        ...
        buffer.write_once("hop4_routing", {
            "route": "INMAIL",
            "constraints": {"char_limit": 700, "word_range": [100, 150]}
        })
