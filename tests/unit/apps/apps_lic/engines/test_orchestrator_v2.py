...
class MockAgent(V2AgentBase):
    ...
    def _process(self, buffer: ImmutableStagingBuffer, registry: TraceRegistry) -> None:
        self.call_count += 1
        output_key = f"hop{self.hop_id[-1]}_" + {
            "HOP1": "analysis",
            "HOP2": "research",
...
class TestOrchestratorV2:
    ...
    def test_linear_flow_no_failures(self, mock_config):
        ...
        with patch("apps_lic.engines.HOPOrchestratorAgent.load_agent_specs", return_value=mock_config):
            ...
            orchestrator.register_agent("HOP5", MockAgent("HOP5", {"selected_draft": {"text": "Draft", "score": 10}}))
            orchestrator.register_agent("HOP6", MockAgent("HOP6", {"passed": True, "validation_results": []}))
            orchestrator.register_agent("HOP7", MockAgent("HOP7", {"decision": "PASS", "action": "PROCEED"}))
            orchestrator.register_agent("HOP8", MockAgent("HOP8", {"total_score": 95, "report_path": "/tmp/report.md"}))
    ...
    def test_factual_failure_retry_hop2(self, mock_config):
        ...
        with patch("apps_lic.engines.HOPOrchestratorAgent.load_agent_specs", return_value=mock_config):
            ...
            orchestrator.register_agent("HOP4", MockAgent("HOP4", {"route": "INMAIL"}))
            orchestrator.register_agent("HOP5", MockAgent("HOP5", {"selected_draft": {"text": "Draft", "score": 10}}))
            orchestrator.register_agent("HOP6", MockAgent("HOP6", {"passed": False, "validation_results": [{"rule_id": "STRATEGIC_ALIGNMENT", "passed": False}]}))
            ...
            orchestrator.register_agent("HOP8", MockAgent("HOP8", {"total_score": 85, "report_path": "/tmp/report.md"}))
    ...
    def test_creative_failure_retry_hop5(self, mock_config):
        ...
        with patch("apps_lic.engines.HOPOrchestratorAgent.load_agent_specs", return_value=mock_config):
            ...
            orchestrator.register_agent("HOP6", MockAgent("HOP6", {"passed": False, "validation_results": [{"rule_id": "PLACEHOLDERS", "passed": False}]}))
            ...
            orchestrator.register_agent("HOP8", MockAgent("HOP8", {"total_score": 90, "report_path": "/tmp/report.md"}))
    ...
    def test_buffer_forking_preserves_state(self, mock_config):
        ...
        with patch("apps_lic.engines.HOPOrchestratorAgent.load_agent_specs", return_value=mock_config):
            ...
            # Register mock agents
            orchestrator.register_agent("HOP1", MockAgent("HOP1", {"Archetype": "C_LEVEL", "recipient_name": "Test User"}))
            orchestrator.register_agent("HOP2", MockAgent("HOP2", {"signal_score": 0.8}))
            orchestrator.register_agent("HOP3", MockAgent("HOP3", {"capabilities": ["AI", "ML"]}))
            orchestrator.register_agent("HOP4", MockAgent("HOP4", {"route": "INMAIL"}))
            orchestrator.register_agent("HOP5", MockAgent("HOP5", {"selected_draft": {"text": "Draft", "score": 10}}))
            orchestrator.register_agent("HOP6", MockAgent("HOP6", {"passed": False, "validation_results": []}))
            
            hop7_agent = MockAgent("HOP7", {"decision": "PASS", "action": "PROCEED"})
            hop7_agent.retry_scenario = "creative"
            orchestrator.register_agent("HOP7", hop7_agent)
            
            orchestrator.register_agent("HOP8", MockAgent("HOP8", {"total_score": 88, "report_path": "/tmp/report.md"}))
