...
class TestHOP6SpecialistValidation:
    ...
    def test_placeholder_curly_braces(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Hello {FirstName}, your work at {CompanyName} is impressive."}
        })
    ...
    def test_placeholder_angle_brackets(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Dear <Recipient>, I noticed <Topic>."}
        })
    ...
    def test_strategic_alignment_factual_check(self):
        ...
        buffer.write_once("hop2_research", {"strategic_brief": "Regulated industries compliance security"})
        buffer.write_once("hop5_generation", {
    ...
    def test_strategic_alignment_pass(self):
        ...
        buffer.write_once("hop2_research", {"strategic_brief": "Cloud migration strategy enterprise"})
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "I see your focus on cloud migration strategy for enterprise clients."}
        })
    ...
    def test_clean_draft_pass(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "I see your focus on cloud migration strategy for enterprise."}
        })
    ...
    def test_forbidden_verbs_medium_severity(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "We will revolutionize your digital transformation and disrupt the market."}
        })
    ...
    def test_forbidden_verbs_detection(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Let's leverage our synergies to optimize and transform your business."}
        })
    ...
    def test_no_strategic_brief_skips_alignment(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Generic outreach message."}
        })
    ...
    def test_trace_logging_validation_flow(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Clean draft about strategy."}
        })
    ...
    def test_multiple_critical_failures(self):
        ...
        buffer.write_once("hop5_generation", {
            "selected_draft": {"text": "Hi [Name], we sell coffee."}  # Placeholder + no alignment
        })
