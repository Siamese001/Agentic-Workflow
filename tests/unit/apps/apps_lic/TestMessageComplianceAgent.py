...
class TestMessageComplianceAgent:
    ...
    def test_class_exists(self):
        ...
        try:
            from apps_lic.engines.outreach_engine.MessageComplianceAgent import MessageComplianceAgent
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(MessageComplianceAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(MessageComplianceAgent))
