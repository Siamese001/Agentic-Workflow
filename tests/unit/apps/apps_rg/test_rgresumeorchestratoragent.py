...
class TestRgResumeOrchestratorAgent:
    ...
    def test_class_exists(self):
        ...
        try:
            from apps_rg.engines.resume_engine.RgResumeOrchestratorAgent import RgResumeOrchestratorAgent
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(RgResumeOrchestratorAgent, 'heal_repository') or \
                       any('heal' in str(m).lower() for m in dir(RgResumeOrchestratorAgent))
