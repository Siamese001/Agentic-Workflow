...
class TestContentStrategyAgent:
    """Test suite for ContentStrategyAgent."""
    ...
    def test_class_is_agent(self):
        ...
        try:
            ...
            # Check it's a class
            assert isinstance(ContentStrategyAgent, type)
        except ImportError:
    ...
    def test_instantiation_with_mocks(self):
        ...
        try:
            ...
            with patch.multiple(ContentStrategyAgent, __init__=lambda self: None, create=True):
    ...
    def test_has_healing_capability(self):
        ...
        try:
            ...
            has_heal = hasattr(ContentStrategyAgent, "heal_repository") or any(
                "heal" in str(m).lower() for m in dir(ContentStrategyAgent)
            )
    ...
    def test_key_methods_exist(self):
        ...
        try:
            ...
            methods = [m for m in dir(ContentStrategyAgent) if not m.startswith("_")]
