                ...
                "diffs": [
                    {
                        ...
                        "content": "diff --git a/architecture.md b/architecture.md\n+++ b/architecture.md\n@@ -1,10 +1,20 @@\n # Current System\n \n ## Components\n - User Service\n - API Gateway\n - Database\n+\n+## New Components\n+- Auth Service\n+- Token Store\n+- Session Manager\n"
                        * 10,
                    },
                ],
