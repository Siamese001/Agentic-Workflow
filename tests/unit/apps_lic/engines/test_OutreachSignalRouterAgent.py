...
# tests\apps\test_OutreachSignalRouterAgent.py was depth 3, MUST be 2.
...
class TestOutreachSignalRouterAgent:
    ...
    def test_agent_mcp_hardened(self):
        ...
        if "MCPHardenedMixin" in mro_names:
            ...
            assert hasattr(OutreachSignalRouterAgent, "list_tools") or hasattr(
                OutreachSignalRouterAgent, "call_tool"
            )
    ...
    def test_agent_subatomic_testing(self):
        ...
        if "SubatomicTestingMixin" in mro_names:
            ...
            assert hasattr(OutreachSignalRouterAgent, "run_tests") or hasattr(
                OutreachSignalRouterAgent, "self_test"
            )
...
class TestOutreachSignalRouterAgentIntegration:
    ...
    def test_agent_file_exists(self):
        ...
        agent_path = (
            ...
            / "apps_lic/engines/outreach_engine/OutreachSignalRouterAgent.py"
        )
