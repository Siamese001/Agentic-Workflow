"""
Unit tests for CheckSchemaPolicyValidator
...
class TestCheckSchemaPolicyValidatorInitialization:
...
class TestCheckSchemaPolicyValidatorCoreMethods:
...
class TestCheckSchemaPolicyValidatorEdgeCases:
...
class TestCheckSchemaPolicyValidatorTypeBoundaries:
