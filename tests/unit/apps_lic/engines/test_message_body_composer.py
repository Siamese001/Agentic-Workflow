"""
Unit tests for MessageBodyComposer
...
class TestMessageBodyComposerInitialization:
...
class TestMessageBodyComposerCoreMethods:
...
class TestMessageBodyComposerEdgeCases:
...
class TestMessageBodyComposerTypeBoundaries:
