"""
Unit tests for HOP4RoutingAgent - Analyzer in Apps.
...
class TestHOP4RoutingAgent:
    ...
    def agent_class(self):
        ...
        try:
            ...
            pytest.skip(f"Cannot import HOP4RoutingAgent: {e}")

    def test_class_exists(self, agent_class):
        """Verify HOP4RoutingAgent exists and is importable."""
        assert agent_class is not None, "HOP4RoutingAgent should exist"
    ...
    def test_no_network_calls_on_import(self):
        ...
        with patch("requests.get", track_call), patch("requests.post", track_call):
            try:
                from apps_lic.engines.HOP4RoutingAgent import HOP4RoutingAgent  # noqa: F401
