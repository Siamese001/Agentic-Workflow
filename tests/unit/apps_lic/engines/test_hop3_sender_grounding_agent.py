"""
Unit tests for HOP3SenderGroundingAgent - Governor in Apps.
...
class TestHOP3SenderGroundingAgent:
    """Unit tests for HOP3SenderGroundingAgent."""
    ...
    def agent_class(self):
        ...
        try:
            ...
            pytest.skip(f"Cannot import HOP3SenderGroundingAgent: {e}")

    def test_class_exists(self, agent_class):
        """Verify HOP3SenderGroundingAgent exists and is importable."""
        assert agent_class is not None, "HOP3SenderGroundingAgent should exist"
