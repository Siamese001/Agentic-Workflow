"""
Unit tests for InvokeMessageService
...
class TestInvokeMessageServiceInitialization:
...
class TestInvokeMessageServiceCoreMethods:
...
class TestInvokeMessageServiceEdgeCases:
...
class TestInvokeMessageServiceTypeBoundaries:
