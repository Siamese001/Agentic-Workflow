"""
Unit tests for AggregateCampaignState
...
class TestAggregateCampaignStateInitialization:
...
class TestAggregateCampaignStateCoreMethods:
...
class TestAggregateCampaignStateEdgeCases:
...
class TestAggregateCampaignStateTypeBoundaries:
