"""
Unit tests for NormalizeRelevanceScores
...
class TestNormalizeRelevanceScoresInitialization:
...
class TestNormalizeRelevanceScoresCoreMethods:
...
class TestNormalizeRelevanceScoresEdgeCases:
...
class TestNormalizeRelevanceScoresTypeBoundaries:
