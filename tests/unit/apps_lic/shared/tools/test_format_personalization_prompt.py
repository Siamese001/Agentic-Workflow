"""
Unit tests for FormatPersonalizationPrompt
...
class TestFormatPersonalizationPromptInitialization:
...
class TestFormatPersonalizationPromptCoreMethods:
...
class TestFormatPersonalizationPromptEdgeCases:
...
class TestFormatPersonalizationPromptTypeBoundaries:
