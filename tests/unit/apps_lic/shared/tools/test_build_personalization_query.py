"""
Unit tests for BuildPersonalizationQuery
...
class TestBuildPersonalizationQueryInitialization:
...
class TestBuildPersonalizationQueryCoreMethods:
...
class TestBuildPersonalizationQueryEdgeCases:
...
class TestBuildPersonalizationQueryTypeBoundaries:
