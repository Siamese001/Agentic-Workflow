"""
Unit tests for ImmutableStagingBuffer
...
class TestImmutableStagingBufferInitialization:
...
class TestImmutableStagingBufferCoreMethods:
...
class TestImmutableStagingBufferEdgeCases:
...
class TestImmutableStagingBufferTypeBoundaries:
