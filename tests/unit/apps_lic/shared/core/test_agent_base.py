...
class ConcreteTestAgent(LICAgentBase):
...
class FailingTestAgent(LICAgentBase):
    def _process(self, buffer: ImmutableStagingBuffer, registry: TraceRegistry) -> None:
        raise ValueError("Simulated failure")


class TestLICAgentBase:
    @patch("apps_lic.shared.core.agent_base.load_agent_specs")
