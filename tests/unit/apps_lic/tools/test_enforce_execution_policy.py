"""
Unit tests for EnforceExecutionPolicy
...
class TestEnforceExecutionPolicyInitialization:
...
class TestEnforceExecutionPolicyCoreMethods:
...
class TestEnforceExecutionPolicyEdgeCases:
...
class TestEnforceExecutionPolicyTypeBoundaries:
