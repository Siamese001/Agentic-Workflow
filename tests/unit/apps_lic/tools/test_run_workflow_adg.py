...
@pytest.mark.skipif(not _AVAILABLE, reason="run_workflow.py deps unavailable")
class TestLoadMissionInput:
    def test_is_callable(self):
        assert callable(load_mission_input)
...
def test_module_importable():
    """Module run_workflow.py is importable (or deps unavailable)."""
