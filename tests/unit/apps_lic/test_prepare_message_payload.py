"""
Unit tests for PrepareMessagePayload
...
class TestPrepareMessagePayloadInitialization:
...
class TestPrepareMessagePayloadCoreMethods:
...
class TestPrepareMessagePayloadEdgeCases:
...
class TestPrepareMessagePayloadTypeBoundaries:
