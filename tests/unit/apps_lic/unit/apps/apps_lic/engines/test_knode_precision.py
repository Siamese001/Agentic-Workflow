...
class TestKNodePrecision:
    ...
    def test_k1_cxo_precedence_ceo(self):
        ...
        buffer.write_once(
            "recipient_profile",
            {"title": "Acting CEO", "about": "N/A", "name": "John Doe", "company": "TestCorp"},
        )
    ...
    def test_full_k_node_integration(self):
        ...
        buffer.write_once(
            "hop2_research",
            {"signal_score": 0.9, "strategic_signals": ["Digital transformation", "AI adoption"]},
        )
        buffer.write_once(
            "hop3_sender_grounding", {"sender_grounding": {"products": ["Platform X", "Service Y"]}}
        )
        buffer.write_once(
            "hop4_routing",
            {
        ...
        assert (
            "Two strategic insights I have gleaned from my research about MegaCorp:" in draft_text
        )
