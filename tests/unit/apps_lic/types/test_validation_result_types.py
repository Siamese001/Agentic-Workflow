...
def test_test_validation_result_types_can_import():
    ...
    try:
        mod = importlib.import_module("apps_lic.types.validation_result_types")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module apps_lic.types.validation_result_types: {e}")
...
def test_test_validation_result_types_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module apps_lic.types.validation_result_types")
