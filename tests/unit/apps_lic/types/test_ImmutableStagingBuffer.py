...
ADG import-hygiene is covered separately by test_ImmutableStagingBuffer_adg.py.
...
@pytest.mark.skipif(not _AVAILABLE, reason="ImmutableStagingBuffer.py deps unavailable")
class TestImmutableStagingBufferContract:
    def test_is_dataclass(self):
        import dataclasses
        assert dataclasses.is_dataclass(ImmutableStagingBuffer)
