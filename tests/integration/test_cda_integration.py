...
class TestCDAIntegration(unittest.TestCase):
    ...
    def test_enhanced_decision_engine_creation(self):
        ...
        try:
            from agentic_core.L0_maintenance.scripts.execute_ssot import EnhancedAutonomousDecisionEngine
...
class TestCDALiveIntegration(unittest.TestCase):
    ...
    @unittest.skipUnless(os.getenv("RUN_LIVE_TESTS"), "Live tests require RUN_LIVE_TESTS environment variable")
