...
class TestHookCLI:
    ...
    def test_hook_mode_returns_zero(self):
        ...
        result = subprocess.run(
            [sys.executable, str(REPO_ROOT / ".claude" / "governance" / "scripts" / "pre_ask_user_question_gate.py"), "--hook-mode"],
            capture_output=True,
            text=True,
        )
    ...
    def test_test_mode_returns_zero(self):
        ...
        result = subprocess.run(
            [sys.executable, str(REPO_ROOT / ".claude" / "governance" / "scripts" / "pre_ask_user_question_gate.py"), "--test"],
            capture_output=True,
            text=True,
        )
    ...
    def test_stdin_mode_valid_input(self):
        ...
        result = subprocess.run(
            [sys.executable, str(REPO_ROOT / ".claude" / "governance" / "scripts" / "pre_ask_user_question_gate.py")],
