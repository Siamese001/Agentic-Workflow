...
_emit_execution_terminates_at_uwg("p1", "test_orchestrator_hardening", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "test_orchestrator_hardening", "uwg_term_secondary")
_emit_writes_through("p1", "test_orchestrator_hardening", "write_through")
_emit_writes_through("p1", "test_orchestrator_hardening", "write_through_secondary")
