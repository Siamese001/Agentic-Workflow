...
_emit_escalates_to_human("p1", "test_sqlite_memory_store", "human_escalation")
_emit_routes_through("p1", "test_sqlite_memory_store", "route_through")
_emit_checks_agent_registry("p1", "test_sqlite_memory_store", "agent_registry")
_emit_validates_agent_capability("p1", "test_sqlite_memory_store", "capability")
_emit_dispatches_execution_plan("p1", "test_sqlite_memory_store", "exec_plan")
_emit_agent_executes_agent("p1", "test_sqlite_memory_store", "sub_agent")
_emit_routes_to_agent("p1", "test_sqlite_memory_store", "target_agent")
_emit_verifies_policy("p1", "test_sqlite_memory_store", "policy_check")
_emit_observes_runtime_state("p1", "test_sqlite_memory_store", "runtime_state")
_emit_verifies_boundary("p1", "test_sqlite_memory_store", "boundary_check")
_emit_transcripts_response("p1", "test_sqlite_memory_store", "transcript")
_emit_hard_fails_untranscripted("p1", "test_sqlite_memory_store")
_emit_gated_by_confidence("p1", "test_sqlite_memory_store", "confidence_gate")
