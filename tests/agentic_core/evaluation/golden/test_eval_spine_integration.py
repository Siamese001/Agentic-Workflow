"""ADG-hotspot scaffold tests for `agentic_core.evaluation.golden.eval_spine_integration` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.evaluation.golden.eval_spine_integration"
