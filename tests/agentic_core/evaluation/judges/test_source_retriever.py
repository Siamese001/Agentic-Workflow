"""ADG-hotspot scaffold tests for `agentic_core.evaluation.judges.source_retriever` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.evaluation.judges.source_retriever"
