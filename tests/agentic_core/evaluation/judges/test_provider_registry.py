"""ADG-hotspot scaffold tests for `agentic_core.evaluation.judges.provider_registry` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.evaluation.judges.provider_registry"
