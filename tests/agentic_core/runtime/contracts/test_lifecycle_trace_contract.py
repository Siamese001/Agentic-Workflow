"""ADG-hotspot scaffold tests for `agentic_core.runtime.contracts.lifecycle_trace_contract` (fanin=1953).
...
MODULE_PATH = "agentic_core.runtime.contracts.lifecycle_trace_contract"
