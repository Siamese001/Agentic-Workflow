"""ADG-hotspot scaffold tests for `agentic_core.runtime.config.anomaly_report_config` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.runtime.config.anomaly_report_config"
