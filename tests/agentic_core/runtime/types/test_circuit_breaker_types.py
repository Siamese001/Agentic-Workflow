"""ADG-hotspot scaffold tests for `agentic_core.runtime.types.circuit_breaker_types` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.runtime.types.circuit_breaker_types"
