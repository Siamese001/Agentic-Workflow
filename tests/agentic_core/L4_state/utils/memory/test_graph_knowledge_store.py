"""ADG-hotspot scaffold tests for `agentic_core.L4_state.utils.memory.graph_knowledge_store` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L4_state.utils.memory.graph_knowledge_store"
