"""ADG-hotspot scaffold tests for `agentic_core.L4_state.utils.memory.template_registry` (fanin=6).
...
MODULE_PATH = "agentic_core.L4_state.utils.memory.template_registry"
