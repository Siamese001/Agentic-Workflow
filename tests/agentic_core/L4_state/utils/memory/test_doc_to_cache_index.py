"""ADG-hotspot scaffold tests for `agentic_core.L4_state.utils.memory.doc_to_cache_index` (fanin=2).
...
MODULE_PATH = "agentic_core.L4_state.utils.memory.doc_to_cache_index"
