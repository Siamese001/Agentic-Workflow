"""ADG-hotspot scaffold tests for `agentic_core.L4_state.utils.memory.chunk_manifest_registry` (fanin=2).
...
MODULE_PATH = "agentic_core.L4_state.utils.memory.chunk_manifest_registry"
