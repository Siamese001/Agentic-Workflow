"""ADG-hotspot scaffold tests for `agentic_core.L4_state.utils.memory.cache_lock_client` (fanin=2).
...
MODULE_PATH = "agentic_core.L4_state.utils.memory.cache_lock_client"
