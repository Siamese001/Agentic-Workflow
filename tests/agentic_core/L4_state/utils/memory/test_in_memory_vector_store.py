"""ADG-hotspot scaffold tests for `agentic_core.L4_state.utils.memory.in_memory_vector_store` (fanin=2).
...
MODULE_PATH = "agentic_core.L4_state.utils.memory.in_memory_vector_store"
