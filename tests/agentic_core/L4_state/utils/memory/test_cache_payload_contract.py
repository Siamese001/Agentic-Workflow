"""ADG-hotspot scaffold tests for `agentic_core.L4_state.utils.memory.cache_payload_contract` (fanin=2).
...
MODULE_PATH = "agentic_core.L4_state.utils.memory.cache_payload_contract"
