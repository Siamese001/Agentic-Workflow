"""ADG-hotspot scaffold tests for `agentic_core.L4_state.utils.commit.two_phase_coordinator` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L4_state.utils.commit.two_phase_coordinator"
