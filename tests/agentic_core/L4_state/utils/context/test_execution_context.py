"""ADG-hotspot scaffold tests for `agentic_core.L4_state.utils.context.execution_context` (fanin=20).
...
MODULE_PATH = "agentic_core.L4_state.utils.context.execution_context"
