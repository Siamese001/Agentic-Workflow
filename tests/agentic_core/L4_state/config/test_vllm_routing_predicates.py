"""ADG-hotspot scaffold tests for `agentic_core.L4_state.config.vllm_routing_predicates` (fanin=5).
...
MODULE_PATH = "agentic_core.L4_state.config.vllm_routing_predicates"
