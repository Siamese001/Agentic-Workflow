"""ADG-hotspot scaffold tests for `agentic_core.L4_state.reasoning.meta_learning_feedback` (fanin=3).
...
MODULE_PATH = "agentic_core.L4_state.reasoning.meta_learning_feedback"
