"""ADG-hotspot scaffold tests for `agentic_core.L4_state.reasoning.parent_child_expansion` (fanin=3).
...
MODULE_PATH = "agentic_core.L4_state.reasoning.parent_child_expansion"
