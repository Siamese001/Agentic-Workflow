"""ADG-hotspot scaffold tests for `agentic_core.L4_state.enforcement.graph_memory_bridge` (fanin=12).
...
MODULE_PATH = "agentic_core.L4_state.enforcement.graph_memory_bridge"
