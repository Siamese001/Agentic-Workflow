"""ADG-hotspot scaffold tests for `agentic_core.L4_state.enforcement.elevator_shaft_consistency_enforcer` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L4_state.enforcement.elevator_shaft_consistency_enforcer"
