"""ADG-hotspot scaffold tests for `agentic_core.L4_state.enforcement.knowledge_integrity_guard` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L4_state.enforcement.knowledge_integrity_guard"
