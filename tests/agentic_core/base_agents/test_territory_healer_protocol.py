"""ADG-hotspot scaffold tests for `agentic_core.base_agents.territory_healer_protocol` (fanin=4).
...
MODULE_PATH = "agentic_core.base_agents.territory_healer_protocol"
