"""ADG-hotspot scaffold tests for `agentic_core.knowledge.document_loaders.csv_document_loader_config` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.knowledge.document_loaders.csv_document_loader_config"
