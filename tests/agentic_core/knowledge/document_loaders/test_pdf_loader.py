"""ADG-hotspot scaffold tests for `agentic_core.knowledge.document_loaders.pdf_loader` (fanin=2).
...
MODULE_PATH = "agentic_core.knowledge.document_loaders.pdf_loader"
