"""ADG-hotspot scaffold tests for `agentic_core.knowledge.chunking.corpus_classifier` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.knowledge.chunking.corpus_classifier"
