"""ADG-hotspot scaffold tests for `agentic_core.knowledge.enrichment.semantic_enricher` (fanin=2).
...
MODULE_PATH = "agentic_core.knowledge.enrichment.semantic_enricher"
