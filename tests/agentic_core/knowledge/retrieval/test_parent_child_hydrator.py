"""ADG-hotspot scaffold tests for `agentic_core.knowledge.retrieval.parent_child_hydrator` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.knowledge.retrieval.parent_child_hydrator"
