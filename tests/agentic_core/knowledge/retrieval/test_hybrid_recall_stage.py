"""ADG-hotspot scaffold tests for `agentic_core.knowledge.retrieval.hybrid_recall_stage` (fanin=5).
...
MODULE_PATH = "agentic_core.knowledge.retrieval.hybrid_recall_stage"
