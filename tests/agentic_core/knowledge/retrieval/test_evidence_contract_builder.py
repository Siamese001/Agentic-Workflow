"""ADG-hotspot scaffold tests for `agentic_core.knowledge.retrieval.evidence_contract_builder` (fanin=12).
...
MODULE_PATH = "agentic_core.knowledge.retrieval.evidence_contract_builder"
