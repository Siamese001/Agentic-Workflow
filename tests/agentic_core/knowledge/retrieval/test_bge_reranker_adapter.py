"""ADG-hotspot scaffold tests for `agentic_core.knowledge.retrieval.bge_reranker_adapter` (fanin=2).
...
MODULE_PATH = "agentic_core.knowledge.retrieval.bge_reranker_adapter"
