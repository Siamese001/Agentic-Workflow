"""ADG-hotspot scaffold tests for `agentic_core.knowledge.retrieval.senior_librarian_reranker` (fanin=4).
...
MODULE_PATH = "agentic_core.knowledge.retrieval.senior_librarian_reranker"
