"""ADG-hotspot scaffold tests for `agentic_core.knowledge.canonical.raw_unit_factory` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.knowledge.canonical.raw_unit_factory"
