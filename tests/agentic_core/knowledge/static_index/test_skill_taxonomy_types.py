"""ADG-hotspot scaffold tests for `agentic_core.knowledge.static_index.skill_taxonomy_types` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.knowledge.static_index.skill_taxonomy_types"
