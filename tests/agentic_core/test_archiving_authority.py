"""
Unit tests for ArchivingAuthority
...
class TestArchivingAuthorityInitialization:
...
class TestArchivingAuthorityCoreMethods:
...
class TestArchivingAuthorityEdgeCases:
...
class TestArchivingAuthorityTypeBoundaries:
