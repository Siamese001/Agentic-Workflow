...
def test_test_guardian_registry_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L0_routing.types.guardian_registry")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L0_routing.types.guardian_registry: {e}")
...
def test_test_guardian_registry_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L0_routing.types.guardian_registry")
