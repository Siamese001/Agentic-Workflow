"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.adg_span_annotator` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L6_observability.adg_span_annotator"
