"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.routing_decision_events_schema` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L6_observability.routing_decision_events_schema"
