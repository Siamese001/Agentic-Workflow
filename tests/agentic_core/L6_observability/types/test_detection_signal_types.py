"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.types.detection_signal_types` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L6_observability.types.detection_signal_types"
