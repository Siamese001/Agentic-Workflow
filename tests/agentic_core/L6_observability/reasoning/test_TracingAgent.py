...
def test_test_TracingAgent_can_import():
    ...
    try:
        mod = importlib.import_module("tests.support.l6_observability.TracingAgent")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module tests.support.l6_observability.TracingAgent: {e}")
...
def test_test_TracingAgent_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module tests.support.l6_observability.TracingAgent")
