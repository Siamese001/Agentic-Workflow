"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.reasoning.observability_probe_executor` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L6_observability.reasoning.observability_probe_executor"
