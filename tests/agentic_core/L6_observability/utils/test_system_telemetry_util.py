"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.system_telemetry_util` (fanin=2).
...
MODULE_PATH = "agentic_core.L6_observability.utils.system_telemetry_util"
