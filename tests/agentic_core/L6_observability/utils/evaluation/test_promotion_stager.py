"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.evaluation.promotion_stager` (fanin=6).
...
MODULE_PATH = "agentic_core.L6_observability.utils.evaluation.promotion_stager"
