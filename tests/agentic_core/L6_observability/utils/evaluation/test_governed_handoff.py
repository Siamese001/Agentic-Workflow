"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.evaluation.governed_handoff` (fanin=4).
...
MODULE_PATH = "agentic_core.L6_observability.utils.evaluation.governed_handoff"
