"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.evaluation.rca_aggregator` (fanin=7).
...
MODULE_PATH = "agentic_core.L6_observability.utils.evaluation.rca_aggregator"
