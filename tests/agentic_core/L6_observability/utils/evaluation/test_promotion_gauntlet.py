"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.evaluation.promotion_gauntlet` (fanin=2).
...
MODULE_PATH = "agentic_core.L6_observability.utils.evaluation.promotion_gauntlet"
