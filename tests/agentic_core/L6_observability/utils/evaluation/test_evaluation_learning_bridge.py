"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.evaluation.evaluation_learning_bridge` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L6_observability.utils.evaluation.evaluation_learning_bridge"
