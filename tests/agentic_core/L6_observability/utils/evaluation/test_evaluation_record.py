"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.evaluation.evaluation_record` (fanin=3).
...
MODULE_PATH = "agentic_core.L6_observability.utils.evaluation.evaluation_record"
