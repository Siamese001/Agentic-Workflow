"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.evaluation.shadow_eval_grader` (fanin=4).
...
MODULE_PATH = "agentic_core.L6_observability.utils.evaluation.shadow_eval_grader"
