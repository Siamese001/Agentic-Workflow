"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.engines.drift_registry` (fanin=2).
...
MODULE_PATH = "agentic_core.L6_observability.utils.engines.drift_registry"
