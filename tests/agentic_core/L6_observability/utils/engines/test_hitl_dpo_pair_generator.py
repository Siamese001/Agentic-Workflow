"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.engines.hitl_dpo_pair_generator` (fanin=3).
...
MODULE_PATH = "agentic_core.L6_observability.utils.engines.hitl_dpo_pair_generator"
