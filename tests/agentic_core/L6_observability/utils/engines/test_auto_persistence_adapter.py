"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.engines.auto_persistence_adapter` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L6_observability.utils.engines.auto_persistence_adapter"
