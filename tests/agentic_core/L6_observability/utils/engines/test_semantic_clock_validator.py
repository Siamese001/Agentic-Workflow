"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.engines.semantic_clock_validator` (fanin=2).
...
MODULE_PATH = "agentic_core.L6_observability.utils.engines.semantic_clock_validator"
