"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.dashboard.dashboard_aggregate` (fanin=3).
...
MODULE_PATH = "agentic_core.L6_observability.utils.dashboard.dashboard_aggregate"
