"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.dashboard.dashboard_orchestrator` (fanin=2).
...
MODULE_PATH = "agentic_core.L6_observability.utils.dashboard.dashboard_orchestrator"
