"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.metrics.prometheus_metrics` (fanin=6).
...
MODULE_PATH = "agentic_core.L6_observability.utils.metrics.prometheus_metrics"
