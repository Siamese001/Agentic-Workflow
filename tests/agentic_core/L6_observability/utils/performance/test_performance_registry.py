"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.performance.performance_registry` (fanin=3).
...
MODULE_PATH = "agentic_core.L6_observability.utils.performance.performance_registry"
