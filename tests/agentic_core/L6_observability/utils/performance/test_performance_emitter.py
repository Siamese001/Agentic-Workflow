"""ADG-hotspot scaffold tests for `agentic_core.L6_observability.utils.performance.performance_emitter` (fanin=4).
...
MODULE_PATH = "agentic_core.L6_observability.utils.performance.performance_emitter"
