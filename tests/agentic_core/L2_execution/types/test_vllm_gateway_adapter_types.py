"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.vllm_gateway_adapter_types` (fanin=5).
...
MODULE_PATH = "agentic_core.L2_execution.types.vllm_gateway_adapter_types"
