"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.trace_grading_hooks` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L2_execution.types.trace_grading_hooks"
