"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.l2_execution_contract` (fanin=6).
...
MODULE_PATH = "agentic_core.L2_execution.types.l2_execution_contract"
