"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.l2_instruction_packet` (fanin=5).
...
MODULE_PATH = "agentic_core.L2_execution.types.l2_instruction_packet"
