"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.sealed_l2_artifact` (fanin=15).
...
MODULE_PATH = "agentic_core.L2_execution.types.sealed_l2_artifact"
