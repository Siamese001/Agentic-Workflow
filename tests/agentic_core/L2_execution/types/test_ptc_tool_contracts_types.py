"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.ptc_tool_contracts_types` (fanin=3).
...
MODULE_PATH = "agentic_core.L2_execution.types.ptc_tool_contracts_types"
