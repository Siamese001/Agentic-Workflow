"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.vllm_serving_profile_types` (fanin=2).
...
MODULE_PATH = "agentic_core.L2_execution.types.vllm_serving_profile_types"
