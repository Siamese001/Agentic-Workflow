"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.execution_tool_contract` (fanin=7).
...
MODULE_PATH = "agentic_core.L2_execution.types.execution_tool_contract"
