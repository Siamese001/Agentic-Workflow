"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.l2_tool_enrichment` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L2_execution.types.l2_tool_enrichment"
