"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.l2_safety_contracts` (fanin=4).
...
MODULE_PATH = "agentic_core.L2_execution.types.l2_safety_contracts"
