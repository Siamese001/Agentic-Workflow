"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.agent_taxonomy_registry` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L2_execution.types.agent_taxonomy_registry"
