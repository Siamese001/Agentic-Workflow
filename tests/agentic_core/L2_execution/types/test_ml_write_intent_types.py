"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.ml_write_intent_types` (fanin=2, band=P3).
...
MODULE_PATH = "agentic_core.L2_execution.types.ml_write_intent_types"
