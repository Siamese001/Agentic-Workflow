"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.capability_token_v4_types` (fanin=12).
...
MODULE_PATH = "agentic_core.L2_execution.types.capability_token_v4_types"
