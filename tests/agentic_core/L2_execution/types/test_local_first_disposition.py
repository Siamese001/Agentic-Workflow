"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.local_first_disposition` (fanin=6).
...
MODULE_PATH = "agentic_core.L2_execution.types.local_first_disposition"
