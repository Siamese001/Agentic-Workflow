"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.types.tool_intent_types` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L2_execution.types.tool_intent_types"
