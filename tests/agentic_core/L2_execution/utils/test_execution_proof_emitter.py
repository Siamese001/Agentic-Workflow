"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.utils.execution_proof_emitter` (fanin=18).
...
MODULE_PATH = "agentic_core.L2_execution.utils.execution_proof_emitter"
