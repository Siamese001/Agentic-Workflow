"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.enforcement.UniversalWriteGateway` (fanin=3).
...
MODULE_PATH = "agentic_core.L2_execution.enforcement.UniversalWriteGateway"
