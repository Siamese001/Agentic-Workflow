"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.enforcement._adapter_openai_oseries` (fanin=4).
...
MODULE_PATH = "agentic_core.L2_execution.enforcement._adapter_openai_oseries"
