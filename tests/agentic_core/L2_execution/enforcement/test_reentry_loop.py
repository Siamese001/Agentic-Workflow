"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.enforcement.reentry_loop` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L2_execution.enforcement.reentry_loop"
