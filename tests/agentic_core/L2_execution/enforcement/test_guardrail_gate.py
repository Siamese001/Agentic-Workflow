"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.enforcement.guardrail_gate` (fanin=12).
...
MODULE_PATH = "agentic_core.L2_execution.enforcement.guardrail_gate"
