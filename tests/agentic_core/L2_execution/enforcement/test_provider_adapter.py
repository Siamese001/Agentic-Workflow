"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.enforcement.provider_adapter` (fanin=8).
...
MODULE_PATH = "agentic_core.L2_execution.enforcement.provider_adapter"
