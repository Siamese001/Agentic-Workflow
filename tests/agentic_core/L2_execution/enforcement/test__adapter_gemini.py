"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.enforcement._adapter_gemini` (fanin=5).
...
MODULE_PATH = "agentic_core.L2_execution.enforcement._adapter_gemini"
