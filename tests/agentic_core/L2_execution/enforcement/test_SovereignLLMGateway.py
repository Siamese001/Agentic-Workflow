"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.enforcement.SovereignLLMGateway` (fanin=11).
...
MODULE_PATH = "agentic_core.L2_execution.enforcement.SovereignLLMGateway"
