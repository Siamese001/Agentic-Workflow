"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.enforcement.e2_validate_before_execute` (fanin=4).
...
MODULE_PATH = "agentic_core.L2_execution.enforcement.e2_validate_before_execute"
