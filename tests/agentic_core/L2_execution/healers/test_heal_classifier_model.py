"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.healers.heal_classifier_model` (fanin=5).
...
MODULE_PATH = "agentic_core.L2_execution.healers.heal_classifier_model"
