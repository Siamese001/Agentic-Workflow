"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.healers.confidence_scorer` (fanin=9).
...
MODULE_PATH = "agentic_core.L2_execution.healers.confidence_scorer"
