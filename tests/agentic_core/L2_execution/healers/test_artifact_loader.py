"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.healers.artifact_loader` (fanin=2, band=P3).
...
MODULE_PATH = "agentic_core.L2_execution.healers.artifact_loader"
