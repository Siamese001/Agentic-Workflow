"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.reasoning.slot_assembly_engine` (fanin=3).
...
MODULE_PATH = "agentic_core.L2_execution.reasoning.slot_assembly_engine"
