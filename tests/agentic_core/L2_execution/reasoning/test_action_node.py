"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.reasoning.action_node` (fanin=2, band=P3).
...
MODULE_PATH = "agentic_core.L2_execution.reasoning.action_node"
