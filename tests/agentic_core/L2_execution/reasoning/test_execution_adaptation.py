"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.reasoning.execution_adaptation` (fanin=3).
...
MODULE_PATH = "agentic_core.L2_execution.reasoning.execution_adaptation"
