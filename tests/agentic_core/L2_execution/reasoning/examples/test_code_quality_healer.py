"""ADG-hotspot scaffold tests for `agentic_core.L2_execution.reasoning.examples.code_quality_healer` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L2_execution.reasoning.examples.code_quality_healer"
