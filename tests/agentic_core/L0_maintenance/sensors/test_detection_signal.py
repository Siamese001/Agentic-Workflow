"""
Unit tests for DetectionSignal
...
class TestDetectionSignalInitialization:
...
class TestDetectionSignalCoreMethods:
...
class TestDetectionSignalEdgeCases:
...
class TestDetectionSignalTypeBoundaries:
