...
def test_test_ssot_consolidation_analyzer_can_import():
    ...
    try:
        mod = load_dev_script("ssot_consolidation_analyzer.py")
        assert mod is not None
    except ImportError as e:
        pytest.skip(
            f"Cannot load dev_tools/l0_scripts/ssot_consolidation_analyzer.py: {e}",
        )
...
def test_test_ssot_consolidation_analyzer_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/ssot_consolidation_analyzer.py")
