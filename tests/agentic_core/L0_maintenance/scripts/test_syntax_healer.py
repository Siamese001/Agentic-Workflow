...
def test_test_syntax_healer_can_import():
    ...
    try:
        mod = load_dev_script("syntax_healer.py")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot load dev_tools/l0_scripts/syntax_healer.py: {e}")
...
def test_test_syntax_healer_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/syntax_healer.py")
