...
def test_test_bulk_agent_rename_util_can_import():
    ...
    try:
        mod = importlib.import_module("dev_tools.l0_scripts.bulk_agent_rename_util")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module dev_tools.l0_scripts.bulk_agent_rename_util: {e}")
...
def test_test_bulk_agent_rename_util_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module dev_tools.l0_scripts.bulk_agent_rename_util")
