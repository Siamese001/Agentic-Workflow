...
def test_test_generate_summary_section_can_import():
    ...
    try:
        mod = load_dev_script("generate_summary_section.py")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot load dev_tools/l0_scripts/generate_summary_section.py: {e}")
...
def test_test_generate_summary_section_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/generate_summary_section.py")
