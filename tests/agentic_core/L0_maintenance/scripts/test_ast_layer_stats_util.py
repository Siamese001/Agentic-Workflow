...
def test_test_ast_layer_stats_util_can_import():
    ...
    try:
        mod = importlib.import_module("dev_tools.l0_scripts.ast_layer_stats_util")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module dev_tools.l0_scripts.ast_layer_stats_util: {e}")
...
def test_test_ast_layer_stats_util_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module dev_tools.l0_scripts.ast_layer_stats_util")
