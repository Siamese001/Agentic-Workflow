...
def test_test_sovereignty_auditor_can_import():
    ...
    try:
        mod = load_dev_script("sovereignty_auditor.py")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot load dev_tools/l0_scripts/sovereignty_auditor.py: {e}")
...
def test_test_sovereignty_auditor_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/sovereignty_auditor.py")
