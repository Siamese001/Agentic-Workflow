...
def test_test_complexity_reducer_can_import():
    ...
    try:
        mod = importlib.import_module("dev_tools.l0_scripts.complexity_reducer")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module dev_tools.l0_scripts.complexity_reducer: {e}")
...
def test_test_complexity_reducer_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module dev_tools.l0_scripts.complexity_reducer")
