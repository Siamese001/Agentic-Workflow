...
def test_test_audit_all_agents_mro_util_can_import():
    ...
    try:
        mod = importlib.import_module("dev_tools.l0_scripts.audit_all_agents_mro_util")
        assert mod is not None
    except ImportError as e:
        pytest.skip(
            f"Cannot import module dev_tools.l0_scripts.audit_all_agents_mro_util: {e}",
        )
...
def test_test_audit_all_agents_mro_util_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module dev_tools.l0_scripts.audit_all_agents_mro_util")
