...
def test_test_analyze_extract_can_import():
    ...
    try:
        mod = importlib.import_module("dev_tools.l0_scripts.analyze_extract")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module dev_tools.l0_scripts.analyze_extract: {e}")
...
def test_test_analyze_extract_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module dev_tools.l0_scripts.analyze_extract")
