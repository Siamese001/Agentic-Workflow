"""ADG-hotspot scaffold tests for `agentic_core.L0_routing.enforcement.safety_validators_seam` (fanin=5).
...
MODULE_PATH = "agentic_core.L0_routing.enforcement.safety_validators_seam"
