"""ADG-hotspot scaffold tests for `agentic_core.L0_routing.enforcement.safety_enforcement_seam` (fanin=4).
...
MODULE_PATH = "agentic_core.L0_routing.enforcement.safety_enforcement_seam"
