...
def test_test_ssot_guardrail_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L5_safety.enforcement.ssot_guardrail")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L5_safety.enforcement.ssot_guardrail: {e}")
...
def test_test_ssot_guardrail_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L5_safety.enforcement.ssot_guardrail")
