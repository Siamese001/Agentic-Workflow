"""ADG-hotspot scaffold tests for `agentic_core.L0_routing.types.l0_instruction_packet` (fanin=7).
...
MODULE_PATH = "agentic_core.L0_routing.types.l0_instruction_packet"
