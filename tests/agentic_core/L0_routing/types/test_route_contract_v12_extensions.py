"""ADG-hotspot scaffold tests for `agentic_core.L0_routing.types.route_contract_v12_extensions` (fanin=4).
...
MODULE_PATH = "agentic_core.L0_routing.types.route_contract_v12_extensions"
