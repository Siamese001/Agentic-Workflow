"""ADG-hotspot scaffold tests for `agentic_core.L0_routing.types.guardian_enforcement_exceptions` (fanin=5).
...
MODULE_PATH = "agentic_core.L0_routing.types.guardian_enforcement_exceptions"
