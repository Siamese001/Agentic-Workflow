...
def test_test_mock_subatomic_hop_can_import():
    ...
    try:
        mod = load_dev_script("mock_subatomic_hop.py")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot load dev_tools/l0_scripts/mock_subatomic_hop.py: {e}")
...
def test_test_mock_subatomic_hop_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/mock_subatomic_hop.py")
