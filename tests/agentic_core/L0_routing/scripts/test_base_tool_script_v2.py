...
def test_test_base_tool_script_v2_can_import():
    ...
    try:
        mod = importlib.import_module("agentic_core.L0_routing.scripts.base_tool_script_v2")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot import module agentic_core.L0_routing.scripts.base_tool_script_v2: {e}")
...
def test_test_base_tool_script_v2_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot import module agentic_core.L0_routing.scripts.base_tool_script_v2")
