"""ADG-hotspot scaffold tests for `agentic_core.L0_routing.reasoning.deterministic_routing_gateway` (fanin=15).
...
MODULE_PATH = "agentic_core.L0_routing.reasoning.deterministic_routing_gateway"
