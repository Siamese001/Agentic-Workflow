"""ADG-hotspot scaffold tests for `agentic_core.L0_routing.reasoning.prompt_bom_builder` (fanin=4).
...
MODULE_PATH = "agentic_core.L0_routing.reasoning.prompt_bom_builder"
