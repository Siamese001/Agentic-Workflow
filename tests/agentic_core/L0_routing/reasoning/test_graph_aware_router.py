"""ADG-hotspot scaffold tests for `agentic_core.L0_routing.reasoning.graph_aware_router` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L0_routing.reasoning.graph_aware_router"
