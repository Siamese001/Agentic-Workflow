"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.utils.location_constants_util` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.utils.location_constants_util"
