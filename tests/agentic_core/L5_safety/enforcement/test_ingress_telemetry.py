"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.ingress_telemetry` (fanin=3).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.ingress_telemetry"
