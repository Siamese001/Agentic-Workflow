"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.payload_normalizer` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.payload_normalizer"
