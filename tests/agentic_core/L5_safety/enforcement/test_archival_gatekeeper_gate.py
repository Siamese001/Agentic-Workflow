"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.archival_gatekeeper_gate` (fanin=10).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.archival_gatekeeper_gate"
