"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.input_safety_screen` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.input_safety_screen"
