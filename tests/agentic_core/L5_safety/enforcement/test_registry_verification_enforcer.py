"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.registry_verification_enforcer` (fanin=4).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.registry_verification_enforcer"
