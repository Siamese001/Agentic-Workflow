"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.hitl.hitl_escalation_activator` (fanin=5).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.hitl.hitl_escalation_activator"
