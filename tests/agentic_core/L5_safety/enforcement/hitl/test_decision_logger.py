"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.hitl.decision_logger` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.hitl.decision_logger"
