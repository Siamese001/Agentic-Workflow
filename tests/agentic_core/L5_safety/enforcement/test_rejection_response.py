"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.rejection_response` (fanin=5).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.rejection_response"
