"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.exit_control_gate` (fanin=3).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.exit_control_gate"
