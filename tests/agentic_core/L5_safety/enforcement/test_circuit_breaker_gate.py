"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.enforcement.circuit_breaker_gate` (fanin=4).
...
MODULE_PATH = "agentic_core.L5_safety.enforcement.circuit_breaker_gate"
