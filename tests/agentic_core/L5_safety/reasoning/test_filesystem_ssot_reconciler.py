"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.reasoning.filesystem_ssot_reconciler` (fanin=6).
...
MODULE_PATH = "agentic_core.L5_safety.reasoning.filesystem_ssot_reconciler"
