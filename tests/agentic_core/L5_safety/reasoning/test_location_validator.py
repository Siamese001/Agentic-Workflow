"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.reasoning.location_validator` (fanin=5).
...
MODULE_PATH = "agentic_core.L5_safety.reasoning.location_validator"
