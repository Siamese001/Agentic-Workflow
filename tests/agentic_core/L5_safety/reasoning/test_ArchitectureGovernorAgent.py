"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.reasoning.ArchitectureGovernorAgent` (fanin=7).
...
MODULE_PATH = "agentic_core.L5_safety.reasoning.ArchitectureGovernorAgent"
