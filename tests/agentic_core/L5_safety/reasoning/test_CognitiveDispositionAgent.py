"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.reasoning.CognitiveDispositionAgent` (fanin=5).
...
MODULE_PATH = "agentic_core.L5_safety.reasoning.CognitiveDispositionAgent"
