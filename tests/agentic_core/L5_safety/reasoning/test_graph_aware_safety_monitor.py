"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.reasoning.graph_aware_safety_monitor` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L5_safety.reasoning.graph_aware_safety_monitor"
