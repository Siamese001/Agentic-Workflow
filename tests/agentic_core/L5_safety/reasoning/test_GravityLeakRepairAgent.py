"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.reasoning.GravityLeakRepairAgent` (fanin=6).
...
MODULE_PATH = "agentic_core.L5_safety.reasoning.GravityLeakRepairAgent"
