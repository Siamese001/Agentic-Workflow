"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.config.structure_blueprint.artifacts` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.config.structure_blueprint.artifacts"
