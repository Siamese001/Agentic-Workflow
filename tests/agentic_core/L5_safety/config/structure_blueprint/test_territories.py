"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.config.structure_blueprint.territories` (fanin=5).
...
MODULE_PATH = "agentic_core.L5_safety.config.structure_blueprint.territories"
