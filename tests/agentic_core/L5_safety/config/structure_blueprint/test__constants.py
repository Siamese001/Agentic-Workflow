"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.config.structure_blueprint._constants` (fanin=3).
...
MODULE_PATH = "agentic_core.L5_safety.config.structure_blueprint._constants"
