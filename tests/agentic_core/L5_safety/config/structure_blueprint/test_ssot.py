"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.config.structure_blueprint.ssot` (fanin=12).
...
MODULE_PATH = "agentic_core.L5_safety.config.structure_blueprint.ssot"
