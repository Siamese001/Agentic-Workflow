"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.config.structure_blueprint.semantics` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L5_safety.config.structure_blueprint.semantics"
