"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.config.structure_blueprint.derived` (fanin=4).
...
MODULE_PATH = "agentic_core.L5_safety.config.structure_blueprint.derived"
