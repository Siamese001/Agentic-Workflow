"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.eval_spine.escalation_packet` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.eval_spine.escalation_packet"
