"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.eval_spine.trajectory_metrics` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.eval_spine.trajectory_metrics"
