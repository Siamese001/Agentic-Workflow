"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.eval_spine.tool_call_canonicalizer` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L5_safety.eval_spine.tool_call_canonicalizer"
