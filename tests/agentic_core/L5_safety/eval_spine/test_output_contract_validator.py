"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.eval_spine.output_contract_validator` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.eval_spine.output_contract_validator"
