"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.adapters.notion_approval_adapter` (fanin=3).
...
MODULE_PATH = "agentic_core.L5_safety.adapters.notion_approval_adapter"

_REPO_ROOT = pathlib.Path(__file__).parents[4]
_MODULE_FILE = _REPO_ROOT / "agentic_core" / "L5_safety" / "adapters" / "notion_approval_adapter.py"
