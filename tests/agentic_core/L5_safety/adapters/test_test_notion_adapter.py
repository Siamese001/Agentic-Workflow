"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.adapters.test_notion_adapter` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L5_safety.adapters.test_notion_adapter"
