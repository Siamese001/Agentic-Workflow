"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.adapters.slack_approval_adapter` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.adapters.slack_approval_adapter"
