"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.validators.canonical_truth_validator` (fanin=3).
...
MODULE_PATH = "agentic_core.L5_safety.validators.canonical_truth_validator"
