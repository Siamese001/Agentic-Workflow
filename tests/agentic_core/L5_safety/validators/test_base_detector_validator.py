"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.validators.base_detector_validator` (fanin=7).
...
MODULE_PATH = "agentic_core.L5_safety.validators.base_detector_validator"
