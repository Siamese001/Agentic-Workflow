"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.validators.silent_degradation_validator` (fanin=2).
...
MODULE_PATH = "agentic_core.L5_safety.validators.silent_degradation_validator"
