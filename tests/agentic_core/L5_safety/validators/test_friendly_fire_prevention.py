"""
Unit tests for FriendlyFirePrevention
...
class TestFriendlyFirePreventionInitialization:
...
class TestFriendlyFirePreventionCoreMethods:
...
class TestFriendlyFirePreventionEdgeCases:
...
class TestFriendlyFirePreventionTypeBoundaries:
