"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.validators.anti_pattern_scanner_validator` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L5_safety.validators.anti_pattern_scanner_validator"
