"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.types.healing_orchestration_types` (fanin=5).
...
MODULE_PATH = "agentic_core.L5_safety.types.healing_orchestration_types"
