"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.types.surgical_context_types` (fanin=7).
...
MODULE_PATH = "agentic_core.L5_safety.types.surgical_context_types"
