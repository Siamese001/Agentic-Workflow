"""ADG-hotspot scaffold tests for `agentic_core.L5_safety.types.exit_disposition_types` (fanin=9).
...
MODULE_PATH = "agentic_core.L5_safety.types.exit_disposition_types"
