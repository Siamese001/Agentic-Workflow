"""ADG-hotspot scaffold tests for `agentic_core.adg.analysis.mutation_authority_validator` (fanin=2).
...
MODULE_PATH = "agentic_core.adg.analysis.mutation_authority_validator"
