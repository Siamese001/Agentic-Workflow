"""ADG-hotspot scaffold tests for `agentic_core.adg.analysis.healer_validator_graph_validator` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.adg.analysis.healer_validator_graph_validator"
