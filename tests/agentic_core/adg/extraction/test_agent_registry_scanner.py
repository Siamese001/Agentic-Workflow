"""ADG-hotspot scaffold tests for `agentic_core.adg.extraction.agent_registry_scanner` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.adg.extraction.agent_registry_scanner"
