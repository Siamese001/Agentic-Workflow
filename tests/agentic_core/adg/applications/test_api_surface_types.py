"""ADG-hotspot scaffold tests for `agentic_core.adg.applications.api_surface_types` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.adg.applications.api_surface_types"
