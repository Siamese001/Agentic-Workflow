"""ADG-hotspot scaffold tests for `agentic_core.adg.applications.architecture_verifier_validator` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.adg.applications.architecture_verifier_validator"
