"""ADG-hotspot scaffold tests for `agentic_core.adg.applications.rename_safety_types` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.adg.applications.rename_safety_types"
