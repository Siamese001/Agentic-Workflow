"""ADG-hotspot scaffold tests for `agentic_core.seams.contracts.orchestration_protocols` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.seams.contracts.orchestration_protocols"
