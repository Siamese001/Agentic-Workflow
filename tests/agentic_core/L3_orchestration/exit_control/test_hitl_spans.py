"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.exit_control.hitl_spans` (fanin=4).
...
MODULE_PATH = "agentic_core.L3_orchestration.exit_control.hitl_spans"
