"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.utils.subatomic_agent_util` (fanin=3).
...
MODULE_PATH = "agentic_core.L3_orchestration.utils.subatomic_agent_util"
