"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.exit_eval.dimension` (fanin=20).
...
MODULE_PATH = "agentic_core.L3_orchestration.exit_eval.dimension"
