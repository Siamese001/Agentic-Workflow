"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.exit_eval.graders.code_based` (fanin=5).
...
MODULE_PATH = "agentic_core.L3_orchestration.exit_eval.graders.code_based"
