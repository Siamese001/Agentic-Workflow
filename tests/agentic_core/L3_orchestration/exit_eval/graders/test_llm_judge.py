"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.exit_eval.graders.llm_judge` (fanin=9).
...
MODULE_PATH = "agentic_core.L3_orchestration.exit_eval.graders.llm_judge"
