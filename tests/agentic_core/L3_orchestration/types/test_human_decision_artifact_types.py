"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.types.human_decision_artifact_types` (fanin=6).
...
MODULE_PATH = "agentic_core.L3_orchestration.types.human_decision_artifact_types"
