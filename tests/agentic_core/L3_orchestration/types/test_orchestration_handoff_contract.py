"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.types.orchestration_handoff_contract` (fanin=12).
...
MODULE_PATH = "agentic_core.L3_orchestration.types.orchestration_handoff_contract"
