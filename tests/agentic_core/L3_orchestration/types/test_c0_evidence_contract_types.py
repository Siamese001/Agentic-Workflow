"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.types.c0_evidence_contract_types` (fanin=11).
...
MODULE_PATH = "agentic_core.L3_orchestration.types.c0_evidence_contract_types"
