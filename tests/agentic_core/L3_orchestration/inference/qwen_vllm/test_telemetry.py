"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.inference.qwen_vllm.telemetry` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L3_orchestration.inference.qwen_vllm.telemetry"
