"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.inference.qwen_vllm.reasoning.qwen_inference_gateway` (fanin=6).
...
MODULE_PATH = "agentic_core.L3_orchestration.inference.qwen_vllm.reasoning.qwen_inference_gateway"
