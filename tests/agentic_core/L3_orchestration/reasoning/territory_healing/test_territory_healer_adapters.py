"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.territory_healing.territory_healer_adapters` (fanin=2).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.territory_healing.territory_healer_adapters"
