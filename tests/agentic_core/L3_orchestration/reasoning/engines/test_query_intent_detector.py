"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.engines.query_intent_detector` (fanin=4).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.engines.query_intent_detector"
