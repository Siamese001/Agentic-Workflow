"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.engines.graph_aware_indexer` (fanin=3).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.engines.graph_aware_indexer"
