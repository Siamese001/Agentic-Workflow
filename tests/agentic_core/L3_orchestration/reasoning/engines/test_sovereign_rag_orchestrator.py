"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.engines.sovereign_rag_orchestrator` (fanin=2).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.engines.sovereign_rag_orchestrator"
