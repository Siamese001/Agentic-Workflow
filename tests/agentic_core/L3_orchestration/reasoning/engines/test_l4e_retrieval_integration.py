"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.engines.l4e_retrieval_integration` (fanin=3).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.engines.l4e_retrieval_integration"
