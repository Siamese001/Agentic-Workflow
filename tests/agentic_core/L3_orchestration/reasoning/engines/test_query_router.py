"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.engines.query_router` (fanin=3).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.engines.query_router"
