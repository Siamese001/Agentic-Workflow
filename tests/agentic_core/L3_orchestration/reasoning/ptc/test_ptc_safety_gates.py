"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.ptc.ptc_safety_gates` (fanin=2).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.ptc.ptc_safety_gates"
