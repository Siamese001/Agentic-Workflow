"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.ptc.tool_contract` (fanin=3).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.ptc.tool_contract"
