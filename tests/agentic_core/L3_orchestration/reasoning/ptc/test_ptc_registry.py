"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.ptc.ptc_registry` (fanin=3).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.ptc.ptc_registry"
