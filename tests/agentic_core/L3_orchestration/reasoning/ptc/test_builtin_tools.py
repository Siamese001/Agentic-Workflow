"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.ptc.builtin_tools` (fanin=2).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.ptc.builtin_tools"
