"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.ptc.tool_call_store` (fanin=2).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.ptc.tool_call_store"
