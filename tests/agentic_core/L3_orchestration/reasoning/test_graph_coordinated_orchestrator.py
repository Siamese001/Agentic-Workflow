"""ADG-hotspot scaffold tests for `agentic_core.L3_orchestration.reasoning.graph_coordinated_orchestrator` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L3_orchestration.reasoning.graph_coordinated_orchestrator"
