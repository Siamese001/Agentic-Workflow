...
def test_test_silo_mover_can_import():
    ...
    try:
        mod = load_dev_script("silo_mover.py")
        assert mod is not None
    except ImportError as e:
        pytest.skip(f"Cannot load dev_tools/l0_scripts/silo_mover.py: {e}")
...
def test_test_silo_mover_has_file_attribute():
    ...
    try:
        ...
        pytest.skip("Cannot load dev_tools/l0_scripts/silo_mover.py")
