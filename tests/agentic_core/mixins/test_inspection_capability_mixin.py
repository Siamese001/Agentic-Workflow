"""ADG-hotspot scaffold tests for `agentic_core.mixins.inspection_capability_mixin` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.mixins.inspection_capability_mixin"
