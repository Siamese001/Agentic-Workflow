"""ADG-hotspot scaffold tests for `agentic_core.mixins.performance_optimized_collector` (fanin=2).
...
MODULE_PATH = "agentic_core.mixins.performance_optimized_collector"
