"""ADG-hotspot scaffold tests for `agentic_core.mixins.meta_learning_client_mixin` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.mixins.meta_learning_client_mixin"
