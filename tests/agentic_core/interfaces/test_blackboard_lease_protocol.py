"""ADG-hotspot scaffold tests for `agentic_core.interfaces.blackboard_lease_protocol` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.interfaces.blackboard_lease_protocol"
