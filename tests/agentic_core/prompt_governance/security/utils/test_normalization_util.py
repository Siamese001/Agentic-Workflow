"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.security.utils.normalization_util` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.prompt_governance.security.utils.normalization_util"
