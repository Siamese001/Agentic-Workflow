"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.security.validators.output_schema_validator` (fanin=4).
...
MODULE_PATH = "agentic_core.prompt_governance.security.validators.output_schema_validator"
