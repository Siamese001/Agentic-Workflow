"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.security.detectors.pii_scrubber` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.prompt_governance.security.detectors.pii_scrubber"
