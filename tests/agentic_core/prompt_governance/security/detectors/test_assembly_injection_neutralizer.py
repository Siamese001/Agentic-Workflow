"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.security.assembly_injection_neutralizer` (fanin=2).
...
MODULE_PATH = "agentic_core.prompt_governance.security.assembly_injection_neutralizer"
