"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.contracts.template_manifest_types` (fanin=3).
...
MODULE_PATH = "agentic_core.prompt_governance.contracts.template_manifest_types"
