"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.contracts.prompt_bom_types` (fanin=5).
...
MODULE_PATH = "agentic_core.prompt_governance.contracts.prompt_bom_types"
