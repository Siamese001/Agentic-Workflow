"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.contracts.compiled_artifact_types` (fanin=3).
...
MODULE_PATH = "agentic_core.prompt_governance.contracts.compiled_artifact_types"
