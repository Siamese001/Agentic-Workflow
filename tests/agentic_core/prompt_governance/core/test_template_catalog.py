"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.core.template_catalog` (fanin=2).
...
MODULE_PATH = "agentic_core.prompt_governance.core.template_catalog"
