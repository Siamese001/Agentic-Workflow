"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.core.sovereign_prompt_renderer` (fanin=2).
...
MODULE_PATH = "agentic_core.prompt_governance.core.sovereign_prompt_renderer"
