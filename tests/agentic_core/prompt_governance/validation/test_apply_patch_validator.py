"""ADG-hotspot scaffold tests for `agentic_core.prompt_governance.validation.apply_patch_validator` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.prompt_governance.validation.apply_patch_validator"
