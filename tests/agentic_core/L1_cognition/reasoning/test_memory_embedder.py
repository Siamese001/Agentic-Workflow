"""ADG-hotspot scaffold tests for `agentic_core.L1_cognition.reasoning.memory_embedder` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L1_cognition.reasoning.memory_embedder"
