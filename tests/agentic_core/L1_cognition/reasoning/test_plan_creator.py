"""ADG-hotspot scaffold tests for `agentic_core.L1_cognition.reasoning.plan_creator` (fanin=2, band=P3).
...
MODULE_PATH = "agentic_core.L1_cognition.reasoning.plan_creator"
