"""ADG-hotspot scaffold tests for `agentic_core.L1_cognition.reasoning.semantic_retriever` (fanin=3).
...
MODULE_PATH = "agentic_core.L1_cognition.reasoning.semantic_retriever"
