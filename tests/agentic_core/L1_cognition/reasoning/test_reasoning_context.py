"""ADG-hotspot scaffold tests for `agentic_core.L1_cognition.reasoning.reasoning_context` (fanin=2, band=P3).
...
MODULE_PATH = "agentic_core.L1_cognition.reasoning.reasoning_context"
