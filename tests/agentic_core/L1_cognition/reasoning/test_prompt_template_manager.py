"""ADG-hotspot scaffold tests for `agentic_core.L1_cognition.reasoning.prompt_template_manager` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L1_cognition.reasoning.prompt_template_manager"
