"""ADG-hotspot scaffold tests for `agentic_core.L1_cognition.reasoning.reasoning_context_builder` (fanin=3).
...
MODULE_PATH = "agentic_core.L1_cognition.reasoning.reasoning_context_builder"
