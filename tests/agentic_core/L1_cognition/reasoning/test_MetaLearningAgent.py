"""ADG-hotspot scaffold tests for `agentic_core.L1_cognition.reasoning.MetaLearningAgent` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.L1_cognition.reasoning.MetaLearningAgent"
