"""ADG-hotspot scaffold tests for `agentic_core.L1_cognition.types.reasoning_pattern` (fanin=2, band=P3).
...
MODULE_PATH = "agentic_core.L1_cognition.types.reasoning_pattern"
