"""ADG-hotspot scaffold tests for `agentic_core.utils.workflow_engines.shadow_eval_runner` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.utils.workflow_engines.shadow_eval_runner"
