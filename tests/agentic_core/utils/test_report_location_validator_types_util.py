"""ADG-hotspot scaffold tests for `agentic_core.utils.report_location_validator_types_util` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.utils.report_location_validator_types_util"
