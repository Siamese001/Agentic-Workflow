"""ADG-hotspot scaffold tests for `agentic_core.utils.schemas.evaluation_dataset_schema` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.utils.schemas.evaluation_dataset_schema"
