"""ADG-hotspot scaffold tests for `agentic_core.case_memory.core.graph_neighborhood_memory` (fanin=1, band=P4).
...
MODULE_PATH = "agentic_core.case_memory.core.graph_neighborhood_memory"
