"""Auto-generated flattened view for state/test_safety_state_integration.py.
...
SOURCE_REL_PATH = "state/test_safety_state_integration.py"
SOURCE_PATH = REPO_ROOT / SOURCE_REL_PATH

# Embedded canonical source
EMBEDDED_SOURCES = {
    SOURCE_REL_PATH: """import pathlib
...
ORIGINAL_MODULE_NAME = "tests.state.test_safety_state_integration"
FLAT_MODULE_NAME = "tests_flat.state__test_safety_state_integration"
