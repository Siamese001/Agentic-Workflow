...
from seam_audit import (
    SeamAuditRecord, SeamAuditLogger, get_seam_audit_logger,
    log_seam_operation, get_seam_audit_digest, clear_seam_audit_records
)
...
class TestSeamAuditDeterminism:
    ...
    def test_seam_audit_record_creation(self):
        ...
        result = seam.process_data({"input": "test"})
    ...
    def test_seam_audit_disabled_logging(self):
        ...
        assert result["processed"], "Operation should still work"
