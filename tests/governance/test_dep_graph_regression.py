...
CYCLE_BUDGET = 13  # current: 13  — target: 0
INVERSION_BUDGET = 100  # current: 100 — target: 0
PINECONE_BUDGET = 92  # current: 92  — shrinks with each Pinecone removal wave
...
class TestDepGraphRegression:
    ...
    def test_pinecone_importer_count_within_budget(self) -> None:
        """Pinecone transitive importers must not exceed PINECONE_BUDGET.
        Budget decreases as Pinecone removal waves complete."""
