...
if __name__ == "__main__":
    ...
    print("Running InputSanitizer security tests...")
    
    # Run a few critical tests
    try:
        test_suite.test_xml_breakout_prevention()
        print("✓ XML breakout prevention test passed")
        
        test_suite.test_injection_pattern_detection()
        print("✓ Injection pattern detection test passed")
        
        test_suite.test_json_xml_tunneling_prevention()
        print("✓ JSON XML tunneling prevention test passed")
        
        test_suite.test_template_integrity_validation()
        print("✓ Template integrity validation test passed")
