...
class TestPhase1Foundation:
    ...
    def test_zero_tolerance_regeneration_attempts(self):
        ...
        try:
            fixed_text = enforcer.enforce_with_regeneration(
                short_text, "resume_overview", max_attempts=3
            )
    ...
    def test_router_injects_thematic_analysis(self):
        ...
        assert (
            state["primary_theme"] == "Strategic Leadership"
        )  # CEO role maps to Strategic Leadership
    ...
    def test_router_differentiator_logic(self):
        ...
        flow_result = router._classify_flow_with_thematic_analysis(
            "generate new resume", True, mock_thematic
        )
    ...
    def test_router_flow_configuration_integrity(self):
        ...
        assert (
            len(router.flow_configs["strategic_tailor_node"]["required_hops"]) == 6
        )  # HOP-1 through HOP-6
