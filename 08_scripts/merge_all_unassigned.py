...
def route_file_in_root(filepath: Path, root_name: str, parent_folder: str) -> Tuple[str, str]:
    ...
    # === 04_prompt_governance ===
    if root_name == "04_prompt_governance":
