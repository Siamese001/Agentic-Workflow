...
__version__ = "14_20" # <-- Increment version for tracking changes
...
class PreFlightValidator:
    ...
    def _validate_cover_letter_full_structure(self, context: ValidationContext) -> bool:
        # Validates the full structure of the cover letter (date, recipient, salutation, body, closing, signature).
    ...
    def _validate_bullet_word_count_range(self, context: ValidationContext) -> bool:
        # Validates that all generated bullets fall within their section-specific word count ranges.
    ...
    def _validate_jd_keyword_range(self, context: ValidationContext) -> bool:
        # Validates the total number of unique JD keywords found across the entire resume.
    ...
    def _validate_narrative_mining_presence(self, context: ValidationContext) -> bool:
        # Checks if problem-solution narrative data from RAG exists in the thematic analysis.
    ...
    def _validate_provenance_split(self, context: ValidationContext) -> bool:
        # Validates that the V/C/S provenance split for bullet sections matches the targets.
    ...
    def _validate_authenticity_signal(self, context: ValidationContext) -> bool:
        # Checks if authenticity signals (verbs, phrasing) from RAG are present in the final resume content.
...
class QAReportGenerator:
    ...
    # Section 13: Reasoning Configuration Summary (NEW)
