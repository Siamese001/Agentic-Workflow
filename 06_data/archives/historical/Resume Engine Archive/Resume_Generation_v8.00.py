...
class EnhancedJobDescriptionAnalyzer:
    ...
    def _analyze_with_resilient_web_search(
        ...
        if partial_result.full_success:
            ...
            logger.error("✗ RAG analysis was only partially successful. Halting workflow.")
...
class PreFlightValidator:
    ...
    def _register_rules(self):
        ...
        rules = [
            ...
            ValidationRule(
                ...
                severity=ValidationSeverity.CRITICAL,
                validator=lambda d: WORD_COUNT_MIN <= d['total_words'] <= WORD_COUNT_MAX,
                error_message=lambda d: f"Total resume: {d['total_words']} words (target: {WORD_COUNT_MIN}-{WORD_COUNT_MAX})",
                category="word_count"
            ),
            ValidationRule(
    ...
    def validate(
        ...
        data = self._prepare_validation_data(staging_buffer, thematic_analysis, actual_counts)
    ...
    def _prepare_validation_data(self, staging_buffer: ImmutableStagingBuffer, thematic_analysis: ThematicAnalysis, actual_counts: Dict) -> Dict:
...
class WorkflowOrchestrator:
    ...
    def execute_workflow(
        ...
        try:
            ...
            print("\n[HOP-5] Pre-flight Validation...")
            validator = PreFlightValidator(self.master_resume)
            hop5_results, all_validations_passed = validator.validate(staging_buffer, thematic_analysis)
    ...
    def _build_coc_ledger(
        ...
        return {
            ...
            "version": "v8.00",
            "architecture": "Job_Workflow_v8.00_Comprehensive_Redesign",
