...
# v9.5: Pointing CONFIG_PATH to master_config_v9_5.json
#
...
# Load Configuration
CONFIG_PATH = PROJECT_ROOT / "master_config_v9_5.json"

class Configuration:
    """
    Central configuration class.
    Reads all settings from master_config_v9_5.json.
