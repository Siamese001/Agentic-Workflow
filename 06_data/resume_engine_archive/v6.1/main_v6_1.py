...
# Version info
__version__ = "6.1.0-batch-processing"
...
class WorkflowV60:
    ...
    def __init__(self, config_overrides: Optional[Dict] = None):
        ...
        self.logger.info(f"Workflow v6.1 initialized (version: {__version__})")
    ...
    def run(
        ...
        """
        self.logger.info("=" * 80)
        self.logger.info(f"Starting Workflow v6.1 for {company_name} - {job_title}")
        self.logger.info("=" * 80)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description=f'V6.1 MoE + Reflection + ReAct + Conductor System (Version: {__version__})',
...
Examples:
  ...
  python {script_path} --test                    # Run with test data
    ...
    parser.add_argument(
        '--version',
        action='version',
        version=f'V6.1 MoE + Reflection + ReAct + Conductor System - Version {__version__}'
    )
