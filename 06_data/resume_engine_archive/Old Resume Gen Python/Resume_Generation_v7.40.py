...
class PreFlightValidator:
    ...
    def validate(
        ...
        validation_results.extend(self._validate_cover_letter(staging_buffer))
...
class FileRenderer:
    ...
    def _render_resume_markdown(self, staging_buffer: ImmutableStagingBuffer) -> str:
        ...
        render_actions = {
            ...
            ResumeSection.K0_COMPETENCIES_HEADER: lambda v: f"Strategic & Technical Competencies\n--------------------------------------------------------------------------------\n",
            ResumeSection.K0_EDUCATION_HEADER: lambda v: f"Education\n--------------------------------------------------------------------------------\n",
            ResumeSection.K0_CERTIFICATIONS_HEADER: lambda v: f"Certifications\n--------------------------------------------------------------------------------\n",
    ...
    def _render_competencies_section(self, competencies_list: List[Dict]) -> str:
        ...
        return "\n".join([f"• {c['text']}" for c in competencies_list]) + "\n\n"
    ...
    def _render_resume_markdown_old(self, staging_buffer: ImmutableStagingBuffer) -> str:
        ...
        staging_keys = [
            (ResumeSection.K5_UNIFY_BULLETS.value, ResumeSection.K5_UNIFY_OVERVIEW.value),
            (ResumeSection.K6_IBM_BULLETS.value, ResumeSection.K6_IBM_OVERVIEW.value),
