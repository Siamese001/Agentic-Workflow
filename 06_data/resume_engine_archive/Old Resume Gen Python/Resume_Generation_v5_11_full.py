"""
Resume Generation Engine v5.11 - SKILLS AS SEPARATE OUTPUT
================================================================================
PATCH NOTES v5.11 (October 2025):
✓ Output 2: Skills file (12 technical & strategic skills) - NEW separate file
✓ Renumbered outputs: Resume, Skills, Cover Letter, QA Report, Word Table, App Tracker
✓ 6-output structure with skills extracted from resume into dedicated file
...
✓ 6 Output Files (Resume, Skills, Cover Letter, QA Report, Word Table, App Tracker)
...
Version: 5.11
Date: October 2025
Architecture: Job_Workflow v1.9.2 + v5.4 + v5.6 RAG + v5.7 Constraints + v5.11 Skills Output
Output Files: 6 (Resume, Skills, Cover Letter, QA Report, Word Table, App Tracker)
"""
...
SECTION_CONSTRAINTS_V57 = {
    ...
    "output_files": {
        "count": 6,  # v5.11: Resume, Skills, Cover Letter, QA Report, Word Table, App Tracker
        "required": ["resume", "skills", "cover_letter", "qa_report", "word_table", "app_tracker"]
    }
}
    ...
    def render_and_verify(
        ...
        try:
            ...
            files_to_write = [
                ...
                (qa_report_filename, qa_report, "R8-010"),
                (word_table_filename, word_table_text, "R8-011"),
