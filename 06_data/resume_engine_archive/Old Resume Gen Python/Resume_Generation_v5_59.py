"""
Resume Generation Engine v5.59 - RAG RESILIENCE: HARDENED WEB SEARCH
    ...
    def _render_skills(self, staging_buffer: ImmutableStagingBuffer, job_description: str = None) -> Dict:
        ...
        if job_description:
            try:
                ...
                # Score each skill against JD
                scored_skills = []
                for i, skill in enumerate(skills[:12]):  # Top 12 skills
                    score = jd_scorer.score_skill(skill)
                ...
                return {
                    ...
                    "jd_alignment_methodology": "JDAlignmentScorer v5.58",
            ...
            # No JD available, return simple list
            return {"skills": skills}
