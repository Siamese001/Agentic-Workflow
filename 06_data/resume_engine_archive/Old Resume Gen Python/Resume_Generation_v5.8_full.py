"""
Resume Generation Engine v5.8 - APPLICATION TRACKER OUTPUT + SECTION CONSTRAINTS
================================================================================
...
Version: 5.8
Date: October 2025
Architecture: Job_Workflow v1.9.2 + v5.4 + v5.6 RAG + v5.7 Constraints + v5.8 App Tracker
"""
...
SECTION_CONSTRAINTS_V57 = {
    ...
    "output_files": {
        "count": 5,  # v5.8: Changed from 4 to 5 (added app tracker)
        "required": ["resume", "cover_letter", "qa_report", "coc_ledger", "app_tracker"]
    }
}
