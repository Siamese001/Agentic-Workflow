...
class ResumeGenerator:
    ...
    def generate_resume(self, job_desc: str, company_name: str = "",
        ...
        """
        print("=" * 80)
        print("RESUME GENERATION v5.4 - FULL RAG INTEGRATION")
        print("=" * 80)
        ...
        if thematic_analysis.signal_quality_score < 0.45:
            print("⚠ WARNING: Signal quality below threshold (0.45)")
        ...
        print(f"✓ Extracted {len(keywords)} keywords (K2-boosted)")
