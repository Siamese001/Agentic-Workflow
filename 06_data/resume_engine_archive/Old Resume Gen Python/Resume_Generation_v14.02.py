...
def count_words_ms_word_style(text: str) -> int:
    ...
    if not text:
        return 0
    # This regex is more robust. It finds sequences of letters, numbers, and apostrophes.
    # It also correctly handles hyphenated words and common constructs like emails or URLs as single words.
