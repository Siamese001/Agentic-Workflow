...
# /Resume_Generation_v12.05.py (Section: ContentConstraintsConfig)
@dataclass
...
# /Resume_Generation_v12.05.py (Section: ArtistGenerator Class Definition)

# Assuming necessary imports like Dict, List, Optional, Tuple, ResumeSection,
# ThematicAnalysis, ValidationResult, ContentConstraintsConfig, ReasoningConfig,
# BulletProvenance, HopExecutionError, count_words_ms_word_style, _call_gemini_api,
# calculate_master_avg_bullet_length, MASTER_RESUME_JSON, COVER_LETTER_SIGNATURE_TEMPLATE,
# logging, re, random, time, copy, json, etc. are defined elsewhere in the file.

# /Resume_Generation_v12.05.py (Section: Global Version)
# --- START MODIFICATION ---
__version__ = "12.05"
# --- END MODIFICATION ---

# ... (other imports and class definitions like ReasoningConfig, ContentConstraintsConfig,
#      ThematicAnalysis, ResumeSection, BulletProvenance, HopExecutionError,
#      ValidationResult, ValidationSeverity, count_words_ms_word_style,
#      calculate_master_avg_bullet_length, MASTER_RESUME_JSON,
#      COVER_LETTER_SIGNATURE_TEMPLATE, logging, re, random, time, copy, json,
#      google.generativeai as genai etc. remain the same) ...
...
class ArtistGenerator:
    ...
    # Temperature Schedules (as defined for v12.04)
    ...
    def _generate_k1_executive_summary(self, temperature_override: Optional[float] = None) -> str:
        ...
        # ... (Build prompt - UNCHANGED, includes NON-NEGOTIABLE sentence count) ...
    ...
    # ... (Similar calls for _generate_k6_ibm_overview, _generate_k8_ey_overview, _generate_k9_early_career_overview)
    ...
    def _generate_tailored_bullets_for_experience(
        ...
        # ... (Determine section_name_for_avg) ...
...
# ... (rest of reorder prompt) ..."""
    ...
    # ... (Similar calls for _generate_k6_ibm_bullets, _generate_k10_competencies)
    ...
    # ... (Similar fail-fast logic for _generate_k9_early_career_bullets)
