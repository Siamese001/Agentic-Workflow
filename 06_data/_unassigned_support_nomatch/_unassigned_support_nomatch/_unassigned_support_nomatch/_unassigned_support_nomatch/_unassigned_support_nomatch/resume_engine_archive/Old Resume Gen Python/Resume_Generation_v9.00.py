...
2. The headline MUST be based on the **Target Job Title** ('{target_role_title}'), not the 'Current Role'.
3. Include 2-3 of these differentiators: {', '.join(differentiators)}
4. Format: "[Target Title] | [Key Strength 1] | [Key Strength 2]"
...
class WorkflowOrchestrator:
    ...
    def _build_qa_section_1_signal_quality(self, staging_buffer: ImmutableStagingBuffer, thematic_analysis: ThematicAnalysis) -> List[str]:
        ...
        if total_weight > 0:
            ...
            summary_bar = self._format_ascii_bar_chart(label="Total Weighted Score", value=average_signal, target=overall_target)
    ...
    def _generate_qa_report( # Renamed for clarity, already modular
        ...
        report_lines = [
            "=" * 80,
            f"RESUME QA REPORT (v{__version__} - Modular)", # Updated title slightly
