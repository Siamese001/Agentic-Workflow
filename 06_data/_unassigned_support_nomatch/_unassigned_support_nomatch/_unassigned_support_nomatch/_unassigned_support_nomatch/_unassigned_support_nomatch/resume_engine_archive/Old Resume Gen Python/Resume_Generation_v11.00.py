...
class ContentConstraintsConfig:
    ...
    EY_OVERVIEW_WORD_COUNT_MIN: int = 25 # <<< Corrected: Added EY constraints
    EY_OVERVIEW_WORD_COUNT_MAX: int = 35 # <<< Corrected: Added EY constraints
    ...
    TRADERSENSE_OVERVIEW_WORD_COUNT_MIN: int = 18
    TRADERSENSE_OVERVIEW_WORD_COUNT_MAX: int = 30
