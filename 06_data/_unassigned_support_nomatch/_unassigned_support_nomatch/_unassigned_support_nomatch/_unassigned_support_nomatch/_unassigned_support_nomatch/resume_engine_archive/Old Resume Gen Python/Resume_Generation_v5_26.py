"""
Resume Generation Engine v5.26 - EY & EARLY CAREER CUSTOMIZATION
================================================================================
CRITICAL v5.26 UPDATE: Implements LLM-driven customization for EY and Early Career sections

✓ MODIFIED: SECTION_CONSTRAINTS_V521 - Removed EY/Early Career from source_requirements
✓ ADDED: Bullet word tolerance ±10% for EY and Early Career sections  
✓ ADDED: K.7A/K.7B methods for EY highlight/overview generation
✓ ADDED: K.10A/K.10B methods for Early Career highlight/overview generation
✓ ADDED: TraderSense K.7.5A/K.7.5B methods for verbatim copying (unchanged)
✓ UPGRADED: FileRenderer to include TraderSense, EY, and Early Career sections
✓ UPGRADED: PreFlightValidator to apply ±10% bullet tolerance for EY/Early Career
✓ PROVENANCE: EY uses 1V-1T-0S, Early Career uses 0V-1T-0S tracking
✓ EMPHASIS: Risk management focus for EY, quantitative foundation for Early Career
✓ VALIDATION: All word count tolerances properly enforced at HOP-5/HOP-6
✓ BASE: Complete v5.23 code preserved + v5.26 enhancements

PATCH NOTES v5.26 (January 2025):
✓ EY Section: LLM-driven customization with risk management emphasis
  - Overview: Generated using JD themes (±20% tolerance)
  - Highlights: 2 bullets selected/adapted from master (±10% tolerance per bullet)
  - Provenance: 1 Verified, 1 Tailored, 0 Synthetic (1V-1T-0S)
  - Authenticity: 0.5 positioning : 0.5 authenticity ratio
  - Metrics: All original metrics preserved ($16M, 38%, 19%)
✓ Early Career Section: LLM-driven customization with quantitative focus
  - Overview: Generated using JD themes (±20% tolerance)
  - Highlights: 1 bullet adapted from master (±10% tolerance)
  - Provenance: 0 Verified, 1 Tailored, 0 Synthetic (0V-1T-0S)
  - Authenticity: 0.5 positioning : 0.5 authenticity ratio
  - Metrics: All original metrics preserved
✓ TraderSense Section: VERBATIM COPY from master (NO CHANGES)
  - Overview: Copied from master (±20% validation only)
  - Highlights: 2 bullets copied from master
  - Total section: ±10% validation
✓ Configuration Updates:
  - Removed "EY" and "Early Career" from source_requirements
  - Added bullet_word_tolerance for "EY": 0.10 and "Early Career": 0.10
  - Kept TraderSense in source_requirements (MUST_USE_MASTER_INTRO_AND_BULLETS)
✓ Validation Updates:
  - PreFlightValidator applies ±10% per-bullet tolerance for EY/Early Career
  - BatchedQAValidator checks overview ±20% and section total ±10%
  - All word count validations properly configured
✓ FileRenderer Updates:
  - Added TraderSense, EY, and Early Career to resume JSON output
  - Added all three sections to markdown rendering
  - Complete professional experience timeline now included
...
Version: 5.26
Date: January 2025  
Architecture: Job_Workflow v1.9.2 + All v5.23 + v5.26 EY/Early Career Customization
