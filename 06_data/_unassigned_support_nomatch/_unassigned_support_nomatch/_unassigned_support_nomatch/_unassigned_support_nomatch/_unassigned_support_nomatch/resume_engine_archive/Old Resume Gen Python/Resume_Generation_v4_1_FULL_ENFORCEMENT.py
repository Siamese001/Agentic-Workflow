...
__version__ = "4.1.0-FULL-QA-ENFORCEMENT"
__all__ = [
    'MasterResume',
    'SaaSRoleProfiles',
    'AppTrackerSchema',
...
class QAValidationGates:
    ...
    def validate_gate_6_coherence(self, coherence_penalty: float, cv: float) -> bool:
        """
        FIXED in v4.1: Gate 6 now enforces coherence penalties.
        ...
        if cv > 0.18:
            failure_msg = (
                f"{gate_name}: CV={cv:.3f} exceeds target 0.18. "
    ...
    def run_all_gates(self, coherence_penalty: float, cv: float) -> Tuple[bool, List[str]]:
        """
        ...
        gate_results = {
            ...
            "Gate 6 (Coherence)": self.validate_gate_6_coherence(coherence_penalty, cv),
        }
...
class ResumeGenerationEngineV4:
    ...
    def execute_pipeline(
        ...
        gates_passed, gate_failures = qa_gates.run_all_gates(coherence_penalty, cv)
