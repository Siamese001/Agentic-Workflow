...
class PreFlightValidator:
    ...
    RULES_CONFIG = [
        # --- Word Count Rules ---
        {
            ...
            "validator": lambda d: self.constraints.TOTAL_WORD_COUNT_MIN <= d['total_words'] <= self.constraints.TOTAL_WORD_COUNT_MAX,
        ...
        },
        {
            ...
            "validator": lambda d: self.constraints.EXEC_SUMMARY_WORD_COUNT_MIN <= count_words_clean(d['staging_buffer'].get(ResumeSection.K1_EXECUTIVE_SUMMARY.value, '')) <= self.constraints.EXEC_SUMMARY_WORD_COUNT_MAX,
            "error_message": "K.1: {word_count} words (target: 120-150)"
        },
        {
            "rule_id": "VG_SENTENCE_COUNT_K1", "severity": ValidationSeverity.CRITICAL, "category": "structure",
            "validator": lambda d: self.constraints.EXEC_SUMMARY_SENTENCE_COUNT_MIN <= _count_sentences(d['staging_buffer'].get(ResumeSection.K1_EXECUTIVE_SUMMARY.value, '')) <= self.constraints.EXEC_SUMMARY_SENTENCE_COUNT_MAX,
        ...
        },
        {
            ...
            "error_message": "Cover letter relevance to JD is too low. Similarity: {similarity:.2f} (target: >= {min_sim})"
        },
        {
    ...
    RULES_CONFIG.extend([
        {
            ...
            "validator": lambda d: self.constraints.HEADLINE_WORD_COUNT_MIN <= count_words_clean(d['staging_buffer'].get(ResumeSection.K0_HEADLINE.value, '')) <= self.constraints.HEADLINE_WORD_COUNT_MAX,
