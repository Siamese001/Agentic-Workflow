...
__version__ = "9.94" # Consolidated refactoring of configuration and data-driven components.
try:
...
class ContentConstraintsConfig:
    ...
    MIN_JD_KEYWORDS: int = 5 # <<< ADDED MINIMUM
    ...
    K1_MIN_DIFFERENTIATORS: int = 3 # <<< ADDED MINIMUM
...
class WorkflowOrchestrator:
    ...
    def _build_qa_section_1_signal_quality(self, staging_buffer: ImmutableStagingBuffer, thematic_analysis: ThematicAnalysis) -> List[str]:
        ...
        section_configs = {
            ...
            "Executive Summary": (ResumeSection.K1_EXECUTIVE_SUMMARY, 0.80, max_signal_target, 0.25, ReasoningConfig.K1_EXECUTIVE_SUMMARY_CONFIG),
            "Unify Overview": (ResumeSection.K5_UNIFY_OVERVIEW, 0.60, max_signal_target, 0.05, ReasoningConfig.K5_UNIFY_OVERVIEW_CONFIG),
            "Unify Bullets": (ResumeSection.K5_UNIFY_BULLETS, 0.70, max_signal_target, 0.20, ReasoningConfig.K5_UNIFY_BULLETS_CONFIG),
            "IBM Overview": (ResumeSection.K6_IBM_OVERVIEW, 0.60, max_signal_target, 0.05, ReasoningConfig.K6_IBM_OVERVIEW_CONFIG),
            "IBM Bullets": (ResumeSection.K6_IBM_BULLETS, 0.70, max_signal_target, 0.20, ReasoningConfig.K6_IBM_BULLETS_CONFIG),
            "EY Overview": (ResumeSection.K8_EY_OVERVIEW, 0.50, max_signal_target, 0.025, ReasoningConfig.K8_EY_OVERVIEW_CONFIG),
            "EY Bullets": (ResumeSection.K8_EY_BULLETS, 0.50, max_signal_target, 0.025, ReasoningConfig.K8_EY_BULLETS_CONFIG),
            "Early Career Overview": (ResumeSection.K9_EARLY_CAREER_OVERVIEW, 0.50, max_signal_target, 0.025, ReasoningConfig.K9_EARLY_CAREER_OVERVIEW_CONFIG),
            "Early Career Bullets": (ResumeSection.K9_EARLY_CAREER_BULLETS, 0.50, max_signal_target, 0.025, ReasoningConfig.K9_EARLY_CAREER_BULLETS_CONFIG),
            "Competencies": (ResumeSection.K10_COMPETENCIES, 0.85, max_signal_target, 0.15, ReasoningConfig.K10_COMPETENCIES_CONFIG),
        }
        ...
        if total_weight > 0:
            ...
            summary_bar = self._format_ascii_bar_chart(
                ...
                target_min=overall_target,
                target_max=max_signal_target,
                temperature=None
            )
