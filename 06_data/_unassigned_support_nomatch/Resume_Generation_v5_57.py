"""
Resume Generation Engine v5.57 - MAJOR REFACTORING
...
class FileRenderer:
    ...
    def _render_skills(self, staging_buffer: ImmutableStagingBuffer, job_description: str = None) -> Dict:
        ...
        if job_description:
            try:
                jd_scorer = JDAlignmentScorer()
                # Get master resume skills for alignment
                master_skills = self.master_resume.get('skills', [])
                
                # Score each skill against JD
                scored_skills = []
                for i, skill in enumerate(skills[:12]):  # Top 12 skills
                    score = jd_scorer.score_skill_alignment(skill, job_description)
                ...
                return {
                    ...
                    "jd_alignment_methodology": "JDAlignmentScorer v5.35",
