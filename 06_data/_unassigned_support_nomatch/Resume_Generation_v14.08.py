...
def count_words_ms_word_style(text: str) -> int:
    """
    Counts words attempting to replicate QuillBot's behavior:
    - Excludes common short words.
    - Excludes words within parentheses.
    - Keeps hyphenated words as single words.
    """
    if not text:
        return 0
    ...
    words = re.findall(r"[\w'-]+", text_no_parens)
