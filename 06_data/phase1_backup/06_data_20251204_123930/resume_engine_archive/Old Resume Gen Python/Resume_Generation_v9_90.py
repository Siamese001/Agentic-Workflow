...
__version__ = "9.90" # Consolidated refactoring of configuration and data-driven components.
try:
...
# Replace the old count_words_in_list_clean function signature if it exists separately
def count_words_in_list_clean(content_list: List[Any]) -> int:
    """DEPRECATED Helper: Counts words in a list of strings using old method."""
...
class PreFlightValidator:
    ...
    RULES_CONFIG.extend([
        ...
        # *** START FIX: Add missing rule definitions ***
        {
    ...
    def validate(
        ...
        v9.87: Uses count_words_ms_word_style for calculations.
        """
        actual_counts = {}
        total_words = 0
    ...
    def _calculate_master_avg_bullet_length(self) -> Dict[str, float]:
        ...
        for key, (company_name_part, bullets_key) in experience_sections_to_avg.items():
            ...
            if exp:
                ...
                # USE MS WORD STYLE count for strings
...
class WorkflowOrchestrator:
    ...
    def _calculate_master_avg_bullet_length(self) -> Dict[str, float]:
        """
        Helper to calculate average bullet length for sections in master resume.
        v9.87: Added to WorkflowOrchestrator, uses count_words_ms_word_style.
        This ensures QA Table 6 uses the correct average lengths.
        """
        avg_lengths = {}
    ...
    def _build_qa_section_6_provenance(self, staging_buffer: ImmutableStagingBuffer) -> List[str]:
        ...
        rows = []
        # USE CORRECT method from WorkflowOrchestrator instance
        master_avg_lengths = self._calculate_master_avg_bullet_length()
        tolerance = 0.20 # 20% tolerance
