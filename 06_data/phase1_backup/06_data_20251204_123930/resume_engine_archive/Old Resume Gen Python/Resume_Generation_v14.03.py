...
__version__ = "14.03" # <-- Increment version for tracking changes
try:
...
class ValidationContext:
    ...
    def _calculate_headline_details(self):
        ...
        details = {
            ...
            'min_char': ContentConstraintsConfig.HEADLINE_MIN_CHARS,
            'max_char': ContentConstraintsConfig.HEADLINE_MAX_CHARS
        }
...
class PreFlightValidator:
    ...
    RULES_CONFIG = [
        ...
        { # K.0 Headline Character Count
            "rule_id": "VG_HEADLINE_CHAR_COUNT", "severity": ValidationSeverity.HIGH, "category": "structure",
            "validator": lambda ctx: ctx.constraints.HEADLINE_MIN_CHARS <= ctx.headline_details['char_count'] <= ctx.constraints.HEADLINE_MAX_CHARS,
            "error_message": lambda ctx: f"K.0 Headline: {ctx.headline_details['char_count']} chars (target: {ctx.headline_details['min_char']}-{ctx.headline_details['max_char']})."
        },
    ...
    def _initialize_rule_map(self) -> Dict[str, Union[ResumeSection, str]]:
        ...
        rule_map = {
            ...
            "VG_HEADLINE_CHAR_COUNT": ResumeSection.K0_HEADLINE,
