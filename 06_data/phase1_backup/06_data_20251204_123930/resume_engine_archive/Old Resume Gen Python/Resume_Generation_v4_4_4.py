...
class BaselineResumeMetricsV4:
    """v4.4.4 baseline word count targets - FIXED to 1052 words."""
    
    # Total word count target (FIXED from 1032 to 1052)
    TARGET_TOTAL = 1052
    TOLERANCE = 50  # ±50 words allowed
    
    # Section word counts (baseline)
    SECTION_BASELINES = {
        "name": 2,  # "Amit Ayer" = 2 words
        "headline": 8,
        "contact": 10,
        "executive_summary": 125,  # Enforced 100-150 words
        "unify_intro": 14,
        "unify_bullets": 187,
        "ibm_intro": 15,
        "ibm_bullets": 128,
        "tradersense_intro": 10,
        "tradersense_bullets": 62,
        "ey_intro": 13,
        "ey_bullets": 63,
        "early_intro": 26,
        "early_bullets": 36,
...
class ResumeGenerationEngineV4:
    ...
    def _generate_output2_word_count(self, sections: Dict) -> str:
        ...
        lines.append(f"  Baseline Target:  1,052 words")
