...
class ResumeSection(Enum):
    ...
    K4_HEADLINE = "K.4"
    K1_EXECUTIVE_SUMMARY = "K.1"
    K5A_UNIFY_BULLETS = "K.5A"
    K5B_UNIFY_OVERVIEW = "K.5B"
    K6A_IBM_BULLETS = "K.6A"
    K6B_IBM_OVERVIEW = "K.6B"
    K7A_TRADERSENSE_BULLETS = "K.7A"
    K7B_TRADERSENSE_OVERVIEW = "K.7B"
    K8A_EY_BULLETS = "K.8A"
    K8B_EY_OVERVIEW = "K.8B"
    K9A_EARLY_CAREER_BULLETS = "K.9A"
    K9B_EARLY_CAREER_OVERVIEW = "K.9B"
    K10_STRATEGIC_TECHNICAL_COMPETENCIES = "K.10"
    K11_EDUCATION = "K.11"
    K12_CERTIFICATIONS_AND_CREDENTIALS = "K.12"
    K2_12_SKILLS = "K.2"
    K13_COVER_LETTER = "K.13"
...
class ArtistGenerator:
    ...
    def _generate_artist_output(
        ...
        output[ResumeSection.K4_HEADLINE.value] = self._generate_k4_headline(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        ...
        output[ResumeSection.K5A_UNIFY_BULLETS.value] = self._generate_k5a_bullets(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K5B_UNIFY_OVERVIEW.value] = self._generate_k5b_overview(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K6A_IBM_BULLETS.value] = self._generate_k6a_bullets(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K6B_IBM_OVERVIEW.value] = self._generate_k6b_overview(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K7A_TRADERSENSE_BULLETS.value] = self._copy_k7a_tradersense_bullets(enriched_scaffold)
        output[ResumeSection.K7B_TRADERSENSE_OVERVIEW.value] = self._copy_k7b_tradersense_overview(enriched_scaffold)
        output[ResumeSection.K8A_EY_BULLETS.value] = self._generate_k8a_ey_bullets(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K8B_EY_OVERVIEW.value] = self._generate_k8b_ey_overview(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K9A_EARLY_CAREER_BULLETS.value] = self._generate_k9a_early_career_bullets(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K9B_EARLY_CAREER_OVERVIEW.value] = self._generate_k9b_early_career_overview(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K10_STRATEGIC_TECHNICAL_COMPETENCIES.value] = self._generate_k10_competencies(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K11_EDUCATION.value] = self._generate_k11_education(enriched_scaffold)
        output[ResumeSection.K12_CERTIFICATIONS_AND_CREDENTIALS.value] = self._generate_k12_certifications(enriched_scaffold, job_description, thematic_analysis, previous_failures)
        output[ResumeSection.K2_12_SKILLS.value] = self._generate_k2_skills(job_description, thematic_analysis)
...
class PreFlightValidator:
    ...
    def _validate_structure(self, staging_buffer: ImmutableStagingBuffer) -> List[ValidationResult]:
        ...
        required_sections = [ # Use updated Enum
            ...
            ResumeSection.K4_HEADLINE,
            ResumeSection.K1_EXECUTIVE_SUMMARY,
            ResumeSection.K5A_UNIFY_BULLETS,
            ResumeSection.K5B_UNIFY_OVERVIEW,
            ResumeSection.K6A_IBM_BULLETS,
            ResumeSection.K6B_IBM_OVERVIEW,
            ResumeSection.K10_STRATEGIC_TECHNICAL_COMPETENCIES,
            ResumeSection.K11_EDUCATION,
            ResumeSection.K12_CERTIFICATIONS_AND_CREDENTIALS,
...
class FileRenderer:
    ...
    def _render_resume_markdown(self, staging_buffer: ImmutableStagingBuffer) -> str:
        ...
        exp_map = {
            ResumeSection.K5A_UNIFY_BULLETS: master_experience[0] if len(master_experience) > 0 else {},
            ResumeSection.K6A_IBM_BULLETS: master_experience[1] if len(master_experience) > 1 else {},
            ResumeSection.K7A_TRADERSENSE_BULLETS: master_experience[2] if len(master_experience) > 2 else {},
            ResumeSection.K8A_EY_BULLETS: master_experience[3] if len(master_experience) > 3 else {},
            ResumeSection.K9A_EARLY_CAREER_BULLETS: master_experience[4] if len(master_experience) > 4 else {},
        }

        # Define how to render each section type
        render_actions = {
            ResumeSection.K0_NAME: lambda v: f"{v}\n",
            ResumeSection.K4_HEADLINE: lambda v: f"{v}\n",
            ResumeSection.K0_CONTACT: lambda v: f"{v}\n",
            ResumeSection.K1_EXECUTIVE_SUMMARY: lambda v: f"Executive Summary\n--------------------------------------------------------------------------------\n{v}\n",
            ResumeSection.K0_EXPERIENCE_HEADER: lambda v: f"Professional Experience\n--------------------------------------------------------------------------------\n",
            ResumeSection.K5A_UNIFY_BULLETS: lambda v: self._render_experience_section(
                exp_map[ResumeSection.K5A_UNIFY_BULLETS],
                staging_buffer.get(ResumeSection.K5B_UNIFY_OVERVIEW.value),
                v
            ),
            ResumeSection.K6A_IBM_BULLETS: lambda v: self._render_experience_section(
                exp_map[ResumeSection.K6A_IBM_BULLETS],
                staging_buffer.get(ResumeSection.K6B_IBM_OVERVIEW.value),
                v
            ),
            ResumeSection.K7A_TRADERSENSE_BULLETS: lambda v: self._render_experience_section(
                exp_map[ResumeSection.K7A_TRADERSENSE_BULLETS],
                staging_buffer.get(ResumeSection.K7B_TRADERSENSE_OVERVIEW.value),
                v
            ),
            ResumeSection.K8A_EY_BULLETS: lambda v: self._render_experience_section(
                exp_map[ResumeSection.K8A_EY_BULLETS],
                staging_buffer.get(ResumeSection.K8B_EY_OVERVIEW.value),
                v
            ),
            ResumeSection.K9A_EARLY_CAREER_BULLETS: lambda v: self._render_experience_section(
                exp_map[ResumeSection.K9A_EARLY_CAREER_BULLETS],
                staging_buffer.get(ResumeSection.K9B_EARLY_CAREER_OVERVIEW.value),
                v
            ),
            ResumeSection.K10_STRATEGIC_TECHNICAL_COMPETENCIES: lambda v: f"Strategic & Technical Competencies\n--------------------------------------------------------------------------------\n{v}\n",
            ResumeSection.K11_EDUCATION: lambda v: f"Education\n--------------------------------------------------------------------------------\n" + "".join([f"{edu.get('degree')}, {edu.get('institution')} ({edu.get('notes')})\n" for edu in v]) + "\n",
            ResumeSection.K12_CERTIFICATIONS_AND_CREDENTIALS: lambda v: f"Certifications\n--------------------------------------------------------------------------------\n{v}\n",
            # K2_12_SKILLS and K13_COVER_LETTER are not part of the resume markdown
        }
        ...
        for section_enum in ResumeSection:
            ...
            if "OVERVIEW" in section_enum.name or section_enum in [ResumeSection.K2_12_SKILLS, ResumeSection.K13_COVER_LETTER]:
                continue
    ...
    def _render_resume_markdown_old(self, staging_buffer: ImmutableStagingBuffer) -> str:
        ...
        staging_keys = [
            (ResumeSection.K5A_UNIFY_BULLETS.value, ResumeSection.K5B_UNIFY_OVERVIEW.value), # This is fine
            (ResumeSection.K6A_IBM_BULLETS.value, ResumeSection.K6B_IBM_OVERVIEW.value), # This is fine
            (ResumeSection.K7A_TRADERSENSE_BULLETS.value, ResumeSection.K7B_TRADERSENSE_OVERVIEW.value),
            (ResumeSection.K8A_EY_BULLETS.value, ResumeSection.K8B_EY_OVERVIEW.value),
            (ResumeSection.K9A_EARLY_CAREER_BULLETS.value, ResumeSection.K9B_EARLY_CAREER_OVERVIEW.value)
        ]
    ...
    def _render_skills(self, staging_buffer: ImmutableStagingBuffer, job_description: str = None) -> str:
        ...
        """
        skills_list = staging_buffer.get(ResumeSection.K2_12_SKILLS.value)
