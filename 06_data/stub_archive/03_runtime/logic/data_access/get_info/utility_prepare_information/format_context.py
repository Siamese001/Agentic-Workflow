"""
format_context.py - Formatting Module

Domain: utility_prepare_information
Generated: 2025-12-07T12:07:54.799709
"""
...
class FormatContext:
    """Formatter for utility_prepare_information domain."""
...
def format_data(data: Any, config: Optional[Dict] = None) -> FormattedOutput:
    ...
    return FormatContext(config).format(data)
