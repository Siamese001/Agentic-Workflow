...
- **NEW v1.8 — Reply-to-Short Redundancy Guard + Executive Row Split:** adds Prompt 3D, a deterministic overlap guard with one auto-rewrite attempt, new BLOCK codes, audit fields, and Executive variant rows (Direct vs Reply-to-Short).
...
- **Reply-to-Short only (append row):**  
...
EXECUTIVE-RobustRAG (EXISTING — **two variants in v1.8**)
- **Direct via Premium (no prior Short):**
| # | Validation Item                             | Status | Notes |
|---|---------------------------------------------|--------|-------|
...
- **Reply to Short (Prompt 3D required; redundancy guard on):**
| # | Validation Item                             | Status | Notes |
|---|---------------------------------------------|--------|-------|
| 1 | Exec insight #1 (dated, sourceable)         |        | ≤18 months                               |
| 2 | Exec insight #2 (dated, sourceable)         |        | ≤18 months                               |
...
**RUN-TIME GATING (updated)**
- Do not render or emit any App Tracker payload unless **all** of the following pass:  
...
- If EXISTING:
  ...
  • **NEW v1.8:** If prior Short is detected/declared, set route = **Reply-to-Short** and require Prompt **3D** + redundancy guard before render.
...
===============================================================================
Block if any of:
- **Operator Prompts sequence failures:** any of (1)–(5) skipped, reordered, altered, or missing. **(v1.8)** Missing Prompt **3D** when route = Reply-to-Short.
...
===============================================================================
END OF LINKEDIN OUTREACH - CANONICAL v1.8
===============================================================================
