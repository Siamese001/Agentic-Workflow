...
# Donor: C:/Git/Agentic-Workflow/06_data/resume_engine_archive/phase05/phase05_validate.py
...
# Required global set (semantic checked separately)
REQUIRED_GLOBAL_SET = {
    "ast",
    "ast.meta.json",
    "embedding",
