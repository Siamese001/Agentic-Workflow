...
# Source: update_observability_usage.py
# Match Score: 0.7843
# ============================================================
...
class UpdateObservabilityUsageSafetySafety(ABC):
    ...
    @abstractmethod
    def apply_safety(self, data: Dict[str, Any]) -> UpdateObservabilityUsageSafetyResult:
...
def update_observability_usage(data: Dict[str, Any]) -> Dict[str, Any]:
    """
