...
class CheckDataPolicyPlanProcessor(ABC):
    ...
    @abstractmethod
    def process(self, input_data: Dict[str, Any]) -> CheckDataPolicyPlanResult:
...
class CheckDataPolicyPlanImpl(CheckDataPolicyPlanProcessor):
    ...
    def __init__(self, constraints: Optional[CheckDataPolicyPlanConstraints] = None):
...
def check_data_policy(input_data: Dict[str, Any]) -> Dict[str, Any]:
    """
