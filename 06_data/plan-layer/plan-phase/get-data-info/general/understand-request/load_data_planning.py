...
class LoadDataPlanningPlanProcessor(ABC):
    ...
    @abstractmethod
    def process(self, input_data: Dict[str, Any]) -> LoadDataPlanningPlanResult:
...
class LoadDataPlanningPlanInterface:
    ...
    def __init__(self, processor: LoadDataPlanningPlanProcessor):
...
class LoadDataPlanningPlanFactory:
    ...
    def create_processor(safety_level: str = "strict") -> LoadDataPlanningPlanInterface:
        ...
        processor = LoadDataPlanningPlanImpl(constraints)
        return LoadDataPlanningPlanInterface(processor)

# L5 Main execution point
def load_data_planning(input_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    """
    factory = LoadDataPlanningPlanFactory()
