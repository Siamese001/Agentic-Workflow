...
from qdrant_client.models import (
    ...
    Range, PointStruct, FilterSelector
)
    ...
    def _setup_index(self):
        ...
        try:
            ...
            if not exists:
                ...
                logger.info(f"Using existing Qdrant collection: {self.index_name}")
    ...
    def get_trending_patterns(
        ...
        try:
            ...
            for result in results:
                ...
                total = payload.get("failure_count", 0) + payload.get("success_count", 0)
                result["success_rate"] = payload.get("success_count", 0) / total if total > 0 else 0
