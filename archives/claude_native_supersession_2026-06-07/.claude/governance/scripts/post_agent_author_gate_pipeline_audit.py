#!/usr/bin/env python3
"""
post_agent_author_gate_pipeline_audit.py — Pipeline-completion audit.
...
``post_agent_ask_user_question_packet_audit.py`` (ask-without-packet).

Together they close the enforcement square:
    1. UI shape        → post_agent_author_gate_ui_audit.py
