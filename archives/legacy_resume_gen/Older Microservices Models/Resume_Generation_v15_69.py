...
class WebSearchRAG:
    ...
    def __init__(self, client: GeminiWebSearchClient, config: RAGConfig = RAGConfig(), master_resume_index: Optional['MasterResumeIndex'] = None):
        self.client = client
        self.config = config
    ...
    def __init__(
        ...
        if self.enable_web_search:
            try:
                ...
                self.web_rag = WebSearchRAG(self.gemini_client, self.config, master_resume_index=self.master_resume_index)
