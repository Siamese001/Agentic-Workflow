# File: config_RES_v2.py
# Version: 19.0.0 (High Priority Consolidation)
...
# ============================================================================
# All magic numbers from codebase consolidated here
# No constants should be defined elsewhere
...
MAX_WORD_COUNT_BUFFER = 10  # Allow 10% buffer on max word counts
MIN_BULLET_COUNT = 5
MAX_BULLET_COUNT = 8
MIN_CONFIDENCE_SCORE = 0.7
MIN_RELEVANCE_SCORE = 0.65

# Bullet Word Count Constraints (from artist_RES_v2.py)
...
class EnricherConfig:
    ...
    def from_json(cls, json_path: Path = None) -> 'EnricherConfig':
        if json_path is None:
            # This file is not in the provided list, but 'enricher_RES_v2.py'
...
class ValidatorConfig:
    ...
    def from_json(cls, 
        ...
        return cls(
            ...
            provenance_split_targets=rules_data.get("provenance_split_targets", {}),
