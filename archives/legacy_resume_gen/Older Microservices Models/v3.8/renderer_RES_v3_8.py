...
from archives.legacy_resume_gen.Older Microservices Models.v3.8.config_RES_v3_8 import AppConfig, DATA_DIR, CONFIG
from archives.legacy_resume_gen.Older Microservices Models.v3.8.utils_RES_v3_8 import text_utils, sanitize_filename
...
if TYPE_CHECKING:
    from archives.legacy_resume_gen.Older Microservices Models.v3.8.workflow_RES_v3_8 import WorkflowOrchestrator

logger = logging.getLogger(__name__)
# text_utils is imported from utils_RES_v3_8
