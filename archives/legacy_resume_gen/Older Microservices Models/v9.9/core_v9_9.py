# File: core_v9_9.py
# Overwrites: core_v9_8.py
# Version: 9.9 (Security & Error Handling Hardening)

# v9.9 CRITICAL CHANGES:
# SECURITY FIX #1: Removed LLM-based PII detection (now local Presidio)
# SECURITY FIX #2: Removed LLM-based bias detection (now local regex)
# ERROR HANDLING FIX: Added specific exception types (ModelAPIError, JSONParsingError, FileIOError)
# ERROR HANDLING FIX: Replaced broad "except Exception" with specific catches
# RELIABILITY: Improved fail-fast behavior for debugging
...
class MainGraphState(TypedDict):
    """Enhanced v9.9 graph state (unchanged from v9.8)."""
    ...
    conductor_thoughts: List[Dict[str, object]]
    conductor_plan: Optional[Dict[str, object]]
    # P1: Dynamic tooling
    available_tools: List[Dict[str, object]]
    tool_execution_history: List[Dict[str, object]]
    # P1: HIL interaction
    ambiguity_detected: bool
    hil_feedback_queue: List[Dict[str, object]]
    hil_responses: List[Dict[str, object]]
    # P2: Cost tracking
...
class MetaGraphState(TypedDict):
    """Meta-learning graph state (unchanged)."""
...
# ============================================================================
# P1: DYNAMIC TOOLING SYSTEM (unchanged from v9.8)
# ============================================================================
...
class ToolRegistry:
    ...
    def generate_tool(self, specification: Dict[str, object]) -> Optional[ToolDefinition]:
        """P1: Generate new tool from specification (placeholder)."""
        self.generation_history.append({
            "timestamp": datetime.now().isoformat(),
            "specification": specification,
            "status": "pending_implementation"
        })
        logger.warning("Tool generation requested but not yet implemented in v9.9")
        return None
...
# ============================================================================
# P1: HIL INTERACTION SYSTEM (unchanged from v9.8)
# ============================================================================
...
# ============================================================================
# P2: COST TRACKING SYSTEM (unchanged from v9.8)
# ============================================================================
...
# ============================================================================
# P2: AGENT RELIABILITY SYSTEM (unchanged from v9.8)
# ============================================================================
...
class AgentReliabilityTracker:
    ...
    def _load_scores(self):
        ...
        try:
            ...
            logger.error(f"File I/O error loading reliability scores: {e}")
        except json.JSONDecodeError as e:
            logger.error(f"JSON parsing error in feedback log: {e}")
...
class LoggingConfig:
    ...
    log_file: str = "./logs/workflow_v9_9.log"
    log_format: str = "json"
...
class AgentStackConfig:
    ...
    # P0 Item #1: SafetyGuardStack (v9.9: LOCAL ONLY)
    safety_stack_enabled: bool = True
    bias_detection_threshold: float = 0.7
    pii_detection_enabled: bool = True
    use_presidio_for_pii: bool = True  # v9.9: Local Presidio
    use_local_bias_detection: bool = True  # v9.9: Local regex
...
class MasterConfig:
    ...
    @classmethod
    def from_file(cls, filepath: str = "master_config_v9_9.json") -> 'MasterConfig':
        ...
        try:
            ...
            logger.warning(f"File I/O error loading config from {filepath}: {e}. Using defaults.")
            return cls()
        except json.JSONDecodeError as e:
            logger.warning(f"JSON parsing error in {filepath}: {e}. Using defaults.")
            return cls()
        except (KeyError, TypeError) as e:
            logger.warning(f"Config structure error in {filepath}: {e}. Using defaults.")
            return cls()

# Initialize global CONFIG
try:
    CONFIG = MasterConfig.from_file("master_config_v9_9.json")
except Exception as e:
    logger.warning(f"Failed to load master_config_v9_9.json: {e}. Using defaults.")
    CONFIG = MasterConfig()
...
# ============================================================================
# v9.9 EXCEPTIONS (NEW SPECIFIC ERROR TYPES)
# ============================================================================
...
# v9.9: NEW SPECIFIC EXCEPTIONS FOR ERROR HANDLING
class ModelAPIError(Exception):
    """v9.9: Raised when LLM API call fails."""
    pass

class JSONParsingError(Exception):
    """v9.9: Raised when JSON parsing fails."""
    pass

class FileIOError(Exception):
    """v9.9: Raised when file I/O operations fail."""
    pass

# ============================================================================
# MODEL CLIENT FACTORY (v9.9: SPECIFIC ERROR HANDLING)
# ============================================================================
...
class GoogleGeminiClient(BaseModelClient):
    """Google Gemini API client with v9.9 specific error handling."""
    ...
    def __init__(self, model_name: str = "gemini-2.0-flash-exp"):
        ...
        try:
            ...
            raise ImportError(f"google-generativeai package not installed: {e}")
    ...
    def chat_completion(
        ...
        """Execute chat completion with v9.9 specific error handling."""
        try:
            ...
            if response_format == "json_object":
                try:
                    ...
                    raise JSONParsingError(f"Failed to parse Gemini JSON response: {e}")
            ...
            raise ModelAPIError(f"Gemini import error: {e}")
        except (ConnectionError, TimeoutError) as e:
            raise ModelAPIError(f"Gemini network error: {e}")
        except Exception as e:
            raise ModelAPIError(f"Gemini API error: {e}")

class AnthropicClient(BaseModelClient):
    """Anthropic Claude API client with v9.9 specific error handling."""
    ...
    def __init__(self, model_name: str = "claude-sonnet-4-20250514"):
        ...
        try:
            ...
            raise ImportError(f"anthropic package not installed: {e}")
        ...
        try:
            ...
            if response_format == "json_object":
                try:
                    ...
                    logger.warning(f"JSON parsing failed: {e}")
                    raise JSONParsingError(f"Failed to parse Anthropic JSON response: {e}")
            ...
            raise ModelAPIError(f"Anthropic import error: {e}")
        except (ConnectionError, TimeoutError) as e:
            raise ModelAPIError(f"Anthropic network error: {e}")
        except Exception as e:
...
# ============================================================================
# BASE AGENT CLASS (v9.9: IMPROVED ERROR HANDLING)
# ============================================================================

class BaseAgent(ABC):
    """Enhanced base agent with cost tracking and v9.9 error handling."""
...
# ============================================================================
# SYSTEM PROMPTS (v9.9: REMOVED LLM-BASED PII/BIAS PROMPTS)
# ============================================================================

# v9.9: REMOVED BIAS_DETECTOR_SYSTEM_PROMPT (now local regex)
# v9.9: REMOVED PII_SCRUBBER_SYSTEM_PROMPT (now local Presidio)
...
# Meta-learning prompts (unchanged)
...
__all__ = [
    ...
    # Exceptions (v9.9: ADDED NEW SPECIFIC EXCEPTIONS)
    "CircuitBreakerOpenError",
    "AgentExecutionError",
    "ValidationError",
    "CostCeilingExceededError",
    "ToolExecutionError",
    "ModelAPIError",  # NEW v9.9
    "JSONParsingError",  # NEW v9.9
    "FileIOError",  # NEW v9.9
