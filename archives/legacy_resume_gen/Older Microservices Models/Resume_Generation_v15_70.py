...
class MasterResumeIndex:
    ...
    skill_vectors: Optional[Dict[str, object]] = None  # skill -> TF-IDF vector (optional for advanced matching)
...
class RAGState:
    ...
    cumulative_result: Optional[Dict[str, object]] = None  # Latest merged result
