...
from typing import Dict, object, List, Optional, Tuple, TypeVar, Callable, Awaitable
...
def _parse_mcp_client_specs(raw_specs: List[Dict[str, object]]) -> List[MCPClientSpec]:
