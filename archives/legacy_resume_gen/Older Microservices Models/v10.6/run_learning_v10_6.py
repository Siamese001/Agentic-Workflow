...
from core_v10_6 import (
    ConfigV10_6, WorkflowContext, BaseAgent, MetaGraphState,
...
# ============================================================================
# META-LEARNING AGENTS (v10.6: Refactored)
# ============================================================================
...
class AsyncLogSummarizerAgent(BaseAgent):
    ...
    async def run_async(self, raw_logs: Dict[str, str], workflow_id: str) -> Dict[str, object]:
        self.log_info("Summarizing logs with LLM (v10.6)...")
...
class AsyncPatternFinderAgent(BaseAgent):
    ...
    async def run_async(self, log_summary: Dict[str, object], workflow_id: str) -> List[Dict]:
        self.log_info("Finding patterns in logs (v10.6)...")
...
class AsyncHypothesisGeneratorAgent(BaseAgent):
    ...
    async def run_async(self, patterns: List[Dict], previous_critique: Dict[str, object], workflow_id: str) -> List[Dict]:
        self.log_info("Generating hypotheses (v10.6)...")
        client = self.get_model_client("strategy_model")
...
class AsyncProposalDrafterAgent(BaseAgent):
    ...
    async def run_async(self, hypothesis: Dict[str, object], workflow_id: str) -> Dict[str, object]:
        self.log_info(f"Drafting proposal for hypothesis (v10.6)...")
...
class AsyncProposalCritiqueAgent(BaseAgent):
    ...
    async def run_async(self, proposal: Dict[str, object], patterns: List[Dict], workflow_id: str) -> Dict[str, object]:
        self.log_info("Critiquing proposal (v10.6)...")
...
class AsyncToolGeneratorAgent(BaseAgent):
    ...
    async def run_async(self, hypothesis: Dict[str, object], workflow_id: str) -> Dict[str, object]:
        self.log_info("Generating new tool code from hypothesis (v10.6)...")
...
class AsyncToolCritiqueAgent(BaseAgent):
    ...
    async def run_async(self, tool_code: str, workflow_id: str) -> Dict[str, object]:
        self.log_info("Critiquing generated tool code (v10.6)...")
...
# ============================================================================
# META-LEARNING CONDITIONAL EDGE FUNCTIONS (v10.6: Preserved)
# ============================================================================

def check_proposal_type(state: MetaGraphState) -> str:
    """v10.6: Routes to tool gen or rule gen branch."""
...
def check_tool_critique(state: MetaGraphState) -> str:
    """v10.6: Checks if generated tool code passed critique."""
    critique_passed = state.critique.get("critique_passed", False)
    if critique_passed:
...
def build_meta_learning_graph(context: WorkflowContext, checkpointer: Any):
    ...
    # --- Meta-Graph Nodes (v10.6: Refactored) ---
...
# ============================================================================
# MAIN META-LEARNING RUNNER (v10.6: Refactored)
# ============================================================================

async def run_meta_learning(config: ConfigV10_6):
    """
...
# v10.6: This file is not a main entry point.
# ============================================================================
# END OF run_learning_v10_6.py
# ============================================================================