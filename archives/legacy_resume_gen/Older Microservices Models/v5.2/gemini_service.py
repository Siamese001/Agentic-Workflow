...
class GeminiService:
    ...
    def call_api(
        ...
        Args:
            ...
            json_mode: Enforce JSON output schema (Technique #2)
        ...
        # Technique #2: Enforced Output Schemas (JSON Mode)
        if json_mode:
            api_params["response_mime_type"] = "application/json"
        ...
        try:
            ...
            model = genai.GenerativeModel(
                ...
                generation_config={
                    ...
                    # Technique #2: JSON Mode Injection
                    "response_mime_type": api_params.get("response_mime_type", "text/plain")
                },
                safety_settings={
