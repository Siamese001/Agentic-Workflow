...
class QAValidationStack:
    ...
    _TOOL_BUILDERS: Tuple[Tuple[str, object], ...] = (
    ...
    def __init__(
        ...
        *,
        validators: Optional[Sequence[Tuple[str, object]]] = None,
    ) -> None:
        self.context = context
        self.debug_mode = debug_mode
        self._validators: Tuple[Tuple[str, object], ...] = (
            tuple(validators) if validators is not None else self._build_validators()
        )
        self._adapter = StateAdapterStack(context, debug_mode)

    def _build_validators(self) -> Tuple[Tuple[str, object], ...]:
    ...
    async def run_async(self, state: Dict[str, object], workflow_id: str) -> Dict[str, object]:
        ...
        validator_results: List[Tuple[str, Dict[str, object]]] = []
    ...
    def _build_tool_input(self, state: Dict[str, object]) -> Dict[str, object]:
    ...
    def _normalize_strategy(self, strategy: Any) -> Dict[str, object]:
    ...
    def _collect_issues(
        self, validator_results: Iterable[Tuple[str, Dict[str, object]]]
    ...
    def _detect_issue(self, tool_name: str, result: Dict[str, object]) -> Optional[str]:
    ...
    def _merge_patch(self, base: Dict[str, object], addition: Dict[str, object]) -> Dict[str, object]:
    ...
    def _append_agent_note(self, state: Dict[str, object], summary: str) -> List[str]:
