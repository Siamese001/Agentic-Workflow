...
Version: 2025-09-02 v1.6.3
================================================================================

# SUMMARY
- Full router with NEW vs EXISTING and SINGLE vs MULTIPLE batching.
- **Edge-case support (NEW full message):** When Premium InMail/full-message is available for a NEW contact, route to the **EXISTING Recruiter** or **EXISTING Contact-LightRAG** shells (identical structure and rules) with a **salutation override** (remove any “Thanks for connecting” variants). Everything else remains identical to the EXISTING shells.
...
**Example (illustrative, not to be rendered with outputs):**  
BATCH | Recruiter | K=3  
...
- For EXISTING, run **dedup vs prior outreach** (do not restate prior lines; specifically avoid repeating “I applied for [Role]” unless materially changed).  
...
- Normalize “percent” → “%”; enforce ASCII hyphen only (ban en/em dash and “--”).  
...
- Compose capabilities frame; map insights → JD requirements → quantified achievements; ensure alignment to imperatives; enforce ASCII-hyphen/percent policies and dedup (avoid repeating “I applied for [Role]”).
...
**NEW full-message edge case (uses this EXISTING shell) — Salutation override (required):**  
Replace the sentence “Thanks again for connecting.” with:  
...
- Dash policy (ASCII hyphen only) or percent normalization violations (ban en/em dash and “--”).
...
================================================================================
END OF LINKEDIN OUTREACH - CANONICAL v1.6.3
================================================================================
