...
UNIT_FILES = [
    ...
    "tests/unit/agentic_core/L2_execution/apps_qwen/test_apps_qwen_config.py",
    "tests/unit/agentic_core/L2_execution/apps_qwen/test_apps_qwen_gateway.py",
    "tests/unit/agentic_core/L2_execution/apps_qwen/test_apps_qwen_telemetry.py",
