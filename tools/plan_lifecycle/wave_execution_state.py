...
Usage:
    ...
    python tools/plan_lifecycle/wave_execution_state.py complete --plan <slug-6hex>
    python tools/plan_lifecycle/wave_execution_state.py wave-progress --plan <slug-6hex> --wave N
