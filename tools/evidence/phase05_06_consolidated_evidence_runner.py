...
def main():
    ...
    evidence_lines.append('')
    inspected = ['apps_shared/spine/base_spine_adapter.py', 'apps_lic/engines/lic_spine_adapter.py', 'apps_rg/engines/rg_spine_adapter.py', 'tests/unit_min_deps/test_apps_lic_spine_adapter.py', 'tests/unit_min_deps/test_apps_rg_spine_adapter.py', 'tests/unit_min_deps/test_spine_cross_app_contract.py', 'ops_scripts/ci/check_spine_adapter_contract.py', 'tools/evidence/phase05_06_consolidated_evidence_runner.py']
    ...
    commands = [([sys.executable, '-m', 'pytest', '-q', 'tests/unit_min_deps/test_apps_lic_spine_adapter.py'], 'LIC Unit Tests'), ([sys.executable, '-m', 'pytest', '-q', 'tests/unit_min_deps/test_apps_rg_spine_adapter.py'], 'RG Unit Tests'), ([sys.executable, '-m', 'pytest', '-q', 'tests/unit_min_deps/test_spine_cross_app_contract.py'], 'Cross-App Contract Tests'), ([sys.executable, 'ops_scripts/ci/check_spine_bypass.py'], 'Spine Bypass Check'), ([sys.executable, 'ops_scripts/ci/check_spine_adapter_contract.py'], 'Spine Adapter Contract Guard'), ([sys.executable, '-m', 'pytest', '-q'], 'Full Test Suite')]
