...
emit_determinism_digest("trace_qwen_migration_phase5_evidence_runner", "qwen_migration_phase5_evidence_runner_dispatch")
emit_determinism_digest("trace_qwen_migration_phase5_evidence_runner", "qwen_migration_phase5_evidence_runner_complete")
...
def main():
    ...
    if args.evidence_commit:
        ...
        h('')
    h('## INSPECTED_FILES')
    phase5_files = ['agentic_core/L2_execution/types/vllm_invariant_contract_types.py', 'agentic_core/L2_execution/types/vllm_invariant_verifier_types.py', 'agentic_core/L2_execution/types/vllm_gateway_adapter_types.py', 'agentic_core/L2_execution/types/vllm_gateway_integration_types.py', 'tests/unit_min_deps/test_vllm_invariant_contract.py', 'tests/unit_min_deps/test_vllm_invariant_verifier.py', 'tests/agentic_core/L2_execution/types/test_vllm_invariant_enforcement.py']
    for f in phase5_files:
        h(f)
    h('')
    h('## Unit_min_deps Tests (Invariant Contract)')
    out, rc = run([sys.executable, '-m', 'pytest', '-q', '--color=no', '-m', 'unit_min_deps', 'tests/unit_min_deps/test_vllm_invariant_contract.py'])
    fence(out)
    if rc != 0:
    ...
    out, rc = run([sys.executable, '-m', 'pytest', '-q', '--color=no', '-m', 'unit_min_deps', 'tests/unit_min_deps/test_vllm_invariant_verifier.py'])
    fence(out)
    if rc != 0:
    ...
    out, rc = run([sys.executable, '-m', 'pytest', '-q', '--color=no', 'tests/agentic_core/L2_execution/types/test_vllm_invariant_enforcement.py'])
    fence(out)
    if rc != 0:
    ...
    out, rc = run([sys.executable, '-m', 'pytest', '-q', '--color=no', 'tests/agentic_core/L2_execution/types/test_vllm_infrastructure_fingerprint.py', 'tests/agentic_core/L2_execution/types/test_vllm_replay_validator.py', 'tests/agentic_core/L2_execution/types/test_vllm_gateway_adapter.py'])
    fence(out)
    if rc != 0:
    ...
    out, rc = run([sys.executable, '-m', 'pytest', '-q', '--color=no', 'tests/agentic_core/L2_execution'], required=False)
    fence(out)
    h('')
    ...
    phase5_touched = ['agentic_core/L2_execution/types/vllm_invariant_contract_types.py', 'agentic_core/L2_execution/types/vllm_invariant_verifier_types.py', 'agentic_core/L2_execution/types/vllm_gateway_adapter_types.py', 'agentic_core/L2_execution/types/vllm_gateway_integration_types.py', 'tests/unit_min_deps/test_vllm_invariant_contract.py', 'tests/unit_min_deps/test_vllm_invariant_verifier.py', 'tests/agentic_core/L2_execution/types/test_vllm_invariant_enforcement.py']
