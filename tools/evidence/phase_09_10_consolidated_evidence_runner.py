...
def main():
    ...
    evidence_file = repo_root / 'docs' / REPORTS_DIR / 'plans' / 'phase_09_10_consolidated.md'
    ...
    evidence_lines.append('')
    inspected = ['tools/evidence/evidence_contract_v2.py', 'tools/evidence/phase02_consolidated_evidence_runner.py', 'tools/evidence/phase03_04_consolidated_evidence_runner.py', 'tools/evidence/phase05_06_consolidated_evidence_runner.py', 'tools/evidence/phase07_08_consolidated_evidence_runner.py', 'tools/evidence/phase_09_10_consolidated_evidence_runner.py', 'ops_scripts/ci/check_evidence_contract_v2.py', '.github/workflows/spine-determinism-guard.yml']
    ...
    commands = [([sys.executable, '-m', 'pytest', '-q'], 'Full Test Suite'), ([sys.executable, 'ops_scripts/ci/check_evidence_contract_v2.py', '--paths', DOCS_REPORTS_PLANS], 'Evidence Contract v2 Checker (Repo-Wide)')]
