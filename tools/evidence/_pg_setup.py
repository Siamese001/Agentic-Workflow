...
# 1. Set password
r = run([str(PG_BIN / "psql.exe"), "-U", "postgres", "-h", "localhost", "-p", "5432",
...
r2 = run([str(PG_BIN / "psql.exe"), "-U", "postgres", "-h", "localhost", "-p", "5432",
          "-d", "mcp_db", "-c", "SELECT current_database(), current_user;"])
