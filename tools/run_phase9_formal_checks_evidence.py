...
def main():
    """Execute Phase 9 evidence collection."""
    evidence_lines = []

    # Header
    evidence_lines.append("# Phase 9 Formal Verification Evidence")
    ...
    # Run static invariants checker
    evidence_lines.append("## STATIC_INVARIANTS_CHECK")
    evidence_lines.append("")
    ...
    for run_num in [1, 2]:
        ...
        # Test: static checks tests
        evidence_lines.append('### pytest -q tests/unit_min_deps/ -k "static_checks or formal_verification"')
        result = run_cmd(
            [
                "python",
                "-m",
                ...
                "tests/unit_min_deps/",
                "-k",
                "static_checks or formal_verification",
            ]
        )
        evidence_lines.append(f"EXIT CODE: {result.returncode}")
        evidence_lines.append("STDOUT:")
    ...
    # Write evidence file
    evidence_path = Path("docs/evidence/phase_formal_verification_phase9.md")
