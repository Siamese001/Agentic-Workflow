...
c = sqlite3.connect(r"artifacts/adg/adg_indexed_05052026_0722.sqlite").cursor()
print("TABLES:")
...
for r in c.execute("SELECT relation_type, COUNT(*) FROM edges GROUP BY relation_type ORDER BY 2 DESC LIMIT 25"):
    print(f"  {r}")
