...
KNOWN_EMITTERS = {
    "_emit_reads_through", "_emit_writes_through", "_emit_links_incident_trace",
    "_emit_pulls_context", "_emit_validated_by_safety_plane",
    "_emit_execution_terminates_at_uwg", "_emit_invokes_eval",
    "_emit_proposal_commits_routing", "_emit_reads_environ",
    "_emit_reads_runtime_state", "_emit_captures_pattern",
    "_emit_records_learning_event", "_emit_writes_learning_snapshot",
    "_emit_feeds_meta_learning", "_emit_updates_routing_strategy",
    "_emit_improves_agent_policy", "_emit_stores_learning_state",
    ...
    "_emit_verifies_boundary", "_emit_transcripts_response",
