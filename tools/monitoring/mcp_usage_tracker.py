...
class MCPUsageTracker:
    ...
    def log_simple_usage(self, tool_name: str, context: str, success: bool,
                        response_time: float = 0.0, token_count: int = 0,
...
def main():
    ...
    parser.add_argument('--log', nargs=5, help='Log usage: tool_name context success response_time token_count')
