...
def main():
    """Execute Phase 8 evidence collection."""
    evidence_lines = []

    # Header
    evidence_lines.append("# Phase 8 Performance Envelope & Scaling Hardening Evidence")
    ...
    for run_num in [1, 2]:
        ...
        # Test: performance envelope tests
        evidence_lines.append(
        ...
        result = run_cmd(
            [
                ...
                "tests/unit_min_deps/",
                "-k",
                "performance_envelope or truncation or store_limit",
            ]
        )
    ...
    # Write evidence file
    evidence_path = Path("docs/evidence/phase_performance_envelope_phase8.md")
