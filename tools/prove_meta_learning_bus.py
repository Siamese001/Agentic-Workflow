...
# ============================================================================
# STAGE 0: Verify imports are resolvable (pre-Wave 0B check)
# ============================================================================
print("=" * 72)
...
# ============================================================================
# STAGE 1: Simulate healing actions (exactly what execute_ssot records)
# ============================================================================
print("\n" + "=" * 72)
...
healing_actions = [
    {
        ...
        "routing_gate": "N/A",
        "confidence": 0.95,
        "fix_summary": "Fixed 3 of 5 semantic duplicate violations",
        "outcome": "SUCCESS",
        "status": "applied",
        "type": "SEMANTIC_DUPLICATE",
        "timestamp": "2025-06-01T16:00:19",
    },
    {
        ...
        "routing_gate": "N/A",
        "confidence": 0.90,
        "fix_summary": "Fixed 2 of 2 layer inversion violations",
        "outcome": "SUCCESS",
        "status": "applied",
        "type": "LAYER_INVERSION",
        "timestamp": "2025-06-01T16:01:05",
    },
    {
        "agent": "LocationAgent",
        "territory": "apps_lic",
        ...
        "routing_gate": "N/A",
        "confidence": 0.85,
        "fix_summary": "Healed 1 of 1 location violations",
        "outcome": "SUCCESS",
        "status": "applied",
        "type": "WRONG_LOCATION",
        "timestamp": "2025-06-01T16:02:30",
    },
    {
        ...
        "routing_gate": "N/A",
        "confidence": 0.90,
        "fix_summary": "Fixed 1 of 1 gravity violations",
        "outcome": "SUCCESS",
        "status": "applied",
        "type": "GRAVITY_LEAK",
        "timestamp": "2025-06-01T16:03:00",
    },
    {
        "agent": "FileClassificationAgent",
...
# Check the snapshot stats
for s in snapshot:
    if s.healer_id == "FileClassificationAgent":
        # 2 events: 1 applied (success), 1 skipped (failure)
...
try:
    ...
    stage5_pass = (
        ...
        and ml_after["total_experiences"] >= 1
        and len(ml_after["recent_experiences"]) > 0
        and "intake:" in ml_after["recent_experiences"][0]
    )
    if stage5_pass:
...
logging.disable(logging.CRITICAL)  # suppress further logging noise

# ============================================================================
# STAGE 6: Verify HealingConfigOptimizer can consume intake
# ============================================================================
print("\n" + "=" * 72)
...
try:
    ...
    # Check if optimizer would propose escalation for FCA (success_rate=0.5 < 0.6 threshold)
...
# ============================================================================
# STAGE 7: Pattern Analysis Engine availability
# ============================================================================
print("\n" + "=" * 72)
