...
_emit_escalates_to_human("p1", "prove_meta_learning_bus", "human_escalation")
_emit_routes_through("p1", "prove_meta_learning_bus", "route_through")
_emit_checks_agent_registry("p1", "prove_meta_learning_bus", "agent_registry")
_emit_validates_agent_capability("p1", "prove_meta_learning_bus", "capability")
_emit_dispatches_execution_plan("p1", "prove_meta_learning_bus", "exec_plan")
_emit_agent_executes_agent("p1", "prove_meta_learning_bus", "sub_agent")
_emit_routes_to_agent("p1", "prove_meta_learning_bus", "target_agent")
_emit_verifies_policy("p1", "prove_meta_learning_bus", "policy_check")
_emit_observes_runtime_state("p1", "prove_meta_learning_bus", "runtime_state")
_emit_verifies_boundary("p1", "prove_meta_learning_bus", "boundary_check")
_emit_transcripts_response("p1", "prove_meta_learning_bus", "transcript")
_emit_hard_fails_untranscripted("p1", "prove_meta_learning_bus")
_emit_gated_by_confidence("p1", "prove_meta_learning_bus", "confidence_gate")
