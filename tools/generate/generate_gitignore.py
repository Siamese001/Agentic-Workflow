...
def generate_gitignore_content(dirs: set[str], patterns: set[str]) -> str:
    ...
    ide = {".idea", ".vscode", "docs/archive/windsurf/legacy-tree", ".DS_Store"}
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--write-codeiumignore",
        action="store_true",
        help="Write .codeiumignore file from YAML codeium_patterns + codeium_negations",
    )
    parser.add_argument(
        "--check-codeiumignore",
        action="store_true",
        help="Verify .codeiumignore is in sync with YAML (CI mode)",
    )
