...
Provides comprehensive HTTP capabilities for legacy editor with enterprise features.
...
if __name__ == "__main__":
    # Guard against legacy editor double-spawn: two HTTP MCP processes wastes
