...
class ADGStaticValidator:
    ...
    def _validate_denominator_integrity(self, query_engine) -> Dict[str, float]:
        ...
        function_ratio = adg_counts['functions'] / ast_counts['functions'] if ast_counts['functions'] > 0 else 0
        ...
        print(f"  🔧 Function ratio: {function_ratio:.3f} ({adg_counts['functions']}/{ast_counts['functions']})")
