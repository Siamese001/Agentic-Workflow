...
To add a ledger:
    1. Write .codex/schemas/<name>_ledger.schema.sql
    ...
    5. Create consulting skill at .codex/skills/ledger-consulter-<name>/SKILL.md
"""
...
CURSOR_SCRIPTS_DIR = ".codex/governance/scripts"
...
class LedgerSpec:
    ...
    schema_file: str  # filename under .codex/schemas/
...
LEDGER_REGISTRY: tuple[LedgerSpec, ...] = (
    LedgerSpec(
        ...
        writer_hook=f"{CURSOR_SCRIPTS_DIR}/post_agent_adg_audit.py",
        consulting_skill=".codex/skills/ledger-consulter-tool-routing/SKILL.md",
        wave="W1.1",
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-refactor-outcome/SKILL.md",
        wave="W1.2",
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-prompt-classifier/SKILL.md",
        wave="W2.1",
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-mcp-invocation/SKILL.md",
        wave="W2.2",
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-hotspot-defect/SKILL.md",
        wave="W3.1",
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-deferred-scope-calibration/SKILL.md",
        wave="W3.2",
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-guardian-exemption/SKILL.md",
        wave="W4.1",
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-progress-eta/SKILL.md",
        wave="W4.2",
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-test-selection/SKILL.md",
        wave="W4.4",
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l2-cascade/SKILL.md",
        wave="W5.1",
        sunset_criterion=(
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l1-c0/SKILL.md",
        wave="W5.2",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l6-promo/SKILL.md",
        wave="W5.3",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l3-sovereign-mcp/SKILL.md",
        wave="W5.9",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l3-reroute/SKILL.md",
        wave="W5.8",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l5-hitl/SKILL.md",
        wave="W5.8",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l4-uwg/SKILL.md",
        wave="W5.7",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l0-ensemble/SKILL.md",
        wave="W5.6",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l0-path/SKILL.md",
        wave="W5.5",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l0-agentic/SKILL.md",
        wave="W5.5",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l0-bandit/SKILL.md",
        wave="W5.4",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-router-l6-regret/SKILL.md",
        wave="W5.3",
        sunset_criterion=(
            "90 consecutive days with zero §29 router-enforcement violations "
            "AND 4 consecutive in-band weekly calibration reports"
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-eval-harness-outcome/SKILL.md",
        wave="W5.P7",
        sunset_criterion=(
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-ask-user-question/SKILL.md",
        wave="W1.5",
        sunset_criterion=(
    ...
    LedgerSpec(
        ...
        consulting_skill=".codex/skills/ledger-consulter-apps-qna-pack-lifecycle/SKILL.md",
        wave="W1.4",
        sunset_criterion=(
