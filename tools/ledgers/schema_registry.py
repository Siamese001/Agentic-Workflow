...
LEDGER_REGISTRY: tuple[LedgerSpec, ...] = (
    LedgerSpec(
        ...
        writer_hook=".windsurf/scripts/post_cascade_adg_audit.py",
    ...
    LedgerSpec(
        ...
        writer_hook=".windsurf/scripts/post_commit_outcome_binder.py",
    ...
    LedgerSpec(
        ...
        writer_hook=".windsurf/scripts/pre_prompt_classifier.py",
    ...
    LedgerSpec(
        ...
        writer_hook=".windsurf/scripts/post_mcp_audit.py",
    ...
    LedgerSpec(
        ...
        writer_hook=".windsurf/scripts/post_write_audit.py",
    ...
    LedgerSpec(
        ...
        writer_hook=".windsurf/scripts/post_cascade_writeback_audit.py",
    ...
    LedgerSpec(
        ...
        writer_hook=".windsurf/scripts/post_run_audit.py",
