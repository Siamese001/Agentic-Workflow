...
To add a ledger:
    1. Write .windsurf/schemas/<name>_ledger.schema.sql
    ...
    5. Create consulting skill at .windsurf/skills/ledger-consulter-<name>/SKILL.md
"""
...
SCHEMAS_DIR = REPO_ROOT / ".windsurf" / "schemas"
...
class LedgerSpec:
    ...
    schema_file: str  # filename under .windsurf/schemas/
...
LEDGER_REGISTRY: tuple[LedgerSpec, ...] = (
    LedgerSpec(
        ...
        writer_hook=f"{WINDSURF_SCRIPTS_DIR}/post_cursor_agent_adg_audit.py",
        consulting_skill=".windsurf/skills/ledger-consulter-tool-routing/SKILL.md",
        wave="W1.1",
    ...
    LedgerSpec(
        ...
        writer_hook=f"{WINDSURF_SCRIPTS_DIR}/post_commit_outcome_binder.py",
        consulting_skill=".windsurf/skills/ledger-consulter-refactor-outcome/SKILL.md",
        wave="W1.2",
    ...
    LedgerSpec(
        ...
        writer_hook=f"{WINDSURF_SCRIPTS_DIR}/pre_prompt_classifier.py",
        consulting_skill=".windsurf/skills/ledger-consulter-prompt-classifier/SKILL.md",
        wave="W2.1",
    ...
    LedgerSpec(
        ...
        writer_hook=f"{WINDSURF_SCRIPTS_DIR}/post_mcp_audit.py",
        consulting_skill=".windsurf/skills/ledger-consulter-mcp-invocation/SKILL.md",
        wave="W2.2",
    ...
    LedgerSpec(
        ...
        consulting_skill=".windsurf/skills/ledger-consulter-hotspot-defect/SKILL.md",
        wave="W3.1",
    ...
    LedgerSpec(
        ...
        consulting_skill=".windsurf/skills/ledger-consulter-deferred-scope-calibration/SKILL.md",
        wave="W3.2",
    ...
    LedgerSpec(
        ...
        writer_hook=f"{WINDSURF_SCRIPTS_DIR}/post_write_audit.py",
        consulting_skill=".windsurf/skills/ledger-consulter-guardian-exemption/SKILL.md",
        wave="W4.1",
    ...
    LedgerSpec(
        ...
        consulting_skill=".windsurf/skills/ledger-consulter-progress-eta/SKILL.md",
        wave="W4.2",
    ...
    LedgerSpec(
        ...
        writer_hook=f"{WINDSURF_SCRIPTS_DIR}/post_cursor_agent_writeback_audit.py",
        consulting_skill=".windsurf/skills/ledger-consulter-memory-recall/SKILL.md",
        wave="W4.3",
    ...
    LedgerSpec(
        ...
        writer_hook=f"{WINDSURF_SCRIPTS_DIR}/post_run_audit.py",
        consulting_skill=".windsurf/skills/ledger-consulter-test-selection/SKILL.md",
        wave="W4.4",
