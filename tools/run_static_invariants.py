...
_emit_escalates_to_human("p1", "run_static_invariants", "human_escalation")
_emit_routes_through("p1", "run_static_invariants", "route_through")
_emit_checks_agent_registry("p1", "run_static_invariants", "agent_registry")
_emit_validates_agent_capability("p1", "run_static_invariants", "capability")
_emit_dispatches_execution_plan("p1", "run_static_invariants", "exec_plan")
_emit_agent_executes_agent("p1", "run_static_invariants", "sub_agent")
_emit_routes_to_agent("p1", "run_static_invariants", "target_agent")
_emit_verifies_policy("p1", "run_static_invariants", "policy_check")
_emit_observes_runtime_state("p1", "run_static_invariants", "runtime_state")
_emit_verifies_boundary("p1", "run_static_invariants", "boundary_check")
_emit_transcripts_response("p1", "run_static_invariants", "transcript")
_emit_hard_fails_untranscripted("p1", "run_static_invariants")
_emit_gated_by_confidence("p1", "run_static_invariants", "confidence_gate")
