...
post_cursor_agent_response hook (lifecycle gap). Manually pipes the marker
...
HOOK = REPO / ".claude" / "governance/scripts" / "_legacy_windsurf" / "post_cursor_agent_deferred_scope_capture.py"
