...
DB = r"C:\Git\Agentic-Workflow\artifacts\adg\adg_indexed_03132026_1949.sqlite"
...
cur.execute(f"SELECT id, adg_name, layer, entity_type, resolved_path FROM nodes WHERE {like_clauses}")
