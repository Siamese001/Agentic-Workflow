...
def _rescore(dry_run: bool) -> float:
    ...
    except (subprocess.TimeoutExpired, OSError) as exc:    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
