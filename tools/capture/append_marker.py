...
Used by Cascade as a `run_command` invocation at the end of any refactor-class
response, to record DECISION_CAPTURED / DEFERRED_SCOPE / NEXT_STEP markers
without depending on the Windsurf post-cascade hook chain.
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not lines:
        ...
        return 0  # fail-open; caller (Cascade) shouldn't see this as fatal
