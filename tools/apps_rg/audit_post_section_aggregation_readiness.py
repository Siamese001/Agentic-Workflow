...
def run_audit() -> dict[str, Any]:
    ...
    return {
        ...
        "aggregation_code": {
            "final_resume_assembler": "apps_rg/runtime/assembly/final_resume_assembler.py",
            ...
            "generated_lane_rollup": "apps_rg/runtime/reports/generated_lane_rollup.py",
            "orchestrate_full_resume": "apps_rg/runtime/orchestrate_full_resume.py",
            "resume_package_x3": "apps_rg/runtime/package/resume_package_x3.py",
