...
CONST_DEFS: list[tuple[str, str, str]] = sorted(
    [
        ("ARCHIVES_DIR", ARCHIVES_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("AGENTIC_CORE_DIR", AGENTIC_CORE_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("APPS_RG_DIR", APPS_RG_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("APPS_LIC_DIR", APPS_LIC_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("APPS_SHARED_DIR", APPS_SHARED_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("OPS_SCRIPTS_DIR", OPS_SCRIPTS_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("TESTS_DIR", TESTS_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("TOOLS_DIR", TOOLS_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("SYSTEM_LEARNING_DIR", SYSTEM_LEARNING_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("L0_MAINTENANCE_DIR", L0_MAINTENANCE_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("L1_COGNITION_DIR", L1_COGNITION_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("L2_EXECUTION_DIR", L2_EXECUTION_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("L3_ORCHESTRATION_DIR", L3_ORCHESTRATION_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("L4_STATE_DIR", L4_STATE_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("L5_SAFETY_DIR", L5_SAFETY_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("L6_OBSERVABILITY_DIR", L6_OBSERVABILITY_DIR, "agentic_core.L0_routing.config.path_constants"),
        ("DOCS_REPORTS_PLANS", DOCS_REPORTS_PLANS, "agentic_core.L5_safety.config.structure_blueprint.ssot"),
        ("REPORTS_DIR", REPORTS_DIR, "agentic_core.L5_safety.config.structure_blueprint.ssot"),
        ("TESTS_UNIT_DIR", TESTS_UNIT_DIR, "agentic_core.L5_safety.config.structure_blueprint.ssot"),
    ],
...
def restore_from_head(rel: str) -> bool:
    result = subprocess.run(
        ["git", "checkout", "HEAD", "--", rel], cwd=str(ROOT), capture_output=True, text=True
    )
