# DEPRECATED - SEE `.windsurf/workflows/antipattern-hitl-gate.md`

**Archived**: 2026-04-06
**Reason**: Consolidated into workflow to separate policy from operations
**Replacement**: `.windsurf/workflows/antipattern-hitl-gate.md` contains all anti-pattern HITL procedures
