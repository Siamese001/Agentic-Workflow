# DEPRECATED - SEE `.windsurf/rules/plan_ci_enforcement.md`

**Archived**: 2026-04-06
**Reason**: Consolidated into plan_ci_enforcement.md to reduce duplication
**Replacement**: `.windsurf/rules/plan_ci_enforcement.md` contains plan location SSOT requirements
