...
def main() -> NoReturn:
    ...
    parser.add_argument(
        "--output", type=Path, help="Output path for regenerated artifact (default: temp file)"
    )
    parser.add_argument(
        "--verbose", action="store_true", help="Show detailed output from regeneration and scoreboard"
    )
