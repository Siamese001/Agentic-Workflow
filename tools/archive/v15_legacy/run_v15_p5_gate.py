...
class P5EvidenceCollector:
    ...
    def _check_signed_modify_type(self):
        ...
        if not p5_path.exists():
            self.violations.append(
                {"check": "signed_modify_type", "detail": "crypto_trust_types.py not found"}
            )
            return
    ...
    def _check_ensure_v15_signed(self):
        ...
        if "ensure_v15_signed" in content:
            self.checks_passed.append(
                {"check": "ensure_v15_signed", "detail": "ensure_v15_signed found in guardian_contract"}
            )
        else:
            self.violations.append(
                {"check": "ensure_v15_signed", "detail": "ensure_v15_signed not found in guardian_contract"}
            )
    ...
    def _check_policy_exception_artifact(self):
        ...
        if not p3_path.exists():
            self.violations.append(
                {"check": "policy_exception_artifact", "detail": "governance_types.py not found"}
            )
            return
    ...
    def _check_evidence_pack_type(self):
        ...
        if "class EvidencePack" in content and "trace_id:" in content:
            ...
            self.violations.append(
                {"check": "evidence_pack_type", "detail": "EvidencePack missing or incomplete"}
            )
