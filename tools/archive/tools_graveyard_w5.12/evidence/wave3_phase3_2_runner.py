...
def main() -> None:
    ...
    rows = [
        (
            ...
            "analyze_l2_execution",
            "boundary",
            "'cache' in validator filename",
            "no gap",
            "test_l2_validator_cache_in_name_skipped",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l2_execution",
            ...
            "parse failure",
            "no gap",
            "test_l2_validator_parse_fail_skipped",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l2_execution",
            "success",
            "no schema_validator_cache import",
            "L2-GAP-VALIDATOR HIGH",
            "test_l2_validator_no_cache_import_generates_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l2_execution",
            "negative",
            "schema_validator_cache module imported",
            "no gap",
            "test_l2_validator_with_cache_module_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l2_execution",
            "negative",
            "SchemaValidatorCache symbol imported",
            "no gap",
            "test_l2_validator_with_symbol_cache_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l2_execution",
            ...
            "no validator files",
            "no gaps",
            "test_l2_no_validator_files_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l3_orchestration",
            "boundary",
            "parse failure",
            "no L3-GAP-001",
            "test_l3_orchestrator_parse_fail_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l3_orchestration",
            "success",
            "no plan cache import",
            "L3-GAP-001 MEDIUM",
            "test_l3_orchestrator_no_cache_generates_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l3_orchestration",
            "negative",
            "orchestration_plan_cache imported",
            "no gap",
            "test_l3_orchestrator_with_cache_module_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l3_orchestration",
            ...
            "file does not exist",
            "no gaps",
            "test_l3_orchestrator_file_missing_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l4_state",
            ...
            "parse failure",
            "no L4-GAP-001",
            "test_l4_blob_parse_fail_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l4_state",
            "boundary",
            "exactly 10 l4_state_accesses",
            "no L4-GAP-001 (boundary <= 10)",
            "test_l4_blob_exactly_ten_accesses_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l4_state",
            "success",
            "11 l4_state_accesses",
            "L4-GAP-001 HIGH (> 10)",
            "test_l4_blob_eleven_accesses_generates_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l4_state",
            ...
            "file does not exist",
            "no gaps",
            "test_l4_blob_file_missing_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l5_safety",
            "boundary",
            "'cache' in enforcement filename",
            "no gap",
            "test_l5_enforcement_cache_in_name_skipped",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l5_safety",
            ...
            "parse failure",
            "no gap",
            "test_l5_enforcement_parse_fail_skipped",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l5_safety",
            "success",
            "'policy' in name + no cache import",
            "L5-GAP-POLICY MEDIUM",
            "test_l5_enforcement_policy_in_name_no_cache_generates_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l5_safety",
            ...
            "'policy' not in name",
            "no gap",
            "test_l5_enforcement_no_policy_in_name_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l5_safety",
            "negative",
            "policy_registry_cache imported",
            "no gap",
            "test_l5_enforcement_with_cache_import_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l5_safety",
            "boundary",
            "no enforcement files",
            "no gaps",
            "test_l5_no_enforcement_files_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l6_observability",
            "boundary",
            "parse failure",
            "no gap",
            "test_l6_telemetry_parse_fail_skipped",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l6_observability",
            "success",
            "no config_file_cache import",
            "L6-GAP-CONFIG LOW",
            "test_l6_telemetry_no_cache_import_generates_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l6_observability",
            "negative",
            "config_file_cache module imported",
            "no gap",
            "test_l6_telemetry_with_cache_module_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l6_observability",
            "negative",
            "ConfigFileCache symbol imported",
            "no gap",
            "test_l6_telemetry_with_symbol_cache_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_l6_observability",
            ...
            "no telemetry files",
            "no gaps",
            "test_l6_no_telemetry_files_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_architecture_component_presence",
            "boundary",
            "file does not exist",
            "ARCH-COMPONENT-MISSING",
            "test_arch_component_missing_file_generates_missing_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_architecture_component_presence",
            ...
            "parse failure",
            "no gap",
            "test_arch_component_parse_fail_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_architecture_component_presence",
            "negative",
            "signals present",
            "no ARCH-COMPONENT-WEAK",
            "test_arch_component_signals_present_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_architecture_component_presence",
            ...
            "no signals found",
            "ARCH-COMPONENT-WEAK",
            "test_arch_component_no_signals_generates_weak_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "_dedupe_gaps",
        ...
        (
            ...
            "no duplicate keys",
            "all retained",
            "test_dedupe_gaps_no_duplicates_all_retained",
        ),
        (
            "semantic_gap_analyzer.py",
            "_dedupe_gaps",
            "success",
            "dup key, HIGH vs MEDIUM",
            "HIGH wins",
            "test_dedupe_gaps_duplicate_key_keeps_higher_priority",
        ),
        (
            "semantic_gap_analyzer.py",
            "_dedupe_gaps",
            ...
            "HIGH < MEDIUM < LOW",
            "test_dedupe_gaps_sorted_by_priority",
        ),
        (
            "agentic_core (real)",
            "analyze_l2_execution",
            ...
            "returns list",
            "list",
            "test_analyze_l2_execution_returns_list",
        ),
        (
            "agentic_core (real)",
            "analyze_l3_orchestration",
            ...
            "returns list",
            "list",
            "test_analyze_l3_orchestration_returns_list",
        ),
        (
            "agentic_core (real)",
            "analyze_l4_state",
            ...
            "returns list",
            "list",
            "test_analyze_l4_state_returns_list",
        ),
        (
            "agentic_core (real)",
            "analyze_l5_safety",
            ...
            "returns list",
            "list",
            "test_analyze_l5_safety_returns_list",
        ),
        (
            "agentic_core (real)",
            "analyze_l6_observability",
            ...
            "returns list",
            "list",
            "test_analyze_l6_observability_returns_list",
        ),
        (
            "agentic_core (real)",
            "analyze_architecture_component_presence",
            ...
            "returns list",
            "list",
            "test_analyze_architecture_component_presence_returns_list",
        ),
        (
            "agentic_core (real)",
            "L2-GAP-VALIDATOR priority",
            "contract",
            "HIGH",
            "all HIGH",
            "test_l2_validator_gaps_are_high_priority",
        ),
        (
            "agentic_core (real)",
            "L3-GAP-001 priority",
            ...
            "MEDIUM",
            "MEDIUM",
            "test_l3_gap001_is_medium_if_present",
        ),
        (
            "agentic_core (real)",
            "L4-GAP-001 priority",
            ...
            "HIGH",
            "HIGH",
            "test_l4_gap001_is_high_if_present",
        ),
        (
            "agentic_core (real)",
            "L5-GAP-POLICY priority",
            "contract",
            "MEDIUM",
            "all MEDIUM",
            "test_l5_policy_gaps_are_medium_if_present",
        ),
        (
            "agentic_core (real)",
            "L6-GAP-CONFIG priority",
            "contract",
            "LOW",
            "all LOW",
            "test_l6_config_gaps_are_low_if_present",
        ),
    ]
    for row in rows:
