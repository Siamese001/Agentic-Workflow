...
def main() -> None:
    ...
    rows = [
        (
            ...
            "returns dict",
            "dict",
            "test_run_analysis_returns_dict",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            ...
            "no missing keys",
            "test_run_analysis_has_all_required_keys",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
        ...
        (
            ...
            "run_analysis",
            "contract",
            "gaps are SemanticGap instances",
            "all instances",
            "test_run_analysis_gaps_are_semantic_gap_instances",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            "contract",
            "parse_failures is list",
            "list",
            "test_run_analysis_parse_failures_is_list",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            "contract",
            "prompt_taxonomy_findings is list",
            "list",
            "test_run_analysis_prompt_taxonomy_findings_is_list",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            "contract",
            "architecture_component_findings is list",
            "list",
            "test_run_analysis_architecture_component_findings_is_list",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            "contract",
            "layer_connection_findings is list",
            "list",
            "test_run_analysis_layer_connection_findings_is_list",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            "success",
            "self.gaps populated after call",
            "populated",
            "test_run_analysis_self_gaps_populated_after_call",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            "success",
            "self.parse_failures sorted after call",
            "sorted",
            "test_run_analysis_self_parse_failures_sorted_after_call",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            "contract",
            "high_priority count accurate",
            "matches",
            "test_run_analysis_high_priority_count_correct",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            "contract",
            "medium_priority count accurate",
            "matches",
            "test_run_analysis_medium_priority_count_correct",
        ),
        (
            "semantic_gap_analyzer.py",
            "run_analysis",
            "contract",
            "low_priority count accurate",
            "matches",
            "test_run_analysis_low_priority_count_correct",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
        ...
        (
            ...
            "creates parent dirs",
            "nested dirs created",
            "test_generate_report_creates_parent_dirs",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
        ...
        (
            ...
            "file is valid UTF-8",
            "no decode error",
            "test_generate_report_is_valid_utf8",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            ...
            "Executive Summary",
            "present",
            "test_generate_report_has_executive_summary",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            ...
            "present",
            "test_generate_report_has_analysis_methodology",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            ...
            "Next Steps",
            "present",
            "test_generate_report_has_next_steps",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            ...
            "Validation",
            "present",
            "test_generate_report_has_validation",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            "conditional",
            "Priority Matrix when gaps exist",
            "present",
            "test_generate_report_has_priority_matrix_when_gaps",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            "conditional",
            "no Arch section when findings empty",
            "absent",
        ...
        (
            ...
            "generate_report",
            "conditional",
            "Arch section when findings present",
            "present",
            "test_generate_report_arch_section_present_when_findings",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            "conditional",
            "no Taxonomy section when findings empty",
            "absent",
        ...
        (
            ...
            "generate_report",
            "conditional",
            "Taxonomy section when findings present",
            "present",
            "test_generate_report_taxonomy_section_present_when_findings",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            "conditional",
            "no Layer Connection when empty",
            "absent",
            "test_generate_report_no_layer_connection_section_when_empty",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            "conditional",
            "Layer Connection when findings present",
            "present",
            "test_generate_report_layer_connection_present_when_findings",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            "conditional",
            "no Parse Failures section when none",
            "absent",
            "test_generate_report_no_parse_failures_section_when_empty",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            "conditional",
            "Parse Failures section when present",
            "present",
            "test_generate_report_parse_failures_section_present",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            "success",
            "per-layer gap sections",
            "present",
            "test_generate_report_per_layer_gap_section",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            ...
            "matches gaps",
            "test_generate_report_executive_summary_counts_accurate",
        ),
        (
            "semantic_gap_analyzer.py",
            "generate_report",
            "contract",
            "gap_id appears in report",
            "present",
            "test_generate_report_gap_id_appears_in_report",
        ),
        (
            "agentic_core (real)",
            ...
            "full pipeline",
            "valid report",
            "test_real_run_analysis_and_generate_report_e2e",
        ),
        (
            "agentic_core (real)",
            "run_analysis totals",
            "invariant",
            "total/priority consistent",
            "consistent",
            "test_real_run_analysis_result_totals_consistent",
        ),
        (
            "agentic_core (real)",
            "SemanticGap.evidence_files",
            "contract",
            "non-empty on all gaps",
            "all non-empty",
            "test_all_gap_evidence_files_nonempty",
        ),
        (
            "agentic_core (real)",
            "SemanticGap.priority",
            "contract",
            "HIGH/MEDIUM/LOW only",
            "valid",
            "test_all_gaps_have_valid_priority",
        ),
        (
            "agentic_core (real)",
            "SemanticGap.layer",
            ...
            "L0-L6/UNKNOWN only",
            "valid",
            "test_all_gaps_have_valid_layer",
        ),
        (
            "agentic_core (real)",
            "SemanticGap.intent",
            ...
            "non-empty",
            "non-empty",
            "test_all_gaps_have_nonempty_intent",
        ),
        (
            "agentic_core (real)",
            "SemanticGap.recommended_fix",
            "contract",
            "non-empty",
            "non-empty",
            "test_all_gaps_have_nonempty_recommended_fix",
        ),
    ]
    for row in rows:
