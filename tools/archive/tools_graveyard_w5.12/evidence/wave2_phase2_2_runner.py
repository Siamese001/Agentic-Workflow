...
def main() -> None:
    ...
    rows = [
        (
            ...
            "analyze_rag_embedding_sovereignty",
            "negative",
            "no embedding_mentions in file",
            "skip, no gap",
            "test_no_embedding_mentions_produces_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            "allowed",
            "'embedding' in path",
            "no EMBEDDING-PLACEMENT-GAP",
            "test_embedding_in_path_name_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
        ...
        (
            ...
            "'factory' in path",
            "no gap",
            "test_factory_in_path_name_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            ...
            "'memory' in path",
            "no gap",
            "test_memory_in_path_name_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            ...
            "'seed' in path",
            "no gap",
            "test_seed_in_path_name_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            "allowed-layer",
            "L1 file with embedding",
            "no gap",
            "test_l1_layer_file_with_embedding_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            "allowed-layer",
            "L4 file with embedding",
            "no gap",
            "test_l4_layer_file_with_embedding_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            "success",
            "L0 file, no allowed token",
            "EMBEDDING-PLACEMENT-GAP HIGH",
            "test_l0_file_no_allowed_token_generates_embedding_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            "success",
            "L2 file, no allowed token",
            "EMBEDDING-PLACEMENT-GAP",
            "test_l2_file_no_allowed_token_generates_embedding_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            "success",
            "L3 file, no allowed token",
            "EMBEDDING-PLACEMENT-GAP",
        ...
        (
            ...
            "analyze_rag_embedding_sovereignty",
            "success",
            "UNKNOWN layer, no allowed token",
            "EMBEDDING-PLACEMENT-GAP",
            "test_unknown_layer_file_no_allowed_token_generates_embedding_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            ...
            "parse-failed file",
            "skipped, no gap",
            "test_parse_failed_file_skipped_no_embedding_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            "boundary",
            "allowed token overrides bad L0 layer",
            "no gap",
            "test_allowed_token_in_path_overrides_bad_layer",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_rag_embedding_sovereignty",
            "boundary",
            "L4 layer without allowed token",
            "no gap (layer exempt)",
            "test_l4_layer_without_allowed_token_still_no_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            ...
            "non-empty tuple",
            "invariant holds",
            "test_embedding_hint_patterns_non_empty",
        ),
        (
            "semantic_gap_analyzer.py",
            "EMBEDDING_HINT_PATTERNS",
            "invariant",
            "contains embedding/bge/faiss",
            "all present",
            "test_embedding_hint_patterns_contains_expected_entries",
        ),
        (
            "agentic_core (real)",
            "analyze_rag_embedding_sovereignty",
            ...
            "returns list",
            "list type",
            "test_embedding_sovereignty_returns_list",
        ),
        (
            "agentic_core (real)",
            "all gaps",
            ...
            "priority == HIGH",
            "all HIGH",
            "test_all_embedding_gaps_are_high_priority",
        ),
        (
            "agentic_core (real)",
            "all gaps",
            "contract",
            "evidence_files non-empty",
            "all non-empty",
            "test_all_embedding_gaps_have_evidence_files",
        ),
        (
            "agentic_core (real)",
            "L1 layer invariant",
            ...
            "L1 not in gaps",
            "never flagged",
            "test_l1_files_not_in_embedding_gaps",
        ),
        (
            "agentic_core (real)",
            "L4 layer invariant",
            ...
            "L4 not in gaps",
            "never flagged",
            "test_l4_files_not_in_embedding_gaps",
        ),
    ]
    for row in rows:
