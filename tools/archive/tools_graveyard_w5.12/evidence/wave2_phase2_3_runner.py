...
def main() -> None:
    ...
    rows = [
        (
            ...
            "success",
            "prompt in name + assembler in rel",
            "True",
            "test_looks_like_prompt_assembler_prompt_in_name_assembler_in_rel",
        ),
        (
            "semantic_gap_analyzer.py",
            "_looks_like_prompt_assembler",
            "success",
            "prompt in name + builder in rel",
            "True",
            "test_looks_like_prompt_assembler_prompt_in_name_builder_in_rel",
        ),
        (
            "semantic_gap_analyzer.py",
            "_looks_like_prompt_assembler",
            "negative",
            "no prompt in filename",
            "False",
            "test_looks_like_prompt_assembler_no_prompt_in_name",
        ),
        (
            "semantic_gap_analyzer.py",
            "_looks_like_prompt_assembler",
            "negative",
            "prompt in name, no assembler token",
            "False",
            "test_looks_like_prompt_assembler_prompt_in_name_no_assembler_token",
        ),
        (
            "semantic_gap_analyzer.py",
            "_looks_like_prompt_assembler",
            ...
            "True",
            "test_looks_like_prompt_assembler_assembler_hint_in_used_names",
        ),
        (
            "semantic_gap_analyzer.py",
            "_looks_like_prompt_assembler",
            "success",
            "prompt_assembly_markers non-empty (string)",
            "True",
            "test_looks_like_prompt_assembler_assembler_hint_in_string_literals",
        ),
        (
            "semantic_gap_analyzer.py",
            ...
            "no hits -> 0",
            "0",
            "test_slot_coverage_score_zero_when_no_hits",
        ),
        (
            "semantic_gap_analyzer.py",
            "_slot_coverage_score",
            "boundary",
            "all slots hit -> max",
            "len(PROMPT_SLOT_ORDER)",
            "test_slot_coverage_score_max_when_all_slots_hit",
        ),
        (
            "semantic_gap_analyzer.py",
            "_slot_coverage_score",
        ...
        (
            ...
            "[]",
            "test_missing_slots_empty_when_all_present",
        ),
        (
            "semantic_gap_analyzer.py",
            "_missing_slots",
            ...
            "some missing",
            "correct subset",
            "test_missing_slots_partial",
        ),
        (
            "semantic_gap_analyzer.py",
            "_report_slot_status",
            "contract",
            "= separator, present/missing labels",
            "correct format",
            "test_report_slot_status_marks_missing_and_present",
        ),
        (
            "semantic_gap_analyzer.py",
            "PROMPT_SLOT_ORDER",
            ...
            "5 canonical slots",
            "S0 D0 I0 C0 U0",
            "test_prompt_slot_order_contains_all_canonical_slots",
        ),
        (
            "semantic_gap_analyzer.py",
            "PROMPT_TAXONOMY_PATTERNS",
            "invariant",
            "each slot has patterns",
            "all non-empty",
            "test_prompt_taxonomy_patterns_all_slots_have_patterns",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_file (S0)",
            "success",
            "system_prompt in string literal",
            "S0 detected",
            "test_s0_slot_detected_from_system_prompt_literal",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_file (D0)",
            "success",
            "guardrail in string literal",
            "D0 detected",
            "test_d0_slot_detected_from_guardrail_literal",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_file (I0)",
            "success",
            "persona in used_name",
            "I0 detected",
            "test_i0_slot_detected_from_persona_used_name",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_file (C0)",
            "success",
            "injected_context in literal",
            "C0 detected",
            "test_c0_slot_detected_from_context_literal",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_file (U0)",
            "success",
            "user_prompt in literal",
            "U0 detected",
            "test_u0_slot_detected_from_user_prompt_literal",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_file (no slots)",
            "negative",
            "unrelated code",
            "no hits",
            "test_no_slot_hit_for_unrelated_content",
        ),
        (
            "semantic_gap_analyzer.py",
            ...
            "no gaps",
            "test_parse_failed_file_skipped_no_taxonomy_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_prompt_taxonomy_coverage",
            "boundary",
            "non-assembler file skipped",
            "no gaps",
            "test_non_assembler_file_skipped_no_taxonomy_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_prompt_taxonomy_coverage",
            "success",
            "missing S0/C0/U0 -> HIGH",
            "PROMPT-TAXONOMY-GAP HIGH",
            "test_missing_critical_slots_generates_high_priority_taxonomy_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_prompt_taxonomy_coverage",
            "success",
            "missing D0/I0 only -> MEDIUM",
            "PROMPT-TAXONOMY-GAP MEDIUM",
            "test_missing_non_critical_slots_generates_medium_priority_taxonomy_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_prompt_taxonomy_coverage",
            "negative",
            "all slots present -> no gap",
            "no PROMPT-TAXONOMY-GAP",
            "test_all_slots_present_no_taxonomy_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_prompt_taxonomy_coverage",
        ...
        (
            ...
            "no PROMPT-MANIFEST-GAP",
            "test_manifest_hash_present_no_manifest_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_prompt_taxonomy_coverage",
            "success",
            "no boundary snapshot",
            "PROMPT-VALIDATOR-GAP LOW",
        ...
        (
            ...
            "analyze_prompt_taxonomy_coverage",
            "negative",
            "boundary snapshot present",
            "no PROMPT-VALIDATOR-GAP",
            "test_boundary_snapshot_present_no_validator_gap",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_prompt_taxonomy_coverage",
            ...
            "at most 1 gap per file",
            "test_deduplication_prevents_double_gaps",
        ),
        (
            "semantic_gap_analyzer.py",
            ...
            "all keys found",
            "test_taxonomy_finding_added_to_prompt_taxonomy_findings",
        ),
        (
            "agentic_core (real)",
            "analyze_prompt_taxonomy_coverage",
            ...
            "returns list",
            "list type",
            "test_prompt_taxonomy_coverage_returns_list",
        ),
        (
            "agentic_core (real)",
            "PROMPT-TAXONOMY-GAP layer",
            "contract",
            "layer == L1",
            "all L1",
            "test_all_taxonomy_gaps_have_layer_l1",
        ),
        (
            "agentic_core (real)",
            "PROMPT-MANIFEST-GAP priority",
            "contract",
            "MEDIUM",
            "all MEDIUM",
            "test_all_manifest_gaps_are_medium_priority",
        ),
        (
            "agentic_core (real)",
            "PROMPT-VALIDATOR-GAP priority",
            "contract",
            "LOW",
            "all LOW",
            "test_all_validator_gaps_are_low_priority",
        ),
    ]
    for row in rows:
