...
def main() -> None:
    ...
    rows = [
        (
            ...
            "_load_ssot_config",
            "success",
            "import indented in method body",
            "parses cleanly",
            "test_parse_failure_file_parses_cleanly[SSOTFolderCleanupAgent.py]",
        ),
        (
            "SSOTFolderCleanupAgent.py",
            "_load_ssot_config",
            "negative",
            "import at col-0 inside method",
            "SyntaxError raised",
            "test_unindented_import_inside_method_raises_syntax_error",
        ),
        (
            "SSOTFolderCleanupAgent.py",
            "_load_ssot_config",
            "positive-structural",
            "import AST node is indented",
            "line starts with spaces",
            "test_ssot_folder_cleanup_agent_import_is_inside_method",
        ),
        (
            "forensic_discovery_prep.py",
            "module-level try",
            "success",
            "import indented inside try block",
            "parses cleanly",
            "test_parse_failure_file_parses_cleanly[forensic_discovery_prep.py]",
        ),
        (
            "forensic_discovery_prep.py",
            "module-level try",
            "negative",
            "import at col-0 inside try",
            "SyntaxError raised",
            "test_unindented_import_inside_try_raises_syntax_error",
        ),
        (
            "forensic_discovery_prep.py",
            "module-level try",
            "positive-structural",
            "import node inside Try AST node",
            "4-space indent confirmed",
            "test_forensic_discovery_prep_import_is_inside_try",
        ),
        (
            "run_guardian_hierarchy_compliance.py",
            "scan_missing_structure",
            "success",
            "import indented in function",
            "parses cleanly",
            "test_parse_failure_file_parses_cleanly[run_guardian_hierarchy_compliance.py]",
        ),
        (
            "run_guardian_hierarchy_compliance.py",
            "scan_missing_structure",
            "negative",
            "import at col-0 inside function",
            "SyntaxError raised",
            "test_unindented_import_inside_function_raises_syntax_error",
        ),
        (
            "run_guardian_hierarchy_compliance.py",
            "scan_missing_structure",
            "positive-structural",
            "import inside FunctionDef AST node",
            "4-space indent confirmed",
            "test_run_guardian_hierarchy_compliance_import_is_inside_function",
        ),
        (
            "semantic_gap_analyzer.py",
            "ARCHITECTURE_COMPONENT_RULES",
            "success",
            "write_gateway path exists",
            "file present",
            "test_write_gateway_correct_path_exists",
        ),
        (
            "semantic_gap_analyzer.py",
            "ARCHITECTURE_COMPONENT_RULES",
            "negative",
            "old write_gateway path absent",
            "file not present",
            "test_write_gateway_wrong_path_does_not_exist",
        ),
        (
            "semantic_gap_analyzer.py",
            "ARCHITECTURE_COMPONENT_RULES",
            "success",
            "meta_learning path exists",
            "file present",
            "test_meta_learning_pipeline_correct_path_exists",
        ),
        (
            "semantic_gap_analyzer.py",
            "ARCHITECTURE_COMPONENT_RULES",
            "negative",
            "old system_learning path absent",
            "file not present",
            "test_meta_learning_wrong_path_does_not_exist",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_architecture_component_presence",
            "success",
            "all 5 rules point to existing files",
            "no missing paths",
            "test_all_architecture_component_rule_paths_exist",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_architecture_component_presence",
            "success",
            "all component files parse cleanly",
            "no SyntaxErrors",
            "test_all_architecture_component_rule_paths_parse_cleanly",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_architecture_component_presence",
            "integration-success",
            "write_gateway finding shows exists=True",
            "exists=True",
            "test_analyzer_write_gateway_finding_shows_present",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_architecture_component_presence",
            "integration-success",
            "meta_learning finding shows exists=True",
            "exists=True",
            "test_analyzer_meta_learning_pipeline_finding_shows_present",
        ),
        (
            "semantic_gap_analyzer.py",
            "analyze_architecture_component_presence",
            "integration-negative",
            "no finding has signals_present='missing file'",
            "zero missing rows",
            "test_analyzer_no_component_finding_shows_missing_file",
        ),
        (
            "tools/evidence/_ast_parse_ok",
            "_ast_parse_ok",
            "success",
            "valid file -> True, empty err",
            "True",
            "test_ast_parse_ok_returns_true_for_valid_source",
        ),
        (
            "tools/evidence/_ast_parse_ok",
            "_ast_parse_ok",
            "failure",
            "broken file -> False, non-empty err",
            "False",
            "test_ast_parse_ok_returns_false_for_broken_source",
        ),
        (
            "tools/evidence/_ast_parse_ok",
            "_ast_parse_ok",
            ...
            "True",
            "test_ast_parse_ok_empty_file_is_valid",
        ),
        (
            "tools/evidence/analyze_architecture_component_presence",
            "integration",
            "integration-negative",
            "no gap has 'missing file' in reality",
            "zero missing-file gaps",
            "test_analyzer_reports_no_missing_component_files",
        ),
    ]
    for row in rows:
