...
def main():
    ...
    evidence_file = repo_root / "docs" / REPORTS_DIR / "plans" / "phase_05_06_consolidated.md"
    ...
    commands = [
        ...
        ([sys.executable, "ops_scripts/ci/check_spine_adapter_contract.py"], "Spine Adapter Contract Guard"),
