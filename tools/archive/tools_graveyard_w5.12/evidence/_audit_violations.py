...
ALLOWED = {
    ...
    ("L_RUNTIME", "L3"), ("L_RUNTIME", "L4"), ("L_RUNTIME", "L5"), ("L_RUNTIME", "L_SHARED"),
    ("L_PG", "L0"), ("L_PG", "L1"), ("L_PG", "L2"), ("L_PG", "L_RUNTIME"), ("L_PG", "L4"),
    ("L_SHARED", "L0"), ("L_SHARED", "L_RUNTIME"), ("L_SHARED", "L5"),
    ("L_SHARED", "L2"), ("L_SHARED", "L1"), ("L_SHARED", "L_APP"), ("L_SHARED", "L_SHARED"),
    ("L_APP", "L6"), ("L_APP", "L5"), ("L_APP", "L4"), ("L_APP", "L3"),
    ("L_APP", "L2"), ("L_APP", "L1"), ("L_APP", "L0"), ("L_APP", "L_SHARED"), ("L_APP", "L_SL"),
...
STDLIB = {
    "__future__", "logging", "json", "sys", "os", "uuid", "time", "typing",
    "dataclasses", "enum", "pathlib", "asyncio", "hashlib", "threading",
    "shutil", "abc", "copy", "re", "io", "functools", "itertools",
    "collections", "warnings", "contextlib", "weakref", "inspect",
    "traceback", "subprocess", "tempfile", "socket", "http", "math",
    "random", "string", "struct", "datetime", "gc", "operator",
}

THIRD_PARTY = {
    "flask", "werkzeug", "requests", "pydantic", "numpy", "pandas",
    "chromadb", "watchdog", "websockets", "git", "yaml", "toml",
    "attrs", "cattrs", "click", "fastapi", "uvicorn", "starlette",
}
