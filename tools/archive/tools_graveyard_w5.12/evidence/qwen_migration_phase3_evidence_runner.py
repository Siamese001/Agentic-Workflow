...
emit_determinism_digest(
    "trace_qwen_migration_phase3_evidence_runner", "qwen_migration_phase3_evidence_runner_dispatch"
)
emit_determinism_digest(
    "trace_qwen_migration_phase3_evidence_runner", "qwen_migration_phase3_evidence_runner_complete"
)
