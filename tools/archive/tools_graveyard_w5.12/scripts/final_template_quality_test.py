    ...
    for scenario in test_scenarios:
        ...
        try:
            ...
            checks = {
                ...
                "data_coverage": sum(1 for data in scenario["expected_data"] if data in template)
                / len(scenario["expected_data"]),
            ...
            print(
                f"   Data Coverage: {checks['data_coverage'] * 100:.1f}% ({len(result['data_found'])}/{len(scenario['expected_data'])})"
            )
