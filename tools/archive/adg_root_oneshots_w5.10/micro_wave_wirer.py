...
EMIT_TEMPLATES = {
    ...
    "validated_by_safety_plane": {
        "import_line": "from agentic_core.runtime.contracts.lifecycle_trace_contract import _emit_validated_by_safety_plane",
        "call_template": '_emit_validated_by_safety_plane(str(uuid.uuid4()), "{method_name}", "{layer}")',
    },
    "verifies_boundary": {
        "import_line": "from agentic_core.runtime.contracts.lifecycle_trace_contract import _emit_verifies_boundary",
        "call_template": '_emit_verifies_boundary(str(uuid.uuid4()), "{method_name}", "{layer}")',
    },
    "agent_executes_agent": {
        "import_line": "from agentic_core.runtime.contracts.lifecycle_trace_contract import _emit_agent_executes_agent",
    ...
    "observes_runtime_state": {
        "import_line": "from agentic_core.runtime.contracts.lifecycle_trace_contract import _emit_observes_runtime_state",
        "call_template": '_emit_observes_runtime_state(str(uuid.uuid4()), "{method_name}", "{layer}")',
    },
    "verifies_policy": {
        "import_line": "from agentic_core.runtime.contracts.lifecycle_trace_contract import _emit_verifies_policy",
        "call_template": '_emit_verifies_policy(str(uuid.uuid4()), "{method_name}", "{layer}")',
    },
    "gated_by_confidence": {
        "import_line": "from agentic_core.runtime.contracts.lifecycle_trace_contract import _emit_gated_by_confidence",
        "call_template": '_emit_gated_by_confidence(str(uuid.uuid4()), "{method_name}", "0.5")',
    },
    "hard_fails_untranscripted": {
        "import_line": "from agentic_core.runtime.contracts.lifecycle_trace_contract import _emit_hard_fails_untranscripted",
        "call_template": '_emit_hard_fails_untranscripted(str(uuid.uuid4()), "{method_name}")',
    },
    "transcripts_response": {
        "import_line": "from agentic_core.runtime.contracts.lifecycle_trace_contract import _emit_transcripts_response",
...
def find_best_method(
    tree: ast.Module, method_patterns: list[str]
