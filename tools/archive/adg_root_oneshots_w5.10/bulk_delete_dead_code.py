...
def query_dead_functions(
    layer: str | None = None, directory: str | None = None, limit: int = 100
) -> list[dict]:
...
def cluster_dead_code_via_graph(limit: int = 1000) -> dict:
    ...
    try:
        ...
        for community in communities:
            ...
            avg_centrality = (
                sum(cluster_centralities) / len(cluster_centralities) if cluster_centralities else 0.0
            )
