...
LAYER_OWNER_MAP: Mapping[str, str] = {
    ...
    "l6 observability": "06_L6_Observability_and_System_Learning",
    "l6 shadow eval": "06_L6_Observability_and_System_Learning",
    "l6 evaluation": "06_L6_Observability_and_System_Learning",
    ...
    "l6 observability + hitl": "06_L6_Observability_and_System_Learning",
...
DEFAULT_OTEL_SPAN: Mapping[str, str] = {
    ...
    "06_L6_Observability_and_System_Learning": "l6.eval.record_sealed",
...
PHASE_SPAN_REFINEMENT: Mapping[tuple[str, str], str] = {
    ...
    ("06_L6_Observability_and_System_Learning", "Post-run learning"): "l6.learning.proposal_emitted",
    ("06_L6_Observability_and_System_Learning", "Promotion + Shadow eval"): "l6.eval.record_sealed",
...
TEST_ROOT_MAP: Mapping[str, str] = {
    ...
    "06_L6_Observability_and_System_Learning": "tests/unit/agentic_core/L6_observability/",
...
CI_GATE_MAP: Mapping[str, str] = {
    ...
    "06_L6_Observability_and_System_Learning": "ops_scripts/ci/check_l6_shadow_eval_proof.py",
...
NEGATIVE_CONTROL_MAP: Mapping[str, str] = {
    ...
    "06_L6_Observability_and_System_Learning": "L6 attempts current-run mutation -- must fail",
...
RUNTIME_ARTIFACT_MAP: Mapping[str, str] = {
    ...
    "06_L6_Observability_and_System_Learning": "L6EvalRecord + LearningProposal (replay-tied, no current-run mutation)",
...
ARTIFACT_SCHEMA_MAP: Mapping[str, str] = {
    ...
    "06_L6_Observability_and_System_Learning": "agentic_core/L6_observability/contracts.py:L6EvalRecord",
...
OWNER_EXTRA_ATTRS: Mapping[str, tuple[str, ...]] = {
    ...
    "06_L6_Observability_and_System_Learning": ("replay_key",),
...
def _derive_replay_proof(owner_surface: str) -> str:
    ...
    if owner_surface == "06_L6_Observability_and_System_Learning":
