...
class UnifiedMemoryManager:
    ...
    def load_embedding(self, entity_id: str, entity_type: str, model_version: str = "latest") -> Optional[EmbeddingVector]:
    ...
    def load_application_state(self, key: str) -> Optional[Any]:
