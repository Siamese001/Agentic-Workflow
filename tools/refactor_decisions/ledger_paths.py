...
Writable SSOT: ``.codex/state/refactor_decisions/refactor_decision_ledger.sqlite``.

``.codex/state/...`` is a **legacy mirror** surface only (drift checks, one-way
...
REFACTOR_DECISIONS_DIR_SSO = REPO_ROOT / ".codex" / "state" / "refactor_decisions"
...
REFACTOR_DECISIONS_DIR_WINDSURF_LEGACY = REPO_ROOT / ".codex" / "state" / "refactor_decisions"
