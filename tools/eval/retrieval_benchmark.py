...
# ---------------------------------------------------------------------------
# Retired exec pilot proof
# ---------------------------------------------------------------------------


def run_exec_pilot_proof() -> bool:
    """Retired after the executive-brief app surface was deleted."""
    print(
        "\nEXEC pilot proof SKIPPED: the executive-brief app surface has been retired. "
        "Use the remaining app-specific proof commands instead."
    )
    return True
