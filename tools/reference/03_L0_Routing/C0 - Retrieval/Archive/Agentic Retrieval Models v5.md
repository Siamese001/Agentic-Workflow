# UNIFIED ARCHITECTURAL SPEC: AGENTIC RETRIEVAL & RAG PIPELINES (v6.4 - FULL INTEGRATION)
...
|                                  |                                  | 1. ChunkManifestRegistry (L4D)   | 3. RetrievalEvaluation (L4F)     |                                  |
|                                  |                                  | DOMAIN: Ingestion & Substrate    | DOMAIN: Execution Quality        |                                  |
|                                  |                                  | KEY: chunk_id (SHA-256)          | KEY: trace_id / query_hash       |                                  |
|                                  |                                  | DATA: [22] EnrichedManifest      | DATA: [19] SupportedAnswerCheck  |                                  |
|                                  |                                  | MECH: - Validates payload integr | MECH: - Logs Prec/Recall/MRR     |                                  |
|                                  |                                  | - Maps structured knowl to head  | - Stores ground-truth F1 (Grnd)  |                                  |
|                                  |                                  | - Guarantees exact knowl retriev | - Emits signals for Shadow Run   |                                  |
|                                  |                                  |                                  |                                  |                                  |
|                                  |                                  | 2. ParentChildIndex (L4E)        | 4. CompletenessSnapshot (L4G)    |                                  |
|                                  |                                  | DOMAIN: Graph & Relationship     | DOMAIN: Context Health & Support |                                  |
|                                  |                                  | KEY: parent_id / child_id        | KEY: trace_id / snapshot_hash    |                                  |
|                                  |                                  | DATA: ADG Edges                  | DATA: [18] ContextComp           |                                  |
|                                  |                                  | MECH: - Resolves pulls_context   | MECH: - Captures ContextCompScore|                                  |
|                                  |                                  | - Defines expansion depth (1-5)  | - Logs missing_sig & error spans |                                  |
|                                  |                                  | - Hydrates sibling context windws| - Feeds CompletenessRAGProposer  |                                  |
+----------------------------------+----------------------------------+----------------------------------+----------------------------------+----------------------------------+
