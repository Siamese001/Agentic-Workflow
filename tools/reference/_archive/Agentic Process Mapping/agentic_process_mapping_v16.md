================================================================================================================================================================================================================================
                                                                🗺️ AGENTIC SYSTEM — PROCESS MAP v26.3 (ZERO-DRIFT PURIFIED ALIGNMENT) 🗺️
...
[ 🛑 REAL-TIME CONTROL & SAFETY MANIFOLD (BUS C, D, E) ]
  ...
  ▼                      ▼          ▼                                                                                                             │                                   │
┌────────┐             ┌────────┐             ┌────────┐             ┌────────┐             ┌────────┐             ┌────────┐             ┌────────┐             ┌────────┐             ┌────────────────┐             ┌────────┐
│   U0   │────────────>│   L1   │────────────>│   L0   │────────────>│   L3   │────────────>│   L5   │────────────>│   L2   │────────────>│  Eval  │────────────>│   L6   │────────────>│   L4 Archive   │────────────>│   ML   │
└────────┘             └─┬──▲─┬─┘             └───┬────┘             └─▲────▲─┘             └────────┘             └────────┘             └───┬────┘             └───┬────┘             │  ┌──────────┐  │             └───┬────┘
                         │  │ │                   │                    │    │                                                                   │                    │                  │  │   UWG    │  │                 │
┌────────┐               │  │ │                   ├─[R4: ACTION]───────┘    │                                                                   │                    │                  │  └─────▲────┘  │                 │
│  APPS  │───────────────┘  │ │                   │                         │                                                                   │                    │                  └────────┼───────┘                 │
...
================================================================================================================================================================================================================================
 ...
 ├────────────────────────── VERIFICATION ─────────────────────────┴─────────────────────────────────────────────────────────────────────────────┤
 │ 7. L5 decides if work is allowed (policy)   |   8. L6 verifies what happened (observe only)   |   9. Eval Spine judges outcomes               │
 └───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
================================================================================================================================================================================================================================
 [ SCOPE RULES ]: EXECUTES STRICTLY POST-L2. WRITES TO L4. DOES NOT FEED L1 INLINE.
 AUTHORITY: READ-ONLY | NO EXECUTE | NO ROUTE | NO MUTATION | SIGNALS ONLY                                                  ┌───────────────────────────────────────┐
 FLOW: L2 Execute ─→ Eval Spine scores ─→ L6 validates/observes ─→ L4 stores ─→ ML ingests later                            │ EVALUATION SPINE METRICS (L4/L6)      │
