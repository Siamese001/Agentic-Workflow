#!/usr/bin/env python3
"""Register or patch exec-summary-l2-x1d-input-parity-c4f8e1 in Notion Plans DB."""
...
SUMMARY = (
    "COMPLETED (2026-05-25): L2/X1D input parity — post-X2 judges only, E0 SVP-first, B4 cert optional, "
    "named-cert X2 tighten, judge packet synthesis gates + generation_law_digest, "
    "generation_grade_contract_manifest, CI manifest gate. 52 pytest + drift gates PASS. "
    "Live Brown 3/3 deferred to exec-summary-operator-ship-a3f7c2."
)

AI_SUMMARY = """- PLAN_STATUS: COMPLETED (2026-05-25)
- Closeout: docs/reports/apps_rg/exec_summary_l2_x1d_input_parity_closeout_20260525.md
