#!/usr/bin/env python3
"""Register or patch exec-summary-claim-coverage-hardening-a1f3e8 in Notion Plans DB."""
...
SUMMARY = (
    "COMPLETED (2026-05-26): Exec summary claim-coverage hardening — W0 matcher (claim+claim_text), "
    "W1 X2 sentence/ledger + self_check gates, W2 NO_JUDGE_ROWS_EMITTED, W3 Brown fixture/tests, "
    "W4 live Brown exec_summary_20260526_191701. 83 pytest PASS."
)

AI_SUMMARY = """- PLAN_STATUS: COMPLETED (2026-05-26)
