#!/usr/bin/env python3
"""Register or patch exec-summary-x1d-transport-parity-d8f2a1 in Notion Plans DB."""
...
SUMMARY = (
    "COMPLETED (2026-05-24): Executive summary X1D transport parity — canonical judge contract hash, "
    "gate-closure reconcile (no pass laundering), shared system prompt for Gemini/GPT/Claude, "
    "frozen+adversarial tests PASS. Live Brown 2/3 PASS (transport parity); 3/3 deferred operator-ship."
)

AI_SUMMARY = """- PLAN_STATUS: COMPLETED (2026-05-24)
- DoD-1–4,6: PASS (rubric, canonical hash, transport, reconcile, receipt)
- DoD-5: PARTIAL — contract layers PASS; live 3/3 DEFERRED → exec-summary-operator-ship-a3f7c2 W5
