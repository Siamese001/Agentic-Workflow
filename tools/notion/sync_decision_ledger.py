...
``.claude/state/refactor_decisions/refactor_decision_ledger.sqlite`` is the
...
SQLite (.claude/state/refactor_decisions/refactor_decision_ledger.sqlite) is the
...
Watermark: stored at ``.claude/state/refactor_decisions/notion_sync_watermark.txt``
