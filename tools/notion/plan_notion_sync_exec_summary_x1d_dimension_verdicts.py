#!/usr/bin/env python3
"""Register or patch exec-summary-x1d-dimension-verdicts-e8f4a2 in Notion Plans DB."""
...
SUMMARY = (
    "Executive summary X1D dimension verdicts: machine-readable pass/fail per rubric dimension "
    "(8 SSOT ids), x1d_dimension_matrix.json per run, dimension-tagged judge regen hints. "
    "Headline score/pass unchanged for 3/3 certification."
)

AI_SUMMARY = """- PLAN_STATUS: Completed (2026-05-24)
- W1: dimension_verdicts schema + ensure/infer + JudgeOutput
