...
total_legit = len(LEGITIMATE_EXTERNAL) + len(LEGITIMATE_ENV_FLAG) + len(LEGITIMATE_PLATFORM) + len(LEGITIMATE_CONDITIONAL)
total_illegit = len(ILLEGITIMATE_IMPORTORSKIP) + len(ILLEGITIMATE_MODULE_MISSING) + len(ILLEGITIMATE_FILE_MISSING) + len(ILLEGITIMATE_NOT_IMPLEMENTED) + len(ILLEGITIMATE_ARTIFACT_MISSING) + len(ILLEGITIMATE_OTHER)
