...
VERB_PATTERN = re.compile(
    "^(Fix|Run|Test|Analyze|Update|Manage|Utilities|Check|Archive|Restore|Generate|Fetch|Find|Load|Perform|Query|Refactor|Verify|Convert|Calculate|Execute|Invoke|Measure|Monitor|Parse|Process|Register|Resolve|Validate|Watch|Write)(?=[A-Z])"
)
PROTECTED_SUFFIXES = (
    "Agent.py",
    "Orchestrator.py",
