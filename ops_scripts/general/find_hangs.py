...
def import_with_timeout(module_path: str, timeout: float = 2.0) -> tuple[str, str, float]:
    ...
    except (queue.Empty, OSError):    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging    # guardian: Add error context logging
