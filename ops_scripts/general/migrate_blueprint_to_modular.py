...
ASSIGNMENTS: dict[str, str] = {'HEALING_CONFIG': 'governance', 'AGENT_RESILIENCE_CONFIG': 'governance', 'MISSION_CONFIG': 'governance', 'MCP_CAPABILITIES': 'governance', 'GRAVITY_CONFIG': 'governance', 'GRAVITY_SURGERY_ENABLED': 'governance', 'UPSTREAM_SOVEREIGN_ROOTS': 'governance', 'DOWNSTREAM_ROOTS': 'governance', 'VALIDATED_FILE_EXTENSIONS': 'ssot', 'NAMING_EXEMPT_FILES': 'ssot', 'NAMING_EXEMPT_DIRS': 'ssot', 'FORBIDDEN_PATTERNS': 'ssot', 'ROOT_PROTECTED_FILES': 'ssot', 'PROJECT_ROOT_WHITELIST': 'ssot', 'ROOT_ALLOWED_PATTERNS': 'ssot', 'SOVEREIGN_EXCLUDED_FOLDERS': 'ssot', 'FORBIDDEN_FOLDER_PATTERN': 'ssot', 'FORBIDDEN_ROOT_FOLDERS': 'ssot', 'TESTS_ROOT_FILE_WHITELIST': 'ssot', 'AUTONOMOUS_AGENT_WHITELIST': 'ssot', 'ALLOWED_DUPLICATE_FILENAMES': 'ssot', 'DISCOVERY_EXCLUDED_TERRITORIES': 'ssot', 'PYTHON_STDLIB_MODULES': 'ssot', 'ROOT_WHITELIST': 'ssot', 'GLOBAL_EXCLUDED_DIRS': 'ssot', 'SCOPE_SUMMARY_EXCLUSIONS': 'ssot', 'FLAT_DIRECTORIES': 'ssot', 'validate_flat_directory': 'ssot', 'safe_prefixed_filename': 'ssot', 'validate_no_duplicate_prefix': 'ssot', 'is_path_allowed': 'ssot', 'is_l4_approved': 'ssot', 'protected_folders': 'ssot', 'ignore_dirs': 'ssot', 'sovereign_ignored_folders': 'ssot', 'ARTIFACT_ROUTING_MAP': 'artifacts', 'validate_artifact_routing': 'artifacts', 'check_forbidden_signals': 'artifacts', 'DATA_SUBFOLDER_METADATA': 'artifacts', 'DOCS_SUBFOLDER_METADATA': 'artifacts', 'PROJECT_ROOT_SUBFOLDERS': 'artifacts', 'PROJECT_ROOT_METADATA': 'artifacts', 'TEST_TYPE_SIGNALS': 'semantics', 'LEGACY_AST_SIGNALS': 'semantics', 'AST_PLACEMENT_SIGNALS': 'semantics', 'PLACEMENT_CONFIDENCE': 'semantics', 'L2_TO_L1_MAP': 'semantics', 'EXERCISER_REGISTRY': 'semantics', 'AGENT_REGISTRY': 'semantics', 'semantic_l2_registry': 'semantics', 'SEMANTIC_L2_REGISTRY': 'semantics'}
PRIVATE_DEPS: dict[str, str] = {'_STATIC_ROOT_PROTECTED_FILES': 'ssot', '_DYNAMIC_ROOT_PROTECTED_FILES': 'ssot', '_semantic_templates': 'semantics'}
