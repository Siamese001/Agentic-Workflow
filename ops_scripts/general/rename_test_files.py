...
RENAMES: list[tuple[str, str]] = [
    # ── tests/guardian ────────────────────────────────────────────────────────
    ("tests/guardian/test_v15_p2_compliance.py",             "tests/guardian/test_determinism_replayability_contracts.py"),
    ("tests/guardian/test_v15_p2_wave2_1_inventory.py",      "tests/guardian/test_runtime_entrypoint_inventory.py"),
    ...
    ("tests/guardian/test_v15_p8_2c_mode_matrix.py",         "tests/guardian/test_enforcement_mode_transition_matrix.py"),
    ...
    ("tests/governance/test_req018_hmac_artifact_coverage.py",                    "tests/governance/test_hmac_artifact_coverage.py"),
    ("tests/governance/test_req060_063_meta_learning_replay.py",                  "tests/governance/test_meta_learning_replay.py"),
    ...
    ("tests/governance/test_req087_modify_diff_signature_invalidation.py",        "tests/governance/test_diff_signature_invalidation.py"),
    ...
    ("tests/governance/test_req114_no_wallclock_determinism.py",                  "tests/governance/test_no_wallclock_determinism.py"),
    ("tests/governance/test_req118_no_reflection_bypass.py",                      "tests/governance/test_no_reflection_bypass.py"),
    ("tests/governance/test_req121_126_subprocess_env.py",                        "tests/governance/test_subprocess_env_isolation.py"),
    ...
    ("tests/governance/test_req184_381_384_canonical_hash_replay.py",             "tests/governance/test_canonical_hash_replay.py"),
    ("tests/governance/test_req186_390_392_393_395_396_hmac_lifecycle.py",        "tests/governance/test_hmac_lifecycle.py"),
    ("tests/governance/test_req188_189_398_399_403_404_407_enclave_replay.py",    "tests/governance/test_enclave_replay.py"),
    ("tests/governance/test_req192_409_semantic_clock_replay.py",                 "tests/governance/test_semantic_clock_replay.py"),
    ("tests/governance/test_req199_211_236_emission.py",                          "tests/governance/test_guardian_emission.py"),
    ("tests/governance/test_req201_212_222_242_262_289_rag_law_rollback.py",      "tests/governance/test_rag_law_rollback.py"),
    ("tests/governance/test_req239_240_quorum.py",                                "tests/governance/test_quorum.py"),
    ("tests/governance/test_req243_244_247_audit_completeness.py",                "tests/governance/test_audit_completeness.py"),
    ("tests/governance/test_req245_248_hil_ttl.py",                               "tests/governance/test_hil_ttl.py"),
    ("tests/governance/test_req253_254_cross_wave_linkage.py",                    "tests/governance/test_cross_context_linkage.py"),
    ("tests/governance/test_req270_273_seam_mutable_ref.py",                      "tests/governance/test_seam_mutable_ref.py"),
    ("tests/governance/test_req298_337_discovery_promotion.py",                   "tests/governance/test_discovery_promotion.py"),
    ("tests/governance/test_req307_308_evidence_replay.py",                       "tests/governance/test_evidence_replay.py"),
    ("tests/governance/test_req313_320_surgical_ssot_replay.py",                  "tests/governance/test_surgical_ssot_replay.py"),
    ("tests/governance/test_req327_331_360_365_side_effect_legality.py",          "tests/governance/test_side_effect_legality.py"),
    ...
    ("tests/governance/test_req378_384_forensic_determinism.py",                  "tests/governance/test_forensic_determinism.py"),
    ("tests/governance/test_req411_413_provider_binding.py",                      "tests/governance/test_provider_binding_contracts.py"),
    ("tests/governance/test_req413_provider_binding_determinism.py",              "tests/governance/test_provider_binding_determinism.py"),
    ...
    ("tests/governance/test_req415_provider_substitution_prohibition.py",         "tests/governance/test_provider_substitution_prohibition.py"),
    ("tests/governance/test_req416_critical_dual_enforcement.py",                 "tests/governance/test_critical_dual_enforcement.py"),
    ("tests/governance/test_req417_runtime_mutation_guard.py",                    "tests/governance/test_runtime_mutation_guard.py"),
    ("tests/governance/test_req_p0_canonical_digest_stability.py",                "tests/governance/test_canonical_digest_stability.py"),
    ("tests/governance/test_req_p0_capability_replay_binding.py",                 "tests/governance/test_capability_replay_binding.py"),
    ("tests/governance/test_req_p0_gateway_monopoly.py",                          "tests/governance/test_gateway_monopoly.py"),
    ("tests/governance/test_req_p0_runtime_write_interceptor.py",                 "tests/governance/test_runtime_write_interceptor.py"),
    ("tests/governance/test_req_p1_freeze_complete_revocation.py",                "tests/governance/test_freeze_complete_revocation.py"),
    ("tests/governance/test_req_p1_freeze_timing.py",                             "tests/governance/test_freeze_timing.py"),
    ("tests/governance/test_req_p2_cognitive_diff_trusted.py",                    "tests/governance/test_cognitive_diff_trusted.py"),
    ("tests/governance/test_req_p2_deterministic_velocity.py",                    "tests/governance/test_deterministic_velocity.py"),
    ("tests/governance/test_req_p2_evacuation_discipline.py",                     "tests/governance/test_evacuation_discipline.py"),
    ("tests/governance/test_req_p2_metrics_chokepoint_ast.py",                    "tests/governance/test_metrics_chokepoint_ast.py"),
    ("tests/governance/test_req_p2_metrics_single_emission.py",                   "tests/governance/test_metrics_single_emission.py"),
    ...
    ("tests/evaluation/test_phase6_completeness_retrieval.py", "tests/evaluation/test_eval_completeness_retrieval.py"),

    # ── tests/integration ─────────────────────────────────────────────────────
    ("tests/integration/test_phase1_enforcer_seam.py",          "tests/integration/test_enforcer_seam.py"),
    ("tests/integration/test_phase2_orchestrator_hardening.py", "tests/integration/test_orchestrator_hardening.py"),
    ("tests/integration/test_phase3_router_discrimination.py",  "tests/integration/test_router_discrimination.py"),
    ("tests/integration/test_phase4_stability_guardrails.py",   "tests/integration/test_stability_guardrails.py"),
    ...
    ("tests/integration/test_wave_creative_cross_wave.py",      "tests/integration/test_creative_cross_context.py"),

    # ── tests/system_learning ─────────────────────────────────────────────────
    ("tests/system_learning/test_phase_a_learning_loop.py",  "tests/system_learning/test_learning_loop.py"),
    ("tests/system_learning/test_w2_negative_control.py",    "tests/system_learning/test_healing_optimizer_negative_control.py"),
    ("tests/system_learning/test_w3_negative_control.py",    "tests/system_learning/test_pattern_analysis_negative_control.py"),
    ...
    # ── tests/unit_min_deps ───────────────────────────────────────────────────
    ("tests/unit_min_deps/test_phase2_unsafe_io_enforcement.py", "tests/unit_min_deps/test_unsafe_io_enforcement.py"),
    ("tests/unit_min_deps/test_phase7_hardening.py",             "tests/unit_min_deps/test_l4_state_writer_isolation.py"),
    ("tests/unit_min_deps/test_phase8_hardening.py",             "tests/unit_min_deps/test_pattern_analysis_hardening.py"),
    ("tests/unit_min_deps/test_phase9_hardening.py",             "tests/unit_min_deps/test_resource_predictor_hardening.py"),
    ("tests/unit_min_deps/test_w5_determinism_digest.py",        "tests/unit_min_deps/test_determinism_digest.py"),
    ("tests/unit_min_deps/test_w5_executiontrace_plan_hash.py",  "tests/unit_min_deps/test_executiontrace_plan_hash.py"),
    ("tests/unit_min_deps/test_w5_handshake_state_machine.py",   "tests/unit_min_deps/test_handshake_state_machine.py"),
    ("tests/unit_min_deps/test_w5_l3_orchestrator_paths.py",     "tests/unit_min_deps/test_l3_orchestrator_paths.py"),
    ("tests/unit_min_deps/test_wave0c_meta_learning_intake_wiring.py", "tests/unit_min_deps/test_meta_learning_intake_wiring.py"),

    # ── tests/unit/agentic_core subdirectories ────────────────────────────────
    ("tests/unit/agentic_core/cache/test_redis_mcp_p3.py",
     "tests/unit/agentic_core/cache/test_redis_mcp.py"),
    ...
    ("tests/unit/apps_shared/test_apps_refactor_phases.py",
     "tests/unit/apps_shared/test_apps_refactor.py"),
]
