...
def generate():
    ...
    output = ['# SOVEREIGN SYSTEM CERTIFICATE (V2.5)', '**Status:** CERTIFIED PRODUCTION READY', '**Integrity:** LOCKED', '**Architecture:** HARDENED DATACLASS', '', '## Active Sovereign Agents', '| Domain | Agent Name | Base Class | Dataclass | Status |', '| :--- | :--- | :--- | :--- | :--- |']
