...
_emit_checks_agent_registry("p1", "fix_all_tunnels_util", "agent_registry")
_emit_validates_agent_capability("p1", "fix_all_tunnels_util", "capability")
_emit_dispatches_execution_plan("p1", "fix_all_tunnels_util", "exec_plan")
_emit_agent_executes_agent("p1", "fix_all_tunnels_util", "sub_agent")
_emit_routes_to_agent("p1", "fix_all_tunnels_util", "target_agent")
_emit_verifies_policy("p1", "fix_all_tunnels_util", "policy_check")
_emit_observes_runtime_state("p1", "fix_all_tunnels_util", "runtime_state")
_emit_verifies_boundary("p1", "fix_all_tunnels_util", "boundary_check")
_emit_transcripts_response("p1", "fix_all_tunnels_util", "transcript")
_emit_hard_fails_untranscripted("p1", "fix_all_tunnels_util")
_emit_gated_by_confidence("p1", "fix_all_tunnels_util", "confidence_gate")
...
_emit_emits_metric_event("fix_all_tunnels_util", "p4obs", "metric_3")
_emit_emits_metric_event("fix_all_tunnels_util", "p4obs", "metric_4")
_emit_emits_metric_event("fix_all_tunnels_util", "p4obs", "metric_5")
_emit_emits_metric_event("fix_all_tunnels_util", "p4obs", "metric_6")
_emit_records_incident_event("fix_all_tunnels_util", "p4obs", "incident")
_emit_captures_runtime_anomaly("fix_all_tunnels_util", "p4obs", "anomaly")
_emit_writes_observability_log("fix_all_tunnels_util", "p4obs", "obs_log")
_emit_updates_monitoring_state("fix_all_tunnels_util", "p4obs", "mon_state")
_emit_triggers_alert("fix_all_tunnels_util", "p4obs", "alert")
_emit_links_incident_trace("fix_all_tunnels_util", "p4obs", "trace_link")
_emit_captures_pattern("fix_all_tunnels_util", "p3lm", "pattern")
_emit_records_learning_event("fix_all_tunnels_util", "p3lm", "learning_event")
_emit_writes_learning_snapshot("fix_all_tunnels_util", "p3lm", "snapshot")
_emit_feeds_meta_learning("fix_all_tunnels_util", "p3lm", "meta_feed")
_emit_updates_routing_strategy("fix_all_tunnels_util", "p3lm", "routing")
_emit_improves_agent_policy("fix_all_tunnels_util", "p3lm", "policy")
_emit_stores_learning_state("fix_all_tunnels_util", "p3lm", "state")
_emit_records_execution_trace("fix_all_tunnels_util", "L0_ROUTING", "p2_trace_1")
_emit_records_execution_trace("fix_all_tunnels_util", "L1_REASONING", "p2_trace_2")
_emit_records_execution_trace("fix_all_tunnels_util", "L2_EXECUTION", "p2_trace_3")
_emit_records_execution_trace("fix_all_tunnels_util", "L3_ORCHESTRATION", "p2_trace_4")
_emit_records_execution_trace("fix_all_tunnels_util", "L4_STATE", "p2_trace_5")
_emit_reads_environ("fix_all_tunnels_util", "env_read", "p2_env_1")
_emit_reads_environ("fix_all_tunnels_util", "env_read", "p2_env_2")
_emit_reads_runtime_state("fix_all_tunnels_util", "runtime_state", "p2_rt_1")
_emit_reads_runtime_state("fix_all_tunnels_util", "runtime_state", "p2_rt_2")
_emit_pulls_context("p1", "fix_all_tunnels_util", "context_pull")
_emit_pulls_context("p1", "fix_all_tunnels_util", "context_pull_2")
_emit_execution_terminates_at_uwg("p1", "fix_all_tunnels_util", "uwg_term")
_emit_execution_terminates_at_uwg("p1", "fix_all_tunnels_util", "uwg_term_2")
_emit_writes_through("p1", "fix_all_tunnels_util", "write_through")
_emit_writes_through("p1", "fix_all_tunnels_util", "write_through_2")
_emit_validated_by_safety_plane("p1", "fix_all_tunnels_util", "safety_validation")
_emit_invokes_eval("p1", "fix_all_tunnels_util", "eval_call")
_emit_proposal_commits_routing("p1", "fix_all_tunnels_util", "routing_commit")
