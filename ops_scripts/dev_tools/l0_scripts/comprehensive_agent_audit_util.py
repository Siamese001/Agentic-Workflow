...
def analyze_agents():
    ...
    for py_file in agent_files:
        ...
        if (
            ...
            and "Detector" not in name
            and "Enforcer" not in name
        ):
            continue
        ...
        try:
            ...
            has_validate = (
                ...
                or "def detect" in content_lower
                or "def scan" in content_lower
            )
            has_heal = (
                "def heal" in content_lower or "def fix" in content_lower or "def repair" in content_lower
            )
