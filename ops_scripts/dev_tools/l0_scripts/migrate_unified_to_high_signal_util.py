...
emit_determinism_digest("trace_migrate_unified_to_high_signal_util", "migrate_unified_to_high_signal_util_dispatch")
emit_determinism_digest("trace_migrate_unified_to_high_signal_util", "migrate_unified_to_high_signal_util_complete")
...
def migrate_unified():
    ...
    PATH_MAPPING = {'agentic_core/L5_safety/unified': 'agentic_core/L5_safety/reasoning', 'agentic_core/L2_execution/unified': 'agentic_core/L2_execution/execution_bridge'}
    ...
    replacements = [(re.compile('from agentic_core\\.L5_safety\\.unified\\.'), 'from agentic_core.L5_safety.reasoning.'), (re.compile('import agentic_core\\.L5_safety\\.unified\\.'), 'import agentic_core.L5_safety.reasoning.'), (re.compile('from agentic_core\\.L5_safety\\.unified import'), 'from agentic_core.L5_safety.reasoning import'), (re.compile('from agentic_core\\.L2_execution\\.unified\\.'), 'from agentic_core.L2_execution.execution_bridge.'), (re.compile('import agentic_core\\.L2_execution\\.unified\\.'), 'import agentic_core.L2_execution.execution_bridge.'), (re.compile('from agentic_core\\.L2_execution\\.unified import'), 'from agentic_core.L2_execution.execution_bridge import'), (re.compile('\\bUnified([A-Z][a-zA-Z]+Agent)\\b'), '\\1')]
