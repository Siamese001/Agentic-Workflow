...
def investigate_row_collapse():
    ...
    return {'total_rows': len(data), 'expected_rows': 29, 'empty_territories': len(empty_territories), 'l6_rows': len(l6_rows), 'l6_agents': l6_agents, 'health_formula_correct': False, 'total_calculation_correct': abs(manual_health_avg - total_health) < 0.1}
