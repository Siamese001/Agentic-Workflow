...
def run_hardened_query(
    ...
    with Progress(
        ...
        except (concurrent.futures.TimeoutError, TimeoutError):    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context
