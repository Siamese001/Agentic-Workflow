...
def validate_totals():
    ...
    metrics_to_check = [('Heal Cap %', 'Healing Capability'), ('Invocation %', 'Healing Invocation'), ('Hardened %', 'MCP Hardened'), ('Test %', 'Test Coverage'), ('Typed %', 'Typing'), ('Observable %', 'observability')]
    all_valid = True
    ...
    if breakdown:
        ...
        for comp in breakdown:
            ...
            print(f"     {comp['component']:20s}: {comp['raw']:5.1f}% × {comp['weight'] * 100:2.0f}% = {points:5.1f} pts")
