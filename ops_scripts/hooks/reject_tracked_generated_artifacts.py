...
# Patterns for generated artifacts that must NEVER be tracked.
# Uses fnmatch glob syntax against git-relative paths.
...
def _match(path: str, pattern: str) -> bool:
    ...
    if pattern.startswith("**/"):
        suffix = pattern[3:]
        # Match against every possible tail of the path
