...
PHRASE_REPLACEMENTS: list[tuple[str, str]] = [
    ...
    (
        "See `.windsurf/rules/sequential-thinking-enforcement.md`",
    ...
    (
        "See `.windsurf/rules/windsurf-config-lookup.md`",
        "See `.cursor/rules/cursor-config-lookup.mdc`",
    ),
    (
        "See `.windsurf/rules/windsurf-config-lookup.md` for the full local-first lookup order. Local docs mirror: `docs/windsurf/`. Plans SSOT: `.windsurf/plans/<name>-<6hex>.md`",
    ...
    (
        "Sync Windsurf mirror via `.windsurf/scripts/post_write_mcp_config_sync.py` when using Windsurf",
        "Sync Windsurf mirror via `.windsurf/scripts/post_write_mcp_config_sync.py` when using Windsurf (optional)",
    ),
    (
        "Change gate behavior in `.windsurf/scripts/pre_mcp_gate.py`",
    ...
    (
        ...
        "Filesystem SSOT (Windsurf mirror): `.windsurf/mcp_config.json`",
    ),
    (
        "Filesystem SSOT: `.windsurf/rules/*.md`",
