...
from agentic_core.utils.report_location_validator_types_util import (  # noqa: E402
    SSOT_REPORTS_DIR,
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=int,
        metavar="N",
        help="Migrate only the first N reports (for testing)",
    )
    parser.add_argument(
        "--force",
        action="store_true",
    ...
    parser.add_argument(
        "--manifest",
        type=Path,
        help="Path to migration manifest for rollback",
    )
