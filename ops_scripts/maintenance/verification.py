...
def test_circuit_breaker():
    ...
    except CircuitBreakerOpenError:    # guardian: CircuitBreakerOpenError should be handled with specific context    # guardian: CircuitBreakerOpenError should be handled with specific context    # guardian: CircuitBreakerOpenError should be handled with specific context    # guardian: CircuitBreakerOpenError should be handled with specific context    # guardian: CircuitBreakerOpenError should be handled with specific context
    ...
    except CircuitBreakerTimeoutError:    # guardian: CircuitBreakerTimeoutError should be handled with specific context    # guardian: CircuitBreakerTimeoutError should be handled with specific context    # guardian: CircuitBreakerTimeoutError should be handled with specific context    # guardian: CircuitBreakerTimeoutError should be handled with specific context    # guardian: CircuitBreakerTimeoutError should be handled with specific context
