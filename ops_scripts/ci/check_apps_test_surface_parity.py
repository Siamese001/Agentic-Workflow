...
Rule: .codex/rules/apps-test-surface-taxonomy.md.
"""
...
_WINDSURF_SCRIPTS = REPO_ROOT / ".codex" / "governance" / "scripts"
...
def main() -> int:
    ...
    print(
        "\nSee .codex/rules/apps-test-surface-taxonomy.md for remediation.",
        file=sys.stderr,
    )
    print(
