...
STANDARD_LIBRARY_MODULES = {
    ...
    "enum", "functools", "gc", "hashlib", "inspect", "itertools", "json",
    "logging", "math", "os", "pathlib", "pickle", "re", "sys", "time",
    "traceback", "types", "typing", "uuid", "warnings", "weakref",
    # Additional common modules
    "importlib", "importlib.util", "struct", "shutil", "tempfile", "statistics",
    "dotenv", "numpy", "openai", "subprocess", "threading", "psutil", "pydantic",
    "csv", "io", "fnmatch", "unicodedata", "urllib.parse", "jinja2",
    # External libraries commonly used
    "libcst", "google", "google.genai", "uvicorn", "fastapi", "fastapi.responses",
    "xml.etree.ElementTree", "yaml", "hmac", "contextvars",
    # More external libraries
    "tree_sitter", "tree_sitter_python", "cryptography.fernet", "watchdog", "watchdog.events",
    "watchdog.observers", "tqdm", "difflib", "textwrap", "secrets", "platform", "winreg", "random",
    # Standard library additions
    "concurrent.futures", "atexit", "signal",
    # More external libraries
    "redis",
    # Internal modules that should be treated as standard library for boundary checking
    "base_detector_validator", "engine",
    # Relative imports (treated as internal) - these are typically same-package imports
    "cache_entry_types", "claim_type_types", "cost_governor_types", "expansion_strategy_types",
    "main_util", "runtime_bootstrapper",
    "runtime.core.telemetry", "services.configuration",
    # Common relative import patterns
    "governance_hub", "prompt_assembler", "sovereign_prompt_renderer", "optimization_strategy",
    "detectors.injection_detector", "detectors.pii_scrubber", "injection_detector", "pii_scrubber",
    "output_schema_validator",
    "shared_infrastructure_config", "signal_quality_config",
    "ast_relocator",
    # agentic_core sub-modules that are internal
    "agentic_core.config", "agentic_core.patterns", "agentic_core.base_agents",
    # More internal modules
    "signature_verifier", "context_contracts", "slot_contracts",
    # Additional internal modules
    "agentic_core.L6_observability", "ops_scripts", "apps_shared", "agentic_core.shared",
    # More internal modules
    "classification_kernel", "sovereign_policy_registry", "agentic_core.governor",
    "agentic_core.overseer", "agentic_core.PiiVault",
    # Even more internal modules
    "persistent_store", "agentic_core.storage",
}
...
def scan_directory(directory: Path) -> dict[str, list[str]]:
    ...
    for py_file in directory.rglob("*.py"):
        ...
        file_violations = check_file_boundary(
            py_file, module_path, imports, from_imports
        )
