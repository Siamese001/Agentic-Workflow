...
def analyze_hooks(hooks_data: Dict) -> Dict:
    ...
    return {
        "counts": {
            ...
            "post_agent_count": post_agent_count,
        ...
        "growth_indicators": {
            ...
            "post_agent_hooks": post_agent_count,
...
def check_thresholds(analysis: Dict, args) -> List[Dict]:
    ...
    # Check max post_agent_response hooks
    if counts["post_agent_count"] > args.max_post_agent:
        violations.append({
            "type": "max_post_agent_exceeded",
            "threshold": args.max_post_agent,
            "actual": counts["post_agent_count"],
            "severity": "warning",
        })
...
def generate_receipt(
    ...
    return {
        ...
        "thresholds": {
            ...
            "max_post_agent": args.max_post_agent,
        },
        "hooks_summary": {
