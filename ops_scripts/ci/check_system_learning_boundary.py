...
# Paths within system_learning that are exempt (none by default)
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "ERROR: system_learning/ must not import from L6 observability. "
        "See docs/technical/Embedding Lifecycle.md architecture note."
    )
    return 1
