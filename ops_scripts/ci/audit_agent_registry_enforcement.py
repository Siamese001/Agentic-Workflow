...
try:
    from agentic_core.agents.agent_registry import get_profile, get_all_agent_ids
except ImportError:
            ...
            if keyword.arg == "agent_id":
                ...
                if isinstance(keyword.value, ast.Constant):
                    ...
                    if agent_id not in self.registered_agents:
                        self.violations.append(AgentUsageViolation(
                            self.file_path,
                            node.lineno,
                            "UNREGISTERED_AGENT",
...
def scan_file(file_path: Path) -> List[AgentUsageViolation]:
    ...
    try:
        ...
        violations.append(AgentUsageViolation(
