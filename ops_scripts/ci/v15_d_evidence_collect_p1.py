...
class DEvidenceCollector:
    ...
    def check_healing_transaction_boundary(self) -> dict[str, Any]:
        ...
        contracts_file = self.project_root / "agentic_core" / "L0_maintenance" / "types" / "v15_contracts.py"
    ...
    def check_semantic_clock_usage(self) -> dict[str, Any]:
        ...
        gateway_file = (
            self.project_root / "agentic_core" / "L0_maintenance" / "enforcement" / "v15_execution_gateway.py"
        )
    ...
    def check_trace_id_generation(self) -> dict[str, Any]:
        ...
        p2_types_file = self.project_root / "agentic_core" / "L0_maintenance" / "types" / "v15_p2_types.py"
    ...
    def check_guardian_signing(self) -> dict[str, Any]:
        ...
        guardian_file = (
            self.project_root / "agentic_core" / "L0_maintenance" / "types" / "guardian_contract.py"
        )
