...
def ci_timeout(seconds: int = 300, operation_name: str = "CI Operation"):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs) -> Any:
            ...
            except TimeoutError as e:    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context    # guardian: TimeoutError should be handled with specific context
                elapsed = time.time() - start_time
