...
def _changed_prod_files(base_ref: str) -> list[str]:
    ...
    except (subprocess.TimeoutExpired, OSError, FileNotFoundError) as exc:    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling    # guardian: Multiple exceptions (OSError, FileNotFoundError) need specific handling
