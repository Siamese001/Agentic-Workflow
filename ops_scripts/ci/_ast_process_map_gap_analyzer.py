...
class FunctionalAreaExtractor(ast.NodeVisitor):
    ...
    def visit_ClassDef(self, node: ast.ClassDef) -> None:
        ...
        self.classes.append({'name': node.name, 'bases': bases, 'decorators': decorators, 'line': node.lineno, 'docstring': ast.get_docstring(node) or ''})
    ...
    def visit_FunctionDef(self, node: ast.FunctionDef) -> None:
        ...
        decorators = [self._get_name(dec) for dec in node.decorator_list]
        self.functions.append({'name': node.name, 'decorators': decorators, 'line': node.lineno, 'docstring': ast.get_docstring(node) or ''})
        self._extract_keywords(node.name)
        self.generic_visit(node)
    ...
    def _extract_keywords(self, text: str) -> None:
        ...
        functional_keywords = {'redis', 'cache', 'semantic', 'mcp', 'telemetry', 'metrics', 'observability', 'monitoring', 'tracing', 'logging', 'audit', 'circuit', 'breaker', 'retry', 'timeout', 'rate', 'limit', 'throttle', 'backoff', 'queue', 'pubsub', 'stream', 'event', 'webhook', 'notification', 'alert', 'health', 'readiness', 'liveness', 'docker', 'sandbox', 'firecracker', 'isolation', 'embedding', 'vector', 'faiss', 'pinecone', 'chromadb', 'rag', 'retrieval', 'rerank', 'fusion', 'bm25', 'cosine', 'llm', 'gateway', 'sovereign', 'anthropic', 'openai', 'gemini', 'prompt', 'template', 'governance', 'policy', 'compliance', 'safety', 'guard', 'fence', 'validation', 'enforcement', 'routing', 'orchestration', 'workflow', 'dag', 'pipeline', 'healing', 'recovery', 'rollback', 'compensation', 'saga', 'state', 'persistence', 'ledger', 'registry', 'manifest', 'checkpoint', 'snapshot', 'replay', 'determinism', 'idempotent', 'migration', 'schema', 'version', 'upgrade', 'deprecation', 'feature', 'flag', 'toggle', 'experiment', 'canary', 'rollout', 'dpo', 'rlhf', 'reward', 'preference', 'feedback', 'learning', 'meta', 'adaptation', 'drift', 'anomaly', 'detection', 'rca', 'tool', 'capability', 'authorization', 'permission', 'token', 'budget', 'quota', 'throttling', 'escalation', 'tier', 'confidence', 'calibration', 'uncertainty', 'threshold', 'assembly', 'composition', 'injection', 'airlock', 'execution', 'evaluation', 'synthesis', 'transcript', 'trace'}
        for part in parts:
...
def scan_repository(repo_root: Path) -> dict[str, dict]:
    ...
    functional_areas = defaultdict(lambda: {'files': [], 'classes': [], 'functions': [], 'keywords': set(), 'layers': set()})
    ...
    for filepath in python_files:
        ...
        except (SyntaxError, UnicodeDecodeError, OSError) as e:    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies    # guardian: Parsing and encoding errors need separate handling strategies
...
def analyze_process_map_coverage(process_map_path: Path) -> set[str]:
    ...
    search_keywords = {'redis', 'cache', 'semantic', 'mcp', 'telemetry', 'metrics', 'observability', 'circuit breaker', 'retry', 'timeout', 'rate limit', 'queue', 'pubsub', 'stream', 'webhook', 'notification', 'alert', 'docker', 'sandbox', 'firecracker', 'embedding', 'vector', 'faiss', 'pinecone', 'chromadb', 'rerank', 'fusion', 'bm25', 'feature flag', 'toggle', 'canary', 'rollout', 'migration', 'schema', 'version'}
    found = set()
...
def generate_gap_report(functional_areas: dict, process_map_coverage: set[str]) -> dict:
    ...
    for keyword, data in functional_areas.items():
        ...
        if file_count >= 3 or class_count + function_count >= 5:
            significant_areas[keyword] = {'file_count': file_count, 'class_count': class_count, 'function_count': function_count, 'layers': sorted(data['layers']), 'in_process_map': keyword in process_map_coverage, 'sample_files': sorted(set(data['files']))[:5], 'sample_classes': [c['name'] for c in data['classes'][:5]]}
    gaps = {k: v for k, v in significant_areas.items() if not v['in_process_map']}
    return {'total_functional_areas': len(significant_areas), 'documented_areas': len([v for v in significant_areas.values() if v['in_process_map']]), 'missing_areas': len(gaps), 'gaps': gaps, 'all_areas': significant_areas}
...
def main():
    ...
    sorted_gaps = sorted(report['gaps'].items(), key=lambda x: x[1]['file_count'] + x[1]['class_count'], reverse=True)
    for keyword, data in sorted_gaps[:10]:
        print(f"  - {keyword}: {data['file_count']} files, {data['class_count']} classes, layers={data['layers']}", file=sys.stderr)
    return 0
