...
def main() -> int:
    ...
    except SchemaValidationError as exc:    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context    # guardian: SchemaValidationError should be handled with specific context
