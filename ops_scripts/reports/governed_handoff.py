...
if TYPE_CHECKING:
    from agentic_core.L6_observability.shadow_eval.legacy_parallel.promotion_packet import PromotionPacket  # guardian: allow-layer-violation -- ADR-086 M3 canonical legacy_parallel; TYPE_CHECKING only
