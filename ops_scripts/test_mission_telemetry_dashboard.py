...
class TestMissionTelemetryDashboard(unittest.TestCase):
    ...
    def test_intervention_ratio_zero_scanned(self):
        ...
        self.assertEqual(intervention_ratio, 0, "Intervention ratio should be 0 when no files scanned.")
    ...
    def test_dashboard_with_mock_state_file(self):
        ...
        with patch('ops_scripts.mission_telemetry_dashboard.project_root', self.temp_path):
            with patch('ops_scripts.mission_telemetry_dashboard.RUNTIME_STATE_JSON', 'runtime_state.json'):
    ...
    def test_dashboard_no_state_file(self):
        ...
        with patch('ops_scripts.mission_telemetry_dashboard.project_root', self.temp_path):
            with patch('ops_scripts.mission_telemetry_dashboard.RUNTIME_STATE_JSON', 'nonexistent.json'):
                # Capture print output
                with patch('builtins.print') as mock_print:
                    generate_report()
