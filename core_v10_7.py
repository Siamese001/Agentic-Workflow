...
def get_checkpointer(
    ...
    *,
    ...
    # v10.7 Colab Patch:
    # Disable LangGraph persistent checkpointing (Redis/Sqlite) because
    # Colab environment does not ship langgraph.checkpoint module.
    # Return None so the graph runs purely in-memory.
    return None
