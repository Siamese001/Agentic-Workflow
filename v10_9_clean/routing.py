...
from l1.meta_profile import META_PROFILE  # UPDATED path
...
def decide_route(criteria: RoutingCriteria) -> RoutingDecision:
    ...
    if META_PROFILE.routing_bias.get("prefer_fast") and decision.endpoint in ("fast", "default"):
        decision = RoutingDecision(
...
# The rest of the original 10_8 routing stack depended on model_invocation
# and prompt_utils. If you still want run_model_for_plan and related helpers
# wired into the new L2 clients, we can layer that in next. For now, this
# preserves the core deterministic routing decision logic.
