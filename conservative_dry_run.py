...
# ============================================================
# SAFE FILE MIGRATION LOGIC (DRY RUN)
# ============================================================
...
def move_config_files():
    ...
    print(f"Would move {len(moved_files)} config files")
...
def move_docs_files():
    ...
    print(f"Would move {len(moved_files)} docs files")
...
if __name__ == "__main__":
    print("\n=== DRY RUN: Creating config & docs subfolder structure ===")
    ...
    print("\n=== DRY RUN: Cleaning up empty config/docs folders ===")
    cleanup_config_docs_empty_folders()

    print("\n=== DRY RUN: CONSERVATIVE SUBFOLDER MIGRATION COMPLETE ===")
