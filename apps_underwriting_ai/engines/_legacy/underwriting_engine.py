"""LEGACY — relocated from engines/underwriting_engine.py.

NOT on any active import path. Preserved as reference only.
The active execution path is the agentic_core dispatch chain:
  apps_underwriting_ai/runtime/bindings/ (U0 → L1 → L0 → C0 → PA → L2 → Exit)
