"""LLM client adapter shim — sanctioned infra import wrapper for apps_underwriting_ai.

This module provides a thin adapter layer that re-exports from the sanctioned
infrastructure.sdks_mcps location, allowing apps_underwriting_ai to use LLM clients
...
# guardian: allow-layer-violation -- sanctioned LLM client shim; apps_underwriting_ai/integrations is the approved cross-layer seam for infra SDK access
