"""
Check Outreach package initialization.

Provides core functionality and exports for the Check Outreach module.
"""
...
__description__: str = "Core Check Outreach functionality"
...
def create_instance(config: Optional[Dict[str,
    ...
    logger.info(f"Created Check Outreach instance with config: {final_config}")
    return final_config
