"""apps_lic profile builder adapter — Bundle C canonical form.

Core binding imports live here (``*_adapter.py`` is exempt from authority MV).
``profile_builder.py`` is a thin re-export surface only.
"""
