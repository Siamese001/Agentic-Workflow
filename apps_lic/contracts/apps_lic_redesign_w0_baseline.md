...
| L0 | `apps_lic/runtime/bindings/l0_binding.py` chooses R4/R3R4/R5 using the outreach route profile and legacy local-provider constraints. | No v2 `sc_level`, `reasoning_intensity`, judge profile, recipient-class route, JD gate, or message-type policy matrix. |
