...
_emit_escalates_to_human("p1", "code_quality_guardrail_types", "human_escalation")
_emit_routes_through("p1", "code_quality_guardrail_types", "route_through")
_emit_checks_agent_registry("p1", "code_quality_guardrail_types", "agent_registry")
_emit_validates_agent_capability("p1", "code_quality_guardrail_types", "capability")
_emit_dispatches_execution_plan("p1", "code_quality_guardrail_types", "exec_plan")
_emit_agent_executes_agent("p1", "code_quality_guardrail_types", "sub_agent")
_emit_routes_to_agent("p1", "code_quality_guardrail_types", "target_agent")
_emit_verifies_policy("p1", "code_quality_guardrail_types", "policy_check")
_emit_observes_runtime_state("p1", "code_quality_guardrail_types", "runtime_state")
_emit_verifies_boundary("p1", "code_quality_guardrail_types", "boundary_check")
_emit_transcripts_response("p1", "code_quality_guardrail_types", "transcript")
_emit_hard_fails_untranscripted("p1", "code_quality_guardrail_types")
_emit_gated_by_confidence("p1", "code_quality_guardrail_types", "confidence_gate")
