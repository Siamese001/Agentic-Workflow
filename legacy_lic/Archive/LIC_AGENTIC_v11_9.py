"""
LinkedIn Outreach Orchestrator (LIC) - AGENTIC v11.9
====================================================
...
class ResearchOrchestrator:
    ...
    async def conduct_research(
        ...
        NEW v11.9: Extracts sender grounding whitelists from RAG
        Implements:
        - Signal quality scoring
        - RAG reflexion loop
        - Job tracker integration
        - Archetype self-correction
        - Sender grounding extraction (v11.9)
        """
        self.status = AgentStatus.RUNNING
        ...
        # NEW v11.9: Extract sender grounding whitelists
        ...
        context = ResearchContext(
            ...
            sender_context=[],
            sender_grounding=sender_grounding  # NEW v11.9
        )
